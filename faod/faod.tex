...
Monocarboxylate transporter 1 deficiency & AR, AD\\
 & \\
\end{tabular}
\end{table}\footnotetext[1]{\label{org66cc989}promoter-activating mutations in patients with hyperinsulinemic
...
\label{sec:orgf142887}
\begin{enumerate}
\item Neonatal
\label{sec:org5da31f9}
\begin{itemize}
...
\label{sec:orgd659acb}
\subsection{Routine Biochemistry}
\label{sec:org7dc53f9}
\begin{itemize}
\item Glucose
\item Ketones
\item Lactate
...
\caption{\label{fig:orgd048557}
Randle Cycle}
\end{figure}}}
\label{sec:org92a5028}
\begin{itemize}
\item Fasted state:
\begin{itemize}
