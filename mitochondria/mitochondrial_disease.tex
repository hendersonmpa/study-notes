...
\label{sec:orge13419d}
\subsection{Background}
\label{sec:org01d871b}
\begin{enumerate}
\item Mitochondria
\label{sec:org746c70e}
\begin{itemize}
...
\caption[hela]{\label{fig:org49e882d}
HeLa Cells mtGFP}
\end{figure}

\item Maternal Inheritance
\label{sec:orgfcbff44}
\begin{itemize}
...
\caption[mom]{\label{fig:orgff87828}
Maternal Inheritance}
\end{figure}

\item Heteroplasmy
\label{sec:org1c31ee9}
...
\caption[heter]{\label{fig:orgd123c05}
heteroplasmy}
\end{figure}
...
\caption[bottle]{\label{fig:org689aa7e}
Mitochondrial bottle neck}
\end{figure}

\item Fusion
\label{sec:org134e2fd}
\begin{itemize}
...
\caption[fusion]{\label{fig:orgc6ab96f}
Mitochondrial fusion}
\end{figure}

\item Replication and Fission
\label{sec:org2a632f5}
...
\caption[mtdna]{\label{fig:org2703b86}
Human mitochondrial genome}
\end{figure}

\item Alternative genetic code
\label{sec:orga0d707a}
...
\begin{table}[htbp]
\caption[mito code]{\label{tab:org1237552}
...
\caption[keto]{\label{fig:org871d528}
Ketogenesis}
\end{figure}

\item Ketolysis
\label{sec:orgfbde3dd}
...
\section{Pyruvate}
\label{sec:orgf9b6361}
\subsection{Introduction}
\label{sec:org3c0db91}
\begin{enumerate}
\item Disorders of Pyruvate Metabolism
\label{sec:org0ac1f6c}
...
\label{sec:org231ef53}
\begin{enumerate}
\item Phospoenolpyruvate Carboxykinase Deficiency
\label{sec:org035438f}
...
\label{sec:orgaa7773e}
\begin{enumerate}
\item Pyruvate Dehydrogenase Complex
\label{sec:org48ec28c}
\begin{itemize}
...
\caption[pdhe1]{\label{fig:org829dcbc}
...
\caption[pdhc]{\label{fig:orgf31a809}
Pyruvate Dehydrogenase Complex}
\end{figure}

\item Pyruvate Dehydrogenase Complex Deficiency
\label{sec:orgbea11d6}
...
\centering
\includegraphics[width=0.6\textwidth]{./pyruvate/figures/pdhe1_phos.png}
\caption[pdhe1]{\label{fig:org538fd7e}
Activation/deactivation of PDHE1}
\end{figure}

\item Pyruvate Transport Defect
\label{sec:orgea2298a}
\begin{itemize}
...
\label{sec:orgb26c7b1}
\begin{enumerate}
\item Dihydrolipoamide Dehydrogenase
\label{sec:org29923f2}
\begin{itemize}
...
\label{sec:org6f7cfe3}
\subsection{Introduction}
\label{sec:org3372470}

\begin{enumerate}
\item The Tricarboxylic Acid Cycle
\label{sec:org0a2f332}
...
\label{sec:org656bb92}
\begin{enumerate}
\item \(\alpha\)-ketoglutarate Dehydrogenase Complex Deficiency
\label{sec:org31cdfc5}
...
\label{sec:org563342f}

\begin{enumerate}
\item Succinate Dehydrogenase Deficiency
\label{sec:org726c0ac}
...
\caption{\label{fig:org2e45479}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org7c6fed3}
...
\label{sec:org6cb2575}
\begin{enumerate}
\item Fumarase Deficiency
\label{sec:org0c27e8b}
...
\label{sec:orgd49daf9}
\begin{enumerate}
\item Isocitrate Dehydrogenase
\label{sec:orga5b6d49}
\begin{itemize}
...
\label{sec:org1e38f00}
\subsection{Introduction}
\label{sec:org704f84a}
\begin{enumerate}
\item ETC and OxPhos system
\label{sec:orgfada3cd}
\begin{itemize}
...
\caption[c1]{\label{fig:org0c675b1}
Complex I}
\end{figure}

\item Complex I Inhibitors
\label{sec:orgcc5ef05}
...
\label{sec:org7f1c60c}
\begin{enumerate}
\item Complex II | Succinate Dehydrogenase
\label{sec:org8f992ab}
\begin{itemize}
\item Four subunits compose Complex II of the mitochondrial respiratory chain
\end{itemize}
...
\caption[cII]{\label{fig:orgd617b3a}
Complex II}
\end{figure}

\item Complex II Inhibitors
\label{sec:org96c238e}
...
\label{sec:org315903d}
\begin{enumerate}
\item Glycerol-3-phosphate shuttle
\label{sec:org9f44a63}
\begin{itemize}
...
\label{sec:org0dc3e46}
\begin{enumerate}
\item Complex IV | Cytochrome c oxidase
\label{sec:org59671a2}
...
\caption[cIV]{\label{fig:org7bf23b7}
Complex IV}
\end{figure}

\item Complex IV | Inhibitors
\label{sec:org4c2ffe3}
...
\label{sec:orga165de7}
\begin{enumerate}
\item Complex V | ATP synthase
\label{sec:org17c5ada}
...
\label{sec:org21d10fb}

\begin{enumerate}
\item Anaerobic Glycolysis
\label{sec:org009d93a}
\begin{itemize}
...
\label{sec:orgdf4e746}

\begin{enumerate}
\item Type of Defect
\label{sec:orgb53410b}
\begin{itemize}
\item OxPhos Subunit
...
\label{sec:orgaf7aa05}
\subsection{Metabolic Derangement}
\label{sec:org8a441e4}
\begin{enumerate}
\item OxPhos Deficiency and Anaerobic Glycolysis
\label{sec:org61e585d}
\begin{itemize}
\item Insufficient ATP severely affects highly energy dependant tissues
\begin{itemize}
\item A complete loss of OxPhos is not observed in human disease.
...
\label{sec:org959630e}
\begin{enumerate}
\item Clinical Manifestations
\label{sec:orga7ce158}
\begin{itemize}
...
\label{sec:org021689f}

\begin{enumerate}
\item Biochemistry
\label{sec:org57e3064}
\begin{itemize}
...
\caption[rrf]{\label{fig:org00ebf29}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:org21694b2}
\begin{itemize}
