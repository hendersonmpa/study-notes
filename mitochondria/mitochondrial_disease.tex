...
\label{sec:orge9c477c}
\subsection{Background}
\label{sec:orgababbd5}
\begin{enumerate}
\item Maternal Inheritance
\label{sec:org0848a15}
\begin{itemize}
...
\caption[heter]{\label{fig:org58503bc}
Heteroplasmy}
\end{figure}

\item Muller's Ratchet and the Mitochondrial Bottleneck
\label{sec:org73ac02a}
\begin{itemize}
...
\caption[bottle]{\label{fig:org31c7dd3}
Mitochondrial bottle neck}
\end{figure}

\item Fusion
\label{sec:orge03a947}
\begin{itemize}
...
\caption[mtdna]{\label{fig:org92191c6}
Human mitochondrial genome}
\end{figure}

\item Alternative genetic code
\label{sec:orga97f02e}
\begin{itemize}
...
\begin{table}[htbp]
\caption[mito code]{\label{tab:org6454a51}
...
\end{enumerate}
\section{Pyruvate}
\label{sec:orge7f5cc6}
\subsection{Introduction}
\label{sec:org59a9024}
\begin{enumerate}
\item Disorders of Pyruvate Metabolism
\label{sec:org59c3def}
...
\caption[TCA]{\label{fig:org8000a22}
Disorders of Pyruvate Metabolism}
\end{figure}

\begin{enumerate}
\item Pyruvate Reactions
\label{sec:org081ed83}
...
\label{sec:orgcc0b49b}
\begin{enumerate}
\item Pyruvate Dehydrogenase Complex
\label{sec:orgcedbfb0}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orge2425be}
Pyruvate Dehydrogenases Complex}
\centering
\begin{tabular}{llll}
Unit & Name & Gene & Cofactor\\
\hline
E1 & pyruvate dehydrogenase & PDHA1, PDHB & thiamine pyrophosphate (TPP)\\
...
\caption[pdhe1]{\label{fig:orgbf508f9}
...
\caption[pdhc]{\label{fig:org3501f8e}
Pyruvate Dehydrogenase Complex}
\end{figure}

\item Pyruvate Dehydrogenase Complex Deficiency
\label{sec:orgbdb6e44}
\begin{itemize}
...
\item Treatment
\label{sec:orge085711}
\begin{itemize}
\item Early adoption of ketogenic diet may have a benefit
\item Thiamine responsive forms
\item DCA is a pyruvate analog, inhibits E1 kinase, keeps E1 dephosphorylated (active) (Figure \ref{fig:orgbf508f9})
\end{itemize}

\item Pyruvate Transport Defect
\label{sec:org85bbd12}
\begin{itemize}
...
\label{sec:org444f916}
\begin{enumerate}
\item Dihydrolipoamide Dehydrogenase
\label{sec:org008d1fd}
\begin{itemize}
...
\label{sec:org2008f6b}
\subsection{Introduction}
\label{sec:orge0c0114}
\begin{itemize}
...
mini-cycles (Figure \ref{fig:orgf1b0281})
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org74297e9}
\begin{itemize}
\item Similar to PDHC (section \ref{sec:orgcc0b49b})
...
\caption{\label{fig:org591164c}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd5ff79e}
\begin{itemize}
...
\caption{\label{fig:orgab8800e}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org6c3a568}
\begin{itemize}
...
\label{sec:orgfe7ef73}
\subsection{Introduction}
\label{sec:orgac5d62f}
\begin{enumerate}
\item ETC and OxPhos system
\label{sec:org9b34d7b}
\begin{itemize}
...
\caption[ETC]{\label{fig:orgcdcbda5}
...
\caption[ETC mega complex]{\label{fig:org484aff1}
ETC Mega Complex}
\end{figure}
...
\caption[c1]{\label{fig:org2f831fd}
Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\item Complex I Inhibitors
\label{sec:org36aabc4}
\begin{itemize}
...
\label{sec:org7df35b0}
\begin{enumerate}
\item Complex II | Succinate Dehydrogenase
\label{sec:org3ce788f}
\begin{itemize}
\item Four subunits compose Complex II of the mitochondrial respiratory chain
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org49dfc2e}
...
\caption[cII]{\label{fig:org5657d52}
Complex II | Succinate Dehydrogenase}
\end{figure}

\item Complex II Inhibitors
\label{sec:org7c72313}
\begin{itemize}
...
\label{sec:org6c93768}
\begin{enumerate}
\item Complex IV | Cytochrome c oxidase
\label{sec:org3e59bb5}
...
\caption[cIV]{\label{fig:org89190c1}
Complex IV | Cytochrome c oxidase}
\end{figure}

\item Complex IV | Inhibitors
\label{sec:org19afe41}
\begin{itemize}
...
\label{sec:org38db63d}
\begin{enumerate}
\item Complex V | ATP synthase
\label{sec:orgcd1238f}
...
\label{sec:org8e9dc2d}

\begin{enumerate}
\item Biochemistry
\label{sec:orgf5df743}
\begin{itemize}
...
\caption[rrf]{\label{fig:org29ff52c}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:orgf2e325c}
\begin{itemize}
...
\label{sec:org2732c94}
\subsection{Introduction}
\label{sec:org531c5f1}
...
\label{sec:orgb5cc389}
\subsection{Introduction}
\label{sec:org502bac9}
