...
\label{sec:org62e77ab}
\subsection{Background}
\label{sec:orgb316347}
\begin{enumerate}
\item Mitochondria
\label{sec:org1c587ca}
\begin{itemize}
...
\caption[hela]{\label{fig:orgf2b4c57}
HeLa Cells mtGFP}
\end{figure}

\item Maternal Inheritance
\label{sec:org9fadc2b}
\begin{itemize}
...
\caption[mom]{\label{fig:org348bb3d}
Maternal Inheritance}
\end{figure}

\item Heteroplasmy
\label{sec:org38930fd}
...
\caption[heter]{\label{fig:orgde57556}
heteroplasmy}
\end{figure}
...
\caption[bottle]{\label{fig:orge9813af}
Mitochondrial bottle neck}
\end{figure}

\item Fusion
\label{sec:org9a59db6}
\begin{itemize}
...
\caption[fusion]{\label{fig:org63d66a4}
Mitochondrial fusion}
\end{figure}

\item Replication and Fission
\label{sec:org8b519ce}
...
\caption[mtdna]{\label{fig:org6ee445a}
Human mitochondrial genome}
\end{figure}

\item Alternative genetic code
\label{sec:org5aae1e8}
...
\begin{table}[htbp]
\caption[mito code]{\label{tab:org311344d}
...
\caption[keto]{\label{fig:org1e4886a}
Ketogenesis}
\end{figure}

\item Ketolysis
\label{sec:org343117f}
...
\section{Pyruvate}
\label{sec:orga8ea84c}
\subsection{Introduction}
\label{sec:org3edf51d}
\begin{enumerate}
\item Disorders of Pyruvate Metabolism
\label{sec:org54491c3}
...
\label{sec:org36c4a87}
\begin{enumerate}
\item Phospoenolpyruvate Carboxykinase Deficiency
\label{sec:orgeaa1089}
...
\label{sec:org444302f}
\begin{enumerate}
\item Pyruvate Dehydrogenase Complex
\label{sec:org0b8b48e}
\begin{itemize}
...
\caption[pdhe1]{\label{fig:org784d737}
...
\caption[pdhc]{\label{fig:org2db2034}
Pyruvate Dehydrogenase Complex}
\end{figure}

\item Pyruvate Dehydrogenase Complex Deficiency
\label{sec:org5ea086f}
...
\centering
\includegraphics[width=0.6\textwidth]{./pyruvate/figures/pdhe1_phos.png}
\caption[pdhe1]{\label{fig:org0bc4344}
Activation/deactivation of PDHE1}
\end{figure}

\item Pyruvate Transport Defect
\label{sec:org5612607}
\begin{itemize}
...
\label{sec:org37b5e10}
\begin{enumerate}
\item Dihydrolipoamide Dehydrogenase
\label{sec:org079da28}
\begin{itemize}
...
\label{sec:orgcd92ce8}
\subsection{Introduction}
\label{sec:orgc1c27ad}

\begin{enumerate}
\item The Tricarboxylic Acid Cycle
\label{sec:orgb633a91}
...
\label{sec:orgad2a5e2}
\begin{enumerate}
\item \(\alpha\)-ketoglutarate Dehydrogenase Complex Deficiency
\label{sec:org2986e20}
...
\label{sec:org5b62e3a}

\begin{enumerate}
\item Succinate Dehydrogenase Deficiency
\label{sec:orge296ba2}
...
\caption{\label{fig:org3d49abd}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org44457d7}
...
\label{sec:org9d5731b}
\begin{enumerate}
\item Fumarase Deficiency
\label{sec:org7b7f7f4}
...
\label{sec:org0940f73}
\begin{enumerate}
\item Isocitrate Dehydrogenase
\label{sec:org0322e84}
\begin{itemize}
...
\label{sec:orge86dc25}
\subsection{Introduction}
\label{sec:orgab12204}
\begin{enumerate}
\item ETC and OxPhos system
\label{sec:org695b69d}
\begin{itemize}
...
\caption[c1]{\label{fig:org27930bf}
Complex I}
\end{figure}

\item Complex I Inhibitors
\label{sec:orgc0be33d}
...
\label{sec:orgdd5675a}
\begin{enumerate}
\item Complex II | Succinate Dehydrogenase
\label{sec:orgab68542}
\begin{itemize}
\item Four subunits compose Complex II of the mitochondrial respiratory chain
\end{itemize}
...
\caption[cII]{\label{fig:org6f4c89b}
Complex II}
\end{figure}

\item Complex II Inhibitors
\label{sec:org2c025aa}
...
\label{sec:org7a32b2a}
\begin{enumerate}
\item Glycerol-3-phosphate shuttle
\label{sec:orgf7b00ec}
\begin{itemize}
...
\label{sec:orgf3d9e75}
\begin{enumerate}
\item Complex IV | Cytochrome c oxidase
\label{sec:org5103f8a}
...
\caption[cIV]{\label{fig:org099fbbf}
Complex IV}
\end{figure}

\item Complex IV | Inhibitors
\label{sec:org89d4c29}
...
\label{sec:org4fd2472}
\begin{enumerate}
\item Complex V | ATP synthase
\label{sec:orgedcff20}
...
\label{sec:org52ad0df}

\begin{enumerate}
\item Anaerobic Glycolysis
\label{sec:org5f01c7d}
\begin{itemize}
...
\label{sec:org665c9e5}

\begin{enumerate}
\item Type of Defect
\label{sec:org309e06a}
\begin{itemize}
\item OxPhos Subunit
...
\label{sec:orgdd42b16}
\subsection{Metabolic Derangement}
\label{sec:org1614dee}
\begin{enumerate}
\item OxPhos Deficiency and Anaerobic Glycolysis
\label{sec:org9aa4f2d}
\begin{itemize}
\item Insufficient ATP severely affects highly energy dependant tissues
\begin{itemize}
\item A complete loss of OxPhos is not observed in human disease.
...
\label{sec:org44a8989}
\begin{enumerate}
\item Clinical Manifestations
\label{sec:org87ec668}
\begin{itemize}
...
\label{sec:org8baa3c8}

\begin{enumerate}
\item Biochemistry
\label{sec:org393a0b0}
\begin{itemize}
...
\caption[rrf]{\label{fig:org29fa4cd}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:org85d8ad6}
\begin{itemize}
