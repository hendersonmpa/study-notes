...
\label{sec:org1ea71c7}
\subsection{Background}
\label{sec:org077ec83}
\begin{enumerate}
\item Maternal Inheritance
\label{sec:org67baf8f}
\begin{itemize}
...
\caption[heter]{\label{fig:orgdc84a8c}
Heteroplasmy}
\end{figure}

\item Muller's Ratchet and the Mitochondrial Bottleneck
\label{sec:org5739ac9}
\begin{itemize}
...
\caption[bottle]{\label{fig:org4c7a55d}
Mitochondrial bottle neck}
\end{figure}

\item Fusion
\label{sec:org1aa5541}
\begin{itemize}
...
\caption[mtdna]{\label{fig:org62e6fa5}
Human mitochondrial genome}
\end{figure}

\item Alternative genetic code
\label{sec:org05718de}
\begin{itemize}
...
\begin{table}[htbp]
\caption[mito code]{\label{tab:orgd58af6e}
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org8cf1591}
\subsection{Introduction}
\label{sec:org72be541}
\begin{enumerate}
\item Disorders of Pyruvate Metabolism
\label{sec:orgd5b74b3}
...
\caption[TCA]{\label{fig:orga7c59ae}
Disorders of Pyruvate Metabolism}
\end{figure}

\begin{enumerate}
\item Pyruvate Reactions
\label{sec:org51e432f}
...
\label{sec:org7810835}
\begin{enumerate}
\item Pyruvate Dehydrogenase Complex
\label{sec:org956a04a}
\begin{itemize}
...
\caption[pdhe1]{\label{fig:org86fa0d2}
...
\caption[pdhc]{\label{fig:orge37c511}
Pyruvate Dehydrogenase Complex}
\end{figure}

\item Pyruvate Dehydrogenase Complex Deficiency
\label{sec:orgd50ef23}
\begin{itemize}
...
\item Treatment
\label{sec:orgef841e7}
\begin{itemize}
\item Early adoption of ketogenic diet may have a benefit
\item Thiamine responsive forms
\item DCA is a pyruvate analog, inhibits E1 kinase, keeps E1 dephosphorylated (active) (Figure \ref{fig:org86fa0d2})
\end{itemize}

\item Pyruvate Transport Defect
\label{sec:orgf252ef6}
\begin{itemize}
...
\label{sec:org08cfb95}
\begin{enumerate}
\item Dihydrolipoamide Dehydrogenase
\label{sec:org1799ad7}
\begin{itemize}
...
\label{sec:org1fcc7f2}
\subsection{Introduction}
\label{sec:orge317a50}
\begin{itemize}
...
mini-cycles (Figure \ref{fig:orgfbeb7e9})
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org675ba1a}
\begin{itemize}
\item Similar to PDHC (section \ref{sec:org7810835})
...
\caption{\label{fig:org45ce9ec}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org540528a}
\begin{itemize}
...
\label{sec:org7718acb}
\subsection{Introduction}
\label{sec:org8b9556c}
\begin{enumerate}
\item ETC and OxPhos system
\label{sec:orgfd3a31c}
\begin{itemize}
...
\caption[ETC]{\label{fig:org07e3b46}
...
\caption[c1]{\label{fig:orgb9121e2}
Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\item Complex I Inhibitors
\label{sec:org89a5fdc}
\begin{itemize}
...
\label{sec:orga15934b}
\begin{enumerate}
\item Complex II | Succinate Dehydrogenase
\label{sec:org2ec526d}
\begin{itemize}
\item see section \ref{sec:orga174081}
\end{itemize}

\item Complex II Inhibitors
\label{sec:orgc45e4bc}
\begin{itemize}
...
\label{sec:orga55f116}
\begin{enumerate}
\item Complex IV | Cytochrome c oxidase
\label{sec:orgfa04779}
...
\caption[cIV]{\label{fig:orgfaaeb63}
Complex IV | Cytochrome c oxidase}
\end{figure}

\item Complex IV | Inhibitors
\label{sec:org57d8a75}
\begin{itemize}
...
\label{sec:org080f722}
\begin{enumerate}
\item Complex V | ATP synthase
\label{sec:org05d5ba4}
...
\label{sec:org2b3c051}
\subsection{Introduction}
\label{sec:org2b68d5d}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:org07e3b46}).
...
\label{sec:orga9801ed}
\begin{enumerate}
\item Neonatal and Infantile Presentation
\label{sec:org53225e8}
\begin{itemize}
...
\label{sec:org49fdff0}
\begin{enumerate}
\item Biochemistry
\label{sec:org73913f4}
\begin{itemize}
...
\caption[rrf]{\label{fig:org9ca4584}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:org0724651}
\begin{itemize}
...
\label{sec:orgcbb16a4}
\subsection{Introduction}
\label{sec:org9bff65d}
...
\item Diagnostic Tests
\label{sec:org26f9c68}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org38030a4}
\begin{itemize}
...
\label{sec:org1b06329}
\subsection{Introduction}
\label{sec:org73778cd}
\begin{itemize}
