...
\label{sec:org015f59e}
\subsection{Background}
\label{sec:orgc1ebdf8}
\begin{enumerate}
\item Mitochondria
\label{sec:orgce39a8f}
\begin{itemize}
...
\caption[hela]{\label{fig:org0bf1dbc}
HeLa Cells mtGFP}
\end{figure}

\item Maternal Inheritance
\label{sec:org7c02037}
\begin{itemize}
...
\caption[mom]{\label{fig:org12985ff}
Maternal Inheritance}
\end{figure}

\item Heteroplasmy
\label{sec:org3f207bd}
...
\caption[heter]{\label{fig:orgdb55aa8}
heteroplasmy}
\end{figure}
...
\caption[bottle]{\label{fig:orgcafe3c9}
Mitochondrial bottle neck}
\end{figure}

\item Fusion
\label{sec:org1446740}
\begin{itemize}
...
\caption[fusion]{\label{fig:org1aca5a2}
Mitochondrial fusion}
\end{figure}

\item Replication and Fission
\label{sec:orgdd5536a}
...
\caption[mtdna]{\label{fig:orge431a08}
Human mitochondrial genome}
\end{figure}

\item Alternative genetic code
\label{sec:org459da27}
...
\begin{table}[htbp]
\caption[mito code]{\label{tab:orgc7c4ed4}
...
\caption[keto]{\label{fig:org6466578}
Ketogenesis}
\end{figure}

\item Ketolysis
\label{sec:org071d62e}
...
\section{Pyruvate}
\label{sec:org3af6bff}
\subsection{Introduction}
\label{sec:org4936378}
\begin{enumerate}
\item Disorders of Pyruvate Metabolism
\label{sec:orgce2f095}
...
\label{sec:org5014a2d}
\begin{enumerate}
\item Phospoenolpyruvate Carboxykinase Deficiency
\label{sec:org54cbba7}
...
\label{sec:org79978fc}
\begin{enumerate}
\item Pyruvate Dehydrogenase Complex
\label{sec:org828eb41}
\begin{itemize}
...
\caption[pdhe1]{\label{fig:org19c1671}
...
\caption[pdhc]{\label{fig:org2debb44}
Pyruvate Dehydrogenase Complex}
\end{figure}

\item Pyruvate Dehydrogenase Complex Deficiency
\label{sec:org0fdf9c5}
...
\centering
\includegraphics[width=0.6\textwidth]{./pyruvate/figures/pdhe1_phos.png}
\caption[pdhe1]{\label{fig:org3fb3593}
Activation/deactivation of PDHE1}
\end{figure}

\item Pyruvate Transport Defect
\label{sec:orge072dd5}
\begin{itemize}
...
\label{sec:orgc3bb5c3}
\begin{enumerate}
\item Dihydrolipoamide Dehydrogenase
\label{sec:org0a8bab4}
\begin{itemize}
...
\label{sec:orge1a13c3}
\subsection{Introduction}
\label{sec:org7337b39}

\begin{enumerate}
\item The Tricarboxylic Acid Cycle
\label{sec:org392a7f6}
...
\label{sec:org3ff44fc}
\begin{enumerate}
\item \(\alpha\)-ketoglutarate Dehydrogenase Complex Deficiency
\label{sec:orgbe4b29f}
...
\label{sec:orge487aa2}

\begin{enumerate}
\item Succinate Dehydrogenase Deficiency
\label{sec:orgf2e2333}
...
\caption{\label{fig:orgf0c3dca}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org878ef40}
...
\label{sec:org1f0b622}
\begin{enumerate}
\item Fumarase Deficiency
\label{sec:org1535879}
...
\label{sec:orgc5f3a2e}
\begin{enumerate}
\item Isocitrate Dehydrogenase
\label{sec:org41a1690}
\begin{itemize}
...
\label{sec:org8c86340}
\subsection{Introduction}
\label{sec:org927f8a4}
\begin{enumerate}
\item ETC and OxPhos system
\label{sec:orgaf89959}
\begin{itemize}
...
\caption[c1]{\label{fig:org46b9818}
Complex I}
\end{figure}

\item Complex I Inhibitors
\label{sec:org8cd08a4}
...
\label{sec:orga0ea33c}
\begin{enumerate}
\item Complex II | Succinate Dehydrogenase
\label{sec:orge660bca}
\begin{itemize}
\item Four subunits compose Complex II of the mitochondrial respiratory chain
\end{itemize}
...
\caption[cII]{\label{fig:org7a56a71}
Complex II}
\end{figure}

\item Complex II Inhibitors
\label{sec:org5d88a56}
...
\label{sec:orge007f0e}
\begin{enumerate}
\item Glycerol-3-phosphate shuttle
\label{sec:org907baf8}
\begin{itemize}
...
\label{sec:org819e48b}
\begin{enumerate}
\item Complex IV | Cytochrome c oxidase
\label{sec:org8d2a4c3}
...
\caption[cIV]{\label{fig:orgd84a888}
Complex IV}
\end{figure}

\item Complex IV | Inhibitors
\label{sec:org1f4912b}
...
\label{sec:org0e7668a}
\begin{enumerate}
\item Complex V | ATP synthase
\label{sec:orga067071}
...
\label{sec:orgd4b1827}

\begin{enumerate}
\item Anaerobic Glycolysis
\label{sec:orgb356b94}
\begin{itemize}
...
\label{sec:orgb23525c}

\begin{enumerate}
\item Type of Defect
\label{sec:orgae7e41f}
\begin{itemize}
\item OxPhos Subunit
...
\label{sec:org2f840c4}
\subsection{Metabolic Derangement}
\label{sec:org2cdbb27}
\begin{enumerate}
\item OxPhos Deficiency and Anaerobic Glycolysis
\label{sec:org1db1fcb}
\begin{itemize}
\item Insufficient ATP severely affects highly energy dependant tissues
\begin{itemize}
\item A complete loss of OxPhos is not observed in human disease.
...
\label{sec:orgc6c7dc4}
\begin{enumerate}
\item Clinical Manifestations
\label{sec:org539fadc}
\begin{itemize}
...
\label{sec:org8b3532d}

\begin{enumerate}
\item Biochemistry
\label{sec:org85caf3a}
\begin{itemize}
...
\caption[rrf]{\label{fig:orga179d2f}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:org9247800}
\begin{itemize}
