...
\label{sec:org2383bb2}
\subsection{Background}
\label{sec:org2f73132}
\begin{enumerate}
\item Mitochondria
\label{sec:org3a42b36}
\begin{itemize}
...
\caption[mom]{\label{fig:orgb505948}
Maternal Inheritance}
\end{figure}

\item Heteroplasmy
\label{sec:orgfbeb0ad}
...
\caption[heter]{\label{fig:org637ebf3}
Heteroplasmy}
\end{figure}
...
\caption[bottle]{\label{fig:org5726ddc}
Mitochondrial bottle neck}
\end{figure}

\item Fusion
\label{sec:org4315b2f}
\begin{itemize}
...
\caption[mtdna]{\label{fig:org4238c00}
Human mitochondrial genome}
\end{figure}

\item Alternative genetic code
\label{sec:orgf003e35}
\begin{itemize}
...
\begin{table}[htbp]
\caption[mito code]{\label{tab:org4433860}
...
\section{Pyruvate}
\label{sec:org250f165}
\subsection{Introduction}
\label{sec:orge2187d8}
\begin{enumerate}
\item Disorders of Pyruvate Metabolism
\label{sec:org12595c3}
...
\caption[TCA]{\label{fig:org5bd4070}
...
\label{sec:orgf5b263a}
\begin{enumerate}
\item Pyruvate Carboxylase
\label{sec:orgfc429f0}
...
\label{sec:org018fd0c}
\begin{enumerate}
\item Pyruvate Dehydrogenase Complex
\label{sec:org0034711}
\begin{itemize}
...
\caption[pdhe1]{\label{fig:org2e7f34a}
...
\caption[pdhc]{\label{fig:orgd2e5e95}
Pyruvate Dehydrogenase Complex}
\end{figure}

\item Pyruvate Dehydrogenase Complex Deficiency
\label{sec:org0270967}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./pyruvate/figures/pdhe1_phos.png}
\caption[pdhe1]{\label{fig:org2390a76}
Activation/deactivation of PDHE1}
\end{figure}

\item Pyruvate Transport Defect
\label{sec:org580ef02}
\begin{itemize}
...
\label{sec:org15ed401}
\begin{enumerate}
\item Dihydrolipoamide Dehydrogenase
\label{sec:org8c20b7c}
\begin{itemize}
...
\label{sec:orga5a9cf7}
\subsection{Introduction}
\label{sec:org44c2e64}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./tca/figures/TCACycle.png}
\caption{\label{fig:org2b614c8}
TCA cycle}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./tca/figures/TCA_disorders.png}
\caption{\label{fig:orge96d145}
TCA disorders}
\end{figure}
...
\label{sec:orgbe9ff1f}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./tca/figures/kgdh.png}
\caption{\label{fig:orgb3ee73f}
\(\alpha\)-ketoglutarate Dehydrogenase Complex Deficiency}
\end{figure}

\begin{enumerate}
\item \(\alpha\)-ketoglutarate Dehydrogenase Complex
\label{sec:orgd611394}
\begin{itemize}
...
\label{sec:orgf28fd9f}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./tca/figures/sdh.png}
\caption{\label{fig:org058a865}
Succinate Dehydrogenase Deficiency}
\end{figure}

\begin{enumerate}
\item Succinate Dehydrogenase | Complex II
\label{sec:org0d703f0}
\begin{itemize}
\item Four subunits compose Complex II of the mitochondrial respiratory chain
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgfc02743}
...
\caption{\label{fig:org3a033d0}
Succinate Dehydrogenase Deficiency}
\end{figure}

\item Clinical Presentation
\label{sec:org5298840}
\begin{itemize}
...
\caption{\label{fig:orgbc860e6}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:orgefc64fc}
\begin{itemize}
...
\label{sec:orgf8db148}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./tca/figures/fumarase.png}
\caption{\label{fig:orgf094e43}
Fumarase Deficiency}
\end{figure}

\begin{enumerate}
\item Fumarase
\label{sec:org5cfd8d4}
\begin{itemize}
...
\label{sec:org30f0f6d}
\subsection{Introduction}
\label{sec:orgcb8f6e6}
\begin{enumerate}
\item ETC and OxPhos system
\label{sec:org31ba46b}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./etc/figures/etc.pdf}
\caption{\label{fig:org1f2938f}
...
\caption[ETC]{\label{fig:org3625712}
...
\caption[ETC mega complex]{\label{fig:org91d243f}
ETC Mega Complex}
\end{figure}
...
\caption[c1]{\label{fig:orga99735b}
Complex I}
\end{figure}

\item Complex I Inhibitors
\label{sec:org9c5d8c4}
\begin{itemize}
...
\label{sec:org54c2555}
\begin{enumerate}
\item Complex II | Succinate Dehydrogenase
\label{sec:orgc4dd4fe}
\begin{itemize}
\item Four subunits compose Complex II of the mitochondrial respiratory chain
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgf404d36}
...
\caption[cII]{\label{fig:org91ddd8f}
Complex II}
\end{figure}

\item Complex II Inhibitors
\label{sec:org70d7b35}
\begin{itemize}
...
\begin{itemize}
\item Discussed in Lysine Catabolism
\end{itemize}
\end{itemize}
\subsection{Complex III}
\label{sec:org7478dd9}
\begin{enumerate}
\item Complex III | Coenzyme Q – cytochrome c reductase
\label{sec:orgd6706df}
\begin{itemize}
...
\label{sec:org890a8c7}
\begin{enumerate}
\item Complex IV | Cytochrome c oxidase
\label{sec:orga62d593}
...
\caption[cIV]{\label{fig:org0545723}
Complex IV}
\end{figure}

\item Complex IV | Inhibitors
\label{sec:org2dd8d8b}
\begin{itemize}
...
\label{sec:orgb890b06}
\begin{enumerate}
\item Complex V | ATP synthase
\label{sec:orgab57709}
...
\label{sec:orgb2d254e}

\begin{enumerate}
\item Biochemistry
\label{sec:orgf6fc36e}
\begin{itemize}
...
\caption[rrf]{\label{fig:org745a108}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:orgcd79892}
\begin{itemize}
