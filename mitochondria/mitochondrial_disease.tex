...
\caption[mtdna]{\label{fig:orgb9c1aee}
Human mitochondrial genome}
\end{figure}

\item Alternative genetic code
\label{sec:org4e489b9}
...
\begin{table}[htbp]
\caption[mito code]{\label{tab:orgd25d91f}
...
\caption[keto]{\label{fig:org0df6e13}
Ketogenesis}
\end{figure}

\item Ketolysis
\label{sec:org321d68e}
...
\section{Pyruvate}
\label{sec:org370dbca}
\subsection{Introduction}
\label{sec:orge809529}
\begin{enumerate}
\item Disorders of Pyruvate Metabolism
\label{sec:org5e7af5d}
...
\label{sec:org70962fa}
\begin{enumerate}
\item Phospoenolpyruvate Carboxykinase Deficiency
\label{sec:orgd951f07}
...
\label{sec:org1936990}
\begin{enumerate}
\item Pyruvate Dehydrogenase Complex
\label{sec:org625f50e}
\begin{itemize}
...
\caption[pdhe1]{\label{fig:orgef3aaed}
...
\caption[pdhc]{\label{fig:orgd2bd51a}
Pyruvate Dehydrogenase Complex}
\end{figure}

\item Pyruvate Dehydrogenase Complex Deficiency
\label{sec:orgad6a4e0}
...
\centering
\includegraphics[width=0.6\textwidth]{./pyruvate/figures/pdhe1_phos.png}
\caption[pdhe1]{\label{fig:orgbd6399d}
Activation/deactivation of PDHE1}
\end{figure}

\item Pyruvate Transport Defect
\label{sec:orge78ef03}
\begin{itemize}
...
\label{sec:org0c3c8ae}
\begin{enumerate}
\item Dihydrolipoamide Dehydrogenase
\label{sec:org751f3f4}
\begin{itemize}
...
\label{sec:orge4ffd89}
\subsection{Introduction}
\label{sec:orgd5bc2b0}

\begin{enumerate}
\item The Tricarboxylic Acid Cycle
\label{sec:org194fbf7}
...
\label{sec:orgd8755b3}
\begin{enumerate}
\item \(\alpha\)-ketoglutarate Dehydrogenase Complex Deficiency
\label{sec:org99015c4}
...
\label{sec:org33c048d}

\begin{enumerate}
\item Succinate Dehydrogenase Deficiency
\label{sec:orgc78cc3f}
...
\caption{\label{fig:orgad806ee}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org69f9f6f}
...
\label{sec:orgbae6cee}
\begin{enumerate}
\item Fumarase Deficiency
\label{sec:orgef25561}
...
\label{sec:orgb292e16}
\begin{enumerate}
\item Isocitrate Dehydrogenase
\label{sec:orgfef9c02}
\begin{itemize}
...
\label{sec:orgdb1a2a5}
\subsection{Introduction}
\label{sec:orgdbcca21}
\begin{enumerate}
\item ETC and OxPhos system
\label{sec:org6b15954}
\begin{itemize}
...
\caption[c1]{\label{fig:org803b04e}
Complex I}
\end{figure}

\item Complex I Inhibitors
\label{sec:org6cc51e3}
...
\label{sec:org2e55958}
\begin{enumerate}
\item Complex II | Succinate Dehydrogenase
\label{sec:orga1a9022}
\begin{itemize}
\item Four subunits compose Complex II of the mitochondrial respiratory chain
\end{itemize}
...
\caption[cII]{\label{fig:org855abc7}
Complex II}
\end{figure}

\item Complex II Inhibitors
\label{sec:orgb34e93f}
...
\label{sec:org1d33750}
\begin{enumerate}
\item Glycerol-3-phosphate shuttle
\label{sec:org0f82989}
\begin{itemize}
...
\label{sec:org245b959}
\begin{enumerate}
\item Complex IV | Cytochrome c oxidase
\label{sec:orgf6cb4de}
...
\caption[cIV]{\label{fig:org1dd39ed}
Complex IV}
\end{figure}

\item Complex IV | Inhibitors
\label{sec:org32f33c2}
...
\label{sec:orgf5014ef}
\begin{enumerate}
\item Complex V | ATP synthase
\label{sec:orgc0c62b0}
...
\label{sec:org17803a3}

\begin{enumerate}
\item Anaerobic Glycolysis
\label{sec:org26bba08}
\begin{itemize}
...
\label{sec:orga47c73d}

\begin{enumerate}
\item Type of Defect
\label{sec:org68bc6ca}
\begin{itemize}
\item OxPhos Subunit
...
\label{sec:org3b3c007}
\subsection{Metabolic Derangement}
\label{sec:org10d793b}
\begin{enumerate}
\item OxPhos Deficiency and Anaerobic Glycolysis
\label{sec:org5f28652}
\begin{itemize}
\item Insufficient ATP severely affects highly energy dependant tissues
\begin{itemize}
\item A complete loss of OxPhos is not observed in human disease.
...
\label{sec:orga49f859}
\begin{enumerate}
\item Clinical Manifestations
\label{sec:org7130da5}
\begin{itemize}
...
\label{sec:org4e1e199}

\begin{enumerate}
\item Biochemistry
\label{sec:org29372f7}
\begin{itemize}
...
\caption[rrf]{\label{fig:orge6fb753}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:org613e6fd}
\begin{itemize}
