...
#+CAPTION[]:\alpha-ketoglutarate Dehydrogenase Complex Deficiency
#+NAME: fig:2kg
#+ATTR_LaTeX: :width 0.5\textwidth
...
#+CAPTION[]:Succinate Dehydrogenase Deficiency
#+NAME: fig:sdd
#+ATTR_LaTeX: :width 0.5\textwidth
...
#+CAPTION[]:Succinate Dehydrogenase
#+NAME: tab:sdd
