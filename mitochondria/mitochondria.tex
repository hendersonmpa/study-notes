...
\label{sec:org9d944e6}

\subsection{RedOx State}
\label{sec:orgca3d11f}
\begin{itemize}
...
\label{sec:org6790696}
\subsection{Introduction}
\label{sec:orgbe50e1a}
\begin{itemize}
...
\label{sec:org17ffe0d}

\begin{itemize}
\item involves three processes (Figure \ref{fig:org676789b})
\begin{enumerate}
...
\caption{\label{fig:org01e5101}
FA oxidation and ketone body metabolism}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org902eb2f}
...
\caption{\label{fig:orgb6697de}
CPT1}
\end{figure}

\item Genetics
\label{sec:org03febb5}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:orgf9c31e6}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0818c70}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org3293bef}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:org654de5f})
...
\caption{\label{fig:org654de5f}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:orgb524f0a}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Testing
\label{sec:org2543768}
\begin{itemize}
...
\label{sec:orgc6d3db5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb24062e}
\begin{enumerate}
\item Neonatal
\label{sec:orgce0c0ac}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:orgb6697de})
\end{itemize}
\item Genetics
\label{sec:org22f5d8e}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Testing
\label{sec:org8d68f4b}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:orgb11ccad}
\begin{enumerate}
\item Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency
\label{sec:org6a93ba5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1a970eb}
\begin{enumerate}
\item Infancy
\label{sec:org3d06a70}
\begin{itemize}
...
\caption{\label{fig:orgcbe8aaa}
VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:orgcc85b2b}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Testing
\label{sec:orgd6a8883}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org9239974}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga87d500}
\begin{itemize}
...
\label{sec:org90e3ede}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:org43d0671}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:org44fb7db}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org695db14}
\begin{itemize}
...
(Figure \ref{fig:orgccc4815})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fao/figures/lchad.png}
\caption{\label{fig:orgccc4815}
LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:orgff98888}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:org0f8dc1b}
\begin{itemize}
...
\label{sec:orgf6f18a9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org734c165}
\begin{itemize}
...
\caption{\label{fig:org28c4ca2}
Acyl-CoA Dehydrogenase Reaction}
\end{figure}

\item Genetics
\label{sec:org4b9d8a1}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org47b675a}
\begin{itemize}
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org6ca2b4d}
\subsection{Introduction}
\label{sec:org1cf7eb1}
\begin{itemize}
...
\caption[TCA]{\label{fig:orge0c53c4}
...
\caption[pdhe1]{\label{fig:orge1bc48e}
...
\caption[pdhc]{\label{fig:org69b2cc7}
...
\item Treatment
\label{sec:org2929eb2}
\begin{itemize}
\item early adoption of ketogenic diet may have a benefit
\item thiamine responsive forms
\item DCA is a pyruvate analog, inhibits E1 kinase, keeps E1 dephosphorylated (active) (Figure \ref{fig:orge1bc48e})
\end{itemize}

\item Pyruvate Transport Defect
\label{sec:orgdf50dc3}
\begin{itemize}
...
\label{sec:orgfec86f3}
\subsection{Introduction}
\label{sec:org1f350b5}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgc19989a}
Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\begin{enumerate}
\item Disorders of the TCA cycle
\label{sec:orgdbc18a2}
...
mini-cycles (Figure \ref{fig:orgf66fc61})
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgddaac65}
\begin{itemize}
\item similar to PDHC (section \ref{sec:orgdfa778d})
...
\caption{\label{fig:orgd0eabcb}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:orgea19c7d}
\begin{itemize}
...
\caption{\label{fig:orgad8be98}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org81dfae9}
\begin{itemize}
...
\label{sec:org2fbdd76}
\subsection{Introduction}
\label{sec:org11577c6}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:org8ad5399})
...
\item 13 subunits of Complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:orgd4913ef})
...
\caption[ETC]{\label{fig:org8ad5399}
...
\caption[redox]{\label{fig:org3ac6754}
Electron flow to O\(_{\text{2}}\) and release free energy}
\end{figure}

\begin{enumerate}
\item Complex I
\label{sec:org4ebf8cb}
\begin{itemize}
...
\caption[c1]{\label{fig:org2789dbd}
Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:org1f0e058}
\begin{itemize}
...
\item Complex II
\label{sec:org3d5c266}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:orga090f50}
\end{itemize}
\end{itemize}

\begin{enumerate}
\item Inhibitors
\label{sec:org97aeecc}
\begin{itemize}
...
\caption[cIV]{\label{fig:org7fe7d18}
...
\label{sec:org656e842}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:org6e5a12b})
\begin{enumerate}
...
\caption[ETC]{\label{fig:org6e5a12b}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:orgc4e8e8c})
...
\label{sec:org217db16}
\begin{enumerate}
\item Barth
\label{sec:org7bf9222}
\begin{itemize}
...
\label{sec:orgd1d86b7}
\begin{enumerate}
\item Biochemistry
\label{sec:orgc18a9d6}
\begin{itemize}
...
\label{sec:org8a8a070}
\item Imaging
\label{sec:org70cb70c}
\begin{itemize}
...
\caption[rrf]{\label{fig:orgf92aee0}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:orgbc94862}
\begin{itemize}
...
\label{sec:org1eeec5f}
\subsection{Introduction}
\label{sec:orgaf245cb}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org6290d99}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:orge9539bb}
\begin{itemize}
...
\label{sec:org3294559}
\subsection{Introduction}
\label{sec:orge920dc8}
\begin{itemize}
...
\caption{\label{fig:orgdc98818}
Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org8a444e6}
\begin{itemize}
