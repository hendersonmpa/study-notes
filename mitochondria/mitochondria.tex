...
\label{sec:org3423bae}

\subsection{RedOx State}
\label{sec:org640863c}
\begin{itemize}
...
\label{sec:org28bf44d}
\subsection{Introduction}
\label{sec:org93104c9}
\begin{itemize}
...
\label{sec:org5dabe92}

\begin{itemize}
\item involves three processes (Figure \ref{fig:org0c55f92})
\begin{enumerate}
...
\caption{\label{fig:org679d381}
FA oxidation and ketone body metabolism}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org418688f}
...
\caption{\label{fig:orgfe9fcd6}
CPT1}
\end{figure}

\item Genetics
\label{sec:org782d818}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:orga4f67d5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3507d1f}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org7d0e54d}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:org39ac30c})
...
\caption{\label{fig:org39ac30c}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:orgd8bcace}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Testing
\label{sec:org9b39f3a}
\begin{itemize}
...
\label{sec:orgd41d137}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9008e85}
\begin{enumerate}
\item Neonatal
\label{sec:orgb415ecb}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:orgfe9fcd6})
\end{itemize}
\item Genetics
\label{sec:orgbce8f8f}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Testing
\label{sec:org8755f63}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:org75394f6}
\begin{enumerate}
\item Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency
\label{sec:org3327a4d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org44fb015}
\begin{enumerate}
\item Infancy
\label{sec:org81c876b}
\begin{itemize}
...
\caption{\label{fig:org7e1b6a2}
VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:orgd7b7116}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Testing
\label{sec:org3437c55}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org96a776e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0c1f977}
\begin{itemize}
...
\label{sec:org665ef56}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:orge554aa7}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:org70e7626}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge2c9cf9}
\begin{itemize}
...
(Figure \ref{fig:org52d47c0})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fao/figures/lchad.png}
\caption{\label{fig:org52d47c0}
LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:orgc0ab433}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:org51f2449}
\begin{itemize}
...
\label{sec:org70c43f2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org00040eb}
\begin{itemize}
...
\caption{\label{fig:orgeb85007}
Acyl-CoA Dehydrogenase Reaction}
\end{figure}

\item Genetics
\label{sec:org07123fe}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org5c9b313}
\begin{itemize}
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org0c18d74}
\subsection{Introduction}
\label{sec:org99fcd06}
\begin{itemize}
...
\caption[TCA]{\label{fig:org286e034}
...
\caption[pdhe1]{\label{fig:org2757ef5}
...
\caption[pdhc]{\label{fig:orgeea6ec8}
...
\item Treatment
\label{sec:orgdf5997e}
\begin{itemize}
\item early adoption of ketogenic diet may have a benefit
\item thiamine responsive forms
\item DCA is a pyruvate analog, inhibits E1 kinase, keeps E1 dephosphorylated (active) (Figure \ref{fig:org2757ef5})
\end{itemize}

\item Pyruvate Transport Defect
\label{sec:org06f84b4}
\begin{itemize}
...
\label{sec:orga671ab4}
\subsection{Introduction}
\label{sec:org83bbcfa}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgc9a8941}
Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\begin{enumerate}
\item Disorders of the TCA cycle
\label{sec:orgb6eae08}
...
mini-cycles (Figure \ref{fig:org88ace6d})
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3b276b6}
\begin{itemize}
\item similar to PDHC (section \ref{sec:org8ed5cbe})
...
\caption{\label{fig:org47f330b}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:orgcd68dfc}
\begin{itemize}
...
\caption{\label{fig:org2d8d341}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org416d676}
\begin{itemize}
...
\label{sec:org916388f}
\subsection{Introduction}
\label{sec:org39dc27c}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:org6d8dd0b})
...
\item 13 subunits of Complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:orgf6e26a9})
...
\caption[ETC]{\label{fig:org6d8dd0b}
...
\caption[redox]{\label{fig:org4043374}
Electron flow to O\(_{\text{2}}\) and release free energy}
\end{figure}

\begin{enumerate}
\item Complex I
\label{sec:orga597f5d}
\begin{itemize}
...
\caption[c1]{\label{fig:org8c97e6a}
Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:org816549c}
\begin{itemize}
...
\item Complex II
\label{sec:org8771414}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org6317eaa}
\end{itemize}
\end{itemize}

\begin{enumerate}
\item Inhibitors
\label{sec:org2223934}
\begin{itemize}
...
\caption[cIV]{\label{fig:orgdd8afc8}
...
\label{sec:org3a70205}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:orgaec55fd})
\begin{enumerate}
...
\caption[ETC]{\label{fig:orgaec55fd}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:org1056acc})
...
\label{sec:orgb0db407}
\begin{enumerate}
\item Barth
\label{sec:org04a8ec9}
\begin{itemize}
...
\label{sec:orgd269295}
\begin{enumerate}
\item Biochemistry
\label{sec:orgc4d345e}
\begin{itemize}
...
\label{sec:orgda5dc45}
\item Imaging
\label{sec:orgeddffc1}
\begin{itemize}
...
\caption[rrf]{\label{fig:orgab29ec8}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:orgccada5d}
\begin{itemize}
...
\label{sec:org849a117}
\subsection{Introduction}
\label{sec:org02d1c03}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:orgc716bd7}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org44e5469}
\begin{itemize}
...
\label{sec:orga19cd79}
\subsection{Introduction}
\label{sec:org3988b5f}
\begin{itemize}
...
\caption{\label{fig:org02b6078}
Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org7770052}
\begin{itemize}
