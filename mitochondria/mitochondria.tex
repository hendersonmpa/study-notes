...
\label{sec:org21e07c3}

\subsection{RedOx State}
\label{sec:org8270c19}
\begin{itemize}
...
\label{sec:org84faa95}
\subsection{Introduction}
\label{sec:org9efe773}
\begin{itemize}
...
\label{sec:org901532a}

\begin{itemize}
\item involves three processes (Figure \ref{fig:orgd78832d})
\begin{enumerate}
...
\caption{\label{fig:orgc29e597}
FA oxidation and ketone body metabolism}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org2c53ab9}
...
\caption{\label{fig:org5217910}
CPT1}
\end{figure}

\item Genetics
\label{sec:org577a515}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:orgfed7a9f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9713e83}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org0bee7a5}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:orgdd16390})
...
\caption{\label{fig:orgdd16390}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org6470e10}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Testing
\label{sec:org9136dac}
\begin{itemize}
...
\label{sec:org1c45a0e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge92c4d4}
\begin{enumerate}
\item Neonatal
\label{sec:org9365971}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:org5217910})
\end{itemize}
\item Genetics
\label{sec:org2bd8a4f}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Testing
\label{sec:org1c8ba82}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:org371cc9d}
\begin{enumerate}
\item Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency
\label{sec:org7b0a9d6}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org60c6b70}
\begin{enumerate}
\item Infancy
\label{sec:org17dcd03}
\begin{itemize}
...
\caption{\label{fig:org46db3d5}
VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:org2297e9a}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Testing
\label{sec:orgf2acb07}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:orgeb7447d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org118fce0}
\begin{itemize}
...
\label{sec:orgeb9920c}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:orga203796}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:org4592ed7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org782bda9}
\begin{itemize}
...
(Figure \ref{fig:orgd25e4d4})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fao/figures/lchad.png}
\caption{\label{fig:orgd25e4d4}
LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:org76e1f1f}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:org171aa7a}
\begin{itemize}
...
\label{sec:orgd4ad322}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org320ba82}
\begin{itemize}
...
\caption{\label{fig:orgc265993}
Acyl-CoA Dehydrogenase Reaction}
\end{figure}

\item Genetics
\label{sec:orgf3f413a}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org6391a72}
\begin{itemize}
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org32617a4}
\subsection{Introduction}
\label{sec:org39a7697}
\begin{itemize}
...
\caption[TCA]{\label{fig:org1c659e5}
...
\caption[pdhe1]{\label{fig:org6102b8f}
...
\caption[pdhc]{\label{fig:org9cefef4}
...
\item Treatment
\label{sec:orgb2bbd5a}
\begin{itemize}
\item early adoption of ketogenic diet may have a benefit
\item thiamine responsive forms
\item DCA is a pyruvate analog, inhibits E1 kinase, keeps E1 dephosphorylated (active) (Figure \ref{fig:org6102b8f})
\end{itemize}

\item Pyruvate Transport Defect
\label{sec:org151f276}
\begin{itemize}
...
\label{sec:orgd373a5d}
\subsection{Introduction}
\label{sec:orge00dfc1}
\begin{itemize}
...
\caption[TCA]{\label{fig:org143467b}
Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\begin{enumerate}
\item Disorders of the TCA cycle
\label{sec:orgb77e93e}
...
mini-cycles (Figure \ref{fig:org64b1da1})
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org601796a}
\begin{itemize}
\item similar to PDHC (section \ref{sec:org0e4d370})
...
\caption{\label{fig:org0c65db8}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org16580b6}
\begin{itemize}
...
\caption{\label{fig:org0c54d2c}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org5abcaf6}
\begin{itemize}
...
\label{sec:org10a066e}
\subsection{Introduction}
\label{sec:org3ed173a}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:orgafebb23})
...
\item 13 subunits of Complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:org8009b08})
...
\caption[ETC]{\label{fig:orgafebb23}
...
\caption[redox]{\label{fig:orgd43a56c}
Electron flow to O\(_{\text{2}}\) and release free energy}
\end{figure}

\begin{enumerate}
\item Complex I
\label{sec:org181d927}
\begin{itemize}
...
\caption[c1]{\label{fig:org44306fd}
Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:org809e911}
\begin{itemize}
...
\item Complex II
\label{sec:org7cb789d}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org6bb6abe}
\end{itemize}
\end{itemize}

\begin{enumerate}
\item Inhibitors
\label{sec:org1fa917e}
\begin{itemize}
...
\caption[cIV]{\label{fig:orgc0056f1}
...
\label{sec:org8e7e050}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:org6909847})
\begin{enumerate}
...
\caption[ETC]{\label{fig:org6909847}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:org78d9314})
...
\label{sec:orgcd87a0a}
\begin{enumerate}
\item Barth
\label{sec:org0187bc3}
\begin{itemize}
...
\label{sec:org655919c}
\begin{enumerate}
\item Biochemistry
\label{sec:orgd92073d}
\begin{itemize}
...
\label{sec:orgfa9a58f}
\item Imaging
\label{sec:org689ff67}
\begin{itemize}
...
\caption[rrf]{\label{fig:org21aa505}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:org41cdff4}
\begin{itemize}
...
\label{sec:org7fd1449}
\subsection{Introduction}
\label{sec:org3d92719}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:orgf6d8e74}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:orgb4a86f7}
\begin{itemize}
...
\label{sec:org824c90c}
\subsection{Introduction}
\label{sec:org47f65b3}
\begin{itemize}
...
\caption{\label{fig:orgd8df221}
Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org1d99901}
\begin{itemize}
