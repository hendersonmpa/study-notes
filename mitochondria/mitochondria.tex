...
\caption{\label{fig:orge6d20ec}
FA oxidation and ketone body metabolism}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org77c8897}
...
carnitine uptake (Figure \ref{fig:orgd909575})
\begin{itemize}
...
\caption{\label{fig:org873cbf9}
CPT1}
\end{figure}

\item Genetics
\label{sec:org02e891d}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:org6528e51}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org98a146e}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org9b349b4}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:org5650ee8})
...
\caption{\label{fig:org5650ee8}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org32211ae}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Testing
\label{sec:org184da90}
\begin{itemize}
...
\label{sec:org6378c5f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1f1d006}
\begin{enumerate}
\item Neonatal
\label{sec:org519e221}
\begin{itemize}
...
\item Genetics
\label{sec:org3834a54}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Testing
\label{sec:orgf3bed68}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org9719804}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb994ea1}
\begin{itemize}
...
\label{sec:org079856f}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:orgc19c54c}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:org3469bc8}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org167bbc5}
\begin{itemize}
...
\label{sec:orgd86d73a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org78ce9b7}
\begin{itemize}
...
\caption{\label{fig:org9871386}
Acyl-CoA Dehydrogenase Reaction}
\end{figure}

\item Genetics
\label{sec:org1bb34bb}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org02d40c0}
\begin{itemize}
\item \(\uparrow\) C8, C6,
\item \(\uparrow\) C8/C10
...
\caption[TCA]{\label{fig:org4a2a7f5}
Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\begin{enumerate}
\item Disorders of the TCA cycle
\label{sec:orgdba6326}
...
mini-cycles (Figure \ref{fig:org60b6b7f})
\begin{itemize}
...
\caption{\label{fig:orgad962de}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:orge64be91}
\begin{itemize}
...
\caption{\label{fig:org5445465}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org02a50c1}
\begin{itemize}
...
\caption[ETC]{\label{fig:org1d1b260}
...
\caption[redox]{\label{fig:orga235d87}
Electron flow to O\(_{\text{2}}\) and release free energy}
\end{figure}

\item Complex I
\label{sec:org262536e}
\begin{itemize}
...
\caption[c1]{\label{fig:org30a35ea}
Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:org6f079fe}
\begin{itemize}
...
\item Complex II
\label{sec:org19d74e6}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:orgf9ac64a}
\end{itemize}
\end{itemize}
...
\caption[rrf]{\label{fig:org296fe9e}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:orgae38e01}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org9a28107}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org9ed43a5}
\begin{itemize}
...
\caption{\label{fig:org8125af2}
Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org415d43a}
\begin{itemize}
