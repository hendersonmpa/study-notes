...
\label{sec:org6d27faa}

\subsection{RedOx State}
\label{sec:orgdfbdfe5}
\begin{itemize}
...
\label{sec:org590f875}
\subsection{Introduction}
\label{sec:org40f41bd}
\begin{itemize}
...
\label{sec:org2fee22b}

\begin{itemize}
\item involves three processes (Figure \ref{fig:orgaead276})
\begin{enumerate}
...
\caption{\label{fig:org2b4385b}
FA oxidation and ketone body metabolism}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org8f5f6d8}
...
\caption{\label{fig:org8d127eb}
CPT1}
\end{figure}

\item Genetics
\label{sec:org15d1453}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:org6113a6a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf042f51}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org078b1f2}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:org64f72d3})
...
\caption{\label{fig:org64f72d3}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:orgcb7db53}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Testing
\label{sec:org1c45250}
\begin{itemize}
...
\label{sec:org4f83beb}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org40ec766}
\begin{enumerate}
\item Neonatal
\label{sec:orgc1693ea}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:org8d127eb})
\end{itemize}
\item Genetics
\label{sec:org7cd7b96}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Testing
\label{sec:orgbd304ae}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:org61e6684}
\begin{enumerate}
\item Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency
\label{sec:org77225bb}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd94efc1}
\begin{enumerate}
\item Infancy
\label{sec:orgc137118}
\begin{itemize}
...
\caption{\label{fig:org877c9c7}
VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:org33bfc70}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Testing
\label{sec:org827ab0e}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org0b6efd7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1b33a7e}
\begin{itemize}
...
\label{sec:org34dce9a}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:orgc3153bf}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:orgf7779b3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org026cb97}
\begin{itemize}
...
(Figure \ref{fig:orga09f471})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fao/figures/lchad.png}
\caption{\label{fig:orga09f471}
LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:org25e7926}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:org9f480ed}
\begin{itemize}
...
\label{sec:orgd56f185}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org64647cb}
\begin{itemize}
...
\caption{\label{fig:org3f80f51}
Acyl-CoA Dehydrogenase Reaction}
\end{figure}

\item Genetics
\label{sec:orgefd601a}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:orgb556259}
\begin{itemize}
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org7980f3b}
\subsection{Introduction}
\label{sec:org752b20f}
\begin{itemize}
...
\caption[TCA]{\label{fig:org038f921}
...
\caption[TCA]{\label{fig:org4e0b3e2}
...
\caption[pdhe1]{\label{fig:org51c2910}
...
\caption[pdhc]{\label{fig:orgf14edfb}
...
\item Treatment
\label{sec:org9caa2df}
\begin{itemize}
\item early adoption of ketogenic diet may have a benefit
\item thiamine responsive forms
\item DCA is a pyruvate analog, inhibits E1 kinase, keeps E1 dephosphorylated (active) (Figure \ref{fig:org51c2910})
\end{itemize}

\item Pyruvate Transport Defect
\label{sec:org5dda2f4}
\begin{itemize}
...
\label{sec:org4832e03}
\subsection{Introduction}
\label{sec:org65de01d}
\begin{itemize}
...
\caption[TCA]{\label{fig:orged37daf}
Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\begin{enumerate}
\item Disorders of the TCA cycle
\label{sec:org0b75e84}
...
mini-cycles (Figure \ref{fig:org16a999e})
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgaa64a3e}
\begin{itemize}
\item similar to PDHC (section \ref{sec:orga921405})
...
\caption{\label{fig:org5209021}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:orge5cf0b8}
\begin{itemize}
...
\caption{\label{fig:orgd2df3ed}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:orga3145ec}
\begin{itemize}
...
\label{sec:org081757c}
\subsection{Introduction}
\label{sec:org730974d}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:orge6aba33})
...
\item 13 subunits of Complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:org42d5a8c})
...
\caption[ETC]{\label{fig:orge6aba33}
...
\caption[redox]{\label{fig:org3fb3476}
Electron flow to O\(_{\text{2}}\) and release free energy}
\end{figure}

\begin{enumerate}
\item Complex I
\label{sec:org81cb98e}
\begin{itemize}
...
\caption[c1]{\label{fig:org73fcf43}
Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\item Complex II
\label{sec:orgcf34a4b}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:orgc85d66a}
\end{itemize}
\end{itemize}

\item Glycerol-3-phosphate shuttle
\label{sec:org597b3c2}
\begin{itemize}
...
\caption[cIV]{\label{fig:orgd2da1cd}
Complex IV | Cytochrome c oxidase}
\end{figure}
\end{itemize}

\item Complex V
\label{sec:org0569841}
\begin{itemize}
...
\label{sec:org0a296dd}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:org9a1a6b3})
\begin{enumerate}
...
\caption[ETC]{\label{fig:org9a1a6b3}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:orgdfee797})
...
\label{sec:orgd574cdd}
\begin{enumerate}
\item Barth
\label{sec:org199e529}
\begin{itemize}
...
\label{sec:orgac24302}
\begin{itemize}
\item interpretation
\begin{itemize}
\item i.e normal CII in mtDNA depletion
\end{itemize}
\end{itemize}

\item Imaging
\label{sec:org6bef5d3}
\begin{itemize}
...
\caption[rrf]{\label{fig:org323d691}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:org5ad1b78}
\begin{itemize}
...
\label{sec:orgd15f0cf}
\subsection{Introduction}
\label{sec:org93e56be}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org0631c2d}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org31bdcba}
\begin{itemize}
...
\label{sec:orge85f8d7}
\subsection{Introduction}
\label{sec:org15a5696}
\begin{itemize}
...
\caption{\label{fig:org0a620eb}
Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org67aa485}
\begin{itemize}
