...
\label{sec:orgf29200c}
\subsection{Background}
\label{sec:orgf5630e8}
\begin{enumerate}
\item Maternal Inheritance
\label{sec:orgbe14a28}
\begin{itemize}
...
\caption[heter]{\label{fig:org30bef7b}
Heteroplasmy}
\end{figure}

\item Muller's Ratchet and the Mitochondrial Bottleneck
\label{sec:org90f41e0}
\begin{itemize}
...
\caption[bottle]{\label{fig:orgceb9bbe}
Mitochondrial bottle neck}
\end{figure}

\item Fusion
\label{sec:orgaf955bf}
\begin{itemize}
...
\caption[mtdna]{\label{fig:org8d42ab7}
Human mitochondrial genome}
\end{figure}

\item Alternative genetic code
\label{sec:org2830501}
\begin{itemize}
...
\begin{table}[htbp]
\caption[mito code]{\label{tab:org807a92a}
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org530524b}
\subsection{Introduction}
\label{sec:org965529f}
\begin{enumerate}
\item Disorders of Pyruvate Metabolism
\label{sec:org6f84b8e}
...
\caption[TCA]{\label{fig:org358abda}
Disorders of Pyruvate Metabolism}
\end{figure}

\begin{enumerate}
\item Pyruvate Reactions
\label{sec:org320b215}
...
\label{sec:org7103152}
\begin{enumerate}
\item Pyruvate Dehydrogenase Complex
\label{sec:org970e58d}
\begin{itemize}
...
\caption[pdhe1]{\label{fig:org99566ca}
...
\caption[pdhc]{\label{fig:org42c99cc}
Pyruvate Dehydrogenase Complex}
\end{figure}

\item Pyruvate Dehydrogenase Complex Deficiency
\label{sec:org03f49a7}
\begin{itemize}
...
\item Treatment
\label{sec:org466ccc0}
\begin{itemize}
\item Early adoption of ketogenic diet may have a benefit
\item Thiamine responsive forms
\item DCA is a pyruvate analog, inhibits E1 kinase, keeps E1 dephosphorylated (active) (Figure \ref{fig:org99566ca})
\end{itemize}

\item Pyruvate Transport Defect
\label{sec:org96b74ec}
\begin{itemize}
...
\label{sec:orge7a679c}
\begin{enumerate}
\item Dihydrolipoamide Dehydrogenase
\label{sec:org219e37c}
\begin{itemize}
...
\label{sec:org145a2fc}
\subsection{Introduction}
\label{sec:org7a5ebf1}
\begin{itemize}
...
mini-cycles (Figure \ref{fig:orgd4798cb})
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc4fb478}
\begin{itemize}
\item Similar to PDHC (section \ref{sec:org7103152})
...
\caption{\label{fig:org399a23a}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org781b056}
\begin{itemize}
...
\caption{\label{fig:orgb8320e7}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org404adaa}
\begin{itemize}
...
\label{sec:org2d2a542}
\subsection{Introduction}
\label{sec:orgbd5ce0e}
\begin{enumerate}
\item ETC and OxPhos system
\label{sec:orgec0474f}
\begin{itemize}
...
\caption[ETC]{\label{fig:orge307401}
...
\caption[c1]{\label{fig:org86b428e}
Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\item Complex I Inhibitors
\label{sec:org890551f}
\begin{itemize}
...
\label{sec:org49c54ad}
\begin{enumerate}
\item Complex II | Succinate Dehydrogenase
\label{sec:orgf28d3b2}
\begin{itemize}
\item see section \ref{sec:orgfe836bd}
\end{itemize}

\item Complex II Inhibitors
\label{sec:orgaf8a9ca}
\begin{itemize}
...
\label{sec:orgb10176b}
\begin{enumerate}
\item Complex IV | Cytochrome c oxidase
\label{sec:org9178af0}
...
\caption[cIV]{\label{fig:org0d28c97}
Complex IV | Cytochrome c oxidase}
\end{figure}

\item Complex IV | Inhibitors
\label{sec:orgad4b00f}
\begin{itemize}
...
\label{sec:org011ab69}
\begin{enumerate}
\item Complex V | ATP synthase
\label{sec:org99facc1}
...
\caption{\label{fig:orgc1c0c50}
Complex V | ATP synthase}
\end{figure}

\item Complex V Inhibitors
\label{sec:org8995053}
\begin{itemize}
...
\label{sec:org8c45f7b}
\subsection{Introduction}
\label{sec:org19af91d}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:orge307401}).
...
\label{sec:org68fd8d4}
\begin{enumerate}
\item Neonatal and Infantile Presentation
\label{sec:orge6a6da7}
\begin{itemize}
...
\label{sec:org0a164ac}
\begin{enumerate}
\item Biochemistry
\label{sec:org9be05bb}
\begin{itemize}
...
\caption[rrf]{\label{fig:org57ee7b4}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:org5cc0e3a}
\begin{itemize}
...
\label{sec:org9aaa646}
\subsection{Introduction}
\label{sec:org85ccd64}
\begin{itemize}
...
\label{sec:org542cf06}

\begin{itemize}
\item involves three processes (Figure \ref{fig:org325c672})
\begin{enumerate}
...
\caption{\label{fig:org2f03cba}
FA oxidation and ketone body metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org605d283}
...
\caption{\label{fig:orgc6e41dc}
CPT1}
\end{figure}

\item Genetics
\label{sec:orga2aa93c}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:org0ee5da9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org60ba170}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org5f524f6}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:org347f733})
...
\caption{\label{fig:org347f733}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:orgf878a2a}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Testing
\label{sec:orga71c44b}
\begin{itemize}
...
\label{sec:org40f9d04}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgbaae437}
\begin{enumerate}
\item Neonatal
\label{sec:orgabbf254}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:orgc6e41dc})
\end{itemize}
\item Genetics
\label{sec:org1b30db7}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Testing
\label{sec:org9e6e131}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:orgb241a0a}
\begin{enumerate}
\item Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency
\label{sec:orgd21d793}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf8cfc06}
\begin{enumerate}
\item Infancy
\label{sec:org652afd9}
\begin{itemize}
...
\caption{\label{fig:org4ac7045}
VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:org2e59017}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Testing
\label{sec:orgdcae7f6}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org035de92}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0b41e00}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org5f7fb53}
\begin{itemize}
\item see \ref{sec:orgb8e59fb}
\end{itemize}

\item Treatment
\label{sec:org7e46344}
\begin{itemize}
\item see \ref{sec:orgb8e59fb}
\end{itemize}
\end{enumerate}
...
\label{sec:orgb8e59fb}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgfbc925a}
\begin{itemize}
...
(Figure \ref{fig:org6c6b796})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fao/figures/lchad.png}
\caption{\label{fig:org6c6b796}
LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:orgc15c6bc}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:org46ba21a}
\begin{itemize}
...
\label{sec:org9da755e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org25c8422}
\begin{itemize}
...
\caption{\label{fig:orgfdbbf3e}
Acyl-CoA Dehydrogenase Reaction}
\end{figure}

\item Genetics
\label{sec:org9ac23ad}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:orgf8d7638}
\begin{itemize}
\item \(\uparrow\) C8, C6,
\item \(\uparrow\) C8/C10
...
\label{sec:org90413c8}
\subsection{Introduction}
\label{sec:orgf452d49}
...
\item Diagnostic Tests
\label{sec:org87a00a2}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org940b3fa}
\begin{itemize}
...
\label{sec:org3aea82e}
\subsection{Introduction}
\label{sec:orgac985c3}
\begin{itemize}
