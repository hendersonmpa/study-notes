...
\label{sec:org6693a8c}

\subsection{RedOx State}
\label{sec:org6e4fd9a}
\begin{itemize}
...
\label{sec:org01da337}
\subsection{Introduction}
\label{sec:orgb1dc0e4}
\begin{itemize}
...
\label{sec:org2842165}

\begin{itemize}
\item involves three processes (Figure \ref{fig:org7b3649a})
\begin{enumerate}
...
\caption{\label{fig:orgf20c081}
FA oxidation and ketone body metabolism}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org30bfaac}
...
\caption{\label{fig:org29b1468}
CPT1}
\end{figure}

\item Genetics
\label{sec:org78d6146}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:org5d7e952}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8d6ccaa}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org6d59349}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:org1fac8e3})
...
\caption{\label{fig:org1fac8e3}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:orgd506438}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Testing
\label{sec:org3d37141}
\begin{itemize}
...
\label{sec:orgb7e248f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgce6fe6a}
\begin{enumerate}
\item Neonatal
\label{sec:org354befb}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:org29b1468})
\end{itemize}
\item Genetics
\label{sec:orgdc76a93}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Testing
\label{sec:org61f35c6}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:org41fddad}
\begin{enumerate}
\item Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency
\label{sec:orgcb3308e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8f7022c}
\begin{enumerate}
\item Infancy
\label{sec:org698a4e2}
\begin{itemize}
...
\caption{\label{fig:orgd7e7a89}
VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:org63de511}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Testing
\label{sec:org962a9bb}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:orgecedbee}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9a3880b}
\begin{itemize}
...
\label{sec:orgf8fe82a}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:orgcda61ba}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:org65103cb}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org64d1127}
\begin{itemize}
...
(Figure \ref{fig:org6057af8})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fao/figures/lchad.png}
\caption{\label{fig:org6057af8}
LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:orge434ad0}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd7cc414}
\begin{itemize}
...
\label{sec:org5cdcaa2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgdd54fe9}
\begin{itemize}
...
\caption{\label{fig:orgfebd10f}
Acyl-CoA Dehydrogenase Reaction}
\end{figure}

\item Genetics
\label{sec:orgb5a92f7}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:orgc95997a}
\begin{itemize}
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org908ad46}
\subsection{Introduction}
\label{sec:org868d13f}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgba3365d}
...
\label{sec:org55d6ff9}
\begin{enumerate}
\item Pyruvate Dehydrogenase Complex
\label{sec:orge9254ea}
\begin{itemize}
...
\caption[pdhe1]{\label{fig:org3a00f50}
...
\caption[pdhc]{\label{fig:orgacb0449}
Pyruvate Dehydrogenase Complex}
\end{figure}

\item Pyruvate Dehydrogenase Complex Deficiency
\label{sec:org6d54b38}
\begin{itemize}
...
\item Treatment
\label{sec:orgada3108}
\begin{itemize}
\item early adoption of ketogenic diet may have a benefit
\item thiamine responsive forms
\item DCA is a pyruvate analog, inhibits E1 kinase, keeps E1 dephosphorylated (active) (Figure \ref{fig:org3a00f50})
\end{itemize}

\item Pyruvate Transport Defect
\label{sec:org3938560}
\begin{itemize}
...
\label{sec:orgb529e6e}
\begin{enumerate}
\item Dihydrolipoamide Dehydrogenase
\label{sec:orge44311a}
\begin{itemize}
...
\label{sec:orgc70458b}
\subsection{Introduction}
\label{sec:org1d50487}
\begin{itemize}
...
\caption[TCA]{\label{fig:org82e0be6}
Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\begin{enumerate}
\item Disorders of the TCA cycle
\label{sec:org5caa22f}
...
mini-cycles (Figure \ref{fig:orgefc8f0c})
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb539298}
\begin{itemize}
\item similar to PDHC (section \ref{sec:org55d6ff9})
...
\caption{\label{fig:org09d78fa}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org69d0ef9}
\begin{itemize}
...
\caption{\label{fig:org8c3d504}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org6b27cf8}
\begin{itemize}
...
\label{sec:org44c9ff9}
\subsection{Introduction}
\label{sec:org1022bac}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:org1bf53fa})
...
\caption[ETC]{\label{fig:org1bf53fa}
...
\caption[redox]{\label{fig:org71667fe}
Electron flow to O\(_{\text{2}}\) and release free energy}
\end{figure}

\item Complex I
\label{sec:org0c2dba2}
\begin{itemize}
...
\caption[c1]{\label{fig:org6613413}
Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:orgc016485}
\begin{itemize}
...
\item Complex II
\label{sec:org00b36a1}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org0a050fd}
\end{itemize}
\end{itemize}

\begin{enumerate}
\item Inhibitors
\label{sec:org7246ede}
\begin{itemize}
...
\caption[cIV]{\label{fig:org8be0373}
...
\label{sec:org258438b}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:orgb4fb3a8})
\begin{enumerate}
...
\item Clinical Presentation
\label{sec:org0c31b42}
\begin{enumerate}
\item Neonatal and Infantile Presentation
\label{sec:org0bca598}
\begin{itemize}
...
\end{enumerate}
\item Investigations
\label{sec:orgf526afe}
\begin{enumerate}
\item Biochemistry
\label{sec:org9a4d4da}
\begin{itemize}
...
\caption[rrf]{\label{fig:org0735961}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:orgd47a60f}
\begin{itemize}
...
\label{sec:org63fdc85}
\subsection{Introduction}
\label{sec:org220260b}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org84729f9}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org22f48ca}
\begin{itemize}
...
\label{sec:orgb3518f3}
\subsection{Introduction}
\label{sec:orgba37999}
\begin{itemize}
...
\caption{\label{fig:org52fb72f}
Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org051f11e}
\begin{itemize}
