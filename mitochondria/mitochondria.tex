...
\label{sec:org34e3f5d}

\subsection{RedOx State}
\label{sec:org6ffc9aa}
\begin{itemize}
...
\label{sec:org787a6f6}
\subsection{Introduction}
\label{sec:org068a29e}
\begin{itemize}
...
\label{sec:org2beec0e}

\begin{itemize}
\item involves three processes (Figure \ref{fig:org143da2e})
\begin{enumerate}
...
\caption{\label{fig:org3f23909}
FA oxidation and ketone body metabolism}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org63f41e2}
...
\caption{\label{fig:orgcb32bb5}
CPT1}
\end{figure}

\item Genetics
\label{sec:org0b15500}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:orgb250a9f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga943664}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:orgfaa8e5a}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:org9862fd9})
...
\caption{\label{fig:org9862fd9}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org07cb8ab}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Testing
\label{sec:org422a684}
\begin{itemize}
...
\label{sec:orgf1d85cf}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc6a482d}
\begin{enumerate}
\item Neonatal
\label{sec:org3d5ba78}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:orgcb32bb5})
\end{itemize}
\item Genetics
\label{sec:org7a763d2}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Testing
\label{sec:orgb469e21}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:orgf6e371c}
\begin{enumerate}
\item Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency
\label{sec:org754edf9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org12dee4a}
\begin{enumerate}
\item Infancy
\label{sec:orgb546ad9}
\begin{itemize}
...
\caption{\label{fig:org70a85a4}
VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:orgc347183}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Testing
\label{sec:orgb493083}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org3a63fe9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org29a9cd6}
\begin{itemize}
...
\label{sec:org4c2b396}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:org439bce4}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:org79bd52b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd517c98}
\begin{itemize}
...
(Figure \ref{fig:orgfe5e80a})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fao/figures/lchad.png}
\caption{\label{fig:orgfe5e80a}
LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:orga315a56}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:orgdd3235f}
\begin{itemize}
...
\label{sec:org33efa59}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgbad687c}
\begin{itemize}
...
\caption{\label{fig:org485d402}
Acyl-CoA Dehydrogenase Reaction}
\end{figure}

\item Genetics
\label{sec:org8a4f544}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org91a739b}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgeaf8d6e}
...
\caption[pdhe1]{\label{fig:orge823819}
...
\caption[pdhc]{\label{fig:orgf31c1f5}
...
\item Treatment
\label{sec:org48fb3b5}
\begin{itemize}
\item early adoption of ketogenic diet may have a benefit
\item thiamine responsive forms
\item DCA is a pyruvate analog, inhibits E1 kinase, keeps E1 dephosphorylated (active) (Figure \ref{fig:orge823819})
\end{itemize}

\item Pyruvate Transport Defect
\label{sec:orgde969cc}
\begin{itemize}
...
\label{sec:org0853996}
\subsection{Introduction}
\label{sec:org7b32c16}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgee1e8e0}
Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\begin{enumerate}
\item Disorders of the TCA cycle
\label{sec:orgc72c771}
...
mini-cycles (Figure \ref{fig:orgbf3a182})
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc66c92e}
\begin{itemize}
\item similar to PDHC (section \ref{sec:org2fc56b0})
...
\caption{\label{fig:org406fa0e}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:orgbca0450}
\begin{itemize}
...
\caption{\label{fig:orge370ec4}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org1ddba6f}
\begin{itemize}
...
\label{sec:org940c830}
\subsection{Introduction}
\label{sec:org8ee7695}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:orgced5ca7})
...
\caption[ETC]{\label{fig:orgced5ca7}
...
\caption[redox]{\label{fig:orgc0df28b}
Electron flow to O\(_{\text{2}}\) and release free energy}
\end{figure}

\item Complex I
\label{sec:org9ae4e70}
\begin{itemize}
...
\caption[c1]{\label{fig:org656a426}
Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:org0d7ca91}
\begin{itemize}
...
\item Complex II
\label{sec:org929dd74}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org63dc530}
\end{itemize}
\end{itemize}

\begin{enumerate}
\item Inhibitors
\label{sec:org19efc98}
\begin{itemize}
...
\caption[cIV]{\label{fig:org82d7642}
...
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:org558da3a})
\begin{enumerate}
...
\caption[ETC]{\label{fig:org558da3a}
...
\item Clinical Presentation
\label{sec:org9b946fd}
\begin{enumerate}
\item Neonatal and Infantile Presentation
\label{sec:org2efa130}
\begin{itemize}
...
\end{enumerate}
\item Investigations
\label{sec:org5dfc953}
\begin{enumerate}
\item Biochemistry
\label{sec:org151318c}
\begin{itemize}
...
\item \uparrown ala/lys \textgreater{} 3:1
...
\caption[rrf]{\label{fig:org4bc4e57}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:org0e67da7}
\begin{itemize}
...
\label{sec:org7cbc454}
\subsection{Introduction}
\label{sec:org16792c3}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org88be6dd}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:orgb1a5c4b}
\begin{itemize}
...
\label{sec:org20f0855}
\subsection{Introduction}
\label{sec:org541f4df}
\begin{itemize}
...
\caption{\label{fig:orgb2c022d}
Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:orgf7e957e}
\begin{itemize}
