...
\label{sec:orgbc2bd21}
\subsection{Introduction}
\label{sec:org2a0a3c1}
\begin{itemize}
...
\label{sec:org0e76ba0}
\begin{enumerate}
\item Complex IV | Cytochrome c oxidase
\label{sec:org74dc344}
...
\caption[cIV]{\label{fig:org9018c55}
Complex IV | Cytochrome c oxidase}
\end{figure}

\item Complex IV | Inhibitors
\label{sec:orgeb50042}
\begin{itemize}
...
\caption[rrf]{\label{fig:org14a845a}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:org141e186}
\begin{itemize}
...
\label{sec:org2ff8f11}
\subsection{Introduction}
\label{sec:org8e77978}
