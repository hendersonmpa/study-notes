...
\label{sec:orga392b08}

\subsection{RedOx State}
\label{sec:org220d52c}
\begin{itemize}
...
\subsection{TCA}
\label{sec:orgd97e0aa}
\begin{description}
\item[{Net reaction}] Acetyl-CoA oxidized to 2CO\(_{\text{2}}\)
\end{description}
{\small\ce{Acetyl-CoA + 3NAD+ + FAD + GDP + Pi + 2H2O -> 2CO2 + CoA + 3NADH + FADH2 + GTP + 2H+}}

\subsection{ETC}
\label{sec:org09cd8e5}
\begin{description}
...
\label{sec:org5b841cf}
\subsection{Introduction}
\label{sec:orge59d49c}
\begin{itemize}
...
\label{sec:org39f0d9f}

\begin{itemize}
\item involves three processes (Figure \ref{fig:org1b1fe35})
\begin{enumerate}
...
\caption{\label{fig:org1ea046b}
FA oxidation and ketone body metabolism}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orgdbef3f5}
...
\caption{\label{fig:org6573112}
CPT1}
\end{figure}

\item Genetics
\label{sec:org8aa19df}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:org3752c93}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org958a9ed}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org88a8297}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:orgc9ab2b6})
...
\caption{\label{fig:orgc9ab2b6}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:orgafb1a9d}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Testing
\label{sec:orge6e7556}
\begin{itemize}
...
\label{sec:orgec98085}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org551324e}
\begin{enumerate}
\item Neonatal
\label{sec:orge27fa6b}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:org6573112})
\end{itemize}
\item Genetics
\label{sec:org1b827e5}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Testing
\label{sec:org4f65bcb}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:orgd994b5c}
\begin{enumerate}
\item Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency
\label{sec:orga17b3c6}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org7e5f202}
\begin{enumerate}
\item Infancy
\label{sec:org2da1800}
\begin{itemize}
...
\caption{\label{fig:orgc11a2ea}
VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:orga4bff72}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Testing
\label{sec:org2bd3003}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org79f2a79}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5cf0540}
\begin{itemize}
...
\label{sec:org6f110e4}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:orga0ecb8c}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:org0099f68}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga6c800c}
\begin{itemize}
...
(Figure \ref{fig:org03bd4a6})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fao/figures/lchad.png}
\caption{\label{fig:org03bd4a6}
LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:orge39ab8f}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:orgde93c7d}
\begin{itemize}
...
\label{sec:org9f7db9a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1358ea8}
\begin{itemize}
...
\caption{\label{fig:org01c7cf1}
Acyl-CoA Dehydrogenase Reaction}
\end{figure}

\item Genetics
\label{sec:org4a8c941}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org6086b58}
\begin{itemize}
...
\end{enumerate}
\section{Pyruvate}
\label{sec:orge2dd25f}
\subsection{Introduction}
\label{sec:orgad738e1}
\begin{itemize}
...
\caption[TCA]{\label{fig:org80b7860}
...
\label{sec:org5395e58}
\begin{enumerate}
\item Pyruvate Dehydrogenase Complex
\label{sec:org5064bea}
\begin{itemize}
...
\caption[pdhe1]{\label{fig:orgfcfa12d}
...
\caption[pdhc]{\label{fig:org3d329ab}
Pyruvate Dehydrogenase Complex}
\end{figure}

\item Pyruvate Dehydrogenase Complex Deficiency
\label{sec:orgcde26f0}
\begin{itemize}
...
\item Treatment
\label{sec:orgc8a1428}
\begin{itemize}
\item early adoption of ketogenic diet may have a benefit
\item thiamine responsive forms
\item DCA is a pyruvate analog, inhibits E1 kinase, keeps E1 dephosphorylated (active) (Figure \ref{fig:orgfcfa12d})
\end{itemize}

\item Pyruvate Transport Defect
\label{sec:org9afb56f}
\begin{itemize}
...
\label{sec:org322a8ac}
\begin{enumerate}
\item Dihydrolipoamide Dehydrogenase
\label{sec:orgb71ac73}
\begin{itemize}
...
\label{sec:org5860324}
\subsection{Introduction}
\label{sec:org4e6a413}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgf7ab000}
Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\begin{enumerate}
\item Disorders of the TCA cycle
\label{sec:orgac68ff2}
...
mini-cycles (Figure \ref{fig:org7f9d02b})
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgdac1287}
\begin{itemize}
\item similar to PDHC (section \ref{sec:org5395e58})
...
\caption{\label{fig:org1d74852}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org6f97df1}
\begin{itemize}
...
\caption{\label{fig:org0281b79}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org334a8a8}
\begin{itemize}
...
\label{sec:orga8a760c}
\subsection{Introduction}
\label{sec:orgb6181d4}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:orgcefd799})
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./etc/figures/Slide14.png}
\caption[ETC]{\label{fig:orgcefd799}
...
\caption[redox]{\label{fig:org2beb144}
Electron flow to O\(_{\text{2}}\) and release free energy}
\end{figure}

\item Complex I
\label{sec:org78712a6}
\begin{itemize}
...
\caption[c1]{\label{fig:org84f488d}
Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:orgf9ddf33}
\begin{itemize}
...
\item Complex II
\label{sec:orgafbf3e6}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:orgd04cb23}
\end{itemize}
\end{itemize}

\begin{enumerate}
\item Inhibitors
\label{sec:org605ddf7}
\begin{itemize}
...
\caption[cIV]{\label{fig:org23098b2}
...
\label{sec:orgb8fea0d}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:org2404410})
\begin{enumerate}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./etc/figures/Slide15.png}
\caption[ETC]{\label{fig:org2404410}
Pathogenesis of OxPhos Disorders}
\end{figure}

\begin{enumerate}
\item Clinical Manifestations
\label{sec:org12e7662}
\begin{itemize}
...
\item Clinical Presentation
\label{sec:org19a1b4c}
\begin{enumerate}
\item Neonatal and Infantile Presentation
\label{sec:orgd19d4a2}
\begin{itemize}
...
\end{enumerate}
\item Investigations
\label{sec:org68c6fdb}
\begin{enumerate}
\item Biochemistry
\label{sec:orgf898f07}
\begin{itemize}
...
\caption[rrf]{\label{fig:orgf1d0fb4}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:orgf8be9c9}
\begin{itemize}
...
\label{sec:org4886b4b}
\subsection{Introduction}
\label{sec:orgea80e09}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org786bd55}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:orgd9c8b58}
\begin{itemize}
...
\label{sec:org7f06690}
\subsection{Introduction}
\label{sec:org9a45acd}
\begin{itemize}
...
\caption{\label{fig:orgf212aad}
Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:orgf280250}
\begin{itemize}
