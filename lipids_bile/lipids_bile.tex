...
\label{sec:orgf039954}
\subsection{Introduction}
\label{sec:org2ded911}
\begin{itemize}
...
\caption{\label{fig:org0ba19b0}
Lipid and Lipoprotein Metabolism}
\end{figure}
\end{enumerate}

\subsection{LDL Metabolism Disorders}
\label{sec:orgdc25ef4}
\begin{itemize}
...
\label{sec:org9f2fb27}
\subsection{Introduction}
\label{sec:orgbd81b56}
\begin{itemize}
...
\label{sec:orgb305e88}
\begin{itemize}
\item mevalonate kinase deficiency (Figure \ref{fig:org1ad129d})
\end{itemize}
...
\label{sec:org1d580b5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2082d62}
\begin{itemize}
...
\label{sec:org2818a0d}
\subsection{Introduction}
\label{sec:orgcec34d8}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org8d0f883}
\begin{itemize}
\item 3\(\beta\)-dehydrogenase catalyses the second reaction in the major
pathway of synthesis of bile acid (Figure \ref{fig:orgcbfe62c},enyzyme 2)
...
\item Genetics
\label{sec:orga2b557d}
\begin{itemize}
\item AR, HSD3B7
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf2f5a8c}
\begin{itemize}
...
\label{sec:orgde43849}
\begin{itemize}
\item 5\(\beta\)-reductase deficiency (Figure \ref{fig:orgcbfe62c}, enzyme 3)
...
\label{sec:org8a0036b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga7b8ff7}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org015047e}
\begin{itemize}
\item sterol 27-hydroxylase deficiency (Figure \ref{fig:orgcbfe62c}, enzyme 4)
...
7\(\alpha\)-hydroxylase by bile acids is disrupted (Figure \ref{fig:orgcbfe62c}, enzyme 1)
\end{itemize}
...
\item Genetics
\label{sec:org5e1796a}
\begin{itemize}
\item AR, CYP27A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org716927c}
\begin{itemize}
\item molecular
\end{itemize}
\begin{enumerate}
\item Plasma
\label{sec:org6250f99}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:orgf5da4cb}
\begin{itemize}
\item \(\alpha\)-methylacyl-CoA racemase deficiency (Figure \ref{fig:orgcbfe62c}, enzyme 5)
...
\item Genetics
\label{sec:org6d45c9c}
\begin{itemize}
\item AR, AMACR
\end{itemize}

\item Diagnostic Tests
\label{sec:org5cbfa73}
\begin{itemize}
...
\label{sec:orgb861db4}
\subsection{Introduction}
\label{sec:orgc8777b5}
\begin{itemize}
...
(Figure \ref{fig:org1d1d516} steps 1,2 and 3)
\item four are proteins of the mitochondrial membrane (Figure
\ref{fig:org1d1d516} steps 4, 5 and 6)
\end{itemize}
