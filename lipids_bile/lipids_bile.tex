...
\label{sec:orgc138bc3}
\subsection{Introduction}
\label{sec:orgb655b9d}
\begin{itemize}
...
\caption{\label{fig:org3a8efdc}Lipid and Lipoprotein Metabolism}
\end{figure}
\end{enumerate}

\subsection{LDL Metabolism}
\label{sec:org42f94d6}
\begin{itemize}
...
\end{enumerate}
\item see table \ref{tab:org69368f4}
...
\begin{table}[htbp]
\caption{\label{tab:org69368f4}Selected Disorders Affecting Low Density Lipoprotein Metabolism}
\centering
\begin{tabular}{lllll}
...
\label{sec:orgc2e1a78}
\subsection{Introduction}
\label{sec:orge7431fa}
\begin{itemize}
...
\end{itemize}
\item isoprenoid synthesis starts from acetyl-CoA (Figures \ref{fig:orga99f18a})
\begin{itemize}
...
\item lanosterol \(\to\) cholesterol occurs via two routes (Figures \ref{fig:org10d37ed})
\begin{itemize}
...
\caption{\label{fig:org10d37ed}Isoprenoid/Cholesterol Synthesis Pathway}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{iso_chol/figures/Slide18.png}
\caption{\label{fig:orga99f18a}Isoprenoid/Cholesterol Synthesis Pathway}
\end{figure}

\subsection{Mevalonate Kinase Deficiency}
\label{sec:orge7e2af3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf7291fe}
\begin{itemize}
...
\label{sec:orgdd4af75}
\begin{itemize}
\item \textbf{mevalonate kinase} deficiency (Figure \ref{fig:orga99f18a})
\end{itemize}
...
\label{sec:org0910895}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga4c3687}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org94d7a40}
\begin{itemize}
\item \textbf{7-dehydrocholesterol reductase} deficiency (Figure \ref{fig:orga99f18a})
\begin{itemize}
...
\label{sec:org9b4090e}
\subsection{Introduction}
\label{sec:org1126654}
\begin{itemize}
...
\end{itemize}
\item synthesis can occur by a number of pathways (Figure \ref{fig:orgd9546db})
\begin{itemize}
...
\caption{\label{fig:orgd9546db}Synthesis of Bile Acids from Cholesterol}
\end{figure}

\subsection{3\(\beta\)-Dehydrogenase Deficiency}
\label{sec:orgb2ec4fb}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org11d3ae5}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org9bc1408}
\begin{itemize}
\item 3\(\beta\)-dehydrogenase catalyses the second reaction in the major
pathway of synthesis of bile acid (Figure \ref{fig:orgd9546db}, enzyme 2)
...
\item Genetics
\label{sec:orgc6e2575}
\begin{itemize}
\item AR HSD3B7
\end{itemize}

\item Diagnostic Tests
\label{sec:orgb13311a}
\begin{itemize}
...
\label{sec:org8f95b4f}
\begin{itemize}
\item 5\(\beta\)-reductase deficiency (Figure \ref{fig:orgd9546db}, enzyme 3)
...
\label{sec:org306d9a9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge5bd77c}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org1ad0eee}
\begin{itemize}
\item sterol 27-hydroxylase deficiency (Figure \ref{fig:orgd9546db}, enzyme 4)
...
7\(\alpha\)-hydroxylase by bile acids is disrupted (Figure \ref{fig:orgd9546db}, enzyme 1)
\end{itemize}
...
\item Genetics
\label{sec:org61f3760}
\begin{itemize}
\item AR CYP27A1
\end{itemize}
\item Diagnostic Tests
\label{sec:orgc80abea}
\begin{itemize}
\item molecular
\end{itemize}
\begin{enumerate}
\item Plasma
\label{sec:org8c7b989}
\begin{itemize}
...
\label{sec:org32c71f0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb4df511}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:orgb291353}
\begin{itemize}
\item \(\alpha\)-methylacyl-CoA racemase deficiency (Figure \ref{fig:orgd9546db}, enzyme 5)
...
\item Genetics
\label{sec:org0877c63}
\begin{itemize}
\item AR AMACR
\end{itemize}
\item Diagnostic Tests
\label{sec:orgcbd5ed0}
\begin{itemize}
...
\label{sec:orgb277aa6}
\subsection{Introduction}
\label{sec:org3047af0}
\begin{itemize}
...
\item the first steps of TG and of PL synthesis are the same (Figure \ref{fig:org96f5344})
...
\caption{\label{fig:org96f5344}Triglyceride Synthesis and Lipolysis}
\end{figure}

\subsection{Common Pathway}
\label{sec:org0b713df}
\begin{enumerate}
\item Lipin-1 Deficiency
\label{sec:orgf92ac61}
\begin{itemize}
...
\caption{\label{fig:orgf0f0787}Phospholipid Biosynthesis and Remodelling}
\end{figure}
\end{itemize}

\begin{enumerate}
\item Inborn Errors of Phospholipid Biosynthesis
\label{sec:org12e4c24}
\begin{itemize}
...
(Figure \ref{fig:orgf0f0787} steps 1,2 and 3)
\item four are proteins of the mitochondrial membrane (Figure
\ref{fig:orgf0f0787} steps 4, 5 and 6)
\end{itemize}
