...
\label{sec:org5a66bb3}
\subsection{Introduction}
\label{sec:org2924a4a}
\begin{itemize}
...
\caption{\label{fig:orgb3bbf72}
Lipid and Lipoprotein Metabolism}
\end{figure}
\end{enumerate}

\subsection{LDL Metabolism}
\label{sec:orgb700d9e}
\begin{itemize}
\item see table \ref{tab:orgbd6f6c0}
...
\label{sec:orgad12f82}
\subsection{Introduction}
\label{sec:org261ffb1}
\begin{itemize}
...
\label{sec:org4a2be9e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6166b06}
\begin{itemize}
...
\label{sec:org0a282f5}
\begin{itemize}
\item mevalonate kinase deficiency (Figure \ref{fig:org98b48fe} , enzyme 4)
\end{itemize}
...
\label{sec:orga9783e9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd8f378e}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org1d42f9c}
\begin{itemize}
\item 7-dehydrocholesterol reductase deficiency (Figure \ref{fig:org98b48fe} , enzyme 19)
\begin{itemize}
...
\label{sec:org08e74b5}
\subsection{Introduction}
\label{sec:orgb1ca74c}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org530cd21}
\begin{itemize}
\item 3\(\beta\)-dehydrogenase catalyses the second reaction in the major
pathway of synthesis of bile acid (Figure \ref{fig:org3da6d9b}, enzyme 2)
...
\item Genetics
\label{sec:org2336339}
\begin{itemize}
\item AR, HSD3B7
\end{itemize}

\item Diagnostic Tests
\label{sec:org64e8b5a}
\begin{itemize}
...
\label{sec:orgc79a711}
\begin{itemize}
\item 5\(\beta\)-reductase deficiency (Figure \ref{fig:org3da6d9b}, enzyme 3)
...
\label{sec:org17b1a05}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc1ec8a1}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org86c2514}
\begin{itemize}
\item sterol 27-hydroxylase deficiency (Figure \ref{fig:org3da6d9b}, enzyme 4)
...
7\(\alpha\)-hydroxylase by bile acids is disrupted (Figure \ref{fig:org3da6d9b}, enzyme 1)
\end{itemize}
...
\item Genetics
\label{sec:org655f2db}
\begin{itemize}
\item AR, CYP27A1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd38d77a}
\begin{itemize}
\item molecular
\end{itemize}
\begin{enumerate}
\item Plasma
\label{sec:orga621676}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org37e3f21}
\begin{itemize}
\item \(\alpha\)-methylacyl-CoA racemase deficiency (Figure \ref{fig:org3da6d9b}, enzyme 5)
...
\item Genetics
\label{sec:org846ae3c}
\begin{itemize}
\item AR, AMACR
\end{itemize}

\item Diagnostic Tests
\label{sec:org05a1849}
\begin{itemize}
...
\label{sec:org8f5b4c6}
\subsection{Introduction}
\label{sec:orgdc50f47}
\begin{itemize}
...
(Figure \ref{fig:orgc5282eb} steps 1,2 and 3)
\item four are proteins of the mitochondrial membrane (Figure
\ref{fig:orgc5282eb} steps 4, 5 and 6)
\end{itemize}
