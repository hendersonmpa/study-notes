...
\label{sec:org732a43c}
\subsection{Introduction}
\label{sec:orgd991356}
\begin{itemize}
...
\caption{\label{fig:orgb7902b9}Lipid and Lipoprotein Metabolism}
\end{figure}
\end{enumerate}

\subsection{LDL Metabolism}
\label{sec:org9aa7380}
\begin{itemize}
\item see table \ref{tab:orga43eab9}
...
\begin{table}[htbp]
\caption{\label{tab:orga43eab9}Selected disorders affecting low density lipoprotein metabolism}
\centering
\begin{tabular}{lllll}
...
\label{sec:org0bd9aa8}
\subsection{Introduction}
\label{sec:org8500d55}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{iso_chol/iso_chol/figures/iso_chol_synth.png}
\caption{\label{fig:orgc81011a}Isoprenoid/cholesterol synthesis pathway}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{iso_chol/iso_chol/figures/Slide18.png}
\caption{\label{fig:org56d0268}Isoprenoid/cholesterol synthesis pathway}
\end{figure}



\subsection{Mevalonate Kinase Deficiency}
\label{sec:orge0e5295}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5f9e5de}
\begin{itemize}
...
\label{sec:orge12287b}
\begin{itemize}
\item mevalonate kinase deficiency (Figure \ref{fig:orgc81011a} , enzyme 4)
\end{itemize}
...
\label{sec:org4ed2fe3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3fd60ff}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org3cd8018}
\begin{itemize}
\item 7-dehydrocholesterol reductase deficiency (Figure \ref{fig:orgc81011a} , enzyme 19)
\begin{itemize}
...
\label{sec:org39acbdf}
\subsection{Introduction}
\label{sec:orgd972547}
...
\begin{enumerate}
\item 3\(\beta\)-hydroxy-\(\Delta\)\textsuperscript{5}-C\textsubscript{27}-steroid dehydrogenase (3\(\beta\)-dehydrogenase) deficiency
...
\item 3\(\beta\)-hydroxy \(\Delta\)\textsuperscript{5}-C\textsubscript{27}-steroid dehydrogenase deficiency the
major metabolite is not 7\(\alpha\)-hydroxycholesterol
\begin{itemize}
\item \(\to\) unsaturated bile acids with normal bile acid side chain but
persistence of the 3\(\beta\), 7\(\alpha\)-dihydroxy-\(\Delta\)\textsuperscript{5} structure of
the nucleus
\end{itemize}
\end{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{bile/bile/figures/bile_synth.png}
\caption{\label{fig:org17f0851}Major reactions the synthesis of bile acids from cholesterol}
\end{figure}

\subsection{3\(\beta\)-dehydrogenase deficiency}
\label{sec:orga6f7fea}
\begin{enumerate}
\item Clinical presentation
\label{sec:orgbeb62ac}
\begin{itemize}
\item present with
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org6333084}
\begin{itemize}
\item 3\(\beta\)-dehydrogenase catalyses the second reaction in the major
pathway of synthesis of bile acid (Figure \ref{fig:org17f0851}, enzyme 2)
...
\end{itemize}
\item probable that the sulphated \(\Delta\)\textsuperscript{5} bile acids cannot be secreted
...
\item Genetics
\label{sec:org1570f4c}
\begin{itemize}
\item AR, HSD3B7
\end{itemize}

\item Diagnostic Tests
\label{sec:orgfa0c5c7}
\begin{itemize}
...
\label{sec:org434ea8f}
\begin{itemize}
\item 5\(\beta\)-reductase deficiency (Figure \ref{fig:org17f0851}, enzyme 3)
...
\label{sec:org435c5c9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8b3d799}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org70535c0}
\begin{itemize}
\item sterol 27-hydroxylase deficiency (Figure \ref{fig:org17f0851}, enzyme 4)
...
7\(\alpha\)-hydroxylase by bile acids is disrupted (Figure \ref{fig:org17f0851}, enzyme 1)
\end{itemize}
...
\item Genetics
\label{sec:org868efd1}
\begin{itemize}
\item AR, CYP27A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org71768df}
\begin{itemize}
\item molecular
\end{itemize}
\begin{enumerate}
\item Plasma
\label{sec:orga2f744b}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org05f38f5}
\begin{itemize}
\item \(\alpha\)-methylacyl-CoA racemase deficiency (Figure \ref{fig:org17f0851}, enzyme 5)
...
\item Genetics
\label{sec:org2bacc4f}
\begin{itemize}
\item AR, AMACR
\end{itemize}

\item Diagnostic Tests
\label{sec:org7f38497}
\begin{itemize}
...
\label{sec:org34a32e1}
\subsection{Introduction}
\label{sec:org97daf83}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{tg_pl/tg_pl/figures/tg.png}
\caption{\label{fig:orgc1f669d}The common pathway, triglyceride synthesis and lipolysis}
\end{figure}
...
\label{sec:org3478a7b}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{tg_pl/tg_pl/figures/pl.png}
\caption{\label{fig:org2a83482}Phospholipid biosynthesis (top of the figure) and remodelling (bottom of the figure)}
\end{figure}


\begin{enumerate}
\item Inborn Errors of Phospholipid Biosynthesis
\label{sec:orgacfd67b}
\begin{itemize}
...
(Figure \ref{fig:org2a83482} steps 1,2 and 3)
\item four are proteins of the mitochondrial membrane (Figure
\ref{fig:org2a83482} steps 4, 5 and 6)
\end{itemize}
