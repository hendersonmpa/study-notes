...
\label{sec:org74b197e}
\subsection{Introduction}
\label{sec:org7394cee}
\begin{itemize}
...
\caption{\label{fig:orgde655d2}Lipid and Lipoprotein Metabolism}
\end{figure}
\end{enumerate}

\subsection{LDL Metabolism}
\label{sec:orgd952312}
\begin{itemize}
...
\end{enumerate}
\item see table \ref{tab:org30f06a6}
...
\begin{table}[htbp]
\caption{\label{tab:org30f06a6}Selected Disorders Affecting Low Density Lipoprotein Metabolism}
\centering
\begin{tabular}{lllll}
...
\label{sec:org67363b9}
\subsection{Introduction}
\label{sec:org17a8ea9}
\begin{itemize}
...
\end{itemize}
\item isoprenoid synthesis starts from acetyl-CoA (Figures \ref{fig:orgd55b902})
\begin{itemize}
...
\item lanosterol \(\to\) cholesterol occurs via two routes (Figures \ref{fig:org998d22d})
\begin{itemize}
...
\caption{\label{fig:org998d22d}Isoprenoid/Cholesterol Synthesis Pathway}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{iso_chol/figures/Slide18.png}
\caption{\label{fig:orgd55b902}Isoprenoid/Cholesterol Synthesis Pathway}
\end{figure}

\subsection{Mevalonate Kinase Deficiency}
\label{sec:org1b1eb49}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org7921aa3}
\begin{itemize}
...
\label{sec:orge72d3e5}
\begin{itemize}
\item \textbf{mevalonate kinase} deficiency (Figure \ref{fig:orgd55b902})
\end{itemize}
...
\label{sec:orge286ebe}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgcfa8162}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:orgb27729f}
\begin{itemize}
\item \textbf{7-dehydrocholesterol reductase} deficiency (Figure \ref{fig:orgd55b902})
\begin{itemize}
...
\label{sec:org0b2f952}
\subsection{Introduction}
\label{sec:org73a200b}
\begin{itemize}
...
\end{itemize}
\item synthesis can occur by a number of pathways (Figure \ref{fig:orgb89d0ca})
\begin{itemize}
...
\caption{\label{fig:orgb89d0ca}Synthesis of Bile Acids from Cholesterol}
\end{figure}

\subsection{3\(\beta\)-Dehydrogenase Deficiency}
\label{sec:org5aa5514}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0b6f89b}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:orgc2d0b13}
\begin{itemize}
\item 3\(\beta\)-dehydrogenase catalyses the second reaction in the major
pathway of synthesis of bile acid (Figure \ref{fig:orgb89d0ca}, enzyme 2)
...
\item Genetics
\label{sec:orgadf80a9}
\begin{itemize}
\item AR HSD3B7
\end{itemize}

\item Diagnostic Tests
\label{sec:org13688de}
\begin{itemize}
...
\label{sec:orgc3cd39b}
\begin{itemize}
\item 5\(\beta\)-reductase deficiency (Figure \ref{fig:orgb89d0ca}, enzyme 3)
...
\label{sec:org9fa579f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org95c4b14}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org00d1fd4}
\begin{itemize}
\item sterol 27-hydroxylase deficiency (Figure \ref{fig:orgb89d0ca}, enzyme 4)
...
7\(\alpha\)-hydroxylase by bile acids is disrupted (Figure \ref{fig:orgb89d0ca}, enzyme 1)
\end{itemize}
...
\item Genetics
\label{sec:org0707584}
\begin{itemize}
\item AR CYP27A1
\end{itemize}
\item Diagnostic Tests
\label{sec:orge747690}
\begin{itemize}
\item molecular
\end{itemize}
\begin{enumerate}
\item Plasma
\label{sec:org652d5e6}
\begin{itemize}
...
\label{sec:org7e0497c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org23b30e7}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org4757db1}
\begin{itemize}
\item \(\alpha\)-methylacyl-CoA racemase deficiency (Figure \ref{fig:orgb89d0ca}, enzyme 5)
...
\item Genetics
\label{sec:org92a085d}
\begin{itemize}
\item AR AMACR
\end{itemize}
\item Diagnostic Tests
\label{sec:org59bec8f}
\begin{itemize}
...
\label{sec:orgd1748d6}
\subsection{Introduction}
\label{sec:orgd49c7fa}
\begin{itemize}
...
\item the first steps of TG and of PL synthesis are the same (Figure \ref{fig:org25056e6})
...
\caption{\label{fig:org25056e6}Triglyceride Synthesis and Lipolysis}
\end{figure}

\subsection{Common Pathway}
\label{sec:org8f762dd}
\begin{enumerate}
\item Lipin-1 Deficiency
\label{sec:orgc362889}
\begin{itemize}
...
\caption{\label{fig:org6c19f4d}Phospholipid Biosynthesis and Remodelling}
\end{figure}
\end{itemize}

\begin{enumerate}
\item Inborn Errors of Phospholipid Biosynthesis
\label{sec:org1d57078}
\begin{itemize}
...
(Figure \ref{fig:org6c19f4d} steps 1,2 and 3)
\item four are proteins of the mitochondrial membrane (Figure
\ref{fig:org6c19f4d} steps 4, 5 and 6)
\end{itemize}
