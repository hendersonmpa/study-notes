...
\label{sec:org3cbc1b4}
\subsection{Introduction}
\label{sec:org454cff2}
\begin{itemize}
...
\end{enumerate}
\item see table \ref{tab:org79e6cd0}
...
\begin{table}[htbp]
\caption{\label{tab:org79e6cd0}Selected disorders affecting low density lipoprotein metabolism}
\centering
\begin{tabular}{lllll}
...
\label{sec:org3c0a264}
\subsection{Introduction}
\label{sec:orgd2b3567}
\begin{itemize}
...
\end{itemize}
\item isoprenoid synthesis starts from acetyl-CoA (Figures \ref{fig:org4103006})
\begin{itemize}
...
\item lanosterol \(\to\) cholesterol occurs via two routes (Figures \ref{fig:org4b1673c})
\begin{itemize}
...
\caption{\label{fig:org4b1673c}Isoprenoid/Cholesterol Synthesis Pathway}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{iso_chol/figures/Slide18.png}
\caption{\label{fig:org4103006}Isoprenoid/Cholesterol Synthesis Pathway}
\end{figure}
...
\label{sec:org223c6b0}
\subsection{Introduction}
\label{sec:orgfefef8c}
\begin{itemize}
...
\end{itemize}
\item synthesis can occur by a number of pathways (Figure \ref{fig:orgeebf962})
\begin{itemize}
...
\caption{\label{fig:orgeebf962}Major reactions the synthesis of bile acids from cholesterol}
\end{figure}

\subsection{3\(\beta\)-Dehydrogenase Deficiency}
\label{sec:orgdec22f0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org80cada9}
\begin{itemize}
...
\label{sec:orge263eb8}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2faa38d}
\begin{itemize}
...
\item Genetics
\label{sec:orgc502c24}
\begin{itemize}
\item AR AMACR
\end{itemize}
\item Diagnostic Tests
\label{sec:org1dc914c}
\begin{itemize}
...
\caption{\label{fig:org936c684}The common pathway, triglyceride synthesis and lipolysis}
\end{figure}
\subsection{Common Pathway}
\label{sec:org7c8f407}
\begin{enumerate}
\item Lipin-1 Deficiency
\label{sec:org35074de}
\begin{itemize}
...
\caption{\label{fig:orgd2ecbd4}Phospholipid biosynthesis (top of the figure) and remodelling (bottom of the figure)}
\end{figure}
\end{itemize}

\begin{enumerate}
\item Inborn Errors of Phospholipid Biosynthesis
\label{sec:org3be656b}
\begin{itemize}
...
(Figure \ref{fig:orgd2ecbd4} steps 1,2 and 3)
\item four are proteins of the mitochondrial membrane (Figure
\ref{fig:orgd2ecbd4} steps 4, 5 and 6)
\end{itemize}
