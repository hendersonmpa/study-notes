...
\label{sec:orge9b0860}
\subsection{Introduction}
\label{sec:org8bb5f97}
\begin{itemize}
...
\caption{\label{fig:org4c5e1ce}
Lipid and Lipoprotein Metabolism}
\end{figure}
\end{enumerate}

\subsection{LDL Metabolism}
\label{sec:orgbd2de2e}
\begin{itemize}
\item see table \ref{tab:org6382dc7}
...
\label{sec:orge307ab5}
\subsection{Introduction}
\label{sec:orga954655}
\begin{itemize}
...
\label{sec:org9994e07}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb3fcab1}
\begin{itemize}
...
\label{sec:org3576418}
\begin{itemize}
\item mevalonate kinase deficiency (Figure \ref{fig:org18c651c} , enzyme 4)
\end{itemize}
...
\label{sec:org589b65c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6e4a899}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org998073f}
\begin{itemize}
\item 7-dehydrocholesterol reductase deficiency (Figure \ref{fig:org18c651c} , enzyme 19)
\begin{itemize}
...
\label{sec:orgf6f0f8a}
\subsection{Introduction}
\label{sec:org2dc19b6}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:orgf61ffb0}
\begin{itemize}
\item 3\(\beta\)-dehydrogenase catalyses the second reaction in the major
pathway of synthesis of bile acid (Figure \ref{fig:org3c00149}, enzyme 2)
...
\item Genetics
\label{sec:org8dc9bd7}
\begin{itemize}
\item AR, HSD3B7
\end{itemize}

\item Diagnostic Tests
\label{sec:orge8c1cfc}
\begin{itemize}
...
\label{sec:org795ef72}
\begin{itemize}
\item 5\(\beta\)-reductase deficiency (Figure \ref{fig:org3c00149}, enzyme 3)
...
\label{sec:org67a90a7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge31e1f2}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:orgbbf5fc2}
\begin{itemize}
\item sterol 27-hydroxylase deficiency (Figure \ref{fig:org3c00149}, enzyme 4)
...
7\(\alpha\)-hydroxylase by bile acids is disrupted (Figure \ref{fig:org3c00149}, enzyme 1)
\end{itemize}
...
\item Genetics
\label{sec:org3faccfc}
\begin{itemize}
\item AR, CYP27A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org1efbd36}
\begin{itemize}
\item molecular
\end{itemize}
\begin{enumerate}
\item Plasma
\label{sec:org1aef92d}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org4a13413}
\begin{itemize}
\item \(\alpha\)-methylacyl-CoA racemase deficiency (Figure \ref{fig:org3c00149}, enzyme 5)
...
\item Genetics
\label{sec:org393d3d3}
\begin{itemize}
\item AR, AMACR
\end{itemize}

\item Diagnostic Tests
\label{sec:org138c69c}
\begin{itemize}
...
\label{sec:org28df95a}
\subsection{Introduction}
\label{sec:org52d93b1}
\begin{itemize}
...
(Figure \ref{fig:orga38e640} steps 1,2 and 3)
\item four are proteins of the mitochondrial membrane (Figure
\ref{fig:orga38e640} steps 4, 5 and 6)
\end{itemize}
