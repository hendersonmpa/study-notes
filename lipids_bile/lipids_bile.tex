...
\label{sec:org41738c3}
\subsection{Introduction}
\label{sec:org53dd7ac}
\begin{itemize}
...
\caption{\label{fig:orgdf115b4}Lipid and Lipoprotein Metabolism}
\end{figure}
\end{enumerate}

\subsection{LDL Metabolism}
\label{sec:orgda94d3a}
\begin{itemize}
...
\end{enumerate}
\item see table \ref{tab:orgbaf1b23}
...
\begin{table}[htbp]
\caption{\label{tab:orgbaf1b23}Selected disorders affecting low density lipoprotein metabolism}
\centering
\begin{tabular}{lllll}
...
\label{sec:orgc2f7287}
\subsection{Introduction}
\label{sec:orgb0f0c2c}
\begin{itemize}
...
\end{itemize}
\item isoprenoid synthesis starts from acetyl-CoA (Figures \ref{fig:org40174d3})
\begin{itemize}
...
\item lanosterol \(\to\) cholesterol occurs via two routes (Figures \ref{fig:orga01b728})
\begin{itemize}
...
\caption{\label{fig:orga01b728}Isoprenoid/Cholesterol Synthesis Pathway}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{iso_chol/figures/Slide18.png}
\caption{\label{fig:org40174d3}Isoprenoid/Cholesterol Synthesis Pathway}
\end{figure}

\subsection{Mevalonate Kinase Deficiency}
\label{sec:org94a3dab}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4b73a6b}
\begin{itemize}
...
\label{sec:orgc091940}
\begin{itemize}
\item \textbf{mevalonate kinase} deficiency (Figure \ref{fig:org40174d3})
\end{itemize}
...
\label{sec:org2c1db0b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2534362}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org6d9ffb0}
\begin{itemize}
\item \textbf{7-dehydrocholesterol reductase} deficiency (Figure \ref{fig:org40174d3})
\begin{itemize}
...
\label{sec:org4da3eb7}
\subsection{Introduction}
\label{sec:org8a5a999}
\begin{itemize}
...
\end{itemize}
\item synthesis can occur by a number of pathways (Figure \ref{fig:org48a8933})
\begin{itemize}
...
\caption{\label{fig:org48a8933}Synthesis of Bile Acids from Cholesterol}
\end{figure}

\subsection{3\(\beta\)-Dehydrogenase Deficiency}
\label{sec:orgff9f8a0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0abfa78}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org8b30e01}
\begin{itemize}
\item 3\(\beta\)-dehydrogenase catalyses the second reaction in the major
pathway of synthesis of bile acid (Figure \ref{fig:org48a8933}, enzyme 2)
...
\item Genetics
\label{sec:orgbbaa721}
\begin{itemize}
\item AR HSD3B7
\end{itemize}

\item Diagnostic Tests
\label{sec:org00368dc}
\begin{itemize}
...
\label{sec:org1555496}
\begin{itemize}
\item 5\(\beta\)-reductase deficiency (Figure \ref{fig:org48a8933}, enzyme 3)
...
\label{sec:org7e2e89b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb0a9206}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:orga5db4b6}
\begin{itemize}
\item sterol 27-hydroxylase deficiency (Figure \ref{fig:org48a8933}, enzyme 4)
...
7\(\alpha\)-hydroxylase by bile acids is disrupted (Figure \ref{fig:org48a8933}, enzyme 1)
\end{itemize}
...
\item Genetics
\label{sec:orgcb4864d}
\begin{itemize}
\item AR CYP27A1
\end{itemize}
\item Diagnostic Tests
\label{sec:org48ff446}
\begin{itemize}
\item molecular
\end{itemize}
\begin{enumerate}
\item Plasma
\label{sec:org6ba2c75}
\begin{itemize}
...
\label{sec:org609d287}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgbc6a234}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org672e665}
\begin{itemize}
\item \(\alpha\)-methylacyl-CoA racemase deficiency (Figure \ref{fig:org48a8933}, enzyme 5)
...
\item Genetics
\label{sec:orgccf34dd}
\begin{itemize}
\item AR AMACR
\end{itemize}
\item Diagnostic Tests
\label{sec:orgfa60c8c}
\begin{itemize}
...
\label{sec:orgb561762}
\subsection{Introduction}
\label{sec:orgf132415}
\begin{itemize}
...
\item the first steps of TG and of PL synthesis are the same (Figure \ref{fig:org760b76f})
...
\caption{\label{fig:org760b76f}Triglyceride Synthesis and Lipolysis}
\end{figure}

\subsection{Common Pathway}
\label{sec:org2425bec}
\begin{enumerate}
\item Lipin-1 Deficiency
\label{sec:orgeec5599}
\begin{itemize}
...
\caption{\label{fig:orga2d9189}Phospholipid Biosynthesis and Remodelling}
\end{figure}
\end{itemize}

\begin{enumerate}
\item Inborn Errors of Phospholipid Biosynthesis
\label{sec:orge5c7d03}
\begin{itemize}
...
(Figure \ref{fig:orga2d9189} steps 1,2 and 3)
\item four are proteins of the mitochondrial membrane (Figure
\ref{fig:orga2d9189} steps 4, 5 and 6)
\end{itemize}
