...
\label{sec:org2db032f}
\subsection{Introduction}
\label{sec:org74ec21f}
\begin{itemize}
...
\caption{\label{fig:org6dcc1d2}
Lipid and Lipoprotein Metabolism}
\end{figure}
\end{enumerate}

\subsection{LDL Metabolism Disorders}
\label{sec:orgb058939}
\begin{itemize}
...
\label{sec:org6610e3e}
\subsection{Introduction}
\label{sec:orgd49e084}
\begin{itemize}
...
\label{sec:org27b16cb}
\begin{itemize}
\item mevalonate kinase deficiency (Figure \ref{fig:org865f0d2})
\end{itemize}
...
\label{sec:orga564fc5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1034c84}
\begin{itemize}
...
\label{sec:orga5e2266}
\subsection{Introduction}
\label{sec:orgd1e508a}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org16f6b51}
\begin{itemize}
\item 3\(\beta\)-dehydrogenase catalyses the second reaction in the major
pathway of synthesis of bile acid (Figure \ref{fig:orge2b34ff},enyzyme 2)
...
\item Genetics
\label{sec:org76039de}
\begin{itemize}
\item AR, HSD3B7
\end{itemize}

\item Diagnostic Tests
\label{sec:orgfa8ffff}
\begin{itemize}
...
\label{sec:orgb53cd37}
\begin{itemize}
\item 5\(\beta\)-reductase deficiency (Figure \ref{fig:orge2b34ff}, enzyme 3)
...
\label{sec:orgf253227}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4577743}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:orga1191c7}
\begin{itemize}
\item sterol 27-hydroxylase deficiency (Figure \ref{fig:orge2b34ff}, enzyme 4)
...
7\(\alpha\)-hydroxylase by bile acids is disrupted (Figure \ref{fig:orge2b34ff}, enzyme 1)
\end{itemize}
...
\item Genetics
\label{sec:orgbebe8bf}
\begin{itemize}
\item AR, CYP27A1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgfddb259}
\begin{itemize}
\item molecular
\end{itemize}
\begin{enumerate}
\item Plasma
\label{sec:org2173b6c}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:orgfe26d26}
\begin{itemize}
\item \(\alpha\)-methylacyl-CoA racemase deficiency (Figure \ref{fig:orge2b34ff}, enzyme 5)
...
\item Genetics
\label{sec:org73d80db}
\begin{itemize}
\item AR, AMACR
\end{itemize}

\item Diagnostic Tests
\label{sec:orgcc64844}
\begin{itemize}
...
\label{sec:org848073c}
\subsection{Introduction}
\label{sec:org2caaae1}
\begin{itemize}
...
(Figure \ref{fig:org9189e12} steps 1,2 and 3)
\item four are proteins of the mitochondrial membrane (Figure
\ref{fig:org9189e12} steps 4, 5 and 6)
\end{itemize}
