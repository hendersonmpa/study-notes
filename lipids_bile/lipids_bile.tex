...
\label{sec:org0f9eeee}
\subsection{Introduction}
\label{sec:org1d289d7}
\begin{itemize}
...
\caption{\label{fig:org909f585}
Lipid and Lipoprotein Metabolism}
\end{figure}
\end{enumerate}

\subsection{LDL Metabolism Disorders}
\label{sec:org84cebef}
\begin{itemize}
...
\label{sec:org9372534}
\subsection{Introduction}
\label{sec:org7d4b1a3}
\begin{itemize}
...
\label{sec:org3db97e2}
\begin{itemize}
\item mevalonate kinase deficiency (Figure \ref{fig:org079462d})
\end{itemize}
...
\label{sec:orgdc7b64c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga3f5534}
\begin{itemize}
...
\label{sec:org1f002c4}
\subsection{Introduction}
\label{sec:org4a142a4}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org10b37dc}
\begin{itemize}
\item 3\(\beta\)-dehydrogenase catalyses the second reaction in the major
pathway of synthesis of bile acid (Figure \ref{fig:orgc348975},enyzyme 2)
...
\item Genetics
\label{sec:org195950a}
\begin{itemize}
\item AR, HSD3B7
\end{itemize}

\item Diagnostic Tests
\label{sec:org67efa96}
\begin{itemize}
...
\label{sec:org199341b}
\begin{itemize}
\item 5\(\beta\)-reductase deficiency (Figure \ref{fig:orgc348975}, enzyme 3)
...
\label{sec:org8afaedc}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf89b91e}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org043ab91}
\begin{itemize}
\item sterol 27-hydroxylase deficiency (Figure \ref{fig:orgc348975}, enzyme 4)
...
7\(\alpha\)-hydroxylase by bile acids is disrupted (Figure \ref{fig:orgc348975}, enzyme 1)
\end{itemize}
...
\item Genetics
\label{sec:orgf6dbb45}
\begin{itemize}
\item AR, CYP27A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org14bd6c3}
\begin{itemize}
\item molecular
\end{itemize}
\begin{enumerate}
\item Plasma
\label{sec:orgabf3806}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org643c112}
\begin{itemize}
\item \(\alpha\)-methylacyl-CoA racemase deficiency (Figure \ref{fig:orgc348975}, enzyme 5)
...
\item Genetics
\label{sec:org94ff5fc}
\begin{itemize}
\item AR, AMACR
\end{itemize}

\item Diagnostic Tests
\label{sec:org65070c3}
\begin{itemize}
...
\label{sec:orgc220b60}
\subsection{Introduction}
\label{sec:orgdeaa635}
\begin{itemize}
...
(Figure \ref{fig:org625e29e} steps 1,2 and 3)
\item four are proteins of the mitochondrial membrane (Figure
\ref{fig:org625e29e} steps 4, 5 and 6)
\end{itemize}
