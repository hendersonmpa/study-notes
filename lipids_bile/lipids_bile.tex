...
\label{sec:org3e8be0a}
\subsection{Introduction}
\label{sec:org4ef3318}
\begin{itemize}
...
\caption{\label{fig:orgb80ce15}Lipid and Lipoprotein Metabolism}
\end{figure}
\end{enumerate}

\subsection{LDL Metabolism}
\label{sec:orgceea86c}
\begin{itemize}
...
\end{enumerate}
\item see table \ref{tab:orgde3f652}
...
\begin{table}[htbp]
\caption{\label{tab:orgde3f652}Selected disorders affecting low density lipoprotein metabolism}
\centering
\begin{tabular}{lllll}
...
\label{sec:orgeff2fab}
\subsection{Introduction}
\label{sec:orgbdf5f6b}
\begin{itemize}
...
\end{itemize}
\item isoprenoid synthesis starts from acetyl-CoA (Figures \ref{fig:orge50f044})
\begin{itemize}
...
\item lanosterol \(\to\) cholesterol occurs via two routes (Figures \ref{fig:org728ce40})
\begin{itemize}
...
\caption{\label{fig:org728ce40}Isoprenoid/Cholesterol Synthesis Pathway}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{iso_chol/figures/Slide18.png}
\caption{\label{fig:orge50f044}Isoprenoid/Cholesterol Synthesis Pathway}
\end{figure}
...
\label{sec:orgd795697}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc4af2fe}
\begin{itemize}
...
\label{sec:org9763a72}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org15f63b2}
\begin{itemize}
...
\item Genetics
\label{sec:org2c38e74}
\begin{itemize}
\item AR AMACR
\end{itemize}
\item Diagnostic Tests
\label{sec:orgbce0c22}
\begin{itemize}
