...
\label{sec:orgb700c11}
\subsection{Introduction}
\label{sec:org03c8bb8}
\begin{itemize}
...
\end{enumerate}
\item see table \ref{tab:org33cfe8a}
...
\begin{table}[htbp]
\caption{\label{tab:org33cfe8a}Selected disorders affecting low density lipoprotein metabolism}
\centering
\begin{tabular}{lllll}
...
\label{sec:org57c6529}
\subsection{Introduction}
\label{sec:org56c4841}
\begin{itemize}
...
\end{itemize}
\item isoprenoid synthesis starts from acetyl-CoA (Figures \ref{fig:orgad02241})
\begin{itemize}
...
\item lanosterol \(\to\) cholesterol occurs via two routes (Figures \ref{fig:orgb3a94a9})
\begin{itemize}
...
\caption{\label{fig:orgb3a94a9}Isoprenoid/Cholesterol Synthesis Pathway}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{iso_chol/figures/Slide18.png}
\caption{\label{fig:orgad02241}Isoprenoid/Cholesterol Synthesis Pathway}
\end{figure}
...
\label{sec:org585b2c2}
\subsection{Introduction}
\label{sec:org5c83ab7}
\begin{itemize}
...
\end{itemize}
\item synthesis can occur by a number of pathways (Figure \ref{fig:org7cafbd6})
\begin{itemize}
...
\caption{\label{fig:org7cafbd6}Major reactions the synthesis of bile acids from cholesterol}
\end{figure}

\subsection{3\(\beta\)-Dehydrogenase Deficiency}
\label{sec:org7c96e4d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgaf2d224}
\begin{itemize}
...
\label{sec:org80d488b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga5a1e8f}
\begin{itemize}
...
\item Genetics
\label{sec:org61b2269}
\begin{itemize}
\item AR AMACR
\end{itemize}
\item Diagnostic Tests
\label{sec:org1306677}
\begin{itemize}
...
\caption{\label{fig:orgc1fc324}The common pathway, triglyceride synthesis and lipolysis}
\end{figure}
\subsection{Common Pathway}
\label{sec:org68d93bc}
\begin{enumerate}
\item Lipin-1 Deficiency
\label{sec:org2b1a40e}
\begin{itemize}
...
\caption{\label{fig:orgc5f255b}Phospholipid biosynthesis (top of the figure) and remodelling (bottom of the figure)}
\end{figure}
\end{itemize}

\begin{enumerate}
\item Inborn Errors of Phospholipid Biosynthesis
\label{sec:org1ca6acb}
\begin{itemize}
...
(Figure \ref{fig:orgc5f255b} steps 1,2 and 3)
\item four are proteins of the mitochondrial membrane (Figure
\ref{fig:orgc5f255b} steps 4, 5 and 6)
\end{itemize}
