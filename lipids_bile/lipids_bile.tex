...
\label{sec:orgce4dc8a}
\subsection{Introduction}
\label{sec:orge97f904}
\begin{itemize}
...
\caption{\label{fig:orgf26df69}Lipid and Lipoprotein Metabolism}
\end{figure}
\end{enumerate}

\subsection{LDL Metabolism}
\label{sec:orga6b26df}
\begin{itemize}
...
\end{enumerate}
\item see table \ref{tab:orgb5a7b65}
...
\begin{table}[htbp]
\caption{\label{tab:orgb5a7b65}Selected disorders affecting low density lipoprotein metabolism}
\centering
\begin{tabular}{lllll}
...
\label{sec:orge1243de}
\subsection{Introduction}
\label{sec:orgdd6875b}
\begin{itemize}
...
\end{itemize}
\item isoprenoid synthesis starts from acetyl-CoA (Figures \ref{fig:org783185f})
\begin{itemize}
...
\item lanosterol \(\to\) cholesterol occurs via two routes (Figures \ref{fig:org1b82604})
\begin{itemize}
...
\caption{\label{fig:org1b82604}Isoprenoid/Cholesterol Synthesis Pathway}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{iso_chol/figures/Slide18.png}
\caption{\label{fig:org783185f}Isoprenoid/Cholesterol Synthesis Pathway}
\end{figure}

\subsection{Mevalonate Kinase Deficiency}
\label{sec:orgc366618}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org205095c}
\begin{itemize}
...
\label{sec:orgfcaa5b8}
\begin{itemize}
\item \textbf{mevalonate kinase} deficiency (Figure \ref{fig:org783185f})
\end{itemize}
...
\label{sec:org0ddfcc3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb849c0c}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:orga6c8957}
\begin{itemize}
\item \textbf{7-dehydrocholesterol reductase} deficiency (Figure \ref{fig:org783185f})
\begin{itemize}
...
\label{sec:orgc78cc84}
\subsection{Introduction}
\label{sec:orgfbba280}
\begin{itemize}
...
\end{itemize}
\item synthesis can occur by a number of pathways (Figure \ref{fig:orgf3c5a11})
\begin{itemize}
...
\caption{\label{fig:orgf3c5a11}Major reactions the synthesis of bile acids from cholesterol}
\end{figure}

\subsection{3\(\beta\)-Dehydrogenase Deficiency}
\label{sec:org8086427}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb5e28fb}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:orgdbcbdf7}
\begin{itemize}
\item 3\(\beta\)-dehydrogenase catalyses the second reaction in the major
pathway of synthesis of bile acid (Figure \ref{fig:orgf3c5a11}, enzyme 2)
...
\item Genetics
\label{sec:org7b7cf8e}
\begin{itemize}
\item AR HSD3B7
\end{itemize}

\item Diagnostic Tests
\label{sec:org583e20a}
\begin{itemize}
...
\label{sec:org554ec62}
\begin{itemize}
\item 5\(\beta\)-reductase deficiency (Figure \ref{fig:orgf3c5a11}, enzyme 3)
...
\label{sec:org2634ae7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgcede9d9}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org2dc82cb}
\begin{itemize}
\item sterol 27-hydroxylase deficiency (Figure \ref{fig:orgf3c5a11}, enzyme 4)
...
7\(\alpha\)-hydroxylase by bile acids is disrupted (Figure \ref{fig:orgf3c5a11}, enzyme 1)
\end{itemize}
...
\item Genetics
\label{sec:orga139749}
\begin{itemize}
\item AR CYP27A1
\end{itemize}
\item Diagnostic Tests
\label{sec:org6f07822}
\begin{itemize}
\item molecular
\end{itemize}
\begin{enumerate}
\item Plasma
\label{sec:org60d0ff9}
\begin{itemize}
...
\label{sec:org832d518}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge62c157}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org9bb93c6}
\begin{itemize}
\item \(\alpha\)-methylacyl-CoA racemase deficiency (Figure \ref{fig:orgf3c5a11}, enzyme 5)
...
\item Genetics
\label{sec:orgb4c1a4b}
\begin{itemize}
\item AR AMACR
\end{itemize}
\item Diagnostic Tests
\label{sec:orga76553d}
\begin{itemize}
...
\label{sec:org911c09b}
\subsection{Introduction}
\label{sec:orgc75beaa}
\begin{itemize}
...
\item the first steps of TG and of PL synthesis are the same (Figure \ref{fig:org21cde29})
...
\caption{\label{fig:org21cde29}The common pathway, triglyceride synthesis and lipolysis}
\end{figure}
\subsection{Common Pathway}
\label{sec:orgefe125b}
\begin{enumerate}
\item Lipin-1 Deficiency
\label{sec:orgd7a8971}
\begin{itemize}
...
\caption{\label{fig:org08673e3}Phospholipid biosynthesis (top of the figure) and remodelling (bottom of the figure)}
\end{figure}
\end{itemize}

\begin{enumerate}
\item Inborn Errors of Phospholipid Biosynthesis
\label{sec:org7e5db34}
\begin{itemize}
...
(Figure \ref{fig:org08673e3} steps 1,2 and 3)
\item four are proteins of the mitochondrial membrane (Figure
\ref{fig:org08673e3} steps 4, 5 and 6)
\end{itemize}
