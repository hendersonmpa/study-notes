...
\label{sec:orgc88b28b}
\subsection{Mitosis}
\label{sec:orgd09411f}
\begin{description}
...
\caption{\label{fig:orged7c115}
Karyotype}
\end{figure}

\subsection{Meiosis}
\label{sec:org981229e}
...
\caption{\label{fig:org2bffc8a}
Meiosis}
\end{figure}


\subsection{Homologous Recombination}
\label{sec:org99a53bd}
...
\caption{\label{fig:org4724228}
Polymorphism}
\end{figure}


\subsection{Origins and Freq of Mutation types}
\label{sec:orgde69d3f}
\begin{itemize}
\item germline
\item somatic
\item Mutations:
...
\caption{\label{fig:org2ddb932}
ISCN (continued)}
\end{figure}

\subsection{Gene Dosage, Balance and Imbalance}
\label{sec:orge98a999}
\begin{itemize}
...
\item Aneuploidy
\label{sec:org615e622}
\begin{itemize}
\item most common cause is meiotic nondisjunction in meiosis I or II (Figure \ref{fig:orgdf80c18})
\begin{description}
...
\caption{\label{fig:orgdf80c18}
Nondisjunction}
\end{figure}
\end{enumerate}

\subsection{Abnormalities of Chromosome Structure}
\label{sec:org7dec6f0}
\begin{itemize}
...
\begin{enumerate}
\item Down Syndrome
\label{sec:orgc3ac3d8}
\begin{itemize}
\item see conditions
\end{itemize}
\begin{enumerate}
\item Robertsonian Translocation
\label{sec:org392a311}
\begin{itemize}
...
\caption{\label{fig:org833c9ec}
Targeted cancer treatment}
\end{figure}

\section{{\bfseries\sffamily STARTED} Chapter 16: Risk}
\label{sec:org58de4c2}
\subsection{X linked}
\label{sec:org8497296}
\begin{enumerate}
\item Transmission
\label{sec:orge60a6f4}
\begin{itemize}
...
post & 2/3 & 1/3\\
\end{tabular}
\end{center}\footnotetext[1]{\label{org9ca4c2e}Prop of affected son}
