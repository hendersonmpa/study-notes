...
\label{sec:orgbade2d5}
\subsection{Mitosis}
\label{sec:orgc25c8de}
\begin{description}
...
\caption{\label{fig:orgf6863e7}
Karyotype}
\end{figure}

\subsection{Meiosis}
\label{sec:org466db87}
...
\caption{\label{fig:org67ed9c8}
Meiosis}
\end{figure}


\subsection{Homologous Recombination}
\label{sec:org58e31cc}
...
\caption{\label{fig:org4ae0c70}
ISCN (continued)}
\end{figure}

\subsection{Gene Dosage, Balance and Imbalance}
\label{sec:orgd64db3d}
\begin{itemize}
...
\item Aneuploidy
\label{sec:orgdfc5b7b}
\begin{itemize}
\item most common cause is meiotic nondisjunction in meiosis I or II (Figure \ref{fig:org17873e5})
\begin{description}
...
\caption{\label{fig:org17873e5}
Nondisjunction}
\end{figure}
\end{enumerate}

\subsection{Abnormalities of Chromosome Structure}
\label{sec:orga6e6095}
\begin{itemize}
...
\begin{enumerate}
\item Down Syndrome
\label{sec:orga8436a2}
\begin{itemize}
\item see conditions
\end{itemize}
\begin{enumerate}
\item Robertsonian Translocation
\label{sec:org604358d}
\begin{itemize}
...
\caption{\label{fig:orga5452e2}
Targeted cancer treatment}
\end{figure}

\section{{\bfseries\sffamily STARTED} Chapter 16: Risk}
\label{sec:org3b0f6dd}
\subsection{X linked}
\label{sec:orgb580654}
\begin{enumerate}
\item Transmission
\label{sec:orgaa5b53f}
\begin{itemize}
...
post & 2/3 & 1/3\\
\end{tabular}
\end{center}\footnotetext[1]{\label{orgb20003f}Prop of affected son}
