...
\label{sec:orge633b90}
\subsection{Mitosis}
\label{sec:org11a5923}
\begin{description}
...
\caption{\label{fig:orgf63370c}
Karyotype}
\end{figure}

\subsection{Meiosis}
\label{sec:org8aeb550}
...
\caption{\label{fig:orga15b6ca}
Meiosis}
\end{figure}


\subsection{Homologous Recombination}
\label{sec:org27ed895}
...
\caption{\label{fig:org6b815b8}
Polymorphism}
\end{figure}


\subsection{Origins and Freq of Mutation types}
\label{sec:org2e0110a}
\begin{itemize}
\item germline
\item somatic
\item Mutations:
...
\caption{\label{fig:org0977086}
ISCN (continued)}
\end{figure}

\subsection{Gene Dosage, Balance and Imbalance}
\label{sec:org092df78}
\begin{itemize}
...
\item Aneuploidy
\label{sec:org291be06}
\begin{itemize}
\item most common cause is meiotic nondisjunction in meiosis I or II (Figure \ref{fig:org7608fd5})
\begin{description}
...
\caption{\label{fig:org7608fd5}
Nondisjunction}
\end{figure}
\end{enumerate}

\subsection{Abnormalities of Chromosome Structure}
\label{sec:org0d7d606}
\begin{itemize}
...
\begin{enumerate}
\item Down Syndrome
\label{sec:orgac06790}
\begin{itemize}
\item see conditions
\end{itemize}
\begin{enumerate}
\item Robertsonian Translocation
\label{sec:org032fa4b}
\begin{itemize}
...
\caption{\label{fig:org9427db9}
Targeted cancer treatment}
\end{figure}

\section{{\bfseries\sffamily STARTED} Chapter 16: Risk}
\label{sec:orgf1bb685}
\subsection{X linked}
\label{sec:orgc26f3f1}
\begin{enumerate}
\item Transmission
\label{sec:org21cd2bf}
\begin{itemize}
...
post & 2/3 & 1/3\\
\end{tabular}
\end{center}\footnotetext[1]{\label{org594855f}Prop of affected son}
