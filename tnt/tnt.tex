...
\label{sec:org3677a60}
\subsection{Mitosis}
\label{sec:org53244fb}
\begin{description}
...
\caption{\label{fig:orgc1344ec}
Karyotype}
\end{figure}

\subsection{Meiosis}
\label{sec:orgb5cfa21}
...
\caption{\label{fig:org33f039c}
Meiosis}
\end{figure}


\subsection{Homologous Recombination}
\label{sec:org5da4d9d}
...
\caption{\label{fig:orge12bf0d}
Polymorphism}
\end{figure}


\subsection{Origins and Freq of Mutation types}
\label{sec:org42963b9}
\begin{itemize}
\item germline
\item somatic
\item Mutations:
...
\caption{\label{fig:org48957b5}
ISCN (continued)}
\end{figure}

\subsection{Gene Dosage, Balance and Imbalance}
\label{sec:orgadb697c}
\begin{itemize}
...
\item Aneuploidy
\label{sec:orgbc8ed89}
\begin{itemize}
\item most common cause is meiotic nondisjunction in meiosis I or II (Figure \ref{fig:orge77a8de})
\begin{description}
...
\caption{\label{fig:orge77a8de}
Nondisjunction}
\end{figure}
\end{enumerate}

\subsection{Abnormalities of Chromosome Structure}
\label{sec:orgad4c0c1}
\begin{itemize}
...
\begin{enumerate}
\item Down Syndrome
\label{sec:org3be0193}
\begin{itemize}
\item see conditions
\end{itemize}
\begin{enumerate}
\item Robertsonian Translocation
\label{sec:org90bc3be}
\begin{itemize}
...
\caption{\label{fig:org2befac4}
Targeted cancer treatment}
\end{figure}

\section{{\bfseries\sffamily STARTED} Chapter 16: Risk}
\label{sec:orge9b18ab}
\subsection{X linked}
\label{sec:orgb27bdaa}
\begin{enumerate}
\item Transmission
\label{sec:org9df01dc}
\begin{itemize}
...
post & 2/3 & 1/3\\
\end{tabular}
\end{center}\footnotetext[1]{\label{org32bb299}Prop of affected son}
