...
\label{sec:orge126e08}
\subsection{Mitosis}
\label{sec:org7ee3f48}
\begin{description}
...
\caption{\label{fig:orgb60b9fe}
Karyotype}
\end{figure}

\subsection{Meiosis}
\label{sec:org83d15fb}
...
\caption{\label{fig:orged4a7fe}
Meiosis}
\end{figure}


\subsection{Homologous Recombination}
\label{sec:orgba4f498}
...
\item Aneuploidy
\label{sec:org4093e23}
\begin{itemize}
\item most common cause is meiotic nondisjunction in meiosis I or II (Figure \ref{fig:org1d5c059})
\begin{description}
...
\caption{\label{fig:org1d5c059}
Nondisjunction}
\end{figure}
\end{enumerate}

\subsection{Abnormalities of Chromosome Structure}
\label{sec:org049b8e3}
\begin{itemize}
...
\begin{enumerate}
\item Down Syndrome
\label{sec:orgfd06401}
\begin{itemize}
\item see conditions
\end{itemize}
\begin{enumerate}
\item Robertsonian Translocation
\label{sec:orge110af3}
\begin{itemize}
...
\caption{\label{fig:org6ea02d6}
Targeted cancer treatment}
\end{figure}

\section{{\bfseries\sffamily STARTED} Chapter 16: Risk}
\label{sec:org8d39b89}
\subsection{X linked}
\label{sec:org237d34e}
\begin{enumerate}
\item Transmission
\label{sec:org55fe027}
\begin{itemize}
...
post & 2/3 & 1/3\\
\end{tabular}
\end{center}\footnotetext[1]{\label{org7101f66}Prop of affected son}
