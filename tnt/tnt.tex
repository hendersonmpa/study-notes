...
\caption{\label{fig:org6e19d08}Karyotype}
\end{figure}

\subsection{Meiosis}
\label{sec:orgb11485e}
...
\caption{\label{fig:org18cbaac}Meiosis}
\end{figure}

\subsection{Homologous Recombination}
\label{sec:orgfab871c}
...
\caption{\label{fig:orgf6f7a55}X Inactivation}
\end{figure}

\section{Human Genetic Diversity}
\label{sec:org2cf505d}
\subsection{Inherited variation and polymorphism}
\label{sec:orga86b6eb}
\begin{itemize}
\item SNPs
\item indels
\item microsatelite
...
\caption{\label{fig:org7c19705}Polymorphism}
\end{figure}


\subsection{Origins and Freq of Mutation types}
\label{sec:org8fe5ec3}
\begin{itemize}
\item germline
\item somatic
\item mutations:
...
\caption{\label{fig:orgc4aeda4}Incidence of Chromosomal Abnormalities}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{./figures/ch5_nom.png}
\caption{\label{fig:org94ae09f}ISCN for Common Cytogenetic Aberration}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{./figures/ch5_nom2.png}
\caption{\label{fig:orgda0b7e9}ISCN (continued)}
\end{figure}

\subsection{Gene Dosage, Balance and Imbalance}
\label{sec:org95f8995}
\begin{itemize}
...
\item Aneuploidy
\label{sec:org985e386}
\begin{itemize}
\item most common cause is meiotic nondisjunction in meiosis I or II (Figure \ref{fig:org0d2494f})
\begin{description}
...
\caption{\label{fig:org0d2494f}Nondisjunction}
\end{figure}
\end{enumerate}

\subsection{Abnormalities of Chromosome Structure}
\label{sec:org4f9ff4f}
\begin{itemize}
...
\caption{\label{fig:org0a46e23}Structural Rearrangements of Chromosomes}
\end{figure}

\begin{enumerate}
\item Unbalanced rearrangements
\label{sec:orgaf11ae7}
\begin{itemize}
...
\caption{\label{fig:org75d75e6}Balanced Translocations}
\end{figure}
\end{enumerate}

\section{Chromosomal and Genomic basis of Disease}
\label{sec:orgfe1775b}
\begin{itemize}
...
\caption{\label{fig:orgdf5b199}Mechanisms of Chromosome Abnormalities and Genomic Imbalance}
\end{figure}

\subsection{Lessons From Genomic Disorders}
\label{sec:org7226b66}
\begin{itemize}
...
\begin{enumerate}
\item Down Syndrome
\label{sec:org5e63295}
\begin{itemize}
\item see conditions
\end{itemize}
\begin{enumerate}
\item Robertsonian Translocation
\label{sec:org4db4564}
\begin{itemize}
...
\caption{\label{fig:org0bcdc2a}Chromosomes of Gametes that Theoretically can be Produced by a Carrier of a Robertsonian Translocation, rob(14;21)}
\end{figure}
\end{enumerate}

\item Uniparental Disomy
\label{sec:orgb230c17}
\begin{itemize}
...
\caption{\label{fig:orgb10564a}Mechanism causing Prader-Willi and Angelman Syndrome}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:org66051fa}Sex Chromosome Constitution and X Inactiviation}
\centering
\begin{tabular}{llrr}
...
\caption{\label{fig:org940f369}Pedigree Symbols}
\end{figure}

\subsection{Autosomal Dominant Inheritance}
\label{sec:orga1be4cd}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org8d0894a}Genotypes and Phenotypes in X-linked Disease}
\centering
\begin{tabular}{lll}
 & genotype & phenotype\\
\hline
...
\label{sec:org12ad5d7}
\begin{enumerate}
\item Maternal Inheritance
\label{sec:org9fd7756}
\begin{itemize}
...
\label{sec:orga078083}
\subsection{Hardy-Weinberg}
\label{sec:org0aa522f}
\begin{itemize}
...
of the three genotypes (Table \ref{tab:orge944627})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orge944627}Population Frequency in Modes of Inheritance}
\centering
\begin{tabular}{llll}
...
\label{sec:org96a4a9e}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./figures/ch13_treatment.png}
\caption{\label{fig:org2165769}Levels of Treatment in Genetic Disease}
\end{figure}

\subsection{Manipulation of Metabolism}
\label{sec:orgbb833af}
\begin{description}
...
\label{sec:org36e9343}
\subsection{Malformations}
\label{sec:org692fa57}
\begin{itemize}
...
\caption{\label{fig:orgf99e4d5}Characteristic Chromosome Translocations in Selected Human Malignant Neoplasms}
\end{figure}

\subsection{Cytogenetic Changes in Cancer}
\label{sec:org42c261a}
\begin{enumerate}
\item Aneuploidy and Aneusomy
\label{sec:org2ed38fb}
\begin{itemize}
...
\caption{\label{fig:orgc3a5d21}Targeted cancer treatment}
\end{figure}

\section{Calculation of Genetic Risk}
\label{sec:org04d9ea7}
\begin{description}
...
post & 2/3 & 1/3\\
\end{tabular}
\end{center}\footnotetext[1]{\label{orge820750}prop of affected son}
...
\caption{\label{fig:org056f5ce}Mosaicism Detected in Prenatal Diagnsosis}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org1422611}First Trimester Screening Tests}
\centering
\begin{tabular}{llll}
...
\begin{table}[htbp]
\caption{\label{tab:org6f8b93a}Second Trimester Screening Tests}
\centering
\begin{tabular}{lllll}
