...
\label{sec:org4c3c9ae}
\subsection{Mitosis}
\label{sec:orgb1e4b06}
\begin{description}
...
\caption{\label{fig:org59a7f2d}Mitosis}
\end{figure}
...
\caption{\label{fig:org7a95365}Karyotype}
\end{figure}

\subsection{Meiosis}
\label{sec:org77ad2f5}
\subsubsection{Meiosis I}
\label{sec:orga86e8cb}
\begin{itemize}
...
\caption{\label{fig:org305de7f}Meiosis}
\end{figure}

\subsubsection{Homologous Recombination}
\label{sec:org5aef3ad}
\begin{itemize}
...
\caption{\label{fig:org914a7ab}X Inactivation}
\end{figure}

\section{Human Genetic Diversity}
\label{sec:org9d79c00}
\subsection{Inherited variation and polymorphism}
\label{sec:org5cd9ea6}
\begin{itemize}
\item SNPs
\item indels
\item microsatelite
...
\caption{\label{fig:org9a68d0a}Polymorphism}
\end{figure}


\subsection{Mutation Types}
\label{sec:org9963e5d}
\begin{itemize}
\item cell type:
\begin{itemize}
\item germline
...
\caption{\label{fig:org20b8808}Incidence of Chromosomal Abnormalities}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{./figures/ch5_nom.png}
\caption{\label{fig:org2caff1d}ISCN for Common Cytogenetic Aberration}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{./figures/ch5_nom2.png}
\caption{\label{fig:org19cac0f}ISCN (continued)}
\end{figure}

\subsection{Gene Dosage, Balance and Imbalance}
\label{sec:org662c6d9}
\begin{itemize}
...
\begin{itemize}
\item most common cause is meiotic nondisjunction in meiosis I or II (Figure \ref{fig:org8c7ad78})
\begin{description}
...
\caption{\label{fig:org8c7ad78}Nondisjunction}
\end{figure}

\subsection{Abnormalities of Chromosome Structure}
\label{sec:org08534ff}
\begin{itemize}
...
\caption{\label{fig:org82de1d1}Structural Rearrangements of Chromosomes}
\end{figure}

\subsubsection{Unbalanced Rearrangements}
\label{sec:org7a9a2a0}
\begin{itemize}
...
\caption{\label{fig:orgd0bcfc4}Balanced Translocations}
\end{figure}

\section{Chromosomal and Genomic Basis of Disease}
\label{sec:org7bbd35a}
\begin{itemize}
...
\caption{\label{fig:org44e47c8}Mechanisms of Chromosome Abnormalities and Genomic Imbalance}
\end{figure}

\subsection{Lessons from Genomic Disorders}
\label{sec:org32a7bb1}
\begin{itemize}
...
\label{sec:org0dab353}
\begin{itemize}
\item see Conditions
\end{itemize}
\begin{enumerate}
\item Robertsonian Translocation
\label{sec:org84d54c8}
\begin{itemize}
...
\caption{\label{fig:org0ba5e13}Chromosomes of Gametes that Theoretically can be Produced by a Carrier of a Robertsonian Translocation, rob(14;21)}
\end{figure}
\end{enumerate}

\subsubsection{Uniparental Disomy}
\label{sec:org61413f3}
\begin{itemize}
...
\caption{\label{fig:orgd0e7367}Mechanism causing Prader-Willi and Angelman Syndrome}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:org06810c5}Sex Chromosome Constitution and X Inactiviation}
\centering
\begin{tabular}{llrr}
...
\caption{\label{fig:org641db99}Pedigree Symbols}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:org80225a1}Genotypes and Phenotypes in X-linked Disease}
\centering
\begin{tabular}{lll}
 & genotype & phenotype\\
\hline
...
\label{sec:orgd78da3e}
\subsubsection{Maternal Inheritance}
\label{sec:orgf3046d8}
\begin{itemize}
...
\label{sec:org0db967a}
\subsection{Hardy-Weinberg}
\label{sec:org6f3af26}
\begin{itemize}
...
of the three genotypes (Table \ref{tab:orgaeb29b5})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgaeb29b5}Population Frequency in Modes of Inheritance}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orge5179f4}q = frequency of affected \male{} in XL disease}
...
\label{sec:org5ea7ea6}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./figures/ch13_treatment.png}
\caption{\label{fig:org4bff9f4}Levels of Treatment in Genetic Disease}
\end{figure}

\subsection{Manipulation of Metabolism}
\label{sec:org4836b94}
\begin{description}
...
\label{sec:orga7690e2}
\subsection{Malformations}
\label{sec:orgcdaa3df}
\begin{itemize}
...
\caption{\label{fig:org5e774fe}Characteristic Chromosome Translocations in Selected Human Malignant Neoplasms}
\end{figure}

\subsection{Cytogenetic Changes in Cancer}
\label{sec:orge4906be}
\subsubsection{Aneuploidy and Aneusomy}
\label{sec:orgb5b1108}
\begin{itemize}
...
\caption{\label{fig:org48cf06d}Targeted Cancer Treatment}
\end{figure}

\section{Calculation of Genetic Risk}
\label{sec:org3e83ed8}
\begin{description}
...
post & 2/3 & 1/3\\
\end{tabular}
\end{center}\footnotetext[2]{\label{org7ce6ec2}prop of affected son}
...
\begin{table}[htbp]
\caption{\label{tab:org618de35}Punnett Square for AR Disease}
\centering
\begin{tabular}{lll}
 & A & a\\
A & AA & Aa\\
...
\caption{\label{fig:orgdcba1ae}Mosaicism Detected in Prenatal Diagnsosis}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org4b47b20}First Trimester Screening Tests}
\centering
\begin{tabular}{llll}
...
\begin{table}[htbp]
\caption{\label{tab:org5af2580}Second Trimester Screening Tests}
\centering
\begin{tabular}{lllll}
...
\label{sec:org5f58194}
\subsection{General Recommendations}
\label{sec:org637db3e}
\begin{itemize}
