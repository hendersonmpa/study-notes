...
\label{sec:org1d9f801}
\subsection{Mitosis}
\label{sec:org70ee515}
\begin{description}
...
\caption{\label{fig:orgfb4a4bf}Mitosis}
\end{figure}
...
\caption{\label{fig:orgcbc5d55}Karyotype}
\end{figure}

\subsection{Meiosis}
\label{sec:org4902c83}
\subsubsection{Meiosis I}
\label{sec:org3f9a751}
\begin{itemize}
...
\caption{\label{fig:orgef352b0}Meiosis}
\end{figure}

\subsubsection{Homologous Recombination}
\label{sec:orgd3f1a31}
\begin{itemize}
...
\caption{\label{fig:org77cd561}X Inactivation}
\end{figure}

\section{Human Genetic Diversity}
\label{sec:orgd3ecc54}
\subsection{Inherited variation and polymorphism}
\label{sec:orgc98e5d6}
\begin{itemize}
\item SNPs
\item indels
\item microsatelite
...
\caption{\label{fig:orgcb929ae}Polymorphism}
\end{figure}


\subsection{Mutation Types}
\label{sec:org831ed9c}
\begin{itemize}
\item cell type:
\begin{itemize}
\item germline
...
\caption{\label{fig:org5597064}Incidence of Chromosomal Abnormalities}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{./figures/ch5_nom.png}
\caption{\label{fig:org6b4c96b}ISCN for Common Cytogenetic Aberration}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{./figures/ch5_nom2.png}
\caption{\label{fig:orgc9a2878}ISCN (continued)}
\end{figure}

\subsection{Gene Dosage, Balance and Imbalance}
\label{sec:org79abe37}
\begin{itemize}
...
\begin{itemize}
\item most common cause is meiotic nondisjunction in meiosis I or II (Figure \ref{fig:org08fc6ad})
\begin{description}
...
\caption{\label{fig:org08fc6ad}Nondisjunction}
\end{figure}

\subsection{Abnormalities of Chromosome Structure}
\label{sec:orgba65f61}
\begin{itemize}
...
\caption{\label{fig:org60b67dc}Structural Rearrangements of Chromosomes}
\end{figure}

\subsubsection{Unbalanced Rearrangements}
\label{sec:orgf76ef96}
\begin{itemize}
...
\caption{\label{fig:orgb65fe25}Balanced Translocations}
\end{figure}

\section{Chromosomal and Genomic basis of Disease}
\label{sec:org3d28902}
\begin{itemize}
...
\caption{\label{fig:org0b2c58b}Mechanisms of Chromosome Abnormalities and Genomic Imbalance}
\end{figure}

\subsection{Lessons from Genomic Disorders}
\label{sec:org76b41b5}
\begin{itemize}
...
\label{sec:org1fcd55f}
\begin{itemize}
\item see Conditions
\end{itemize}
\begin{enumerate}
\item Robertsonian Translocation
\label{sec:orgf50f1ca}
\begin{itemize}
...
\caption{\label{fig:org0587ddf}Chromosomes of Gametes that Theoretically can be Produced by a Carrier of a Robertsonian Translocation, rob(14;21)}
\end{figure}
\end{enumerate}

\subsubsection{Uniparental Disomy}
\label{sec:orgc98343b}
\begin{itemize}
...
\caption{\label{fig:org9861efe}Mechanism causing Prader-Willi and Angelman Syndrome}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:orge958955}Sex Chromosome Constitution and X Inactiviation}
\centering
\begin{tabular}{llrr}
...
\caption{\label{fig:org4373937}Pedigree Symbols}
\end{figure}

\subsection{Autosomal Dominant Inheritance}
\label{sec:orgf8b555c}
\begin{itemize}
...
\label{sec:orgea2bae5}
\begin{description}
\item[{confined placental}] discrepancy between the chromosomal makeup of
the cells in the placenta and the cells in the fetus (Figure \ref{fig:org4f1e495})
...
\begin{table}[htbp]
\caption{\label{tab:org15ae2fd}Genotypes and Phenotypes in X-linked Disease}
\centering
\begin{tabular}{lll}
 & genotype & phenotype\\
\hline
...
\label{sec:org5075822}
\subsubsection{Maternal Inheritance}
\label{sec:org67277e0}
\begin{itemize}
...
\label{sec:org397e1b2}
\subsection{Hardy-Weinberg}
\label{sec:org50a4f7f}
\begin{itemize}
...
of the three genotypes (Table \ref{tab:org99918c3})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org99918c3}Population Frequency in Modes of Inheritance}
\centering
\begin{tabular}{llll}
...
XL & 1/2 \(\cdot\) q\textsuperscript{2} & X\textsubscript{M}Y & hemizygote \male\\
\end{tabular}
\end{table}
...
\label{sec:org00027d6}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./figures/ch13_treatment.png}
\caption{\label{fig:org6dd3686}Levels of Treatment in Genetic Disease}
\end{figure}

\subsection{Manipulation of Metabolism}
\label{sec:orga93c1ec}
\begin{description}
...
\label{sec:orgddc39b0}
\subsection{Malformations}
\label{sec:org3297b39}
\begin{itemize}
...
\caption{\label{fig:org061d944}Characteristic Chromosome Translocations in Selected Human Malignant Neoplasms}
\end{figure}

\subsection{Cytogenetic Changes in Cancer}
\label{sec:org5312991}
\subsubsection{Aneuploidy and Aneusomy}
\label{sec:org4845211}
\begin{itemize}
...
\caption{\label{fig:org3652140}Targeted Cancer Treatment}
\end{figure}

\section{Calculation of Genetic Risk}
\label{sec:org3507b8b}
\begin{description}
...
post & 2/3 & 1/3\\
\end{tabular}
\end{center}\footnotetext[1]{\label{org39b597f}prop of affected son}
...
\begin{table}[htbp]
\caption{\label{tab:org1300c7c}Punnett Square for AR Disease}
\centering
\begin{tabular}{lll}
 & A & a\\
A & AA & Aa\\
...
\caption{\label{fig:org4f1e495}Mosaicism Detected in Prenatal Diagnsosis}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org37c2f9a}First Trimester Screening Tests}
\centering
\begin{tabular}{llll}
...
\begin{table}[htbp]
\caption{\label{tab:org13334f1}Second Trimester Screening Tests}
\centering
\begin{tabular}{lllll}
