...
\label{sec:orgefee97f}
\subsection{Mitosis}
\label{sec:org1ce3edd}
\begin{description}
...
\caption{\label{fig:orga431423}Mitosis}
\end{figure}
...
\caption{\label{fig:org01b62dc}Karyotype}
\end{figure}

\subsection{Meiosis}
\label{sec:org705846d}
...
\caption{\label{fig:orgc9729ab}Meiosis}
\end{figure}


\subsection{Homologous Recombination}
\label{sec:orgb4d7f28}
...
\caption{\label{fig:org44545e9}Polymorphism}
\end{figure}


\subsection{Origins and Freq of Mutation types}
\label{sec:orgc943ba7}
\begin{itemize}
\item germline
\item somatic
\item Mutations:
...
\caption{\label{fig:orga962d97}Incidence of chromosomal abnormalities}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{./figures/ch5_nom.png}
\caption{\label{fig:org5368ec6}ISCN for common cytogenetic aberration}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{./figures/ch5_nom2.png}
\caption{\label{fig:orgc5ece71}ISCN (continued)}
\end{figure}

\subsection{Gene Dosage, Balance and Imbalance}
\label{sec:org1dc9c4b}
\begin{itemize}
...
\item Aneuploidy
\label{sec:org40b1aeb}
\begin{itemize}
\item most common cause is meiotic nondisjunction in meiosis I or II (Figure \ref{fig:orgb7d252e})
\begin{description}
...
\caption{\label{fig:orgb7d252e}Nondisjunction}
\end{figure}
\end{enumerate}

\subsection{Abnormalities of Chromosome Structure}
\label{sec:orgc5a5f57}
\begin{itemize}
...
\caption{\label{fig:orgbcabdf2}Structural rearrangements of chromosomes}
\end{figure}

\begin{enumerate}
\item Unbalanced rearrangements
\label{sec:orgc803605}
\begin{itemize}
...
\caption{\label{fig:org4f50f42}Mechanisms of chromosome abnormalities and genomic imbalance}
\end{figure}

\subsection{Lessons From Genomic Disorders}
\label{sec:org0016c95}
\begin{itemize}
...
\begin{enumerate}
\item Down Syndrome
\label{sec:org8515082}
\begin{itemize}
\item see conditions
\end{itemize}
\begin{enumerate}
\item Robertsonian Translocation
\label{sec:orgb10df9a}
\begin{itemize}
...
\caption{\label{fig:org11e4a03}Chromosomes of gametes that theoretically can be produced by a carrier of a Robertsonian translocation, rob(14;21)}
\end{figure}
\end{enumerate}

\item Uniparental Disomy
\label{sec:org9dc65ef}
\begin{itemize}
...
\caption{\label{fig:org4069669}Characteristic Chromosome Translocations in Selected Human Malignant Neoplasms}
\end{figure}

\subsection{Cytogenetic Changes in Cancer}
\label{sec:orgf3214aa}

\begin{enumerate}
\item Aneuploidy and Aneusomy
\label{sec:org850b20e}
\begin{itemize}
...
\caption{\label{fig:org385cf2a}Targeted cancer treatment}
\end{figure}

\section{{\bfseries\sffamily STARTED} Chapter 16: Risk}
\label{sec:org04506c4}
\subsection{X linked}
\label{sec:orgad9e5e1}
\begin{enumerate}
\item Transmission
\label{sec:orgbcbe69f}
\begin{itemize}
...
post & 2/3 & 1/3\\
\end{tabular}
\end{center}\footnotetext[1]{\label{orga9f6ef2}Prop of affected son}
