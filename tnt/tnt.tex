...
\label{sec:orgcacf006}
\subsection{Mitosis}
\label{sec:orgc79554a}
\begin{description}
...
\caption{\label{fig:orge723e95}
Karyotype}
\end{figure}

\subsection{Meiosis}
\label{sec:org04e4c23}
...
\caption{\label{fig:org363e5af}
Meiosis}
\end{figure}


\subsection{Homologous Recombination}
\label{sec:org84fe9b1}
...
\caption{\label{fig:orgea15ae4}
Polymorphism}
\end{figure}


\subsection{Origins and Freq of Mutation types}
\label{sec:org1808325}
\begin{itemize}
\item germline
\item somatic
\item Mutations:
...
\caption{\label{fig:orgab8a5ca}
ISCN (continued)}
\end{figure}

\subsection{Gene Dosage, Balance and Imbalance}
\label{sec:orgff116e2}
\begin{itemize}
...
\item Aneuploidy
\label{sec:orgd4ab8b0}
\begin{itemize}
\item most common cause is meiotic nondisjunction in meiosis I or II (Figure \ref{fig:orgf0bc8ec})
\begin{description}
...
\caption{\label{fig:orgf0bc8ec}
Nondisjunction}
\end{figure}
\end{enumerate}

\subsection{Abnormalities of Chromosome Structure}
\label{sec:org2432b33}
\begin{itemize}
...
\begin{enumerate}
\item Down Syndrome
\label{sec:orga900657}
\begin{itemize}
\item see conditions
\end{itemize}
\begin{enumerate}
\item Robertsonian Translocation
\label{sec:org5285f7f}
\begin{itemize}
...
\caption{\label{fig:orgcc5c39d}
Targeted cancer treatment}
\end{figure}

\section{{\bfseries\sffamily STARTED} Chapter 16: Risk}
\label{sec:orgb19f34b}
\subsection{X linked}
\label{sec:org1c2d686}
\begin{enumerate}
\item Transmission
\label{sec:org3b266c9}
\begin{itemize}
...
post & 2/3 & 1/3\\
\end{tabular}
\end{center}\footnotetext[1]{\label{orgbe920db}Prop of affected son}
