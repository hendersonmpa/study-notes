...
\caption{\label{fig:org1385976}Karyotype}
\end{figure}

\subsection{Meiosis}
\label{sec:org739a805}
...
\caption{\label{fig:org8e1de4b}Meiosis}
\end{figure}

\subsection{Homologous Recombination}
\label{sec:org76b9496}
...
\caption{\label{fig:orge1d5d59}X Inactivation}
\end{figure}

\section{Human Genetic Diversity}
\label{sec:orgb9490d3}
\subsection{Inherited variation and polymorphism}
\label{sec:orgae39ec6}
\begin{itemize}
\item SNPs
\item indels
\item microsatelite
...
\caption{\label{fig:org20e6862}Polymorphism}
\end{figure}


\subsection{Origins and Freq of Mutation types}
\label{sec:org100c1be}
\begin{itemize}
\item germline
\item somatic
\item mutations:
...
\caption{\label{fig:org3e4f9f9}Incidence of Chromosomal Abnormalities}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{./figures/ch5_nom.png}
\caption{\label{fig:org2c107db}ISCN for Common Cytogenetic Aberration}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{./figures/ch5_nom2.png}
\caption{\label{fig:org8a8de95}ISCN (continued)}
\end{figure}

\subsection{Gene Dosage, Balance and Imbalance}
\label{sec:org6be1a0d}
\begin{itemize}
...
\item Aneuploidy
\label{sec:orgb0fd1f3}
\begin{itemize}
\item most common cause is meiotic nondisjunction in meiosis I or II (Figure \ref{fig:org62d415c})
\begin{description}
...
\caption{\label{fig:org62d415c}Nondisjunction}
\end{figure}
\end{enumerate}

\subsection{Abnormalities of Chromosome Structure}
\label{sec:org92be7f7}
\begin{itemize}
...
\caption{\label{fig:orge157ef0}Structural Rearrangements of Chromosomes}
\end{figure}

\begin{enumerate}
\item Unbalanced rearrangements
\label{sec:orgdd500bb}
\begin{itemize}
...
\caption{\label{fig:org13febb5}Balanced Translocations}
\end{figure}
\end{enumerate}

\section{Chromosomal and Genomic basis of Disease}
\label{sec:org2ab8ba2}
\begin{itemize}
...
\caption{\label{fig:orgcb29c10}Mechanisms of Chromosome Abnormalities and Genomic Imbalance}
\end{figure}

\subsection{Lessons From Genomic Disorders}
\label{sec:org829f785}
\begin{itemize}
...
\begin{enumerate}
\item Down Syndrome
\label{sec:org64b586c}
\begin{itemize}
\item see conditions
\end{itemize}
\begin{enumerate}
\item Robertsonian Translocation
\label{sec:orgf880141}
\begin{itemize}
...
\caption{\label{fig:org46ac051}Chromosomes of Gametes that Theoretically can be Produced by a Carrier of a Robertsonian Translocation, rob(14;21)}
\end{figure}
\end{enumerate}

\item Uniparental Disomy
\label{sec:org3eb73d0}
\begin{itemize}
...
\caption{\label{fig:org8a6b0b9}Mechanism causing Prader-Willi and Angelman Syndrome}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:orgfd405fe}Sex Chromosome Constitution and X Inactiviation}
\centering
\begin{tabular}{llrr}
...
\caption{\label{fig:org96d251d}Pedigree Symbols}
\end{figure}

\subsection{Autosomal Dominant Inheritance}
\label{sec:orgc91ca39}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orge3cd711}Genotypes and Phenotypes in X-linked Disease}
\centering
\begin{tabular}{lll}
 & genotype & phenotype\\
\hline
...
\label{sec:org896271a}
\begin{enumerate}
\item Maternal Inheritance
\label{sec:org9d488f4}
\begin{itemize}
...
\label{sec:org13cef9c}
\subsection{Hardy-Weinberg}
\label{sec:org9b8a4d2}
\begin{itemize}
...
of the three genotypes (Table \ref{tab:org248949f})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org248949f}Population Frequency in Modes of Inheritance}
\centering
\begin{tabular}{llll}
...
\label{sec:org992a107}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./figures/ch13_treatment.png}
\caption{\label{fig:org9539765}Levels of Treatment in Genetic Disease}
\end{figure}

\subsection{Manipulation of Metabolism}
\label{sec:org55afdcb}
\begin{description}
...
\label{sec:org407daa0}
\subsection{Malformations}
\label{sec:org26f06af}
\begin{itemize}
...
\caption{\label{fig:org7e675fd}Characteristic Chromosome Translocations in Selected Human Malignant Neoplasms}
\end{figure}

\subsection{Cytogenetic Changes in Cancer}
\label{sec:orgaa8dce8}
\begin{enumerate}
\item Aneuploidy and Aneusomy
\label{sec:orgd370d87}
\begin{itemize}
...
\caption{\label{fig:org38bcd53}Targeted cancer treatment}
\end{figure}

\section{Calculation of Genetic Risk}
\label{sec:org235a2d1}
\begin{description}
...
post & 2/3 & 1/3\\
\end{tabular}
\end{center}\footnotetext[1]{\label{org3388153}prop of affected son}
...
\caption{\label{fig:org5fd8ec4}Mosaicism Detected in Prenatal Diagnsosis}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org8d58c53}First Trimester Screening Tests}
\centering
\begin{tabular}{llll}
...
\begin{table}[htbp]
\caption{\label{tab:org336d8f1}Second Trimester Screening Tests}
\centering
\begin{tabular}{lllll}
