...
\label{sec:org7a4fbab}
\subsection{Mitosis}
\label{sec:orgba2915d}
\begin{description}
...
\caption{\label{fig:org1a43c52}Mitosis}
\end{figure}
...
\caption{\label{fig:org956dab3}Karyotype}
\end{figure}

\subsection{Meiosis}
\label{sec:org07bf0c7}
...
\caption{\label{fig:org379a2fb}Meiosis}
\end{figure}


\subsection{Homologous Recombination}
\label{sec:org4b50f5a}
...
\caption{\label{fig:orgfc99a94}Polymorphism}
\end{figure}


\subsection{Origins and Freq of Mutation types}
\label{sec:orgf166389}
\begin{itemize}
\item germline
\item somatic
\item Mutations:
...
\caption{\label{fig:org1eb4fbb}Incidence of chromosomal abnormalities}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{./figures/ch5_nom.png}
\caption{\label{fig:orgcdd639b}ISCN for common cytogenetic aberration}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{./figures/ch5_nom2.png}
\caption{\label{fig:orgef7a09c}ISCN (continued)}
\end{figure}

\subsection{Gene Dosage, Balance and Imbalance}
\label{sec:orge330af0}
\begin{itemize}
...
\item Aneuploidy
\label{sec:orgf6bb9b2}
\begin{itemize}
\item most common cause is meiotic nondisjunction in meiosis I or II (Figure \ref{fig:org67ed7cb})
\begin{description}
...
\caption{\label{fig:org67ed7cb}Nondisjunction}
\end{figure}
\end{enumerate}

\subsection{Abnormalities of Chromosome Structure}
\label{sec:org39406bf}
\begin{itemize}
...
\caption{\label{fig:orgca06382}Structural rearrangements of chromosomes}
\end{figure}

\begin{enumerate}
\item Unbalanced rearrangements
\label{sec:org7dc87f0}
\begin{itemize}
...
\caption{\label{fig:orgf7fa0b5}Mechanisms of chromosome abnormalities and genomic imbalance}
\end{figure}

\subsection{Lessons From Genomic Disorders}
\label{sec:org65fcbc9}
\begin{itemize}
...
\begin{enumerate}
\item Down Syndrome
\label{sec:org17b6127}
\begin{itemize}
\item see conditions
\end{itemize}
\begin{enumerate}
\item Robertsonian Translocation
\label{sec:org19a8a1b}
\begin{itemize}
...
\caption{\label{fig:orgbe39f10}Chromosomes of gametes that theoretically can be produced by a carrier of a Robertsonian translocation, rob(14;21)}
\end{figure}
\end{enumerate}

\item Uniparental Disomy
\label{sec:org975c1a5}
\begin{itemize}
...
expansion of (p + q)\textsuperscript{2} = p\textsuperscript{2} + 2pq + q\textsuperscript{2}
...
\caption{\label{fig:org37cdb61}Characteristic Chromosome Translocations in Selected Human Malignant Neoplasms}
\end{figure}

\subsection{Cytogenetic Changes in Cancer}
\label{sec:orgbd5915c}

\begin{enumerate}
\item Aneuploidy and Aneusomy
\label{sec:org52ca287}
\begin{itemize}
...
\caption{\label{fig:org2053c09}Targeted cancer treatment}
\end{figure}

\section{{\bfseries\sffamily STARTED} Chapter 16: Risk}
\label{sec:orgbdf6d97}
\subsection{X linked}
\label{sec:orgd620731}
\begin{enumerate}
\item Transmission
\label{sec:orge179b0a}
\begin{itemize}
...
post & 2/3 & 1/3\\
\end{tabular}
\end{center}\footnotetext[1]{\label{org256ee48}Prop of affected son}
