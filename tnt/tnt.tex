...
\label{sec:org00ac66e}
\subsection{Mitosis}
\label{sec:org16bfa44}
\begin{description}
...
\caption{\label{fig:org0717aed}Mitosis}
\end{figure}
...
\caption{\label{fig:org6a8570b}Karyotype}
\end{figure}

\subsection{Meiosis}
\label{sec:org3facb0d}
...
\caption{\label{fig:org9c234b2}Meiosis}
\end{figure}

\subsection{Homologous Recombination}
\label{sec:orga8cf1ed}
...
\caption{\label{fig:orgcfe1e08}X Inactivation}
\end{figure}

\section{Human Genetic Diversity}
\label{sec:org233466a}
\subsection{Inherited variation and polymorphism}
\label{sec:org31de7a3}
\begin{itemize}
\item SNPs
\item indels
\item microsatelite
...
\caption{\label{fig:orgf1fd574}Polymorphism}
\end{figure}


\subsection{Origins and Freq of Mutation types}
\label{sec:org2925f41}
\begin{itemize}
\item germline
\item somatic
\item mutations:
...
\caption{\label{fig:org5622d14}Incidence of Chromosomal Abnormalities}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{./figures/ch5_nom.png}
\caption{\label{fig:orge976cc2}ISCN for Common Cytogenetic Aberration}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{./figures/ch5_nom2.png}
\caption{\label{fig:org9e8829b}ISCN (continued)}
\end{figure}

\subsection{Gene Dosage, Balance and Imbalance}
\label{sec:org6e6bcd7}
\begin{itemize}
...
\item Aneuploidy
\label{sec:orgd098798}
\begin{itemize}
\item most common cause is meiotic nondisjunction in meiosis I or II (Figure \ref{fig:orgd693bbe})
\begin{description}
...
\caption{\label{fig:orgd693bbe}Nondisjunction}
\end{figure}
\end{enumerate}

\subsection{Abnormalities of Chromosome Structure}
\label{sec:orgfd0f8c1}
\begin{itemize}
...
\caption{\label{fig:org00b2f2d}Structural Rearrangements of Chromosomes}
\end{figure}

\begin{enumerate}
\item Unbalanced rearrangements
\label{sec:orgeab6a48}
\begin{itemize}
...
\caption{\label{fig:orgb4fdf13}Balanced Translocations}
\end{figure}
\end{enumerate}

\section{Chromosomal and Genomic basis of Disease}
\label{sec:org7c7ecfb}
\begin{itemize}
...
\caption{\label{fig:org55f21d3}Mechanisms of Chromosome Abnormalities and Genomic Imbalance}
\end{figure}

\subsection{Lessons From Genomic Disorders}
\label{sec:orgbe9bd1e}
\begin{itemize}
...
\begin{enumerate}
\item Down Syndrome
\label{sec:orgba20508}
\begin{itemize}
\item see conditions
\end{itemize}
\begin{enumerate}
\item Robertsonian Translocation
\label{sec:org8475a10}
\begin{itemize}
...
\caption{\label{fig:orgdbd48e1}Chromosomes of Gametes that Theoretically can be Produced by a Carrier of a Robertsonian Translocation, rob(14;21)}
\end{figure}
\end{enumerate}

\item Uniparental Disomy
\label{sec:org4d48345}
\begin{itemize}
...
\caption{\label{fig:orgedd7c5f}Mechanism causing Prader-Willi and Angelman Syndrome}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:org95f791a}Sex Chromosome Constitution and X Inactiviation}
\centering
\begin{tabular}{llrr}
...
\caption{\label{fig:orgaf28cf3}Pedigree Symbols}
\end{figure}

\subsection{Autosomal Dominant Inheritance}
\label{sec:org3c990cb}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org8c09340}Genotypes and Phenotypes in X-linked Disease}
\centering
\begin{tabular}{lll}
 & genotype & phenotype\\
\hline
...
\label{sec:org2b0ce69}
\begin{enumerate}
\item Maternal Inheritance
\label{sec:org57a0dd6}
\begin{itemize}
...
\label{sec:org42437d1}
\subsection{Hardy-Weinberg}
\label{sec:org78bf242}
\begin{itemize}
...
of the three genotypes (Table \ref{tab:orge11e7d1})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orge11e7d1}Population Frequency in Modes of Inheritance}
\centering
\begin{tabular}{llll}
...
\label{sec:orgc560d29}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./figures/ch13_treatment.png}
\caption{\label{fig:org465cb6e}Levels of Treatment in Genetic Disease}
\end{figure}

\subsection{Manipulation of Metabolism}
\label{sec:org9777ed2}
\begin{description}
...
\label{sec:orgb85f117}
\subsection{Malformations}
\label{sec:org0622d75}
\begin{itemize}
...
\caption{\label{fig:org1ecb417}Characteristic Chromosome Translocations in Selected Human Malignant Neoplasms}
\end{figure}

\subsection{Cytogenetic Changes in Cancer}
\label{sec:orga8ed2c0}
\begin{enumerate}
\item Aneuploidy and Aneusomy
\label{sec:org5f66f4f}
\begin{itemize}
...
\caption{\label{fig:org6cf4f4f}Targeted cancer treatment}
\end{figure}

\section{Calculation of Genetic Risk}
\label{sec:orgeea7aeb}
\begin{description}
...
post & 2/3 & 1/3\\
\end{tabular}
\end{center}\footnotetext[1]{\label{org886b358}Prop of affected son}
...
\begin{table}[htbp]
\caption{\label{tab:org1d35fa6}Punnett Square for AR Disease}
\centering
\begin{tabular}{lll}
 & A & a\\
A & AA & Aa\\
...
\caption{\label{fig:org298265f}Mosaicism Detected in Prenatal Diagnsosis}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org2134067}First Trimester Screening Tests}
\centering
\begin{tabular}{llll}
...
\begin{table}[htbp]
\caption{\label{tab:org19f6f96}Second Trimester Screening Tests}
\centering
\begin{tabular}{lllll}
