...
** Method
- oxidized Hcy that is bound to protein is reduced to free Hcy
- Hcy then reacts with S-adenosylmethionine (SAM), to form methionine
  (Met) and S-adenosyl homocysteine (SAH), catalyzed by a Hcy
  S-methyl transferase (HMTase)
- SAH is assessed by coupled enzyme reactions where SAH is hydrolyzed
  ...
  adenosine is immediately hydrolyzed into inosine and ammonia (NH_3).
- glutamate dehydrogenase (GLDH) catalyzes the reaction of ammonia
  with 2-oxoglutarate and NADH to form NAD^+
- Photometric measurement: the concentration of Hcy in the sample is
