...
\section{NBS}
\label{sec:orgcda51ce}
\subsection{Dried Blood Spot}
\label{sec:orgc723d65}
\begin{itemize}
...
\subsection{AAAC}
\label{sec:orga2df83c}
\begin{enumerate}
\item FIA-MS/MS schematic
\label{sec:org3a4e806}
\begin{center}
...
\caption{\label{fig:org415b5cf}
FIA-MS/MS Method}
\end{figure}

\item AA NL Scan
\label{sec:orgdcf611c}
\begin{itemize}
...
201–202.\label{orgbae2158}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgb4dffcc}
...
used with caution." \textsuperscript{\ref{orgbae2158}}
\end{itemize}

\item Pros and Cons of FIA-MS/MS using DBS
\label{sec:org4b29776}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:orgafa4e38}
\begin{itemize}
...
\section{Amino Acids}
\label{sec:org14ccd72}
\subsection{Introduction}
\label{sec:org28222d6}
\begin{enumerate}
\item Amino Acids: A Very Short Introduction
\label{sec:org7260ad3}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org6f55ed7}Plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[3]{\label{org3fe4d44}Sulphocysteine may not be detectable in plasma using routine methods}

\item Plasma
\label{sec:org059047d}
\begin{itemize}
\item Patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:org4ff046b}
\begin{enumerate}
\item LC-MS/MS schematic
\label{sec:org7b74fc8}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\label{sec:org6058e69}
\begin{itemize}
\item As compared to FIA-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org718609f}
\begin{itemize}
...
\label{sec:org9ffb9ad}
\begin{enumerate}
\item What are urine organic acids?
\label{sec:org87a1cd3}
\begin{itemize}
...
\label{sec:org66c60a3}

\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}

\begin{table}[htbp]
\caption{\label{tab:org4f7547e}
...
\item Side Chains
\label{sec:orgd62608d}

\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}

\begin{table}[htbp]
\caption{\label{tab:orgd0e89be}
...
\label{sec:org3c92737}
\begin{enumerate}
\item Endogenous Sources
\label{sec:org2b1b6cf}
\begin{itemize}
...
\label{sec:org761eb0e}
\begin{enumerate}
\item Oximation
\label{sec:orgb2a04b6}
\begin{itemize}
...
\label{sec:org0804cd6}

\item Mass-spectroscopy
\label{sec:org632f3a8}

\item Reporting
\label{sec:org5fbcea2}
\end{enumerate}
\section{Mitochondria}
\label{sec:orgd8ed413}
\subsection{Introduction}
\label{sec:org7fac75b}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:orgd0c83c8}
Electron Transport Chain}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:org9504181}
\begin{enumerate}
\item CI
\label{sec:org9b2bde2}
\begin{itemize}
...
\label{sec:org9190f93}
\subsection{CI+III assay}
\label{sec:org3d8fe92}
\begin{enumerate}
\item Purpose
\label{sec:orgb14d7f4}
\begin{itemize}
...
\label{sec:org1c57ba9}
\begin{enumerate}
\item Purpose
\label{sec:org2bdc09a}
\begin{itemize}
\item Complex II activity
\end{itemize}
\item Principle
\label{sec:orgc20ebec}
\begin{itemize}
...
\label{sec:org5e89df7}
\begin{enumerate}
\item Purpose
\label{sec:org6f907f1}
\begin{itemize}
...
\label{sec:org475efcd}
\begin{enumerate}
\item Purpose
\label{sec:org7f05b2d}
\begin{itemize}
...
\end{itemize}
\section{NIET}
\label{sec:org7caa313}
\subsection{Exercising Muscle}
\label{sec:orgaa75924}
\begin{enumerate}
\item Lactate
\label{sec:orgf37d03e}
\begin{itemize}
...
\caption{\label{fig:orgdb6c489}
LDH}
\end{figure}

\item ATP
\label{sec:orgf65289b}
\begin{itemize}
...
\caption[gln]{\label{fig:org93c1f24}
...
\caption[interp]{\label{fig:orge2bdd1d}
NIET Results}
\end{figure}
\end{enumerate}
...
\label{sec:orgdc92a55}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./niet/figures/niet_method.png}
\caption{\label{fig:orgefa6ac1}
NIET Method}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org408eb2c}
NIET in Myopathy}
\centering
\begin{tabular}{lll}
 & Lactate & Ammonia\\
...
\end{table}
\section{Porphyrins}
\label{sec:orgec8a5cf}
\subsection{Methods for Metabolites}
\label{sec:orgc8a5340}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:org7d19a49}
\begin{enumerate}
\item Porphobilinogen
\label{sec:org599bebd}
\begin{itemize}
