...
\section{NBS}
\label{sec:org0699c09}
\subsection{Dried Blood Spot}
\label{sec:org5179923}
\begin{itemize}
...
\subsection{AAAC}
\label{sec:orga2261da}
\begin{enumerate}
\item FIA-MS/MS schematic
\label{sec:orgd676e6e}
\begin{center}
...
\centering
\schemestart
\chemname{\chemfig{{\color{red}R}-[::-60](<[::-60]NH_3^+)-[::60](=[::60]O)-[::-60]OH}}{\tiny \textalpha{}-amino acid}
\+
\chemname{\chemfig{HO-[::30]-[::-60]-[::60]-[::-60]}}{\tiny n-butanol}
\arrow{-U>[][{\tiny \ce{H2O}}]}
...
\centering
\schemestart
\chemname{\chemfig{-N^{+}([2]-)([6]-)-[1]-[7]([6]-O-([5]=O)!e)-[1]-[7]([7]=O)([1]-O^{-})}}{\tiny C5-carnitine}
\+
\chemname{\chemfig{HO!x!x}}{\tiny n-butanol}
\arrow{-U>[][{\tiny \ce{H2O}}]}
\chemname{\chemfig{-N^{+}([2]-)([6]-)-[1]-[7]([6]-O-([5]=O)!e)-[1]-[7]([6]=O)-[1,.6]O!y!y}}{\tiny C5-carnitine, butyl ester}
\schemestop
\vspace{2em}
\schemestart
\chemname{\chemfig{-N^{+}([2]-)([6]-)-[1]-[7]([6]-O-([5]=O)!d)-[1]-[7]([7]=O)([1]-O^{-})}}{\tiny C6DC-carnitine}
\+
\chemname{\chemfig{HO!x!x}}{\tiny n-butanol}
\arrow{-U>[][{\tiny \ce{2H2O}}]}
\chemname{\chemfig{-N^{+}([2]-)([6]-)-[1]-[7]([6]-O-([5]=O)!e-[7,.6]O!x!x)-[1]-[7]([6]=O)-[1,.6]O!y!y}}{\tiny C6DC-carnitine, butyl ester}
\schemestop 

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./nbs/figures/outletmethod.pdf}
\caption{\label{fig:org8a08b63}
FIA-MS/MS Method}
\end{figure}

\item AA NL Scan
\label{sec:org1182402}
\begin{itemize}
...
\centering
\schemestart
\chemname{\chemfig{H_2N-[::30,,2,](=[::60]O)-[::-60]NH-[::60]-[::-60]-[::60]-[::-60](<[::-60]NH_3^+)-[::60](=[::60]O)-[::-60]OH}}{\tiny citrulline 175 Da}
\+
\chemname{\chemfig{HO-[::30]-[::-60]-[::60]-[::-60]}}{\tiny n-butanol 74 Da}
\arrow{-U>[][{\tiny \ce{H2O}}]}
\chemname{\chemfig{H_2N-[::30,,2,](=[::60]O)-[::-60]NH-[::60]-[::-60]-[::60]-[::-60](<[::-60]NH_3^+)-[::60](=[::60]O)-[::-60]O-[::60]-[::-60]-[::60]-[::-60]}}{\tiny 232 Da}
\schemestop

\centering
\schemestart
\chemname{\chemfig{H_2N-[::60]-[::-60]-[::60]-[::-60]-[::60]N=O=C}}{\tiny 113 Da}
\+
\chemname{\chemfig{H-[::60](=[::60]O)-[::-60]O-[::60]-[::-60]-[::60]-[::-60]}}{\tiny 102 Da}
\+
\chemname{\chemfig{NH_3}}{\tiny 17 Da}
\schemestop

\begin{table}[htbp]
\caption{\label{tab:orgf308a99}
...
\definesubmol{x}{-[1,.6]-[7,.6]}
\centering
 \chemname{\chemfig{H_{3}C-N^{+}([2]-CH_3)([6]-CH_{3})-CH_2-C([2]-H)([6]-O-C([0]=O)-{\color{red}R})-CH_2-C([2]=O)-O-CH_2-CH_2-CH_2-CH_3}}{\tiny acylcarnitine, butyl ester}

\vspace{2.5em}

 \chemname{\chemfig{H_{3}C-N([1]-CH_3)([7]-CH_3)}}{\tiny trimethylamine}
\hspace{2em}
\chemname{\chemfig{{\color{red}R}-C([1]=O)([7]-OH)}}{\tiny carboxylic acid}
\hspace{2em}
 \chemname{\chemfig{H!x!x}}{\tiny butyl group}
\hspace{2em}
 \chemname{\chemfig{H_{2}C^{+}-HC=CH-C([1]=O)([7]-OH)}}{\tiny 85 m/z}
...
201–202.\label{org45541c9}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgae82289}
...
used with caution." \textsuperscript{\ref{org45541c9}}
\end{itemize}

\item Pros and Cons of FIA-MS/MS using DBS
\label{sec:org9fcd684}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:orgaf9ab05}
\begin{itemize}
...
\end{enumerate}
\section{Amino Acids}
\label{sec:orge78027e}
\subsection{Introduction}
\label{sec:org10a1c09}
\begin{enumerate}
\item Amino Acids: A Very Short Introduction
\label{sec:orgda82e92}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org4e6c044}Plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[3]{\label{org4c6f106}Sulphocysteine may not be detectable in plasma using routine methods}

\item Plasma
\label{sec:org7e6aee6}
\begin{itemize}
\item Patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:org51bb793}
\begin{enumerate}
\item LC-MS/MS schematic
\label{sec:org12033c6}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\label{sec:orgea7cd89}
\begin{enumerate}
\item Pros
\label{sec:org9950033}
\begin{itemize}
...
\label{sec:org75b0efc}
\begin{enumerate}
\item Pros
\label{sec:orgb2c7429}
\begin{itemize}
...
\label{sec:org55cdda6}
\subsection{Introduction}
\label{sec:orge8e87a0}
\begin{itemize}
...
\label{sec:org5f96660}
\begin{itemize}
\item see \ref{sec:orga2261da}
\end{itemize}

\begin{enumerate}
\item Typical Panel
\label{sec:org6709e31}
\begin{itemize}
...
\label{sec:org247c899}
\subsection{Background}
\label{sec:org7f2711c}
\begin{enumerate}
\item What are urine organic acids?
\label{sec:org0df36a2}
\begin{itemize}
...
\label{sec:org94c3a3b}

\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}

\begin{table}[htbp]
\caption{\label{tab:orgbc274e5}
...
\item Side Chains
\label{sec:org9104c83}

\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}

\begin{table}[htbp]
\caption{\label{tab:org9b102f5}
...
\label{sec:org08cedc2}
\begin{enumerate}
\item Endogenous Sources
\label{sec:org5b8d554}
\begin{itemize}
...
\label{sec:orga4fd588}
\begin{enumerate}
\item Oximation
\label{sec:orgc853165}
\begin{itemize}
...
\label{sec:org40585ae}

\item Mass-spectroscopy
\label{sec:org289e8e7}

\item Reporting
\label{sec:org032e1d4}
\end{enumerate}
\section{Mitochondria}
\label{sec:orgd4753de}
\subsection{Introduction}
\label{sec:org734e3e4}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:orgce62a2e}
Electron Transport Chain}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:orgf87935c}
\begin{enumerate}
\item CI
\label{sec:org0a1c331}
\begin{itemize}
...
\label{sec:orged89c9c}
\subsection{CI+III assay}
\label{sec:org116fcb4}
\begin{enumerate}
\item Purpose
\label{sec:orgfcb7d5f}
\begin{itemize}
...
\label{sec:org9530266}
\begin{enumerate}
\item Purpose
\label{sec:org0f41e77}
\begin{itemize}
\item Complex II activity
\end{itemize}
\item Principle
\label{sec:org0f90c25}
\begin{itemize}
...
\label{sec:orgf4934b1}
\begin{enumerate}
\item Purpose
\label{sec:org4b43f8d}
\begin{itemize}
...
\label{sec:org14e0254}
\begin{enumerate}
\item Purpose
\label{sec:orgaa56bc1}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:orgf727b24}
\begin{enumerate}
\item Purpose
\label{sec:org8b8723d}
\begin{itemize}
...
\label{sec:org547d85a}
\section{{\bfseries\sffamily TODO} GAGs and Oligosacarides}
\label{sec:org719c1ec}
\section{Enzymes}
\label{sec:org11cdeab}
\subsection{GALT}
\label{sec:org4c06523}
\begin{enumerate}
\item Beutler Test
\label{sec:org9aab8d1}
...
\caption{\label{fig:org36082b2}
Beutler Method}
\end{figure}


\item Spotcheck
\label{sec:org4d0250f}
...
\label{sec:org2948841}
\begin{enumerate}
\item Multiplex DBS Assay
\label{sec:orgf06d1bf}
\begin{itemize}
...
\label{sec:org7884d5d}
\subsection{Transferrin IEF}
\label{sec:orge1812b7}
\begin{itemize}
...
\caption{\label{fig:org8e89938}
Transferrin IEF}
\end{figure}

\begin{enumerate}
\item Type 1 pattern
\label{sec:orgf720a47}
\begin{itemize}
...
\end{itemize}
\section{NIET}
\label{sec:orgdb763b3}
\subsection{Exercising Muscle}
\label{sec:org10c0700}
\begin{enumerate}
\item Lactate
\label{sec:org02057e6}
\begin{itemize}
...
\caption{\label{fig:org1063327}
LDH}
\end{figure}

\item ATP
\label{sec:org385ddcf}
\begin{itemize}
...
\caption[gln]{\label{fig:orgf98bfcc}
...
\caption[interp]{\label{fig:orgdb517df}
NIET Results}
\end{figure}
\end{enumerate}
...
\label{sec:org6559ff9}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./niet/figures/niet_method.png}
\caption{\label{fig:org46e0440}
NIET Method}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org1947027}
NIET in Myopathy}
\centering
\begin{tabular}{lll}
 & Lactate & Ammonia\\
...
\end{table}
\section{Porphyrins}
\label{sec:org6c88c82}
\subsection{Methods for Metabolites}
\label{sec:org2b61518}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:orgce48946}
\begin{enumerate}
\item Porphobilinogen
\label{sec:org55b42e8}
\begin{itemize}
