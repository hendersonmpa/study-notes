...
\section{Amino Acids}
\label{sec:org87e5ebd}
\subsection{Introduction}
\label{sec:orgb538cb4}
\begin{enumerate}
\item Amino Acids: A Very Short Introduction
\label{sec:org0eaa5a5}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org96d8ce9}Plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{orgb6ed711}Sulphocysteine may not be detectable in plasma using routine methods}

\item Plasma
\label{sec:org1ecfa76}
\begin{itemize}
\item Patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:org373302c}
\begin{enumerate}
\item LC-MS/MS schematic
\label{sec:orgd5e753a}
\begin{center}
...
\label{sec:orgee7092d}
\begin{itemize}
\item As compared to FIA-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org5de39c5}
\begin{itemize}
...
\label{sec:orgd65bd73}
\subsection{Introduction}
\label{sec:orgd35a800}
\begin{itemize}
...
\label{sec:orge6e2ee2}
\begin{enumerate}
\item Diagnostic FIA-MS/MS schematic
\label{sec:orga97de24}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
used with caution." \textsuperscript{\ref{org480f3a2}}
\end{itemize}

\item Pros and Cons of Butanol  FIA-MSMS for Aceylcarnitines
\label{sec:org95c25b0}
\begin{enumerate}
\item Pros
\label{sec:orgac6a684}
\begin{itemize}
\item Speed
\item Sensitivity
\item Expertise
...
\label{sec:orgcce3a56}
\subsection{Background}
\label{sec:org62a8c72}
\begin{enumerate}
\item What are urine organic acids?
\label{sec:org0df8c65}
\begin{itemize}
...
\label{sec:org612cc7d}
\centering
\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}
\begin{table}[htbp]
\caption{\label{tab:orgf3045a3}
...
\item Side Chains
\label{sec:org55c7a70}
\centering
\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}
\begin{table}[htbp]
\caption{\label{tab:orga7a0ce8}
...
\label{sec:org3c78f21}
\begin{enumerate}
\item Endogenous Sources
\label{sec:orga81a6a2}
\begin{itemize}
...
\label{sec:org2c9f1e2}
\begin{enumerate}
\item Oximation
\label{sec:orgc293580}
\begin{itemize}
...
\label{sec:orga944b62}

\item Mass-spectroscopy
\label{sec:org835764f}

\item Reporting
\label{sec:org3485caf}
\end{enumerate}

\section{NBS}
\label{sec:orgf65c006}
\subsection{Dried Blood Spot}
\label{sec:org39d0074}
\begin{itemize}
...
\subsection{AAAC}
\label{sec:org592fa03}
\begin{enumerate}
\item FIA-MS/MS schematic
\label{sec:orga5aca1a}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\item Overestimation of Free Carnitine
\label{sec:orgb47ea4b}
\begin{itemize}
\item Butylated acylcarnitines are converted to butylated carnitine in
n-butanol-3M HCl at 65\degree{}C. \footnote{Johnson, D. W. (1999). Inaccurate measurement of free
carnitine by the electrospray tandem mass spectrometry screening
method for blood spots. Journal of Inherited Metabolic Disease, 22(2),
201–202.\label{org236984d}}
\end{itemize}
...
\item "The free carnitine results obtained by this screening method on
blood spots with high levels of acylcarnitines should therefore be
used with caution." \textsuperscript{\ref{org236984d}}
\end{itemize}

\item Pros and Cons of FIA-MS/MS using DBS
\label{sec:orgdc6c110}
\begin{itemize}
\item As compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org4c42246}
\begin{itemize}
