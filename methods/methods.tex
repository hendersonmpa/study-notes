...
\section{Amino Acids}
\label{sec:org9faac0c}
\subsection{Introduction}
\label{sec:org7824630}
\begin{enumerate}
\item Amino Acids: A Very Short Introduction
\label{sec:org0586eee}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgac7f970}Plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{org8a3f885}Sulphocysteine may not be detectable in plasma using routine methods}

\item Plasma
\label{sec:orgcc95724}
\begin{itemize}
\item Patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:orgd680ef1}
\begin{enumerate}
\item LC-MS/MS schematic
\label{sec:orgdb4e369}
\begin{center}
...
\label{sec:org192fd97}
\begin{itemize}
\item As compared to FIA-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org140503d}
\begin{itemize}
...
\label{sec:org1204a10}
\begin{enumerate}
\item Diagnostic FIA-MS/MS schematic
\label{sec:org320ed8e}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\section{NBS}
\label{sec:orged433d0}
\subsection{Dried Blood Spot}
\label{sec:orgcb60f38}
\begin{itemize}
