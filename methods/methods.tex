...
\section{Amino Acids}
\label{sec:org7072d1f}
\subsection{Introduction}
\label{sec:orgc5c097e}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgfe455ce}Recommended Plasma AA Profile for Diagnosis of Amino Acid Disorders}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org39dcd59}plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{org4bea52b}sulphocysteine may not be detectable in plasma using routine methods}

\subsubsection{Sample Types}
\label{sec:org782fffc}
\begin{enumerate}
\item Plasma
\label{sec:org3dcebbc}
\begin{itemize}
\item patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:org6b21ec3}
\subsubsection{LC-MS/MS schematic}
\label{sec:orge591d11}
...
\caption{\label{fig:org383ff5b}LC-MS/MS outletmethod}
\end{figure}

\subsubsection{Ion-Pairing Chromatography}
\label{sec:org1150aca}
...
\begin{table}[htbp]
\caption{\label{tab:org83b206b}AA Quantified by LC-MS/MS}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org640d90e}reported in urine}

\subsubsection{Pros and Cons of LC-MS/MS vs AAA}
\label{sec:orgc827f18}
\begin{enumerate}
\item Pros
\label{sec:org3ecafaa}
\begin{itemize}
...
\label{sec:org46f691a}
\begin{enumerate}
\item Pros
\label{sec:orgb96a9f1}
\begin{itemize}
...
\caption{\label{fig:org3861207}The Three Forms of Homocysteine}
\end{figure}

\subsubsection{Method}
\label{sec:org56e7efb}
\begin{itemize}
...
reaction cycle that amplifies the detection signal. The formed
adenosine is immediately hydrolyzed into inosine and ammonia (NH\textsubscript{3}).
\item glutamate dehydrogenase (GLDH) catalyzes the reaction of ammonia
with 2-oxoglutarate and NADH to form NAD\^{}+
\item Photometric measurement: the concentration of Hcy in the sample is
directly proportional to the amount of NADH converted to NAD + (\(\delta\) A340nm).
\end{itemize}
...
\caption{\label{fig:org4bf66bc}Enzymatic Total Homocysteine Method}
\end{figure}
\section{Acylcarnitines}
\label{sec:org552d989}
\subsection{Introduction}
\label{sec:org43b8a61}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org1bd62fb}Acylcarnitine Panel}
\centering
\begin{tabular}{lll}
...
\label{sec:org54fd67a}
\subsubsection{Sample Prep}
\label{sec:orgb082302}
...
\caption{\label{fig:org28a2c2d}Rationale for Derivatization}
\end{figure}

\subsubsection{FIA-MS/MS schematic}
\label{sec:org758d698}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
201–202.\label{org1e42ca2}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org01965bf}Overestimation of Free Carnitine}
\centering
\begin{tabular}{lr}
...
used with caution" \textsuperscript{\ref{org1e42ca2}}
\end{itemize}


\subsection{Free and Total Carnitine}
\label{sec:org37cfc6d}
\begin{itemize}
...
\label{sec:org993a32f}

\subsubsection{FIA-MS/MS Schematic}
\label{sec:org71ffc2e}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\begin{table}[htbp]
\caption{\label{tab:org63b1b65}Quantified Amino Acids}
\centering
\begin{tabular}{ll}
glycine & tyrosine\\
alanine & ornithine\\
...
\begin{table}[htbp]
\caption{\label{tab:org3f40702}MRM is used to detected selected acylcarnitines}
\centering
\begin{tabular}{ll}
Compound & Reaction\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org845bade}Quantified Acylcarnitines}
\centering
\begin{tabular}{lll}
C0 & C8 & C16\\
C2 & C8:1 & C16:1\\
...
\label{sec:org67e24eb}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:orgafcf517}
\begin{itemize}
...
\label{sec:org9bd0711}
\subsection{Introduction}
\label{sec:org4b81773}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org38fdcd7}Organic Acid Functional Groups}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:org8693d7d}Organic Acid Side Chains}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:org0249989}Organic Acid Nomenclature}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:org3ea000a}Pathologic Acylglycines}
\centering
\begin{tabular}{llll}
...
\label{sec:orgb9458d6}
\begin{enumerate}
\item Endogenous
\label{sec:orgbd915f3}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org1308c60}Disorders of Organic Acid Metabolism}
\centering
\begin{tabular}{ll}
...
\label{sec:org12c5f90}
\subsubsection{Oximation}
\label{sec:org436e748}
\begin{itemize}
...
\label{sec:org55d0cdc}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:orgb0731a0}Flow of Electrons in the ETC}
\end{figure}

\subsection{Citrate Synthase}
\label{sec:org0907e4f}
\subsubsection{Purpose}
\label{sec:org396d922}
\begin{itemize}
...
\label{sec:org1365194}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/c1c3.pdf}
\caption{\label{fig:orga732bda}CI \& III assay}
\end{figure}


\subsubsection{Purpose}
\label{sec:org202927c}
\begin{itemize}
...
\label{sec:orgbd66bad}
\begin{figure}[htbp]
\centering
\includegraphics[width=.7\textwidth]{./mito/figures/c2.pdf}
\caption{\label{fig:orgd156c19}CII Assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:org9c7fcf0}
\begin{itemize}
\item Complex II activity
\end{itemize}
\subsubsection{Principle}
\label{sec:org0c34c7a}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{mito/figures/gr4.jpg}
\caption{\label{fig:org28883e4}Alternative Coupled Spectrophotometric CII Assay}
\end{figure}

\subsection{CII \& III assay}
\label{sec:org47b3142}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/c2c3.pdf}
\caption{\label{fig:org277a365}CII \& CIII}
\end{figure}

\subsubsection{Purpose}
\label{sec:orgf3d6e20}
\begin{itemize}
...
\label{sec:orgb9dfe9c}
\begin{figure}[htbp]
\centering
\includegraphics[width=.7\textwidth]{./mito/figures/c4.pdf}
\caption{\label{fig:org6217543}CIV Assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:orgcabdad9}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:org3f941e4}
\subsubsection{Purpose}
\label{sec:orgfcbca46}
\begin{itemize}
...
\label{sec:org926445d}
\section{{\bfseries\sffamily TODO} GAGs and Oligosacarides}
\label{sec:org6a9747b}
\section{Enzymes}
\label{sec:orgdc59ccb}
\subsection{GALT}
\label{sec:org0d0b74c}
\subsubsection{Beutler Test}
\label{sec:org825b58f}
...
\caption{\label{fig:orgd7b2933}Beutler Method}
\end{figure}


\subsubsection{Spotcheck}
\label{sec:orga6f4c15}
...
\label{sec:orgce52f8c}
\subsubsection{Multiplex DBS Assay}
\label{sec:orge7e3e9c}
\begin{itemize}
...
\label{sec:orgc5fcce3}
\subsection{Transferrin IEF}
\label{sec:org37fa56c}
\begin{itemize}
...
\caption{\label{fig:org7cea863}Transferrin IEF}
\end{figure}

\subsubsection{Type 1 pattern}
\label{sec:orge2838ab}
\begin{itemize}
...
\end{itemize}
\section{NIET}
\label{sec:orgd64cb55}
\subsection{Exercising Muscle}
\label{sec:org0ff6a6a}
\subsubsection{Lactate}
\label{sec:orgcc8d0c2}
\begin{itemize}
...
\caption{\label{fig:orgbefae7b}LDH}
\end{figure}

\subsubsection{ATP}
\label{sec:org7a03f47}
\begin{itemize}
...
\caption[gln]{\label{fig:orgec38f60}Glutamine and Ammonia}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=.6\textheight]{niet/niet/figures/niet_results.png}
\caption[interp]{\label{fig:org3024606}NIET Results}
\end{figure}


\subsection{The non-ischemic forearm exercise test}
\label{sec:orgd23cbd3}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{niet/niet/figures/niet_method.png}
\caption{\label{fig:org113ef9a}NIET Method}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org8d84f6c}NIET in Myopathy}
\centering
\begin{tabular}{lll}
 & Lactate & Ammonia\\
\hline
...
\end{table}
\section{Porphyrins}
\label{sec:org3f05bb7}
\subsection{Methods for Metabolites}
\label{sec:orgdc5a135}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:org4922ceb}
\begin{enumerate}
\item Porphobilinogen
\label{sec:org33c4580}
\begin{itemize}
