...
\section{Amino Acids}
\label{sec:org271115a}
\subsection{Introduction}
\label{sec:org2326da1}
\begin{enumerate}
\item Amino Acids: A Very Short Introduction
\label{sec:orga9b6fc2}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orge800e25}Recommended Plasma AA Profile for Diagnosis of Amino Acid Disorders}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org213656b}plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{orgc6b195d}sulphocysteine may not be detectable in plasma using routine methods}

\item Sample Types
\label{sec:orga355e1e}
\begin{enumerate}
\item Plasma
\label{sec:org3d5c844}
\begin{itemize}
\item patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:orgf05f803}
\begin{enumerate}
\item LC-MS/MS schematic
\label{sec:orgc51b4ca}
...
\caption{\label{fig:orgc32f07f}LC-MS/MS outletmethod}
\end{figure}

\item Ion-Pairing Chromatography
\label{sec:orgfdb97f0}
...
\begin{table}[htbp]
\caption{\label{tab:org98e45d5}AA Quantified by LC-MS/MS}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org4c23840}reported in urine}

\item Pros and Cons of LC-MS/MS vs FIA-MS/MS
\label{sec:org068a0df}
\begin{enumerate}
\item Pros
\label{sec:org5778baf}
\begin{itemize}
...
\label{sec:org7cbd6d8}
\begin{enumerate}
\item Pros
\label{sec:org6ee3697}
\begin{itemize}
...
standard IEC chromatogram (see above section \ref{sec:orgc31dbae})
\end{itemize}
\item long term reagent expense
\end{itemize}

\item Cons
\label{sec:orgefc0999}
\begin{itemize}
...
\label{sec:org18b931b}
\subsection{Introduction}
\label{sec:org8e1b3a1}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org4744dd4}Acylcarnitine Panel}
\centering
\begin{tabular}{lll}
...
\label{sec:org37f51ee}
\begin{enumerate}
\item Sample Prep
\label{sec:org42bd1cd}
...
\caption{\label{fig:org05e4d4a}Rationale for Derivatization}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{./ac/figures/outletmethod.pdf}
\caption{\label{fig:org9b3c189}FIA-MS/MS Method}
\end{figure}

\item FIA-MS/MS schematic
\label{sec:org240b24a}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
201–202.\label{org90d1a01}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org604b8ce}Overestimation of Free Carnitine}
\centering
\begin{tabular}{lr}
...
\end{enumerate}
\section{AAAC}
\label{sec:org3bfe822}
\subsection{Sample}
\label{sec:orga432e86}
\begin{enumerate}
\item Dried Blood Spot
\label{sec:orgebeb91c}
\begin{itemize}
...
\label{sec:org32e66e2}

\begin{enumerate}
\item FIA-MS/MS Schematic
\label{sec:org1158f66}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\begin{table}[htbp]
\caption{\label{tab:orgc2e944f}Quantified Amino Acids}
\centering
\begin{tabular}{ll}
glycine & tyrosine\\
alanine & ornithine\\
...
\begin{table}[htbp]
\caption{\label{tab:org91cd430}MRM is used to detected selected acylcarnitines}
\centering
\begin{tabular}{ll}
Compound & Reaction\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org6422d0b}Quantified Acylcarnitines}
\centering
\begin{tabular}{lll}
C0 & C8 & C16\\
C2 & C8:1 & C16:1\\
...
\label{sec:org7908fed}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org8f0c0fb}
\begin{itemize}
...
\label{sec:org3f9ec05}
\subsection{Introduction}
\label{sec:org51814d9}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org399df20}Organic Acid Functional Groups}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:org43426b6}Organic Acid Side Chains}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:org9b7a1a7}Organic Acid Nomenclature}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:org48665ec}Pathologic Acylglycines}
\centering
\begin{tabular}{llll}
...
\label{sec:orgc30d344}
\begin{enumerate}
\item Endogenous
\label{sec:org02ea038}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org02b5aea}Disorders of Organic Acid Metabolism}
\centering
\begin{tabular}{ll}
...
\label{sec:org73f866b}
\begin{enumerate}
\item Oximation
\label{sec:orge9e3302}
\begin{itemize}
...
\label{sec:orgcb6e0aa}
\subsection{Introduction}
\label{sec:org3a53c06}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:orgbe028b1}Electron Transport Chain}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:org33d9e19}
\begin{enumerate}
\item CI
\label{sec:orgce97476}
\begin{itemize}
...
\label{sec:org5469554}
\subsection{CI+III assay}
\label{sec:org82630d2}
\begin{enumerate}
\item Purpose
\label{sec:org913eb33}
\begin{itemize}
...
\label{sec:org9e3e5c5}
\begin{enumerate}
\item Purpose
\label{sec:org3581f90}
\begin{itemize}
\item Complex II activity
\end{itemize}
\item Principle
\label{sec:org42355fe}
\begin{itemize}
...
\label{sec:org89ee81d}
\begin{enumerate}
\item Purpose
\label{sec:orgb539c75}
\begin{itemize}
...
\label{sec:orgeb40ef1}
\begin{enumerate}
\item Purpose
\label{sec:org4d8fa57}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:orgfdca1d1}
\begin{enumerate}
\item Purpose
\label{sec:orga4251e1}
\begin{itemize}
...
\label{sec:org1a7f294}
\section{{\bfseries\sffamily TODO} GAGs and Oligosacarides}
\label{sec:org8ca58b3}
\section{Enzymes}
\label{sec:org3fee8f8}
\subsection{GALT}
\label{sec:orga8a45b3}
\begin{enumerate}
\item Beutler Test
\label{sec:org8d9cc43}
...
\caption{\label{fig:org5c4b02a}Beutler Method}
\end{figure}


\item Spotcheck
\label{sec:orga3f4823}
...
\label{sec:org5fbe2d0}
\begin{enumerate}
\item Multiplex DBS Assay
\label{sec:org41a3242}
\begin{itemize}
...
\label{sec:org142cafa}
\subsection{Transferrin IEF}
\label{sec:org06da8af}
\begin{itemize}
...
\caption{\label{fig:orgce176b1}Transferrin IEF}
\end{figure}

\begin{enumerate}
\item Type 1 pattern
\label{sec:org967b227}
\begin{itemize}
...
\end{itemize}
\section{NIET}
\label{sec:org24427de}
\subsection{Exercising Muscle}
\label{sec:org1a92367}
\begin{enumerate}
\item Lactate
\label{sec:orgd39f6df}
\begin{itemize}
...
\caption{\label{fig:orga2c9ce4}LDH}
\end{figure}

\item ATP
\label{sec:org46fc3c8}
\begin{itemize}
...
\caption[gln]{\label{fig:org22ab359}Glutamine and Ammonia}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=.6\textheight]{niet/niet/figures/niet_results.png}
\caption[interp]{\label{fig:orge36c2bc}NIET Results}
\end{figure}
\end{enumerate}


\subsection{The non-ischemic forearm exercise test}
\label{sec:org33b21f0}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{niet/niet/figures/niet_method.png}
\caption{\label{fig:orgff7fb6c}NIET Method}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org5822ec1}NIET in Myopathy}
\centering
\begin{tabular}{lll}
 & Lactate & Ammonia\\
\hline
...
\end{table}
\section{Porphyrins}
\label{sec:org06e77a1}
\subsection{Methods for Metabolites}
\label{sec:org1074af5}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:orgdc8eed8}
\begin{enumerate}
\item Porphobilinogen
\label{sec:org44f9d83}
\begin{itemize}
