...
\section{Amino Acids}
\label{sec:org1e3e57b}
\subsection{Introduction}
\label{sec:orgd4da1cf}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org3699379}Recommended Plasma AA Profile for Diagnosis of Amino Acid Disorders}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgc5dc666}plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{orgfb0e537}sulphocysteine may not be detectable in plasma using routine methods}

\subsubsection{Sample Types}
\label{sec:orge6cc399}
\begin{enumerate}
\item Plasma
\label{sec:org572e712}
\begin{itemize}
\item patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:org8339f77}
\subsubsection{LC-MS/MS schematic}
\label{sec:orgf14919c}
...
\begin{table}[htbp]
\caption{\label{tab:org5dc7073}AA Quantified by LC-MS/MS}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{orgd39fb13}reported in urine}

\subsubsection{Pros and Cons of LC-MS/MS vs AAA}
\label{sec:orgbbb1668}
\begin{enumerate}
\item Pros
\label{sec:org3b4823a}
\begin{itemize}
...
\label{sec:orgf99eaf5}
\begin{enumerate}
\item Pros
\label{sec:org7e4992a}
\begin{itemize}
...
\caption{\label{fig:org7085311}Enzymatic Total Homocysteine Method}
\end{figure}
\section{Acylcarnitines}
\label{sec:org5ee92bb}
\subsection{Introduction}
\label{sec:org1c3d8a8}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org6eb071b}Acylcarnitine Panel}
\centering
\begin{tabular}{lll}
...
\label{sec:org72d01ff}
\subsubsection{Sample Prep}
\label{sec:orgf5a739a}
...
\caption{\label{fig:org3b73d25}Rationale for Derivatization}
\end{figure}

\subsubsection{FIA-MS/MS schematic}
\label{sec:orgf275fa9}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
201–202.\label{orgf5e6204}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org6792ec1}Overestimation of Free Carnitine}
\centering
\begin{tabular}{lr}
...
\label{sec:org7cf52a2}

\subsubsection{FIA-MS/MS Schematic}
\label{sec:org3ed10de}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\begin{table}[htbp]
\caption{\label{tab:org506f6de}MRM is used to detected selected acylcarnitines}
\centering
\begin{tabular}{ll}
Compound & Reaction\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orgfe0f6c3}Quantified Acylcarnitines}
\centering
\begin{tabular}{lll}
C0 & C8 & C16\\
C2 & C8:1 & C16:1\\
...
\label{sec:org8e427db}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org087343d}
\begin{itemize}
...
\label{sec:org84b0a1d}
\subsection{Introduction}
\label{sec:org61a8536}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org0c4fc8c}Organic Acid Functional Groups}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:orgfe71fc6}Organic Acid Side Chains}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:org5011d04}Organic Acid Nomenclature}
\centering
\begin{tabular}{lll}
...
\label{sec:orgeb73b87}
\begin{enumerate}
\item Endogenous
\label{sec:org066fc84}
\begin{itemize}
...
\label{sec:org6afc1b7}
\subsubsection{Oximation}
\label{sec:orged6b04e}
\begin{itemize}
