...
\section{NBS}
\label{sec:org652b4d9}
\subsection{Dried Blood Spot}
\label{sec:orgf1759a7}
\begin{itemize}
...
\subsection{AAAC}
\label{sec:org022764e}
\begin{enumerate}
\item FIA-MS/MS schematic
\label{sec:org1d791e5}
\begin{center}
...
\caption{\label{fig:orgf967088}
FIA-MS/MS Method}
\end{figure}

\item AA NL Scan
\label{sec:org6c9ab80}
\begin{itemize}
...
201–202.\label{org05308ce}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org4578e21}
...
used with caution." \textsuperscript{\ref{org05308ce}}
\end{itemize}

\item Pros and Cons of FIA-MS/MS using DBS
\label{sec:org3f6bf34}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org912083d}
\begin{itemize}
...
\end{enumerate}
\section{Amino Acids}
\label{sec:org63d1615}
\subsection{Introduction}
\label{sec:org9590384}
\begin{enumerate}
\item Amino Acids: A Very Short Introduction
\label{sec:org501b9f4}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org68e3eb2}Plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[3]{\label{orgf870c33}Sulphocysteine may not be detectable in plasma using routine methods}

\item Plasma
\label{sec:org312f0f4}
\begin{itemize}
\item Patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:org2f908a5}
\begin{enumerate}
\item LC-MS/MS schematic
\label{sec:org1f48a41}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\label{sec:orgb769024}
\begin{enumerate}
\item Pros
\label{sec:org90b3262}
\begin{itemize}
...
\label{sec:org33e2e95}
\begin{enumerate}
\item Pros
\label{sec:org746425a}
\begin{itemize}
...
\label{sec:orgde50c86}
\subsection{Introduction}
\label{sec:org0c787e6}
\begin{itemize}
...
\label{sec:orgb2d5e38}
\subsection{Background}
\label{sec:orgf5d5f33}
\begin{enumerate}
\item What are urine organic acids?
\label{sec:orgb349fb2}
\begin{itemize}
...
\label{sec:org262c13d}

\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}

\begin{table}[htbp]
\caption{\label{tab:org53e8b06}
...
\item Side Chains
\label{sec:org1880a79}

\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}

\begin{table}[htbp]
\caption{\label{tab:orgf0c61ed}
...
\label{sec:org3d9b139}
\begin{enumerate}
\item Endogenous Sources
\label{sec:org9e6ae68}
\begin{itemize}
...
\label{sec:org71d7611}
\begin{enumerate}
\item Oximation
\label{sec:org30384fb}
\begin{itemize}
...
\label{sec:org074bedd}

\item Mass-spectroscopy
\label{sec:orgcdf7916}

\item Reporting
\label{sec:org7ee44e3}
\end{enumerate}
\section{Mitochondria}
\label{sec:org34c4813}
\subsection{Introduction}
\label{sec:orgfd7328f}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:org6291830}
Electron Transport Chain}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:org47018e8}
\begin{enumerate}
\item CI
\label{sec:orgb75820c}
\begin{itemize}
...
\label{sec:org40477d8}
\subsection{CI+III assay}
\label{sec:org89d110e}
\begin{enumerate}
\item Purpose
\label{sec:org837a1f2}
\begin{itemize}
...
\label{sec:org3a30645}
\begin{enumerate}
\item Purpose
\label{sec:org4994746}
\begin{itemize}
\item Complex II activity
\end{itemize}
\item Principle
\label{sec:org5c6a7d8}
\begin{itemize}
...
\label{sec:org7ce9250}
\begin{enumerate}
\item Purpose
\label{sec:orgf80e896}
\begin{itemize}
...
\label{sec:orga6ebc37}
\begin{enumerate}
\item Purpose
\label{sec:org0702d15}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:orga51240c}
\begin{enumerate}
\item Purpose
\label{sec:org66ac444}
\begin{itemize}
...
\label{sec:org2f47bbc}
\section{{\bfseries\sffamily TODO} GAGs and Oligosacarides}
\label{sec:orgf36a2ac}
\section{Enzymes}
\label{sec:org72bf34d}
\subsection{GALT}
\label{sec:org599331a}
\begin{enumerate}
\item Beutler Test
\label{sec:org2010125}
...
\caption{\label{fig:org0190613}
Beutler Method}
\end{figure}


\item Spotcheck
\label{sec:org9f2632f}
...
\label{sec:orge919972}
\begin{enumerate}
\item Multiplex DBS Assay
\label{sec:org26dc348}
\begin{itemize}
...
\label{sec:orgb01b7cf}
\subsection{Transferrin IEF}
\label{sec:orgb14a449}
\begin{itemize}
...
\caption{\label{fig:org3a86739}
Transferrin IEF}
\end{figure}

\begin{enumerate}
\item Type 1 pattern
\label{sec:org8d426ec}
\begin{itemize}
...
\end{itemize}
\section{NIET}
\label{sec:orgfc03897}
\subsection{Exercising Muscle}
\label{sec:org1d6f58f}
\begin{enumerate}
\item Lactate
\label{sec:org4de5bea}
\begin{itemize}
...
\caption{\label{fig:org9c40a9f}
LDH}
\end{figure}

\item ATP
\label{sec:orgc2279b0}
\begin{itemize}
...
\caption[gln]{\label{fig:org40227b4}
...
\caption[interp]{\label{fig:orgd1913f3}
NIET Results}
\end{figure}
\end{enumerate}
...
\label{sec:org66852ac}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./niet/figures/niet_method.png}
\caption{\label{fig:org34111d7}
NIET Method}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:orgb018c26}
NIET in Myopathy}
\centering
\begin{tabular}{lll}
 & Lactate & Ammonia\\
...
\end{table}
\section{Porphyrins}
\label{sec:org1bad7be}
\subsection{Methods for Metabolites}
\label{sec:org934d7c3}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:org8abb2a0}
\begin{enumerate}
\item Porphobilinogen
\label{sec:org064b02b}
\begin{itemize}
