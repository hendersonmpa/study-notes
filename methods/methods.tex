...
\section{Amino Acids}
\label{sec:orgcd18307}
\subsection{Introduction}
\label{sec:org153a8b2}
\begin{enumerate}
\item Amino Acids: A Very Short Introduction
\label{sec:org2e460cf}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org66f6e4b}Recommended Plasma AA Profile for Diagnosis of Amino Acid Disorders}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgca299e1}plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{orgf69141b}sulphocysteine may not be detectable in plasma using routine methods}

\item Sample Types
\label{sec:org3d788dc}
\begin{enumerate}
\item Plasma
\label{sec:orgd3930b1}
\begin{itemize}
\item patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:org250be25}
\begin{enumerate}
\item LC-MS/MS schematic
\label{sec:orgea2614d}
...
\caption{\label{fig:org340bd15}LC-MS/MS outletmethod}
\end{figure}

\item Ion-Pairing Chromatography
\label{sec:orgf0352eb}
...
\begin{table}[htbp]
\caption{\label{tab:orgd6c5bfb}AA Quantified by LC-MS/MS}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org7851369}reported in urine}

\item Pros and Cons of LC-MS/MS vs FIA-MS/MS
\label{sec:org304f5d2}
\begin{enumerate}
\item Pros
\label{sec:orgdbe472e}
\begin{itemize}
...
\label{sec:org60f0b57}
\begin{enumerate}
\item Pros
\label{sec:org4190c0f}
\begin{itemize}
...
standard IEC chromatogram (see above section \ref{sec:org6e18551})
\end{itemize}
\item long term reagent expense
\end{itemize}

\item Cons
\label{sec:orgfa336a8}
\begin{itemize}
...
\label{sec:org6762b1d}
\subsection{Introduction}
\label{sec:org4d1efcc}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org93a7628}Acylcarnitine Panel}
\centering
\begin{tabular}{lll}
...
\label{sec:orgf3fbc23}
\begin{enumerate}
\item Sample Prep
\label{sec:orgcee8e79}
...
\caption{\label{fig:org88c8c5e}Rationale for Derivatization}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{./ac/figures/outletmethod.pdf}
\caption{\label{fig:orgd46d3a6}FIA-MS/MS Method}
\end{figure}

\item FIA-MS/MS schematic
\label{sec:org537cce1}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
201–202.\label{org685dd88}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org0bb3848}Overestimation of Free Carnitine}
\centering
\begin{tabular}{lr}
...
\end{enumerate}
\section{AAAC}
\label{sec:org0aa193e}
\subsection{Sample}
\label{sec:org28a9209}
\begin{enumerate}
\item Dried Blood Spot
\label{sec:org6471939}
\begin{itemize}
...
\label{sec:org676eb2f}

\begin{enumerate}
\item FIA-MS/MS Schematic
\label{sec:org8e7f2d6}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\begin{table}[htbp]
\caption{\label{tab:orgf9d61ad}Quantified Amino Acids}
\centering
\begin{tabular}{ll}
glycine & tyrosine\\
alanine & ornithine\\
...
\begin{table}[htbp]
\caption{\label{tab:orga1f4eb9}MRM is used to detected selected acylcarnitines}
\centering
\begin{tabular}{ll}
Compound & Reaction\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org887d300}Quantified Acylcarnitines}
\centering
\begin{tabular}{lll}
C0 & C8 & C16\\
C2 & C8:1 & C16:1\\
...
\label{sec:org7e33232}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org8225d99}
\begin{itemize}
...
\label{sec:org164f359}
\subsection{Introduction}
\label{sec:orga3c90f1}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org6d35e3d}Organic Acid Functional Groups}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:orgee537b0}Organic Acid Side Chains}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:org0eb008a}Organic Acid Nomenclature}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:org90ae131}Pathologic Acylglycines}
\centering
\begin{tabular}{llll}
...
\label{sec:org151960b}
\begin{enumerate}
\item Endogenous
\label{sec:orgab155b0}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgde6ccc1}Disorders of Organic Acid Metabolism}
\centering
\begin{tabular}{ll}
...
\label{sec:org9893cdf}
\begin{enumerate}
\item Oximation
\label{sec:orgce5baf7}
\begin{itemize}
...
\label{sec:org8ee5f08}
\subsection{Introduction}
\label{sec:org1a110ad}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:orgba5a29b}Electron Transport Chain}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:org18c169a}
\begin{enumerate}
\item CI
\label{sec:orge5145db}
\begin{itemize}
...
\label{sec:org45c56ce}
\subsection{CI+III assay}
\label{sec:orgee63cfe}
\begin{enumerate}
\item Purpose
\label{sec:org22d5fb1}
\begin{itemize}
...
\label{sec:orge88afa2}
\begin{enumerate}
\item Purpose
\label{sec:orgdd5dc05}
\begin{itemize}
\item Complex II activity
\end{itemize}
\item Principle
\label{sec:orgb9f5963}
\begin{itemize}
...
\label{sec:org87d6a2a}
\begin{enumerate}
\item Purpose
\label{sec:orgc682c6b}
\begin{itemize}
...
\label{sec:org5fb902c}
\begin{enumerate}
\item Purpose
\label{sec:org2bd7dc3}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:org46e9fad}
\begin{enumerate}
\item Purpose
\label{sec:org5fe1a10}
\begin{itemize}
...
\label{sec:org70fa4f3}
\section{{\bfseries\sffamily TODO} GAGs and Oligosacarides}
\label{sec:orgc6a6f43}
\section{Enzymes}
\label{sec:orgd178c04}
\subsection{GALT}
\label{sec:org58f042c}
\begin{enumerate}
\item Beutler Test
\label{sec:org65d9f93}
...
\caption{\label{fig:org40684d9}Beutler Method}
\end{figure}


\item Spotcheck
\label{sec:org69062a8}
...
\label{sec:org90eaf8b}
\begin{enumerate}
\item Multiplex DBS Assay
\label{sec:orgde0bb91}
\begin{itemize}
...
\label{sec:org78f2069}
\subsection{Transferrin IEF}
\label{sec:org727453d}
\begin{itemize}
...
\caption{\label{fig:orgc09225a}Transferrin IEF}
\end{figure}

\begin{enumerate}
\item Type 1 pattern
\label{sec:org63d9312}
\begin{itemize}
...
\end{itemize}
\section{NIET}
\label{sec:org4185520}
\subsection{Exercising Muscle}
\label{sec:org80b104b}
\begin{enumerate}
\item Lactate
\label{sec:org2578e7f}
\begin{itemize}
...
\caption{\label{fig:org2493de6}LDH}
\end{figure}

\item ATP
\label{sec:org44232d1}
\begin{itemize}
...
\caption[gln]{\label{fig:org4709ddb}Glutamine and Ammonia}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=.6\textheight]{niet/niet/figures/niet_results.png}
\caption[interp]{\label{fig:orgb210187}NIET Results}
\end{figure}
\end{enumerate}


\subsection{The non-ischemic forearm exercise test}
\label{sec:org721c7a1}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{niet/niet/figures/niet_method.png}
\caption{\label{fig:org8f00e51}NIET Method}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:orgaf30790}NIET in Myopathy}
\centering
\begin{tabular}{lll}
 & Lactate & Ammonia\\
\hline
...
\end{table}
\section{Porphyrins}
\label{sec:org377e0d7}
\subsection{Methods for Metabolites}
\label{sec:org0e8645c}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:orgda5d9f0}
\begin{enumerate}
\item Porphobilinogen
\label{sec:orge2ef494}
\begin{itemize}
