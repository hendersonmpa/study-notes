...
\section{Amino Acids}
\label{sec:orgc926e3b}
\subsection{Introduction}
\label{sec:org799ff11}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgd017f8a}Recommended Plasma AA Profile for Diagnosis of Amino Acid Disorders}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org31cc229}plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{org824e450}sulphocysteine may not be detectable in plasma using routine methods}

\subsubsection{Sample Types}
\label{sec:orgc8f22f5}
\begin{enumerate}
\item Plasma
\label{sec:org4fdc984}
\begin{itemize}
\item patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:org4a07d51}
\subsubsection{LC-MS/MS schematic}
\label{sec:org6cb4506}
...
\caption{\label{fig:org38d222a}LC-MS/MS outletmethod}
\end{figure}

\subsubsection{Ion-Pairing Chromatography}
\label{sec:orgfdc75ef}
...
\begin{table}[htbp]
\caption{\label{tab:orgf54a0ba}AA Quantified by LC-MS/MS}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{orgf4bac83}reported in urine}

\subsubsection{Pros and Cons of LC-MS/MS vs AAA}
\label{sec:orgd6045ce}
\begin{enumerate}
\item Pros
\label{sec:orga0c1fde}
\begin{itemize}
...
\label{sec:org4ca7430}
\begin{enumerate}
\item Pros
\label{sec:orgdc32f7c}
\begin{itemize}
...
\caption{\label{fig:orgdbf3100}The Three Forms of Homocysteine}
\end{figure}

\subsubsection{Method}
\label{sec:org4026412}
\begin{itemize}
\item enzymatic total homocysteine method (Figure \ref{fig:orgeb98eb6})
\begin{enumerate}
...
\caption{\label{fig:orgeb98eb6}Enzymatic Total Homocysteine Method}
\end{figure}
\section{Acylcarnitines}
\label{sec:org49e9dc7}
\subsection{Introduction}
\label{sec:orgd466a92}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org205667a}Acylcarnitine Panel}
\centering
\begin{tabular}{lll}
...
\label{sec:org8cfde8e}
\subsubsection{Sample Prep}
\label{sec:org6b836dd}
...
\caption{\label{fig:org434880b}Rationale for Derivatization}
\end{figure}

\subsubsection{FIA-MS/MS schematic}
\label{sec:orgc394f3a}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
201–202.\label{orgd48d81e}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org64646cc}Overestimation of Free Carnitine}
\centering
\begin{tabular}{lr}
...
used with caution" \textsuperscript{\ref{orgd48d81e}}
\end{itemize}


\subsection{Free and Total Carnitine}
\label{sec:orgd802ca3}
\begin{itemize}
...
\label{sec:orgc3e0a49}

\subsubsection{FIA-MS/MS Schematic}
\label{sec:org8ea1aba}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\begin{table}[htbp]
\caption{\label{tab:orgcab0268}Quantified Amino Acids}
\centering
\begin{tabular}{ll}
glycine & tyrosine\\
alanine & ornithine\\
...
\begin{table}[htbp]
\caption{\label{tab:org190eb69}MRM is used to detected selected acylcarnitines}
\centering
\begin{tabular}{ll}
Compound & Reaction\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orgc0ed108}Quantified Acylcarnitines}
\centering
\begin{tabular}{lll}
C0 & C8 & C16\\
C2 & C8:1 & C16:1\\
...
\label{sec:org0002951}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org0a4bb02}
\begin{itemize}
...
\label{sec:orge9969aa}
\subsection{Introduction}
\label{sec:orgd6bc10c}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org4e57a5f}Organic Acid Functional Groups}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:org3c1dce8}Organic Acid Side Chains}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:orgfaa896f}Organic Acid Nomenclature}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:orgd7f6cc4}Acylglycines}
\centering
\begin{tabular}{llll}
...
\label{sec:org6c854a0}
\begin{enumerate}
\item Endogenous
\label{sec:org0dbdb16}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgdd2bb00}Disorders of Organic Acid Metabolism}
\centering
\begin{tabular}{ll}
...
\label{sec:orge9f93a7}
\subsubsection{Oximation}
\label{sec:org7c6d96f}
\begin{itemize}
...
\label{sec:org2255b40}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:org243a27c}Flow of Electrons in the ETC}
\end{figure}

\subsection{Citrate Synthase}
\label{sec:org0667a85}
\subsubsection{Purpose}
\label{sec:orgf6e60c3}
\begin{itemize}
...
\label{sec:org7121d5d}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/c1c3.pdf}
\caption{\label{fig:org0dc5293}CI \& III assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:org489ca32}
\begin{itemize}
...
\label{sec:orgaa9ee20}
\begin{figure}[htbp]
\centering
\includegraphics[width=.7\textwidth]{./mito/figures/c2.pdf}
\caption{\label{fig:orgf539ab6}CII Assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:org9246297}
\begin{itemize}
\item Complex II activity
\end{itemize}
\subsubsection{Principle}
\label{sec:org9fed64a}
\begin{itemize}
...
\label{sec:org2f46362}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/c2c3.pdf}
\caption{\label{fig:org744b91a}CII \& CIII}
\end{figure}

\subsubsection{Purpose}
\label{sec:org0f74e7b}
\begin{itemize}
...
\label{sec:org70698b2}
\begin{figure}[htbp]
\centering
\includegraphics[width=.7\textwidth]{./mito/figures/c4.pdf}
\caption{\label{fig:orgb9097ab}CIV Assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:orga87c5a9}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:orge8dbc58}
\subsubsection{Purpose}
\label{sec:org444691a}
\begin{itemize}
...
\section{VLCFA}
\label{sec:orgb9c7d76}
\begin{itemize}
\item investigation of peroxisomal disorders (Table \ref{tab:org89c2a64})
\item C22, C24 and C26 fatty acids and their ratios are measured
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org89c2a64}VLCFAs in Peroxisomal Disease}
\centering
\begin{tabular}{llll}
...
\label{sec:org6a7f682}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{gags/figures/cs.png}
\caption{\label{fig:org489f628}Chondroitin Sulfate}
\end{figure}
...
\caption{\label{fig:org95a4599}Dermatan Sulfate}
\end{figure}
...
\caption{\label{fig:org9b119f1}Heparan Sulfate}
\end{figure}
...
\caption{\label{fig:org025f052}Keratan Sulfate}
\end{figure}


\subsection{Berry Spot Test}
\label{sec:org6f23f0f}
\begin{itemize}
\item provides a rapid qualitative evaluation of urine (Figure \ref{fig:org6bb5d7b})
...
\caption{\label{fig:org6bb5d7b}Positive (a) and Negative (b) Berry Spot Test}
\end{figure}


\subsection{Spectrophotometric}
\label{sec:org4f83638}
\begin{itemize}
\item urine sample
...
\label{sec:org09ec440}
\begin{itemize}
\item TLC or electrophoresis used to fractionate urine GAGs (Figures \ref{fig:orgc5ad4bc} and \ref{fig:org7f9d237})
...
\caption{\label{fig:orgc5ad4bc}TLC for urine GAGs}
\end{figure}
...
\caption{\label{fig:org7f9d237}Electrophoresis for urine GAGs: LZ loading zone}
\end{figure}
\section{Oligosacarides}
\label{sec:org1ea3592}
\subsection{Fractionation}
\label{sec:org370f5d7}
\begin{itemize}
\item TLC is used to fractionate urine oligosaccharides (Figure \ref{fig:org1be403c})
...
\caption{\label{fig:org1be403c}TLC of urinary oligos:control, \(\alpha\)-mannosidosis, fucosidosis, Sandhoff and aspartylglucosaminuria}
\end{figure}
\section{Enzymes}
\label{sec:orgfb9ba82}
\subsection{GALT}
\label{sec:org6a7dc90}
\subsubsection{Beutler Test}
\label{sec:orgdbe56c7}
...
\caption{\label{fig:org0e12623}Beutler Method}
\end{figure}


\subsubsection{Spotcheck}
\label{sec:org1a0bd08}
...
\caption[4MUI]{\label{fig:org6765752}4-Methylumbelliferyl-\(\alpha\)-L-Iduronide}
\end{figure}

\begin{enumerate}
\item Known Issues
\label{sec:orgc882ecb}
\begin{enumerate}
\item Psuedodeficiency
\label{sec:org8e3da95}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org71aed4c}Neo-LSD Lysosomal enzyme activities}
\centering
\begin{tabular}{lll}
...
with a very low percent HexA (Table \ref{tab:org137e053})
...
\begin{table}[htbp]
\caption{\label{tab:org137e053}Biochemical Results in GM2 Gangliosidosis}
\centering
\begin{tabular}{lllll}
...
\label{sec:orgceaca5e}
\subsection{Transferrin IEF}
\label{sec:org3812f8f}
\begin{itemize}
...
\caption{\label{fig:org6d792e3}Transferrin IEF}
\end{figure}

\subsubsection{Type 1 pattern}
\label{sec:org079b925}
\begin{itemize}
...
\end{itemize}
\section{NIET}
\label{sec:org7858875}
\begin{itemize}
\item used to identify a GSD in patients with myopathy (Table
\ref{tab:org5ea5a1e} and Figure \ref{fig:org29d5fd6})
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org5ea5a1e}NIET in Myopathy}
\centering
\begin{tabular}{lll}
...
\label{sec:orge5443ef}
\subsubsection{Lactate}
\label{sec:org41cf000}
\begin{itemize}
...
the liver by LDH (Figure \ref{fig:org1a2c5fb})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\textwidth]{niet/figures/Lactate_dehydrogenase_mechanism.png}
\caption{\label{fig:org1a2c5fb}LDH}
\end{figure}

\subsubsection{ATP}
\label{sec:org3274050}
\begin{itemize}
...
\label{sec:org56e477f}
\begin{itemize}
\item most ammonia produced by exercising muscle removed by formation of glutamine (Figure \ref{fig:orgcca059e})
\begin{itemize}
...
\caption[gln]{\label{fig:orgcca059e}Glutamine and Ammonia}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=.6\textheight]{niet/figures/niet_results.png}
\caption[interp]{\label{fig:org29d5fd6}NIET Results}
\end{figure}
...
\caption{\label{fig:orge128889}NIET Method}
\end{figure}
\section{Porphyrins}
\label{sec:org15e86cf}
\subsection{Methods for Metabolites}
\label{sec:org5758b6f}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:org1ac8010}
\begin{enumerate}
\item Porphobilinogen
\label{sec:org7d141a0}
\begin{itemize}
