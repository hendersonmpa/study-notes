...
\section{Amino Acids}
\label{sec:orgd56653e}
\subsection{Introduction}
\label{sec:orga689eda}
\begin{enumerate}
\item Amino Acids: A Very Short Introduction
\label{sec:org34d3e65}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orge498918}plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{orgd7a8458}sulphocysteine may not be detectable in plasma using routine methods}

\item Sample Types
\label{sec:org3bbfe1e}
\begin{enumerate}
\item Plasma
\label{sec:orga456a2a}
\begin{itemize}
\item patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:org87232b1}
\begin{enumerate}
\item LC-MS/MS schematic
\label{sec:orgba30218}
...
\caption{\label{fig:org3dca458}LC-MS/MS outletmethod}
\end{figure}

\item Ion-Pairing Chromatography
\label{sec:org206399b}
...
\begin{table}[htbp]
\caption{\label{tab:org06bd274}AA Quantified by LC-MS/MS}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org5aaf063}reported in urine}

\item Pros and Cons of LC-MS/MS vs FIA-MS/MS
\label{sec:org94b483a}
\begin{enumerate}
\item Pros
\label{sec:org4e43ef1}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org62dcbec}Acylcarnitine Panel}
\centering
\begin{tabular}{lll}
...
\label{sec:org14618fb}

\begin{enumerate}
\item FIA-MS/MS Schematic
\label{sec:org920ad47}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\begin{table}[htbp]
\caption{\label{tab:orge0cf0fc}Quantified Amino Acids}
\centering
\begin{tabular}{ll}
glycine & tyrosine\\
alanine & ornithine\\
...
\begin{table}[htbp]
\caption{\label{tab:org20479b7}MRM is used to detected selected acylcarnitines}
\centering
\begin{tabular}{ll}
Compound & Reaction\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orgc6ce441}Quantified Acylcarnitines}
\centering
\begin{tabular}{lll}
C0 & C8 & C16\\
C2 & C8:1 & C16:1\\
...
\label{sec:org9586264}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org9ba54b6}
\begin{itemize}
...
\label{sec:orgfd38e3a}
\subsection{Introduction}
\label{sec:orgc68f1de}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org421301d}Organic Acid Functional Groups}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:org30e1fb1}Organic Acid Side Chains}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:orgc9e3395}Organic Acid Nomenclature}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:org4661328}Pathologic Acylglycines}
\centering
\begin{tabular}{llll}
...
\label{sec:orga4c8079}
\begin{enumerate}
\item Endogenous
\label{sec:org2fdecc4}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgb7ffe80}Disorders of Organic Acid Metabolism}
\centering
\begin{tabular}{ll}
...
\label{sec:org1148def}
\begin{enumerate}
\item Oximation
\label{sec:orge781f0e}
\begin{itemize}
...
\label{sec:org9f26831}
\subsection{Introduction}
\label{sec:orga61b128}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:org1bc4a81}Electron Transport Chain}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:org1d7da3e}
\begin{enumerate}
\item CI
\label{sec:orge015fc6}
\begin{itemize}
...
\subsection{GALT}
\label{sec:org52dc92e}
\begin{enumerate}
\item Beutler Test
\label{sec:orgb6d4d15}
...
\caption{\label{fig:orgc5ec50d}Beutler Method}
\end{figure}


\item Spotcheck
\label{sec:org97476c2}
...
\label{sec:org146c1f6}
\begin{enumerate}
\item Multiplex DBS Assay
\label{sec:org0438510}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgcfadffb}NIET in Myopathy}
\centering
\begin{tabular}{lll}
 & Lactate & Ammonia\\
\hline
...
\end{table}
\section{Porphyrins}
\label{sec:org70ded32}
\subsection{Methods for Metabolites}
\label{sec:org61cd5cd}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:org1a16654}
\begin{enumerate}
\item Porphobilinogen
\label{sec:orgc4d48bb}
\begin{itemize}
