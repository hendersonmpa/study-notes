...
\section{Amino Acids}
\label{sec:org47843c8}
\subsection{Introduction}
\label{sec:org3a12f95}
\begin{enumerate}
\item Amino Acids: A Very Short Introduction
\label{sec:org52a5d5b}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org8bbf540}Plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{orga7e5489}Sulphocysteine may not be detectable in plasma using routine methods}

\item Sample Types
\label{sec:orgea65269}
\begin{enumerate}
\item Plasma
\label{sec:orgf0bde6d}
\begin{itemize}
\item patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:org0cb2e75}
\begin{enumerate}
\item LC-MS/MS schematic
\label{sec:orgb65e7f5}
...
\label{sec:org74779b9}
\begin{enumerate}
\item Pros
\label{sec:orgbea5b10}
\begin{itemize}
...
\label{sec:org3637f18}
\begin{enumerate}
\item Sample Prep
\label{sec:org9a1777e}
...
201–202.\label{org4484c99}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgb128bcc}
...
\label{sec:org017901e}

\begin{enumerate}
\item FIA-MS/MS Schematic
\label{sec:org5a2e939}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\label{sec:org06a4755}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org10ee60f}
\begin{itemize}
...
\label{sec:org3151d7e}
\subsection{Introduction}
\label{sec:org5838051}
\begin{itemize}
...
\label{sec:org41f9246}
\begin{enumerate}
\item Endogenous
\label{sec:org90be207}
\begin{itemize}
...
\label{sec:org179c498}
\begin{enumerate}
\item Oximation
\label{sec:orgdad77ba}
\begin{itemize}
...
\label{sec:orgcf8372e}
\subsection{Introduction}
\label{sec:orgb33baf7}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:orgfa4c6e1}
Electron Transport Chain}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:org301986a}
\begin{enumerate}
\item CI
\label{sec:org6530a0b}
\begin{itemize}
...
\label{sec:orga95cd49}
\begin{enumerate}
\item Purpose
\label{sec:orga2b1678}
\begin{itemize}
...
\label{sec:org6edaf0d}
\begin{enumerate}
\item Purpose
\label{sec:orgf5fad4e}
\begin{itemize}
\item Complex II activity
\end{itemize}
\item Principle
\label{sec:org13d9594}
\begin{itemize}
...
\label{sec:org7d53a6f}
\begin{enumerate}
\item Purpose
\label{sec:orgf266edf}
\begin{itemize}
...
\label{sec:org3ca9af7}
\begin{enumerate}
\item Purpose
\label{sec:orgd269dab}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:orgea10437}
\begin{enumerate}
\item Purpose
\label{sec:org874bef1}
\begin{itemize}
...
\label{sec:org6621225}
\section{{\bfseries\sffamily TODO} GAGs and Oligosacarides}
\label{sec:orgd1bf9d4}
\section{Enzymes}
\label{sec:org0acfc81}
\subsection{GALT}
\label{sec:orgc99a249}
\begin{enumerate}
\item Beutler Test
\label{sec:orgc3b1d4d}
...
\caption{\label{fig:org2839edd}
Beutler Method}
\end{figure}


\item Spotcheck
\label{sec:orgb47097e}
...
\label{sec:orgd871a25}
\begin{enumerate}
\item Multiplex DBS Assay
\label{sec:orga8a8282}
\begin{itemize}
...
\label{sec:org46f238d}
\subsection{Transferrin IEF}
\label{sec:org93ea48a}
\begin{itemize}
...
\caption{\label{fig:org57a9688}
Transferrin IEF}
\end{figure}

\begin{enumerate}
\item Type 1 pattern
\label{sec:orge8d9b0d}
\begin{itemize}
...
\end{itemize}
\section{NIET}
\label{sec:org148b0c6}
\subsection{Exercising Muscle}
\label{sec:org8c4052f}
\begin{enumerate}
\item Lactate
\label{sec:orgb9345b8}
\begin{itemize}
...
\caption{\label{fig:org75016ec}
LDH}
\end{figure}

\item ATP
\label{sec:org2d587a9}
\begin{itemize}
...
\caption[gln]{\label{fig:org03d1187}
...
\caption[interp]{\label{fig:org1c66145}
NIET Results}
\end{figure}
\end{enumerate}
...
\label{sec:orge1b53a4}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./niet/figures/niet_method.png}
\caption{\label{fig:org8cde938}
NIET Method}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:orgeb1d8fd}
NIET in Myopathy}
\centering
\begin{tabular}{lll}
 & Lactate & Ammonia\\
...
\end{table}
\section{Porphyrins}
\label{sec:orgf3bad38}
\subsection{Methods for Metabolites}
\label{sec:org8b7193f}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:org5083974}
\begin{enumerate}
\item Porphobilinogen
\label{sec:org5173c2b}
\begin{itemize}
