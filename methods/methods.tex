...
\section{Amino Acids}
\label{sec:org5ad8f0f}
\subsection{Introduction}
\label{sec:org5638304}
\begin{enumerate}
\item Amino Acids: A Very Short Introduction
\label{sec:org0b251dd}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org0ea8230}Plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{orgcc3d2b8}Sulphocysteine may not be detectable in plasma using routine methods}

\item Plasma
\label{sec:org2248b11}
\begin{itemize}
\item Patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:org488b963}
\begin{enumerate}
\item LC-MS/MS schematic
\label{sec:org70323ab}
\begin{center}
...
\label{sec:org1e690dd}
\begin{itemize}
\item As compared to FIA-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org3bd1e21}
\begin{itemize}
...
\label{sec:org6d88c05}
\subsection{Introduction}
\label{sec:org49e5707}
\begin{itemize}
...
\label{sec:orgb8c9187}
\begin{enumerate}
\item Diagnostic FIA-MS/MS schematic
\label{sec:org3eeb4e4}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
used with caution." \textsuperscript{\ref{org3e9c86a}}
\end{itemize}

\item Pros and Cons of Butanol  FIA-MSMS for Aceylcarnitines
\label{sec:org783f063}
\begin{enumerate}
\item Pros
\label{sec:orgd512077}
\begin{itemize}
\item Speed
\item Sensitivity
\item Expertise
...
\label{sec:org6d3bd57}
\subsection{Background}
\label{sec:orgc18468b}
\begin{enumerate}
\item What are urine organic acids?
\label{sec:orgfae56a0}
\begin{itemize}
...
\label{sec:org8b1f35d}
\centering
\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}
\begin{table}[htbp]
\caption{\label{tab:org10feed7}
...
\item Side Chains
\label{sec:org28225f9}
\centering
\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}
\begin{table}[htbp]
\caption{\label{tab:org84725f5}
...
\label{sec:orgc6ea28c}
\begin{enumerate}
\item Endogenous Sources
\label{sec:orgd0f6960}
\begin{itemize}
...
\label{sec:orgd0845ae}
\begin{enumerate}
\item Oximation
\label{sec:org1023679}
\begin{itemize}
...
\label{sec:org246d476}

\item Mass-spectroscopy
\label{sec:orgf00cce8}

\item Reporting
\label{sec:orgb66f859}
\end{enumerate}

\section{NBS}
\label{sec:org2b94ca6}
\subsection{Dried Blood Spot}
\label{sec:orgd7471bc}
\begin{itemize}
...
\subsection{AAAC}
\label{sec:org7af40e4}
\begin{enumerate}
\item FIA-MS/MS schematic
\label{sec:orgac1a007}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\item Overestimation of Free Carnitine
\label{sec:org915c83c}
\begin{itemize}
\item Butylated acylcarnitines are converted to butylated carnitine in
n-butanol-3M HCl at 65\degree{}C. \footnote{Johnson, D. W. (1999). Inaccurate measurement of free
carnitine by the electrospray tandem mass spectrometry screening
method for blood spots. Journal of Inherited Metabolic Disease, 22(2),
201–202.\label{orgd0b878e}}
\end{itemize}
...
\item "The free carnitine results obtained by this screening method on
blood spots with high levels of acylcarnitines should therefore be
used with caution." \textsuperscript{\ref{orgd0b878e}}
\end{itemize}

\item Pros and Cons of FIA-MS/MS using DBS
\label{sec:orgc92e03c}
\begin{itemize}
\item As compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org24f15d5}
\begin{itemize}
...
\label{sec:org27ef88e}
\subsection{GALT}
\label{sec:org24b0f3c}
\begin{enumerate}
