...
\begin{table}[htbp]
\caption{\label{tab:org31f5a49}Recommended Plasma AA Profile for Diagnosis of Amino Acid Disorders}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orga75235c}plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{org1907d63}sulphocysteine may not be detectable in plasma using routine methods}

\subsubsection{Sample Types}
\label{sec:orge28f8bd}
\begin{enumerate}
\item Plasma
\label{sec:org17e15fe}
\begin{itemize}
\item patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:orgb3fb09a}
\subsubsection{LC-MS/MS schematic}
\label{sec:org7e003c8}
...
\caption{\label{fig:orgf6d7e6a}LC-MS/MS Outlet Method}
\end{figure}

\subsubsection{Ion-Pairing Chromatography}
\label{sec:org9ef412d}
...
\begin{table}[htbp]
\caption{\label{tab:orge60cdc5}AA Quantified by LC-MS/MS}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org0e25382}reported in urine}

\subsubsection{Pros and Cons of LC-MS/MS vs AAA}
\label{sec:orgc0c03a1}
\begin{enumerate}
\item Pros
\label{sec:orgae943b3}
\begin{itemize}
...
\label{sec:org1cf8d89}
\begin{enumerate}
\item Pros
\label{sec:org4422f60}
\begin{itemize}
...
\caption{\label{fig:org3e56966}Enzymatic Total Homocysteine Method}
\end{figure}
\section{Acylcarnitines}
\label{sec:org207b8b2}
\subsection{Introduction}
\label{sec:org4e83fe7}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org73285f2}Acylcarnitine Panel}
\centering
\begin{tabular}{lll}
...
201–202.\label{org5ec939a}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org8dd2c76}Overestimation of Free Carnitine}
\centering
\begin{tabular}{lr}
...
\label{sec:orgd467b66}

\subsubsection{FIA-MS/MS Schematic}
\label{sec:orgbb2d1ad}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\begin{table}[htbp]
\caption{\label{tab:org0893420}Quantified Amino Acids}
\centering
\begin{tabular}{ll}
glycine & tyrosine\\
alanine & ornithine\\
...
\begin{table}[htbp]
\caption{\label{tab:org71dc4f0}MRM is used to detected selected acylcarnitines}
\centering
\begin{tabular}{ll}
Compound & Reaction\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org76086b8}Quantified Acylcarnitines}
\centering
\begin{tabular}{lll}
C0 & C8 & C16\\
C2 & C8:1 & C16:1\\
...
\begin{table}[htbp]
\caption{\label{tab:org2934b64}Organic Acid Functional Groups}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:org6733eb3}Organic Acid Side Chains}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:org576deb5}Organic Acid Nomenclature}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:org94d04f6}Acylglycines}
\centering
\begin{tabular}{llll}
...
\label{sec:orgebee811}
\begin{enumerate}
\item Endogenous
\label{sec:org696bc0b}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgd879029}Disorders of Organic Acid Metabolism}
\centering
\begin{tabular}{ll}
...
\label{sec:orge38c0d5}
\subsubsection{Oximation}
\label{sec:org19008cc}
\begin{itemize}
...
\label{sec:org2736de8}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:org35333df}Flow of Electrons in the ETC}
\end{figure}

\subsection{Citrate Synthase}
\label{sec:org3c66d0c}
\subsubsection{Purpose}
\label{sec:orgd6c5a1d}
\begin{itemize}
...
\label{sec:org3aa36a3}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/c1c3.pdf}
\caption{\label{fig:orgc61c038}CI \& III assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:org2a06e46}
\begin{itemize}
...
\label{sec:org028dd3d}
\begin{figure}[htbp]
\centering
\includegraphics[width=.7\textwidth]{./mito/figures/c2.pdf}
\caption{\label{fig:orga194ad4}CII Assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:org1f58ef7}
\begin{itemize}
\item Complex II activity
\end{itemize}
\subsubsection{Principle}
\label{sec:orgadf5df4}
\begin{itemize}
...
\label{sec:org646b232}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/c2c3.pdf}
\caption{\label{fig:org9378d8b}CII \& CIII}
\end{figure}

\subsubsection{Purpose}
\label{sec:org1d0de3c}
\begin{itemize}
...
\label{sec:org04868d3}
\begin{figure}[htbp]
\centering
\includegraphics[width=.7\textwidth]{./mito/figures/c4.pdf}
\caption{\label{fig:org1c538eb}CIV Assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:org004e223}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:orgc5b0862}
\subsubsection{Purpose}
\label{sec:orga202eba}
\begin{itemize}
...
\section{VLCFA}
\label{sec:org4cefb3f}
\begin{itemize}
\item investigation of peroxisomal disorders (Table \ref{tab:org7c3f2cf})
\item C22, C24 and C26 fatty acids and their ratios are measured
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org7c3f2cf}VLCFAs in Peroxisomal Disease}
\centering
\begin{tabular}{llll}
...
\label{sec:orgb832869}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{gags/figures/cs.png}
\caption{\label{fig:org991ef92}Chondroitin Sulfate}
\end{figure}
...
\caption{\label{fig:org87d543a}Dermatan Sulfate}
\end{figure}
...
\caption{\label{fig:org55fac26}Heparan Sulfate}
\end{figure}
...
\caption{\label{fig:org0165bbf}Keratan Sulfate}
\end{figure}


\subsection{Berry Spot Test}
\label{sec:org2eaa58f}
\begin{itemize}
\item provides a rapid qualitative evaluation of urine (Figure \ref{fig:orgb0f2af4})
...
\caption{\label{fig:orgb0f2af4}Positive (a) and Negative (b) Berry Spot Test}
\end{figure}

\subsection{Spectrophotometric}
\label{sec:org0e2ec72}
\begin{itemize}
\item total GAGs
\item urine sample
...
\label{sec:org2197029}
\begin{itemize}
\item TLC or electrophoresis used to fractionate urine GAGs (Figures \ref{fig:org7565d1c} and \ref{fig:org74863d7})
...
\caption{\label{fig:org7565d1c}TLC for Urine GAGs}
\end{figure}
...
\caption{\label{fig:org74863d7}Electrophoresis for Urine GAGs: LZ loading zone}
\end{figure}
...
\label{sec:orgeb2613c}
\subsection{Fractionation}
\label{sec:orgee9f2fe}
\begin{itemize}
\item TLC is used to fractionate urine oligosaccharides (Figure \ref{fig:org0d7fd6b})
...
\caption{\label{fig:org0d7fd6b}TLC of Urinary Oligosacarides: control, \(\alpha\)-mannosidosis, fucosidosis, Sandhoff and aspartylglucosaminuria}
\end{figure}
\section{Enzymes}
\label{sec:org43128b1}
\subsection{GALT}
\label{sec:org667c2e4}
...
\caption[4MUI]{\label{fig:org2693208}4-Methylumbelliferyl-\(\alpha\)-L-Iduronide}
\end{figure}

\begin{enumerate}
\item Known Issues
\label{sec:org133a6ad}
\begin{enumerate}
\item Pseudodeficiency
\label{sec:org25bc959}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgb7ead7e}Neo-LSD Lysosomal Enzyme Activities}
\centering
\begin{tabular}{lll}
...
with a very low percent HexA (Table \ref{tab:org78742ec})
...
\begin{table}[htbp]
\caption{\label{tab:org78742ec}Biochemical Results in GM2 Gangliosidosis}
\centering
\begin{tabular}{lllll}
...
\label{sec:orgb1dc8b4}
\subsection{Transferrin IEF}
\label{sec:org2e26cc5}
\begin{itemize}
...
\caption{\label{fig:orgb7e036c}Transferrin IEF}
\end{figure}

\subsubsection{Type 1 pattern}
\label{sec:orgefe54b3}
\begin{itemize}
...
\label{sec:orga60b0e5}
\subsubsection{Lactate}
\label{sec:org116ada9}
\begin{itemize}
...
the liver by LDH (Figure \ref{fig:orgd798563})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\textwidth]{niet/figures/Lactate_dehydrogenase_mechanism.png}
\caption{\label{fig:orgd798563}LDH}
\end{figure}

\subsubsection{ATP}
\label{sec:org6fe68fb}
\begin{itemize}
...
\label{sec:org6bd0bab}
\begin{itemize}
\item most ammonia produced by exercising muscle removed by formation of glutamine (Figure \ref{fig:org85079bd})
\begin{itemize}
...
\caption[gln]{\label{fig:org85079bd}Glutamine and Ammonia}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=.6\textheight]{niet/figures/niet_results.png}
\caption[interp]{\label{fig:org331fad1}NIET Results}
\end{figure}
...
\caption{\label{fig:org58cba6c}NIET Method}
\end{figure}
\section{Porphyrins}
\label{sec:org7d51168}
\subsection{Methods for Metabolites}
\label{sec:org1537024}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:orgb011e7e}
\begin{enumerate}
\item Porphobilinogen
\label{sec:orgc05b25f}
\begin{itemize}
