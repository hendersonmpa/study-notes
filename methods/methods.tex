...
\section{NBS}
\label{sec:org1dfe817}
\subsection{Dried Blood Spot}
\label{sec:org225eeb1}
\begin{itemize}
...
\subsection{AAAC}
\label{sec:org8d909e5}
\begin{enumerate}
\item FIA-MS/MS schematic
\label{sec:org22de728}
\begin{center}
...
\caption{\label{fig:org464279d}
FIA-MS/MS Method}
\end{figure}

\item AA NL Scan
\label{sec:org3fdcae1}
\begin{itemize}
...
201–202.\label{org1dffbac}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org60a32cb}
...
used with caution." \textsuperscript{\ref{org1dffbac}}
\end{itemize}

\item Pros and Cons of FIA-MS/MS using DBS
\label{sec:orgeb0ae66}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org63eaaca}
\begin{itemize}
...
\end{enumerate}
\section{Amino Acids}
\label{sec:org0682261}
\subsection{Introduction}
\label{sec:org739bd66}
\begin{enumerate}
\item Amino Acids: A Very Short Introduction
\label{sec:orgdbae1e7}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[2]{\label{orgfa053ee}Plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[3]{\label{org23aa5d2}Sulphocysteine may not be detectable in plasma using routine methods}

\item Plasma
\label{sec:orge2e6748}
\begin{itemize}
\item Patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:orgeb7bf9d}
\begin{enumerate}
\item LC-MS/MS schematic
\label{sec:org2b083ea}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\label{sec:org98d197b}
\begin{enumerate}
\item Pros
\label{sec:orgbb76f93}
\begin{itemize}
...
\label{sec:org78cd7e5}
\begin{enumerate}
\item Pros
\label{sec:org82efb5f}
\begin{itemize}
...
\label{sec:org6d0d98f}
\subsection{Introduction}
\label{sec:org5f073db}
\begin{itemize}
...
\label{sec:org0cc11ad}
\subsection{Background}
\label{sec:org32c2ef1}
\begin{enumerate}
\item What are urine organic acids?
\label{sec:org622c5ed}
\begin{itemize}
...
\label{sec:org9d76df1}

\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}

\begin{table}[htbp]
\caption{\label{tab:org9140435}
...
\item Side Chains
\label{sec:org8a1161e}

\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}

\begin{table}[htbp]
\caption{\label{tab:orge8f4139}
...
\label{sec:org961fffa}
\begin{enumerate}
\item Endogenous Sources
\label{sec:orgab34315}
\begin{itemize}
...
\label{sec:org232bb71}
\begin{enumerate}
\item Oximation
\label{sec:orgcc0ef51}
\begin{itemize}
...
\label{sec:org3e8da0e}

\item Mass-spectroscopy
\label{sec:org3b98008}

\item Reporting
\label{sec:org2956200}
\end{enumerate}
\section{Mitochondria}
\label{sec:org60f680e}
\subsection{Introduction}
\label{sec:orgfe5cc0b}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:org8a750b5}
Electron Transport Chain}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:org67fbd49}
\begin{enumerate}
\item CI
\label{sec:org1b289dd}
\begin{itemize}
...
\label{sec:org992fe42}
\subsection{CI+III assay}
\label{sec:orgf3b1cb6}
\begin{enumerate}
\item Purpose
\label{sec:org6459c65}
\begin{itemize}
...
\label{sec:orgb4f5563}
\begin{enumerate}
\item Purpose
\label{sec:org9942c6a}
\begin{itemize}
\item Complex II activity
\end{itemize}
\item Principle
\label{sec:orgfc6e0ef}
\begin{itemize}
...
\label{sec:org60e81d6}
\begin{enumerate}
\item Purpose
\label{sec:org10e1cc5}
\begin{itemize}
...
\label{sec:orgc836c34}
\begin{enumerate}
\item Purpose
\label{sec:org1de3b14}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:org8220285}
\begin{enumerate}
\item Purpose
\label{sec:org868b450}
\begin{itemize}
...
\label{sec:orgc724e63}
\section{{\bfseries\sffamily TODO} GAGs and Oligosacarides}
\label{sec:org3432c8d}
\section{Enzymes}
\label{sec:org1cb762c}
\subsection{GALT}
\label{sec:org7006ddc}
\begin{enumerate}
\item Beutler Test
\label{sec:org21b1330}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./figures/beutler.jpg}
\caption{\label{fig:org8304aca}
Beutler Method}
\end{figure}


\item Spotcheck
\label{sec:orge4dba15}
...
\label{sec:org757cc8c}
\begin{enumerate}
\item Multiplex DBS Assay
\label{sec:orga5e758b}
\begin{itemize}
...
\label{sec:org8a6b604}
\subsection{Transferrin IEF}
\label{sec:orgc7764d8}
\begin{itemize}
...
\caption{\label{fig:org5ffadab}
Transferrin IEF}
\end{figure}

\begin{enumerate}
\item Type 1 pattern
\label{sec:orga9f3379}
\begin{itemize}
...
\end{itemize}
\section{NIET}
\label{sec:org83cc3ef}
\subsection{Exercising Muscle}
\label{sec:org7cfddba}
\begin{enumerate}
\item Lactate
\label{sec:org425573b}
\begin{itemize}
...
\caption{\label{fig:org3df89db}
LDH}
\end{figure}

\item ATP
\label{sec:orgd332ef5}
\begin{itemize}
...
\caption[gln]{\label{fig:org83a11e7}
...
\caption[interp]{\label{fig:org58a8b3f}
NIET Results}
\end{figure}
\end{enumerate}
...
\label{sec:org13c7315}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./niet/figures/niet_method.png}
\caption{\label{fig:orgbdcf88f}
NIET Method}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org6a07934}
NIET in Myopathy}
\centering
\begin{tabular}{lll}
 & Lactate & Ammonia\\
...
\end{table}
\section{Porphyrins}
\label{sec:org04f5721}
\subsection{Methods for Metabolites}
\label{sec:org333881c}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:org2862bc1}
\begin{enumerate}
\item Porphobilinogen
\label{sec:orgbdaa145}
\begin{itemize}
