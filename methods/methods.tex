...
\section{NBS}
\label{sec:org3d7f74b}
\subsection{Dried Blood Spot}
\label{sec:orge7bd355}
\begin{itemize}
...
\subsection{AAAC}
\label{sec:orge25f00b}
\begin{enumerate}
\item FIA-MS/MS schematic
\label{sec:org81bc5e6}
\begin{center}
...
\caption{\label{fig:org8afd652}
FIA-MS/MS Method}
\end{figure}

\item AA NL Scan
\label{sec:orga8674ad}
\begin{itemize}
...
201–202.\label{org8381db0}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org768e359}
...
used with caution." \textsuperscript{\ref{org8381db0}}
\end{itemize}

\item Pros and Cons of FIA-MS/MS using DBS
\label{sec:orgc8ac93d}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org2ca877f}
\begin{itemize}
...
\section{Amino Acids}
\label{sec:org4293341}
\subsection{Introduction}
\label{sec:org7dc1233}
\begin{enumerate}
\item Amino Acids: A Very Short Introduction
\label{sec:org1a3e119}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org993ac0c}Plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[3]{\label{orge7b4af6}Sulphocysteine may not be detectable in plasma using routine methods}

\item Plasma
\label{sec:org7923708}
\begin{itemize}
\item Patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:orgae891f5}
\begin{enumerate}
\item LC-MS/MS schematic
\label{sec:org5a0f171}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\label{sec:orgdbe58ab}
\begin{itemize}
\item As compared to FIA-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org59cb9fe}
\begin{itemize}
...
\label{sec:org56ef5ef}
\subsection{Introduction}
\label{sec:orga74a329}
\begin{itemize}
...
\label{sec:orge91f02a}
\subsection{Background}
\label{sec:orgfe8cbc8}
\begin{enumerate}
\item What are urine organic acids?
\label{sec:org699a20a}
\begin{itemize}
...
\label{sec:org271b3c9}
\centering
\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}
\begin{table}[htbp]
\caption{\label{tab:org8324e13}
...
\item Side Chains
\label{sec:org50fe342}
\centering
\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}
\begin{table}[htbp]
\caption{\label{tab:orgd2fd3d6}
...
\label{sec:org751bbbd}
\begin{enumerate}
\item Endogenous Sources
\label{sec:org42e7ece}
\begin{itemize}
...
\label{sec:orgecb0041}
\begin{enumerate}
\item Oximation
\label{sec:org14651a2}
\begin{itemize}
...
\label{sec:org90d7803}

\item Mass-spectroscopy
\label{sec:org27b6a01}

\item Reporting
\label{sec:org224e7f7}
\end{enumerate}
\section{Mitochondria}
\label{sec:org829a7b4}
\subsection{Introduction}
\label{sec:orga438470}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./oxphos/figures/etc.pdf}
\caption{\label{fig:orgae0a25b}
Electron Transport Chain}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:org4c0de74}
\begin{enumerate}
\item CI
\label{sec:org8691b08}
\begin{itemize}
...
\label{sec:org4e0c5ed}
\subsection{CI+III assay}
\label{sec:org9f1f9d7}
\begin{enumerate}
\item Purpose
\label{sec:org6d00243}
\begin{itemize}
...
\label{sec:org3bfb455}
\begin{enumerate}
\item Purpose
\label{sec:org855376e}
\begin{itemize}
\item Complex II activity
\end{itemize}
\item Principle
\label{sec:orgeda5c04}
\begin{itemize}
...
\label{sec:orgeb46900}
\begin{enumerate}
\item Purpose
\label{sec:orgd01fdb3}
\begin{itemize}
...
\label{sec:org38acd20}
\begin{enumerate}
\item Purpose
\label{sec:org1a9b51d}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:org32d31e6}
\begin{enumerate}
\item Purpose
\label{sec:orgfb0fa8e}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{./gly/figures/transferrin_ief.png}
\caption{\label{fig:orgb7a9f22}
Transferrin IEF}
\end{figure}

\begin{enumerate}
\item Type 1 pattern
\label{sec:org7868ba2}
\begin{itemize}
...
\end{itemize}
\section{NIET}
\label{sec:org81ed174}
\subsection{Exercising Muscle}
\label{sec:org5d36548}
\begin{enumerate}
\item Lactate
\label{sec:orgfdedb9a}
\begin{itemize}
...
\caption{\label{fig:org2776e03}
LDH}
\end{figure}

\item ATP
\label{sec:orgf3ec0cf}
\begin{itemize}
...
\caption[gln]{\label{fig:org06683b3}
...
\caption[interp]{\label{fig:orga71f1fd}
NIET Results}
\end{figure}
\end{enumerate}
...
\label{sec:org4b52249}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./niet/figures/niet_method.png}
\caption{\label{fig:org554ada6}
NIET Method}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:orgb4ef96a}
NIET in Myopathy}
\centering
\begin{tabular}{lll}
 & Lactate & Ammonia\\
...
\end{table}
\section{Porphyrins}
\label{sec:org6afcf60}
\subsection{Methods for Metabolites}
\label{sec:orge5d3417}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:org2efc9e9}
\begin{enumerate}
\item Porphobilinogen
\label{sec:org1681d53}
\begin{itemize}
