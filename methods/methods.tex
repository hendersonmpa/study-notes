...
\section{Amino Acids}
\label{sec:org9d24477}
\subsection{Introduction}
\label{sec:orge202749}
\begin{enumerate}
\item Amino Acids: A Very Short Introduction
\label{sec:orgc78cb7c}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org0437ef8}Recommended Plasma AA Profile for Diagnosis of Amino Acid Disorders}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgac68d35}plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{org14d7e45}sulphocysteine may not be detectable in plasma using routine methods}

\item Sample Types
\label{sec:org0e28655}
\begin{enumerate}
\item Plasma
\label{sec:org92a891b}
\begin{itemize}
\item patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:orgce0108f}
\begin{enumerate}
\item LC-MS/MS schematic
\label{sec:org749640b}
...
\caption{\label{fig:org5680651}LC-MS/MS outletmethod}
\end{figure}

\item Ion-Pairing Chromatography
\label{sec:orgdf8621f}
...
\begin{table}[htbp]
\caption{\label{tab:orgeda96d9}AA Quantified by LC-MS/MS}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{orge65f1b7}reported in urine}

\item Pros and Cons of LC-MS/MS vs FIA-MS/MS
\label{sec:org6920f96}
\begin{enumerate}
\item Pros
\label{sec:org1b207ae}
\begin{itemize}
...
\label{sec:org9ab74c0}
\begin{enumerate}
\item Pros
\label{sec:org354aaf1}
\begin{itemize}
...
standard IEC chromatogram (see above section \ref{sec:orgd43ae55})
\end{itemize}
\item long term reagent expense
\end{itemize}

\item Cons
\label{sec:org714a640}
\begin{itemize}
...
\label{sec:org3ce9df4}
\subsection{Introduction}
\label{sec:orgb0533db}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org762c98d}Acylcarnitine Panel}
\centering
\begin{tabular}{lll}
...
\label{sec:org6ec8d66}
\begin{enumerate}
\item Sample Prep
\label{sec:orgd8c4e71}
...
\caption{\label{fig:orgcfabb3a}Rationale for Derivatization}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{./ac/figures/outletmethod.pdf}
\caption{\label{fig:org8bf22e8}FIA-MS/MS Method}
\end{figure}

\item FIA-MS/MS schematic
\label{sec:org10f4776}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
201–202.\label{orgd8643fa}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org7357809}Overestimation of Free Carnitine}
\centering
\begin{tabular}{lr}
...
\end{enumerate}
\section{AAAC}
\label{sec:org872e348}
\subsection{Sample}
\label{sec:org5a169ea}
\begin{enumerate}
\item Dried Blood Spot
\label{sec:orgfc566e2}
\begin{itemize}
...
\label{sec:org62aa4f2}

\begin{enumerate}
\item FIA-MS/MS Schematic
\label{sec:org41eabfb}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\begin{table}[htbp]
\caption{\label{tab:orgb9855c6}Quantified Amino Acids}
\centering
\begin{tabular}{ll}
glycine & tyrosine\\
alanine & ornithine\\
...
\begin{table}[htbp]
\caption{\label{tab:orgfe50926}MRM is used to detected selected acylcarnitines}
\centering
\begin{tabular}{ll}
Compound & Reaction\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org9a36795}Quantified Acylcarnitines}
\centering
\begin{tabular}{lll}
C0 & C8 & C16\\
C2 & C8:1 & C16:1\\
...
\label{sec:org6da8636}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org4046bbf}
\begin{itemize}
...
\label{sec:org12c2535}
\subsection{Introduction}
\label{sec:org123783d}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgdb78dd6}Organic Acid Functional Groups}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:orgcfa715a}Organic Acid Side Chains}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:org386c4f5}Organic Acid Nomenclature}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:orgca5673e}Pathologic Acylglycines}
\centering
\begin{tabular}{llll}
...
\label{sec:org90222c8}
\begin{enumerate}
\item Endogenous
\label{sec:orgc6abdba}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org29a73b7}Disorders of Organic Acid Metabolism}
\centering
\begin{tabular}{ll}
...
\label{sec:org7e487d6}
\begin{enumerate}
\item Oximation
\label{sec:org594fc92}
\begin{itemize}
...
\label{sec:org0e94d66}
\subsection{Introduction}
\label{sec:org8f540b3}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:org99a438d}Electron Transport Chain}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:org3db4a63}
\begin{enumerate}
\item CI
\label{sec:org48d869f}
\begin{itemize}
...
\label{sec:org1be85fb}
\subsection{CI+III assay}
\label{sec:org82188bb}
\begin{enumerate}
\item Purpose
\label{sec:orgdb48643}
\begin{itemize}
...
\label{sec:org53ad21b}
\begin{enumerate}
\item Purpose
\label{sec:orge4efc74}
\begin{itemize}
\item Complex II activity
\end{itemize}
\item Principle
\label{sec:org871bbfd}
\begin{itemize}
...
\label{sec:org1b42290}
\begin{enumerate}
\item Purpose
\label{sec:org83a2bb0}
\begin{itemize}
...
\label{sec:orgc98bde6}
\begin{enumerate}
\item Purpose
\label{sec:org13f53e5}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:org937cf72}
\begin{enumerate}
\item Purpose
\label{sec:org32f6589}
\begin{itemize}
...
\label{sec:org673adcf}
\section{{\bfseries\sffamily TODO} GAGs and Oligosacarides}
\label{sec:org87211a8}
\section{Enzymes}
\label{sec:org56b7c40}
\subsection{GALT}
\label{sec:org9df77de}
\begin{enumerate}
\item Beutler Test
\label{sec:org5c7bc3b}
...
\caption{\label{fig:orgb857dd5}Beutler Method}
\end{figure}


\item Spotcheck
\label{sec:org9510446}
...
\label{sec:org774f128}
\begin{enumerate}
\item Multiplex DBS Assay
\label{sec:org916faf3}
\begin{itemize}
...
\label{sec:orgf1f8749}
\subsection{Transferrin IEF}
\label{sec:orga7b7e01}
\begin{itemize}
...
\caption{\label{fig:orgb06417b}Transferrin IEF}
\end{figure}

\begin{enumerate}
\item Type 1 pattern
\label{sec:orgf42226e}
\begin{itemize}
...
\end{itemize}
\section{NIET}
\label{sec:org2dd2c38}
\subsection{Exercising Muscle}
\label{sec:org745cb4e}
\begin{enumerate}
\item Lactate
\label{sec:org62146d8}
\begin{itemize}
...
\caption{\label{fig:org0e5a1a6}LDH}
\end{figure}

\item ATP
\label{sec:org4e29025}
\begin{itemize}
...
\caption[gln]{\label{fig:org964a24f}Glutamine and Ammonia}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=.6\textheight]{niet/niet/figures/niet_results.png}
\caption[interp]{\label{fig:orgac7af97}NIET Results}
\end{figure}
\end{enumerate}


\subsection{The non-ischemic forearm exercise test}
\label{sec:org87eba77}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{niet/niet/figures/niet_method.png}
\caption{\label{fig:org4333bd8}NIET Method}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org8252e49}NIET in Myopathy}
\centering
\begin{tabular}{lll}
 & Lactate & Ammonia\\
\hline
...
\end{table}
\section{Porphyrins}
\label{sec:org5817d5c}
\subsection{Methods for Metabolites}
\label{sec:org8a952e9}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:org43a98c1}
\begin{enumerate}
\item Porphobilinogen
\label{sec:orgd4797c6}
\begin{itemize}
