...
\section{NBS}
\label{sec:orgf8ca3ce}
\subsection{Dried Blood Spot}
\label{sec:org9f19d28}
\begin{itemize}
...
\subsection{AAAC}
\label{sec:orgfb44756}
\begin{enumerate}
\item FIA-MS/MS schematic
\label{sec:org2810d8e}
\begin{center}
...
\caption{\label{fig:org0748d3b}
FIA-MS/MS Method}
\end{figure}

\item AA NL Scan
\label{sec:orgf9e7789}
\begin{itemize}
...
201–202.\label{org46ddee0}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org5ea2feb}
...
used with caution." \textsuperscript{\ref{org46ddee0}}
\end{itemize}

\item Pros and Cons of FIA-MS/MS using DBS
\label{sec:orgfc49915}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:orgaa00b66}
\begin{itemize}
...
\end{enumerate}
\section{Amino Acids}
\label{sec:org6766969}
\subsection{Introduction}
\label{sec:org421dcf1}
\begin{enumerate}
\item Amino Acids: A Very Short Introduction
\label{sec:org4f261f1}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org87fc296}Plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[3]{\label{org7f18b9f}Sulphocysteine may not be detectable in plasma using routine methods}

\item Plasma
\label{sec:orgb9d2a08}
\begin{itemize}
\item Patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:org4f9df80}
\begin{enumerate}
\item LC-MS/MS schematic
\label{sec:org80b6ccb}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\label{sec:org9a7cf85}
\begin{enumerate}
\item Pros
\label{sec:org634c83b}
\begin{itemize}
...
\label{sec:orgea2b41c}
\begin{enumerate}
\item Pros
\label{sec:orgae65a74}
\begin{itemize}
...
\label{sec:orgb2ff348}
\subsection{Introduction}
\label{sec:orged63f12}
\begin{itemize}
...
\label{sec:org023e663}
\subsection{Background}
\label{sec:org3dedff9}
\begin{enumerate}
\item What are urine organic acids?
\label{sec:orgee7fa01}
\begin{itemize}
...
\label{sec:orgb148af7}

\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}

\begin{table}[htbp]
\caption{\label{tab:org78b1948}
...
\item Side Chains
\label{sec:org57cf165}

\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}

\begin{table}[htbp]
\caption{\label{tab:org81812f9}
...
\label{sec:org7324bc5}
\begin{enumerate}
\item Endogenous Sources
\label{sec:orgbd2977d}
\begin{itemize}
...
\label{sec:org5d8e0d5}
\begin{enumerate}
\item Oximation
\label{sec:orgaee0639}
\begin{itemize}
...
\label{sec:orgba7bdd9}

\item Mass-spectroscopy
\label{sec:orge4b93e1}

\item Reporting
\label{sec:org9c5c2a0}
\end{enumerate}
\section{Mitochondria}
\label{sec:orgebacfaa}
\subsection{Introduction}
\label{sec:orgb0bcedf}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:org9b89f82}
Electron Transport Chain}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:org034dd7f}
\begin{enumerate}
\item CI
\label{sec:orgc92e700}
\begin{itemize}
...
\label{sec:org9e5c9a6}
\subsection{CI+III assay}
\label{sec:orgd593b61}
\begin{enumerate}
\item Purpose
\label{sec:org66d249a}
\begin{itemize}
...
\label{sec:orge88528a}
\begin{enumerate}
\item Purpose
\label{sec:orgacb21dc}
\begin{itemize}
\item Complex II activity
\end{itemize}
\item Principle
\label{sec:orgcbd45a6}
\begin{itemize}
...
\label{sec:org0cf4ccf}
\begin{enumerate}
\item Purpose
\label{sec:org8900dc8}
\begin{itemize}
...
\label{sec:org03655f1}
\begin{enumerate}
\item Purpose
\label{sec:orgdb2925f}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:org43399d5}
\begin{enumerate}
\item Purpose
\label{sec:orgb292b5a}
\begin{itemize}
...
\label{sec:org1e13375}
\section{{\bfseries\sffamily TODO} GAGs and Oligosacarides}
\label{sec:org208be7c}
\section{Enzymes}
\label{sec:orgd48e57d}
\subsection{GALT}
\label{sec:org60f9989}
\begin{enumerate}
\item Beutler Test
\label{sec:org4a56226}
...
\caption{\label{fig:org4fb4b13}
Beutler Method}
\end{figure}


\item Spotcheck
\label{sec:orge31408c}
...
\label{sec:org5f66bff}
\begin{enumerate}
\item Multiplex DBS Assay
\label{sec:orgf52959e}
\begin{itemize}
...
\label{sec:orgf0853c6}
\subsection{Transferrin IEF}
\label{sec:orgc65e66a}
\begin{itemize}
...
\caption{\label{fig:org1d61507}
Transferrin IEF}
\end{figure}

\begin{enumerate}
\item Type 1 pattern
\label{sec:org662e0d8}
\begin{itemize}
...
\end{itemize}
\section{NIET}
\label{sec:org27d27c2}
\subsection{Exercising Muscle}
\label{sec:orgfbbade7}
\begin{enumerate}
\item Lactate
\label{sec:org625a8fc}
\begin{itemize}
...
\caption{\label{fig:org92df524}
LDH}
\end{figure}

\item ATP
\label{sec:org64aa4b1}
\begin{itemize}
...
\caption[gln]{\label{fig:org8d6aa68}
...
\caption[interp]{\label{fig:org68e9ec3}
NIET Results}
\end{figure}
\end{enumerate}
...
\label{sec:org2ad088e}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./niet/figures/niet_method.png}
\caption{\label{fig:orgd727c1b}
NIET Method}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:orgd25a223}
NIET in Myopathy}
\centering
\begin{tabular}{lll}
 & Lactate & Ammonia\\
...
\end{table}
\section{Porphyrins}
\label{sec:org038062b}
\subsection{Methods for Metabolites}
\label{sec:org0f9f827}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:org9d23c94}
\begin{enumerate}
\item Porphobilinogen
\label{sec:orgde8ae36}
\begin{itemize}
