...
\section{Amino Acids}
\label{sec:orgb9f85a6}
\subsection{Introduction}
\label{sec:org3a78c00}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org5da1c10}Recommended Plasma AA Profile for Diagnosis of Amino Acid Disorders}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgd377628}plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{org56f0fd0}sulphocysteine may not be detectable in plasma using routine methods}

\subsubsection{Sample Types}
\label{sec:org79aad64}
\begin{enumerate}
\item Plasma
\label{sec:org3ce2513}
\begin{itemize}
\item patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:orga28b814}
\subsubsection{LC-MS/MS schematic}
\label{sec:orgba53e9b}
...
\caption{\label{fig:org5222aa7}LC-MS/MS Outlet Method}
\end{figure}

\subsubsection{Ion-Pairing Chromatography}
\label{sec:orge76e98d}
...
\begin{table}[htbp]
\caption{\label{tab:org336a44c}AA Quantified by LC-MS/MS}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{orgfdc5688}reported in urine}

\subsubsection{Pros and Cons of LC-MS/MS vs AAA}
\label{sec:org3c79e2a}
\begin{enumerate}
\item Pros
\label{sec:org02bc75a}
\begin{itemize}
...
\label{sec:org62da01d}
\begin{enumerate}
\item Pros
\label{sec:orga82bbc5}
\begin{itemize}
...
\caption{\label{fig:orgba0b377}Enzymatic Total Homocysteine Method}
\end{figure}
\section{Acylcarnitines}
\label{sec:org698876d}
\subsection{Introduction}
\label{sec:orgadaea89}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org8aa9f63}Acylcarnitine Panel}
\centering
\begin{tabular}{lll}
...
\label{sec:org38e43da}
\subsubsection{Sample Prep}
\label{sec:orgdd0258f}
...
\caption{\label{fig:org188d0e9}Rationale for Derivatization}
\end{figure}

\subsubsection{FIA-MS/MS schematic}
\label{sec:orgea05e40}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
201–202.\label{orgd50c50e}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org590f7dc}Overestimation of Free Carnitine}
\centering
\begin{tabular}{lr}
...
\label{sec:org8a9c455}

\subsubsection{FIA-MS/MS Schematic}
\label{sec:orgb69f466}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\begin{table}[htbp]
\caption{\label{tab:orgf387d1d}Quantified Amino Acids}
\centering
\begin{tabular}{ll}
glycine & tyrosine\\
alanine & ornithine\\
...
\begin{table}[htbp]
\caption{\label{tab:org85673b1}MRM is used to detected selected acylcarnitines}
\centering
\begin{tabular}{ll}
Compound & Reaction\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org48ab428}Quantified Acylcarnitines}
\centering
\begin{tabular}{lll}
C0 & C8 & C16\\
C2 & C8:1 & C16:1\\
...
\label{sec:orgbf11120}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org505241c}
\begin{itemize}
...
\label{sec:org398e321}
\subsection{Introduction}
\label{sec:orge530895}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org8278e5c}Organic Acid Functional Groups}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:orgb322551}Organic Acid Side Chains}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:org17abb33}Organic Acid Nomenclature}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:orga5c23c2}Acylglycines}
\centering
\begin{tabular}{llll}
...
\label{sec:orgab317fa}
\begin{enumerate}
\item Endogenous
\label{sec:org3f049cf}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org80277a4}Disorders of Organic Acid Metabolism}
\centering
\begin{tabular}{ll}
...
\label{sec:org51c678e}
\subsubsection{Oximation}
\label{sec:org066ad8f}
\begin{itemize}
...
\label{sec:org9198cc2}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:org3bd9b71}Flow of Electrons in the ETC}
\end{figure}

\subsection{Citrate Synthase}
\label{sec:orgac72420}
\subsubsection{Purpose}
\label{sec:org4ebf702}
\begin{itemize}
...
\label{sec:orgb032102}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/c1c3.pdf}
\caption{\label{fig:org4fea48f}CI \& III assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:org7b7b1f3}
\begin{itemize}
...
\label{sec:org3563bd6}
\begin{figure}[htbp]
\centering
\includegraphics[width=.7\textwidth]{./mito/figures/c2.pdf}
\caption{\label{fig:orge9cf881}CII Assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:orgf6c5cb2}
\begin{itemize}
\item Complex II activity
\end{itemize}
\subsubsection{Principle}
\label{sec:orgd8f4322}
\begin{itemize}
...
\label{sec:orgcf73587}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/c2c3.pdf}
\caption{\label{fig:org599a1c5}CII \& CIII}
\end{figure}

\subsubsection{Purpose}
\label{sec:org5ad8f40}
\begin{itemize}
...
\label{sec:org546b2c0}
\begin{figure}[htbp]
\centering
\includegraphics[width=.7\textwidth]{./mito/figures/c4.pdf}
\caption{\label{fig:org9c6a5b9}CIV Assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:orgd385d0c}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:org66f883f}
\subsubsection{Purpose}
\label{sec:org135f431}
\begin{itemize}
...
\section{VLCFA}
\label{sec:orgb895e4a}
\begin{itemize}
\item investigation of peroxisomal disorders (Table \ref{tab:orga2619be})
\item C22, C24 and C26 fatty acids and their ratios are measured
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orga2619be}VLCFAs in Peroxisomal Disease}
\centering
\begin{tabular}{llll}
...
\label{sec:org8d74dfa}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{gags/figures/cs.png}
\caption{\label{fig:org2547a0c}Chondroitin Sulfate}
\end{figure}
...
\caption{\label{fig:org4a72943}Dermatan Sulfate}
\end{figure}
...
\caption{\label{fig:org829647e}Heparan Sulfate}
\end{figure}
...
\caption{\label{fig:orgb349c71}Keratan Sulfate}
\end{figure}


\subsection{Berry Spot Test}
\label{sec:org0f65079}
\begin{itemize}
\item provides a rapid qualitative evaluation of urine (Figure \ref{fig:org2fc8367})
...
\caption{\label{fig:org2fc8367}Positive (a) and Negative (b) Berry Spot Test}
\end{figure}


\subsection{Spectrophotometric}
\label{sec:orgc412f0e}
\begin{itemize}
\item total GAGs
\item urine sample
...
\label{sec:orgb46cf2b}
\begin{itemize}
\item TLC or electrophoresis used to fractionate urine GAGs (Figures \ref{fig:org3a0dbf5} and \ref{fig:orgc9f6c38})
...
\caption{\label{fig:org3a0dbf5}TLC for Urine GAGs}
\end{figure}
...
\caption{\label{fig:orgc9f6c38}Electrophoresis for Urine GAGs: LZ loading zone}
\end{figure}
\section{Oligosacarides}
\label{sec:org392d599}
\subsection{Fractionation}
\label{sec:orgadf75d7}
\begin{itemize}
\item TLC is used to fractionate urine oligosaccharides (Figure \ref{fig:orgd9eace2})
...
\caption{\label{fig:orgd9eace2}TLC of Urinary Oligosacarides: control, \(\alpha\)-mannosidosis, fucosidosis, Sandhoff and aspartylglucosaminuria}
\end{figure}
\section{Enzymes}
\label{sec:org6336c1b}
\subsection{GALT}
\label{sec:org611295e}
\subsubsection{Beutler Test}
\label{sec:org77b0c92}
...
\caption{\label{fig:org10e1596}Beutler Method}
\end{figure}


\subsubsection{Spotcheck}
\label{sec:org879fbda}
...
\caption[4MUI]{\label{fig:org1f416e6}4-Methylumbelliferyl-\(\alpha\)-L-Iduronide}
\end{figure}

\begin{enumerate}
\item Known Issues
\label{sec:org27b40ff}
\begin{enumerate}
\item Pseudodeficiency
\label{sec:org2d08669}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgf04cc8b}Neo-LSD Lysosomal Enzyme Activities}
\centering
\begin{tabular}{lll}
...
with a very low percent HexA (Table \ref{tab:org959a96b})
...
\begin{table}[htbp]
\caption{\label{tab:org959a96b}Biochemical Results in GM2 Gangliosidosis}
\centering
\begin{tabular}{lllll}
...
\label{sec:orgf891160}
\subsection{Transferrin IEF}
\label{sec:org5cf4d47}
\begin{itemize}
...
\caption{\label{fig:org84c5972}Transferrin IEF}
\end{figure}

\subsubsection{Type 1 pattern}
\label{sec:org0cc80f5}
\begin{itemize}
...
\label{sec:orgc25d806}
\subsubsection{Lactate}
\label{sec:org8bd0a96}
\begin{itemize}
...
the liver by LDH (Figure \ref{fig:org0e2c469})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\textwidth]{niet/figures/Lactate_dehydrogenase_mechanism.png}
\caption{\label{fig:org0e2c469}LDH}
\end{figure}

\subsubsection{ATP}
\label{sec:org6e434ef}
\begin{itemize}
...
\label{sec:orge65f173}
\begin{itemize}
\item most ammonia produced by exercising muscle removed by formation of glutamine (Figure \ref{fig:orgf81fd1f})
\begin{itemize}
...
\caption[gln]{\label{fig:orgf81fd1f}Glutamine and Ammonia}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=.6\textheight]{niet/figures/niet_results.png}
\caption[interp]{\label{fig:orge2813e2}NIET Results}
\end{figure}
...
\caption{\label{fig:orgd3f9b36}NIET Method}
\end{figure}
\section{Porphyrins}
\label{sec:orga1adc4d}
\subsection{Methods for Metabolites}
\label{sec:org83ac545}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:orge009b29}
\begin{enumerate}
\item Porphobilinogen
\label{sec:org386b7d2}
\begin{itemize}
