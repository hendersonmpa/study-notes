...
\section{Amino Acids}
\label{sec:orgb21b7da}
\subsection{Introduction}
\label{sec:org6f768bb}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org6b28029}Recommended Plasma AA Profile for Diagnosis of Amino Acid Disorders}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org3bed973}plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{orgdda2d6a}sulphocysteine may not be detectable in plasma using routine methods}

\subsubsection{Sample Types}
\label{sec:org894f967}
\begin{enumerate}
\item Plasma
\label{sec:org3024dc0}
\begin{itemize}
\item patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:orga2e3340}
\subsubsection{LC-MS/MS schematic}
\label{sec:org2dd17a5}
...
\caption{\label{fig:org67b1c50}LC-MS/MS Outlet Method}
\end{figure}

\subsubsection{Ion-Pairing Chromatography}
\label{sec:org9d8c09d}
...
\begin{table}[htbp]
\caption{\label{tab:org3ae876f}AA Quantified by LC-MS/MS}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org3e93ce7}reported in urine}

\subsubsection{Pros and Cons of LC-MS/MS vs AAA}
\label{sec:orgff0b74c}
\begin{enumerate}
\item Pros
\label{sec:org34f812f}
\begin{itemize}
...
\label{sec:org41e20fb}
\begin{enumerate}
\item Pros
\label{sec:org3bfb451}
\begin{itemize}
...
\caption{\label{fig:orgdd896ff}The Three Forms of Homocysteine}
\end{figure}

\subsubsection{Method}
\label{sec:org8d78321}
\begin{itemize}
\item enzymatic total homocysteine method (Figure \ref{fig:org5dbb127})
\begin{enumerate}
...
\caption{\label{fig:org5dbb127}Enzymatic Total Homocysteine Method}
\end{figure}
\section{Acylcarnitines}
\label{sec:org2cd4df9}
\subsection{Introduction}
\label{sec:org6085685}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org0f4cab2}Acylcarnitine Panel}
\centering
\begin{tabular}{lll}
...
\label{sec:orge1591f0}
\subsubsection{Sample Prep}
\label{sec:org41be4b0}
...
\caption{\label{fig:orga8600b0}Rationale for Derivatization}
\end{figure}

\subsubsection{FIA-MS/MS schematic}
\label{sec:org54eccc5}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
201–202.\label{org1eea89e}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org958e68d}Overestimation of Free Carnitine}
\centering
\begin{tabular}{lr}
...
used with caution" \textsuperscript{\ref{org1eea89e}}
\end{itemize}


\subsection{Free and Total Carnitine}
\label{sec:org56f2b8e}
\begin{itemize}
...
\label{sec:org6b5d26d}

\subsubsection{FIA-MS/MS Schematic}
\label{sec:orgc5abc82}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\begin{table}[htbp]
\caption{\label{tab:org3d8b9be}Quantified Amino Acids}
\centering
\begin{tabular}{ll}
glycine & tyrosine\\
alanine & ornithine\\
...
\begin{table}[htbp]
\caption{\label{tab:org8648f1d}MRM is used to detected selected acylcarnitines}
\centering
\begin{tabular}{ll}
Compound & Reaction\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org170561a}Quantified Acylcarnitines}
\centering
\begin{tabular}{lll}
C0 & C8 & C16\\
C2 & C8:1 & C16:1\\
...
\label{sec:org8d86108}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org021fff6}
\begin{itemize}
...
\label{sec:org4127e69}
\subsection{Introduction}
\label{sec:org5ee1f9b}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgb3218fc}Organic Acid Functional Groups}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:org6737f70}Organic Acid Side Chains}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:org15bf344}Organic Acid Nomenclature}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:orgc33df54}Acylglycines}
\centering
\begin{tabular}{llll}
...
\label{sec:orgbd7c435}
\begin{enumerate}
\item Endogenous
\label{sec:orgf8cd5b2}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org7261ce7}Disorders of Organic Acid Metabolism}
\centering
\begin{tabular}{ll}
...
\label{sec:orgec52223}
\subsubsection{Oximation}
\label{sec:org0d5e0d0}
\begin{itemize}
...
\label{sec:org83c069b}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:org4ce2f3b}Flow of Electrons in the ETC}
\end{figure}

\subsection{Citrate Synthase}
\label{sec:orge8f35a9}
\subsubsection{Purpose}
\label{sec:orgdb4ec47}
\begin{itemize}
...
\label{sec:org2a25103}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/c1c3.pdf}
\caption{\label{fig:org324e7d5}CI \& III assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:orgd6ca0b1}
\begin{itemize}
...
\label{sec:org1873608}
\begin{figure}[htbp]
\centering
\includegraphics[width=.7\textwidth]{./mito/figures/c2.pdf}
\caption{\label{fig:orgc0cd4da}CII Assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:org6c31944}
\begin{itemize}
\item Complex II activity
\end{itemize}
\subsubsection{Principle}
\label{sec:org70318af}
\begin{itemize}
...
\label{sec:org67a7294}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/c2c3.pdf}
\caption{\label{fig:orgb1c1d46}CII \& CIII}
\end{figure}

\subsubsection{Purpose}
\label{sec:org08ce282}
\begin{itemize}
...
\label{sec:org63de37f}
\begin{figure}[htbp]
\centering
\includegraphics[width=.7\textwidth]{./mito/figures/c4.pdf}
\caption{\label{fig:orgaa1f56e}CIV Assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:orga84a9d1}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:org58e16a4}
\subsubsection{Purpose}
\label{sec:orgff24953}
\begin{itemize}
...
\section{VLCFA}
\label{sec:org6c65359}
\begin{itemize}
\item investigation of peroxisomal disorders (Table \ref{tab:org08e594b})
\item C22, C24 and C26 fatty acids and their ratios are measured
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org08e594b}VLCFAs in Peroxisomal Disease}
\centering
\begin{tabular}{llll}
...
\label{sec:org1fb6590}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{gags/figures/cs.png}
\caption{\label{fig:org13a8280}Chondroitin Sulfate}
\end{figure}
...
\caption{\label{fig:org0bee125}Dermatan Sulfate}
\end{figure}
...
\caption{\label{fig:org67907f5}Heparan Sulfate}
\end{figure}
...
\caption{\label{fig:org22c98b1}Keratan Sulfate}
\end{figure}


\subsection{Berry Spot Test}
\label{sec:org4b33402}
\begin{itemize}
\item provides a rapid qualitative evaluation of urine (Figure \ref{fig:org0c76cbc})
...
\caption{\label{fig:org0c76cbc}Positive (a) and Negative (b) Berry Spot Test}
\end{figure}


\subsection{Spectrophotometric}
\label{sec:org3451d5c}
\begin{itemize}
\item total GAGs
\item urine sample
...
\label{sec:org5543543}
\begin{itemize}
\item TLC or electrophoresis used to fractionate urine GAGs (Figures \ref{fig:orgffe9467} and \ref{fig:org901c907})
...
\caption{\label{fig:orgffe9467}TLC for Urine GAGs}
\end{figure}
...
\caption{\label{fig:org901c907}Electrophoresis for Urine GAGs: LZ loading zone}
\end{figure}
\section{Oligosacarides}
\label{sec:org92166a7}
\subsection{Fractionation}
\label{sec:orgb37412e}
\begin{itemize}
\item TLC is used to fractionate urine oligosaccharides (Figure \ref{fig:orge0b8663})
...
\caption{\label{fig:orge0b8663}TLC of Urinary Oligosacarides: control, \(\alpha\)-mannosidosis, fucosidosis, Sandhoff and aspartylglucosaminuria}
\end{figure}
\section{Enzymes}
\label{sec:org295648b}
\subsection{GALT}
\label{sec:org2903813}
\subsubsection{Beutler Test}
\label{sec:org0d34862}
...
\caption{\label{fig:orgc4ea415}Beutler Method, the modified method is used to assay G6PD activity}
\end{figure}


\subsubsection{Spotcheck}
\label{sec:orge21225f}
...
\caption[4MUI]{\label{fig:orgf73923b}4-Methylumbelliferyl-\(\alpha\)-L-Iduronide}
\end{figure}

\begin{enumerate}
\item Known Issues
\label{sec:org49f1bdc}
\begin{enumerate}
\item Pseudodeficiency
\label{sec:org97f40a0}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgbafdedb}Neo-LSD Lysosomal Enzyme Activities}
\centering
\begin{tabular}{lll}
...
with a very low percent HexA (Table \ref{tab:org82b5280})
...
\begin{table}[htbp]
\caption{\label{tab:org82b5280}Biochemical Results in GM2 Gangliosidosis}
\centering
\begin{tabular}{lllll}
...
\label{sec:org6ac7c88}
\subsection{Transferrin IEF}
\label{sec:orgfde7cd1}
\begin{itemize}
...
\caption{\label{fig:orgf97db7c}Transferrin IEF}
\end{figure}

\subsubsection{Type 1 pattern}
\label{sec:org7f2a5a4}
\begin{itemize}
...
\end{itemize}
\section{NIET}
\label{sec:orgeaa9ddf}
\begin{itemize}
\item used to identify a GSD in patients with myopathy (Table
\ref{tab:org7b475f4} and Figure \ref{fig:orgdae34b6})
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org7b475f4}NIET in Myopathy}
\centering
\begin{tabular}{lll}
...
\label{sec:org87b26ce}
\subsubsection{Lactate}
\label{sec:org3fb44a7}
\begin{itemize}
...
the liver by LDH (Figure \ref{fig:orgea8546f})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\textwidth]{niet/figures/Lactate_dehydrogenase_mechanism.png}
\caption{\label{fig:orgea8546f}LDH}
\end{figure}

\subsubsection{ATP}
\label{sec:org09f19f4}
\begin{itemize}
...
\label{sec:orgb73fcd6}
\begin{itemize}
\item most ammonia produced by exercising muscle removed by formation of glutamine (Figure \ref{fig:org9c14176})
\begin{itemize}
...
\caption[gln]{\label{fig:org9c14176}Glutamine and Ammonia}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=.6\textheight]{niet/figures/niet_results.png}
\caption[interp]{\label{fig:orgdae34b6}NIET Results}
\end{figure}
...
\caption{\label{fig:org64faf92}NIET Method}
\end{figure}
\section{Porphyrins}
\label{sec:orgf8eab68}
\subsection{Methods for Metabolites}
\label{sec:orge757b0d}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:orgfd997f6}
\begin{enumerate}
\item Porphobilinogen
\label{sec:org2f86619}
\begin{itemize}
