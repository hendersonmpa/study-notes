...
\section{Amino Acids}
\label{sec:orge1fe500}
\subsection{Introduction}
\label{sec:orgac79f16}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org8a76e21}Recommended Plasma AA Profile for Diagnosis of Amino Acid Disorders}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org967f978}plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{orga1a99b9}sulphocysteine may not be detectable in plasma using routine methods}

\subsubsection{Sample Types}
\label{sec:org37a2575}
\begin{enumerate}
\item Plasma
\label{sec:org94a3e89}
\begin{itemize}
\item patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:org25e0e65}
\subsubsection{LC-MS/MS schematic}
\label{sec:orge79e53c}
...
\caption{\label{fig:org6137f8c}LC-MS/MS Outlet Method}
\end{figure}

\subsubsection{Ion-Pairing Chromatography}
\label{sec:org1927864}
...
\begin{table}[htbp]
\caption{\label{tab:org56ee639}AA Quantified by LC-MS/MS}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org2d920eb}reported in urine}

\subsubsection{Pros and Cons of LC-MS/MS vs AAA}
\label{sec:org39dca06}
\begin{enumerate}
\item Pros
\label{sec:org98de31b}
\begin{itemize}
...
\label{sec:orgf7699d3}
\begin{enumerate}
\item Pros
\label{sec:org0c54460}
\begin{itemize}
...
\caption{\label{fig:org55b2d9a}The Three Forms of Homocysteine}
\end{figure}

\subsubsection{Method}
\label{sec:org7b45df8}
\begin{itemize}
\item enzymatic total homocysteine method (Figure \ref{fig:org4dc3d93})
\begin{enumerate}
...
\caption{\label{fig:org4dc3d93}Enzymatic Total Homocysteine Method}
\end{figure}
\section{Acylcarnitines}
\label{sec:org5d2559c}
\subsection{Introduction}
\label{sec:org4b397e8}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org42521b2}Acylcarnitine Panel}
\centering
\begin{tabular}{lll}
...
\label{sec:org8f94c43}
\subsubsection{Sample Prep}
\label{sec:org0dc5adb}
...
\caption{\label{fig:org650c1bf}Rationale for Derivatization}
\end{figure}

\subsubsection{FIA-MS/MS schematic}
\label{sec:org2f7189d}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
201–202.\label{org5970713}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgacaa5c8}Overestimation of Free Carnitine}
\centering
\begin{tabular}{lr}
...
used with caution" \textsuperscript{\ref{org5970713}}
\end{itemize}


\subsection{Free and Total Carnitine}
\label{sec:org08017d9}
\begin{itemize}
...
\label{sec:org443f26e}

\subsubsection{FIA-MS/MS Schematic}
\label{sec:org900dc57}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\begin{table}[htbp]
\caption{\label{tab:org78a1ceb}Quantified Amino Acids}
\centering
\begin{tabular}{ll}
glycine & tyrosine\\
alanine & ornithine\\
...
\begin{table}[htbp]
\caption{\label{tab:org369631c}MRM is used to detected selected acylcarnitines}
\centering
\begin{tabular}{ll}
Compound & Reaction\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orgdd89370}Quantified Acylcarnitines}
\centering
\begin{tabular}{lll}
C0 & C8 & C16\\
C2 & C8:1 & C16:1\\
...
\label{sec:org2107a4f}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org049efd1}
\begin{itemize}
...
\label{sec:orgfc00c25}
\subsection{Introduction}
\label{sec:org0510fa9}
\begin{itemize}
...
\chemname{\chemfig{H0-[1]C(=[7]0)(-[6]H)-C(-[7]OH)=[1]O}}{oxalic acid}

\end{center}


\begin{table}[htbp]
\caption{\label{tab:orgda833e2}Organic Acid Functional Groups}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:orgbef129b}Organic Acid Side Chains}
\centering
\begin{tabular}{ll}
...
\begin{table}[htbp]
\caption{\label{tab:org04b5992}Organic Acid Nomenclature}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:org9837345}Acylglycines}
\centering
\begin{tabular}{llll}
...
\label{sec:org0517da2}
\begin{enumerate}
\item Endogenous
\label{sec:org3bfcb1b}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org84c184c}Disorders of Organic Acid Metabolism}
\centering
\begin{tabular}{ll}
...
\label{sec:org0aef87c}
\subsubsection{Oximation}
\label{sec:org98a7621}
\begin{itemize}
...
\label{sec:org7d3184d}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:orgecf4514}Flow of Electrons in the ETC}
\end{figure}

\subsection{Citrate Synthase}
\label{sec:org3318fdc}
\subsubsection{Purpose}
\label{sec:org84dd35f}
\begin{itemize}
...
\label{sec:orgd70808e}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/c1c3.pdf}
\caption{\label{fig:org05a9e56}CI \& III assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:org36e1c20}
\begin{itemize}
...
\label{sec:org2b96ae5}
\begin{figure}[htbp]
\centering
\includegraphics[width=.7\textwidth]{./mito/figures/c2.pdf}
\caption{\label{fig:orgf97b901}CII Assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:org7f2ca08}
\begin{itemize}
\item Complex II activity
\end{itemize}
\subsubsection{Principle}
\label{sec:org5f66911}
\begin{itemize}
...
\label{sec:org2d0f11c}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/c2c3.pdf}
\caption{\label{fig:orgdebbc60}CII \& CIII}
\end{figure}

\subsubsection{Purpose}
\label{sec:org62ba6a5}
\begin{itemize}
...
\label{sec:orge9a49d9}
\begin{figure}[htbp]
\centering
\includegraphics[width=.7\textwidth]{./mito/figures/c4.pdf}
\caption{\label{fig:orgd4d9740}CIV Assay}
\end{figure}

\subsubsection{Purpose}
\label{sec:orgd0f910f}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:orgaff23d9}
\subsubsection{Purpose}
\label{sec:org4d8d77c}
\begin{itemize}
...
\section{VLCFA}
\label{sec:orgaee4d58}
\begin{itemize}
\item investigation of peroxisomal disorders (Table \ref{tab:org5cdb616})
\item C22, C24 and C26 fatty acids and their ratios are measured
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org5cdb616}VLCFAs in Peroxisomal Disease}
\centering
\begin{tabular}{llll}
...
\label{sec:org4b77aa9}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{gags/figures/cs.png}
\caption{\label{fig:orgd79ac8c}Chondroitin Sulfate}
\end{figure}
...
\caption{\label{fig:orgc2cd9cf}Dermatan Sulfate}
\end{figure}
...
\caption{\label{fig:orgb478ab6}Heparan Sulfate}
\end{figure}
...
\caption{\label{fig:org6f3b2d9}Keratan Sulfate}
\end{figure}


\subsection{Berry Spot Test}
\label{sec:org3c87224}
\begin{itemize}
\item provides a rapid qualitative evaluation of urine (Figure \ref{fig:orgd5f9e51})
...
\caption{\label{fig:orgd5f9e51}Positive (a) and Negative (b) Berry Spot Test}
\end{figure}


\subsection{Spectrophotometric}
\label{sec:org514d4cd}
\begin{itemize}
\item total GAGs
\item urine sample
...
\label{sec:org7a5ef9f}
\begin{itemize}
\item TLC or electrophoresis used to fractionate urine GAGs (Figures \ref{fig:orga7f986a} and \ref{fig:org8520912})
...
\caption{\label{fig:orga7f986a}TLC for Urine GAGs}
\end{figure}
...
\caption{\label{fig:org8520912}Electrophoresis for Urine GAGs: LZ loading zone}
\end{figure}
\section{Oligosacarides}
\label{sec:org192a7c2}
\subsection{Fractionation}
\label{sec:orgf58b272}
\begin{itemize}
\item TLC is used to fractionate urine oligosaccharides (Figure \ref{fig:org131f082})
...
\caption{\label{fig:org131f082}TLC of Urinary Oligosacarides: control, \(\alpha\)-mannosidosis, fucosidosis, Sandhoff and aspartylglucosaminuria}
\end{figure}
\section{Enzymes}
\label{sec:org1ef4444}
\subsection{GALT}
\label{sec:org5ec0575}
\subsubsection{Beutler Test}
\label{sec:org80e4a54}
...
\caption{\label{fig:orgd748cd6}Beutler Method, the modified method is used to assay G6PD activity}
\end{figure}


\subsubsection{Spotcheck}
\label{sec:org24d96ac}
...
\caption[4MUI]{\label{fig:org98f15d9}4-Methylumbelliferyl-\(\alpha\)-L-Iduronide}
\end{figure}

\begin{enumerate}
\item Known Issues
\label{sec:org0b82049}
\begin{enumerate}
\item Pseudodeficiency
\label{sec:org4fb78ca}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgf58ed95}Neo-LSD Lysosomal Enzyme Activities}
\centering
\begin{tabular}{lll}
...
with a very low percent HexA (Table \ref{tab:org1b1069b})
...
\begin{table}[htbp]
\caption{\label{tab:org1b1069b}Biochemical Results in GM2 Gangliosidosis}
\centering
\begin{tabular}{lllll}
...
\begin{table}[htbp]
\caption{\label{tab:org539ded3}HSC Percent Hex B interpretation}
\centering
\begin{tabular}{rl}
...
\begin{table}[htbp]
\caption{\label{tab:org7a2bde8}HSC Total Hex reference intervals}
\centering
\begin{tabular}{ll}
Specimen & RI\\
\hline
...
\label{sec:org76ec6c8}
\subsection{Transferrin IEF}
\label{sec:orga54cccc}
\begin{itemize}
...
\caption{\label{fig:org1da297f}Transferrin IEF}
\end{figure}

\subsubsection{Type 1 pattern}
\label{sec:orgddb9335}
\begin{itemize}
...
\end{itemize}
\section{NIET}
\label{sec:org8de2ce8}
\begin{itemize}
\item used to identify a GSD in patients with myopathy (Table
\ref{tab:org428cf51} and Figure \ref{fig:orge2b0034})
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org428cf51}NIET in Myopathy}
\centering
\begin{tabular}{lll}
...
\label{sec:orgd1a4587}
\subsubsection{Lactate}
\label{sec:org30ab570}
\begin{itemize}
...
the liver by LDH (Figure \ref{fig:orgacf12a2})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\textwidth]{niet/figures/Lactate_dehydrogenase_mechanism.png}
\caption{\label{fig:orgacf12a2}LDH}
\end{figure}

\subsubsection{ATP}
\label{sec:org850fe15}
\begin{itemize}
...
\label{sec:orgde7d542}
\begin{itemize}
\item most ammonia produced by exercising muscle removed by formation of glutamine (Figure \ref{fig:org05c1460})
\begin{itemize}
...
\caption[gln]{\label{fig:org05c1460}Glutamine and Ammonia}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=.6\textheight]{niet/figures/niet_results.png}
\caption[interp]{\label{fig:orge2b0034}NIET Results}
\end{figure}
...
\caption{\label{fig:org090b879}NIET Method}
\end{figure}
\section{Porphyrins}
\label{sec:org2f67d00}
\subsection{Methods for Metabolites}
\label{sec:orgad039d4}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:org1296e25}
\begin{enumerate}
\item Porphobilinogen
\label{sec:orgf0f83e2}
\begin{itemize}
