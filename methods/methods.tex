...
\section{NBS}
\label{sec:org51e7efc}
\subsection{Dried Blood Spot}
\label{sec:org2f249a8}
\begin{itemize}
...
\subsection{AAAC}
\label{sec:org270b0cf}
\begin{enumerate}
\item FIA-MS/MS schematic
\label{sec:orge18e6f7}
\begin{center}
...
\caption{\label{fig:orgedeb9c7}
FIA-MS/MS Method}
\end{figure}

\item AA NL Scan
\label{sec:org52a7839}
\begin{itemize}
...
201–202.\label{org1279e2a}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org20faf1d}
...
used with caution." \textsuperscript{\ref{org1279e2a}}
\end{itemize}

\item Pros and Cons of FIA-MS/MS using DBS
\label{sec:org4e11338}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org777e124}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[2]{\label{orgeab8bf6}Plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[3]{\label{org06c12ef}Sulphocysteine may not be detectable in plasma using routine methods}

\item Plasma
\label{sec:org7d7ac72}
\begin{itemize}
\item Patient prep
\begin{itemize}
...
\label{sec:orgd30eca4}
\begin{enumerate}
\item What are urine organic acids?
\label{sec:orgb74fb9a}
\begin{itemize}
...
\label{sec:org740e993}

\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}

\begin{table}[htbp]
\caption{\label{tab:org2388aa2}
...
\item Side Chains
\label{sec:org7f7de3f}

\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}

\begin{table}[htbp]
\caption{\label{tab:org0e786e2}
...
\label{sec:org804f0d1}
\begin{enumerate}
\item Endogenous Sources
\label{sec:org88286cf}
\begin{itemize}
...
\label{sec:org282f8c8}
\begin{enumerate}
\item Oximation
\label{sec:org9b27cc3}
\begin{itemize}
...
\label{sec:org26a2b9e}

\item Mass-spectroscopy
\label{sec:org64b2b7e}

\item Reporting
\label{sec:orgb321e8b}
\end{enumerate}
\section{Mitochondria}
\label{sec:org570abca}
\subsection{Introduction}
\label{sec:orgac95627}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:org1b25285}
Electron Transport Chain}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:orgd1a1b8d}
\begin{enumerate}
\item CI
\label{sec:org18226b2}
\begin{itemize}
...
\label{sec:org203b7b8}
\subsection{CI+III assay}
\label{sec:org646908a}
\begin{enumerate}
\item Purpose
\label{sec:org88aface}
\begin{itemize}
...
\label{sec:org19422f5}
\begin{enumerate}
\item Purpose
\label{sec:org28bce2f}
\begin{itemize}
\item Complex II activity
\end{itemize}
\item Principle
\label{sec:orgee4bd2d}
\begin{itemize}
...
\label{sec:orgb1a39ec}
\begin{enumerate}
\item Purpose
\label{sec:orgf021d44}
\begin{itemize}
...
\label{sec:orgee61522}
\begin{enumerate}
\item Purpose
\label{sec:org01ac826}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:orgb3cdf56}
\begin{enumerate}
\item Purpose
\label{sec:org45318f9}
\begin{itemize}
...
\label{sec:orgb9bf76e}
\section{{\bfseries\sffamily TODO} GAGs and Oligosacarides}
\label{sec:orgd03ddb4}
\section{Enzymes}
\label{sec:orgeb43c89}
\subsection{GALT}
\label{sec:org04eb7ee}
\begin{enumerate}
\item Beutler Test
\label{sec:org460fb8e}
...
\caption{\label{fig:orgc94e5a9}
Beutler Method}
\end{figure}


\item Spotcheck
\label{sec:org9967a87}
...
\label{sec:org27d2d19}
\begin{enumerate}
\item Multiplex DBS Assay
\label{sec:org841c58f}
\begin{itemize}
...
\end{itemize}
\section{NIET}
\label{sec:org7fb7452}
\subsection{Exercising Muscle}
\label{sec:org9406c20}
\begin{enumerate}
\item Lactate
\label{sec:org2e8bbcc}
\begin{itemize}
...
\caption{\label{fig:org3dac47c}
LDH}
\end{figure}

\item ATP
\label{sec:org69d701c}
\begin{itemize}
...
\caption[gln]{\label{fig:org4203a40}
...
\caption[interp]{\label{fig:org07ec6c0}
NIET Results}
\end{figure}
\end{enumerate}
...
\label{sec:org80b5cc6}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./niet/figures/niet_method.png}
\caption{\label{fig:orgf0cab1c}
NIET Method}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org55620af}
NIET in Myopathy}
\centering
\begin{tabular}{lll}
 & Lactate & Ammonia\\
...
\end{table}
\section{Porphyrins}
\label{sec:org988bdcf}
\subsection{Methods for Metabolites}
\label{sec:org6df63c3}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:org004c762}
\begin{enumerate}
\item Porphobilinogen
\label{sec:org844e1cc}
\begin{itemize}
