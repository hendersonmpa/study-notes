...
\section{Amino Acids}
\label{sec:org2eb74c4}
\subsection{Introduction}
\label{sec:org81fb8ad}
\begin{enumerate}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org327ebde}Plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{org7901def}Sulphocysteine may not be detectable in plasma using routine methods}

\item Plasma
\label{sec:org143e7f4}
\begin{itemize}
\item Patient prep
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:org4b1f737}
\begin{enumerate}
\item LC-MS/MS schematic
\label{sec:org29800e5}
\begin{center}
...
\label{sec:org7f0456d}
\begin{itemize}
\item As compared to FIA-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org63e4681}
\begin{itemize}
...
\label{sec:org4a78cee}
\subsection{Introduction}
\label{sec:org56e7b0e}
\begin{itemize}
...
\label{sec:orgadbf420}
\begin{enumerate}
\item Diagnostic FIA-MS/MS schematic
\label{sec:org08e3bc7}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
used with caution." \textsuperscript{\ref{org3603d21}}
\end{itemize}

\item Pros and Cons of Butanol  FIA-MSMS for Aceylcarnitines
\label{sec:org876872d}
\begin{enumerate}
\item Pros
\label{sec:org748d97f}
\begin{itemize}
\item Speed
\item Sensitivity
\item Expertise
...
\label{sec:org0e08756}
\subsection{Background}
\label{sec:org5a285f5}
\begin{enumerate}
\item What are urine organic acids?
\label{sec:org5577b80}
\begin{itemize}
...
\label{sec:orgdddf276}
\centering
\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}
\begin{table}[htbp]
\caption{\label{tab:org8b72d2c}
...
\item Side Chains
\label{sec:orgce85ad6}
\centering
\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}
\begin{table}[htbp]
\caption{\label{tab:org2892cac}
...
\label{sec:org2f987a8}
\begin{enumerate}
\item Endogenous Sources
\label{sec:org8d93a35}
\begin{itemize}
...
\label{sec:orgff94b54}
\begin{enumerate}
\item Oximation
\label{sec:org3147be3}
\begin{itemize}
...
\label{sec:orge2744b6}

\item Mass-spectroscopy
\label{sec:org07606c2}

\item Reporting
\label{sec:org2a9ce48}
\end{enumerate}

\section{NBS}
\label{sec:orgea83d1d}
\subsection{Dried Blood Spot}
\label{sec:orgd4ca6d5}
\begin{itemize}
...
\subsection{AAAC}
\label{sec:org58ce05c}
\begin{enumerate}
\item FIA-MS/MS schematic
\label{sec:orgfa7f193}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\item Overestimation of Free Carnitine
\label{sec:org158ca08}
\begin{itemize}
\item Butylated acylcarnitines are converted to butylated carnitine in
n-butanol-3M HCl at 65\degree{}C. \footnote{Johnson, D. W. (1999). Inaccurate measurement of free
carnitine by the electrospray tandem mass spectrometry screening
method for blood spots. Journal of Inherited Metabolic Disease, 22(2),
201–202.\label{org13256f7}}
\end{itemize}
...
\item "The free carnitine results obtained by this screening method on
blood spots with high levels of acylcarnitines should therefore be
used with caution." \textsuperscript{\ref{org13256f7}}
\end{itemize}

\item Pros and Cons of FIA-MS/MS using DBS
\label{sec:org48c6216}
\begin{itemize}
\item As compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:orgd5c019c}
\begin{itemize}
...
\label{sec:org31a1b00}
\subsection{GALT}
\label{sec:orgd9f6072}
\begin{enumerate}
\item Spotcheck Method
\label{sec:org20e8dc7}
