...
\section{Amino Acids}
\label{sec:org02a0665}
\subsection{Introduction}
\label{sec:org91439d8}
\begin{enumerate}
\item Amino Acids: A Very Short Introduction
\label{sec:org9a6a688}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orged3c5af}Plasma total homocysteine is not detected by routine methods, plasma free homocystine analysis has poor clinical sensitivity.}\footnotetext[2]{\label{org47b3ad1}Sulphocysteine may not be detectable in plasma using routine methods}

\item Sample Types
\label{sec:orgda0b11f}
\begin{enumerate}
\item Plasma
\label{sec:orgb3f376c}
\begin{itemize}
\item patient prep
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{./aa/figures/aaachrom.png}
\caption{\label{fig:org58e9aa8}
Amino Acids Analyser}
\end{figure}

\begin{enumerate}
\item Pros and Cons of Amino Acid Analysers
\label{sec:org206a4ff}
\begin{enumerate}
\item Pros
\label{sec:orgf7f4ad7}
\begin{itemize}
\item standardized and established technology
\item interpretive experience
\end{itemize}
\item Cons
\label{sec:org5b4c696}
\begin{itemize}
...
\subsection{LC-MS/MS}
\label{sec:orgd491bf9}
\begin{enumerate}
\item LC-MS/MS schematic
\label{sec:org23fe8fd}
...
\label{sec:org094b591}
\begin{enumerate}
\item Pros
\label{sec:org7060408}
\begin{itemize}
...
\label{sec:org4ee3426}
\begin{enumerate}
\item Pros
\label{sec:orgb9f402e}
\begin{itemize}
...
standard IEC chromatogram (see above \hyperref[sec:org206a4ff]{AAA})
\end{itemize}
\item long term reagent expense
\end{itemize}

\item Cons
\label{sec:org640f487}
\begin{itemize}
...
\label{sec:org691875b}
\subsection{Introduction}
\label{sec:org238f809}
\begin{itemize}
...
\label{sec:orgf9c0071}
\begin{enumerate}
\item Sample Prep
\label{sec:org5ecdc3e}
...
\caption{\label{fig:orgd1af10c}
FIA-MS/MS Method}
\end{figure}

\item FIA-MS/MS schematic
\label{sec:org6e1ed8d}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
201–202.\label{orge2078c8}}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgea1c66a}
...
\end{enumerate}
\section{AAAC}
\label{sec:orgf8c8022}
\subsection{Sample}
\label{sec:org862efd8}
\begin{enumerate}
\item Dried Blood Spot
\label{sec:org2af9a36}
\begin{itemize}
...
\label{sec:org7796e8c}

\begin{enumerate}
\item FIA-MS/MS Schematic
\label{sec:org575e293}
\begin{center}
\begin{tikzpicture}[node distance=7em]
% nodes
\node(ms1)[ms]{MS1: Mass Filter};
...
\label{sec:orge2d283e}
\begin{itemize}
\item as compared to AAA and LC-MS/MS
\end{itemize}
\begin{enumerate}
\item Pros
\label{sec:org87a5377}
\begin{itemize}
...
\label{sec:orgc5416fd}
\subsection{Background}
\label{sec:org4539d95}
\begin{enumerate}
\item What are urine organic acids?
\label{sec:org4fc73b8}
\begin{itemize}
...
\label{sec:org206d1f1}

\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}

\begin{table}[htbp]
\caption{\label{tab:org4f700d1}
...
\item Side Chains
\label{sec:org46c138b}

\chemfig{X-C(-[2]X)(-[6]X)-C(-[2]X)(-[6]X)-C(-[7]OH)=[1]O}

\begin{table}[htbp]
\caption{\label{tab:org3dd8eda}
...
\label{sec:orgaceba23}
\begin{enumerate}
\item Endogenous Sources
\label{sec:org08e6af0}
\begin{itemize}
...
\label{sec:orge02d5f3}
\begin{enumerate}
\item Oximation
\label{sec:orgd7176d9}
\begin{itemize}
...
\label{sec:org7fc69b2}

\item Mass-spectroscopy
\label{sec:orgb306ea7}

\item Reporting
\label{sec:org324258b}
\end{enumerate}
\section{Mitochondria}
\label{sec:orgababc29}
\subsection{Introduction}
\label{sec:org517ee98}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./mito/figures/etc.pdf}
\caption{\label{fig:org009f7f4}
Electron Transport Chain}
\end{figure}

\begin{enumerate}
\item Inhibitors
\label{sec:org55b25d1}
\begin{enumerate}
\item CI
\label{sec:org0b6e92c}
\begin{itemize}
...
\label{sec:org46457cd}
\subsection{CI+III assay}
\label{sec:orgc8b306f}
\begin{enumerate}
\item Purpose
\label{sec:org4636ec7}
\begin{itemize}
...
\label{sec:orgd1c1e20}
\begin{enumerate}
\item Purpose
\label{sec:org80679b8}
\begin{itemize}
\item Complex II activity
\end{itemize}
\item Principle
\label{sec:org06d04c8}
\begin{itemize}
...
\label{sec:orga58aa39}
\begin{enumerate}
\item Purpose
\label{sec:orgf3233a3}
\begin{itemize}
...
\label{sec:org08ff90f}
\begin{enumerate}
\item Purpose
\label{sec:orgf1494ca}
\begin{itemize}
...
\subsection{CV assay}
\label{sec:org6878632}
\begin{enumerate}
\item Purpose
\label{sec:org8a16f23}
\begin{itemize}
...
\label{sec:orgc7db265}
\section{{\bfseries\sffamily TODO} GAGs and Oligosacarides}
\label{sec:org7803011}
\section{Enzymes}
\label{sec:orgaf15fcc}
\subsection{GALT}
\label{sec:org2780f4e}
\begin{enumerate}
\item Beutler Test
\label{sec:org5f0131b}
...
\caption{\label{fig:orgb9740d8}
Beutler Method}
\end{figure}


\item Spotcheck
\label{sec:orgd233ab7}
...
\label{sec:org293e6ce}
\begin{enumerate}
\item Multiplex DBS Assay
\label{sec:org3f9d83b}
\begin{itemize}
...
\label{sec:orgda97581}
\subsection{Transferrin IEF}
\label{sec:orgb09b5c9}
\begin{itemize}
...
\caption{\label{fig:org2f90be1}
Transferrin IEF}
\end{figure}

\begin{enumerate}
\item Type 1 pattern
\label{sec:org39cb1d2}
\begin{itemize}
...
\end{itemize}
\section{NIET}
\label{sec:org4184bad}
\subsection{Exercising Muscle}
\label{sec:org3ab2add}
\begin{enumerate}
\item Lactate
\label{sec:orgdcc40dd}
\begin{itemize}
...
\caption{\label{fig:org44a18b0}
LDH}
\end{figure}

\item ATP
\label{sec:org8bb308d}
\begin{itemize}
...
\caption[gln]{\label{fig:org38a4dda}
...
\caption[interp]{\label{fig:org67b7a21}
NIET Results}
\end{figure}
\end{enumerate}
...
\label{sec:orgf5b382e}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./niet/figures/niet_method.png}
\caption{\label{fig:org9c6413d}
NIET Method}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org01bd4ea}
NIET in Myopathy}
\centering
\begin{tabular}{lll}
 & Lactate & Ammonia\\
...
\end{table}
\section{Porphyrins}
\label{sec:orgb1b439a}
\subsection{Methods for Metabolites}
\label{sec:org5f6d257}
\begin{enumerate}
\item ALA
\item PBG
...
\label{sec:org9419e8a}
\begin{enumerate}
\item Porphobilinogen
\label{sec:org45a89a0}
\begin{itemize}
