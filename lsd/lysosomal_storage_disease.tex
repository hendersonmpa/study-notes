...
\label{sec:org44856f2}
\subsection{Introduction}
\label{sec:orgea5a7c9}
\begin{enumerate}
\item Sphingolipids
\label{sec:org7356ec7}
...
\item Biosynthesis
\label{sec:org83ad9f5}

\begin{enumerate}
\item ER
\label{sec:orgc5ce2ec}
\begin{itemize}
...
\section{Gaucher}
\label{sec:org656d3d6}
\subsection{Introduction}
\label{sec:orgbb6e22d}

\begin{enumerate}
\item Gaucher
\label{sec:orgf6121cb}
\begin{itemize}
...
\label{sec:orgfd3ca1a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb1a3822}

\begin{table}[htbp]
\caption{\label{tab:orga961f54}
...
\label{sec:orge28c82f}
\begin{enumerate}
\item Gaucher Cells
\label{sec:org7e8e3fa}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./gaucher/figures/Gaucher_Cells_with_Fibrillar_Appearing_Cytoplasm.jpg}
\caption{\label{fig:orgdb39585}
Gaucher Cells}
\end{figure}

\item Biochemistry
\label{sec:org59906b0}
\begin{enumerate}
\item Enzyme Assay
\label{sec:org916b873}
\begin{itemize}
...
\label{sec:org138dd55}
\begin{enumerate}
\item Bone marrow transplantation
\label{sec:org66006e7}
\begin{itemize}
...
\label{sec:org30c0a43}
\subsection{Introduction}
\label{sec:org992ea59}

\begin{enumerate}
\item Niemann-Pick Disease
\label{sec:org78fa6b6}
\begin{itemize}
...
\caption{\label{fig:orgb0a79c0}
Sphingomyelinase}
\end{figure}


\item Sphingolipid degradation
\label{sec:orgf157b36}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./niemann_pick/figures/sl_degradation.png}
\caption{\label{fig:org832b99b}
Sphingolipid degradation}
\end{figure}

\item Niemann-Pick C
\label{sec:org313c5ac}
\begin{itemize}
...
\subsection{Clinical Findings}
\label{sec:org08ecca2}

\begin{enumerate}
\item Niemann-Pick A \& B symptoms
\label{sec:org65ceb61}

\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:org2f5d23b}
\begin{itemize}
...
\subsection{Laboratory Investigations}
\label{sec:orgaf40a2e}
\begin{enumerate}
\item Newborn Screening
\label{sec:orgb19f123}
\begin{itemize}
...
\label{sec:org17f9a29}
\subsection{Introduction}
\label{sec:org7718b21}

\begin{enumerate}
\item Sphingolipid degradation
\label{sec:org0754619}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./GM1_2/figures/sl_degradation.png}
\caption{\label{fig:org18a71a8}
Sphingolipid degradation}
\end{figure}

\item GM1 Gangliosidosis
\label{sec:orgc9dfdbd}
\begin{itemize}
...
\item Genetics
\label{sec:orgb52ae18}
\begin{enumerate}
\item GM1
\label{sec:orgaff30bb}
\begin{itemize}
...
\subsection{Clinical Findings}
\label{sec:orgc9d4f8e}

\begin{enumerate}
\item GM1 Signs and Symptoms
\label{sec:org3003833}
\footnotesize
...
Hepatosplenomegaly & + & +/– & – & –\\
Cardiac involvement & +/– & +/– & +/– & +\\
Coarse facial features & +/– & – & – & \textsuperscript{\ref{org30891ae}}\\
Skeletal findings & + & +/– & – & +\\
Neuroimaging & PA & PA & +/– mild atrophy & \textsuperscript{\ref{org30891ae}}\\
Urine (GAG) & \footnotemark & \textsuperscript{\ref{orge450d59}} & \textsuperscript{\ref{orge450d59}} & Keratan sulfate \footnotemark\\
\end{tabular}
\end{center}\footnotetext[1]{\label{org30891ae}Secondary to bony changes}\footnotetext[2]{\label{orge450d59}Oligosacaride with terminal galactose}\footnotetext[3]{\label{org45cce65}FN have been observed}


\item GM2 Signs and Symptoms
\label{sec:org6a614a0}
...
\subsection{Laboratory Investigations}
\label{sec:org5e857fb}

\begin{enumerate}
\item Biochemistry
\label{sec:org40f9c6e}

\begin{enumerate}
\item GM1
\label{sec:orgbc36089}
...
Pregnancies monitored & 2415 \textsuperscript{\ref{orge450d59}}\\
...
\item Treatment
\label{sec:orgc8bdc4d}

\begin{enumerate}
\item GM1
\label{sec:org96b4ffe}
\begin{itemize}
\item no curative treatment to date
\end{itemize}
\item GM2
\label{sec:org05f0737}
\begin{itemize}
\item treat seizures
\item no curative treatment to date
\end{itemize}
...
\section{Krabbe}
\label{sec:orgd1ffc59}
\subsection{Introduction}
\label{sec:org579b5d0}
\begin{enumerate}
\item Krabbe Disease
\label{sec:orga31e14f}
\begin{itemize}
...
\subsection{Clinical Findings}
\label{sec:orgd12b027}
\begin{enumerate}
\item Disease Spectrum
\label{sec:org8337ef7}
\begin{itemize}
...
\label{sec:org15f5311}
\begin{enumerate}
\item Symptomatic presentation
\label{sec:orge5297e3}
\begin{itemize}
...
\subsection{Laboratory Investigations}
\label{sec:orgea4445c}

\begin{enumerate}
\item CSF protein
\label{sec:org68d4878}
\begin{itemize}
...
\item Treatment
\label{sec:org9b03f35}

\begin{enumerate}
\item Treatment of manifestations:
\label{sec:org1a462cd}
\begin{itemize}
...
\label{sec:org0b7cd48}

\section{Fabry}
\label{sec:orgae78c76}
\subsection{Introduction}
\label{sec:org23658fa}

\begin{enumerate}
\item Fabry
\label{sec:org1099181}
...
\item Lysosomal Trafficking
\label{sec:org9483da8}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./fabry/figures/lysosome_trafficking.jpeg}
\caption[Lysosomal protein trafficking receptors]{\label{fig:orgfc04334}
Lysosomal protein trafficking receptors}
\end{figure}
...
\subsection{Clinical Findings}
\label{sec:org3ad830f}

\begin{enumerate}
\item Signs and Symptoms
\label{sec:org5b1ad77}
...
\end{tabular}
\end{center}\footnotetext[4]{\label{org7863cb8}May be induced by heat, cold, fatigue or emotional stress}


\item Angiokeratomas
\label{sec:org42382a9}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fabry/figures/angiokeratomas.png}
\caption[Angiokeratomas of the skin]{\label{fig:orged3ca66}
...
\subsection{Laboratory Investigations}
\label{sec:org0822995}

\begin{enumerate}
\item Biochemistry
\label{sec:org9c160c5}
\begin{itemize}
...
\label{sec:org4a48cf8}

\section{{\bfseries\sffamily TODO} Prosaposin}
\label{sec:orgd125e7c}

\section{Mucopolysaccharidoses}
\label{sec:org978b100}
\subsection{Introduction}
\label{sec:orgbc4a5cb}
\begin{enumerate}
\item Proteoglycans
\label{sec:org8658d7d}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./mps/figures/ch17f01.jpg}
\caption[Proteoglycans]{\label{fig:orgbc936ec}
Proteoglycans}
\end{figure}

\item Proteoglycans function
\label{sec:orgc28d517}
...
\label{sec:orge9c4614}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./mps/figures/ch3f1.jpg}
\caption[Proteoglycan Synthesis]{\label{fig:org178bff3}
Proteoglycan Synthesis}
\end{figure}


\item Glycosaminoglycans
\label{sec:orgb28dbb7}
...
\label{sec:org08d8ab6}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./mps/figures/snfg.png}
\caption[Glycan Nomenclature]{\label{fig:org7be71e3}
Glycan Nomenclature}
\end{figure}


\item Glycosaminoglycans
\label{sec:orgd865576}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./mps/figures/ch17f02.jpg}
\caption[Glycosaminoglycans]{\label{fig:org7074f65}
Glycosaminoglycans}
\end{figure}

\item GAGs
\label{sec:org1bdfa5a}

\begin{enumerate}
\item Hyaluronan
\label{sec:org3f24d1c}
\begin{itemize}
...
\item GAGs
\label{sec:orgfb4831a}

\begin{enumerate}
\item Heparan Sulfate
\label{sec:orgbd0f4ae}
\begin{itemize}
\item O-xylose-linked to core proteins
...
\label{sec:orgcb1d9e7}

\begin{enumerate}
\item Mucopolysaccharidoses
\label{sec:org764ff13}
\begin{itemize}
...
\label{sec:orgddaec6c}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./mps/figures/ch16f9.jpg}
\caption[Glycosaminoglycan Degradation]{\label{fig:orgf12379f}
Glycosaminoglycan Degradation}
\end{figure}


\item Mucopolysaccharidoses
\label{sec:org171fc04}
...
\label{sec:orgf5313b1}

\begin{enumerate}
\item ML II
\label{sec:org438994d}
\begin{itemize}
\item Low IQ
