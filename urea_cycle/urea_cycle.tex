...
\section{Ammonia}
\label{sec:org7fec13f}
\subsection{Background}
\label{sec:orgeff0bb9}
\begin{enumerate}
\item Production
\label{sec:org95aad55}
\begin{itemize}
...
\item Figure \ref{fig:orga8d567d} focuses on periportal and perivenous
...
\label{sec:orga42a562}
\begin{enumerate}
\item Measurement at CHEO
\label{sec:orga4a4a8d}
...
\subsection{Clinical}
\label{sec:orgaa5a9dc}
\begin{enumerate}
\item Neonatal Symptoms
\label{sec:org8204699}
\begin{itemize}
\item poor feeding
\item vomiting
\item seizures
...
\label{sec:org1973cbd}
\begin{enumerate}
\item Increased ammonia production
\label{sec:org42889f6}
\begin{itemize}
...
\caption{\label{fig:orgd0311d4}
THAN v IEM}
\end{figure}

\item Ammonia Interpretation
\label{sec:org5425b51}
...
\label{sec:org015c0cc}
\subsection{Background}
\label{sec:orgaec6bcc}
\begin{enumerate}
\item The Urea Cycle
\label{sec:org98d5439}
\begin{enumerate}
\item Mitochondrial enzymes:
\label{sec:orgdfcc404}
\begin{itemize}
...
\label{sec:orgb21995a}
\begin{enumerate}
\item Urine Organic Acids
\label{sec:orgbbaf11e}
\begin{itemize}
...
\label{sec:orgffb8c2d}
\begin{enumerate}
\item Targets of Newborn Screening
\label{sec:orgf3b5b8f}
\begin{itemize}
\item ASS1
\item ASL
\item ARG1
...
\section{NBS for UCD}
\label{sec:org7be88ed}
\subsection{Background}
\label{sec:orgda3dc8d}
\begin{enumerate}
\item The Urea Cycle
\label{sec:orge9daf8a}
\begin{itemize}
...
\label{sec:orgd48f572}
\begin{enumerate}
\item NBS Challenges
\label{sec:org11869c5}
\begin{itemize}
\item Biochemical 
\begin{itemize}
...
\label{sec:orgc93c651}
\begin{enumerate}
\item Severe Mitochondrial UCDs
\label{sec:orgcb6adcd}
\begin{itemize}
