...
\section{Ammonia}
\label{sec:org774ff14}
\subsection{Background}
\label{sec:orgb778949}
\begin{enumerate}
\item Production
\label{sec:orgddf16b5}
\begin{itemize}
...
\item Figure \ref{fig:orga8f1bf2} focuses on periportal and perivenous
...
\label{sec:org4eaec9a}
\begin{enumerate}
\item Measurement at CHEO
\label{sec:org54086f0}
...
\subsection{Clinical}
\label{sec:orge239003}
\begin{enumerate}
\item Neonatal Symptoms
\label{sec:orga123e41}
\begin{itemize}
\item poor feeding
\item vomiting
\item seizures
...
\label{sec:org32000ea}
\begin{enumerate}
\item Increased ammonia production
\label{sec:org06035df}
\begin{itemize}
...
\caption{\label{fig:orgfea6495}
THAN v IEM}
\end{figure}

\item Ammonia Interpretation
\label{sec:org438322c}
...
\label{sec:orgb4a55bb}
\subsection{Background}
\label{sec:org7525482}
\begin{enumerate}
\item The Urea Cycle
\label{sec:org86e9e59}
\begin{enumerate}
\item Mitochondrial enzymes:
\label{sec:org1576511}
\begin{itemize}
...
\label{sec:org625d59e}
\begin{enumerate}
\item Urine Organic Acids
\label{sec:orgf362cbf}
\begin{itemize}
...
\label{sec:org22f7c3f}
\begin{enumerate}
\item Targets of Newborn Screening
\label{sec:org4a99d5e}
\begin{itemize}
\item ASS1
\item ASL
\item ARG1
...
\section{NBS for UCD}
\label{sec:org7e069f2}
\subsection{Background}
\label{sec:org9d082ba}
\begin{enumerate}
\item The Urea Cycle
\label{sec:org691292b}
\begin{itemize}
...
\label{sec:org662176e}
\begin{enumerate}
\item NBS Challenges
\label{sec:orgc95d153}
\begin{itemize}
\item Biochemical 
\begin{itemize}
...
\label{sec:org224bf44}
\begin{enumerate}
\item Severe Mitochondrial UCDs
\label{sec:orgf1dbd6d}
\begin{itemize}
