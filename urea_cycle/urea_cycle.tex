...
\section{Ammonia}
\label{sec:org2b91f91}
\subsection{Background}
\label{sec:org7495868}
\begin{enumerate}
\item Production
\label{sec:org3f0c79e}
\begin{itemize}
...
\item Figure \ref{fig:orgd0ca692} focuses on periportal and perivenous
...
\label{sec:org8f9b136}
\begin{enumerate}
\item Measurement at CHEO
\label{sec:org06ecc95}
...
\subsection{Clinical}
\label{sec:orga47a6b8}
\begin{enumerate}
\item Neonatal Symptoms
\label{sec:org9f8f07d}
\begin{itemize}
\item poor feeding
\item vomiting
\item seizures
...
\label{sec:org805cc02}
\begin{enumerate}
\item Increased ammonia production
\label{sec:org089361d}
\begin{itemize}
...
\caption{\label{fig:org8419d30}
THAN v IEM}
\end{figure}

\item Ammonia Interpretation
\label{sec:orgfb9fc04}
...
\label{sec:orga02a26a}
\subsection{Background}
\label{sec:org677ca5a}
\begin{enumerate}
\item The Urea Cycle
\label{sec:org1b9a674}
\begin{enumerate}
\item Mitochondrial enzymes:
\label{sec:org2ce6972}
\begin{itemize}
...
\label{sec:org7b3d3dd}
\begin{enumerate}
\item Urine Organic Acids
\label{sec:org1eda115}
\begin{itemize}
...
\label{sec:orgfffda1f}
\begin{enumerate}
\item Targets of Newborn Screening
\label{sec:org9482a69}
\begin{itemize}
\item ASS1
\item ASL
\item ARG1
...
\section{NBS for UCD}
\label{sec:org51e2a1a}
\subsection{Background}
\label{sec:orgaf3c0ea}
\begin{enumerate}
\item The Urea Cycle
\label{sec:org57fc3cc}
\begin{itemize}
...
\label{sec:orgbb7d689}
\begin{enumerate}
\item NBS Challenges
\label{sec:org6c1397a}
\begin{itemize}
\item Biochemical 
\begin{itemize}
...
\label{sec:orgb882803}
\begin{enumerate}
\item Severe Mitochondrial UCDs
\label{sec:org2eeb092}
\begin{itemize}
