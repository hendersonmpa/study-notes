...
\section{Ammonia}
\label{sec:orgbe37558}
\subsection{Background}
\label{sec:org53357b6}
\begin{enumerate}
\item Production
\label{sec:org7dcb88c}
\begin{itemize}
...
\item Figure \ref{fig:orga299631} focuses on periportal and perivenous
...
\label{sec:org6f8ac7f}
\begin{enumerate}
\item Measurement at CHEO
\label{sec:orgc17f717}
...
\subsection{Clinical}
\label{sec:org3d241ca}
\begin{enumerate}
\item Neonatal Symptoms
\label{sec:orgfa6b7c2}
\begin{itemize}
\item poor feeding
\item vomiting
\item seizures
...
\label{sec:orgae35c47}
\begin{enumerate}
\item Increased ammonia production
\label{sec:orgbabd7d3}
\begin{itemize}
...
\caption{\label{fig:orga6b4fbe}
THAN v IEM}
\end{figure}

\item Ammonia Interpretation
\label{sec:org3a79d31}
...
\label{sec:orgf606f93}
\subsection{Background}
\label{sec:org36727cb}
\begin{enumerate}
\item The Urea Cycle
\label{sec:orgc2fed48}
\begin{enumerate}
\item Mitochondrial enzymes:
\label{sec:org9e7d0c2}
\begin{itemize}
...
\label{sec:org556a164}
\begin{enumerate}
\item Urine Organic Acids
\label{sec:org480963e}
\begin{itemize}
...
\label{sec:orgd4bd946}
\begin{enumerate}
\item Targets of Newborn Screening
\label{sec:org72dcd96}
\begin{itemize}
\item ASS1
\item ASL
\item ARG1
...
\section{NBS for UCD}
\label{sec:org244f97c}
\subsection{Background}
\label{sec:orgf65de00}
\begin{enumerate}
\item The Urea Cycle
\label{sec:orgfaf09f8}
\begin{itemize}
...
\label{sec:orge496320}
\begin{enumerate}
\item NBS Challenges
\label{sec:orgedcd983}
\begin{itemize}
\item Biochemical 
\begin{itemize}
...
\label{sec:org40b44da}
\begin{enumerate}
\item Severe Mitochondrial UCDs
\label{sec:org9afbfd7}
\begin{itemize}
