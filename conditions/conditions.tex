...
\label{sec:orgc338211}
\subsection{Tuberous sclerosis}
\label{sec:org4ede088}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga3bac98}
\begin{itemize}
...
\label{sec:org7789d59}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org05a11f6}
\begin{itemize}
...
\label{sec:org7ccab4b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgf65651d}
\begin{itemize}
...
\label{sec:org37e2298}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgdf3bc10}
\begin{itemize}
...
\label{sec:org07d3b61}
\begin{itemize}
\item AKA: Lynch Syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgbee4f39}
\begin{itemize}
...
\label{sec:org3e2619e}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4fb8daf}
\begin{itemize}
...
\label{sec:orge7a0c52}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org00feeec}
\begin{itemize}
...
\label{sec:org984c681}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org06c94fa}
\begin{itemize}
...
\label{sec:orgabeb3dc}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org9384e47}
\begin{itemize}
...
\label{sec:orgf366abe}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org9b46a0e}
\begin{itemize}
\item deficiency in factor IX clotting
\item same as Hemophilia A (section \ref{sec:org5bd7c6f})
\end{itemize}
\item Diagnostic Testing
\label{sec:org38fd642}
\begin{itemize}
...
\label{sec:org314856c}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org414edd4}
\begin{itemize}
...
\label{sec:orgf436548}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgcbd5676}
\begin{itemize}
...
\label{sec:org0628410}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6dce9cd}
...
\item Diagnostic Testing
\label{sec:orgfb85b2d}
\begin{itemize}
\item \(\uparrow\) AFP
\item RAD, karyotype
\end{itemize}
\item Genetic Counseling
\label{sec:orgabafbb7}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Trisomy 13}
\label{sec:org8f36c00}
\begin{itemize}
\item AKA Patau syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge9642a9}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:orgceffad2}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:orgd9c65ef}
\begin{itemize}
...
\label{sec:org28023c8}
\begin{itemize}
\item AKA Edwards syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org8d1d87b}
\begin{itemize}
\item IUGR and LBW
...
\item Diagnostic Testing
\label{sec:org2b39834}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:orgf5254a2}
\begin{itemize}
...
\label{sec:orgcc49190}
\begin{itemize}
\item AKA Down syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org0b206e8}
\begin{itemize}
...
\end{itemize}
\item Diagnostic Testing
\label{sec:org5b47f48}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:orgf007174}
\begin{itemize}
...
\label{sec:orgbb833b4}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1c69357}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:orgea3a4a2}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Fanconi anemia}
\label{sec:org63be46a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5748604}
\begin{itemize}
...
\label{sec:org26aa7f4}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4675e07}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:org98e09ca}
\begin{itemize}
\item AR, ATM
\end{itemize}
\end{enumerate}
\subsection{Williams syndrome}
\label{sec:orgab50d73}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgeb907a0}
\begin{itemize}
...
\label{sec:org5904f0d}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd4b5770}
\begin{itemize}
...
\label{sec:orge52f060}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd0582ca}
\begin{itemize}
...
\label{sec:org80b7feb}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4b1cfbf}
\begin{itemize}
...
\label{sec:org8569509}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5871c4b}
\begin{itemize}
...
\label{sec:org233630f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org0159256}
\begin{itemize}
...
\label{sec:org45b8292}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1468c38}
\begin{itemize}
...
\label{sec:org71aeec6}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org433ddc3}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org120585e}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./figures/aspws.jpg}
\caption{\label{fig:org9f9e215}AS and PWS}
\end{figure}
...
\label{sec:orgdf89e36}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga3ecb26}
\begin{itemize}
...
\caption{\label{fig:orgf35334d}BWS Chromosome 11}
\end{figure}

\item Genetic Counseling
\label{sec:org3a79796}
\begin{itemize}
...
\label{sec:org757d05b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org81aaf59}
\begin{itemize}
...
\label{sec:org95fccca}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org393aa55}
\begin{itemize}
...
\caption{\label{fig:org2a7aa08}11p Duplication in RSS}
\end{figure}

\item Genetic Counseling
\label{sec:orgdb41b1d}
\begin{itemize}
