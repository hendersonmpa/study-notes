...
\label{sec:orgefad702}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org7b68f43}
\begin{itemize}
...
\label{sec:orgcdbd984}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org85ec0ac}
\begin{itemize}
...
\label{sec:org9390c21}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4e0af7d}
\begin{itemize}
...
\label{sec:orga6413a7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc0b4a13}
\begin{itemize}
...
\end{itemize}
\item Genetic Counselling
\label{sec:org56e60dd}
\begin{itemize}
\item AR HBB
\end{itemize}
\end{enumerate}
\subsection{\(\alpha\)-Thalassemia}
\label{sec:orgf3d1b75}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc4daf56}
\begin{itemize}
...
\label{sec:orgbb2ad8d}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3760e1e}
\begin{itemize}
...
\label{sec:orga1fd004}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc4625ed}
\begin{itemize}
...
\label{sec:org90c1fff}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgcc9ad9a}
\begin{itemize}
...
\label{sec:org92e5a63}
\subsection{Cystic fibrosis}
\label{sec:org1ea2456}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3f64bb9}
\begin{itemize}
...
\label{sec:org86939e5}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org23aa3e2}
\begin{itemize}
...
\label{sec:org88190f7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org25ed039}
\begin{itemize}
...
\label{sec:org6b0de20}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org38fe151}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org3db44d7}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./figures/aspws.jpg}
\caption{\label{fig:org5109857}AS and PWS}
\end{figure}
...
\label{sec:org0b7b0a3}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org76686f5}
\begin{itemize}
...
\label{sec:org824a421}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3a2b842}
\begin{itemize}
...
\label{sec:orgf362a6c}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org325dee1}
\begin{itemize}
