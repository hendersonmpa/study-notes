...
\label{sec:org394b08c}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgccc9411}
\begin{itemize}
...
\label{sec:org5bbb762}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org06b2085}
\begin{itemize}
...
\label{sec:org138505b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org458e939}
\begin{itemize}
...
\label{sec:orgb5bf29f}
\begin{itemize}
\item AKA: Lynch Syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3a22771}
\begin{itemize}
...
\label{sec:org7854589}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgbbd71c2}
\begin{itemize}
...
\label{sec:org2eb8a26}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org671e0ad}
\begin{itemize}
...
\label{sec:org66f8af2}
\subsection{Duchenne/Becker Muscular Dystrophy}
\label{sec:orgdb5d371}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org68cb077}
\begin{itemize}
...
\label{sec:org1343673}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc5a02df}
\begin{itemize}
...
\end{itemize}
\item Genetic Counselling
\label{sec:org54dae11}
\begin{itemize}
\item AD KCNH2 KCNQ1 SCN5A
\end{itemize}
\end{enumerate}
\subsection{Marfan Syndrome}
\label{sec:org353c7b1}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org03feab2}
\begin{itemize}
...
\label{sec:orgbfefc3f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgf17be28}
\begin{itemize}
...
\label{sec:orgac08efc}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgfbb3629}
\begin{itemize}
...
\label{sec:org8145056}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org299cf4d}
\begin{itemize}
...
\end{itemize}
\item Genetic Counselling
\label{sec:org45e80f6}
\begin{itemize}
\item AR DHCR7
\end{itemize}
\end{enumerate}
\subsection{Noonan Syndrome}
\label{sec:org65a9df9}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5b5d13d}
\begin{itemize}
...
\end{itemize}
\item Genetic Counselling
\label{sec:org35773f4}
\begin{itemize}
\item AD PTPN11 RAF1 BRAF MAP2K1
\end{itemize}
\end{enumerate}
\subsection{Charge Syndrome}
\label{sec:orgc43b165}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org2443e25}
\begin{itemize}
...
\end{itemize}
\item Genetic Counselling
\label{sec:org4df6018}
\begin{itemize}
\item AD F5
\end{itemize}
\end{enumerate}
\subsection{G6PD Deficiency}
\label{sec:org91c49be}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc8cb42a}
\begin{itemize}
...
\label{sec:orge9ce249}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga7615cc}
\begin{itemize}
...
\end{itemize}
\item Genetic Counselling
\label{sec:orgb9233e1}
\begin{itemize}
\item AR HBB
\end{itemize}
\end{enumerate}
\subsection{\(\alpha\)-Thalassemia}
\label{sec:org700bd8a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org9a9472e}
\begin{itemize}
...
\label{sec:orgcd863e0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org0d3700c}
\begin{itemize}
...
\label{sec:org066b97c}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgba29bbd}
\begin{itemize}
...
\label{sec:org40d6afc}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org630028a}
\begin{itemize}
...
\label{sec:orgb9950d5}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org40d5bf0}
\begin{itemize}
...
\label{sec:orgae79366}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgfedccf3}
\begin{itemize}
...
\label{sec:org0bde13d}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3cbd7bb}
\begin{itemize}
...
\label{sec:orgb415d8b}
\subsection{Alzheimer Disease}
\label{sec:orgc3bff79}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd6e2e43}
\begin{itemize}
...
\end{itemize}
\item Genetic Counselling
\label{sec:orga7c2b0b}
\begin{itemize}
\item GJB2, GJB6, SLC26A4
\end{itemize}
\end{enumerate}
\subsection{Diabetes Mellitus Type I}
\label{sec:org6f6f62f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1b52cb7}
\begin{itemize}
...
\label{sec:orgfe113fa}
\subsection{Cri du Chat Syndrome}
\label{sec:org5faae0c}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org84fb9c9}
\begin{itemize}
...
\label{sec:orgab9d069}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org02fe213}
\begin{itemize}
...
\label{sec:orgea7c2be}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc20f38a}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org1c4aa4f}
\begin{itemize}
\item \(\uparrow\) AFP
\item RAD, karyotype
\end{itemize}
\item Genetic Counselling
\label{sec:orgd68efa1}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Trisomy 13}
\label{sec:org3c7f2b1}
\begin{itemize}
\item AKA Patau syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgab93718}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org4e4ede1}
\begin{itemize}
\item CMA, RAD, karyotype
\end{itemize}

\item Genetic Counselling
\label{sec:orgf58237d}
\begin{itemize}
...
\label{sec:orgef2f497}
\begin{itemize}
\item AKA Edwards syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge2a4d46}
\begin{itemize}
\item IUGR and LBW
...
\item Diagnostic Testing
\label{sec:org849f19d}
\begin{itemize}
\item CMA, RAD, karyotype
\end{itemize}

\item Genetic Counselling
\label{sec:org92db990}
\begin{itemize}
...
\label{sec:orgf1c7da6}
\begin{itemize}
\item AKA Down syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgbfb016d}
\begin{itemize}
...
\end{itemize}
\item Diagnostic Testing
\label{sec:org34d76a3}
\begin{itemize}
\item CMA, RAD, karyotype
\end{itemize}

\item Genetic Counselling
\label{sec:orgbb65d52}
\begin{itemize}
...
\label{sec:orgc0e2254}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga17fc3a}
\begin{itemize}
...
\item Genetic Counselling
\label{sec:org95855dc}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Fanconi Anemia}
\label{sec:org5586da0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org8f2ee0e}
\begin{itemize}
...
\label{sec:org5ce2f7a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd3ab42e}
\begin{itemize}
...
\end{itemize}
\item Genetic Counselling
\label{sec:org000e434}
\begin{itemize}
\item AR ATM
\end{itemize}
\end{enumerate}
\subsection{Williams Syndrome}
\label{sec:org9cd425a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgbc16274}
\begin{itemize}
...
\label{sec:org601ecca}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org92b1869}
\begin{itemize}
...
\label{sec:org01aef81}
\subsection{Cystic Fibrosis}
\label{sec:org04cac95}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org753f758}
\begin{itemize}
...
\label{sec:orgb7a75be}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org8222de5}
\begin{itemize}
...
\label{sec:org5866211}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb7ce0a1}
\begin{itemize}
...
\label{sec:org9239659}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga65d18f}
\begin{itemize}
...
\label{sec:org7922baf}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5b81030}
\begin{itemize}
...
\label{sec:org4c74852}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4808f90}
\begin{itemize}
...
\label{sec:org3645e41}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgf22eb35}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org9c44dcc}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./figures/aspws.jpg}
\caption{\label{fig:orgeb093a9}AS and PWS}
\end{figure}

\begin{itemize}
\item molecular genetic testing for deficient expression or function of
the \textbf{maternally inherited UBE3A allele} (Figure \ref{fig:orgeb093a9})
...
\label{sec:orge9a9c84}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgaeee61b}
\begin{itemize}
...
\caption{\label{fig:orgc95c783}BWS Chromosome 11}
\end{figure}

\item Genetic Counselling
\label{sec:org2e54320}
\begin{itemize}
...
\label{sec:org1e92a47}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgf25c1ae}
\begin{itemize}
...
\caption{\label{fig:org980ef62}11p Duplication in RSS}
\end{figure}

\item Genetic Counselling
\label{sec:org14bf220}
\begin{itemize}
...
\label{sec:org48202a0}
\subsection{Rett Syndrome}
\label{sec:orgc4ae75b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org47a0862}
\begin{description}
...
\end{itemize}
\item Genetic Counselling
\label{sec:orgeb105d3}
\begin{itemize}
\item AD PMP22
\end{itemize}
\end{enumerate}
\subsection{Spinal Muscular Atrophy}
\label{sec:org6d92306}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5e06530}
\begin{itemize}
...
\caption{\label{fig:org168cf20}Algorithm for SMA}
\end{figure}

\item Genetic Counselling
\label{sec:org30c1f11}
\begin{itemize}
\item AR SMN1
\end{itemize}
\end{enumerate}
