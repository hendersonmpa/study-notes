...
\label{sec:org4173733}
\subsection{Tuberous sclerosis}
\label{sec:org71aa45f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org09c84bd}
\begin{itemize}
...
\label{sec:orgb9ae739}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org558e7c8}
\begin{itemize}
...
\label{sec:org0daf51e}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org8f3d720}
\begin{itemize}
...
\label{sec:orga3bfbad}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org0f39a87}
\begin{itemize}
...
\label{sec:orge56891a}
\begin{itemize}
\item AKA: Lynch Syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6877d0e}
\begin{itemize}
...
\label{sec:orgdef5ba7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4cc3837}
\begin{itemize}
...
\label{sec:orgb079f81}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org83e2a6b}
\begin{itemize}
...
\label{sec:orga75918a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org64e01b9}
\begin{itemize}
...
\label{sec:org69255a8}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4d26b70}
\begin{itemize}
\item deficiency in factor IX clotting
\item same as Hemophilia A (section \ref{sec:org712a8e4})
\end{itemize}
\item Diagnostic Testing
\label{sec:orgdf8e92b}
\begin{itemize}
...
\label{sec:org1e8d0bc}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5951de8}
\begin{itemize}
...
\label{sec:org25b1c91}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgcb426c5}
\begin{itemize}
...
\label{sec:org471721f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb0f304e}
...
\item Diagnostic Testing
\label{sec:org7bfc36e}
\begin{itemize}
\item \(\uparrow\) AFP
\item RAD, karyotype
\end{itemize}
\item Genetic Counseling
\label{sec:org2c50b61}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Trisomy 13}
\label{sec:org6bfe0e2}
\begin{itemize}
\item AKA Patau syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgcb91866}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org0cf9cd7}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org7218887}
\begin{itemize}
...
\label{sec:org9283a6f}
\begin{itemize}
\item AKA Edwards syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org21640ff}
\begin{itemize}
\item IUGR and LBW
...
\item Diagnostic Testing
\label{sec:org08c0fd2}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org2d37519}
\begin{itemize}
...
\label{sec:org9d621e6}
\begin{itemize}
\item AKA Down syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org0ba8c8f}
\begin{itemize}
...
\end{itemize}
\item Diagnostic Testing
\label{sec:orga06ff54}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org3b57395}
\begin{itemize}
...
\label{sec:orge6e1cc9}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgffb0f72}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:org9296012}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Fanconi anemia}
\label{sec:orged6262d}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org28a0649}
\begin{itemize}
...
\label{sec:org1b30035}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org0d88cc0}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:orgdb99766}
\begin{itemize}
\item AR, ATM
\end{itemize}
\end{enumerate}
\subsection{Williams syndrome}
\label{sec:org3adf30c}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org187a254}
\begin{itemize}
...
\label{sec:orgf865a7c}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge20023b}
\begin{itemize}
...
\label{sec:org479ee11}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgcd7156e}
\begin{itemize}
...
\label{sec:org5c3f1b7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org8f46b9a}
\begin{itemize}
...
\label{sec:orgfdc1097}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org8dda61c}
\begin{itemize}
...
\label{sec:org8f590ae}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6dbb96a}
\begin{itemize}
...
\label{sec:orge5c6cd3}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgac87707}
\begin{itemize}
...
\label{sec:orgf59a921}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3bd652d}
\begin{itemize}
...
\label{sec:org7719716}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org8060714}
\begin{itemize}
...
\caption{\label{fig:org8c82332}
BWS Chromosome 11}
\end{figure}

\item Genetic Counseling
\label{sec:org6c5a05f}
\begin{itemize}
...
\label{sec:org14e2782}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgac50e54}
\begin{itemize}
...
\label{sec:orgb4fcadc}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org58863fa}
\begin{itemize}
...
\caption{\label{fig:org6e20320}
11p Duplication in RSS}
\end{figure}

\item Genetic Counseling
\label{sec:org107e80a}
\begin{itemize}
