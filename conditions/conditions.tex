...
\label{sec:org4c1350b}
\subsection{Tuberous sclerosis}
\label{sec:orgf787669}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org327892e}
\begin{itemize}
...
\label{sec:org051bbfe}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org51146c2}
\begin{itemize}
...
\label{sec:org9142422}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc073f55}
\begin{itemize}
...
\label{sec:org32623f4}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgfdf4c0c}
\begin{itemize}
...
\label{sec:org780d58a}
\begin{itemize}
\item AKA: Lynch Syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1370936}
\begin{itemize}
...
\label{sec:org37478b3}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5f05c92}
\begin{itemize}
...
\label{sec:org3ca6157}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5542e5b}
\begin{itemize}
...
\label{sec:orga7e1d3d}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgbc5b868}
\begin{itemize}
...
\label{sec:org99f82c3}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga115454}
\begin{itemize}
...
\label{sec:org225166a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org00d1ec0}
\begin{itemize}
\item deficiency in factor IX clotting
\item same as Hemophilia A (section \ref{sec:org0771de9})
\end{itemize}
\item Diagnostic Testing
\label{sec:orgfa09f32}
\begin{itemize}
...
\label{sec:org57372ed}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5f4d484}
\begin{itemize}
...
\label{sec:org9ccd756}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org52509f0}
\begin{itemize}
...
\label{sec:orge8f84bd}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org33663e9}
...
\item Diagnostic Testing
\label{sec:org8e759df}
\begin{itemize}
\item \(\uparrow\) AFP
\item RAD, karyotype
\end{itemize}
\item Genetic Counseling
\label{sec:org5ccf619}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Trisomy 13}
\label{sec:orgb05bd27}
\begin{itemize}
\item AKA Patau syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org672fb58}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:orge08942a}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org7b2c1fc}
\begin{itemize}
...
\label{sec:org24973a3}
\begin{itemize}
\item AKA Edwards syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1e5ab21}
\begin{itemize}
\item IUGR and LBW
...
\item Diagnostic Testing
\label{sec:org96c63ba}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:orga5aaf64}
\begin{itemize}
...
\label{sec:orgad8f204}
\begin{itemize}
\item AKA Down syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org28d5e1d}
\begin{itemize}
...
\end{itemize}
\item Diagnostic Testing
\label{sec:org2d3e766}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org88799ce}
\begin{itemize}
...
\label{sec:orgeedf51d}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org2c3d2e8}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:org3c18850}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Fanconi anemia}
\label{sec:orgfa53c31}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org043596a}
\begin{itemize}
...
\label{sec:orged64578}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc261773}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:org91ef565}
\begin{itemize}
\item AR, ATM
\end{itemize}
\end{enumerate}
\subsection{Williams syndrome}
\label{sec:org644b53f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org42d4577}
\begin{itemize}
...
\label{sec:org22a3df7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgf1aab23}
\begin{itemize}
...
\label{sec:org1a0f7ed}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6bb4239}
\begin{itemize}
...
\label{sec:org6e3ce79}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5d93ce3}
\begin{itemize}
...
\label{sec:orgf53bc90}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org50e4a07}
\begin{itemize}
...
\label{sec:org5a40e05}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org92e9f68}
\begin{itemize}
...
\label{sec:orge045535}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgbf9aed9}
\begin{itemize}
...
\label{sec:org26112e7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1e1e976}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org29a71c3}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./figures/aspws.jpg}
\caption{\label{fig:orgebc98de}AS and PWS}
\end{figure}
...
\label{sec:org7db9c26}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org963f6ea}
\begin{itemize}
...
\caption{\label{fig:orge2f3e0c}BWS Chromosome 11}
\end{figure}

\item Genetic Counseling
\label{sec:orgc2b30db}
\begin{itemize}
...
\label{sec:org41e6484}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org86d37dd}
\begin{itemize}
...
\label{sec:org4c9f2ce}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4ecadfa}
\begin{itemize}
...
\caption{\label{fig:org44726f9}11p Duplication in RSS}
\end{figure}

\item Genetic Counseling
\label{sec:org6e5cf47}
\begin{itemize}
