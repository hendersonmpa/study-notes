...
\label{sec:orgbd7540b}
\subsection{Tuberous sclerosis}
\label{sec:org42b73fc}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org8a3bae6}
\begin{itemize}
...
\label{sec:org09b7e8c}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc57678d}
\begin{itemize}
...
\label{sec:org0b48328}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgfc0c1af}
\begin{itemize}
...
\label{sec:org9442367}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4eb5c73}
\begin{itemize}
...
\label{sec:orgd10901b}
\begin{itemize}
\item AKA: Lynch Syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5a49dd4}
\begin{itemize}
...
\label{sec:orgbba0180}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org7cbfc7b}
\begin{itemize}
...
\label{sec:org402dd7e}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge38c45b}
\begin{itemize}
...
\label{sec:org90eaefd}
\subsection{Duchenne/Becker Muscular Dystrophy}
\label{sec:orga2b9f7c}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5799c26}
\begin{itemize}
...
\label{sec:orgcf396f4}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org104fd7f}
\begin{itemize}
...
\end{itemize}
\item Genetic Counseling
\label{sec:org23f6c71}
\begin{itemize}
\item AD
\end{itemize}
\end{enumerate}
\subsection{Marfan Syndrome}
\label{sec:orgc5920c0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1be8d39}
\begin{itemize}
...
\label{sec:org57e7a7b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3a13bac}
\begin{itemize}
...
\label{sec:orgc2fc636}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd821182}
\begin{itemize}
...
\label{sec:orgd5ce543}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org9f69826}
\begin{itemize}
...
\end{itemize}
\item Genetic Counseling
\label{sec:org0faaf5b}
\begin{itemize}
\item AR DHCR7
\end{itemize}
\end{enumerate}
\subsection{Noonan Syndrome}
\label{sec:org479eb59}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd79fdc3}
\begin{itemize}
...
\end{itemize}
\item Genetic Counseling
\label{sec:org7743099}
\begin{itemize}
\item AD
\end{itemize}
\end{enumerate}
\subsection{Charge Syndrome}
\label{sec:org4909d17}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org87f084f}
\begin{itemize}
...
\end{itemize}
\item Genetic Counseling
\label{sec:org9aefba0}
\begin{itemize}
\item AD
\end{itemize}
\end{enumerate}
\subsection{Factor V Leiden Thrombophilia}
\label{sec:org2600a95}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org28148e2}
\begin{itemize}
...
\end{itemize}
\item Genetic Counseling
\label{sec:orgf7a74dd}
\begin{itemize}
\item AD F5
\end{itemize}
\end{enumerate}
\subsection{G6PD deficiency}
\label{sec:org6a57ce5}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb2fd66f}
\begin{itemize}
...
\end{itemize}
\item Genetic Counseling
\label{sec:org7477873}
\begin{itemize}
\item X-linked recessive G6PD
\end{itemize}
\end{enumerate}

\subsection{{\bfseries\sffamily TODO} Sickle Cell}
\label{sec:org647891e}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org238af2b}
\item Diagnostic Testing
\label{sec:org187c0c9}
\item Genetic Counseling
\label{sec:org994baed}
\end{enumerate}
\subsection{{\bfseries\sffamily TODO} \apha-Thalassemia}
\label{sec:org3606c40}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org2f52b25}
\item Diagnostic Testing
\label{sec:orgc9e6bcf}
\item Genetic Counseling
\label{sec:orgfe2e91b}
\end{enumerate}
\subsection{{\bfseries\sffamily TODO} \(\beta\)-Thalassemia}
\label{sec:orgff44fe7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org2795bcf}
\item Diagnostic Testing
\label{sec:orgc9a87e1}
\item Genetic Counseling
\label{sec:orgcb7d79c}
\end{enumerate}
\subsection{Hemophilia A}
\label{sec:org45ef64e}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgaadbdb6}
\begin{itemize}
...
\label{sec:org6a5f1c5}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga165500}
\begin{itemize}
\item deficiency in factor IX clotting
\item same as Hemophilia A (section \ref{sec:org45ef64e})
\end{itemize}
\item Diagnostic Testing
\label{sec:orgb4ecd2f}
\begin{itemize}
...
\label{sec:orge5ef26a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb043715}
\begin{itemize}
...
\label{sec:orgfabac90}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgde2c7c1}
\item Diagnostic Testing
\label{sec:orgd2bb4f7}
\item Genetic Counseling
\label{sec:org84be1bd}
\end{enumerate}
\subsection{{\bfseries\sffamily TODO} Turner syndrome}
\label{sec:org6848480}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgee1dbab}
\item Diagnostic Testing
\label{sec:orgfa6d4b4}
\item Genetic Counseling
\label{sec:orgc97b1be}
\end{enumerate}
\subsection{{\bfseries\sffamily TODO} Androgen insensitivity syndrome}
\label{sec:orgc44abd4}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org37ed38a}
\item Diagnostic Testing
\label{sec:org07bd355}
\item Genetic Counseling
\label{sec:orgb698941}
\end{enumerate}
\subsection{{\bfseries\sffamily TODO} 21-Hydroxylase deficiency}
\label{sec:orga543443}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org0d48b16}
\item Diagnostic Testing
\label{sec:org3019c32}
\item Genetic Counseling
\label{sec:org0991818}
\end{enumerate}

\section{Complex Inheritance}
\label{sec:org2ee5d8b}
\subsection{Alzheimer disease}
\label{sec:org263069a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgff7ca0f}
\begin{itemize}
...
\label{sec:org06214c4}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org7bb46e6}
\begin{itemize}
\item hearing loss present at birth
\end{itemize}
\item Diagnostic Testing
\label{sec:org0096784}
\begin{itemize}
...
\end{itemize}
\item Genetic Counseling
\label{sec:org10a77d6}
\begin{itemize}
\item GJB2, GJB6, SLC26A4
\end{itemize}
\end{enumerate}
\subsection{Diabetes Mellitus Type I}
\label{sec:orgd4d2492}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgdb7ada1}
\begin{itemize}
...
\label{sec:orgc9877d2}
\subsection{Cri du chat syndrome}
\label{sec:orge04abc2}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org45883f7}
\begin{itemize}
...
\label{sec:org1b6cc88}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3a658c1}
\begin{itemize}
...
\label{sec:org580c305}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org9ac227c}
...
\item Diagnostic Testing
\label{sec:org4e8452e}
\begin{itemize}
\item \(\uparrow\) AFP
\item RAD, karyotype
\end{itemize}
\item Genetic Counseling
\label{sec:org5576711}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Trisomy 13}
\label{sec:orgcc652fb}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org0c2a5df}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:orgae34cbb}
\begin{itemize}
...
\label{sec:org72027d4}
\begin{itemize}
\item AKA Edwards syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgf4a219b}
\begin{itemize}
\item IUGR and LBW
...
\item Diagnostic Testing
\label{sec:org8c63582}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org965760c}
\begin{itemize}
...
\label{sec:org8f08521}
\begin{itemize}
\item AKA Down syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga5fc365}
\begin{itemize}
...
\end{itemize}
\item Diagnostic Testing
\label{sec:org4485f23}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org572a4c7}
\begin{itemize}
...
\label{sec:org7c4ead5}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org01c3cc2}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:org957bc1b}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Fanconi anemia}
\label{sec:orgedecab8}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org29fa4c6}
\begin{itemize}
...
\label{sec:orgac3241b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4597927}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:org14c99cf}
\begin{itemize}
\item AR, ATM
\end{itemize}
\end{enumerate}
\subsection{Williams syndrome}
\label{sec:org6f4daa2}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc2400f8}
\begin{itemize}
...
\label{sec:orgc8021d9}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org28fbbf8}
\begin{itemize}
...
\label{sec:org956a4e2}
\subsection{Cystic fibrosis}
\label{sec:orgee3e6d1}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga937dac}
\begin{itemize}
...
\label{sec:org2d9dac0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org51f7e52}
\begin{itemize}
...
\label{sec:org6fef4a4}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org075af60}
\begin{itemize}
...
\label{sec:orgf7e8243}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org2fcf008}
\begin{itemize}
...
\label{sec:org6adf9ae}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org0e8f9da}
\begin{itemize}
...
\label{sec:org5c5fe75}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org558868a}
\begin{itemize}
...
\label{sec:org7f022be}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4b695d7}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org424ccfd}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./figures/aspws.jpg}
\caption{\label{fig:org13c6b13}AS and PWS}
\end{figure}
...
\label{sec:org7c16c7f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd15450d}
\begin{itemize}
...
\caption{\label{fig:org5ed5984}BWS Chromosome 11}
\end{figure}

\item Genetic Counseling
\label{sec:org73a81ae}
\begin{itemize}
...
\label{sec:orgfc58055}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org34feffa}
\begin{itemize}
...
\label{sec:org15f852e}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3f433e8}
\begin{itemize}
...
\caption{\label{fig:orgc860efe}11p Duplication in RSS}
\end{figure}

\item Genetic Counseling
\label{sec:org118b2de}
\begin{itemize}
...
\label{sec:org77e295d}
\subsection{Rett syndrome}
\label{sec:org41f9577}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgac60542}
\begin{description}
...
\end{itemize}
\item Genetic Counseling
\label{sec:org2eea283}
\begin{itemize}
\item AD PMP22
\end{itemize}
\end{enumerate}
\subsection{Spinal muscular atrophy}
\label{sec:org83f51cb}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org730d2eb}
\begin{itemize}
...
\caption{\label{fig:org2339c27}Algorithm for SMA}
\end{figure}

\item Genetic Counseling
\label{sec:orgbcd050c}
-AR SMN1
\end{enumerate}
\end{document}