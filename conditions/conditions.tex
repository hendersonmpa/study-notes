...
\label{sec:org548f50a}
\subsection{Tuberous sclerosis}
\label{sec:org9677093}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc5bbb74}
\begin{itemize}
...
\label{sec:org31c1a6d}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgdfc7c54}
\begin{itemize}
...
\label{sec:org5a791a0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3a4ff8d}
\begin{itemize}
...
\label{sec:org0c48c1a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb81dafb}
\begin{itemize}
...
\label{sec:org5ed9eec}
\begin{itemize}
\item AKA: Lynch Syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb976c3a}
\begin{itemize}
...
\label{sec:org5c8b5d0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org983e28a}
\begin{itemize}
...
\label{sec:org410da7c}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6e7e20d}
\begin{itemize}
...
\label{sec:org9c9fc8a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc49eead}
\begin{itemize}
...
\label{sec:org36e1a19}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org61ddb6a}
\begin{itemize}
...
\label{sec:org678c8f2}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org223835b}
\begin{itemize}
\item deficiency in factor IX clotting
\item same as Hemophilia A (section \ref{sec:org85dc8d3})
\end{itemize}
\item Diagnostic Testing
\label{sec:org1f7576a}
\begin{itemize}
...
\label{sec:org9366bd1}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga5f2f95}
\begin{itemize}
...
\label{sec:orgea09d3d}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org42a2e31}
\begin{itemize}
\item hearing loss present at birth
\end{itemize}
\item Diagnostic Testing
\label{sec:orgb70fe20}
\begin{itemize}
...
\end{itemize}
\item Genetic Counseling
\label{sec:orgd52865f}
\begin{itemize}
\item GJB2, GJB6 DFNB1
\end{itemize}
\end{enumerate}
\subsection{Diabetes Mellitus Type I}
\label{sec:orge579881}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org75b1680}
\begin{itemize}
...
\label{sec:org136024f}
\subsection{Cri du chat syndrome}
\label{sec:orga8f1e40}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4ea9662}
\begin{itemize}
...
\label{sec:orgf163f64}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org101865b}
\begin{itemize}
...
\label{sec:orge9f1d38}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org66a8160}
...
\item Diagnostic Testing
\label{sec:org56a1b06}
\begin{itemize}
\item \(\uparrow\) AFP
\item RAD, karyotype
\end{itemize}
\item Genetic Counseling
\label{sec:org6114dc3}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Trisomy 13}
\label{sec:orgf9082b3}
\begin{itemize}
\item AKA Patau syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgce63bdb}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:orga0a2f7a}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org9e1e793}
\begin{itemize}
...
\label{sec:org970c6c0}
\begin{itemize}
\item AKA Edwards syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org91c6a64}
\begin{itemize}
\item IUGR and LBW
...
\item Diagnostic Testing
\label{sec:orgfe414de}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:orgf2aa81e}
\begin{itemize}
...
\label{sec:orge508cfe}
\begin{itemize}
\item AKA Down syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc2a2376}
\begin{itemize}
...
\end{itemize}
\item Diagnostic Testing
\label{sec:orgdcbbadc}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org48b9919}
\begin{itemize}
...
\label{sec:org255f0c0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgf051337}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:org212b46b}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Fanconi anemia}
\label{sec:org06cd463}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb440124}
\begin{itemize}
...
\label{sec:org2035069}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3fa6b8f}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:org061f612}
\begin{itemize}
\item AR, ATM
\end{itemize}
\end{enumerate}
\subsection{Williams syndrome}
\label{sec:org2a05fd0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org05d4bce}
\begin{itemize}
...
\label{sec:orgc5c3077}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgdb2937a}
\begin{itemize}
...
\label{sec:org880b225}
\subsection{Cystic fibrosis}
\label{sec:org506c9b7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org157e24e}
\begin{itemize}
...
\label{sec:org3aecd32}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1290674}
\begin{itemize}
...
\label{sec:org40509f1}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org31dac45}
\begin{itemize}
...
\label{sec:org13f1580}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6df36e9}
\begin{itemize}
...
\label{sec:orgfb6c67f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4c14811}
\begin{itemize}
...
\label{sec:orge63bf21}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org86e0a0a}
\begin{itemize}
...
\label{sec:org451d8e8}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6a7707d}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:orgba75b9a}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./figures/aspws.jpg}
\caption{\label{fig:org97e05a9}AS and PWS}
\end{figure}
...
\label{sec:org9f69da8}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb05f608}
\begin{itemize}
...
\caption{\label{fig:org7f318dc}BWS Chromosome 11}
\end{figure}

\item Genetic Counseling
\label{sec:org1723c7f}
\begin{itemize}
...
\label{sec:org28ac295}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgad54aad}
\begin{itemize}
...
\label{sec:org1497551}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgea2cf35}
\begin{itemize}
...
\caption{\label{fig:org30a77f3}11p Duplication in RSS}
\end{figure}

\item Genetic Counseling
\label{sec:org44c3b68}
\begin{itemize}
...
\label{sec:org195196f}
\subsection{Rett syndrome}
\label{sec:org8a71015}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb800ada}
\begin{description}
...
\end{itemize}
\item Genetic Counseling
\label{sec:orgb2b7b3b}
\begin{itemize}
\item AD PMP22
\end{itemize}
\end{enumerate}
\subsection{Spinal muscular atrophy}
\label{sec:org6bf076b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org9fe0d56}
\begin{itemize}
...
\caption{\label{fig:org9d5e22c}Algorithm for SMA}
\end{figure}

\item Genetic Counseling
\label{sec:orgc93813e}
-AR SMN1
\end{enumerate}
\end{document}