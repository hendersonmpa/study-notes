...
\label{sec:org4f09260}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org297486a}
\begin{itemize}
...
\label{sec:org74b3ccb}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org08248d0}
\begin{itemize}
...
\label{sec:orgae251ca}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga6c2e9d}
\begin{itemize}
...
\label{sec:orgb2e0968}
\begin{itemize}
\item AKA: Lynch Syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge11fa3c}
\begin{itemize}
...
\label{sec:orga2fd1c4}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge750564}
\begin{itemize}
...
\label{sec:orgc4bd69b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org327c10b}
\begin{itemize}
...
\label{sec:orgc0ae59a}
\subsection{Duchenne/Becker Muscular Dystrophy}
\label{sec:orgcdba7dd}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org91f31cc}
\begin{itemize}
...
\label{sec:org9c8f89d}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org7c77fa7}
\begin{itemize}
...
\end{itemize}
\item Genetic Counselling
\label{sec:orgcc86868}
\begin{itemize}
\item AD KCNH2 KCNQ1 SCN5A
\end{itemize}
\end{enumerate}
\subsection{Marfan Syndrome}
\label{sec:orgdc45aeb}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6061616}
\begin{itemize}
...
\label{sec:org7003e05}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd8b5a33}
\begin{itemize}
...
\label{sec:orgbe53a7f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge291006}
\begin{itemize}
...
\label{sec:org67e462b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge56ecd6}
\begin{itemize}
...
\end{itemize}
\item Genetic Counselling
\label{sec:org5819ad8}
\begin{itemize}
\item AR DHCR7
\end{itemize}
\end{enumerate}
\subsection{Noonan Syndrome}
\label{sec:org05e365c}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org7121ea1}
\begin{itemize}
...
\end{itemize}
\item Genetic Counselling
\label{sec:org4068613}
\begin{itemize}
\item AD PTPN11 RAF1 BRAF MAP2K1
\end{itemize}
\end{enumerate}
\subsection{Charge Syndrome}
\label{sec:orgdfcea62}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgaa2078f}
\begin{itemize}
...
\end{itemize}
\item Genetic Counselling
\label{sec:org7e93da3}
\begin{itemize}
\item AD F5
\end{itemize}
\end{enumerate}
\subsection{G6PD Deficiency}
\label{sec:org56e9ef2}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org14e49e6}
\begin{itemize}
...
\label{sec:orgec1fc39}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org93bbda9}
\begin{itemize}
...
\end{itemize}
\item Genetic Counselling
\label{sec:org81a6209}
\begin{itemize}
\item AR HBB
\end{itemize}
\end{enumerate}
\subsection{\(\alpha\)-Thalassemia}
\label{sec:orgbd4ee52}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orged82ed8}
\begin{itemize}
...
\label{sec:orgfe92f3e}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4cb40f1}
\begin{itemize}
...
\label{sec:orgb0f1b1e}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1c3bf53}
\begin{itemize}
...
\label{sec:org0559401}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb6169a9}
\begin{itemize}
...
\label{sec:org0d9b590}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orged777cf}
\begin{itemize}
...
\label{sec:orgfe2f4ee}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org15d7fc6}
\begin{itemize}
...
\label{sec:org476a8a4}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgbc0eb2d}
\begin{itemize}
...
\label{sec:orge4cf3f7}
\subsection{Alzheimer Disease}
\label{sec:org25f991e}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org9f26f5a}
\begin{itemize}
...
\end{itemize}
\item Genetic Counselling
\label{sec:org32e2d6c}
\begin{itemize}
\item GJB2, GJB6, SLC26A4
\end{itemize}
\end{enumerate}
\subsection{Diabetes Mellitus Type I}
\label{sec:orgf398eb5}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6c076ec}
\begin{itemize}
...
\label{sec:orgf8d7b18}
\subsection{Cri du Chat Syndrome}
\label{sec:org48cac46}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgef2b4ed}
\begin{itemize}
...
\label{sec:org73f980f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org8319102}
\begin{itemize}
...
\label{sec:org94f699b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgdde769e}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org130381d}
\begin{itemize}
\item \(\uparrow\) AFP
\item RAD, karyotype
\end{itemize}
\item Genetic Counselling
\label{sec:org59436db}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Trisomy 13}
\label{sec:org8eb64b1}
\begin{itemize}
\item AKA Patau syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgfd73f17}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:orgc0441e7}
\begin{itemize}
\item CMA, RAD, karyotype
\end{itemize}

\item Genetic Counselling
\label{sec:org948eb61}
\begin{itemize}
...
\label{sec:org868da84}
\begin{itemize}
\item AKA Edwards syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4268261}
\begin{itemize}
\item IUGR and LBW
...
\item Diagnostic Testing
\label{sec:org12ebb94}
\begin{itemize}
\item CMA, RAD, karyotype
\end{itemize}

\item Genetic Counselling
\label{sec:orge7e076a}
\begin{itemize}
...
\label{sec:org08a8c41}
\begin{itemize}
\item AKA Down syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4360cd3}
\begin{itemize}
...
\end{itemize}
\item Diagnostic Testing
\label{sec:orgc4db657}
\begin{itemize}
\item CMA, RAD, karyotype
\end{itemize}

\item Genetic Counselling
\label{sec:orgda1da48}
\begin{itemize}
...
\label{sec:org2b006c6}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgafcb3e3}
\begin{itemize}
...
\label{sec:orga3d80e2}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org378299c}
\begin{itemize}
...
\end{itemize}
\item Genetic Counselling
\label{sec:org4ce6260}
\begin{itemize}
\item AR ATM
\end{itemize}
\end{enumerate}
\subsection{Williams Syndrome}
\label{sec:org489db90}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgcbe438a}
\begin{itemize}
...
\label{sec:org6fc9ab6}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org999072d}
\begin{itemize}
...
\label{sec:org95052ab}
\subsection{Cystic Fibrosis}
\label{sec:orgefb5033}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org38d06ce}
\begin{itemize}
...
\label{sec:orgfc967b0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org73d7af4}
\begin{itemize}
...
\label{sec:orge0e0b30}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga3b7965}
\begin{itemize}
...
\label{sec:org14647d8}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org48d9182}
\begin{itemize}
...
\label{sec:org8db9c9c}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1e537e2}
\begin{itemize}
...
\label{sec:org134ee3c}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga965ebe}
\begin{itemize}
...
\label{sec:org56884e5}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6fa82fd}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org0247fa3}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./figures/aspws.jpg}
\caption{\label{fig:org1bb0d35}AS and PWS}
\end{figure}

\begin{itemize}
\item molecular genetic testing for deficient expression or function of
the \textbf{maternally inherited UBE3A allele} (Figure \ref{fig:org1bb0d35})
...
\label{sec:org58ff9fe}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org059adc6}
\begin{itemize}
...
\caption{\label{fig:orgd17cfd7}BWS Chromosome 11}
\end{figure}

\item Genetic Counselling
\label{sec:org63a654b}
\begin{itemize}
...
\label{sec:org9f31a44}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org85d4169}
\begin{itemize}
...
\caption{\label{fig:org4810b13}11p Duplication in RSS}
\end{figure}

\item Genetic Counselling
\label{sec:org695cd7d}
\begin{itemize}
...
\label{sec:orgad4dce6}
\subsection{Rett Syndrome}
\label{sec:org8b365bb}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgf0fc7eb}
\begin{description}
...
\end{itemize}
\item Genetic Counselling
\label{sec:org0ab78a7}
\begin{itemize}
\item AD PMP22
\end{itemize}
\end{enumerate}
\subsection{Spinal Muscular Atrophy}
\label{sec:org38b95d0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4ccf129}
\begin{itemize}
...
\caption{\label{fig:org835adae}Algorithm for SMA}
\end{figure}

\item Genetic Counselling
\label{sec:org2c8b451}
\begin{itemize}
\item AR SMN1
\end{itemize}
\end{enumerate}
