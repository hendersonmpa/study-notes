...
\label{sec:org5ea1d1f}
\subsection{Tuberous sclerosis}
\label{sec:org334b46a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org16215e8}
\begin{itemize}
...
\label{sec:orge261997}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org9de624d}
\begin{itemize}
...
\label{sec:org383f180}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgca43549}
\begin{itemize}
...
\label{sec:orge0d1b47}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org43a2c19}
\begin{itemize}
...
\label{sec:orgc18b107}
\begin{itemize}
\item AKA: Lynch Syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org21463d9}
\begin{itemize}
...
\label{sec:orgcc28ea1}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org89d3e93}
\begin{itemize}
...
\label{sec:org759daca}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgbc5c25c}
\begin{itemize}
...
\label{sec:orga8f5fca}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3845adb}
\begin{itemize}
...
\label{sec:org59aafcd}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgaf8701b}
\begin{itemize}
...
\label{sec:org544133a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd5d7aa6}
\begin{itemize}
\item deficiency in factor IX clotting
\item same as Hemophilia A (section \ref{sec:org3ab59d0})
\end{itemize}
\item Diagnostic Testing
\label{sec:org886055e}
\begin{itemize}
...
\label{sec:orga267234}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org427171a}
\begin{itemize}
...
\label{sec:org3b34d24}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgaaed13c}
\begin{itemize}
...
\label{sec:org111ba3b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org0d399bd}
...
\item Diagnostic Testing
\label{sec:orgf72bfa4}
\begin{itemize}
\item \(\uparrow\) AFP
\item RAD, karyotype
\end{itemize}
\item Genetic Counseling
\label{sec:org4ce9b77}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Trisomy 13}
\label{sec:org7f79c9c}
\begin{itemize}
\item AKA Patau syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org199cb60}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org5d84311}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org3beba89}
\begin{itemize}
...
\label{sec:orgba0c8a8}
\begin{itemize}
\item AKA Edwards syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org282c5f1}
\begin{itemize}
\item IUGR and LBW
...
\item Diagnostic Testing
\label{sec:org666aaf1}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org9b96e37}
\begin{itemize}
...
\label{sec:orgb2a8d3d}
\begin{itemize}
\item AKA Down syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5d50c6b}
\begin{itemize}
...
\end{itemize}
\item Diagnostic Testing
\label{sec:org22baef2}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:orge3883c8}
\begin{itemize}
...
\label{sec:orgdfc8f3c}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org2aa26ce}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:org07fbde1}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Fanconi anemia}
\label{sec:org62a9d49}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5cac064}
\begin{itemize}
...
\label{sec:org7334e58}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgec6eceb}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:orge3ba02e}
\begin{itemize}
\item AR, ATM
\end{itemize}
\end{enumerate}
\subsection{Williams syndrome}
\label{sec:org9c2c7d0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org625ea5f}
\begin{itemize}
...
\label{sec:org95bebba}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga3e9afb}
\begin{itemize}
...
\label{sec:orgc358edd}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org806b3ed}
\begin{itemize}
...
\label{sec:orgd3a32aa}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4a08cb5}
\begin{itemize}
...
\label{sec:org6169937}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1c6c511}
\begin{itemize}
...
\label{sec:org1619c64}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org7e9ca45}
\begin{itemize}
...
\label{sec:orge34fc65}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org7bc22d9}
\begin{itemize}
...
\label{sec:org72cfd26}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org001b438}
\begin{itemize}
...
\label{sec:org7b07380}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgba205cf}
\begin{itemize}
...
\caption{\label{fig:org12d08ad}
BWS Chromosome 11}
\end{figure}

\item Genetic Counseling
\label{sec:org7a56a63}
\begin{itemize}
...
\label{sec:orgf7081e8}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd9c4474}
\begin{itemize}
...
\label{sec:org95d3b9e}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6169fce}
\begin{itemize}
...
\caption{\label{fig:orgc282206}
11p Duplication in RSS}
\end{figure}

\item Genetic Counseling
\label{sec:org1ef6506}
\begin{itemize}
