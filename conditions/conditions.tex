...
\label{sec:org117cb24}
\subsection{Tuberous sclerosis}
\label{sec:org70e0fe9}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1d85afa}
\begin{itemize}
...
\label{sec:org258e374}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4b8469e}
\begin{itemize}
...
\label{sec:org78f3f39}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org02f85a4}
\begin{itemize}
...
\label{sec:org8d46166}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org98593b7}
\begin{itemize}
...
\label{sec:org5e188e1}
\begin{itemize}
\item AKA: Lynch Syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3e19030}
\begin{itemize}
...
\label{sec:org197d64d}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org18c3b91}
\begin{itemize}
...
\label{sec:org114c1fc}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org2a9b5df}
\begin{itemize}
...
\label{sec:org2aac2ff}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org2e15de3}
\begin{itemize}
\item deficiency in factor IX clotting
\item same as Hemophilia A (section \ref{sec:orga8b0f65})
\end{itemize}
\item Diagnostic Testing
\label{sec:orgc138d63}
\begin{itemize}
...
\end{itemize}
\item Genetic Counseling
\label{sec:orgd8355b0}
\begin{itemize}
\item same as Hemophilia A (section \ref{sec:orga8b0f65})
\end{itemize}
\end{enumerate}
\subsection{Hemochromatosis}
\label{sec:orgd88e38b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org90d67b5}
\begin{itemize}
...
\label{sec:org950032e}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5a4bf04}
\begin{itemize}
...
\label{sec:org2124213}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org449e93a}
\begin{itemize}
...
\label{sec:orgee30fb0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org053c74c}
\begin{itemize}
...
\label{sec:orgeb57dea}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4cb41aa}
\begin{itemize}
...
\label{sec:orgd9b7d64}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgabbf0a2}
\begin{itemize}
...
\label{sec:orgbcdf9ba}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org84a67d2}
\begin{itemize}
...
\label{sec:org1301523}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge5d83ff}
\begin{itemize}
...
\caption{\label{fig:orgd060664}
BWS Chromosome 11}
\end{figure}

\item Genetic Counseling
\label{sec:orge8dd724}
\begin{itemize}
...
\label{sec:org283a0f0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb683bd6}
\begin{itemize}
...
\label{sec:orge59fd80}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgab8a8f3}
\begin{itemize}
...
\caption{\label{fig:orgb6b2801}
11p Duplication in RSS}
\end{figure}

\item Genetic Counseling
\label{sec:orgafb5350}
\begin{itemize}
