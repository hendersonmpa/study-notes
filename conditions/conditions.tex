...
\label{sec:orgcf73110}
\subsection{Tuberous sclerosis}
\label{sec:org2481d8b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga8b5269}
\begin{itemize}
...
\label{sec:org2baeb8b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc101b7b}
\begin{itemize}
...
\label{sec:orgfd27571}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org0441db3}
\begin{itemize}
...
\label{sec:org570b5b6}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org17541fe}
\begin{itemize}
...
\label{sec:org4853105}
\begin{itemize}
\item AKA: Lynch Syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org95a4e6e}
\begin{itemize}
...
\label{sec:org1586441}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd4c9012}
\begin{itemize}
...
\label{sec:org43390b7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb05059a}
\begin{itemize}
...
\label{sec:org8fce6e7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc0ab5a9}
\begin{itemize}
...
\label{sec:org43a67c1}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3227e14}
\begin{itemize}
...
\label{sec:org3a0470b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgbff35c5}
\begin{itemize}
\item deficiency in factor IX clotting
\item same as Hemophilia A (section \ref{sec:orgf5663c8})
\end{itemize}
\item Diagnostic Testing
\label{sec:orgb803cd8}
\begin{itemize}
...
\label{sec:orgd67c3da}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4f76976}
\begin{itemize}
...
\label{sec:orga7ab8a9}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga814ef8}
\begin{itemize}
...
\label{sec:orgd89a248}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org38d7eda}
...
\item Diagnostic Testing
\label{sec:orgbee7b6a}
\begin{itemize}
\item \(\uparrow\) AFP
\item RAD, karyotype
\end{itemize}
\item Genetic Counseling
\label{sec:org8f6cfbc}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Trisomy 13}
\label{sec:org6b40f12}
\begin{itemize}
\item AKA Patau syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgdf9b182}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:orgcf39ce9}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:orgd79f78a}
\begin{itemize}
...
\label{sec:org3a375b8}
\begin{itemize}
\item AKA Edwards syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org41b8808}
\begin{itemize}
\item IUGR and LBW
...
\item Diagnostic Testing
\label{sec:org296ea1d}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org987b24d}
\begin{itemize}
...
\label{sec:orgd74bd9d}
\begin{itemize}
\item AKA Down syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd93d462}
\begin{itemize}
...
\end{itemize}
\item Diagnostic Testing
\label{sec:org661db82}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:orgc547527}
\begin{itemize}
...
\label{sec:org074076d}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org62823d2}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:orgc6fe96c}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Fanconi anemia}
\label{sec:org8efb6e7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org62e82bc}
\begin{itemize}
...
\label{sec:org45c58ca}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5c82696}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:org31e84bc}
\begin{itemize}
\item AR, ATM
\end{itemize}
\end{enumerate}
\subsection{Williams syndrome}
\label{sec:orgf3938ae}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org216ad52}
\begin{itemize}
...
\label{sec:org3f7f2bc}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgad1944a}
\begin{itemize}
...
\label{sec:orgaba2409}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd9b70bb}
\begin{itemize}
...
\label{sec:org7f46299}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6271980}
\begin{itemize}
...
\label{sec:org64febf2}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org034c6d3}
\begin{itemize}
...
\label{sec:org497e3a7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org8dd5427}
\begin{itemize}
...
\label{sec:orgc01a8f3}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3515691}
\begin{itemize}
...
\label{sec:org8a99612}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd354906}
\begin{itemize}
...
\label{sec:orge060a7d}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge9066e0}
\begin{itemize}
...
\caption{\label{fig:org0553df3}
BWS Chromosome 11}
\end{figure}

\item Genetic Counseling
\label{sec:org0e49ede}
\begin{itemize}
...
\label{sec:org94660b5}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org878d0e4}
\begin{itemize}
...
\label{sec:orgdffdf4a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb39439e}
\begin{itemize}
...
\caption{\label{fig:org362c061}
11p Duplication in RSS}
\end{figure}

\item Genetic Counseling
\label{sec:orga0cd4e6}
\begin{itemize}
