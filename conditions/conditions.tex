...
\label{sec:org5c2f754}
\subsection{Tuberous sclerosis}
\label{sec:org28ed33a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org9d9a210}
\begin{itemize}
...
\label{sec:org2f90601}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgfcdf458}
\begin{itemize}
...
\label{sec:org29bf356}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgbafe6eb}
\begin{itemize}
...
\label{sec:org233b8f7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org36313b1}
\begin{itemize}
...
\label{sec:orge9c8d4f}
\begin{itemize}
\item AKA: Lynch Syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org829bdde}
\begin{itemize}
...
\label{sec:orgfacdcc2}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge38f0f7}
\begin{itemize}
...
\label{sec:org5bec04b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga2ab6ec}
\begin{itemize}
...
\label{sec:org6638d61}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org69a0538}
\begin{itemize}
...
\label{sec:org843fdfb}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org76b6b76}
\begin{itemize}
...
\label{sec:orgb8f9508}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org0f78163}
\begin{itemize}
\item deficiency in factor IX clotting
\item same as Hemophilia A (section \ref{sec:org751eaef})
\end{itemize}
\item Diagnostic Testing
\label{sec:orgcc0f798}
\begin{itemize}
...
\label{sec:orgf67d374}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org35e97b1}
\begin{itemize}
...
\label{sec:org2a2cb43}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga988402}
\begin{itemize}
...
\label{sec:orgc54d1fa}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org65b2ce3}
...
\item Diagnostic Testing
\label{sec:org19495db}
\begin{itemize}
\item \(\uparrow\) AFP
\item RAD, karyotype
\end{itemize}
\item Genetic Counseling
\label{sec:org0fa2311}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Trisomy 13}
\label{sec:org138e7d0}
\begin{itemize}
\item AKA Patau syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgfe441b9}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org3761099}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:orgb604fde}
\begin{itemize}
...
\label{sec:org2d900ba}
\begin{itemize}
\item AKA Edwards syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgbc28c66}
\begin{itemize}
\item IUGR and LBW
...
\item Diagnostic Testing
\label{sec:org9da8f42}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:orgb804d7f}
\begin{itemize}
...
\label{sec:org415f2bc}
\begin{itemize}
\item AKA Down syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga395eaa}
\begin{itemize}
...
\end{itemize}
\item Diagnostic Testing
\label{sec:org4348a4f}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:orgc160b8a}
\begin{itemize}
...
\label{sec:org95e81c9}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org2f2dfec}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:org7e17936}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Fanconi anemia}
\label{sec:org74253cf}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd190ead}
\begin{itemize}
...
\label{sec:org4e22072}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd790624}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:org4d2ffd5}
\begin{itemize}
\item AR, ATM
\end{itemize}
\end{enumerate}
\subsection{Williams syndrome}
\label{sec:org06c30a8}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5a3b535}
\begin{itemize}
...
\label{sec:org7a3edb9}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org74099c6}
\begin{itemize}
...
\label{sec:org3da60a5}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org2fa890d}
\begin{itemize}
...
\label{sec:org27ea8ce}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org172f168}
\begin{itemize}
...
\label{sec:org0e095e7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgec3f120}
\begin{itemize}
...
\label{sec:org30cfc97}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org491b39a}
\begin{itemize}
...
\label{sec:orgc42a4f0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1a99747}
\begin{itemize}
...
\label{sec:org3c45a62}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org16659cd}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org5adefec}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./figures/aspws.jpg}
\caption{\label{fig:org1be0570}AS and PWS}
\end{figure}
...
\label{sec:orga40171a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3017a0d}
\begin{itemize}
...
\caption{\label{fig:orgd46863a}BWS Chromosome 11}
\end{figure}

\item Genetic Counseling
\label{sec:org0328a4d}
\begin{itemize}
...
\label{sec:orgf0188f9}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org565abf9}
\begin{itemize}
...
\label{sec:org1b214f0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgcd30fda}
\begin{itemize}
...
\caption{\label{fig:org03d9e1d}11p Duplication in RSS}
\end{figure}

\item Genetic Counseling
\label{sec:orgcd2d7fb}
\begin{itemize}
