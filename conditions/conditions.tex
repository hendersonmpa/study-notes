...
\label{sec:org5d4de8d}
\subsection{Tuberous sclerosis}
\label{sec:org773bf18}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org7195651}
\begin{itemize}
...
\label{sec:orgac9fbb0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd7c29a6}
\begin{itemize}
...
\label{sec:orgf602623}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org2c9af66}
\begin{itemize}
...
\label{sec:orgde9aa47}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc50049a}
\begin{itemize}
...
\label{sec:org9cf281c}
\begin{itemize}
\item AKA: Lynch Syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd736c79}
\begin{itemize}
...
\label{sec:org29ed80b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org9daaf97}
\begin{itemize}
...
\label{sec:org96594b6}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb41e6ff}
\begin{itemize}
...
\label{sec:orgdf91070}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgcfd40f5}
\begin{itemize}
...
\label{sec:orgc05d8e8}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga319707}
\begin{itemize}
...
\end{itemize}
\item Genetic Counseling
\label{sec:org185d7b5}
\begin{itemize}
\item AR HBB
\end{itemize}
\end{enumerate}
\subsection{\(\alpha\)-Thalassemia}
\label{sec:org8021f53}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org0f322c6}
\begin{itemize}
...
\label{sec:orgeef1a32}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga3a7867}
\begin{itemize}
...
\label{sec:org183b1e6}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3c1e12c}
\begin{itemize}
...
\label{sec:org52d81f6}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge696444}
\begin{itemize}
...
\label{sec:orge1f9679}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org246bc1e}
\begin{itemize}
...
\label{sec:org471b79d}
\subsection{Cri du chat syndrome}
\label{sec:org600b52a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc0f98d9}
\begin{itemize}
...
\label{sec:org6090a03}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org493e045}
\begin{itemize}
...
\label{sec:org76a76fc}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge0f332a}
...
\item Diagnostic Testing
\label{sec:orgdadc9a2}
\begin{itemize}
\item \(\uparrow\) AFP
\item RAD, karyotype
\end{itemize}
\item Genetic Counseling
\label{sec:org23bbaa8}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Trisomy 13}
\label{sec:orgdbc6166}
\begin{itemize}
\item AKA Patau syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge5fb050}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org7886e49}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org8da48d7}
\begin{itemize}
...
\label{sec:orgf2e6382}
\begin{itemize}
\item AKA Edwards syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org201fd6a}
\begin{itemize}
\item IUGR and LBW
...
\item Diagnostic Testing
\label{sec:org1522053}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:orgd603bac}
\begin{itemize}
...
\label{sec:org07e4961}
\begin{itemize}
\item AKA Down syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb8a935a}
\begin{itemize}
...
\end{itemize}
\item Diagnostic Testing
\label{sec:orgcebb718}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:orgdad19f5}
\begin{itemize}
...
\label{sec:org9e79186}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org82e0160}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:orgfd6d4a1}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Fanconi anemia}
\label{sec:orgbf87065}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6e3eee9}
\begin{itemize}
...
\label{sec:orge915177}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org0c2cc45}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:orgdec4ef8}
\begin{itemize}
\item AR, ATM
\end{itemize}
\end{enumerate}
\subsection{Williams syndrome}
\label{sec:org17a065b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgaf9fa88}
\begin{itemize}
...
\label{sec:org1551f4a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb3b33d4}
\begin{itemize}
...
\label{sec:org4dbcd59}
\subsection{Cystic fibrosis}
\label{sec:org8c949aa}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgde44a81}
\begin{itemize}
...
\label{sec:org575b421}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd37df8b}
\begin{itemize}
...
\label{sec:orgdc6163f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3475c4d}
\begin{itemize}
...
\label{sec:org33052c2}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org8d5b826}
\begin{itemize}
...
\label{sec:org7f49a90}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org50c20e7}
\begin{itemize}
...
\label{sec:org04d1c4f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc0b6b9c}
\begin{itemize}
...
\label{sec:org2e79550}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org058f001}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org7831561}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./figures/aspws.jpg}
\caption{\label{fig:org7fdd391}AS and PWS}
\end{figure}
...
\label{sec:orge55fdb7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge593740}
\begin{itemize}
...
\caption{\label{fig:orge2b911e}BWS Chromosome 11}
\end{figure}

\item Genetic Counseling
\label{sec:org3ad90a9}
\begin{itemize}
...
\label{sec:org8e2a30b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge36a912}
\begin{itemize}
...
\label{sec:orga68c4c7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org78ab467}
\begin{itemize}
...
\caption{\label{fig:org88b16b8}11p Duplication in RSS}
\end{figure}

\item Genetic Counseling
\label{sec:org6ea39bd}
\begin{itemize}
...
\label{sec:org300240f}
\subsection{Rett syndrome}
\label{sec:org9e67a3b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgbef394c}
\begin{description}
...
\end{itemize}
\item Genetic Counseling
\label{sec:org1394630}
\begin{itemize}
\item AD PMP22
\end{itemize}
\end{enumerate}
\subsection{Spinal muscular atrophy}
\label{sec:orgc1794aa}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org755f846}
\begin{itemize}
...
\caption{\label{fig:orga30098b}Algorithm for SMA}
\end{figure}

\item Genetic Counseling
\label{sec:org618900c}
-AR SMN1
\end{enumerate}
\end{document}