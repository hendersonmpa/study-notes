...
\label{sec:org33fe8d8}
\subsection{Tuberous sclerosis}
\label{sec:org2fa99eb}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc7b3d8f}
\begin{itemize}
...
\label{sec:org3d3ec68}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org7b19ec4}
\begin{itemize}
...
\label{sec:orgf9960a5}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org7f34dc3}
\begin{itemize}
...
\label{sec:orgb485f15}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org2d954c9}
\begin{itemize}
...
\label{sec:org692573e}
\begin{itemize}
\item AKA: Lynch Syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org96d844d}
\begin{itemize}
...
\label{sec:orgfa323c7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4e4f8dd}
\begin{itemize}
...
\label{sec:orgd466984}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4238a11}
\begin{itemize}
...
\label{sec:orgaae0674}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org15badc7}
\begin{itemize}
...
\label{sec:orga28f844}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgba9f69e}
\begin{itemize}
...
\label{sec:org3db2a75}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org9597b1c}
\begin{itemize}
...
\label{sec:org3028619}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgf00effe}
\begin{itemize}
...
\label{sec:org13a8fdd}
\subsection{Cri du chat syndrome}
\label{sec:orgdba4e97}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org15d9dfa}
\begin{itemize}
...
\label{sec:org0b5c389}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org70bd377}
\begin{itemize}
...
\label{sec:orgcf814d1}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1719c11}
...
\item Diagnostic Testing
\label{sec:org81f000a}
\begin{itemize}
\item \(\uparrow\) AFP
\item RAD, karyotype
\end{itemize}
\item Genetic Counseling
\label{sec:orga48aa5f}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Trisomy 13}
\label{sec:orgc10ac8c}
\begin{itemize}
\item AKA Patau syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1d0b57b}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org8e82c2a}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org4329441}
\begin{itemize}
...
\label{sec:org8406756}
\begin{itemize}
\item AKA Edwards syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc579738}
\begin{itemize}
\item IUGR and LBW
...
\item Diagnostic Testing
\label{sec:org0eb4ead}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org8eecff7}
\begin{itemize}
...
\label{sec:org18f2e16}
\begin{itemize}
\item AKA Down syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org49a1efb}
\begin{itemize}
...
\end{itemize}
\item Diagnostic Testing
\label{sec:org87ab661}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org631d9d3}
\begin{itemize}
...
\label{sec:org59de2f0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org761377b}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:org4993dce}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Fanconi anemia}
\label{sec:orgb753b79}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org24d8451}
\begin{itemize}
...
\label{sec:org0c3aa46}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6b2508e}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:org27715b2}
\begin{itemize}
\item AR, ATM
\end{itemize}
\end{enumerate}
\subsection{Williams syndrome}
\label{sec:org4bd4942}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org73b662d}
\begin{itemize}
...
\label{sec:orgf0b478f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb8845eb}
\begin{itemize}
...
\label{sec:org13f658c}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org9910128}
\begin{itemize}
...
\label{sec:orga3f63f1}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4ca8935}
\begin{itemize}
...
\label{sec:org0d7acb7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6118b0b}
\begin{itemize}
...
\label{sec:orgfcedaec}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgf913830}
\begin{itemize}
...
\label{sec:org2511db0}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgfc4c672}
\begin{itemize}
...
\label{sec:orgf776d55}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgeb5acf6}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org196d1c5}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./figures/aspws.jpg}
\caption{\label{fig:org0e56242}AS and PWS}
\end{figure}
...
\label{sec:org40db011}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org9b127db}
\begin{itemize}
...
\caption{\label{fig:org74d360a}BWS Chromosome 11}
\end{figure}

\item Genetic Counseling
\label{sec:orgdfb1885}
\begin{itemize}
...
\label{sec:org2520d9e}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgbd2c325}
\begin{itemize}
...
\label{sec:org4be59b7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6461bec}
\begin{itemize}
...
\caption{\label{fig:orgf4a1d29}11p Duplication in RSS}
\end{figure}

\item Genetic Counseling
\label{sec:orgeec9b84}
\begin{itemize}
...
\label{sec:org18a6f0d}
\subsection{Rett syndrome}
\label{sec:org501c51f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org43cf0d6}
\begin{description}
...
\end{itemize}
\item Genetic Counseling
\label{sec:org7747495}
\begin{itemize}
\item AD PMP22
\end{itemize}
\end{enumerate}
\subsection{Spinal muscular atrophy}
\label{sec:org060eb81}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orge2800de}
\begin{itemize}
...
\caption{\label{fig:org6b9159a}Algorithm for SMA}
\end{figure}

\item Genetic Counseling
\label{sec:org00f75ef}
-AR SMN1
\end{enumerate}
\end{document}