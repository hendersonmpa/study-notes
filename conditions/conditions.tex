...
\label{sec:org49bfc11}
\subsection{Tuberous sclerosis}
\label{sec:org5285dad}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org04abc9f}
\begin{itemize}
...
\label{sec:org33a33cb}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb1a5d0f}
\begin{itemize}
...
\label{sec:orgbca6707}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org8a5219f}
\begin{itemize}
...
\label{sec:orgd8729d3}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org2c195fd}
\begin{itemize}
...
\label{sec:org856ba45}
\begin{itemize}
\item AKA: Lynch Syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org7f38931}
\begin{itemize}
...
\label{sec:orga31b2c4}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org574ca16}
\begin{itemize}
...
\label{sec:orgdea034b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org7ff1859}
\begin{itemize}
...
\label{sec:org1e5e16f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org563b49c}
\begin{itemize}
\item deficiency in factor IX clotting
\item same as Hemophilia A (section \ref{sec:org9132087})
\end{itemize}
\item Diagnostic Testing
\label{sec:org9a21570}
\begin{itemize}
...
\end{itemize}
\item Genetic Counseling
\label{sec:org3147923}
\begin{itemize}
\item same as Hemophilia A (section \ref{sec:org9132087})
\end{itemize}
\end{enumerate}
\subsection{Hemochromatosis}
\label{sec:orgf401cd3}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgfbd5264}
\begin{itemize}
...
\label{sec:org5a992f9}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5c879ff}
\begin{itemize}
...
\label{sec:org93dad27}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org08a06ea}
\begin{itemize}
...
\label{sec:org3f46830}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3610f60}
\begin{itemize}
...
\label{sec:org69fa5bd}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc358a8f}
\begin{itemize}
...
\label{sec:org014f0be}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga5ff7a6}
\begin{itemize}
...
\label{sec:org42ac4a8}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgf11cd75}
\begin{itemize}
...
\label{sec:org57cb41b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd10f08f}
\begin{itemize}
...
\caption{\label{fig:org966ca37}
BWS Chromosome 11}
\end{figure}

\item Genetic Counseling
\label{sec:orgda7b4cd}
\begin{itemize}
...
\label{sec:org144a224}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6addf88}
\begin{itemize}
...
\label{sec:org970a84d}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org98b3329}
\begin{itemize}
...
\caption{\label{fig:org633bfdc}
11p Duplication in RSS}
\end{figure}

\item Genetic Counseling
\label{sec:org902061e}
\begin{itemize}
