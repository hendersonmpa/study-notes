...
\label{sec:org90aadfd}
\subsection{Tuberous sclerosis}
\label{sec:org2580569}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4df9c5c}
\begin{itemize}
...
\label{sec:orgd780d55}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org0983f34}
\begin{itemize}
...
\label{sec:org7caab0b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga9ce9db}
\begin{itemize}
...
\label{sec:orgbb30996}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgf77ba44}
\begin{itemize}
...
\label{sec:org9900d58}
\begin{itemize}
\item AKA: Lynch Syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org14eb512}
\begin{itemize}
...
\label{sec:org8da2017}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org3b4c933}
\begin{itemize}
...
\label{sec:org28249a2}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga31a226}
\begin{itemize}
...
\label{sec:org8a40b6a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgf7929b3}
\begin{itemize}
...
\label{sec:org86ae8b1}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org620d81d}
\begin{itemize}
...
\label{sec:org14b4dde}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org2412bba}
\begin{itemize}
...
\label{sec:org6ad54cf}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4cc01c4}
\begin{itemize}
...
\label{sec:org362102f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgfd73ee3}
...
\item Diagnostic Testing
\label{sec:org3ac41f7}
\begin{itemize}
\item \(\uparrow\) AFP
\item RAD, karyotype
\end{itemize}
\item Genetic Counseling
\label{sec:orge46b487}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Trisomy 13}
\label{sec:orgaf41580}
\begin{itemize}
\item AKA Patau syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org51e3dbd}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org3aab19b}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org99eb1d1}
\begin{itemize}
...
\label{sec:orgd78d998}
\begin{itemize}
\item AKA Edwards syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb48a3fb}
\begin{itemize}
\item IUGR and LBW
...
\item Diagnostic Testing
\label{sec:org5ee0896}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org27ea620}
\begin{itemize}
...
\label{sec:org50e7be7}
\begin{itemize}
\item AKA Down syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org53cdd6f}
\begin{itemize}
...
\end{itemize}
\item Diagnostic Testing
\label{sec:org928634c}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org9f11515}
\begin{itemize}
...
\label{sec:org8ffa189}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgfd9986d}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:orgbde7d47}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Fanconi anemia}
\label{sec:orgec8584a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org92ee4ae}
\begin{itemize}
...
\label{sec:orgda273cb}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgdbe9ffd}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:orgdcca6ff}
\begin{itemize}
\item AR, ATM
\end{itemize}
\end{enumerate}
\subsection{Williams syndrome}
\label{sec:org9f5c148}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org50d81bd}
\begin{itemize}
...
\label{sec:org0623a0f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org7cc013b}
\begin{itemize}
...
\label{sec:org58cb4e7}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgf5dc678}
\begin{itemize}
...
\label{sec:orgccda2aa}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd178336}
\begin{itemize}
...
\label{sec:org65d58bb}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgaa2f4b2}
\begin{itemize}
...
\label{sec:org8a2380f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org9d2ec81}
\begin{itemize}
...
\label{sec:org94e6002}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1327b47}
\begin{itemize}
...
\label{sec:org32f2bd6}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org7bfdf7f}
\begin{itemize}
...
\label{sec:org03a6c80}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org6fbd957}
\begin{itemize}
...
\caption{\label{fig:orgd16f989}
BWS Chromosome 11}
\end{figure}

\item Genetic Counseling
\label{sec:orgdd49426}
\begin{itemize}
...
\label{sec:org32e239f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org7b67587}
\begin{itemize}
...
\label{sec:orgd4649f1}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org60a83ab}
\begin{itemize}
...
\caption{\label{fig:org166cd31}
11p Duplication in RSS}
\end{figure}

\item Genetic Counseling
\label{sec:orge2352f4}
\begin{itemize}
