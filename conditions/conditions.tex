...
\label{sec:orgd453929}
\subsection{Tuberous sclerosis}
\label{sec:orga50df5f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org1b11d57}
\begin{itemize}
...
\label{sec:orgbccff3d}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb7871db}
\begin{itemize}
...
\label{sec:orgfbb3d63}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org71b7ec1}
\begin{itemize}
...
\label{sec:org7c60d7b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org375c47a}
\begin{itemize}
...
\label{sec:orge825568}
\begin{itemize}
\item AKA: Lynch Syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgfd264a2}
\begin{itemize}
...
\label{sec:orgb8b200f}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgeb32132}
\begin{itemize}
...
\label{sec:org6d69826}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org474d761}
\begin{itemize}
...
\label{sec:orgdca4861}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org4204d21}
\begin{itemize}
...
\label{sec:org34d60b5}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org5329468}
\begin{itemize}
...
\label{sec:orgea4231e}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org27e29e6}
\begin{itemize}
...
\label{sec:org9a1a27b}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org8669763}
\begin{itemize}
...
\label{sec:org088c343}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org7a6a386}
...
\item Diagnostic Testing
\label{sec:orgcc0be25}
\begin{itemize}
\item \(\uparrow\) AFP
\item RAD, karyotype
\end{itemize}
\item Genetic Counseling
\label{sec:org60b89d7}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Trisomy 13}
\label{sec:orgb7404d8}
\begin{itemize}
\item AKA Patau syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgd945f33}
\begin{itemize}
...
\item Diagnostic Testing
\label{sec:org983ebae}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:orgdc818e4}
\begin{itemize}
...
\label{sec:org465bfa2}
\begin{itemize}
\item AKA Edwards syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org9da16b0}
\begin{itemize}
\item IUGR and LBW
...
\item Diagnostic Testing
\label{sec:org3680b74}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:org71fbcb5}
\begin{itemize}
...
\label{sec:orgaf6059b}
\begin{itemize}
\item AKA Down syndrome
\end{itemize}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org8b0a672}
\begin{itemize}
...
\end{itemize}
\item Diagnostic Testing
\label{sec:org60a5942}
\begin{itemize}
\item CMD, RAD, karyotype
\end{itemize}

\item Genetic Counseling
\label{sec:orgdc6f2d7}
\begin{itemize}
...
\label{sec:org5bb6530}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga320453}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:org2f9c3b5}
\begin{itemize}
\item not inherited
\end{itemize}
\end{enumerate}
\subsection{Fanconi anemia}
\label{sec:org7ffb1c2}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga62fccf}
\begin{itemize}
...
\label{sec:org206c5a6}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgc5f1961}
\begin{itemize}
...
\item Genetic Counseling
\label{sec:org9809430}
\begin{itemize}
\item AR, ATM
\end{itemize}
\end{enumerate}
\subsection{Williams syndrome}
\label{sec:orgb828d1a}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgf98bb19}
\begin{itemize}
...
\label{sec:org7bda705}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org0304f48}
\begin{itemize}
...
\label{sec:orgf624471}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga187d91}
\begin{itemize}
...
\label{sec:orge95ec77}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orga156174}
\begin{itemize}
...
\label{sec:org983dc76}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org26e78ca}
\begin{itemize}
...
\label{sec:org2c763dc}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org043fb1a}
\begin{itemize}
...
\label{sec:org25d02c2}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org33aeb5b}
\begin{itemize}
...
\label{sec:org9083e48}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:orgb19e2f8}
\begin{itemize}
...
\label{sec:org0caa903}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org41e6ff4}
\begin{itemize}
...
\caption{\label{fig:orga4172d2}
BWS Chromosome 11}
\end{figure}

\item Genetic Counseling
\label{sec:orgc6d7ee6}
\begin{itemize}
...
\label{sec:orge4ac8fe}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org14865bb}
\begin{itemize}
...
\label{sec:org88b0f7c}
\begin{enumerate}
\item Clinical Characteristics
\label{sec:org0aced1c}
\begin{itemize}
...
\caption{\label{fig:org7b89c72}
11p Duplication in RSS}
\end{figure}

\item Genetic Counseling
\label{sec:org310f2bb}
\begin{itemize}
