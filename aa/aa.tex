...
\label{sec:org00b7347}
\subsection{Introduction}
\label{sec:orgab3884a}
\begin{itemize}
...
\end{itemize}
\item when hydroxylation to Tyr is impeded Phe can be transaminated to
...
\label{sec:orgd1d85f3}
\subsubsection{Clinical Presentation}
\label{sec:orgfda62ce}
\begin{itemize}
...
\label{sec:org528bb5c}
\begin{enumerate}
\item Diet
\label{sec:orgda5208d}
\begin{itemize}
...
\label{sec:org8ae9c63}
\subsubsection{Clinical Presentation}
\label{sec:orgc9e85f1}
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org3f30f22}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figure \ref{fig:org3886841})
...
\begin{table}[htbp]
\caption{\label{tab:org57fe649}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org8e07931}} & primapterin\textsuperscript{\ref{org8e07931}} & CSF 5HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org8e07931}blood or urine}

\subsubsection{Treatment}
\label{sec:org281cca6}
\begin{itemize}
\item BH\(_{\text{4}}\)
...
\section{Tyrosine}
\label{sec:orgd8b5ab6}
\subsection{Introduction}
\label{sec:org2058d60}
...
\label{sec:orgb7f3ece}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org1197912}
\begin{itemize}
...
\label{sec:orgb3df7b0}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org5654bc1}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgc9ddd0d}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgf2fe664}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgb027af4}
\begin{itemize}
\item AR, HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org25bfaff}
\begin{itemize}
...
\label{sec:org2dbfe5b}
\subsubsection{Clinical Presentation}
\label{sec:org1b6696b}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orga1b9773}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org5954456}
\begin{itemize}
...
\label{sec:org1281ef4}
\subsubsection{Clinical Presentation}
\label{sec:orgca67e89}
\begin{itemize}
...
\section{BCAA}
\label{sec:org0a64d20}
\subsection{Introduction}
\label{sec:org37a8eac}
\begin{itemize}
...
\label{sec:orgdd4ba0b}
\subsubsection{Clinical Presentation}
\label{sec:org860c4a3}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org552205d}
\begin{enumerate}
\item MSUD
\label{sec:orgd01d28e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org3ce063b}
\begin{description}
\item[{MSUD}] AR, E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR, IVD
\item[{PA}] AR, PCCB
\item[{MMA}] AR, MUT or cobalamin system (Table \ref{tab:orgef2f4ad})
\begin{itemize}
...
MMADHC & cblD\\
\end{tabular}
\end{table}\footnotetext[2]{\label{orgdc9ff9a}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:orgf343208}
\begin{enumerate}
\item MSUD
\label{sec:org8d48855}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org075ce39}
\begin{itemize}
\item AR, MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgbce47d6}
\begin{itemize}
\item \(\Uparrow\) 3-HIVA
...
\section{Urea Cycle}
\label{sec:org9fa29f0}
\subsection{Introduction}
\label{sec:org37ff604}
\begin{itemize}
...
\label{sec:org2e33443}
\begin{enumerate}
\item Newborns
\label{sec:org9b723ca}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge711cfe}
\begin{itemize}
\item AR, ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgb089842}
\begin{itemize}
...
\label{sec:org7538446}
\subsubsection{HHH Syndrome}
\label{sec:orgcf2f5c0}
\begin{itemize}
\item see section \ref{sec:org9702cbb}
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:orgf84b471}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd89bc98}
\begin{itemize}
...
\item Genetics
\label{sec:orgb051b9c}
\begin{itemize}
\item AR, SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:org2d2a099}
\begin{itemize}
...
\item Genetics
\label{sec:org348f4fd}
\begin{itemize}
\item AR, CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:orgbfb1337}
\begin{itemize}
...
\label{sec:org188ea4f}
\subsection{Introduction}
\label{sec:org4af0440}
\begin{itemize}
...
\caption{\label{fig:org94b0a5d}
Disorders of sulfur amino acid metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org7d9ab19}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org8b22988}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org063188c}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgdfdae5e}
\begin{itemize}
...
\label{sec:org7512e2f}
\subsubsection{Clinical Presentation}
\label{sec:orge5e05f5}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org1e447ea}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3fd7959}
\begin{itemize}
...
\label{sec:org07a5f6b}
\subsubsection{Clinical Presentation}
\label{sec:org747047d}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org779a546}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org9649e27}
\begin{itemize}
\item AR, SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org075757e}
\begin{itemize}
...
\label{sec:org10f1806}
\subsubsection{Clinical Presentation}
\label{sec:orga3589da}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org62564ac}
\begin{itemize}
\item AR, ETHE1, rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org764b90b}
\begin{itemize}
...
\label{sec:org9702cbb}
\subsection{Introduction}
\label{sec:orgb7a4dc2}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org5afc315}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgfdd4617}
\begin{itemize}
...
\label{sec:org870e4e0}
\begin{itemize}
\item \(\Delta\)1-Pyrroline-5-Carboxylate Synthetase Deficiency
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org080c723}
\begin{itemize}
\item central and peripheral neurological
\item see figure \ref{fig:org1cedf37} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:org61d01fb}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge3d1b0c}
\begin{itemize}
\item AR/AD, ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org9b8c512}
\begin{itemize}
...
\label{sec:org8ee8d16}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org9c3f829}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgd715176}
\begin{itemize}
\item AR, ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org644b1e9}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orge10a188}
\begin{itemize}
\item AR, PEPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org9ec4388}
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org4f14d86} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid and the
peroxisomal key enzyme, pipecolic acid oxidase (Figure \ref{fig:org4f14d86} enzyme 2)
\begin{itemize}
...
2-oxoglutarate dehydrogenase-like complex (Figure \ref{fig:org4f14d86} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org4f14d86} enzyme 6b)
...
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org4f14d86} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org4f14d86} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org4f14d86} enzyme 9)
...
(Figure \ref{fig:org4f14d86} enzyme 10)
...
\end{itemize}
\item or are neurotransmitters/ negative modulators
\begin{itemize}
...
\label{sec:org4a9b199}
\subsubsection{Clinical Presentation}
\label{sec:orged0015b}
\begin{description}
...
\label{sec:org53c02ea}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orge85ef39}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org5887943}
\begin{itemize}
\item AR, ASPAragine
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgf7560ac}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org6200548}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:org61b88b3}
\subsection{Introduction}
\label{sec:org9e24383}
\begin{itemize}
...
\caption{\label{fig:orga24f159}
Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:orgd23f9fb}
\subsubsection{Severe Classic NKH}
\label{sec:org5a07c3a}
\begin{itemize}
\item neonatal onset
...
\label{sec:orgf4cc144}
\subsection{Glutamine Metabolism}
\label{sec:orgc0b2053}
\begin{itemize}
...
\caption{\label{fig:org94aaadd}
Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org404f9e6}
\begin{itemize}
...
\section{Transport}
\label{sec:org56d1aca}
\subsection{Introduction}
\label{sec:orge6d7fed}
\begin{itemize}
...
\label{sec:org56f1649}
\subsubsection{Clinical Presentation}
\label{sec:orgc91a133}
\begin{itemize}
...
\label{sec:org9ad91c7}
\subsubsection{Clinical Presentation}
\label{sec:org6f16180}
\begin{itemize}
...
\label{sec:orgff3bfc0}
\subsubsection{Clinical Presentation}
\label{sec:orge8bb2c5}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org6eb3423}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgce0ff63}
\begin{itemize}
