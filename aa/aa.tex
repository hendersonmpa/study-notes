...
\label{sec:org31ec313}
\subsection{Introduction}
\label{sec:orgbe44baa}
\begin{itemize}
...
\label{sec:org05d42d9}
\begin{enumerate}
\item Diet
\label{sec:orgad98c31}
\begin{itemize}
...
\label{sec:org100b75c}
\subsubsection{Clinical Presentation}
\label{sec:orgb29fd4f}
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org28f49c3}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figure \ref{fig:org184b724})
...
\begin{table}[htbp]
\caption{\label{tab:org6538d41}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{orgd76788b}} & primapterin\textsuperscript{\ref{orgd76788b}} & CSF 5HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgd76788b}blood or urine}

\subsubsection{Treatment}
\label{sec:org0fd960a}
\begin{itemize}
\item BH\(_{\text{4}}\)
...
\section{Tyrosine}
\label{sec:orgf673be0}
\subsection{Introduction}
\label{sec:orge5c63ee}
...
\label{sec:orga113626}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org55f7d3e}
\begin{itemize}
...
\label{sec:orgb588515}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgad71c07}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgf86d397}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org9be844e}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org229ed6f}
\begin{itemize}
\item AR, HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orga281ba1}
\begin{itemize}
...
\label{sec:orgf1b9374}
\subsubsection{Clinical Presentation}
\label{sec:orgf67df52}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgb09b399}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org33e963c}
\begin{itemize}
...
\label{sec:org50d5d13}
\subsubsection{Clinical Presentation}
\label{sec:orgd986060}
\begin{itemize}
...
\section{BCAA}
\label{sec:org201abba}
\subsection{Introduction}
\label{sec:orgd4266f3}
\begin{itemize}
...
\label{sec:orga230d9e}
\subsubsection{Clinical Presentation}
\label{sec:orgd6d4934}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:orgeee5167}
\begin{enumerate}
\item MSUD
\label{sec:org4f635a3}
\begin{itemize}
...
\begin{itemize}
\item \(\uparrow\) PA and PA derivatives (see \ref{sec:org5f41fad})
\end{itemize}
\end{itemize}

\item Secondary Effects Of Elevated Propionyl-CoA
\label{sec:org0e5751c}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4f249fd}
\begin{description}
\item[{MSUD}] AR, E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR, IVD
\item[{PA}] AR, PCCB
\item[{MMA}] AR, MUT or cobalamin system (Table \ref{tab:orga8f8779})
\begin{itemize}
...
MMADHC & cblD\\
\end{tabular}
\end{table}\footnotetext[2]{\label{org0d948d4}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org83b6af0}
\begin{itemize}
\item MSUD \(\to\) PAA
\begin{itemize}
\item alloisoleucine
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org7a154ac}
\begin{itemize}
\item AR, MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org2569fa8}
\begin{itemize}
\item \(\Uparrow\) 3-HIVA
...
\section{Urea Cycle}
\label{sec:org6587d59}
\subsection{Introduction}
\label{sec:org13755f9}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{./aa/urea/figures/Slide01.png}
\caption{\label{fig:orga4197b2}
Urea Cycle}
\end{figure}
...
\label{sec:org3535e3e}
\begin{enumerate}
\item Newborns
\label{sec:orgc9db05b}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org5250d9b}
\begin{itemize}
\item AR, ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org9d8ad7b}
\begin{itemize}
...
\label{sec:org542994d}
\subsubsection{HHH Syndrome}
\label{sec:org2f1f714}
\begin{itemize}
\item see section \ref{sec:orgf36ebbf}
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org8a89ac0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8a6dc14}
\begin{itemize}
...
\item Genetics
\label{sec:org07e839d}
-AR, SLC25A13

\item Diagnostic Tests
\label{sec:orgcf9eeeb}
\begin{itemize}
...
\item Genetics
\label{sec:org627f81b}
\begin{itemize}
\item AR, CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org074ba76}
\begin{itemize}
...
\label{sec:org9c1c337}
\subsection{Introduction}
\label{sec:org2d728cf}
\begin{itemize}
...
\caption{\label{fig:orgff1d5d5}
Disorders of sulfur amino acid metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:orgc2a3cd8}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org2b41194}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgd5e5e1b}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgb1e3e04}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org7d8805f}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3859744}
\begin{itemize}
...
\label{sec:org6f3537f}
\subsubsection{Clinical Presentation}
\label{sec:orgdacb46e}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgb7726e9}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgc2ad51c}
\begin{itemize}
\item AR, SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgde3f120}
\begin{itemize}
...
\label{sec:org0a214c2}
\subsubsection{Clinical Presentation}
\label{sec:org936df1d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org1160757}
\begin{itemize}
\item AR, ETHE1, rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgacf50e2}
\begin{itemize}
...
\label{sec:orgf36ebbf}
\subsection{Introduction}
\label{sec:orge735115}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org1e3578d}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org2c0a2b8}
\begin{itemize}
...
\label{sec:org7337112}
\begin{itemize}
\item \(\Delta\)1-Pyrroline-5-Carboxylate Synthetase Deficiency
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgbb271d2}
\begin{itemize}
\item central and peripheral neurological
\item see figure \ref{fig:orgcf55de4} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:org82ac57f}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org31c25a3}
\begin{itemize}
\item AR/AD, ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org8c8800c}
\begin{itemize}
...
\label{sec:org73aa270}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgca562c4}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org05745c1}
\begin{itemize}
\item AR, ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org61111e8}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orga066d55}
\begin{itemize}
\item AR, PEPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org23f809b}
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org09730da} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid and the
peroxisomal key enzyme, pipecolic acid oxidase (Figure \ref{fig:org09730da} enzyme 2)
\begin{itemize}
...
2-oxoglutarate dehydrogenase-like complex (Figure \ref{fig:org09730da} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org09730da} enzyme 6b)
...
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org09730da} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org09730da} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org09730da} enzyme 9)
...
(Figure \ref{fig:org09730da} enzyme 10)
...
\label{sec:org699ee12}
\subsubsection{Clinical Presentation}
\label{sec:org5d5438b}
\begin{description}
...
\label{sec:orgf5ce9f1}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgcafa26c}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4a53ac2}
\begin{itemize}
\item AR, ASPAragine
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgd0cac00}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org39f9ba2}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:org8686024}
\subsection{Introduction}
\label{sec:orgedd8bf7}
\begin{itemize}
...
\caption{\label{fig:org34a70d2}
Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org54c7195}
\subsubsection{Severe Classic NKH}
\label{sec:orgc698516}
\begin{itemize}
\item neonatal onset
...
\label{sec:orga17de89}
\subsection{Glutamine Metabolism}
\label{sec:orgf5237b8}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./figures/Slide06.png}
\caption{\label{fig:orgf4d1c69}
Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org1c2607f}
\begin{itemize}
...
\section{Transport}
\label{sec:org2830f84}
\subsection{Introduction}
\label{sec:org5ab11a7}
\begin{itemize}
...
\label{sec:org221aa26}
\subsubsection{Clinical Presentation}
\label{sec:orgbe0d64e}
\begin{itemize}
...
\label{sec:org8d6c9b3}
\subsubsection{Clinical Presentation}
\label{sec:org5b4d4c7}
\begin{itemize}
...
\label{sec:orgde1b007}
\subsubsection{Clinical Presentation}
\label{sec:org8229e8e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb9e5819}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org8e3d0d5}
\begin{itemize}
