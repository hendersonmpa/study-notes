...
\label{sec:org60dc994}
\subsection{Introduction}
\label{sec:orgacbf262}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org507ac02}mild hyperphenylalaninaemia

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./phe/figures/pah.png}
\caption{\label{fig:org5ac02b3}
...
\label{sec:org5a8fdce}
\begin{enumerate}
\item Diet
\label{sec:org9a6b10d}
\begin{itemize}
...
treatment of responsive\textsuperscript{\ref{org507ac02}} patients with HPA and PKU, of all
ages \textsuperscript{\ref{org507ac02}}defined as reduction of \(\ge\)30\% in blood phenylalanine
after a single dose
\end{itemize}
\item Alternative/Experimental
\label{sec:org335a623}
\begin{itemize}
...
\label{sec:org44d6fda}
\subsubsection{Clinical Presentation}
\label{sec:orga95f6d4}
\begin{itemize}
...
\label{sec:orgd185ac4}
\begin{itemize}
\item disorders of BH\(_{\text{4}}\) associated with HPA and biogenic amine deficiency (Figure \ref{fig:org3446f3d})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org4ede030}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:org5ac02b3}
and \ref{fig:org3446f3d})
...
\subsubsection{Diagnostic Tests}
\label{sec:org9d9bfd3}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:org9c613bb})
...
\begin{table}[htbp]
\caption{\label{tab:org9c613bb}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org5fa9cb5}} & primapterin\textsuperscript{\ref{org5fa9cb5}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org5fa9cb5}blood or urine}

\subsubsection{Treatment}
\label{sec:org7703bbe}
\begin{itemize}
\item BH\(_{\text{4}}\)
...
\section{Tyrosine}
\label{sec:org5379518}
\subsection{Introduction}
\label{sec:org772b737}
\begin{itemize}
...
\label{sec:org595f9c9}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org7d0b910}
\begin{itemize}
...
\label{sec:orga817318}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org6bf141f}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0e6e385}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3daa2b5}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org6ceab2b}
\begin{itemize}
\item AR, HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgfe1a494}
\begin{itemize}
...
\label{sec:org2ad246a}
\subsubsection{Clinical Presentation}
\label{sec:org82550d1}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org3dc4e4a}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orga3fc77d}
\begin{itemize}
...
\label{sec:org0e2e6b0}
\subsubsection{Clinical Presentation}
\label{sec:org698508d}
\begin{itemize}
...
\section{BCAA}
\label{sec:org2e23c9f}
\subsection{Introduction}
\label{sec:org32c5448}
\begin{itemize}
...
\label{sec:orgfca921b}
\subsubsection{Clinical Presentation}
\label{sec:orga41381c}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org82eda85}
\begin{enumerate}
\item MSUD
\label{sec:org8ec7e4d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga7009ef}
\begin{description}
\item[{MSUD}] AR, E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR, IVD
\item[{PA}] AR, PCCB
\item[{MMA}] AR, MUT or cobalamin system (Table \ref{tab:org26d3d1f})
\begin{itemize}
...
MMADHC & cblD\\
\end{tabular}
\end{table}\footnotetext[3]{\label{orge3e8bec}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:orgba76ccd}
\begin{enumerate}
\item MSUD
\label{sec:org4a6439d}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org204b661}
\begin{itemize}
\item AR, MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org909d7f7}
\begin{itemize}
...
\section{Urea Cycle}
\label{sec:org2810450}
\subsection{Introduction}
\label{sec:orgb09b848}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org1e28dee}
\begin{enumerate}
\item Newborns
\label{sec:orgd9851f9}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgeb7f22e}
\begin{itemize}
\item AR, ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgb131016}
\begin{itemize}
...
\label{sec:orga920fbd}
\subsubsection{HHH Syndrome}
\label{sec:org74c8124}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:org6783663})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org711ac88}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge729595}
\begin{itemize}
...
\item Genetics
\label{sec:org63c7f22}
\begin{itemize}
\item AR, SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:org567711b}
\begin{itemize}
...
\item Genetics
\label{sec:org2db453a}
\begin{itemize}
\item AR, CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:orgfe6fc48}
\begin{itemize}
...
\label{sec:org36d8dff}
\subsection{Introduction}
\label{sec:orge3cb342}
\begin{itemize}
...
\caption{\label{fig:org87e1a8b}
Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:orga665ca0}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgff2e51f}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org2ee098c}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgf152829}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org724063a}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org8ac0715}
\begin{itemize}
...
\label{sec:org805dcf4}
\subsubsection{Clinical Presentation}
\label{sec:org75ac24a}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org94cd6ce}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org3d65d25}
\begin{itemize}
\item AR, SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org22575f6}
\begin{itemize}
...
\label{sec:org227fc35}
\subsubsection{Clinical Presentation}
\label{sec:org64de0b0}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org7f5ad44}
\begin{itemize}
\item AR, ETHE1, rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org8604fed}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:org6783663}
\subsection{Introduction}
\label{sec:org5ecc7aa}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org079eca6}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org9f02c62}
\begin{itemize}
...
\item see figure \ref{fig:org723c81b} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:org85f8924}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgcc50f74}
\begin{itemize}
\item AR/AD, ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org97e6a74}
\begin{itemize}
...
\label{sec:org68bc465}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org0f28f6a}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgbf5f165}
\begin{itemize}
\item AR, ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org0b4d9ee}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org8aa3ad0} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:org8aa3ad0} enzyme 2)
\begin{itemize}
...
2-oxoglutarate dehydrogenase-like complex (Figure \ref{fig:org8aa3ad0} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org8aa3ad0} enzyme 6b)
...
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org8aa3ad0} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org8aa3ad0} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org8aa3ad0} enzyme 9)
...
(Figure \ref{fig:org8aa3ad0} enzyme 10)
...
\label{sec:org5d09ced}
\subsubsection{Clinical Presentation}
\label{sec:org2dbcc91}
\begin{description}
...
\label{sec:orgd1c5118}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgbc6faec}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgc5fc265}
\begin{itemize}
\item AR, ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org08cb4da}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgda25d68}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:org74c6645}
\subsection{Introduction}
\label{sec:org36c083e}
\begin{itemize}
...
\caption{\label{fig:org7027460}
Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:orgd12e52f}
\subsubsection{Severe Classic NKH}
\label{sec:org00f5c12}
\begin{itemize}
\item neonatal onset
...
\label{sec:orgc3a4dcb}
\subsection{Glutamine Metabolism}
\label{sec:orgb950ecf}
\begin{itemize}
...
\caption{\label{fig:org98be244}
Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org9c89c3e}
\begin{itemize}
...
\section{Transport}
\label{sec:org2997019}
\subsection{Introduction}
\label{sec:orge9d4c40}
\begin{itemize}
...
\label{sec:org5e1d091}
\subsubsection{Clinical Presentation}
\label{sec:org26ab757}
\begin{itemize}
...
\label{sec:org9e5f47d}
\subsubsection{Clinical Presentation}
\label{sec:orgf8b363f}
\begin{itemize}
...
\label{sec:org788524c}
\subsubsection{Clinical Presentation}
\label{sec:orgf3524fb}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org5795aa1}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org062cbbc}
\begin{itemize}
