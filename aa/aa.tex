...
\caption{\label{fig:orgc04ea67}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:orga09a03b}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:org08120be}Tetrahydrobiopterin Metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:orgb3f6328}Phenylalaninemia Classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org929738a}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:org3a197a9}
\subsubsection{Clinical Presentation}
\label{sec:org5072064}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org99d800f}blood or urine}

\subsubsection{Treatment}
\label{sec:orgfbd9129}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:org4c7c18d}
\subsection{Introduction}
\label{sec:org147433c}
\begin{itemize}
...
\caption{\label{fig:orge024840}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:org0bc27b6}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:org8607d3f}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org93ad969}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:orgd11d1fb}
\begin{enumerate}
\item MSUD
\label{sec:orgc3f5c52}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org870db4d}deficiency of CblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:orgb0e6811}
\begin{enumerate}
\item MSUD
\label{sec:orge100d0d}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org0afff46}
\begin{itemize}
\item AR MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org1878490}
\begin{itemize}
\item \(\Uparrow\) 3-hydroxyisovaleric
...
\caption{\label{fig:orge71b885}Urea Cycle}
\end{figure}
...
\caption{\label{fig:orgaa0d098}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org0c434d3}Diagnostic Algorithm that can be Applied to any Hyperammonaemic Patient}
\end{figure}

\subsection{Mitochondrial UCDs}
\label{sec:orgf2b2a1c}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orgc21b7a0}
\begin{enumerate}
\item Newborns
\label{sec:orgcdebec3}
\begin{itemize}
...
\item Genetics
\label{sec:orgc4a722d}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org5c8d571}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:org946a803}
\subsection{Introduction}
\label{sec:orgb5ce6f9}
...
\caption{\label{fig:org91e134c}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:org4903396}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:org6e761eb}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org6d0be3b}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org68c15fb}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org576e88a}
\begin{itemize}
\item AR MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgd91cbe0}
\begin{itemize}
...
\label{sec:org2640b38}
\subsubsection{Clinical Presentation}
\label{sec:org3d7775a}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgf97c004}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org9cd4c1c}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7e274bd}
\begin{itemize}
...
\label{sec:orgf6c4fb4}
\subsubsection{Clinical Presentation}
\label{sec:orge0570c8}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org97cfc54}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org5f0591d}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:orgeb45088}
\subsection{Introduction}
\label{sec:orge06f283}
\subsubsection{Ornitine}
\label{sec:org142cff8}
\begin{itemize}
...
\caption{\label{fig:org7042ea0}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:org551247e}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:orgc058df7}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:org58dfb7c}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org0e42e3f}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge5d6c0b}
\begin{itemize}
\item AR OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgc66bdfc}
\begin{itemize}
...
\label{sec:org5f7a477}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org5769f9c}
\begin{itemize}
...
\label{sec:org8fe08aa}
\begin{itemize}
\item Hyperprolinaemia Type II
\end{itemize}

\subsubsection{Clinical Presentation}
\label{sec:orgc060f1b}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org3f9d697}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org8e621c6}
\begin{itemize}
...
\label{sec:org0ac232f}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org3e56f9e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org881b84d}
\begin{itemize}
\item AR ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org2e7852b}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org2024145}
\begin{itemize}
\item none
\end{itemize}

\section{Non-Ketotic Hyperglycinemia}
\label{sec:org4bab55c}
\subsection{Introduction}
\label{sec:org3942881}
\begin{itemize}
...
\caption{\label{fig:org2234547}Glycine Cleavage System}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:org39f3645}Activation of Lipoate Dependant Enzymes}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:orgc768158}
\subsubsection{Severe Classic NKH}
\label{sec:orgf30157a}
\begin{itemize}
\item neonatal onset
...
\label{sec:org32d0c21}
\subsection{Glutamine Metabolism}
\label{sec:org65433e1}
\begin{itemize}
...
\caption{\label{fig:orgdc4c4da}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orga9e59d6}
\begin{itemize}
...
\label{sec:org8723d40}
\subsubsection{Clinical Presentation}
\label{sec:org5329a5e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgad19f49}
\begin{itemize}
\item AR SLC7A7
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgd4706be}
\begin{itemize}
...
\label{sec:org31e2dc3}
\subsubsection{Clinical Presentation}
\label{sec:orgbef60d5}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org7fdb764}
\begin{itemize}
\item AR SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orga0f55ae}
\begin{itemize}
