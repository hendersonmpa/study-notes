...
\label{sec:org6bc3277}
\subsection{Introduction}
\label{sec:org78cd9fe}
\begin{itemize}
...
\caption{\label{fig:orgce7434a}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:org7b22db1}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:org9702ac6}Tetrahydrobiopterin Metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org71e4b24}Phenylalaninemia Classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgc5079f7}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:org39db5fb}
\subsubsection{Clinical Presentation}
\label{sec:orgdac7ea5}
\begin{itemize}
...
\label{sec:orgbffca6e}
\begin{enumerate}
\item Diet
\label{sec:orgc79ec3f}
\begin{itemize}
...
\label{sec:org1eb1ef2}
\subsubsection{Clinical Presentation}
\label{sec:org56d9e2d}
\begin{itemize}
...
\label{sec:orgcdab3b0}
\begin{itemize}
\item disorders of BH\textsubscript{4} metabolism associated with HPA and biogenic amine deficiency (Figure \ref{fig:org9702ac6})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orga910401}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:orgce7434a}
and \ref{fig:org9702ac6})
...
\subsubsection{Diagnostic Tests}
\label{sec:org3b16c63}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:orgbbe32d9})
...
\begin{table}[htbp]
\caption{\label{tab:orgbbe32d9}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org877384f}} & primapterin\textsuperscript{\ref{org877384f}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org877384f}blood or urine}

\subsubsection{Treatment}
\label{sec:orgbab8679}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:org805014b}
\subsection{Introduction}
\label{sec:org29c5dcb}
\begin{itemize}
...
\caption{\label{fig:org4b82574}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:org83b2c95}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:org4f1c485}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgaf43d1c}
\begin{itemize}
...
\label{sec:orgdc304b4}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org52b42a7}
\begin{itemize}
...
4-hydroxyphenyllactate and 4-hydroxyphenylacetate via AST (Figure \ref{fig:org4b82574})
\end{itemize}

\subsubsection{Genetics}
\label{sec:org646b745}
\begin{itemize}
\item AR TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orga84478e}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org8c59f99}
\begin{itemize}
\item AR HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org1923cb8}
\begin{itemize}
...
\label{sec:org8b1a95e}
\subsubsection{Clinical Presentation}
\label{sec:orgcb3a403}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org95eee32}
\begin{itemize}
\item AR HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org3154fc7}
\begin{itemize}
...
\section{BCAA}
\label{sec:orge37e100}
\subsection{Introduction}
\label{sec:org7ec38fe}
\begin{itemize}
...
\caption{\label{fig:orgae1c526}BCAA Catabolism}
\end{figure}
...
\label{sec:org032244a}
\subsubsection{Clinical Presentation}
\label{sec:orgfc1d267}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org3806b12}
\begin{description}
\item[{MSUD}] AR E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR IVD
\item[{PA}] AR PCCB \& PCCB
\item[{MMA}] AR MUT or cobalamin system (Table \ref{tab:orgd7dbccc})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgd7dbccc}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
Gene & Protein\\
\hline
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org2ddb9a1}deficiency of CblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org514c0b7}
\begin{enumerate}
\item MSUD
\label{sec:org7535a41}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org12bba81}
\begin{itemize}
\item AR MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org9d849df}
\begin{itemize}
\item \(\Uparrow\) 3-hydroxyisovaleric
...
\section{Urea Cycle}
\label{sec:org9df785f}
\subsection{Introduction}
\label{sec:org3788f67}
\begin{itemize}
...
\caption{\label{fig:org3158678}Urea Cycle}
\end{figure}
...
\caption{\label{fig:orge003a45}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org8dec9b7}Diagnostic Algorithm that can be Applied to any Hyperammonaemic Patient}
\end{figure}

\subsection{Mitochondrial UCDs}
\label{sec:orge231fb3}
\begin{itemize}
...
\caption{\label{fig:org5466254}Nitrogen Elimination by Phenylbutyrate and Benzoate}
\end{figure}

\item Prognosis
\label{sec:org5fe3124}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org9ca527d}
\begin{enumerate}
\item Newborns
\label{sec:org987ad2a}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org7b1be74}
\begin{itemize}
\item AR ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org75de5bb}
\begin{itemize}
...
\label{sec:org42b1ba5}
\subsubsection{HHH Syndrome}
\label{sec:orgb28b5c7}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:orgba0ba4d})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org8ba147b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5877961}
\begin{itemize}
...
\item Genetics
\label{sec:org351df26}
\begin{itemize}
\item AR SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:org59aad27}
\begin{itemize}
...
\item Genetics
\label{sec:orgd794184}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:orgef215d9}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:org4984a53}
\subsection{Introduction}
\label{sec:org3ff090d}
...
\caption{\label{fig:org15c8762}Cysteine and Cystine}
\end{figure}
...
kinase (ADK)
\item homocysteine has two metabolic pathways (Figure \ref{fig:org019ee74}):
\begin{enumerate}
...
\caption{\label{fig:org4842063}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:org019ee74}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:orgd246dea}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:orgdd13b09}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org5f304ff}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org3212a3d}
\begin{itemize}
\item AR MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org64a6cd9}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgce376dd}
\begin{itemize}
\item AR CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org4c841a0}
\begin{itemize}
...
\label{sec:org2f4649a}
\subsubsection{Clinical Presentation}
\label{sec:orgf13b91d}
\begin{itemize}
...
\label{sec:org193bd9e}
\subsubsection{Clinical Presentation}
\label{sec:org72ba95b}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org4313cc5}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org302caab}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org776a99a}
\begin{itemize}
...
\label{sec:orgca915c3}
\subsubsection{Clinical Presentation}
\label{sec:orgfcc1b97}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgab994bc}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org0f9c0e1}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:orgba0ba4d}
\subsection{Introduction}
\label{sec:org89382ab}
\subsubsection{Ornitine}
\label{sec:orgd600c88}
\begin{itemize}
...
\item defective in HHH syndrome (Section \ref{sec:orgb28b5c7})
\end{itemize}
...
\caption{\label{fig:org87708b1}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:orgd874026}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:orgb4110e2}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:orgc9f7f9f}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org966a9fa}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb6fe306}
\begin{itemize}
\item AR OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgff5eaa8}
\begin{itemize}
...
\label{sec:org728bdd8}
\begin{itemize}
\item Hypoprolinaemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orga606aa1}
\begin{itemize}
...
\item see figure \ref{fig:orgb4110e2} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:orgf096476}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org1a599d0}
\begin{itemize}
\item AR/AD ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org953f89c}
\begin{itemize}
...
\label{sec:orga2841c1}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgb1d0386}
\begin{itemize}
...
\label{sec:org03c1e75}
\begin{itemize}
\item Hyperprolinaemia Type II
\end{itemize}

\subsubsection{Clinical Presentation}
\label{sec:orgfadb8dc}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org799dffd}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgdc3fbac}
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org4ed2fd7} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:org4ed2fd7} enzyme 2)
\begin{itemize}
...
ketoglutarate dehydrogenase-like complex (Figure \ref{fig:org4ed2fd7} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org4ed2fd7} enzyme 6b)
\begin{itemize}
\item KGDH may serve as an alternative route
\item 2-oxoadipic acid is dehydrogenated and decarboxylated to
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org4ed2fd7} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org4ed2fd7} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org4ed2fd7} enzyme 9)
...
(Figure \ref{fig:org4ed2fd7} enzyme 10)
\end{itemize}
...
\caption{\label{fig:org4ed2fd7}Tryptophan, Hydroxylysine and Lysine Catabolic Pathways}
\end{figure}
...
\caption{\label{fig:orgb317dc1}Tryptophan and Lysine Catabolic Pathways}
\end{figure}

\subsection{Glutaric Aciduria Type I}
\label{sec:orgbc8d3d2}
\subsubsection{Clinical Presentation}
\label{sec:org3d5e899}
\begin{itemize}
...
\label{sec:org39c7845}
\subsubsection{Clinical Presentation}
\label{sec:org591ad8e}
\begin{description}
...
\label{sec:org096cfff}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org994b774}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4a33e1f}
\begin{itemize}
\item AR ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org315e2d5}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org06d8870}
\begin{itemize}
\item none
\end{itemize}

\section{Non-Ketotic Hyperglycinemia}
\label{sec:orgef50819}
\subsection{Introduction}
\label{sec:orga6f5f69}
\begin{itemize}
...
\caption{\label{fig:orga168ce3}Glycine Cleavage System}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:org32f609d}Activation of Lipoate Dependant Enzymes}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org46a8e28}
\subsubsection{Severe Classic NKH}
\label{sec:org433696a}
\begin{itemize}
\item neonatal onset
...
and BCKDH (Figure \ref{fig:org32f609d})
...
\label{sec:org650f291}
\subsection{Glutamine Metabolism}
\label{sec:org38d7a4f}
\begin{itemize}
...
\caption{\label{fig:org1c441da}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org7ce18ee}
\begin{itemize}
...
\section{Transport}
\label{sec:org18bd64a}
\subsection{Introduction}
\label{sec:org0b24013}
\begin{itemize}
...
\caption{\label{fig:org36275a3}Cystine}
\end{figure}

\subsubsection{Neutral  Amino Acids}
\label{sec:orgd3d9dd7}
\begin{itemize}
...
\caption{\label{fig:orgf671b16}Cationic and Neutral Amino Acid Transport in Epithelial Cells}
\end{figure}

\subsection{Cystinuria}
\label{sec:orgbf8a323}
\subsubsection{Clinical Presentation}
\label{sec:org4ff057d}
\begin{itemize}
...
\label{sec:org04447dd}
\subsubsection{Clinical Presentation}
\label{sec:org09523d0}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb692502}
\begin{itemize}
\item AR SLC7A7
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org2143d1c}
\begin{itemize}
...
\label{sec:org6aacc74}
\subsubsection{Clinical Presentation}
\label{sec:orgc3759c0}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org62bdbcd}
\begin{itemize}
\item AR SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org5652cf2}
\begin{itemize}
