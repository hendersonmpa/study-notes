...
\label{sec:org4f2e35e}
\subsection{Introduction}
\label{sec:orgbac1442}
\begin{itemize}
...
\label{sec:org559d7d0}
\begin{enumerate}
\item Diet
\label{sec:org962827a}
\begin{itemize}
...
\label{sec:org9583a01}
\subsubsection{Clinical Presentation}
\label{sec:org0405aff}
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgdf10f8d}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figure \ref{fig:org4bb8753})
...
\begin{table}[htbp]
\caption{\label{tab:org72aa087}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org2cdcec3}} & primapterin\textsuperscript{\ref{org2cdcec3}} & CSF 5HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org2cdcec3}blood or urine}

\subsubsection{Treatment}
\label{sec:org93203a2}
\begin{itemize}
\item BH\(_{\text{4}}\)
...
\section{Tyrosine}
\label{sec:orgbc9e52b}
\subsection{Introduction}
\label{sec:org399c93e}
...
\label{sec:org89aca01}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgbf16367}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgda16555}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org859a373}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgdf6ecab}
\begin{itemize}
\item AR, HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgafeadc3}
\begin{itemize}
...
\label{sec:org068d68d}
\subsubsection{Clinical Presentation}
\label{sec:org334e0ea}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org5848e07}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org4c81028}
\begin{itemize}
...
\label{sec:org1be5d13}
\subsubsection{Clinical Presentation}
\label{sec:org45346bf}
\begin{itemize}
...
\section{BCAA}
\label{sec:orgda5c35a}
\subsection{Introduction}
\label{sec:orgaa16efe}
\begin{itemize}
...
\label{sec:orgbe40e16}
\subsubsection{Clinical Presentation}
\label{sec:org65a3fa0}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org6e904b5}
\begin{enumerate}
\item MSUD
\label{sec:orge922d5e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org65275d5}
\begin{description}
\item[{MSUD}] AR, E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR, IVD
\item[{PA}] AR, PCCB
\item[{MMA}] AR, MUT or cobalamin system (Table \ref{tab:org6e5139e})
\begin{itemize}
...
MMADHC & cblD\\
\end{tabular}
\end{table}\footnotetext[2]{\label{orgc9caf42}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:orge803ddd}
\begin{enumerate}
\item MSUD
\label{sec:org0d7586f}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org6c3ca3e}
\begin{itemize}
\item AR, MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org48eb573}
\begin{itemize}
\item \(\Uparrow\) 3-HIVA
...
\section{Urea Cycle}
\label{sec:org5c293aa}
\subsection{Introduction}
\label{sec:org4d4aa15}
\begin{itemize}
...
\label{sec:org6e703bc}
\begin{enumerate}
\item Newborns
\label{sec:orgab96fd8}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge056c3e}
\begin{itemize}
\item AR, ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org053b739}
\begin{itemize}
...
\label{sec:orge94e23e}
\subsubsection{HHH Syndrome}
\label{sec:orge4eb8ba}
\begin{itemize}
\item see section \ref{sec:org2d291c4}
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org551ef0a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org32d1b2b}
\begin{itemize}
...
\item Genetics
\label{sec:orgbfdc246}
\begin{itemize}
\item AR, SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:org5f12e01}
\begin{itemize}
...
\item Genetics
\label{sec:org60975e4}
\begin{itemize}
\item AR, CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:orga8d2a78}
\begin{itemize}
...
\label{sec:orga680770}
\subsection{Introduction}
\label{sec:org31c4295}
\begin{itemize}
...
\caption{\label{fig:org7d7a82d}
Disorders of sulfur amino acid metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org213a7cb}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgec34579}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org44602ae}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org6cad4c4}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org968e229}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org52b835f}
\begin{itemize}
...
\label{sec:org0bdea50}
\subsubsection{Clinical Presentation}
\label{sec:org9b8fe26}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orga6ea2c7}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org93bf369}
\begin{itemize}
\item AR, SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgbd14dce}
\begin{itemize}
...
\label{sec:orge247a3d}
\subsubsection{Clinical Presentation}
\label{sec:org947d080}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0eb1bca}
\begin{itemize}
\item AR, ETHE1, rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org00d9f78}
\begin{itemize}
...
\label{sec:org2d291c4}
\subsection{Introduction}
\label{sec:org20b7933}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgf51c55f}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org038272e}
\begin{itemize}
...
\label{sec:org6f90e5f}
\begin{itemize}
\item \(\Delta\)1-Pyrroline-5-Carboxylate Synthetase Deficiency
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgfb66430}
\begin{itemize}
\item central and peripheral neurological
\item see figure \ref{fig:org0740852} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:org803e007}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgc68b411}
\begin{itemize}
\item AR/AD, ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org28f6fd6}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgfa0da26}
\begin{itemize}
\item AR, ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgaf627b0}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org8f98da6}
\begin{itemize}
\item AR, PEPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgd2652a1}
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org7b6ae9d} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid and the
peroxisomal key enzyme, pipecolic acid oxidase (Figure \ref{fig:org7b6ae9d} enzyme 2)
\begin{itemize}
...
2-oxoglutarate dehydrogenase-like complex (Figure \ref{fig:org7b6ae9d} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org7b6ae9d} enzyme 6b)
...
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org7b6ae9d} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org7b6ae9d} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org7b6ae9d} enzyme 9)
...
(Figure \ref{fig:org7b6ae9d} enzyme 10)
...
\label{sec:org12d58dd}
\subsubsection{Clinical Presentation}
\label{sec:org2f09a39}
\begin{description}
...
\label{sec:org965cbe8}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org5351804}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga05d846}
\begin{itemize}
\item AR, ASPAragine
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org944db09}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org28163d7}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:org3e3f419}
\subsection{Introduction}
\label{sec:orgd12026a}
\begin{itemize}
...
\caption{\label{fig:orgbc5ce9c}
Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org2a6e66e}
\subsubsection{Severe Classic NKH}
\label{sec:org1c9c7c1}
\begin{itemize}
\item neonatal onset
...
\label{sec:orgd76ea89}
\subsection{Glutamine Metabolism}
\label{sec:org4eb7e0b}
\begin{itemize}
...
\caption{\label{fig:orgc75dfd9}
Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org971770e}
\begin{itemize}
...
\section{Transport}
\label{sec:orgb69bcb9}
\subsection{Introduction}
\label{sec:org7f48823}
\begin{itemize}
...
\label{sec:orgf5b7bc8}
\subsubsection{Clinical Presentation}
\label{sec:org0813ff4}
\begin{itemize}
...
\label{sec:org7f6b762}
\subsubsection{Clinical Presentation}
\label{sec:org65f937f}
\begin{itemize}
...
\label{sec:org4a50fcb}
\subsubsection{Clinical Presentation}
\label{sec:org3af3ae6}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org343a854}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7fb3e30}
\begin{itemize}
