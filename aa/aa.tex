...
\label{sec:org6c5683e}
\subsection{Introduction}
\label{sec:orgf19f879}
\begin{itemize}
...
\caption{\label{fig:orgac7be5e}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:orgf828c2a}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:org9210621}Tetrahydrobiopterin Metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org0a275ee}Phenylalaninemia Classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orge70ac34}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:orgafe16ae}
\subsubsection{Clinical Presentation}
\label{sec:orga5a2eb6}
\begin{itemize}
...
\label{sec:org4889ba8}
\begin{enumerate}
\item Diet
\label{sec:org26ae92d}
\begin{itemize}
...
\label{sec:org1ceab1a}
\subsubsection{Clinical Presentation}
\label{sec:orgc30d15b}
\begin{itemize}
...
\label{sec:orgbd6f7c8}
\begin{itemize}
\item disorders of BH\textsubscript{4} metabolism associated with HPA and biogenic amine deficiency (Figure \ref{fig:org9210621})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orga54b785}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:orgac7be5e}
and \ref{fig:org9210621})
...
\subsubsection{Diagnostic Tests}
\label{sec:org3980fb1}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:orgc197df2})
...
\begin{table}[htbp]
\caption{\label{tab:orgc197df2}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org6d3a05d}} & primapterin\textsuperscript{\ref{org6d3a05d}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org6d3a05d}blood or urine}

\subsubsection{Treatment}
\label{sec:orgbd382d6}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:orgf5aafc3}
\subsection{Introduction}
\label{sec:org4b30cbe}
\begin{itemize}
...
\caption{\label{fig:org2507db3}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:orgeb367f4}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:org1504390}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org914bbfc}
\begin{itemize}
...
\label{sec:org408281d}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org92cd61e}
\begin{itemize}
...
4-hydroxyphenyllactate and 4-hydroxyphenylacetate via AST (Figure \ref{fig:org2507db3})
\end{itemize}

\subsubsection{Genetics}
\label{sec:org7b96a95}
\begin{itemize}
\item AR TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org06cde4f}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org4c52e87}
\begin{itemize}
\item AR HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org026e7c4}
\begin{itemize}
...
\label{sec:org7a8bb0f}
\subsubsection{Clinical Presentation}
\label{sec:org02290b4}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org41bb471}
\begin{itemize}
\item AR HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org8576d30}
\begin{itemize}
...
\label{sec:org89c57f7}
\subsubsection{Clinical Presentation}
\label{sec:orgfef8bbd}
\begin{itemize}
...
\section{BCAA}
\label{sec:org8aea7d1}
\subsection{Introduction}
\label{sec:org602811c}
\begin{itemize}
...
\caption{\label{fig:org20bbc0d}BCAA Catabolism}
\end{figure}
...
\label{sec:orgd248f64}
\subsubsection{Clinical Presentation}
\label{sec:org6641adb}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:orga4c241c}
\begin{enumerate}
\item MSUD
\label{sec:org0b579fc}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org05fd439}
\begin{description}
\item[{MSUD}] AR E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR IVD
\item[{PA}] AR PCCB \& PCCB
\item[{MMA}] AR MUT or cobalamin system (Table \ref{tab:org3626b49})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org3626b49}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
Gene & Protein\\
\hline
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org66f1695}deficiency of CblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org1e7e09c}
\begin{enumerate}
\item MSUD
\label{sec:orgbf4d26b}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org9c9004a}
\begin{itemize}
\item AR MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org1c33b82}
\begin{itemize}
\item \(\Uparrow\) 3-hydroxyisovaleric
...
\section{Urea Cycle}
\label{sec:org36555c1}
\subsection{Introduction}
\label{sec:org98c90a3}
\begin{itemize}
...
\caption{\label{fig:org95a63e8}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org0c67b46}Urea Cycle}
\end{figure}
...
\caption{\label{fig:orgc7d8c3a}Diagnostic Algorithm that can be Applied to any Hyperammonaemic Patient}
\end{figure}

\subsection{Mitochondrial UCDs}
\label{sec:orgfd83fda}
\begin{itemize}
...
\caption{\label{fig:org9c8e901}Nitrogen Elimination by Phenylbutyrate and Benzoate}
\end{figure}

\item Prognosis
\label{sec:org345daa8}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orgcf1eb3c}
\begin{enumerate}
\item Newborns
\label{sec:org6202cca}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org3ba5a45}
\begin{itemize}
\item AR ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgb7a09bd}
\begin{itemize}
...
\label{sec:orgf0cd769}
\subsubsection{HHH Syndrome}
\label{sec:org10b7605}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:orgc381ca3})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:orgd921ade}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgddf27eb}
\begin{itemize}
...
\item Genetics
\label{sec:org83540cd}
\begin{itemize}
\item AR SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:orgac3696e}
\begin{itemize}
...
\item Genetics
\label{sec:orgb0848be}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org10b4677}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:org0fc73cf}
\subsection{Introduction}
\label{sec:orgd0f42bb}
...
\caption{\label{fig:org0f7dee6}Cysteine and Cystine}
\end{figure}
...
kinase (ADK)
\item homocysteine has two metabolic pathways (Figure \ref{fig:org7e9aa4a}):
\begin{enumerate}
...
\caption{\label{fig:orgf483d70}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:org7e9aa4a}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:org4299678}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org8b3570f}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org7c968bf}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgf4c7e58}
\begin{itemize}
\item AR MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org8efa13a}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org8b016c9}
\begin{itemize}
\item AR CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org01b91d5}
\begin{itemize}
...
\label{sec:orgd41b6f3}
\subsubsection{Clinical Presentation}
\label{sec:orgf00ead3}
\begin{itemize}
...
\label{sec:org3d73fa1}
\subsubsection{Clinical Presentation}
\label{sec:orgb8b509b}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org97b1317}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org4be2dae}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org4e5a0a0}
\begin{itemize}
...
\label{sec:orgeaf8431}
\subsubsection{Clinical Presentation}
\label{sec:org135fecb}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0d7bae3}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org3ef626f}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:orgc381ca3}
\subsection{Introduction}
\label{sec:org0bfeea9}
\subsubsection{Ornitine}
\label{sec:orgcf0aa47}
\begin{itemize}
...
\item defective in HHH syndrome (Section \ref{sec:org10b7605})
\end{itemize}
...
\caption{\label{fig:orgdf56c4b}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:orgf0bdf6d}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:org3165b04}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:org0e75a69}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org6ff2f3c}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org95722a7}
\begin{itemize}
\item AR OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org748bdc3}
\begin{itemize}
...
\label{sec:org96fa9cf}
\begin{itemize}
\item Hypoprolinaemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org620eaf1}
\begin{itemize}
...
\item see figure \ref{fig:org3165b04} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:orgb9ca809}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgf7448f4}
\begin{itemize}
\item AR/AD ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgef1ac38}
\begin{itemize}
...
\label{sec:orgf4d74a7}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org93481e9}
\begin{itemize}
...
\label{sec:org859d238}
\begin{itemize}
\item Hyperprolinaemia Type II
\end{itemize}

\subsubsection{Clinical Presentation}
\label{sec:orga5c37f5}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org7a72b87}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orge8266f9}
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org460b914} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:org460b914} enzyme 2)
\begin{itemize}
...
ketoglutarate dehydrogenase-like complex (Figure \ref{fig:org460b914} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org460b914} enzyme 6b)
\begin{itemize}
\item KGDH may serve as an alternative route
\item 2-oxoadipic acid is dehydrogenated and decarboxylated to
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org460b914} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org460b914} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org460b914} enzyme 9)
...
(Figure \ref{fig:org460b914} enzyme 10)
\end{itemize}
...
\caption{\label{fig:org460b914}Tryptophan, Hydroxylysine and Lysine Catabolic Pathways}
\end{figure}
...
\caption{\label{fig:org7f12446}Tryptophan and Lysine Catabolic Pathways}
\end{figure}

\subsection{Glutaric Aciduria Type I}
\label{sec:org7135b1c}
\subsubsection{Clinical Presentation}
\label{sec:orgba0b307}
\begin{itemize}
...
\label{sec:orgf25de33}
\subsubsection{Clinical Presentation}
\label{sec:org8dd4bcc}
\begin{description}
...
\label{sec:org9ca8034}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org2dc3d59}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org5a217a4}
\begin{itemize}
\item AR ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org303b32f}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org59044b4}
\begin{itemize}
\item none
\end{itemize}

\section{Non-Ketotic Hyperglycinemia}
\label{sec:org3d26b93}
\subsection{Introduction}
\label{sec:org3969bfa}
\begin{itemize}
...
\caption{\label{fig:org7ee465a}Glycine Cleavage System}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:org9b0e16f}Activation of Lipoate Dependant Enzymes}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org316d154}
\subsubsection{Severe Classic NKH}
\label{sec:orga4cc359}
\begin{itemize}
\item neonatal onset
...
and BCKDH (Figure \ref{fig:org9b0e16f})
...
\label{sec:orgfb5b702}
\subsection{Glutamine Metabolism}
\label{sec:orgc34e5be}
\begin{itemize}
...
\caption{\label{fig:org8d11b93}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org10a8c53}
\begin{itemize}
...
\section{Transport}
\label{sec:orgefbe620}
\subsection{Introduction}
\label{sec:org07cf07f}
\begin{itemize}
...
\caption{\label{fig:orga620ed7}Cystine}
\end{figure}

\subsubsection{Neutral  Amino Acids}
\label{sec:org8b2a7ef}
\begin{itemize}
...
\caption{\label{fig:org1e10b21}Cationic and Neutral Amino Acid Transport in Epithelial Cells}
\end{figure}

\subsection{Cystinuria}
\label{sec:orgdff3ed4}
\subsubsection{Clinical Presentation}
\label{sec:org2493c5f}
\begin{itemize}
...
\label{sec:org98f75be}
\subsubsection{Clinical Presentation}
\label{sec:org5877917}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgbf2d0bb}
\begin{itemize}
\item AR SLC7A7
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org4b5b5bc}
\begin{itemize}
...
\label{sec:org4b8d6f5}
\subsubsection{Clinical Presentation}
\label{sec:org6a4f0e0}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org01b2b08}
\begin{itemize}
\item AR SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgf0e1842}
\begin{itemize}
