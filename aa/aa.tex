...
\label{sec:org20282a2}
\subsection{Introduction}
\label{sec:org2a54f4b}
\begin{itemize}
...
\caption{\label{fig:org3874688}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:orgc29970a}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:org8697f09}Tetrahydrobiopterin Metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org90832b2}Phenylalaninemia Classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgd46d20e}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:org8980bb7}
\subsubsection{Clinical Presentation}
\label{sec:org097ba43}
\begin{itemize}
...
\label{sec:org064d8e7}
\begin{enumerate}
\item Diet
\label{sec:org56402ca}
\begin{itemize}
...
\label{sec:orga0404a1}
\subsubsection{Clinical Presentation}
\label{sec:org8e18598}
\begin{itemize}
...
\label{sec:orgb8ee09b}
\begin{itemize}
\item disorders of BH\textsubscript{4} metabolism associated with HPA and biogenic amine deficiency (Figure \ref{fig:org8697f09})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org302bffa}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:org3874688}
and \ref{fig:org8697f09})
...
\subsubsection{Diagnostic Tests}
\label{sec:org863fe93}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:org3c7032a})
...
\begin{table}[htbp]
\caption{\label{tab:org3c7032a}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{orgfe80a99}} & primapterin\textsuperscript{\ref{orgfe80a99}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[3]{\label{orgfe80a99}blood or urine}

\subsubsection{Treatment}
\label{sec:orgcbcb25d}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:org744dbc2}
\subsection{Introduction}
\label{sec:org0124094}
\begin{itemize}
...
\caption{\label{fig:org0431cbc}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:orgdfa8c16}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:org7abb029}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org8110074}
\begin{itemize}
...
\label{sec:org91dfbdd}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org424b50c}
\begin{itemize}
...
4-hydroxyphenyllactate and 4-hydroxyphenylacetate via AST (Figure \ref{fig:org0431cbc})
\end{itemize}

\subsubsection{Genetics}
\label{sec:org6e8b0e0}
\begin{itemize}
\item AR TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org0cb5fb5}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgab5da11}
\begin{itemize}
\item AR HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org81d4f19}
\begin{itemize}
...
\label{sec:orgd42688d}
\subsubsection{Clinical Presentation}
\label{sec:orgcf277ca}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb51fe2f}
\begin{itemize}
\item AR HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org9c36894}
\begin{itemize}
...
\label{sec:org8ec0228}
\subsubsection{Clinical Presentation}
\label{sec:org8fe28e6}
\begin{itemize}
...
\section{BCAA}
\label{sec:org50fcb4c}
\subsection{Introduction}
\label{sec:orgfcdde27}
\begin{itemize}
...
\caption{\label{fig:org586a059}BCAA Catabolism}
\end{figure}
...
\label{sec:orge3d872c}
\subsubsection{Clinical Presentation}
\label{sec:org4f0eb9c}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org31b5185}
\begin{enumerate}
\item MSUD
\label{sec:orgdcad3ec}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgdd38008}
\begin{description}
\item[{MSUD}] AR E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR IVD
\item[{PA}] AR PCCB
\item[{MMA}] AR MUT or cobalamin system (Table \ref{tab:orgec193b9})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgec193b9}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
Gene & Protein\\
\hline
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org1308fb0}deficiency of CblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:orgdbbc6a7}
\begin{enumerate}
\item MSUD
\label{sec:org5a495f8}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgfcf88cf}
\begin{itemize}
\item AR MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org17fd537}
\begin{itemize}
\item \(\Uparrow\) 3-hydroxyisovaleric
...
\section{Urea Cycle}
\label{sec:org0893a5a}
\subsection{Introduction}
\label{sec:org58e2f9e}
\begin{itemize}
...
\caption{\label{fig:org8a292c9}Urea Cycle}
\end{figure}
...
\caption{\label{fig:orgb74a112}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org9d913fd}Diagnostic Algorithm that can be Applied to any Hyperammonaemic Patient}
\end{figure}

\subsection{Mitochondrial UCDs}
\label{sec:orgeb3a100}
\begin{itemize}
...
\caption{\label{fig:orgc0068c3}Nitrogen Elimination by Phenylbutyrate and Benzoate}
\end{figure}

\item Prognosis
\label{sec:org1724466}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orgde58abf}
\begin{enumerate}
\item Newborns
\label{sec:org0b6d79c}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org3b50218}
\begin{itemize}
\item AR ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgef81320}
\begin{itemize}
...
\label{sec:orgb059495}
\subsubsection{HHH Syndrome}
\label{sec:org5c11bc3}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:org76ef9b0})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org457dee0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf2bff9e}
\begin{itemize}
...
\item Genetics
\label{sec:org3487188}
\begin{itemize}
\item AR SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:orgcff601f}
\begin{itemize}
...
\item Genetics
\label{sec:orgd41526e}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org0f45001}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:org2ddfc2d}
\subsection{Introduction}
\label{sec:org5e401ba}
...
\caption{\label{fig:orgb51c24b}Cysteine and Cystine}
\end{figure}
...
kinase (ADK)
\item homocysteine has two metabolic pathways (Figure \ref{fig:orgd49218c}):
\begin{enumerate}
...
\caption{\label{fig:org4234553}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:orgd49218c}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:orgbb11497}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org3482c84}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org1f77a89}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orge0af1da}
\begin{itemize}
\item AR MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org479138e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgfa714a3}
\begin{itemize}
\item AR CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgd13ad8e}
\begin{itemize}
...
\label{sec:orgbc4ab0f}
\subsubsection{Clinical Presentation}
\label{sec:org0ac906d}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org23257c1}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgdf464b6}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org845db81}
\begin{itemize}
...
\label{sec:orgb9aacf9}
\subsubsection{Clinical Presentation}
\label{sec:org325c781}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgbf7087c}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org4a36bcb}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:org76ef9b0}
\subsection{Introduction}
\label{sec:org4d7f0e2}
\subsubsection{Ornitine}
\label{sec:org830f333}
\begin{itemize}
...
\item defective in HHH syndrome (Section \ref{sec:org5c11bc3})
\end{itemize}
...
\caption{\label{fig:org87734ab}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:orgc8a2fa7}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:orgc3168d2}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:orge5dedf7}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org6b8bcb4}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgee39bc0}
\begin{itemize}
\item AR OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org956450f}
\begin{itemize}
...
\label{sec:org21d4907}
\begin{itemize}
\item Hypoprolinaemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgbc1fa00}
\begin{itemize}
...
\item see figure \ref{fig:orgc3168d2} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:orgfa5ede6}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org03153a0}
\begin{itemize}
\item AR/AD ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org5aedaa1}
\begin{itemize}
...
\label{sec:org9f700c3}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org20201ef}
\begin{itemize}
...
\label{sec:orgebee0d1}
\begin{itemize}
\item Hyperprolinaemia Type II
\end{itemize}

\subsubsection{Clinical Presentation}
\label{sec:org21ff600}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org2a5a9ed}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org2afb8ec}
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org062cd4a} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:org062cd4a} enzyme 2)
\begin{itemize}
...
ketoglutarate dehydrogenase-like complex (Figure \ref{fig:org062cd4a} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org062cd4a} enzyme 6b)
\begin{itemize}
\item KGDH may serve as an alternative route
\item 2-oxoadipic acid is dehydrogenated and decarboxylated to
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org062cd4a} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org062cd4a} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org062cd4a} enzyme 9)
...
(Figure \ref{fig:org062cd4a} enzyme 10)
\end{itemize}
...
\caption{\label{fig:org062cd4a}Tryptophan, Hydroxylysine and Lysine Catabolic Pathways}
\end{figure}
...
\caption{\label{fig:org8d4184f}Tryptophan and Lysine Catabolic Pathways}
\end{figure}

\subsection{Glutaric Aciduria Type I}
\label{sec:orgfbdc8e0}
\subsubsection{Clinical Presentation}
\label{sec:orgb6cd4c8}
\begin{itemize}
...
\label{sec:orge064548}
\subsubsection{Clinical Presentation}
\label{sec:org7e91a86}
\begin{description}
...
\label{sec:org872f01a}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org40e185d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgdb93dc1}
\begin{itemize}
\item AR ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orge6400d1}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orge09590c}
\begin{itemize}
\item none
\end{itemize}

\section{Non-Ketotic Hyperglycinemia}
\label{sec:org849beae}
\subsection{Introduction}
\label{sec:orgc2df6e9}
\begin{itemize}
...
\caption{\label{fig:org81d3e4f}Glycine Cleavage System}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:org05ff73c}Activation of Lipoate Dependant Enzymes}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org689f58b}
\subsubsection{Severe Classic NKH}
\label{sec:org72f97e3}
\begin{itemize}
\item neonatal onset
...
and BCKDH (Figure \ref{fig:org05ff73c})
...
\label{sec:orgb1671ae}
\subsection{Glutamine Metabolism}
\label{sec:org0702668}
\begin{itemize}
...
\caption{\label{fig:org489b5bb}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org8324d2f}
\begin{itemize}
...
\section{Transport}
\label{sec:org95386fa}
\subsection{Introduction}
\label{sec:org5aafb7f}
\begin{itemize}
...
\caption{\label{fig:org572d877}Cystine}
\end{figure}

\subsubsection{Neutral  Amino Acids}
\label{sec:org2742cf8}
\begin{itemize}
...
\caption{\label{fig:org60e5ace}Cationic and Neutral Amino Acid Transport in Epithelial Cells}
\end{figure}

\subsection{Cystinuria}
\label{sec:org9ee38f3}
\subsubsection{Clinical Presentation}
\label{sec:org25c2f75}
\begin{itemize}
...
\label{sec:org481931a}
\subsubsection{Clinical Presentation}
\label{sec:orgc12e28c}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org42214f8}
\begin{itemize}
\item AR SLC7A7
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org557a408}
\begin{itemize}
...
\label{sec:org37272c7}
\subsubsection{Clinical Presentation}
\label{sec:org072552f}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0576ab1}
\begin{itemize}
\item AR SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org578e042}
\begin{itemize}
