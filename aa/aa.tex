...
\label{sec:org6061896}
\subsection{Introduction}
\label{sec:orgf219eb2}
\begin{itemize}
...
\caption{\label{fig:org4813ad0}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:org2b519fd}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:orgb4ebca1}Tetrahydrobiopterin metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:orgca90b9e}Phenylalaninemia classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org2060a2c}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:orgbd3f880}
\subsubsection{Clinical Presentation}
\label{sec:orgde5d052}
\begin{itemize}
...
\label{sec:org8a38a87}
\begin{enumerate}
\item Diet
\label{sec:orgab7a915}
\begin{itemize}
...
treatment of responsive\textsuperscript{\ref{org2060a2c}} patients with HPA and PKU, of all
ages
\end{itemize}
\item Alternative/Experimental
\label{sec:org1045ec1}
\begin{itemize}
...
\label{sec:org4e48914}
\subsubsection{Clinical Presentation}
\label{sec:orgaed9855}
\begin{itemize}
...
\label{sec:org70f1dc4}
\begin{itemize}
\item disorders of BH\textsubscript{4} metabolism associated with HPA and biogenic amine deficiency (Figure \ref{fig:orgb4ebca1})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgc016f16}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:org4813ad0}
and \ref{fig:orgb4ebca1})
...
\subsubsection{Diagnostic Tests}
\label{sec:org04722ff}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:orgfee3968})
...
\begin{table}[htbp]
\caption{\label{tab:orgfee3968}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{orgecfb1fa}} & primapterin\textsuperscript{\ref{orgecfb1fa}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{orgecfb1fa}blood or urine}

\subsubsection{Treatment}
\label{sec:org54d9e34}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:orgec3602e}
\subsection{Introduction}
\label{sec:orgeba2b56}
\begin{itemize}
...
\caption{\label{fig:orgd99f48e}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:org259f748}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:org73dd95e}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org5318d22}
\begin{itemize}
...
\label{sec:orgb91097f}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org80072bb}
\begin{itemize}
...
4-hydroxyphenyllactate and 4-hydroxyphenylacetate via AST (Figure \ref{fig:orgd99f48e})
\end{itemize}

\subsubsection{Genetics}
\label{sec:orgbaeedd3}
\begin{itemize}
\item AR TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org72d464d}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org00c123d}
\begin{itemize}
\item AR HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org222decc}
\begin{itemize}
...
\label{sec:org4c42ec0}
\subsubsection{Clinical Presentation}
\label{sec:orga7d776e}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org1572003}
\begin{itemize}
\item AR HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org0f52bf3}
\begin{itemize}
...
\label{sec:org2c4eaa3}
\subsubsection{Clinical Presentation}
\label{sec:org1e8208c}
\begin{itemize}
...
\section{BCAA}
\label{sec:orgf9989a6}
\subsection{Introduction}
\label{sec:org1be3856}
\begin{itemize}
...
\caption{\label{fig:org364c968}BCAA catabolism}
\end{figure}
...
\label{sec:org416691c}
\subsubsection{Clinical Presentation}
\label{sec:org62b471b}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org2afbd0a}
\begin{enumerate}
\item MSUD
\label{sec:org12993ee}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org90bdb80}
\begin{description}
\item[{MSUD}] AR E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR IVD
\item[{PA}] AR PCCB
\item[{MMA}] AR MUT or cobalamin system (Table \ref{tab:org936bf6c})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org936bf6c}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
Gene & Protein\\
\hline
...
\end{tabular}
\end{table}\footnotetext[4]{\label{org9e54520}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org1e50891}
\begin{enumerate}
\item MSUD
\label{sec:orgb009536}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org6477ca8}
\begin{itemize}
\item AR MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org87be24e}
\begin{itemize}
...
\section{Urea Cycle}
\label{sec:orgc3b1f8c}
\subsection{Introduction}
\label{sec:org9530f6a}
\begin{itemize}
...
\caption{\label{fig:org33a2b8f}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org191ce1e}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org1fe0513}Diagnostic algorithm that can be applied to any hyperammonaemic patient}
\end{figure}

\subsection{Mitochondrial}
\label{sec:org5428912}
\begin{itemize}
...
\caption{\label{fig:org71c3b4b}Nitrogen elimination by phenylbutyrate and benzoate}
\end{figure}

\item Prognosis
\label{sec:orgbb0fc97}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orgd96b756}
\begin{enumerate}
\item Newborns
\label{sec:orgefbd635}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org2b9087e}
\begin{itemize}
\item AR ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgc3e2dde}
\begin{itemize}
...
\label{sec:org9642742}
\subsubsection{HHH Syndrome}
\label{sec:org169cb05}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:org60cc015})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:orgce75cf0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org37bcd24}
\begin{itemize}
...
\item Genetics
\label{sec:org52887f6}
\begin{itemize}
\item AR SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:orgaaa28c2}
\begin{itemize}
...
\item Genetics
\label{sec:org345cfc3}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org8afc829}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:org0f898ec}
\subsection{Introduction}
\label{sec:org4a91a38}
...
\caption{\label{fig:org760249e}Cysteine vs Cystine}
\end{figure}
...
kinase (ADK)
\item homocysteine has two metabolic pathways (Figure \ref{fig:orgb3f739f}):
\begin{enumerate}
...
\caption{\label{fig:orgc9a8d89}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:orgb3f739f}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:org4065642}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:orgeeb3e48}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgca87872}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org23a4d3f}
\begin{itemize}
\item AR MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgd3d820c}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org7422ed6}
\begin{itemize}
\item AR CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org0ab303e}
\begin{itemize}
...
\label{sec:org8350231}
\subsubsection{Clinical Presentation}
\label{sec:org4c7be6d}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org7d50c6a}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org434715e}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org93280ba}
\begin{itemize}
...
\label{sec:org21a60a8}
\subsubsection{Clinical Presentation}
\label{sec:orgbca4e89}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org58eca13}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org4f3247c}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:org60cc015}
\subsection{Introduction}
\label{sec:org49dfdd2}
\begin{itemize}
...
\caption{\label{fig:orgaddb4f9}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:orga3d522d}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:org1395e30}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:orgb58cf06}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org7ea1177}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0381a1e}
\begin{itemize}
\item AR OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org24fd961}
\begin{itemize}
...
\item see figure \ref{fig:org1395e30} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:org7c6587d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org01f1e6d}
\begin{itemize}
\item AR/AD ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orged7e71d}
\begin{itemize}
...
\label{sec:org4cb7fc5}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgcf044ae}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgd4e496e}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3644971}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org4f57325} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:org4f57325} enzyme 2)
\begin{itemize}
...
ketoglutarate dehydrogenase-like complex (Figure \ref{fig:org4f57325} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org4f57325} enzyme 6b)
\begin{itemize}
\item KGDH may serve as an alternative route
\item 2-oxoadipic acid is dehydrogenated and decarboxylated to
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org4f57325} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org4f57325} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org4f57325} enzyme 9)
...
(Figure \ref{fig:org4f57325} enzyme 10)
...
\caption{\label{fig:org4f57325}Tryptophan, hydroxylysine and lysine catabolic pathways}
\end{figure}
...
\caption{\label{fig:orge11f6c5}Tryptophan and lysine catabolic pathways}
\end{figure}

\subsection{Glutaric Aciduria Type I}
\label{sec:orgc5d1435}
\subsubsection{Clinical Presentation}
\label{sec:org9016f51}
\begin{itemize}
...
\label{sec:org502bcc8}
\subsubsection{Clinical Presentation}
\label{sec:org58ff3b6}
\begin{description}
...
\label{sec:org4f32968}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgd49af6d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org69b6aed}
\begin{itemize}
\item AR ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orge12f11c}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org58aff5e}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:orgf1f6549}
\subsection{Introduction}
\label{sec:orgc4fa167}
\begin{itemize}
...
\caption{\label{fig:org8b6f2e6}Glycine cleavage enzyme}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:org5bed7f2}Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:orgb1481f6}
\subsubsection{Severe Classic NKH}
\label{sec:orga4c1dac}
\begin{itemize}
\item neonatal onset
...
\label{sec:org1c85a45}
\subsection{Glutamine Metabolism}
\label{sec:org29296fa}
\begin{itemize}
...
\caption{\label{fig:org8dc8a13}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orgf39bec3}
\begin{itemize}
...
\section{Transport}
\label{sec:org0546236}
\subsection{Introduction}
\label{sec:org2035a70}
\begin{itemize}
...
\caption{\label{fig:orgee3f92d}Cystine}
\end{figure}

\subsubsection{Neutral  Amino Acids}
\label{sec:org2706c27}
\begin{itemize}
...
\caption{\label{fig:orgc8acc38}Simplified schematic representation of cationic and neutral amino acid transport in epithelial cells}
\end{figure}

\subsection{Cystinuria}
\label{sec:orge55356f}
\subsubsection{Clinical Presentation}
\label{sec:orgcf7060f}
\begin{itemize}
...
\label{sec:org6bffe20}
\subsubsection{Clinical Presentation}
\label{sec:org54a29be}
\begin{itemize}
...
\label{sec:org67023ef}
\subsubsection{Clinical Presentation}
\label{sec:org1dab377}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgc9e285e}
\begin{itemize}
\item AR SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org5afd093}
\begin{itemize}
