...
\label{sec:org8d885b5}
\subsection{Introduction}
\label{sec:org181016d}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgbf8386c}mild hyperphenylalaninaemia

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./phe/figures/pah.png}
\caption{\label{fig:org8aff9cd}
...
\label{sec:org13743d8}
\begin{enumerate}
\item Diet
\label{sec:orgc5121e1}
\begin{itemize}
...
treatment of responsive\textsuperscript{\ref{orgbf8386c}} patients with HPA and PKU, of all
ages \textsuperscript{\ref{orgbf8386c}}defined as reduction of \(\ge\)30\% in blood phenylalanine
after a single dose
\end{itemize}
\item Alternative/Experimental
\label{sec:org8ca67b1}
\begin{itemize}
...
\label{sec:orgf76d130}
\subsubsection{Clinical Presentation}
\label{sec:org65a1a94}
\begin{itemize}
...
\label{sec:org230cc8c}
\begin{itemize}
\item disorders of BH\(_{\text{4}}\) associated with HPA and biogenic amine deficiency (Figure \ref{fig:org91ef432})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org56da78f}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:org8aff9cd}
and \ref{fig:org91ef432})
...
\subsubsection{Diagnostic Tests}
\label{sec:orgec27a07}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:orgeaa744a})
...
\begin{table}[htbp]
\caption{\label{tab:orgeaa744a}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{orgfb94b0a}} & primapterin\textsuperscript{\ref{orgfb94b0a}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{orgfb94b0a}blood or urine}

\subsubsection{Treatment}
\label{sec:org6121fcd}
\begin{itemize}
\item BH\(_{\text{4}}\)
...
\section{Tyrosine}
\label{sec:org7c50aa7}
\subsection{Introduction}
\label{sec:org0bfcf4a}
\begin{itemize}
...
\label{sec:org7422d76}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgd46f8c1}
\begin{itemize}
...
\label{sec:orgee71715}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org0333aaf}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga4cfdd7}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgbe6e5f8}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgce41588}
\begin{itemize}
\item AR, HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org12cd889}
\begin{itemize}
...
\label{sec:orgb101148}
\subsubsection{Clinical Presentation}
\label{sec:org432347d}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org8cb017e}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgc12a2c0}
\begin{itemize}
...
\label{sec:org909215f}
\subsubsection{Clinical Presentation}
\label{sec:org98b0712}
\begin{itemize}
...
\section{BCAA}
\label{sec:orgd2c155f}
\subsection{Introduction}
\label{sec:org698ae04}
\begin{itemize}
...
\label{sec:org9803015}
\subsubsection{Clinical Presentation}
\label{sec:org54d678c}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org09a88bd}
\begin{enumerate}
\item MSUD
\label{sec:org51b4c3e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org711bd6e}
\begin{description}
\item[{MSUD}] AR, E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR, IVD
\item[{PA}] AR, PCCB
\item[{MMA}] AR, MUT or cobalamin system (Table \ref{tab:org6b525aa})
\begin{itemize}
...
MMADHC & cblD\\
\end{tabular}
\end{table}\footnotetext[3]{\label{org41a8987}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:orgfdc66b3}
\begin{enumerate}
\item MSUD
\label{sec:org74c512b}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orge888f58}
\begin{itemize}
\item AR, MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgcd47e8f}
\begin{itemize}
...
\section{Urea Cycle}
\label{sec:orgada4a6a}
\subsection{Introduction}
\label{sec:orgb4d408e}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org071ad44}
\begin{enumerate}
\item Newborns
\label{sec:org8c0215f}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org24c8807}
\begin{itemize}
\item AR, ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgdd50ea2}
\begin{itemize}
...
\label{sec:org4172b6d}
\subsubsection{HHH Syndrome}
\label{sec:org0d99371}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:org062fb5f})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org70c2421}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org889cebf}
\begin{itemize}
...
\item Genetics
\label{sec:org494b579}
\begin{itemize}
\item AR, CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org5d2a53d}
\begin{itemize}
...
\label{sec:org53cef63}
\subsection{Introduction}
\label{sec:orgd4f437b}
\begin{itemize}
...
\caption{\label{fig:orgd1f9be0}
Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:orgfe0c6bf}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org8f406d1}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org5e6860e}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgb2ec170}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4546fa4}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orga1b14f1}
\begin{itemize}
...
\label{sec:orgebdee29}
\subsubsection{Clinical Presentation}
\label{sec:orgaa17e22}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgf23da7f}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org58b8357}
\begin{itemize}
\item AR, SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org88b98c7}
\begin{itemize}
...
\label{sec:orge728ef7}
\subsubsection{Clinical Presentation}
\label{sec:org4e2b5ad}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org08bbeed}
\begin{itemize}
\item AR, ETHE1, rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgb0057a3}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:org062fb5f}
\subsection{Introduction}
\label{sec:org2bf9b8c}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org8b9ce07}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org9ea71b7}
\begin{itemize}
...
\item see figure \ref{fig:org21786e8} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:orgad2ef1f}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org42128e9}
\begin{itemize}
\item AR/AD, ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgb254484}
\begin{itemize}
...
\label{sec:orge6e843d}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgbc6d9d5}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org24479fc}
\begin{itemize}
\item AR, ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org36ad931}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:orgd8c2c55} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:orgd8c2c55} enzyme 2)
\begin{itemize}
...
2-oxoglutarate dehydrogenase-like complex (Figure \ref{fig:orgd8c2c55} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:orgd8c2c55} enzyme 6b)
...
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:orgd8c2c55} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:orgd8c2c55} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:orgd8c2c55} enzyme 9)
...
(Figure \ref{fig:orgd8c2c55} enzyme 10)
...
\label{sec:org14c0169}
\subsubsection{Clinical Presentation}
\label{sec:orgf05f4fa}
\begin{description}
...
\label{sec:org0e05ab6}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org6fb5545}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org7fca575}
\begin{itemize}
\item AR, ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org864c72f}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org457c626}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:org6ebaba3}
\subsection{Introduction}
\label{sec:org1dac72b}
\begin{itemize}
...
\caption{\label{fig:org9f692fb}
Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org624b10b}
\subsubsection{Severe Classic NKH}
\label{sec:orgd0a1e92}
\begin{itemize}
\item neonatal onset
...
\label{sec:orgd8170b3}
\subsection{Glutamine Metabolism}
\label{sec:orga69c161}
\begin{itemize}
...
\caption{\label{fig:org84dd219}
Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org35f0a80}
\begin{itemize}
...
\section{Transport}
\label{sec:org1f40c4f}
\subsection{Introduction}
\label{sec:org398b4aa}
\begin{itemize}
...
\label{sec:org6c92987}
\subsubsection{Clinical Presentation}
\label{sec:orgc1699ff}
\begin{itemize}
...
\label{sec:org0e3a458}
\subsubsection{Clinical Presentation}
\label{sec:orgbe0d027}
\begin{itemize}
...
\label{sec:orgdbffc82}
\subsubsection{Clinical Presentation}
\label{sec:org3600532}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb9e8fd5}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org956039f}
\begin{itemize}
