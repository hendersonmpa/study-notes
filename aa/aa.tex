...
\caption{\label{fig:org65f34c9}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:org797235a}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:orgcdbd855}Tetrahydrobiopterin Metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org8f71544}Phenylalaninemia Classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org1bc7146}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:org80e56c0}
\subsubsection{Clinical Presentation}
\label{sec:orgdc8638f}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org361e3e3}blood or urine}

\subsubsection{Treatment}
\label{sec:orgde80a59}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:org8cf343c}
\subsection{Introduction}
\label{sec:org8219455}
\begin{itemize}
...
\caption{\label{fig:orgfd064f6}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:org3a023be}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:org3df7b73}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgbb940b1}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:orgad4121d}
\begin{enumerate}
\item MSUD
\label{sec:orgc12d597}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org56b3682}deficiency of CblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:orgf8d4d4a}
\begin{enumerate}
\item MSUD
\label{sec:orga7f95d2}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org342b766}
\begin{itemize}
\item AR MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgcf7401e}
\begin{itemize}
\item \(\Uparrow\) 3-hydroxyisovaleric
...
\caption{\label{fig:org79c8fb9}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org0eb145e}Urea Cycle}
\end{figure}
...
\caption{\label{fig:orgd8af494}Diagnostic Algorithm that can be Applied to any Hyperammonaemic Patient}
\end{figure}

\subsection{Mitochondrial UCDs}
\label{sec:org5ba2e81}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orgd002428}
\begin{enumerate}
\item Newborns
\label{sec:orgf82ae87}
\begin{itemize}
...
\item Genetics
\label{sec:org6bb7ca1}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:orgbab19f4}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:orgceca526}
\subsection{Introduction}
\label{sec:org0ac70ef}
...
\caption{\label{fig:orgc714b08}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:org3aeb3c1}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:org8f69397}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:orgdc50471}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orga169961}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgd38ef06}
\begin{itemize}
\item AR MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org939e5f0}
\begin{itemize}
...
\label{sec:orgea27186}
\subsubsection{Clinical Presentation}
\label{sec:orgc8a4faf}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org3844c5d}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgb2d00d5}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org66cc693}
\begin{itemize}
...
\label{sec:org506ea76}
\subsubsection{Clinical Presentation}
\label{sec:org7a9ff9f}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org796fdfe}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org31a7aec}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:org7812042}
\subsection{Introduction}
\label{sec:org0b40672}
\subsubsection{Ornitine}
\label{sec:orge6fb869}
\begin{itemize}
...
\caption{\label{fig:orgc609ecf}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:org7b9b23b}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:org98bfaa1}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:orge692e85}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orga31dbce}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org9f6f910}
\begin{itemize}
\item AR OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org4a472eb}
\begin{itemize}
...
\label{sec:orgd6f9491}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org08473ca}
\begin{itemize}
...
\label{sec:orgcd0cc21}
\begin{itemize}
\item Hyperprolinaemia Type II
\end{itemize}

\subsubsection{Clinical Presentation}
\label{sec:orgcb57002}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org5b82643}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org6ed7e2c}
\begin{itemize}
...
\label{sec:orge69eb1b}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org8542325}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgfd1ddf5}
\begin{itemize}
\item AR ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org1fb7e85}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org91c2f02}
\begin{itemize}
\item none
\end{itemize}

\section{Non-Ketotic Hyperglycinemia}
\label{sec:org1bc2083}
\subsection{Introduction}
\label{sec:orgb9fb3bf}
\begin{itemize}
...
\caption{\label{fig:org0d51f14}Glycine Cleavage System}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:orgde68ec5}Activation of Lipoate Dependant Enzymes}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:orga53fdb2}
\subsubsection{Severe Classic NKH}
\label{sec:org02dfcf6}
\begin{itemize}
\item neonatal onset
...
\label{sec:orgaa08618}
\subsection{Glutamine Metabolism}
\label{sec:org149dd63}
\begin{itemize}
...
\caption{\label{fig:orgdb12942}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orgc25817e}
\begin{itemize}
...
\label{sec:org49a3c94}
\subsubsection{Clinical Presentation}
\label{sec:orgafd8b2a}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge87881d}
\begin{itemize}
\item AR SLC7A7
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgb90c030}
\begin{itemize}
...
\label{sec:orgd4d6325}
\subsubsection{Clinical Presentation}
\label{sec:org2f14077}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb021907}
\begin{itemize}
\item AR SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org33def1d}
\begin{itemize}
