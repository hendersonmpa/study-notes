...
\label{sec:org5781f98}
\subsection{Introduction}
\label{sec:org8ea9c38}
\begin{itemize}
...
\caption{\label{fig:org456b05e}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:org4a46628}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:orged23a57}Tetrahydrobiopterin Metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org6f32844}Phenylalaninemia Classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org05564b5}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:org24617b9}
\subsubsection{Clinical Presentation}
\label{sec:org03b054a}
\begin{itemize}
...
\label{sec:orga6ec717}
\begin{enumerate}
\item Diet
\label{sec:org3d3f42f}
\begin{itemize}
...
\label{sec:orgf2e5aff}
\subsubsection{Clinical Presentation}
\label{sec:org60fc7bf}
\begin{itemize}
...
\label{sec:org7a95b7a}
\begin{itemize}
\item disorders of BH\textsubscript{4} metabolism associated with HPA and biogenic amine deficiency (Figure \ref{fig:orged23a57})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org9cebb64}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:org456b05e}
and \ref{fig:orged23a57})
...
\subsubsection{Diagnostic Tests}
\label{sec:orge916f30}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:orgac10800})
...
\begin{table}[htbp]
\caption{\label{tab:orgac10800}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org5eed552}} & primapterin\textsuperscript{\ref{org5eed552}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org5eed552}blood or urine}

\subsubsection{Treatment}
\label{sec:org4da2ff4}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:org9ba7845}
\subsection{Introduction}
\label{sec:org6f17fba}
\begin{itemize}
...
\caption{\label{fig:org28be1ad}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:org831032d}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:org9527027}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org1d2207c}
\begin{itemize}
...
\label{sec:org77a1b1e}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgbfd30d8}
\begin{itemize}
...
4-hydroxyphenyllactate and 4-hydroxyphenylacetate via AST (Figure \ref{fig:org28be1ad})
\end{itemize}

\subsubsection{Genetics}
\label{sec:org4bf0563}
\begin{itemize}
\item AR TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org1ac67a1}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org39942f8}
\begin{itemize}
\item AR HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgbd3127e}
\begin{itemize}
...
\label{sec:org5cd0b36}
\subsubsection{Clinical Presentation}
\label{sec:org66bc8f9}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0c2e69c}
\begin{itemize}
\item AR HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org14bad1b}
\begin{itemize}
...
\label{sec:org45f46dc}
\subsubsection{Clinical Presentation}
\label{sec:orgd607acf}
\begin{itemize}
...
\section{BCAA}
\label{sec:org805e466}
\subsection{Introduction}
\label{sec:orgb756268}
\begin{itemize}
...
\caption{\label{fig:org82bcad0}BCAA Catabolism}
\end{figure}
...
\label{sec:org34c28a9}
\subsubsection{Clinical Presentation}
\label{sec:org91ee823}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org4b6ea9c}
\begin{enumerate}
\item MSUD
\label{sec:org2f2f011}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org664dba8}
\begin{description}
\item[{MSUD}] AR E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR IVD
\item[{PA}] AR PCCB \& PCCB
\item[{MMA}] AR MUT or cobalamin system (Table \ref{tab:org9c1d98f})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org9c1d98f}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
Gene & Protein\\
\hline
...
\end{tabular}
\end{table}\footnotetext[5]{\label{orgb111d9d}deficiency of CblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:orga4e892e}
\begin{enumerate}
\item MSUD
\label{sec:org541788d}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgaebc283}
\begin{itemize}
\item AR MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgd2733b5}
\begin{itemize}
\item \(\Uparrow\) 3-hydroxyisovaleric
...
\section{Urea Cycle}
\label{sec:org054a13a}
\subsection{Introduction}
\label{sec:orgd36506c}
\begin{itemize}
...
\caption{\label{fig:org7c95d5e}Urea Cycle}
\end{figure}
...
\caption{\label{fig:orgd598392}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org457a011}Diagnostic Algorithm that can be Applied to any Hyperammonaemic Patient}
\end{figure}

\subsection{Mitochondrial UCDs}
\label{sec:orgd99b3b2}
\begin{itemize}
...
\caption{\label{fig:org35491de}Nitrogen Elimination by Phenylbutyrate and Benzoate}
\end{figure}

\item Prognosis
\label{sec:org2ce848d}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orgdbb9984}
\begin{enumerate}
\item Newborns
\label{sec:org80d65ba}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org26d9df7}
\begin{itemize}
\item AR ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7fa05ec}
\begin{itemize}
...
\label{sec:org3a45824}
\subsubsection{HHH Syndrome}
\label{sec:orgfc6ca20}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:orgf6e525d})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org3bf0a2b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5de1d99}
\begin{itemize}
...
\item Genetics
\label{sec:org9724560}
\begin{itemize}
\item AR SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd8f2f2c}
\begin{itemize}
...
\item Genetics
\label{sec:org23ed258}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org3aad6d8}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:orgc9699f9}
\subsection{Introduction}
\label{sec:orgd6d03e8}
...
\caption{\label{fig:orgab165dd}Cysteine and Cystine}
\end{figure}
...
kinase (ADK)
\item homocysteine has two metabolic pathways (Figure \ref{fig:org0d3a465}):
\begin{enumerate}
...
\caption{\label{fig:orge78290a}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:org0d3a465}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:orgcf17cf0}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org6bea810}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org804c457}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org2a82a75}
\begin{itemize}
\item AR MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org292fbe7}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgd2872cc}
\begin{itemize}
\item AR CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7e1958c}
\begin{itemize}
...
\label{sec:org118961a}
\subsubsection{Clinical Presentation}
\label{sec:org9b953f6}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org56686b3}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgfca3d6c}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgff79e37}
\begin{itemize}
...
\label{sec:org3789828}
\subsubsection{Clinical Presentation}
\label{sec:orgb365066}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4ddd5a1}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orga770bb2}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:orgf6e525d}
\subsection{Introduction}
\label{sec:org299858e}
\subsubsection{Ornitine}
\label{sec:orgc8ac249}
\begin{itemize}
...
\item defective in HHH syndrome (Section \ref{sec:orgfc6ca20})
\end{itemize}
...
\caption{\label{fig:org8747270}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:orgee3ea94}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:orgcc40fd3}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:orgff31286}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgb6a745a}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge55417c}
\begin{itemize}
\item AR OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org17380b1}
\begin{itemize}
...
\label{sec:org7868ae0}
\begin{itemize}
\item Hypoprolinaemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgf873aa4}
\begin{itemize}
...
\item see figure \ref{fig:orgcc40fd3} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:org9a9596b}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgc092672}
\begin{itemize}
\item AR/AD ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org049efde}
\begin{itemize}
...
\label{sec:orgc136327}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgc3d37c7}
\begin{itemize}
...
\label{sec:orge84ae1c}
\begin{itemize}
\item Hyperprolinaemia Type II
\end{itemize}

\subsubsection{Clinical Presentation}
\label{sec:org04f8095}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4ddb9f3}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org5a38b2f}
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org65dc67d} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:org65dc67d} enzyme 2)
\begin{itemize}
...
ketoglutarate dehydrogenase-like complex (Figure \ref{fig:org65dc67d} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org65dc67d} enzyme 6b)
\begin{itemize}
\item KGDH may serve as an alternative route
\item 2-oxoadipic acid is dehydrogenated and decarboxylated to
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org65dc67d} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org65dc67d} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org65dc67d} enzyme 9)
...
(Figure \ref{fig:org65dc67d} enzyme 10)
\end{itemize}
...
\caption{\label{fig:org65dc67d}Tryptophan, Hydroxylysine and Lysine Catabolic Pathways}
\end{figure}
...
\caption{\label{fig:orga343ea2}Tryptophan and Lysine Catabolic Pathways}
\end{figure}

\subsection{Glutaric Aciduria Type I}
\label{sec:org68e83e3}
\subsubsection{Clinical Presentation}
\label{sec:org84fabbe}
\begin{itemize}
...
\label{sec:org3b7a924}
\subsubsection{Clinical Presentation}
\label{sec:org51cfdc2}
\begin{description}
...
\label{sec:orgb4f0f17}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org70444ae}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org7db3b49}
\begin{itemize}
\item AR ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org11a0499}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgbd99456}
\begin{itemize}
\item none
\end{itemize}

\section{Non-Ketotic Hyperglycinemia}
\label{sec:org7f79161}
\subsection{Introduction}
\label{sec:org6d684af}
\begin{itemize}
...
\caption{\label{fig:org0e30564}Glycine Cleavage System}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:org9d89ed1}Activation of Lipoate Dependant Enzymes}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org6c7f3a4}
\subsubsection{Severe Classic NKH}
\label{sec:orgb264192}
\begin{itemize}
\item neonatal onset
...
and BCKDH (Figure \ref{fig:org9d89ed1})
...
\label{sec:org71f5214}
\subsection{Glutamine Metabolism}
\label{sec:org05ae8e2}
\begin{itemize}
...
\caption{\label{fig:org9a3e629}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org4f4c086}
\begin{itemize}
...
\section{Transport}
\label{sec:orgfba79b8}
\subsection{Introduction}
\label{sec:org266a8fb}
\begin{itemize}
...
\caption{\label{fig:org65cd040}Cystine}
\end{figure}

\subsubsection{Neutral  Amino Acids}
\label{sec:orgada69f1}
\begin{itemize}
...
\caption{\label{fig:orgbba696e}Cationic and Neutral Amino Acid Transport in Epithelial Cells}
\end{figure}

\subsection{Cystinuria}
\label{sec:org4189bcc}
\subsubsection{Clinical Presentation}
\label{sec:orgd8d438f}
\begin{itemize}
...
\label{sec:org93901e7}
\subsubsection{Clinical Presentation}
\label{sec:orgc70aaf8}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org3d3f141}
\begin{itemize}
\item AR SLC7A7
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org66b040c}
\begin{itemize}
...
\label{sec:orgbe75da0}
\subsubsection{Clinical Presentation}
\label{sec:org173522c}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org432ef02}
\begin{itemize}
\item AR SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7ba833c}
\begin{itemize}
