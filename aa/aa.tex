...
\label{sec:org44a46a6}
\subsection{Introduction}
\label{sec:org87e5c61}
\begin{itemize}
...
\caption{\label{fig:org81464c4}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:orgb5b434a}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:org247c0b1}Tetrahydrobiopterin Metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:orgfa87331}Phenylalaninemia Classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org5b9f05f}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:org39aade5}
\subsubsection{Clinical Presentation}
\label{sec:org171b443}
\begin{itemize}
...
\label{sec:org84d5699}
\begin{enumerate}
\item Diet
\label{sec:org058fcd0}
\begin{itemize}
...
\label{sec:org299ac37}
\subsubsection{Clinical Presentation}
\label{sec:orgb548c07}
\begin{itemize}
...
\label{sec:org6daef9d}
\begin{itemize}
\item disorders of BH\textsubscript{4} metabolism associated with HPA and biogenic amine deficiency (Figure \ref{fig:org247c0b1})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org946cb3d}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:org81464c4}
and \ref{fig:org247c0b1})
...
\subsubsection{Diagnostic Tests}
\label{sec:org505a8b2}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:org904cc64})
...
\begin{table}[htbp]
\caption{\label{tab:org904cc64}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org6fbf7a8}} & primapterin\textsuperscript{\ref{org6fbf7a8}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org6fbf7a8}blood or urine}

\subsubsection{Treatment}
\label{sec:org6d513dc}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:orgdcd4d24}
\subsection{Introduction}
\label{sec:orgf13fedf}
\begin{itemize}
...
\caption{\label{fig:orgc35f5cc}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:org1e510f5}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:org0ab4fb0}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgab74d84}
\begin{itemize}
...
\label{sec:org705f1fd}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgf9fb40f}
\begin{itemize}
...
4-hydroxyphenyllactate and 4-hydroxyphenylacetate via AST (Figure \ref{fig:orgc35f5cc})
\end{itemize}

\subsubsection{Genetics}
\label{sec:org7bcfae0}
\begin{itemize}
\item AR TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgaab9857}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org9866bf3}
\begin{itemize}
\item AR HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgce26464}
\begin{itemize}
...
\label{sec:org17fa135}
\subsubsection{Clinical Presentation}
\label{sec:org4700460}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgdd1ae7f}
\begin{itemize}
\item AR HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org8a0055a}
\begin{itemize}
...
\label{sec:orgfb9bc1c}
\subsubsection{Clinical Presentation}
\label{sec:orge5c1ec3}
\begin{itemize}
...
\section{BCAA}
\label{sec:orgd07ac8b}
\subsection{Introduction}
\label{sec:org1486d7b}
\begin{itemize}
...
\caption{\label{fig:org18174e3}BCAA catabolism}
\end{figure}
...
\label{sec:org36896c6}
\subsubsection{Clinical Presentation}
\label{sec:org47bd7cf}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org97810a0}
\begin{enumerate}
\item MSUD
\label{sec:orgb3d1e9a}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4dfd60c}
\begin{description}
\item[{MSUD}] AR E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR IVD
\item[{PA}] AR PCCB
\item[{MMA}] AR MUT or cobalamin system (Table \ref{tab:org8bede60})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org8bede60}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
Gene & Protein\\
\hline
...
\end{tabular}
\end{table}\footnotetext[5]{\label{orgf52bf0a}deficiency of CblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org65fb3f6}
\begin{enumerate}
\item MSUD
\label{sec:org701aeab}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org2c1e196}
\begin{itemize}
\item AR MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orga31373a}
\begin{itemize}
\item \(\Uparrow\) 3-hydroxyisovaleric
...
\section{Urea Cycle}
\label{sec:org26fa203}
\subsection{Introduction}
\label{sec:orgfdbe92e}
\begin{itemize}
...
\caption{\label{fig:orgae5e763}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org398d269}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org37da4a7}Diagnostic Algorithm that can be Applied to any Hyperammonaemic Patient}
\end{figure}

\subsection{Mitochondrial UCDs}
\label{sec:org38686d3}
\begin{itemize}
...
\caption{\label{fig:org21c206a}Nitrogen Elimination by Phenylbutyrate and Benzoate}
\end{figure}

\item Prognosis
\label{sec:org44dbc89}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orga60c113}
\begin{enumerate}
\item Newborns
\label{sec:org45627e5}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org7712e48}
\begin{itemize}
\item AR ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org5f0d8e8}
\begin{itemize}
...
\label{sec:orgd7f534f}
\subsubsection{HHH Syndrome}
\label{sec:orgfce7cd9}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:orgbdfb53c})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org10bc46f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org81c817d}
\begin{itemize}
...
\item Genetics
\label{sec:orgc51593e}
\begin{itemize}
\item AR SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:orga0e84c7}
\begin{itemize}
...
\item Genetics
\label{sec:org0b761ae}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:orga7fdfe0}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:org75c83cd}
\subsection{Introduction}
\label{sec:org226b7b3}
...
\caption{\label{fig:org584b49c}Cysteine and Cystine}
\end{figure}
...
kinase (ADK)
\item homocysteine has two metabolic pathways (Figure \ref{fig:orgfe22684}):
\begin{enumerate}
...
\caption{\label{fig:orgaf10523}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:orgfe22684}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:org551ae08}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org022f28f}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org9d3c538}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org358ce68}
\begin{itemize}
\item AR MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orge791380}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgaae3505}
\begin{itemize}
\item AR CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orge6d54e9}
\begin{itemize}
...
\label{sec:orgb3729a0}
\subsubsection{Clinical Presentation}
\label{sec:orgbdf4fd0}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org8989f55}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org0342b45}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgefbd7e6}
\begin{itemize}
...
\label{sec:orgc0ec3ca}
\subsubsection{Clinical Presentation}
\label{sec:orgc18753e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgda63421}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org7e04f8f}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:orgbdfb53c}
\subsection{Introduction}
\label{sec:org38d21ab}
\subsubsection{Ornitine}
\label{sec:org4464056}
\begin{itemize}
...
\item defective in HHH syndrome (Section \ref{sec:orgfce7cd9})
\end{itemize}
...
\caption{\label{fig:org3f251b3}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:orgcd477b0}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:org20afe11}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:org30ead4a}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org33fd419}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org148e008}
\begin{itemize}
\item AR OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7779134}
\begin{itemize}
...
\label{sec:orge40e17c}
\begin{itemize}
\item Hypoprolinaemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org624b096}
\begin{itemize}
...
\item see figure \ref{fig:org20afe11} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:org28149db}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org748876c}
\begin{itemize}
\item AR/AD ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org1fb4702}
\begin{itemize}
...
\label{sec:org262ed05}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org9249100}
\begin{itemize}
...
\label{sec:orgda70994}
\begin{itemize}
\item Hyperprolinaemia Type II
\end{itemize}

\subsubsection{Clinical Presentation}
\label{sec:orgd5024ac}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org06dbca8}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org08ec7c6}
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org5a2369d} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:org5a2369d} enzyme 2)
\begin{itemize}
...
ketoglutarate dehydrogenase-like complex (Figure \ref{fig:org5a2369d} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org5a2369d} enzyme 6b)
\begin{itemize}
\item KGDH may serve as an alternative route
\item 2-oxoadipic acid is dehydrogenated and decarboxylated to
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org5a2369d} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org5a2369d} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org5a2369d} enzyme 9)
...
(Figure \ref{fig:org5a2369d} enzyme 10)
\end{itemize}
...
\caption{\label{fig:org5a2369d}Tryptophan, hydroxylysine and lysine catabolic pathways}
\end{figure}
...
\caption{\label{fig:org283acce}Tryptophan and lysine catabolic pathways}
\end{figure}

\subsection{Glutaric Aciduria Type I}
\label{sec:orgcb2cc3b}
\subsubsection{Clinical Presentation}
\label{sec:org7d1d9f1}
\begin{itemize}
...
\label{sec:orgf6725bb}
\subsubsection{Clinical Presentation}
\label{sec:org18253aa}
\begin{description}
...
\label{sec:org19f9ce2}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org922a43f}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org2e0a9ea}
\begin{itemize}
\item AR ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org863ee55}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org72cd132}
\begin{itemize}
\item none
\end{itemize}

\section{Non-Ketotic Hyperglycinemia}
\label{sec:orgeda9521}
\subsection{Introduction}
\label{sec:org82c3cd7}
\begin{itemize}
...
\caption{\label{fig:org9e8a78c}Glycine Cleavage System}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:org017d12b}Activation of Lipoate Dependant Enzymes}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org9a4af3c}
\subsubsection{Severe Classic NKH}
\label{sec:org7933198}
\begin{itemize}
\item neonatal onset
...
and BCKDH (Figure \ref{fig:org017d12b})
...
\label{sec:org6539c63}
\subsection{Glutamine Metabolism}
\label{sec:org8452722}
\begin{itemize}
...
\caption{\label{fig:org4ace33f}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orgd220e28}
\begin{itemize}
...
\section{Transport}
\label{sec:org80d212e}
\subsection{Introduction}
\label{sec:org3a2793f}
\begin{itemize}
...
\caption{\label{fig:org0dd0f5f}Cystine}
\end{figure}

\subsubsection{Neutral  Amino Acids}
\label{sec:org6e4a59d}
\begin{itemize}
...
\caption{\label{fig:orgfeecb92}Simplified schematic representation of cationic and neutral amino acid transport in epithelial cells}
\end{figure}

\subsection{Cystinuria}
\label{sec:org3445cf5}
\subsubsection{Clinical Presentation}
\label{sec:orgddab8b5}
\begin{itemize}
...
\label{sec:orgaa940c8}
\subsubsection{Clinical Presentation}
\label{sec:org3908f88}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0d152f3}
\begin{itemize}
\item AR SLC7A7
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgd20e2c2}
\begin{itemize}
...
\label{sec:org0cd2cbb}
\subsubsection{Clinical Presentation}
\label{sec:orgac22855}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge007fdb}
\begin{itemize}
\item AR SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3621746}
\begin{itemize}
