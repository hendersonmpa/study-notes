...
\label{sec:org47b9adb}
\subsection{Introduction}
\label{sec:org99e4a00}
\begin{itemize}
...
\caption{\label{fig:org29b40aa}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:org6060e4d}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:org7c3914d}Tetrahydrobiopterin metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org8b22b35}Phenylalaninemia classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org46939c5}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:orgfda88f8}
\subsubsection{Clinical Presentation}
\label{sec:orgf50f209}
\begin{itemize}
...
\label{sec:org9d59cd4}
\begin{enumerate}
\item Diet
\label{sec:org512b7b5}
\begin{itemize}
...
treatment of responsive\textsuperscript{\ref{org46939c5}} patients with HPA and PKU, of all
ages
\end{itemize}
\item Alternative/Experimental
\label{sec:org0f01bcc}
\begin{itemize}
...
\label{sec:org0588a72}
\subsubsection{Clinical Presentation}
\label{sec:org0766faa}
\begin{itemize}
...
\label{sec:orgee31911}
\begin{itemize}
\item disorders of BH\textsubscript{4} metabolism associated with HPA and biogenic amine deficiency (Figure \ref{fig:org7c3914d})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgb45f530}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:org29b40aa}
and \ref{fig:org7c3914d})
...
\subsubsection{Diagnostic Tests}
\label{sec:org0292360}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:org0a899e8})
...
\begin{table}[htbp]
\caption{\label{tab:org0a899e8}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{orgb7abbe8}} & primapterin\textsuperscript{\ref{orgb7abbe8}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{orgb7abbe8}blood or urine}

\subsubsection{Treatment}
\label{sec:orgdb83abd}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:orgf75a424}
\subsection{Introduction}
\label{sec:org899398a}
\begin{itemize}
...
\caption{\label{fig:orgeeb68eb}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:org470ae6a}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:orgcc3a3c8}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org6251d58}
\begin{itemize}
...
\label{sec:org144aeae}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgc8638c8}
\begin{itemize}
...
4-hydroxyphenyllactate and 4-hydroxyphenylacetate via AST (Figure \ref{fig:orgeeb68eb})
\end{itemize}

\subsubsection{Genetics}
\label{sec:orgc1e761f}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org16fc269}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org8c89d77}
\begin{itemize}
\item AR, HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org4a2433c}
\begin{itemize}
...
\label{sec:org712e9ea}
\subsubsection{Clinical Presentation}
\label{sec:org54b4dbf}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orga7add33}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgfb4e8c8}
\begin{itemize}
...
\label{sec:org48552c4}
\subsubsection{Clinical Presentation}
\label{sec:orge8b3d7b}
\begin{itemize}
...
\section{BCAA}
\label{sec:org0d2ea34}
\subsection{Introduction}
\label{sec:org013339a}
\begin{itemize}
...
\caption{\label{fig:orgffa2e99}BCAA catabolism}
\end{figure}
...
\label{sec:orga1e894f}
\subsubsection{Clinical Presentation}
\label{sec:orgd21380a}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org0707995}
\begin{enumerate}
\item MSUD
\label{sec:org1495676}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgaff7356}
\begin{description}
\item{MSUD} AR E1\(\alpha\), E1\(\beta\) and E2
\item{IVA} AR IVD
\item{PA} AR PCCB
\item{MMA} AR MUT or cobalamin system (Table \ref{tab:org948e6ff})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org948e6ff}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
Gene & Protein\\
\hline
...
\end{tabular}
\end{table}\footnotetext[4]{\label{org38e53e0}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org63dde30}
\begin{enumerate}
\item MSUD
\label{sec:org23cf4af}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgd602963}
\begin{itemize}
\item AR, MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org0124973}
\begin{itemize}
...
\section{Urea Cycle}
\label{sec:org0fe94a8}
\subsection{Introduction}
\label{sec:orgefa5f42}
\begin{itemize}
...
\caption{\label{fig:org803c022}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org63f73b2}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org7b720ca}Diagnostic algorithm that can be applied to any hyperammonaemic patient}
\end{figure}

\subsection{Mitochondrial}
\label{sec:org537955d}
\begin{itemize}
...
\caption{\label{fig:org02a4a04}Nitrogen elimination by phenylbutyrate and benzoate}
\end{figure}

\item Prognosis
\label{sec:org0fe430b}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org5fd3352}
\begin{enumerate}
\item Newborns
\label{sec:orgc209302}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org14f0ba2}
\begin{itemize}
\item AR ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orge23f144}
\begin{itemize}
...
\label{sec:org466426e}
\subsubsection{HHH Syndrome}
\label{sec:org6102311}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:orgcdceea6})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org2484b24}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb1dc305}
\begin{itemize}
...
\item Genetics
\label{sec:orgd9ec955}
\begin{itemize}
\item AR, SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:org5f50767}
\begin{itemize}
...
\item Genetics
\label{sec:orgff146a1}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:orga817031}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:orgcab8df8}
\subsection{Introduction}
\label{sec:orgd4954a7}
...
\caption{\label{fig:org8ac5e74}Cysteine vs Cystine}
\end{figure}
...
kinase (ADK)
\item homocysteine has two metabolic pathways (Figure \ref{fig:orgb64d135}):
\begin{enumerate}
...
\caption{\label{fig:org5acd15c}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:orgb64d135}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:org024961d}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:orgedef0d1}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orge50c5c2}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgf5f2c6e}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org221c77a}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org7d6f860}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org9b80471}
\begin{itemize}
...
\label{sec:org2916141}
\subsubsection{Clinical Presentation}
\label{sec:org3711cef}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org074d245}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org6648256}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org6cd2900}
\begin{itemize}
...
\label{sec:org07d30c8}
\subsubsection{Clinical Presentation}
\label{sec:org144b197}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org80fb7fa}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgd9df859}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:orgcdceea6}
\subsection{Introduction}
\label{sec:org3f257bb}
\begin{itemize}
...
\caption{\label{fig:org5b60c5e}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:org7c6bd28}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:orgea751c7}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:org8c775ab}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org8573d96}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org9befb73}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org9522943}
\begin{itemize}
...
\item see figure \ref{fig:orgea751c7} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:orgb6b1821}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgbff6ef4}
\begin{itemize}
\item AR/AD ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgcf336ec}
\begin{itemize}
...
\label{sec:org3d39d7d}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org006ca6a}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org2ab98d3}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org65b8b40}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:orgd219212} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:orgd219212} enzyme 2)
\begin{itemize}
...
ketoglutarate dehydrogenase-like complex (Figure \ref{fig:orgd219212} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:orgd219212} enzyme 6b)
\begin{itemize}
\item KGDH may serve as an alternative route
\item 2-oxoadipic acid is dehydrogenated and decarboxylated to
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:orgd219212} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:orgd219212} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:orgd219212} enzyme 9)
...
(Figure \ref{fig:orgd219212} enzyme 10)
...
\caption{\label{fig:orgd219212}Tryptophan, hydroxylysine and lysine catabolic pathways}
\end{figure}
...
\caption{\label{fig:org7afd1ea}Tryptophan and lysine catabolic pathways}
\end{figure}

\subsection{Glutaric Aciduria Type I}
\label{sec:org9786a9b}
\subsubsection{Clinical Presentation}
\label{sec:orgbeec6d0}
\begin{itemize}
...
\label{sec:org947844d}
\subsubsection{Clinical Presentation}
\label{sec:org70ed3d7}
\begin{description}
...
\label{sec:org41c62b9}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org1bc870b}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgf643017}
\begin{itemize}
\item AR, ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org0554ea2}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orge7eac8f}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:orgd7687aa}
\subsection{Introduction}
\label{sec:orgb38b349}
\begin{itemize}
...
\caption{\label{fig:org1c0e4c5}Glycine cleavage enzyme}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:org7403fe1}Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org1527312}
\subsubsection{Severe Classic NKH}
\label{sec:orgf8ff192}
\begin{itemize}
\item neonatal onset
...
\label{sec:org44f9824}
\subsection{Glutamine Metabolism}
\label{sec:org66bd80b}
\begin{itemize}
...
\caption{\label{fig:org4040751}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orgc75d8a2}
\begin{itemize}
...
\section{Transport}
\label{sec:orgc51fe55}
\subsection{Introduction}
\label{sec:orgdd12382}
\begin{itemize}
...
\caption{\label{fig:org6281fbc}Simplified schematic representation of cationic and neutral amino acid transport in epithelial cells}
\end{figure}

\subsection{Cystinuria}
\label{sec:org50467ab}
\subsubsection{Clinical Presentation}
\label{sec:org08ecc2e}
\begin{itemize}
...
\label{sec:org9c9a41e}
\subsubsection{Clinical Presentation}
\label{sec:orgfb09a3f}
\begin{itemize}
...
\label{sec:orgf09fc07}
\subsubsection{Clinical Presentation}
\label{sec:org6e7482d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org556bdfa}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgb6d27d7}
\begin{itemize}
