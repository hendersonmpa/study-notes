...
\label{sec:org6ef5816}
\subsection{Introduction}
\label{sec:orge788ded}
\begin{itemize}
...
\label{sec:orgd135f0f}
\begin{enumerate}
\item Diet
\label{sec:orgab32820}
\begin{itemize}
...
\label{sec:org555632a}
\subsubsection{Clinical Presentation}
\label{sec:org3001cf5}
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgda26e62}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figure \ref{fig:org0cb775a})
...
\begin{table}[htbp]
\caption{\label{tab:org49b9715}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org98849d5}} & primapterin\textsuperscript{\ref{org98849d5}} & CSF 5HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org98849d5}blood or urine}

\subsubsection{Treatment}
\label{sec:org9720f56}
\begin{itemize}
\item BH\(_{\text{4}}\)
...
\section{Tyrosine}
\label{sec:org078907b}
\subsection{Introduction}
\label{sec:orgd478567}
...
\label{sec:org6d28f04}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgc4623e1}
\begin{itemize}
...
\label{sec:org75088e1}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org627f9c5}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org93c7b40}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgee0c286}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org2b12dad}
\begin{itemize}
\item AR, HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgb37f6df}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgdf5f07f}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org558b501}
\begin{itemize}
...
\label{sec:org754172d}
\subsubsection{Clinical Presentation}
\label{sec:org84659cf}
\begin{itemize}
...
\section{BCAA}
\label{sec:org331de2c}
\subsection{Introduction}
\label{sec:org0a00b46}
\begin{itemize}
...
\label{sec:org3a2dd92}
\subsubsection{Clinical Presentation}
\label{sec:orgc623f37}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org00b35c6}
\begin{enumerate}
\item MSUD
\label{sec:orge5ba0d6}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb315811}
\begin{description}
\item[{MSUD}] AR, E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR, IVD
\item[{PA}] AR, PCCB
\item[{MMA}] AR, MUT or cobalamin system (Table \ref{tab:org86a20b8})
\begin{itemize}
...
MMADHC & cblD\\
\end{tabular}
\end{table}\footnotetext[2]{\label{orgc68effe}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:orgf622b36}
\begin{enumerate}
\item MSUD
\label{sec:org806dba1}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org5f2b080}
\begin{itemize}
\item AR, MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgaf3af0b}
\begin{itemize}
\item \(\Uparrow\) 3-HIVA
...
\section{Urea Cycle}
\label{sec:org83e953d}
\subsection{Introduction}
\label{sec:org6005012}
\begin{itemize}
...
\label{sec:org1c66fe9}
\begin{enumerate}
\item Newborns
\label{sec:org296e828}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgfebb3f1}
\begin{itemize}
\item AR, ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgd6e898c}
\begin{itemize}
...
\label{sec:org28b2f4e}
\subsubsection{HHH Syndrome}
\label{sec:orgef85b4b}
\begin{itemize}
\item see section \ref{sec:org020e0b0}
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org00d9b9d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0626ffc}
\begin{itemize}
...
\item Genetics
\label{sec:org6b8c43b}
\begin{itemize}
\item AR, SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:orga56281e}
\begin{itemize}
...
\item Genetics
\label{sec:org7ba1766}
\begin{itemize}
\item AR, CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:orge44fe61}
\begin{itemize}
...
\label{sec:org5a895c3}
\subsection{Introduction}
\label{sec:org34039a4}
\begin{itemize}
...
\caption{\label{fig:orgd82a31a}
Disorders of sulfur amino acid metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org7e12e1b}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgad7969d}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org1bc8809}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org2f2a268}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org821e569}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org302040a}
\begin{itemize}
...
\label{sec:org76f7b2b}
\subsubsection{Clinical Presentation}
\label{sec:org87826fe}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org839ec62}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org68a7175}
\begin{itemize}
\item AR, SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7e68450}
\begin{itemize}
...
\label{sec:orgd93e4f7}
\subsubsection{Clinical Presentation}
\label{sec:orgcb51279}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgd665dce}
\begin{itemize}
\item AR, ETHE1, rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org9c9986d}
\begin{itemize}
...
\label{sec:org020e0b0}
\subsection{Introduction}
\label{sec:org59fee6a}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org9c4c77e}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org1a9cd41}
\begin{itemize}
...
\label{sec:org6dbd3a5}
\begin{itemize}
\item \(\Delta\)1-Pyrroline-5-Carboxylate Synthetase Deficiency
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org8a127b2}
\begin{itemize}
\item central and peripheral neurological
\item see figure \ref{fig:org3c6fa8f} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:orgaf5d2d9}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga37a0e0}
\begin{itemize}
\item AR/AD, ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org1bb7f12}
\begin{itemize}
...
\label{sec:org362f53b}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org88b734f}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga88dd14}
\begin{itemize}
\item AR, ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgbc1fa2a}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgc1aaeda}
\begin{itemize}
\item AR, PEPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgd483560}
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:orgf4e1ff8} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid and the
peroxisomal key enzyme, pipecolic acid oxidase (Figure \ref{fig:orgf4e1ff8} enzyme 2)
\begin{itemize}
...
2-oxoglutarate dehydrogenase-like complex (Figure \ref{fig:orgf4e1ff8} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:orgf4e1ff8} enzyme 6b)
...
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:orgf4e1ff8} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:orgf4e1ff8} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:orgf4e1ff8} enzyme 9)
...
(Figure \ref{fig:orgf4e1ff8} enzyme 10)
...
\label{sec:orgd02f240}
\subsubsection{Clinical Presentation}
\label{sec:org3decc73}
\begin{description}
...
\label{sec:orgcf258e2}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orge82392a}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4acd8c6}
\begin{itemize}
\item AR, ASPAragine
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org16f1a59}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org80dcb89}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:orgcef3f57}
\subsection{Introduction}
\label{sec:orgd9eb406}
\begin{itemize}
...
\caption{\label{fig:org19791db}
Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org93532e0}
\subsubsection{Severe Classic NKH}
\label{sec:org60f2628}
\begin{itemize}
\item neonatal onset
...
\label{sec:org6579949}
\subsection{Glutamine Metabolism}
\label{sec:org9dc64b6}
\begin{itemize}
...
\caption{\label{fig:org78b08f6}
Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org564c298}
\begin{itemize}
...
\section{Transport}
\label{sec:orgb8fec1b}
\subsection{Introduction}
\label{sec:org54b873f}
\begin{itemize}
...
\label{sec:org9865324}
\subsubsection{Clinical Presentation}
\label{sec:org32fe5ac}
\begin{itemize}
...
\label{sec:orga21f9bf}
\subsubsection{Clinical Presentation}
\label{sec:orgfc472bf}
\begin{itemize}
...
\label{sec:org1dc2e94}
\subsubsection{Clinical Presentation}
\label{sec:orgeb3b786}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgcbbb079}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org996f13f}
\begin{itemize}
