...
\end{tabular}
\end{table}\footnotetext[1]{\label{org7adf3d4}mild hyperphenylalaninaemia

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./phe/figures/pah.png}
\caption{\label{fig:orgc02c408}
...
\end{tabular}
\end{table}\footnotetext[2]{\label{orge143ad0}blood or urine}
...
\label{sec:orgc85b798}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orge54e1c4}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org7e17405}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org9c0ebbc}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgac5a476}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org4cdacb2}
\begin{itemize}
...
\label{sec:orga78078d}
\subsubsection{Clinical Presentation}
\label{sec:orgf84ec0c}
\begin{itemize}
...
MMADHC & cblD\\
\end{tabular}
\end{table}\footnotetext[3]{\label{org239f4b2}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}
...
\label{sec:orgb241294}
\begin{enumerate}
\item Newborns
\label{sec:orgd5d628a}
\begin{itemize}
...
\label{sec:org17497d5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org12f5c6f}
\begin{itemize}
...
\item Genetics
\label{sec:orgda4d335}
\begin{itemize}
\item AR, SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:org61e073a}
\begin{itemize}
...
\item Genetics
\label{sec:orgabd32f0}
\begin{itemize}
\item AR, CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org13efce9}
\begin{itemize}
...
\label{sec:orge8cc022}
\subsection{Introduction}
\label{sec:orga0b4a35}
\begin{itemize}
...
\caption{\label{fig:org1c16b21}
Disorders of sulfur amino acid metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:orgbfd1c7d}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org79d13da}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgc7c4909}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgc2e2e98}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org6962c70}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org17fc882}
\begin{itemize}
...
\label{sec:orgad3e6ed}
\subsubsection{Clinical Presentation}
\label{sec:org5c78159}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org2343589}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge724efc}
\begin{itemize}
\item AR, SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org8abec5d}
\begin{itemize}
...
\label{sec:orga216f57}
\subsubsection{Clinical Presentation}
\label{sec:orgdfcf230}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org468d788}
\begin{itemize}
\item AR, ETHE1, rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgf6d34f6}
\begin{itemize}
...
\label{sec:org181b2ed}
\subsection{Introduction}
\label{sec:org436a4a9}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org937912f}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org37933a0}
\begin{itemize}
...
\label{sec:org576f343}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org9f9485a}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgd5a161d}
\begin{itemize}
\item AR, ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orge08e248}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
\label{sec:org9fabc9d}
\subsubsection{Clinical Presentation}
\label{sec:org3bc7e3f}
\begin{description}
...
\label{sec:orgb6e4b14}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org4d7c1f1}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0ef31ca}
\begin{itemize}
\item AR, ASPAragine
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org26c0139}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org172ca96}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:org70fc51f}
\subsection{Introduction}
\label{sec:org7e397ce}
\begin{itemize}
...
\caption{\label{fig:org93f2c8b}
Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org4db7b7b}
\subsubsection{Severe Classic NKH}
\label{sec:orgca134fa}
\begin{itemize}
\item neonatal onset
...
\label{sec:org9f67272}
\subsection{Glutamine Metabolism}
\label{sec:org350abef}
\begin{itemize}
...
\caption{\label{fig:org786490e}
Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org8771555}
\begin{itemize}
...
\section{Transport}
\label{sec:orgc97265f}
\subsection{Introduction}
\label{sec:orgfaac3e3}
\begin{itemize}
...
\label{sec:org1ea6f52}
\subsubsection{Clinical Presentation}
\label{sec:orge47b576}
\begin{itemize}
...
\label{sec:org5d48433}
\subsubsection{Clinical Presentation}
\label{sec:org2acbd2e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org16deb86}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org02d0a69}
\begin{itemize}
