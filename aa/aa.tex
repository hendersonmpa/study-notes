...
\label{sec:org984407d}
\subsection{Introduction}
\label{sec:org0718b81}
\begin{itemize}
...
\caption{\label{fig:org514745b}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:org05f6575}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:org85c43d8}Tetrahydrobiopterin metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org800b89d}Phenylalaninemia classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgf29c1a6}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:org0d571f1}
\subsubsection{Clinical Presentation}
\label{sec:org0c8b923}
\begin{itemize}
...
\label{sec:orgb7cfa0f}
\begin{enumerate}
\item Diet
\label{sec:org1ecb621}
\begin{itemize}
...
treatment of responsive\textsuperscript{\ref{orgf29c1a6}} patients with HPA and PKU, of all
ages
\end{itemize}
\item Alternative/Experimental
\label{sec:orgb866f20}
\begin{itemize}
...
\label{sec:org5b4b760}
\subsubsection{Clinical Presentation}
\label{sec:org0b42a34}
\begin{itemize}
...
\label{sec:org56589b8}
\begin{itemize}
\item disorders of BH\textsubscript{4} metabolism associated with HPA and biogenic amine deficiency (Figure \ref{fig:org85c43d8})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org037458b}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:org514745b}
and \ref{fig:org85c43d8})
...
\subsubsection{Diagnostic Tests}
\label{sec:org6b4eb77}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:orge4329a9})
...
\begin{table}[htbp]
\caption{\label{tab:orge4329a9}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org5a9886e}} & primapterin\textsuperscript{\ref{org5a9886e}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org5a9886e}blood or urine}

\subsubsection{Treatment}
\label{sec:org5719b8c}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:orgc3f84e1}
\subsection{Introduction}
\label{sec:orga23a8b0}
\begin{itemize}
...
\caption{\label{fig:org474bf7b}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:orge001667}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:orgee5b8df}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org70b4a9a}
\begin{itemize}
...
\label{sec:orgc964159}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org6392f34}
\begin{itemize}
...
4-hydroxyphenyllactate and 4-hydroxyphenylacetate via AST (Figure \ref{fig:org474bf7b})
\end{itemize}

\subsubsection{Genetics}
\label{sec:org9d16d09}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org41c5e37}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org022ca05}
\begin{itemize}
\item AR, HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org4dc4d9a}
\begin{itemize}
...
\label{sec:orgab5c497}
\subsubsection{Clinical Presentation}
\label{sec:org9a806b0}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org1bc4b47}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org6d8e416}
\begin{itemize}
...
\label{sec:org4c40e0d}
\subsubsection{Clinical Presentation}
\label{sec:orgdd66de4}
\begin{itemize}
...
\section{BCAA}
\label{sec:orged370f1}
\subsection{Introduction}
\label{sec:org23fecb6}
\begin{itemize}
...
\caption{\label{fig:orga54d5ce}BCAA catabolism}
\end{figure}
...
\label{sec:org8a21dd9}
\subsubsection{Clinical Presentation}
\label{sec:org43c05c5}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:orge048068}
\begin{enumerate}
\item MSUD
\label{sec:org43c6ae3}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgbe6b1f1}
\begin{description}
\item{MSUD} AR E1\(\alpha\), E1\(\beta\) and E2
\item{IVA} AR IVD
\item{PA} AR PCCB
\item{MMA} AR MUT or cobalamin system (Table \ref{tab:orgee16e61})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgee16e61}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
Gene & Protein\\
\hline
...
\end{tabular}
\end{table}\footnotetext[4]{\label{org9a43b9a}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org042b9cf}
\begin{enumerate}
\item MSUD
\label{sec:org0b7f328}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgca2cea5}
\begin{itemize}
\item AR, MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org7f5fcc4}
\begin{itemize}
...
\section{Urea Cycle}
\label{sec:org928f241}
\subsection{Introduction}
\label{sec:orgf24ca63}
\begin{itemize}
...
\caption{\label{fig:org7f1da9a}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org11f1b5a}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org79df4a8}Diagnostic algorithm that can be applied to any hyperammonaemic patient}
\end{figure}

\subsection{Mitochondrial}
\label{sec:org9173abc}
\begin{itemize}
...
\caption{\label{fig:org78eebfe}Nitrogen elimination by phenylbutyrate and benzoate}
\end{figure}

\item Prognosis
\label{sec:orgf0ca66b}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org372ee51}
\begin{enumerate}
\item Newborns
\label{sec:org1e69368}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgfc2c675}
\begin{itemize}
\item AR ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org87412bf}
\begin{itemize}
...
\label{sec:org0a5fe93}
\subsubsection{HHH Syndrome}
\label{sec:orgb38e8a3}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:orgfd620d9})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org2cc282b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5748142}
\begin{itemize}
...
\item Genetics
\label{sec:org6506a50}
\begin{itemize}
\item AR, SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd62786a}
\begin{itemize}
...
\item Genetics
\label{sec:org41ef428}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org19052a7}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:org0e59a1d}
\subsection{Introduction}
\label{sec:org1a7a73e}
...
\caption{\label{fig:org477867b}Cysteine vs Cystine}
\end{figure}
...
kinase (ADK)
\item homocysteine has two metabolic pathways (Figure \ref{fig:org276ed07}):
\begin{enumerate}
...
\caption{\label{fig:org6f1acb0}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:org276ed07}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:org8083bc5}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:orge5a0e81}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org4a0f48e}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org71c0add}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org2349124}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org3c8adf6}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgdba5e8d}
\begin{itemize}
...
\label{sec:orga1a24cc}
\subsubsection{Clinical Presentation}
\label{sec:org8daab03}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgabda6ab}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgfca1ca9}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org404a896}
\begin{itemize}
...
\label{sec:org0c160da}
\subsubsection{Clinical Presentation}
\label{sec:org48e7be9}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org3b7636d}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org004ab08}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:orgfd620d9}
\subsection{Introduction}
\label{sec:orgebe48cb}
\begin{itemize}
...
\caption{\label{fig:orgcf2e770}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:orgd064f03}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:org95a5933}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:org5857287}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgbc6a385}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgc4b41af}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org6a08844}
\begin{itemize}
...
\item see figure \ref{fig:org95a5933} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:orgf39bca0}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org8892d49}
\begin{itemize}
\item AR/AD ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgf70b76e}
\begin{itemize}
...
\label{sec:orgb014335}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgaeb94fc}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgd94b27a}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgef01a7d}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:orgd36138b} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:orgd36138b} enzyme 2)
\begin{itemize}
...
ketoglutarate dehydrogenase-like complex (Figure \ref{fig:orgd36138b} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:orgd36138b} enzyme 6b)
\begin{itemize}
\item KGDH may serve as an alternative route
\item 2-oxoadipic acid is dehydrogenated and decarboxylated to
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:orgd36138b} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:orgd36138b} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:orgd36138b} enzyme 9)
...
(Figure \ref{fig:orgd36138b} enzyme 10)
...
\caption{\label{fig:orgd36138b}Tryptophan, hydroxylysine and lysine catabolic pathways}
\end{figure}
...
\caption{\label{fig:org2925a8b}Tryptophan and lysine catabolic pathways}
\end{figure}

\subsection{Glutaric Aciduria Type I}
\label{sec:org7467b0c}
\subsubsection{Clinical Presentation}
\label{sec:org66e4a03}
\begin{itemize}
...
\label{sec:orge38e7d5}
\subsubsection{Clinical Presentation}
\label{sec:org2628427}
\begin{description}
...
\label{sec:org1924e17}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org4f8e595}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgc38599e}
\begin{itemize}
\item AR, ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org4e6b073}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org81480cd}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:org9dd8b03}
\subsection{Introduction}
\label{sec:orgb18a36e}
\begin{itemize}
...
\caption{\label{fig:org0f5ad2b}Glycine cleavage enzyme}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:orgfc7f117}Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:orgc9d3d3a}
\subsubsection{Severe Classic NKH}
\label{sec:orgd2d4e52}
\begin{itemize}
\item neonatal onset
...
\label{sec:org31b27e5}
\subsection{Glutamine Metabolism}
\label{sec:org379251d}
\begin{itemize}
...
\caption{\label{fig:orga654b84}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orge5d9349}
\begin{itemize}
...
\section{Transport}
\label{sec:orgab9e54b}
\subsection{Introduction}
\label{sec:orgc70da0e}
\begin{itemize}
...
\caption{\label{fig:org07aac8f}Simplified schematic representation of cationic and neutral amino acid transport in epithelial cells}
\end{figure}

\subsection{Cystinuria}
\label{sec:org1303692}
\subsubsection{Clinical Presentation}
\label{sec:orgc669a4a}
\begin{itemize}
...
\label{sec:orgd0c8aa6}
\subsubsection{Clinical Presentation}
\label{sec:org4e970ea}
\begin{itemize}
...
\label{sec:org13407b5}
\subsubsection{Clinical Presentation}
\label{sec:org4661f71}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org517885f}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org5da9e15}
\begin{itemize}
