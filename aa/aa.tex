...
\label{sec:org4c0ff06}
\subsection{Introduction}
\label{sec:org1261b15}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org1cce686}mild hyperphenylalaninaemia

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./phe/figures/pah.png}
\caption{\label{fig:org3c791da}
...
\label{sec:orgddd68dc}
\begin{enumerate}
\item Diet
\label{sec:org2fb6a61}
\begin{itemize}
...
treatment of responsive\textsuperscript{\ref{org1cce686}} patients with HPA and PKU, of all
ages \textsuperscript{\ref{org1cce686}}defined as reduction of \(\ge\)30\% in blood phenylalanine
after a single dose
\end{itemize}
\item Alternative/Experimental
\label{sec:orgb0c0df1}
\begin{itemize}
...
\label{sec:org81c7ece}
\subsubsection{Clinical Presentation}
\label{sec:org9cf9b18}
\begin{itemize}
...
\label{sec:org9c84f9b}
\begin{itemize}
\item disorders of BH\(_{\text{4}}\) associated with HPA and biogenic amine deficiency (Figure \ref{fig:org66f9d1d})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org4d7aff2}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:org3c791da}
and \ref{fig:org66f9d1d})
...
\subsubsection{Diagnostic Tests}
\label{sec:org2dfcdb6}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:orgac4ec90})
...
\begin{table}[htbp]
\caption{\label{tab:orgac4ec90}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org98b60ee}} & primapterin\textsuperscript{\ref{org98b60ee}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org98b60ee}blood or urine}

\subsubsection{Treatment}
\label{sec:org12f6092}
\begin{itemize}
\item BH\(_{\text{4}}\)
...
\section{Tyrosine}
\label{sec:orgaa04068}
\subsection{Introduction}
\label{sec:orge8b1c7a}
\begin{itemize}
...
\label{sec:org20f7de3}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org0399b5b}
\begin{itemize}
...
\label{sec:orgdf5cade}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org0ed778c}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org538e2f6}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7acf259}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orge5531e9}
\begin{itemize}
\item AR, HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgef21f91}
\begin{itemize}
...
\label{sec:orgf42b2d2}
\subsubsection{Clinical Presentation}
\label{sec:org6427966}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org8d55811}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org5a47864}
\begin{itemize}
...
\label{sec:org2a948c3}
\subsubsection{Clinical Presentation}
\label{sec:orgc7f6436}
\begin{itemize}
...
\section{BCAA}
\label{sec:orgaaa6325}
\subsection{Introduction}
\label{sec:org1989674}
\begin{itemize}
...
\label{sec:orge3064ff}
\subsubsection{Clinical Presentation}
\label{sec:org2379dfd}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org22f0f2f}
\begin{enumerate}
\item MSUD
\label{sec:org3607c0d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgba46fcb}
\begin{description}
\item[{MSUD}] AR, E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR, IVD
\item[{PA}] AR, PCCB
\item[{MMA}] AR, MUT or cobalamin system (Table \ref{tab:orgee682f7})
\begin{itemize}
...
MMADHC & cblD\\
\end{tabular}
\end{table}\footnotetext[3]{\label{org1c56e37}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org84cce29}
\begin{enumerate}
\item MSUD
\label{sec:org088b908}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org5e38d1b}
\begin{itemize}
\item AR, MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgd73eb4b}
\begin{itemize}
...
\section{Urea Cycle}
\label{sec:org262648a}
\subsection{Introduction}
\label{sec:org2db1912}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org48dcc14}
\begin{enumerate}
\item Newborns
\label{sec:orgf86cfe8}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgc3e7061}
\begin{itemize}
\item AR, ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org882ef99}
\begin{itemize}
...
\label{sec:orgfff3b83}
\subsubsection{HHH Syndrome}
\label{sec:orgccdea97}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:org43cf33a})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org592ae11}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org410e6e4}
\begin{itemize}
...
\item Genetics
\label{sec:org8357f47}
\begin{itemize}
\item AR, SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:orgb9315e1}
\begin{itemize}
...
\item Genetics
\label{sec:org2de4066}
\begin{itemize}
\item AR, CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:orga8e396c}
\begin{itemize}
...
\label{sec:orgce3b400}
\subsection{Introduction}
\label{sec:org332f4d6}
\begin{itemize}
...
\caption{\label{fig:orgb7ba99f}
Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org09b56be}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org449a1a2}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org90b3b41}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org0147d6d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga087219}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org0d85490}
\begin{itemize}
...
\label{sec:orga7c0f34}
\subsubsection{Clinical Presentation}
\label{sec:orgf3353fc}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org5973e5b}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orge5a87ff}
\begin{itemize}
\item AR, SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org9389740}
\begin{itemize}
...
\label{sec:org48f7b0b}
\subsubsection{Clinical Presentation}
\label{sec:org00f8653}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org6b64912}
\begin{itemize}
\item AR, ETHE1, rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org734a4f5}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:org43cf33a}
\subsection{Introduction}
\label{sec:org08469d1}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgde41a2d}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgda6a2ea}
\begin{itemize}
...
\item see figure \ref{fig:orgce084d3} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:org39ae3f8}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org90334a2}
\begin{itemize}
\item AR/AD, ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org37e004d}
\begin{itemize}
...
\label{sec:org6561392}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgc83b8cc}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org403b3cb}
\begin{itemize}
\item AR, ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3d8bb32}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org34f5fe4} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:org34f5fe4} enzyme 2)
\begin{itemize}
...
2-oxoglutarate dehydrogenase-like complex (Figure \ref{fig:org34f5fe4} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org34f5fe4} enzyme 6b)
...
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org34f5fe4} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org34f5fe4} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org34f5fe4} enzyme 9)
...
(Figure \ref{fig:org34f5fe4} enzyme 10)
...
\label{sec:orga890474}
\subsubsection{Clinical Presentation}
\label{sec:org9158d1b}
\begin{description}
...
\label{sec:orgd19f640}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org8aefa66}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb40ceff}
\begin{itemize}
\item AR, ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org401965d}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgad553b1}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:org9064968}
\subsection{Introduction}
\label{sec:orgf6ec210}
\begin{itemize}
...
\label{sec:orgac2492a}
\subsection{Glutamine Metabolism}
\label{sec:org9889770}
\begin{itemize}
...
\caption{\label{fig:orgda592fb}
Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org1a66e93}
\begin{itemize}
...
\section{Transport}
\label{sec:org0abfe1c}
\subsection{Introduction}
\label{sec:orgfd8332b}
\begin{itemize}
...
\label{sec:org4415685}
\subsubsection{Clinical Presentation}
\label{sec:orgf856977}
\begin{itemize}
...
\label{sec:orgbe35ab9}
\subsubsection{Clinical Presentation}
\label{sec:org7e32e9f}
\begin{itemize}
...
\label{sec:orgf0e46ba}
\subsubsection{Clinical Presentation}
\label{sec:orgad54749}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org10369de}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orge896c42}
\begin{itemize}
