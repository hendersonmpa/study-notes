...
\label{sec:org7c0e245}
\subsection{Introduction}
\label{sec:orgeb6800e}
\begin{itemize}
...
\caption{\label{fig:orge220fdc}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:orgc55ad13}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:org901557c}Tetrahydrobiopterin Metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:orgc152823}Phenylalaninemia Classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgf2aeb46}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:org3a93f6d}
\subsubsection{Clinical Presentation}
\label{sec:orga5c08a8}
\begin{itemize}
...
\label{sec:org3d7885b}
\begin{enumerate}
\item Diet
\label{sec:orgd165b92}
\begin{itemize}
...
\label{sec:org7ef1e41}
\subsubsection{Clinical Presentation}
\label{sec:org449d86b}
\begin{itemize}
...
\label{sec:org1bb52e7}
\begin{itemize}
\item disorders of BH\textsubscript{4} metabolism associated with HPA and biogenic amine deficiency (Figure \ref{fig:org901557c})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgb28054c}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:orge220fdc}
and \ref{fig:org901557c})
...
\subsubsection{Diagnostic Tests}
\label{sec:orgad605f3}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:org3497ef6})
...
\begin{table}[htbp]
\caption{\label{tab:org3497ef6}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org96e32d7}} & primapterin\textsuperscript{\ref{org96e32d7}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org96e32d7}blood or urine}

\subsubsection{Treatment}
\label{sec:org44fa7eb}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:org397bf2c}
\subsection{Introduction}
\label{sec:org795a41c}
\begin{itemize}
...
\caption{\label{fig:orge9f4b17}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:org12ed363}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:org8f8459c}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgc6d58cf}
\begin{itemize}
...
\label{sec:org7023fe3}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org729239d}
\begin{itemize}
...
4-hydroxyphenyllactate and 4-hydroxyphenylacetate via AST (Figure \ref{fig:orge9f4b17})
\end{itemize}

\subsubsection{Genetics}
\label{sec:org8f2a647}
\begin{itemize}
\item AR TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgf9370d6}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org92ae0c7}
\begin{itemize}
\item AR HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org9d7c7aa}
\begin{itemize}
...
\label{sec:orge77f415}
\subsubsection{Clinical Presentation}
\label{sec:org4a945ac}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgfc88529}
\begin{itemize}
\item AR HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org4ca1db9}
\begin{itemize}
...
\label{sec:org77895db}
\subsubsection{Clinical Presentation}
\label{sec:orgc67c0e6}
\begin{itemize}
...
\section{BCAA}
\label{sec:orgb01bcc8}
\subsection{Introduction}
\label{sec:orgf169685}
\begin{itemize}
...
\caption{\label{fig:orga0ac3f4}BCAA catabolism}
\end{figure}
...
\label{sec:org316f895}
\subsubsection{Clinical Presentation}
\label{sec:org5ae7929}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org2d00997}
\begin{enumerate}
\item MSUD
\label{sec:org5289826}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org428a5d4}
\begin{description}
\item[{MSUD}] AR E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR IVD
\item[{PA}] AR PCCB
\item[{MMA}] AR MUT or cobalamin system (Table \ref{tab:orgd374941})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgd374941}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
Gene & Protein\\
\hline
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org47543f1}deficiency of CblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:orgc40718f}
\begin{enumerate}
\item MSUD
\label{sec:orga24c81d}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org4cc9b00}
\begin{itemize}
\item AR MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org7dc28ad}
\begin{itemize}
\item \(\Uparrow\) 3-hydroxyisovaleric
...
\section{Urea Cycle}
\label{sec:org83f8963}
\subsection{Introduction}
\label{sec:org127fa3c}
\begin{itemize}
...
\caption{\label{fig:org513a02d}Urea Cycle}
\end{figure}
...
\caption{\label{fig:orgc6de8ca}Urea Cycle}
\end{figure}
...
\caption{\label{fig:orge6603fa}Diagnostic Algorithm that can be Applied to any Hyperammonaemic Patient}
\end{figure}

\subsection{Mitochondrial UCDs}
\label{sec:org996ad20}
\begin{itemize}
...
\caption{\label{fig:orgf2144e5}Nitrogen Elimination by Phenylbutyrate and Benzoate}
\end{figure}

\item Prognosis
\label{sec:org863af00}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orgc16c0ed}
\begin{enumerate}
\item Newborns
\label{sec:orga1b0f7e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org56706ca}
\begin{itemize}
\item AR ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgf005a24}
\begin{itemize}
...
\label{sec:org06fe22c}
\subsubsection{HHH Syndrome}
\label{sec:orgd5bd16c}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:orgf7f0f4b})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:orgf2c9850}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga81459e}
\begin{itemize}
...
\item Genetics
\label{sec:orgf9be26d}
\begin{itemize}
\item AR SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:org6654218}
\begin{itemize}
...
\item Genetics
\label{sec:orgd452951}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf2a5125}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:org974f158}
\subsection{Introduction}
\label{sec:org1e205b7}
...
\caption{\label{fig:org96783b2}Cysteine vs Cystine}
\end{figure}
...
kinase (ADK)
\item homocysteine has two metabolic pathways (Figure \ref{fig:orgb562ca7}):
\begin{enumerate}
...
\caption{\label{fig:org39aefda}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:orgb562ca7}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:org8d200f9}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:orged6cf54}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org246db56}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org72a8230}
\begin{itemize}
\item AR MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org5008ea4}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgf97ee12}
\begin{itemize}
\item AR CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orga0343df}
\begin{itemize}
...
\label{sec:org971bafd}
\subsubsection{Clinical Presentation}
\label{sec:orgb94b107}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org1b6ad89}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgc3fc011}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3624aa6}
\begin{itemize}
...
\label{sec:orgbfca95f}
\subsubsection{Clinical Presentation}
\label{sec:org427fb77}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org41066f5}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgd1643eb}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:orgf7f0f4b}
\subsection{Introduction}
\label{sec:org86ea523}
\begin{itemize}
...
\caption{\label{fig:org081b0d6}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:orga88d2ee}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:org34527f0}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:orgb4af4d7}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgb5e7079}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org953b401}
\begin{itemize}
\item AR OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org8451d1f}
\begin{itemize}
...
\item see figure \ref{fig:org34527f0} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:orge7dea57}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org15da11a}
\begin{itemize}
\item AR/AD ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgb9f37f0}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org683fad6}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgd9a81d9}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:orgd4499b2} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:orgd4499b2} enzyme 2)
\begin{itemize}
...
ketoglutarate dehydrogenase-like complex (Figure \ref{fig:orgd4499b2} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:orgd4499b2} enzyme 6b)
\begin{itemize}
\item KGDH may serve as an alternative route
\item 2-oxoadipic acid is dehydrogenated and decarboxylated to
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:orgd4499b2} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:orgd4499b2} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:orgd4499b2} enzyme 9)
...
(Figure \ref{fig:orgd4499b2} enzyme 10)
...
\caption{\label{fig:orgd4499b2}Tryptophan, hydroxylysine and lysine catabolic pathways}
\end{figure}
...
\caption{\label{fig:org11a5ee4}Tryptophan and lysine catabolic pathways}
\end{figure}

\subsection{Glutaric Aciduria Type I}
\label{sec:org27e8c7c}
\subsubsection{Clinical Presentation}
\label{sec:orga32ba43}
\begin{itemize}
...
\label{sec:orgb3cbecd}
\subsubsection{Clinical Presentation}
\label{sec:org29beb72}
\begin{description}
...
\label{sec:org84f9e2f}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgf37f547}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org1cdd3fe}
\begin{itemize}
\item AR ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org2820400}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org730573e}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:org055a846}
\subsection{Introduction}
\label{sec:org146c030}
\begin{itemize}
...
\caption{\label{fig:orgd63fddc}Glycine cleavage enzyme}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:org98ed883}Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org123133c}
\subsubsection{Severe Classic NKH}
\label{sec:org53ac90a}
\begin{itemize}
\item neonatal onset
...
\label{sec:org75459a9}
\subsection{Glutamine Metabolism}
\label{sec:org8a75fdb}
\begin{itemize}
...
\caption{\label{fig:org27b89ee}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orgc2eb9df}
\begin{itemize}
...
\section{Transport}
\label{sec:org588a8c5}
\subsection{Introduction}
\label{sec:orgc8c2735}
\begin{itemize}
...
\caption{\label{fig:org7efec51}Cystine}
\end{figure}

\subsubsection{Neutral  Amino Acids}
\label{sec:org26756b1}
\begin{itemize}
...
\caption{\label{fig:orgc0828cc}Simplified schematic representation of cationic and neutral amino acid transport in epithelial cells}
\end{figure}

\subsection{Cystinuria}
\label{sec:org66de038}
\subsubsection{Clinical Presentation}
\label{sec:org1e49211}
\begin{itemize}
...
\label{sec:org6b0ff38}
\subsubsection{Clinical Presentation}
\label{sec:orge101122}
\begin{itemize}
...
\label{sec:org473e5ab}
\subsubsection{Clinical Presentation}
\label{sec:orgffddc57}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0b01969}
\begin{itemize}
\item AR SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3b123a0}
\begin{itemize}
