...
\label{sec:org2aea81b}
\subsection{Introduction}
\label{sec:org1a683f7}
\begin{itemize}
...
\label{sec:org25afd93}
\begin{enumerate}
\item Diet
\label{sec:org8464820}
\begin{itemize}
...
\label{sec:orgf60fc46}
\subsubsection{Clinical Presentation}
\label{sec:org103e190}
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgab9264e}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figure \ref{fig:org2445da5})
...
\begin{table}[htbp]
\caption{\label{tab:orgf351089}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org87773c1}} & primapterin\textsuperscript{\ref{org87773c1}} & CSF 5HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org87773c1}blood or urine}

\subsubsection{Treatment}
\label{sec:org84e374a}
\begin{itemize}
\item BH\(_{\text{4}}\)
...
\section{Tyrosine}
\label{sec:org5067940}
\subsection{Introduction}
\label{sec:org0517cd5}
...
\label{sec:orge45fd1d}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgf333c4c}
\begin{itemize}
...
\label{sec:orgbeabfc3}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org73ccc3f}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org63b161c}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org033d4c1}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org101d2e9}
\begin{itemize}
\item AR, HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org580d561}
\begin{itemize}
...
\label{sec:org4352c0c}
\subsubsection{Clinical Presentation}
\label{sec:org6c0aa0b}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org4e31683}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org592fe98}
\begin{itemize}
...
\label{sec:org1d28c06}
\subsubsection{Clinical Presentation}
\label{sec:org7013a6d}
\begin{itemize}
...
\section{BCAA}
\label{sec:orgb650ffe}
\subsection{Introduction}
\label{sec:org3819cfd}
\begin{itemize}
...
\label{sec:org5801d05}
\subsubsection{Clinical Presentation}
\label{sec:org67c2e47}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org1e3e24f}
\begin{enumerate}
\item MSUD
\label{sec:orgeac57fe}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgafb4507}
\begin{description}
\item[{MSUD}] AR, E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR, IVD
\item[{PA}] AR, PCCB
\item[{MMA}] AR, MUT or cobalamin system (Table \ref{tab:org8a968a0})
\begin{itemize}
...
MMADHC & cblD\\
\end{tabular}
\end{table}\footnotetext[2]{\label{org8898e11}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:orgb2de1f3}
\begin{enumerate}
\item MSUD
\label{sec:org4589a32}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org22e4dfe}
\begin{itemize}
\item AR, MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org449beac}
\begin{itemize}
\item \(\Uparrow\) 3-HIVA
...
\section{Urea Cycle}
\label{sec:org0e2cc37}
\subsection{Introduction}
\label{sec:org82287e9}
\begin{itemize}
...
\label{sec:org452c1a2}
\begin{enumerate}
\item Newborns
\label{sec:orga42993f}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgf80f577}
\begin{itemize}
\item AR, ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org6264558}
\begin{itemize}
...
\label{sec:org07cf41b}
\subsubsection{HHH Syndrome}
\label{sec:org5664281}
\begin{itemize}
\item see section \ref{sec:orgdbe71c3}
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org701161c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgcfb031a}
\begin{itemize}
...
\item Genetics
\label{sec:orgb503c1f}
\begin{itemize}
\item AR, SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:org243c74b}
\begin{itemize}
...
\item Genetics
\label{sec:org0fddcaf}
\begin{itemize}
\item AR, CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:orgaeb8e39}
\begin{itemize}
...
\label{sec:org0c13cba}
\subsection{Introduction}
\label{sec:orgaf0b4ca}
\begin{itemize}
...
\caption{\label{fig:org03b0861}
Disorders of sulfur amino acid metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org41de9f9}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org129e9bc}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orge4f6e33}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgd7a1fc6}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb54855c}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org56ea804}
\begin{itemize}
...
\label{sec:org6de3ed2}
\subsubsection{Clinical Presentation}
\label{sec:org9fc22e4}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org5cab45b}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org578a38f}
\begin{itemize}
\item AR, SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org53f4291}
\begin{itemize}
...
\label{sec:orgfa844b7}
\subsubsection{Clinical Presentation}
\label{sec:orgb2eae22}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgc1d37aa}
\begin{itemize}
\item AR, ETHE1, rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org84a70d1}
\begin{itemize}
...
\label{sec:orgdbe71c3}
\subsection{Introduction}
\label{sec:orgc7fed05}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgbf792a1}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org80beea3}
\begin{itemize}
...
\label{sec:orgbdcbcbe}
\begin{itemize}
\item \(\Delta\)1-Pyrroline-5-Carboxylate Synthetase Deficiency
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org701bded}
\begin{itemize}
\item central and peripheral neurological
\item see figure \ref{fig:org522b5d0} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:org1534583}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org9baa093}
\begin{itemize}
\item AR/AD, ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org8138c05}
\begin{itemize}
...
\label{sec:org08e60bc}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org534fc53}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org57adc7a}
\begin{itemize}
\item AR, ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgfe6d8d6}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org10486fb}
\begin{itemize}
\item AR, PEPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org658d10b}
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:orge500242} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid and the
peroxisomal key enzyme, pipecolic acid oxidase (Figure \ref{fig:orge500242} enzyme 2)
\begin{itemize}
...
2-oxoglutarate dehydrogenase-like complex (Figure \ref{fig:orge500242} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:orge500242} enzyme 6b)
...
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:orge500242} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:orge500242} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:orge500242} enzyme 9)
...
(Figure \ref{fig:orge500242} enzyme 10)
...
\label{sec:org3f351c4}
\subsubsection{Clinical Presentation}
\label{sec:orgccec4ec}
\begin{description}
...
\label{sec:org5850b77}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org84dfd56}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgeaa77b0}
\begin{itemize}
\item AR, ASPAragine
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org293e367}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org1f31790}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:org9caa3a7}
\subsection{Introduction}
\label{sec:org234ac98}
\begin{itemize}
...
\caption{\label{fig:orgd50f1ad}
Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:orge2ff494}
\subsubsection{Severe Classic NKH}
\label{sec:orgfc68df9}
\begin{itemize}
\item neonatal onset
...
\label{sec:orgcf971d7}
\subsection{Glutamine Metabolism}
\label{sec:org4a92592}
\begin{itemize}
...
\caption{\label{fig:org1772e0d}
Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orga510570}
\begin{itemize}
...
\section{Transport}
\label{sec:orgfac5b5b}
\subsection{Introduction}
\label{sec:org99d9eea}
\begin{itemize}
...
\label{sec:org077d60a}
\subsubsection{Clinical Presentation}
\label{sec:org6ab5178}
\begin{itemize}
...
\label{sec:orgb65421e}
\subsubsection{Clinical Presentation}
\label{sec:org689885f}
\begin{itemize}
...
\label{sec:org03b56d0}
\subsubsection{Clinical Presentation}
\label{sec:org90b3eaa}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org55a1152}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orga4d3dd8}
\begin{itemize}
