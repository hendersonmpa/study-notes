...
\label{sec:org1cca8d4}
\subsection{Introduction}
\label{sec:org88433cb}
\begin{itemize}
...
\caption{\label{fig:org0bd6d70}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:org5f0a55f}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:org11f4005}Tetrahydrobiopterin Metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:orgc6e7402}Phenylalaninemia Classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org5d6e860}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:orgba4ee50}
\subsubsection{Clinical Presentation}
\label{sec:org54eccef}
\begin{itemize}
...
\label{sec:org2d9c69f}
\begin{enumerate}
\item Diet
\label{sec:orgf02fade}
\begin{itemize}
...
\label{sec:org2f2201a}
\subsubsection{Clinical Presentation}
\label{sec:orgf089cc5}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org4b056fb}blood or urine}
...
\label{sec:orgec1178a}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org53c62b0}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org6d89940}
\begin{itemize}
\item AR HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgdebce28}
\begin{itemize}
...
\label{sec:org416d5e4}
\subsubsection{Clinical Presentation}
\label{sec:org06e9081}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0183694}
\begin{itemize}
\item AR HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org3dded9b}
\begin{itemize}
...
\label{sec:orgb7bdb01}
\subsubsection{Clinical Presentation}
\label{sec:org7de67f1}
\begin{itemize}
...
\section{BCAA}
\label{sec:org5260db5}
\subsection{Introduction}
\label{sec:org42fafe4}
\begin{itemize}
...
\caption{\label{fig:orgff0db7f}BCAA Catabolism}
\end{figure}
...
\label{sec:orgd9f75a7}
\subsubsection{Clinical Presentation}
\label{sec:orgc757481}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:orge61bd5e}
\begin{enumerate}
\item MSUD
\label{sec:org1208fe4}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb6489be}
\begin{description}
\item[{MSUD}] AR E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR IVD
\item[{PA}] AR PCCB \& PCCB
\item[{MMA}] AR MUT or cobalamin system (Table \ref{tab:org67932f2})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org67932f2}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
Gene & Protein\\
\hline
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org5b3a6b3}deficiency of CblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org721f029}
\begin{enumerate}
\item MSUD
\label{sec:org80f6b57}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgfce0b26}
\begin{itemize}
\item AR MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgb09f2d3}
\begin{itemize}
\item \(\Uparrow\) 3-hydroxyisovaleric
...
\caption{\label{fig:org311863a}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org205c56f}Urea Cycle}
\end{figure}
...
\caption{\label{fig:orgd38b8b1}Diagnostic Algorithm that can be Applied to any Hyperammonaemic Patient}
\end{figure}

\subsection{Mitochondrial UCDs}
\label{sec:org6add2fe}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orgb31ea6c}
\begin{enumerate}
\item Newborns
\label{sec:org8a4be40}
\begin{itemize}
...
\label{sec:orgf1829fb}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgdc5fc52}
\begin{itemize}
...
\item Genetics
\label{sec:orge07f7fa}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd6c9fd5}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:org2c76d88}
\subsection{Introduction}
\label{sec:orgac28c61}
...
\caption{\label{fig:orge05724e}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:orgab7b563}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:orged4fd4b}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org6efabf9}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org32c28bc}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgd142399}
\begin{itemize}
\item AR MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org27b4217}
\begin{itemize}
...
\label{sec:org69665ad}
\subsubsection{Clinical Presentation}
\label{sec:org6160f58}
\begin{itemize}
...
\label{sec:orge7d80fb}
\subsubsection{Clinical Presentation}
\label{sec:org51e6fd0}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgc225ee9}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org8eec0f2}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org9a6bc4a}
\begin{itemize}
...
\label{sec:orgee2bcfe}
\subsubsection{Clinical Presentation}
\label{sec:org9877264}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgd540a9b}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgad89406}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:orgde49ee9}
\subsection{Introduction}
\label{sec:orge5d4271}
\subsubsection{Ornitine}
\label{sec:orge53ae33}
\begin{itemize}
...
\caption{\label{fig:org481b03a}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:org5b7023e}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:org0e58315}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:orgdec185d}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgf624b98}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org6a1ccd9}
\begin{itemize}
\item AR OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgf5b5652}
\begin{itemize}
...
\label{sec:org610c19d}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orge3b432a}
\begin{itemize}
...
\label{sec:org43accfe}
\begin{itemize}
\item Hyperprolinaemia Type II
\end{itemize}

\subsubsection{Clinical Presentation}
\label{sec:orgf30afed}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org63f62f9}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org576d7ba}
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org15791eb} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org15791eb} enzyme 9)
...
(Figure \ref{fig:org15791eb} enzyme 10)
\end{itemize}
...
\caption{\label{fig:org15791eb}Tryptophan, Hydroxylysine and Lysine Catabolic Pathways}
\end{figure}
...
\caption{\label{fig:orga75a86c}Tryptophan and Lysine Catabolic Pathways}
\end{figure}

\subsubsection{Cerebral Organic Acidurias}
\label{sec:org3df6637}
\begin{itemize}
...
\label{sec:org22088f6}
\subsubsection{Clinical Presentation}
\label{sec:org897195d}
\begin{itemize}
...
\label{sec:org377732d}
\subsubsection{Clinical Presentation}
\label{sec:org1560e3a}
\begin{description}
...
\label{sec:org985e894}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org81ac95f}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga3a081a}
\begin{itemize}
\item AR ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgdd6eec6}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org810b7f1}
\begin{itemize}
\item none
\end{itemize}

\section{Non-Ketotic Hyperglycinemia}
\label{sec:orga2e9285}
\subsection{Introduction}
\label{sec:orgbaa2ec2}
\begin{itemize}
...
\caption{\label{fig:org714b7b3}Glycine Cleavage System}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:orgcf80228}Activation of Lipoate Dependant Enzymes}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:orgbf5c9ea}
\subsubsection{Severe Classic NKH}
\label{sec:org8a4091e}
\begin{itemize}
\item neonatal onset
...
\label{sec:orga30acb8}
\subsection{Glutamine Metabolism}
\label{sec:org413d35a}
\begin{itemize}
...
\caption{\label{fig:orgea19083}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orgfc51902}
\begin{itemize}
...
\section{Transport}
\label{sec:orgbedbd6a}
\subsection{Introduction}
\label{sec:orge346f45}
\begin{itemize}
...
\caption{\label{fig:org8f2947d}Amino Acid Classes}
\end{figure}

\subsubsection{Dibasic Amino Acids}
\label{sec:org0e401e2}
\begin{itemize}
...
\caption{\label{fig:org28ded85}Cystine}
\end{figure}

\subsubsection{Neutral  Amino Acids}
\label{sec:orgd8f357c}
\begin{itemize}
...
\caption{\label{fig:org5c0430b}Cationic and Neutral Amino Acid Transport in Epithelial Cells}
\end{figure}


\subsection{Cystinuria}
\label{sec:org26e9366}
\subsubsection{Clinical Presentation}
\label{sec:org7b461a7}
\begin{itemize}
...
\label{sec:org34e3665}
\subsubsection{Clinical Presentation}
\label{sec:org79607f6}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgf9cab15}
\begin{itemize}
\item AR SLC7A7
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org62045aa}
\begin{itemize}
...
\label{sec:orgdf215cd}
\subsubsection{Clinical Presentation}
\label{sec:org3f94c18}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org68888a5}
\begin{itemize}
\item AR SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgd623543}
\begin{itemize}
