...
\label{sec:orgc549be9}
\subsection{Introduction}
\label{sec:org7fe3136}
\begin{itemize}
...
\label{sec:org94f168c}
\begin{enumerate}
\item Diet
\label{sec:orgeac34a4}
\begin{itemize}
...
\label{sec:orgecbfe27}
\subsubsection{Clinical Presentation}
\label{sec:org5922264}
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org08563ad}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figure \ref{fig:org6d3de19})
...
\begin{table}[htbp]
\caption{\label{tab:orgbbc5c98}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{orge02c77f}} & primapterin\textsuperscript{\ref{orge02c77f}} & CSF 5HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orge02c77f}blood or urine}

\subsubsection{Treatment}
\label{sec:orgb285f36}
\begin{itemize}
\item BH\(_{\text{4}}\)
...
\section{Tyrosine}
\label{sec:org4f83734}
\subsection{Introduction}
\label{sec:org5afd21f}
...
\label{sec:org860db19}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org6772b24}
\begin{itemize}
...
\label{sec:org4d8c398}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgadd80ef}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org63e6c65}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org80e580a}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgd3b6f56}
\begin{itemize}
\item AR, HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orga91211a}
\begin{itemize}
...
\label{sec:org27b2466}
\subsubsection{Clinical Presentation}
\label{sec:org248268d}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgad5becd}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org9de88cd}
\begin{itemize}
...
\label{sec:org3bb3bbb}
\subsubsection{Clinical Presentation}
\label{sec:org60fb238}
\begin{itemize}
...
\section{BCAA}
\label{sec:org289e45d}
\subsection{Introduction}
\label{sec:org262992b}
\begin{itemize}
...
\label{sec:org7653efb}
\subsubsection{Clinical Presentation}
\label{sec:orgb4e8767}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:orgb38284c}
\begin{enumerate}
\item MSUD
\label{sec:orgb178a64}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org3fce2d5}
\begin{description}
\item[{MSUD}] AR, E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR, IVD
\item[{PA}] AR, PCCB
\item[{MMA}] AR, MUT or cobalamin system (Table \ref{tab:org1225ed4})
\begin{itemize}
...
MMADHC & cblD\\
\end{tabular}
\end{table}\footnotetext[2]{\label{orgd39e981}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org8553f13}
\begin{enumerate}
\item MSUD
\label{sec:orgaa9f8b7}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgb1db5ab}
\begin{itemize}
\item AR, MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgf102afb}
\begin{itemize}
\item \(\Uparrow\) 3-HIVA
...
\section{Urea Cycle}
\label{sec:org8d6c7ea}
\subsection{Introduction}
\label{sec:org332baaf}
\begin{itemize}
...
\label{sec:org9c406a5}
\begin{enumerate}
\item Newborns
\label{sec:orge0ccee0}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgef77759}
\begin{itemize}
\item AR, ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org4e13071}
\begin{itemize}
...
\label{sec:org79e8f66}
\subsubsection{HHH Syndrome}
\label{sec:org5a82f91}
\begin{itemize}
\item see section \ref{sec:org82ac86f}
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org8c5a70c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org000f044}
\begin{itemize}
...
\item Genetics
\label{sec:org8d303f3}
\begin{itemize}
\item AR, SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:org7bece52}
\begin{itemize}
...
\item Genetics
\label{sec:org534069e}
\begin{itemize}
\item AR, CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org648d782}
\begin{itemize}
...
\label{sec:org2ebf93e}
\subsection{Introduction}
\label{sec:org93da7fa}
\begin{itemize}
...
\caption{\label{fig:orge567d97}
Disorders of sulfur amino acid metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org883677c}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgd615363}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org7c4ae4c}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org4a30e01}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org878a2c6}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org5d2fbd2}
\begin{itemize}
...
\label{sec:org6199e48}
\subsubsection{Clinical Presentation}
\label{sec:org21bdcd4}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgad80f5c}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org7feeebf}
\begin{itemize}
\item AR, SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org229909b}
\begin{itemize}
...
\label{sec:org9092a35}
\subsubsection{Clinical Presentation}
\label{sec:orge118d2e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgd5a046d}
\begin{itemize}
\item AR, ETHE1, rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgeadb60a}
\begin{itemize}
...
\label{sec:org82ac86f}
\subsection{Introduction}
\label{sec:org955a6b8}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org373bf6c}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orge319b89}
\begin{itemize}
...
\label{sec:org43d9133}
\begin{itemize}
\item \(\Delta\)1-Pyrroline-5-Carboxylate Synthetase Deficiency
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org0fea8d4}
\begin{itemize}
\item central and peripheral neurological
\item see figure \ref{fig:org3d7932c} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:org685b8e6}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org54400f7}
\begin{itemize}
\item AR/AD, ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3d37083}
\begin{itemize}
...
\label{sec:orgf9cbded}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgcd782bb}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org42e184c}
\begin{itemize}
\item AR, ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org80cb827}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgf138125}
\begin{itemize}
\item AR, PEPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org80fa3ba}
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org9b96ea2} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid and the
peroxisomal key enzyme, pipecolic acid oxidase (Figure \ref{fig:org9b96ea2} enzyme 2)
\begin{itemize}
...
2-oxoglutarate dehydrogenase-like complex (Figure \ref{fig:org9b96ea2} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org9b96ea2} enzyme 6b)
...
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org9b96ea2} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org9b96ea2} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org9b96ea2} enzyme 9)
...
(Figure \ref{fig:org9b96ea2} enzyme 10)
...
\label{sec:org1840134}
\subsubsection{Clinical Presentation}
\label{sec:orgbb5047d}
\begin{description}
...
\label{sec:org58952e1}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgd9b8b81}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org5fb3236}
\begin{itemize}
\item AR, ASPAragine
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org894845e}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org97bb0ff}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:orgb93b334}
\subsection{Introduction}
\label{sec:orgf36dfb6}
\begin{itemize}
...
\caption{\label{fig:org1c64ecd}
Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org5460718}
\subsubsection{Severe Classic NKH}
\label{sec:org0c21631}
\begin{itemize}
\item neonatal onset
...
\label{sec:org1a719d8}
\subsection{Glutamine Metabolism}
\label{sec:org95259dc}
\begin{itemize}
...
\caption{\label{fig:org90e54da}
Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org8e0ad57}
\begin{itemize}
...
\section{Transport}
\label{sec:org1efc40f}
\subsection{Introduction}
\label{sec:org32d1dba}
\begin{itemize}
...
\label{sec:orgcdaf0f1}
\subsubsection{Clinical Presentation}
\label{sec:org5c13ef5}
\begin{itemize}
...
\label{sec:orgbfc0894}
\subsubsection{Clinical Presentation}
\label{sec:org9088cba}
\begin{itemize}
...
\label{sec:orge4d8748}
\subsubsection{Clinical Presentation}
\label{sec:org817ce4d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org6c129e8}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org22dfc0b}
\begin{itemize}
