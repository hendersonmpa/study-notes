...
\label{sec:org4bcbb62}
\subsection{Introduction}
\label{sec:orgdbbbfcb}
\begin{itemize}
...
\caption{\label{fig:orgb2eade6}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:org5570851}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:org248f250}Tetrahydrobiopterin metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:orga131537}Phenylalaninemia classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgc89b6c4}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:org80586c5}
\subsubsection{Clinical Presentation}
\label{sec:orga150de0}
\begin{itemize}
...
\label{sec:org0f286ee}
\begin{enumerate}
\item Diet
\label{sec:org80812d2}
\begin{itemize}
...
treatment of responsive\textsuperscript{\ref{orgc89b6c4}} patients with HPA and PKU, of all
ages
\end{itemize}
\item Alternative/Experimental
\label{sec:org7121afe}
\begin{itemize}
...
\label{sec:org4f97347}
\subsubsection{Clinical Presentation}
\label{sec:org2e58e2b}
\begin{itemize}
...
\label{sec:org5db1be1}
\begin{itemize}
\item disorders of BH\textsubscript{4} metabolism associated with HPA and biogenic amine deficiency (Figure \ref{fig:org248f250})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgce45b0b}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:orgb2eade6}
and \ref{fig:org248f250})
...
\subsubsection{Diagnostic Tests}
\label{sec:orge9ebe6e}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:org2d61b40})
...
\begin{table}[htbp]
\caption{\label{tab:org2d61b40}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org0009bda}} & primapterin\textsuperscript{\ref{org0009bda}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org0009bda}blood or urine}

\subsubsection{Treatment}
\label{sec:org91e9047}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:org40d5b4a}
\subsection{Introduction}
\label{sec:org2e20ea9}
\begin{itemize}
...
\caption{\label{fig:orgdfe91b3}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:org5580fb3}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:org103b39e}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org5ce11ce}
\begin{itemize}
...
\label{sec:org1077000}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org32eb1da}
\begin{itemize}
...
4-hydroxyphenyllactate and 4-hydroxyphenylacetate via AST (Figure \ref{fig:orgdfe91b3})
\end{itemize}

\subsubsection{Genetics}
\label{sec:orgdbdd494}
\begin{itemize}
\item AR TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org07eb3e1}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgc1743c7}
\begin{itemize}
\item AR HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org3d9e254}
\begin{itemize}
...
\label{sec:org06ff1fc}
\subsubsection{Clinical Presentation}
\label{sec:orgeb5931c}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orge7668e8}
\begin{itemize}
\item AR HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org889d8f3}
\begin{itemize}
...
\label{sec:orgff3aa7e}
\subsubsection{Clinical Presentation}
\label{sec:org0f5e52f}
\begin{itemize}
...
\section{BCAA}
\label{sec:orgb17e5fb}
\subsection{Introduction}
\label{sec:org1361881}
\begin{itemize}
...
\caption{\label{fig:orgb510401}BCAA catabolism}
\end{figure}
...
\label{sec:org363970d}
\subsubsection{Clinical Presentation}
\label{sec:org352e757}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org74df530}
\begin{enumerate}
\item MSUD
\label{sec:org6be494e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga75219f}
\begin{description}
\item[{MSUD}] AR E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR IVD
\item[{PA}] AR PCCB
\item[{MMA}] AR MUT or cobalamin system (Table \ref{tab:org5507cb4})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org5507cb4}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
Gene & Protein\\
\hline
...
\end{tabular}
\end{table}\footnotetext[4]{\label{orgff39e2f}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org50b173b}
\begin{enumerate}
\item MSUD
\label{sec:orgcf6940b}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgd100f5a}
\begin{itemize}
\item AR MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org1f078cb}
\begin{itemize}
...
\section{Urea Cycle}
\label{sec:org310ec66}
\subsection{Introduction}
\label{sec:orgc377d74}
\begin{itemize}
...
\caption{\label{fig:orgc936876}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org50ef2c0}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org212226a}Diagnostic algorithm that can be applied to any hyperammonaemic patient}
\end{figure}

\subsection{Mitochondrial}
\label{sec:org3fd5451}
\begin{itemize}
...
\caption{\label{fig:org63190b8}Nitrogen elimination by phenylbutyrate and benzoate}
\end{figure}

\item Prognosis
\label{sec:org5ceae5e}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org785e375}
\begin{enumerate}
\item Newborns
\label{sec:org484ae4a}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgc424993}
\begin{itemize}
\item AR ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3a2c1f7}
\begin{itemize}
...
\label{sec:org0e20a83}
\subsubsection{HHH Syndrome}
\label{sec:org481e619}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:org2eabab2})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org8e464a7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb0458c0}
\begin{itemize}
...
\item Genetics
\label{sec:org734d9af}
\begin{itemize}
\item AR SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:orgecf9b50}
\begin{itemize}
...
\item Genetics
\label{sec:org49520fd}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org19ed6d4}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:org737a274}
\subsection{Introduction}
\label{sec:orgdb6502c}
...
\caption{\label{fig:orgae88811}Cysteine vs Cystine}
\end{figure}
...
kinase (ADK)
\item homocysteine has two metabolic pathways (Figure \ref{fig:org7eab1bd}):
\begin{enumerate}
...
\caption{\label{fig:org48d219d}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:org7eab1bd}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:org92267c8}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org5b264c8}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org1599db2}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org076e21e}
\begin{itemize}
\item AR MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgca67a0e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org753ed44}
\begin{itemize}
\item AR CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgf2866f0}
\begin{itemize}
...
\label{sec:org69c2312}
\subsubsection{Clinical Presentation}
\label{sec:org468f1f6}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org6f800aa}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgb578db1}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orga8c24c5}
\begin{itemize}
...
\label{sec:orgd6277eb}
\subsubsection{Clinical Presentation}
\label{sec:orgd058647}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org25c6643}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orge828f68}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:org2eabab2}
\subsection{Introduction}
\label{sec:orgf412148}
\begin{itemize}
...
\caption{\label{fig:orge363ef7}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:orge73cc16}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:org1354019}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:org6955f8b}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgc364a94}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org135f1af}
\begin{itemize}
\item AR OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org56211e7}
\begin{itemize}
...
\item see figure \ref{fig:org1354019} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:orgb215157}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org8483f0d}
\begin{itemize}
\item AR/AD ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org95e81af}
\begin{itemize}
...
\label{sec:org8134f26}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org3756071}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org794b0aa}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3855d2e}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org1b08b82} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:org1b08b82} enzyme 2)
\begin{itemize}
...
ketoglutarate dehydrogenase-like complex (Figure \ref{fig:org1b08b82} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org1b08b82} enzyme 6b)
\begin{itemize}
\item KGDH may serve as an alternative route
\item 2-oxoadipic acid is dehydrogenated and decarboxylated to
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org1b08b82} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org1b08b82} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org1b08b82} enzyme 9)
...
(Figure \ref{fig:org1b08b82} enzyme 10)
...
\caption{\label{fig:org1b08b82}Tryptophan, hydroxylysine and lysine catabolic pathways}
\end{figure}
...
\caption{\label{fig:orgda11d58}Tryptophan and lysine catabolic pathways}
\end{figure}

\subsection{Glutaric Aciduria Type I}
\label{sec:orgb308000}
\subsubsection{Clinical Presentation}
\label{sec:orgf277eef}
\begin{itemize}
...
\label{sec:orga443257}
\subsubsection{Clinical Presentation}
\label{sec:orgbd8e124}
\begin{description}
...
\label{sec:org19573e2}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org486a5ca}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgc5a68bf}
\begin{itemize}
\item AR ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3739d50}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgb83e86f}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:org634faa0}
\subsection{Introduction}
\label{sec:org42fb9de}
\begin{itemize}
...
\caption{\label{fig:orgf767263}Glycine cleavage enzyme}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:org968894a}Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org272b123}
\subsubsection{Severe Classic NKH}
\label{sec:orgee68933}
\begin{itemize}
\item neonatal onset
...
\label{sec:org635dc40}
\subsection{Glutamine Metabolism}
\label{sec:org4aaa53e}
\begin{itemize}
...
\caption{\label{fig:orga4540b2}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org02d0263}
\begin{itemize}
...
\section{Transport}
\label{sec:orgb5432c2}
\subsection{Introduction}
\label{sec:org7874168}
\begin{itemize}
...
\caption{\label{fig:orgad69062}Cystine}
\end{figure}

\subsubsection{Neutral  Amino Acids}
\label{sec:org655e22b}
\begin{itemize}
...
\caption{\label{fig:org1aa242b}Simplified schematic representation of cationic and neutral amino acid transport in epithelial cells}
\end{figure}

\subsection{Cystinuria}
\label{sec:org1d72cc0}
\subsubsection{Clinical Presentation}
\label{sec:org7fdc7bc}
\begin{itemize}
...
\label{sec:org493375d}
\subsubsection{Clinical Presentation}
\label{sec:orgd0b69f2}
\begin{itemize}
...
\label{sec:org61103d8}
\subsubsection{Clinical Presentation}
\label{sec:org45a6db5}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge61b45c}
\begin{itemize}
\item AR SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org42d1786}
\begin{itemize}
