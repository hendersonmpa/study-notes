...
\label{sec:orgf675762}
\subsection{Introduction}
\label{sec:org037b027}
\begin{itemize}
...
\item defects in PAH and those involving production or recycling of BH\textsubscript{4}
...
\begin{table}[htbp]
\caption{\label{tab:org3dca727}Phenylalaninemia classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org85d2803}mild hyperphenylalaninaemia

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/pah.png}
\caption{\label{fig:org3b21b8a}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:org10da520}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:org7f03638}Tetrahydrobiopterin metabolism}
\end{figure}}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:org39851fe}
\subsubsection{Clinical Presentataion}
\label{sec:org987c323}
\begin{itemize}
...
\label{sec:orgd985208}
\begin{enumerate}
\item Diet
\label{sec:orge8a50ab}
\begin{itemize}
...
treatment of responsive\textsuperscript{\ref{org85d2803}} patients with HPA and PKU, of all
ages \textsuperscript{\ref{org85d2803}}defined as reduction of \(\ge\)30\% in blood phenylalanine
after a single dose
\end{itemize}
\item Alternative/Experimental
\label{sec:orgbeacf39}
\begin{itemize}
...
\label{sec:orgc76efae}
\subsubsection{Clinical Presentation}
\label{sec:org401f133}
\begin{itemize}
...
\label{sec:org8b1f0b6}
\begin{itemize}
\item disorders of BH\textsubscript{4} associated with HPA and biogenic amine deficiency (Figure \ref{fig:org7f03638})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org162334f}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:org3b21b8a}
and \ref{fig:org7f03638})
...
\subsubsection{Diagnostic Tests}
\label{sec:orgc2e6ad4}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:org1c1a4a8})
...
\begin{table}[htbp]
\caption{\label{tab:org1c1a4a8}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org6a7f051}} & primapterin\textsuperscript{\ref{org6a7f051}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org6a7f051}blood or urine}

\subsubsection{Treatment}
\label{sec:orgc864ca9}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:org7065946}
\subsection{Introduction}
\label{sec:org0df5c91}
\begin{itemize}
...
\caption{\label{fig:org8335263}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:orgd680d70}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:orga173bb2}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgd31acce}
\begin{itemize}
...
\label{sec:orgf4cd94b}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgaaa715b}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org5c7eb28}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org17cf6f7}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org49d32ca}
\begin{itemize}
\item AR, HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org6b15858}
\begin{itemize}
...
\label{sec:org8eb21a4}
\subsubsection{Clinical Presentation}
\label{sec:orgf628713}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org2ba6adb}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgdfc065f}
\begin{itemize}
...
\label{sec:org497960f}
\subsubsection{Clinical Presentation}
\label{sec:orgd2a4e30}
\begin{itemize}
...
\section{BCAA}
\label{sec:org627f31a}
\subsection{Introduction}
\label{sec:orgb1495bb}
\begin{itemize}
...
\caption{\label{fig:orgbc856b0}BCAA catabolism}
\end{figure}
...
\caption{\label{fig:orge96aff6}BCAA catabolism}
\end{figure}
...
\label{sec:org6cac911}
\subsubsection{Clinical Presentation}
\label{sec:orgc25d8fb}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org213e007}
\begin{enumerate}
\item MSUD
\label{sec:org8a975e6}
\begin{itemize}
...
\item MMA
\label{sec:org35acd36}
\begin{itemize}
\item deficiency of methylmalonyl-CoA mutase (MCM)
\begin{itemize}
\item B\textsubscript{12} dependent-enzyme
...
\subsubsection{Genetics}
\label{sec:org7838cc4}
\begin{description}
\item{MSUD} AR, E1\(\alpha\), E1\(\beta\) and E2
\item{IVA} AR, IVD
\item{PA} AR, PCCB
\item{MMA} AR, MUT or cobalamin system (Table \ref{tab:org1ccef52})
\begin{itemize}
\item mut\^{}-(\(\downarrow\) activity), mut\textsuperscript{0} (zero activity)
\end{itemize}
\end{description}

\begin{table}[htbp]
\caption{\label{tab:org1ccef52}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
...
MMADHC & cblD\\
\end{tabular}
\end{table}\footnotetext[3]{\label{org1300f31}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:orgc6e8be3}
\begin{enumerate}
\item MSUD
\label{sec:org81767ad}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org6b12b16}
\begin{itemize}
\item AR, MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org0825905}
\begin{itemize}
...
\section{Urea Cycle}
\label{sec:orgbc56e57}
\subsection{Introduction}
\label{sec:orge87a5cb}
\begin{itemize}
...
\caption{\label{fig:orgba99a44}Urea Cycle}
\end{figure}
...
\caption{\label{fig:orgec383ec}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org8d03363}Diagnostic algorithm that can be applied to any hyperammonaemic patient}
\end{figure}

\subsection{Mitochondrial}
\label{sec:orga18d595}
\begin{itemize}
...
\caption{\label{fig:orgab9c54c}Nitrogen elimination by phenylbutyrate and benzoate}
\end{figure}

\item Prognosis
\label{sec:org91c9600}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org1a59116}
\begin{enumerate}
\item Newborns
\label{sec:org886c0d3}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org7bbe749}
\begin{itemize}
\item AR, ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgda0d3e8}
\begin{itemize}
...
\label{sec:org705c7fd}
\subsubsection{HHH Syndrome}
\label{sec:org1a87ab1}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:org7de9da8})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org71283de}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org84e839b}
\begin{itemize}
...
\item Genetics
\label{sec:org2090e3f}
\begin{itemize}
\item AR, SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:orgddfda9d}
\begin{itemize}
...
\item Genetics
\label{sec:org0a857e7}
\begin{itemize}
\item AR, CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org256e0dd}
\begin{itemize}
...
\label{sec:org875bf56}
\subsection{Introduction}
\label{sec:org4a81cb9}
\begin{itemize}
...
\caption{\label{fig:orgeb3bd8c}Cysteine vs Cystine}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfuraa.png}
\caption{\label{fig:org53effc3}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:orgb9c2e2e}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:orgde35172}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org87fa669}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org3e1913f}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org11a3e2b}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgef67c88}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgc8caa7a}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgb9a4774}
\begin{itemize}
...
\label{sec:org5ae4027}
\subsubsection{Clinical Presentation}
\label{sec:org0a150e6}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgf64e1d9}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgc564e69}
\begin{itemize}
\item AR, SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org909588b}
\begin{itemize}
...
\label{sec:org4637b2b}
\subsubsection{Clinical Presentation}
\label{sec:org4c4376c}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org302b1c8}
\begin{itemize}
\item AR, ETHE1, rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org0362d29}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:org7de9da8}
\subsection{Introduction}
\label{sec:org03eabd3}
\begin{itemize}
...
\caption{\label{fig:org1289937}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:org06762ea}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:orgf0281ab}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:orgf4149d9}
\subsubsection{Clinical Presentation}
\label{sec:org4129d32}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgda7c67a}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgcfbe21c}
\begin{itemize}
...
\item see figure \ref{fig:orgf0281ab} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:org0fa8650}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org25a986f}
\begin{itemize}
\item AR/AD, ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3583ad0}
\begin{itemize}
...
\label{sec:org95c91e8}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org12b6caf}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb677bfb}
\begin{itemize}
\item AR, ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgeb88864}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:orgba4b9fd} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:orgba4b9fd} enzyme 2)
\begin{itemize}
...
2-oxoglutarate dehydrogenase-like complex (Figure \ref{fig:orgba4b9fd} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:orgba4b9fd} enzyme 6b)
...
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:orgba4b9fd} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:orgba4b9fd} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:orgba4b9fd} enzyme 9)
...
(Figure \ref{fig:orgba4b9fd} enzyme 10)
...
\caption{\label{fig:orgba4b9fd}Tryptophan, hydroxylysine and lysine catabolic pathways}
\end{figure}
...
\caption{\label{fig:orga4fc0ef}Tryptophan and lysine catabolic pathways}
\end{figure}

\subsection{Glutaric Aciduria Type I}
\label{sec:orgfe6555d}
\subsubsection{Clinical Presentation}
\label{sec:orge99f39f}
\begin{itemize}
...
\label{sec:orgd43fb80}
\subsubsection{Clinical Presentation}
\label{sec:org12a4237}
\begin{description}
...
\label{sec:orgcc45eba}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org9acee9d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgbc7e6a3}
\begin{itemize}
\item AR, ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org51a1ddc}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgc1651d9}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:org35ffdf1}
\subsection{Introduction}
\label{sec:org0949539}
\begin{itemize}
...
\caption{\label{fig:orgd6f05e3}Glycine cleavage enzyme}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:orgd44e15c}Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:orgbc70549}
\subsubsection{Severe Classic NKH}
\label{sec:org70420b3}
\begin{itemize}
\item neonatal onset
...
\label{sec:org48681cc}
\subsection{Glutamine Metabolism}
\label{sec:org645f9a1}
\begin{itemize}
...
\caption{\label{fig:org3104c3a}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orge5f4f0c}
\begin{itemize}
...
\section{Transport}
\label{sec:org247a8df}
\subsection{Introduction}
\label{sec:org1f55611}
\begin{itemize}
...
\caption{\label{fig:org99e1d3e}Simplified schematic representation of cationic and neutral amino acid transport in epithelial cells}
\end{figure}

\subsection{Cystinuria}
\label{sec:org6b2afc5}
\subsubsection{Clinical Presentation}
\label{sec:orgaf9475a}
\begin{itemize}
...
\label{sec:org7946667}
\subsubsection{Clinical Presentation}
\label{sec:org7d164a7}
\begin{itemize}
...
\label{sec:orgc11960b}
\subsubsection{Clinical Presentation}
\label{sec:org6fe99ae}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org7daf3f9}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgcff3211}
\begin{itemize}
