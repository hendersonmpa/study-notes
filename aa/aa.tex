...
\label{sec:org941393d}
\subsection{Introduction}
\label{sec:orgaa4583e}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org0414a83}mild hyperphenylalaninaemia

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./phe/figures/pah.png}
\caption{\label{fig:org8cbb3cf}
...
\label{sec:org778b53b}
\begin{enumerate}
\item Diet
\label{sec:org0acab54}
\begin{itemize}
...
treatment of responsive\textsuperscript{\ref{org0414a83}} patients with HPA and PKU, of all
ages \textsuperscript{\ref{org0414a83}}defined as reduction of \(\ge\)30\% in blood phenylalanine
after a single dose
\end{itemize}
\item Alternative/Experimental
\label{sec:org91e954f}
\begin{itemize}
...
\label{sec:org990fa48}
\subsubsection{Clinical Presentation}
\label{sec:orgce4beaf}
\begin{itemize}
...
\label{sec:orge29f262}
\begin{itemize}
\item disorders of BH\(_{\text{4}}\) associated with HPA and biogenic amine deficiency (Figure \ref{fig:orga42aca1})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgfaf740c}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:org8cbb3cf}
and \ref{fig:orga42aca1})
...
\subsubsection{Diagnostic Tests}
\label{sec:org64563ec}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:org49fee8f})
...
\begin{table}[htbp]
\caption{\label{tab:org49fee8f}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{orga5282c4}} & primapterin\textsuperscript{\ref{orga5282c4}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{orga5282c4}blood or urine}

\subsubsection{Treatment}
\label{sec:orgd370761}
\begin{itemize}
\item BH\(_{\text{4}}\)
...
\section{Tyrosine}
\label{sec:org4d8cd90}
\subsection{Introduction}
\label{sec:org85c9be2}
\begin{itemize}
...
\label{sec:orgd4ea55b}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgc9ab165}
\begin{itemize}
...
\label{sec:orga9687cd}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgc9f3b56}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgfadb7f6}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org0e4814a}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org26640a1}
\begin{itemize}
\item AR, HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgff34783}
\begin{itemize}
...
\label{sec:org3860efc}
\subsubsection{Clinical Presentation}
\label{sec:org2c309d2}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org35dc77b}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org864c4f0}
\begin{itemize}
...
\label{sec:org7e6ea5c}
\subsubsection{Clinical Presentation}
\label{sec:org1ea3f88}
\begin{itemize}
...
\section{BCAA}
\label{sec:org9887c73}
\subsection{Introduction}
\label{sec:org3ff4213}
\begin{itemize}
...
\label{sec:org0ff88d0}
\subsubsection{Clinical Presentation}
\label{sec:orgde9ee17}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org4dabb87}
\begin{enumerate}
\item MSUD
\label{sec:org45dd207}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge287f72}
\begin{description}
\item[{MSUD}] AR, E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR, IVD
\item[{PA}] AR, PCCB
\item[{MMA}] AR, MUT or cobalamin system (Table \ref{tab:org088d919})
\begin{itemize}
...
MMADHC & cblD\\
\end{tabular}
\end{table}\footnotetext[3]{\label{org3642a4a}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org1813303}
\begin{enumerate}
\item MSUD
\label{sec:org7eb1dcb}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org6074590}
\begin{itemize}
\item AR, MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org51022d2}
\begin{itemize}
...
\section{Urea Cycle}
\label{sec:org9db1b4e}
\subsection{Introduction}
\label{sec:org1521030}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org746c375}
\begin{enumerate}
\item Newborns
\label{sec:orgd931aec}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org043d5ba}
\begin{itemize}
\item AR, ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org11cec2a}
\begin{itemize}
...
\label{sec:org274913e}
\subsubsection{HHH Syndrome}
\label{sec:org04bb3e6}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:org7205b54})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:orge906ee3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org126b337}
\begin{itemize}
...
\item Genetics
\label{sec:org3838a4d}
\begin{itemize}
\item AR, SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:org9b2b8fb}
\begin{itemize}
...
\item Genetics
\label{sec:orgd23c35f}
\begin{itemize}
\item AR, CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org6b6e934}
\begin{itemize}
...
\label{sec:org88a15e0}
\subsection{Introduction}
\label{sec:org34b28b5}
\begin{itemize}
...
\caption{\label{fig:org1f49524}
Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org52b96bd}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org0c08278}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org57d8b2a}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org2d22538}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgd4307d2}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgbd2d8a5}
\begin{itemize}
...
\label{sec:org32b09b3}
\subsubsection{Clinical Presentation}
\label{sec:orgbd9d769}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orga532cc5}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org135b6a6}
\begin{itemize}
\item AR, SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org470bcf9}
\begin{itemize}
...
\label{sec:org449c3f0}
\subsubsection{Clinical Presentation}
\label{sec:org07c424d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge24078d}
\begin{itemize}
\item AR, ETHE1, rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org1c8c279}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:org7205b54}
\subsection{Introduction}
\label{sec:org5a1e2ff}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org6fc79a4}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org4c61af0}
\begin{itemize}
...
\item see figure \ref{fig:orgd68c871} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:orgdf64658}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org07a0800}
\begin{itemize}
\item AR/AD, ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org2ce360d}
\begin{itemize}
...
\label{sec:org7614151}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org83dca50}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org541f80f}
\begin{itemize}
\item AR, ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org79e07a7}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:orge6f15cc} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:orge6f15cc} enzyme 2)
\begin{itemize}
...
2-oxoglutarate dehydrogenase-like complex (Figure \ref{fig:orge6f15cc} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:orge6f15cc} enzyme 6b)
...
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:orge6f15cc} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:orge6f15cc} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:orge6f15cc} enzyme 9)
...
(Figure \ref{fig:orge6f15cc} enzyme 10)
...
\label{sec:orge6b9214}
\subsubsection{Clinical Presentation}
\label{sec:orgfb1ea8b}
\begin{description}
...
\label{sec:org0579997}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orga139332}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org5da1e76}
\begin{itemize}
\item AR, ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org2bb02a8}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgbf9e666}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:orga1fb56b}
\subsection{Introduction}
\label{sec:orgf555b4c}
\begin{itemize}
...
\caption{\label{fig:org04b8a43}
Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org40b6210}
\subsubsection{Severe Classic NKH}
\label{sec:org585d20a}
\begin{itemize}
\item neonatal onset
...
\label{sec:org7421665}
\subsection{Glutamine Metabolism}
\label{sec:org4533431}
\begin{itemize}
...
\caption{\label{fig:org3586121}
Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orgbc719e3}
\begin{itemize}
...
\section{Transport}
\label{sec:orgbb3570b}
\subsection{Introduction}
\label{sec:org77d353e}
\begin{itemize}
...
\label{sec:org6acf05c}
\subsubsection{Clinical Presentation}
\label{sec:orga83d50c}
\begin{itemize}
...
\label{sec:org46dea01}
\subsubsection{Clinical Presentation}
\label{sec:org273c4b6}
\begin{itemize}
...
\label{sec:orgd9c47a5}
\subsubsection{Clinical Presentation}
\label{sec:orgc2b52c3}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org783c686}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orga1fbb2a}
\begin{itemize}
