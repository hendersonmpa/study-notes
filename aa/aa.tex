...
\label{sec:org8e7cd01}
\begin{enumerate}
\item Diet
\label{sec:orge4f70e0}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org3f8a3da}blood or urine}
...
\caption{\label{fig:orga5266bf}
Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org6bc8d95}
\subsubsection{Severe Classic NKH}
\label{sec:orgf859109}
\begin{itemize}
\item neonatal onset
...
\section{Transport}
\label{sec:org2c84b89}
\subsection{Introduction}
\label{sec:org1bc617e}
\begin{itemize}
