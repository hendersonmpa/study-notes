...
\label{sec:orgee6e234}
\subsection{Introduction}
\label{sec:orga8fec66}
\begin{itemize}
...
\caption{\label{fig:org26296d4}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:orge5fa630}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:org66a2388}Tetrahydrobiopterin Metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org566a2d2}Phenylalaninemia Classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org5215f59}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:orgf898987}
\subsubsection{Clinical Presentation}
\label{sec:org07a4888}
\begin{itemize}
...
\label{sec:org26e83f2}
\begin{enumerate}
\item Diet
\label{sec:orgf290148}
\begin{itemize}
...
\label{sec:org7b5700a}
\subsubsection{Clinical Presentation}
\label{sec:orgbb03a5d}
\begin{itemize}
...
\label{sec:org7aa4b12}
\begin{itemize}
\item disorders of BH\textsubscript{4} metabolism associated with HPA and biogenic amine deficiency (Figure \ref{fig:org66a2388})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgc7a9c3e}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:org26296d4}
and \ref{fig:org66a2388})
...
\subsubsection{Diagnostic Tests}
\label{sec:org9212bb8}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:orgf92689a})
...
\begin{table}[htbp]
\caption{\label{tab:orgf92689a}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{orgd9b6a3f}} & primapterin\textsuperscript{\ref{orgd9b6a3f}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[3]{\label{orgd9b6a3f}blood or urine}

\subsubsection{Treatment}
\label{sec:orgc783d25}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:orga14c96e}
\subsection{Introduction}
\label{sec:orgd2ceae5}
\begin{itemize}
...
\caption{\label{fig:orgf886e7e}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:org2c46ed4}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:org998e880}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org5f93c27}
\begin{itemize}
...
\label{sec:org8c32933}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgf7d961d}
\begin{itemize}
...
4-hydroxyphenyllactate and 4-hydroxyphenylacetate via AST (Figure \ref{fig:orgf886e7e})
\end{itemize}

\subsubsection{Genetics}
\label{sec:org44a1a07}
\begin{itemize}
\item AR TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org83ec2a6}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org034af87}
\begin{itemize}
\item AR HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgdbda001}
\begin{itemize}
...
\label{sec:orgf3a8133}
\subsubsection{Clinical Presentation}
\label{sec:org3710d7b}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org1903a18}
\begin{itemize}
\item AR HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org587f1d0}
\begin{itemize}
...
\label{sec:org33ec6df}
\subsubsection{Clinical Presentation}
\label{sec:org60b0105}
\begin{itemize}
...
\section{BCAA}
\label{sec:org3a4cb28}
\subsection{Introduction}
\label{sec:org1ca0327}
\begin{itemize}
...
\caption{\label{fig:orgc801f79}BCAA catabolism}
\end{figure}
...
\label{sec:org0ff00e5}
\subsubsection{Clinical Presentation}
\label{sec:orged6ba3b}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org3c919f5}
\begin{enumerate}
\item MSUD
\label{sec:org7ca38af}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgec54b19}
\begin{description}
\item[{MSUD}] AR E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR IVD
\item[{PA}] AR PCCB
\item[{MMA}] AR MUT or cobalamin system (Table \ref{tab:org6a6219b})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org6a6219b}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
Gene & Protein\\
\hline
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org97d2ee2}deficiency of CblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org718372d}
\begin{enumerate}
\item MSUD
\label{sec:org3d535fb}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org8626063}
\begin{itemize}
\item AR MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orga89a826}
\begin{itemize}
\item \(\Uparrow\) 3-hydroxyisovaleric
...
\section{Urea Cycle}
\label{sec:org67e16b2}
\subsection{Introduction}
\label{sec:org83508ba}
\begin{itemize}
...
\caption{\label{fig:org411c8cd}Urea Cycle}
\end{figure}
...
\caption{\label{fig:orgba60ac9}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org7eccf8f}Diagnostic Algorithm that can be Applied to any Hyperammonaemic Patient}
\end{figure}

\subsection{Mitochondrial UCDs}
\label{sec:orgbe0fb52}
\begin{itemize}
...
\caption{\label{fig:org85ea4c5}Nitrogen Elimination by Phenylbutyrate and Benzoate}
\end{figure}

\item Prognosis
\label{sec:org4d2ee8d}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org5d7abe8}
\begin{enumerate}
\item Newborns
\label{sec:orge5c9161}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgad1fdb0}
\begin{itemize}
\item AR ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgead4b2d}
\begin{itemize}
...
\label{sec:org96c160b}
\subsubsection{HHH Syndrome}
\label{sec:org7c6c87a}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:orgd1b6029})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org38d72ca}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org67a63d6}
\begin{itemize}
...
\item Genetics
\label{sec:org7444d6e}
\begin{itemize}
\item AR SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:org100282e}
\begin{itemize}
...
\item Genetics
\label{sec:org5cf6afc}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:orgfd2aa61}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:org6d5390c}
\subsection{Introduction}
\label{sec:org7416ef5}
...
\caption{\label{fig:org2f0aa9b}Cysteine and Cystine}
\end{figure}
...
kinase (ADK)
\item homocysteine has two metabolic pathways (Figure \ref{fig:orgc21dc03}):
\begin{enumerate}
...
\caption{\label{fig:org802f934}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:orgc21dc03}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:org1a62cb2}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org4329778}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org92b28fe}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org04ee9a0}
\begin{itemize}
\item AR MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orga5ffaae}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org5ad67d7}
\begin{itemize}
\item AR CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org8b74fca}
\begin{itemize}
...
\label{sec:org40d4a1d}
\subsubsection{Clinical Presentation}
\label{sec:org1eda861}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgdedf462}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orge17ea7a}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7f33ea2}
\begin{itemize}
...
\label{sec:org1fec82d}
\subsubsection{Clinical Presentation}
\label{sec:orgabdde3b}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga23400e}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org74a12f7}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:orgd1b6029}
\subsection{Introduction}
\label{sec:org22130e3}
\subsubsection{Ornitine}
\label{sec:org8888e4d}
\begin{itemize}
...
\item defective in HHH syndrome (Section \ref{sec:org7c6c87a})
\end{itemize}
...
\caption{\label{fig:orgf69332d}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:org9cd58ad}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:orgf73d540}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:orgdedad4b}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orga0adc9d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org816a0ab}
\begin{itemize}
\item AR OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org2362c99}
\begin{itemize}
...
\label{sec:orgbc55d6f}
\begin{itemize}
\item Hypoprolinaemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org5902ead}
\begin{itemize}
...
\item see figure \ref{fig:orgf73d540} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:org6535727}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgdb07c6a}
\begin{itemize}
\item AR/AD ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgca616cb}
\begin{itemize}
...
\label{sec:org76eae57}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgfbda357}
\begin{itemize}
...
\label{sec:orgb20aa97}
\begin{itemize}
\item Hyperprolinaemia Type II
\end{itemize}

\subsubsection{Clinical Presentation}
\label{sec:org2493b99}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga0b5855}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7b4d970}
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org3c26dac} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:org3c26dac} enzyme 2)
\begin{itemize}
...
ketoglutarate dehydrogenase-like complex (Figure \ref{fig:org3c26dac} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org3c26dac} enzyme 6b)
\begin{itemize}
\item KGDH may serve as an alternative route
\item 2-oxoadipic acid is dehydrogenated and decarboxylated to
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org3c26dac} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org3c26dac} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org3c26dac} enzyme 9)
...
(Figure \ref{fig:org3c26dac} enzyme 10)
\end{itemize}
...
\caption{\label{fig:org3c26dac}Tryptophan, hydroxylysine and lysine catabolic pathways}
\end{figure}
...
\caption{\label{fig:org0a90470}Tryptophan and lysine catabolic pathways}
\end{figure}

\subsection{Glutaric Aciduria Type I}
\label{sec:org27b44fe}
\subsubsection{Clinical Presentation}
\label{sec:org5cb8907}
\begin{itemize}
...
\label{sec:orgbe5263b}
\subsubsection{Clinical Presentation}
\label{sec:org5506e83}
\begin{description}
...
\label{sec:org53d70ab}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgf9cd09e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org69ddb41}
\begin{itemize}
\item AR ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgfd14932}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org874593e}
\begin{itemize}
\item none
\end{itemize}

\section{Non-Ketotic Hyperglycinemia}
\label{sec:org0e28199}
\subsection{Introduction}
\label{sec:org289f0e3}
\begin{itemize}
...
\caption{\label{fig:org9460f71}Glycine Cleavage System}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:orgf1074ac}Activation of Lipoate Dependant Enzymes}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org6cf5a3e}
\subsubsection{Severe Classic NKH}
\label{sec:orgda17f4f}
\begin{itemize}
\item neonatal onset
...
and BCKDH (Figure \ref{fig:orgf1074ac})
...
\label{sec:org1ed1f85}
\subsection{Glutamine Metabolism}
\label{sec:org87445ab}
\begin{itemize}
...
\caption{\label{fig:org2dbb655}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orgd9839cc}
\begin{itemize}
...
\section{Transport}
\label{sec:org267aa85}
\subsection{Introduction}
\label{sec:org088ad2f}
\begin{itemize}
...
\caption{\label{fig:org93ce86b}Cystine}
\end{figure}

\subsubsection{Neutral  Amino Acids}
\label{sec:org9ed19f7}
\begin{itemize}
...
\caption{\label{fig:orgfe4ea00}Simplified schematic representation of cationic and neutral amino acid transport in epithelial cells}
\end{figure}

\subsection{Cystinuria}
\label{sec:org5195dfa}
\subsubsection{Clinical Presentation}
\label{sec:org2b349a3}
\begin{itemize}
...
\label{sec:org2fbc0cf}
\subsubsection{Clinical Presentation}
\label{sec:org46cafed}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge61c714}
\begin{itemize}
\item AR SLC7A7
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgca03cab}
\begin{itemize}
...
\label{sec:org39abf25}
\subsubsection{Clinical Presentation}
\label{sec:orgdd35206}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0ecb748}
\begin{itemize}
\item AR SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org2d088e0}
\begin{itemize}
