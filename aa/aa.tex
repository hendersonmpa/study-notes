...
\label{sec:org7368833}
\subsection{Introduction}
\label{sec:org4e241ab}
\begin{itemize}
...
\caption{\label{fig:org0f969d8}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:org348db42}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:orgfb6c406}Tetrahydrobiopterin metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org287539b}Phenylalaninemia classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org9a2d8f8}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:orgdccf49f}
\subsubsection{Clinical Presentation}
\label{sec:org67e834b}
\begin{itemize}
...
\label{sec:orgfa3564e}
\begin{enumerate}
\item Diet
\label{sec:orga64dff7}
\begin{itemize}
...
treatment of responsive\textsuperscript{\ref{org9a2d8f8}} patients with HPA and PKU, of all
ages
\end{itemize}
\item Alternative/Experimental
\label{sec:orgcec2890}
\begin{itemize}
...
\label{sec:org9825bb3}
\subsubsection{Clinical Presentation}
\label{sec:org2b043fb}
\begin{itemize}
...
\label{sec:org104f0a8}
\begin{itemize}
\item disorders of BH\textsubscript{4} metabolism associated with HPA and biogenic amine deficiency (Figure \ref{fig:orgfb6c406})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org904aa3a}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:org0f969d8}
and \ref{fig:orgfb6c406})
...
\subsubsection{Diagnostic Tests}
\label{sec:orgf44340f}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:org87178b7})
...
\begin{table}[htbp]
\caption{\label{tab:org87178b7}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{orgd64d2ab}} & primapterin\textsuperscript{\ref{orgd64d2ab}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{orgd64d2ab}blood or urine}

\subsubsection{Treatment}
\label{sec:org66b49db}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:org826078b}
\subsection{Introduction}
\label{sec:org7c8ef14}
\begin{itemize}
...
\caption{\label{fig:orgca874e4}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:org2ac904f}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:org1dfc280}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org8d7a9a7}
\begin{itemize}
...
\label{sec:orga80f6b1}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orga8c920a}
\begin{itemize}
...
4-hydroxyphenyllactate and 4-hydroxyphenylacetate via AST (Figure \ref{fig:orgca874e4})
\end{itemize}

\subsubsection{Genetics}
\label{sec:org8beae30}
\begin{itemize}
\item AR TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgbb17484}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgda81613}
\begin{itemize}
\item AR HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org9e2aa32}
\begin{itemize}
...
\label{sec:org2d57a35}
\subsubsection{Clinical Presentation}
\label{sec:org2dfa8ef}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org3102dc9}
\begin{itemize}
\item AR HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orge6a258f}
\begin{itemize}
...
\label{sec:org7007009}
\subsubsection{Clinical Presentation}
\label{sec:org4012cb5}
\begin{itemize}
...
\section{BCAA}
\label{sec:org5cfef75}
\subsection{Introduction}
\label{sec:orge8dee89}
\begin{itemize}
...
\caption{\label{fig:org37da2ee}BCAA catabolism}
\end{figure}
...
\label{sec:orge74f08d}
\subsubsection{Clinical Presentation}
\label{sec:org4ea1214}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:orgfe90330}
\begin{enumerate}
\item MSUD
\label{sec:org96c2191}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge79ae78}
\begin{description}
\item[{MSUD}] AR E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR IVD
\item[{PA}] AR PCCB
\item[{MMA}] AR MUT or cobalamin system (Table \ref{tab:org57e6ee7})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org57e6ee7}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
Gene & Protein\\
\hline
...
\end{tabular}
\end{table}\footnotetext[4]{\label{org7a47b37}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org71b1e5c}
\begin{enumerate}
\item MSUD
\label{sec:orgd38f8fd}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org8672860}
\begin{itemize}
\item AR MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgb3afe6f}
\begin{itemize}
...
\section{Urea Cycle}
\label{sec:org05a8e47}
\subsection{Introduction}
\label{sec:org0e9f112}
\begin{itemize}
...
\caption{\label{fig:orgbe60d99}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org5ae6950}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org72792ad}Diagnostic algorithm that can be applied to any hyperammonaemic patient}
\end{figure}

\subsection{Mitochondrial}
\label{sec:org9477f46}
\begin{itemize}
...
\caption{\label{fig:orgaa4bc5e}Nitrogen elimination by phenylbutyrate and benzoate}
\end{figure}

\item Prognosis
\label{sec:orgfe61e54}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org80f7f2b}
\begin{enumerate}
\item Newborns
\label{sec:org49936b3}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org91ad8fc}
\begin{itemize}
\item AR ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgcd278d6}
\begin{itemize}
...
\label{sec:org31e3c3d}
\subsubsection{HHH Syndrome}
\label{sec:orgc1b7786}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:org440bc81})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org340d3b4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgfc7e303}
\begin{itemize}
...
\item Genetics
\label{sec:org46a141f}
\begin{itemize}
\item AR SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:org3730e9a}
\begin{itemize}
...
\item Genetics
\label{sec:org2b74ab3}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org877cff9}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:orgd32f690}
\subsection{Introduction}
\label{sec:org79bcfcd}
...
\caption{\label{fig:org1c95624}Cysteine vs Cystine}
\end{figure}
...
kinase (ADK)
\item homocysteine has two metabolic pathways (Figure \ref{fig:org1faac02}):
\begin{enumerate}
...
\caption{\label{fig:org45f6c0f}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:org1faac02}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:org0cdd187}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org8f205a6}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgb178400}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgb892b84}
\begin{itemize}
\item AR MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgadcdc63}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org04999b1}
\begin{itemize}
\item AR CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org5e38c3b}
\begin{itemize}
...
\label{sec:org5e56d7e}
\subsubsection{Clinical Presentation}
\label{sec:org5cdf87b}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgfbf0bcd}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org31edffc}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgba8980f}
\begin{itemize}
...
\label{sec:org71e8238}
\subsubsection{Clinical Presentation}
\label{sec:orgb2bba35}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgfbb76db}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgc9a56ba}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:org440bc81}
\subsection{Introduction}
\label{sec:org35c62a3}
\begin{itemize}
...
\caption{\label{fig:org74d6df2}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:orga7996b9}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:orgcda056c}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:org5a7a363}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org750e48f}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org6c07022}
\begin{itemize}
\item AR OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org881fa33}
\begin{itemize}
...
\item see figure \ref{fig:orgcda056c} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:org6e89f23}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org16ad05e}
\begin{itemize}
\item AR/AD ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org5b444fd}
\begin{itemize}
...
\label{sec:org12accb3}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org4d0776c}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgbbb400c}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgd3ce256}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org027404f} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:org027404f} enzyme 2)
\begin{itemize}
...
ketoglutarate dehydrogenase-like complex (Figure \ref{fig:org027404f} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org027404f} enzyme 6b)
\begin{itemize}
\item KGDH may serve as an alternative route
\item 2-oxoadipic acid is dehydrogenated and decarboxylated to
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org027404f} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org027404f} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org027404f} enzyme 9)
...
(Figure \ref{fig:org027404f} enzyme 10)
...
\caption{\label{fig:org027404f}Tryptophan, hydroxylysine and lysine catabolic pathways}
\end{figure}
...
\caption{\label{fig:orga57fc54}Tryptophan and lysine catabolic pathways}
\end{figure}

\subsection{Glutaric Aciduria Type I}
\label{sec:orge69c2f3}
\subsubsection{Clinical Presentation}
\label{sec:orgf5edba3}
\begin{itemize}
...
\label{sec:orgab4e183}
\subsubsection{Clinical Presentation}
\label{sec:orgd28e2bf}
\begin{description}
...
\label{sec:org441fe0c}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org4401fae}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb816b53}
\begin{itemize}
\item AR ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orge31537a}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org54c2217}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:orgc93fc30}
\subsection{Introduction}
\label{sec:orgb3205b4}
\begin{itemize}
...
\caption{\label{fig:orgb5632eb}Glycine cleavage enzyme}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:orgffccd82}Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:orgbd4c023}
\subsubsection{Severe Classic NKH}
\label{sec:orgb2c8139}
\begin{itemize}
\item neonatal onset
...
\label{sec:orgd624d89}
\subsection{Glutamine Metabolism}
\label{sec:orga1363e4}
\begin{itemize}
...
\caption{\label{fig:org67ac0d1}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org2b80530}
\begin{itemize}
...
\section{Transport}
\label{sec:org661adc9}
\subsection{Introduction}
\label{sec:org824b5c5}
\begin{itemize}
...
\caption{\label{fig:orged07516}Cystine}
\end{figure}

\subsubsection{Neutral  Amino Acids}
\label{sec:orgb56ea34}
\begin{itemize}
...
\caption{\label{fig:orgb6efcfb}Simplified schematic representation of cationic and neutral amino acid transport in epithelial cells}
\end{figure}

\subsection{Cystinuria}
\label{sec:orgbfbd309}
\subsubsection{Clinical Presentation}
\label{sec:orgac3c997}
\begin{itemize}
...
\label{sec:org981e328}
\subsubsection{Clinical Presentation}
\label{sec:orgd0d3da0}
\begin{itemize}
...
\label{sec:org15a8c91}
\subsubsection{Clinical Presentation}
\label{sec:org9422d42}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org22722a5}
\begin{itemize}
\item AR SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgefd2c9c}
\begin{itemize}
