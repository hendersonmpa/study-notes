...
\label{sec:orga37af75}
\begin{enumerate}
\item Diet
\label{sec:org4978301}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org258097c}blood or urine}
...
\label{sec:org7a2a7fe}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org6d625d8}
\begin{itemize}
...
MMADHC & cblD\\
\end{tabular}
\end{table}\footnotetext[2]{\label{org6325aed}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}
...
\label{sec:orgeff6b4e}
\begin{enumerate}
\item Newborns
\label{sec:orged2564b}
\begin{itemize}
...
\label{sec:org4587026}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2ebe8e4}
\begin{itemize}
...
\item Genetics
\label{sec:orgbb9a388}
\begin{itemize}
\item AR, SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:orgba2bff6}
\begin{itemize}
...
\item Genetics
\label{sec:org8c195cf}
\begin{itemize}
\item AR, CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org991ceda}
\begin{itemize}
...
\label{sec:org5946b47}
\subsection{Introduction}
\label{sec:orged31099}
\begin{itemize}
...
\caption{\label{fig:org7d87662}
Disorders of sulfur amino acid metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org1a7faa1}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org5d8abbe}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgaaeec38}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org2d86a30}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org6b1bc51}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgfbd9efb}
\begin{itemize}
...
\label{sec:org1499a45}
\subsubsection{Clinical Presentation}
\label{sec:org03cfcb7}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgc7ba105}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org59c067d}
\begin{itemize}
\item AR, SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org128b8ea}
\begin{itemize}
...
\label{sec:org82012a0}
\subsubsection{Clinical Presentation}
\label{sec:org212f8b1}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org5829947}
\begin{itemize}
\item AR, ETHE1, rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org4138e11}
\begin{itemize}
...
\label{sec:org354d197}
\subsection{Introduction}
\label{sec:org2e651e1}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org37764f6}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org601f39f}
\begin{itemize}
...
\label{sec:orgab54905}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org4390bb0}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgf97bbaa}
\begin{itemize}
\item AR, ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org1c29494}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
\label{sec:org320014f}
\subsubsection{Clinical Presentation}
\label{sec:orgf4756c3}
\begin{description}
...
\label{sec:org62e8bb1}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgb5d1d65}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgc3895bc}
\begin{itemize}
\item AR, ASPAragine
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3e380ca}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org2ba3bd0}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:orgc40437b}
\subsection{Introduction}
\label{sec:org01fb1e1}
\begin{itemize}
...
\caption{\label{fig:orga155c79}
Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:orgab3a30b}
\subsubsection{Severe Classic NKH}
\label{sec:org335158a}
\begin{itemize}
\item neonatal onset
...
\label{sec:orgb3ccc39}
\subsection{Glutamine Metabolism}
\label{sec:orgd655ae0}
\begin{itemize}
...
\caption{\label{fig:org2f2b879}
Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orgf6e1d4f}
\begin{itemize}
...
\section{Transport}
\label{sec:orgef7998f}
\subsection{Introduction}
\label{sec:orgb39ab3d}
\begin{itemize}
...
\label{sec:orge80cd86}
\subsubsection{Clinical Presentation}
\label{sec:org2ba6a17}
\begin{itemize}
...
\label{sec:org2e7c472}
\subsubsection{Clinical Presentation}
\label{sec:org95a9f7b}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org599ed01}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org2402716}
\begin{itemize}
