...
\label{sec:org784cbfa}
\subsection{Introduction}
\label{sec:org7d311f4}
\begin{itemize}
...
\label{sec:org8aceb2b}
\begin{enumerate}
\item Diet
\label{sec:orga5f2d98}
\begin{itemize}
...
\label{sec:orgc4cceca}
\subsubsection{Clinical Presentation}
\label{sec:org13b9003}
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org90c4fe0}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figure \ref{fig:org6fff986})
...
\begin{table}[htbp]
\caption{\label{tab:org3848047}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org084351b}} & primapterin\textsuperscript{\ref{org084351b}} & CSF 5HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org084351b}blood or urine}

\subsubsection{Treatment}
\label{sec:org8b9fa19}
\begin{itemize}
\item BH\(_{\text{4}}\)
...
\section{Tyrosine}
\label{sec:org0191673}
\subsection{Introduction}
\label{sec:org4f93ef8}
...
\label{sec:org6ec99bf}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org44b0414}
\begin{itemize}
...
\label{sec:orge47bf37}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgeedba78}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgbd922f7}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org4340c44}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org822d210}
\begin{itemize}
\item AR, HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgd32cd03}
\begin{itemize}
...
\label{sec:orgd7b2f42}
\subsubsection{Clinical Presentation}
\label{sec:org4680947}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org6769834}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org81bb0d5}
\begin{itemize}
...
\label{sec:orgab68a25}
\subsubsection{Clinical Presentation}
\label{sec:orgd73d8b6}
\begin{itemize}
...
\section{BCAA}
\label{sec:org51bd873}
\subsection{Introduction}
\label{sec:orgaf9d2cb}
\begin{itemize}
...
\label{sec:org66efce4}
\subsubsection{Clinical Presentation}
\label{sec:org60ed543}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org8ff021b}
\begin{enumerate}
\item MSUD
\label{sec:org40f35f7}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge24e5d6}
\begin{description}
\item[{MSUD}] AR, E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR, IVD
\item[{PA}] AR, PCCB
\item[{MMA}] AR, MUT or cobalamin system (Table \ref{tab:org5073830})
\begin{itemize}
...
MMADHC & cblD\\
\end{tabular}
\end{table}\footnotetext[2]{\label{orgec870ba}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:orgb50032c}
\begin{enumerate}
\item MSUD
\label{sec:org4a4f512}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org8d63f51}
\begin{itemize}
\item AR, MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgfae064e}
\begin{itemize}
\item \(\Uparrow\) 3-HIVA
...
\section{Urea Cycle}
\label{sec:org5d03463}
\subsection{Introduction}
\label{sec:org39b65a2}
\begin{itemize}
...
\label{sec:org3e65b73}
\begin{enumerate}
\item Newborns
\label{sec:org558125e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org56ffe2a}
\begin{itemize}
\item AR, ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org2b36622}
\begin{itemize}
...
\label{sec:org600e3c7}
\subsubsection{HHH Syndrome}
\label{sec:org3241069}
\begin{itemize}
\item see section \ref{sec:org8ce280a}
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:orgbbf657f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc80bd7a}
\begin{itemize}
...
\item Genetics
\label{sec:orgf6a8cb4}
\begin{itemize}
\item AR, SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:org9f176dc}
\begin{itemize}
...
\item Genetics
\label{sec:orgf1321a6}
\begin{itemize}
\item AR, CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org3d71d7b}
\begin{itemize}
...
\label{sec:org3673266}
\subsection{Introduction}
\label{sec:org6bb0bb6}
\begin{itemize}
...
\caption{\label{fig:orgc104f10}
Disorders of sulfur amino acid metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org579fa89}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orge080e3a}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org130076f}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org4600523}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgfa2446b}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org02d26ab}
\begin{itemize}
...
\label{sec:orgb75f6ae}
\subsubsection{Clinical Presentation}
\label{sec:org204b091}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org475199b}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org8407fd2}
\begin{itemize}
\item AR, SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org070052c}
\begin{itemize}
...
\label{sec:orge8db373}
\subsubsection{Clinical Presentation}
\label{sec:orgf4bac5e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4d573be}
\begin{itemize}
\item AR, ETHE1, rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgabc9a38}
\begin{itemize}
...
\label{sec:org8ce280a}
\subsection{Introduction}
\label{sec:org8c79101}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org22e7092}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgf99c67c}
\begin{itemize}
...
\label{sec:org16d90de}
\begin{itemize}
\item \(\Delta\)1-Pyrroline-5-Carboxylate Synthetase Deficiency
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org0e55295}
\begin{itemize}
\item central and peripheral neurological
\item see figure \ref{fig:org6eb6f26} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:org3fc63d0}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org24e6a21}
\begin{itemize}
\item AR/AD, ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org00644c4}
\begin{itemize}
...
\label{sec:org7dc5197}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org7851b80}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org1bb3f1e}
\begin{itemize}
\item AR, ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org76d3527}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgf7e0b52}
\begin{itemize}
\item AR, PEPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgca3c539}
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:orgca19362} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid and the
peroxisomal key enzyme, pipecolic acid oxidase (Figure \ref{fig:orgca19362} enzyme 2)
\begin{itemize}
...
2-oxoglutarate dehydrogenase-like complex (Figure \ref{fig:orgca19362} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:orgca19362} enzyme 6b)
...
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:orgca19362} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:orgca19362} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:orgca19362} enzyme 9)
...
(Figure \ref{fig:orgca19362} enzyme 10)
...
\label{sec:org5a0c7eb}
\subsubsection{Clinical Presentation}
\label{sec:org4285170}
\begin{description}
...
\label{sec:org338df28}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org0f3bfa6}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org077a883}
\begin{itemize}
\item AR, ASPAragine
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgceb2892}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org08f87bb}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:orgbe06d66}
\subsection{Introduction}
\label{sec:org4d97da6}
\begin{itemize}
...
\caption{\label{fig:orga1581d2}
Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:orge98e266}
\subsubsection{Severe Classic NKH}
\label{sec:org912b52a}
\begin{itemize}
\item neonatal onset
...
\label{sec:org9c9dcae}
\subsection{Glutamine Metabolism}
\label{sec:orge72082a}
\begin{itemize}
...
\caption{\label{fig:orge9069ec}
Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orgdbae66d}
\begin{itemize}
...
\section{Transport}
\label{sec:org7f483af}
\subsection{Introduction}
\label{sec:org2f13319}
\begin{itemize}
...
\label{sec:org6a847e4}
\subsubsection{Clinical Presentation}
\label{sec:org7ae54fe}
\begin{itemize}
...
\label{sec:org8e3ee47}
\subsubsection{Clinical Presentation}
\label{sec:orgcfd6ed3}
\begin{itemize}
...
\label{sec:org93dcda7}
\subsubsection{Clinical Presentation}
\label{sec:org21ae51e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4f6c667}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgcbe9f72}
\begin{itemize}
