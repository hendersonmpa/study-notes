...
\label{sec:org2c6cfb6}
\subsection{Introduction}
\label{sec:orgb38c6b2}
\begin{itemize}
...
\caption{\label{fig:orged3bc5e}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:orgb489217}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:org7865de5}Tetrahydrobiopterin Metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org1dfa2fc}Phenylalaninemia Classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgadc541e}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:org2caabab}
\subsubsection{Clinical Presentation}
\label{sec:org5b91623}
\begin{itemize}
...
\label{sec:org32eb187}
\subsubsection{Clinical Presentation}
\label{sec:org272b854}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org766659d}blood or urine}
...
\label{sec:org226af7f}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orge49c052}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org5777940}
\begin{itemize}
\item AR HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgf78623f}
\begin{itemize}
...
\label{sec:orgae60880}
\subsubsection{Clinical Presentation}
\label{sec:org1fcd5ec}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgdc0a5d0}
\begin{itemize}
\item AR HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org4ba2d08}
\begin{itemize}
...
\label{sec:org23571e8}
\subsubsection{Clinical Presentation}
\label{sec:org5912258}
\begin{itemize}
...
\section{BCAA}
\label{sec:orgfa9aba4}
\subsection{Introduction}
\label{sec:org8263ea5}
\begin{itemize}
...
\caption{\label{fig:org6057597}BCAA Catabolism}
\end{figure}
...
\label{sec:org2a542f5}
\subsubsection{Clinical Presentation}
\label{sec:orgfa4d03b}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org124b367}
\begin{enumerate}
\item MSUD
\label{sec:org3de1b0c}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org62e8b0f}
\begin{description}
\item[{MSUD}] AR E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR IVD
\item[{PA}] AR PCCB \& PCCB
\item[{MMA}] AR MUT or cobalamin system (Table \ref{tab:orgf10578d})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgf10578d}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
Gene & Protein\\
\hline
...
\end{tabular}
\end{table}\footnotetext[5]{\label{orge60ae9f}deficiency of CblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:orgd3bb425}
\begin{enumerate}
\item MSUD
\label{sec:orgf771b74}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgb3d0402}
\begin{itemize}
\item AR MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org8685c27}
\begin{itemize}
\item \(\Uparrow\) 3-hydroxyisovaleric
...
\caption{\label{fig:org19d3a7b}Urea Cycle}
\end{figure}
...
\caption{\label{fig:orgbcbce3c}Urea Cycle}
\end{figure}
...
\caption{\label{fig:orge9a7c61}Diagnostic Algorithm that can be Applied to any Hyperammonaemic Patient}
\end{figure}

\subsection{Mitochondrial UCDs}
\label{sec:org87a6d96}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org8812444}
\begin{enumerate}
\item Newborns
\label{sec:org620f378}
\begin{itemize}
...
\label{sec:org3cc43da}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org29f8f15}
\begin{itemize}
...
\item Genetics
\label{sec:orgfc3986d}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:orge3b9bf3}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:org0bd851c}
\subsection{Introduction}
\label{sec:orge6d9fe6}
...
\caption{\label{fig:orgc7cf89e}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:org5051cb7}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:org7accbb7}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org27a433b}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org3158cce}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orge0227a7}
\begin{itemize}
\item AR MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org412415b}
\begin{itemize}
...
\label{sec:org6a2317f}
\subsubsection{Clinical Presentation}
\label{sec:org8972094}
\begin{itemize}
...
\label{sec:orgd15ea92}
\subsubsection{Clinical Presentation}
\label{sec:org14bc235}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org8624a21}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org64ce0ab}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org2fe4e3a}
\begin{itemize}
...
\label{sec:orgb6f5399}
\subsubsection{Clinical Presentation}
\label{sec:org2c948b3}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4239a37}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgb957be5}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:orgd4e0ce2}
\subsection{Introduction}
\label{sec:org92f4564}
\subsubsection{Ornitine}
\label{sec:org2822d7e}
\begin{itemize}
...
\caption{\label{fig:orgf0d5f2a}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:orga81c934}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:orgf19330e}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:org96181e1}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org1dea6db}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org1c1b5b1}
\begin{itemize}
\item AR OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org9c296f0}
\begin{itemize}
...
\label{sec:orge88e1dc}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org545f373}
\begin{itemize}
...
\label{sec:org1bbc6db}
\begin{itemize}
\item Hyperprolinaemia Type II
\end{itemize}

\subsubsection{Clinical Presentation}
\label{sec:orgc722a46}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga77e28f}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org216ccb9}
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org9d7622e} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org9d7622e} enzyme 9)
...
(Figure \ref{fig:org9d7622e} enzyme 10)
\end{itemize}
...
\caption{\label{fig:org9d7622e}Tryptophan, Hydroxylysine and Lysine Catabolic Pathways}
\end{figure}
...
\caption{\label{fig:orgcb9f7d1}Tryptophan and Lysine Catabolic Pathways}
\end{figure}

\subsubsection{Cerebral Organic Acidurias}
\label{sec:org5cf0c1a}
\begin{itemize}
...
\label{sec:org5d2a6a2}
\subsubsection{Clinical Presentation}
\label{sec:org590792f}
\begin{itemize}
...
\label{sec:org93405be}
\subsubsection{Clinical Presentation}
\label{sec:org5a780b7}
\begin{description}
...
\label{sec:org914b2a5}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orga892a1d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org1797098}
\begin{itemize}
\item AR ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org6d7bcef}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org6a50bf2}
\begin{itemize}
\item none
\end{itemize}

\section{Non-Ketotic Hyperglycinemia}
\label{sec:org76630ee}
\subsection{Introduction}
\label{sec:org517fdaa}
\begin{itemize}
...
\caption{\label{fig:org349031d}Glycine Cleavage System}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:org25a1e61}Activation of Lipoate Dependant Enzymes}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org9cf01b6}
\subsubsection{Severe Classic NKH}
\label{sec:org8ccd01c}
\begin{itemize}
\item neonatal onset
...
\label{sec:org3419481}
\subsection{Glutamine Metabolism}
\label{sec:org3aa66ea}
\begin{itemize}
...
\caption{\label{fig:org0627c00}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orgbef6433}
\begin{itemize}
...
\section{Transport}
\label{sec:org99bbde6}
\subsection{Introduction}
\label{sec:org79befc6}
\begin{itemize}
...
\caption{\label{fig:org916aad1}Amino Acid Classes}
\end{figure}

\subsubsection{Dibasic Amino Acids}
\label{sec:orgf1a4feb}
\begin{itemize}
...
\caption{\label{fig:orgebb280b}Cystine}
\end{figure}

\subsubsection{Neutral  Amino Acids}
\label{sec:orgefca32a}
\begin{itemize}
...
\caption{\label{fig:orgfbf23b0}Cationic and Neutral Amino Acid Transport in Epithelial Cells}
\end{figure}


\subsection{Cystinuria}
\label{sec:org2fe31e0}
\subsubsection{Clinical Presentation}
\label{sec:org4e5c74a}
\begin{itemize}
...
\label{sec:org2b0652b}
\subsubsection{Clinical Presentation}
\label{sec:org4e94871}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgf41dc8e}
\begin{itemize}
\item AR SLC7A7
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgce59301}
\begin{itemize}
...
\label{sec:org002c154}
\subsubsection{Clinical Presentation}
\label{sec:org9888e9d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga3a60a7}
\begin{itemize}
\item AR SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org1959160}
\begin{itemize}
