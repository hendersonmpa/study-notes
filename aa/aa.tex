...
\label{sec:orgf9c13fe}
\subsection{Introduction}
\label{sec:org81e7090}
\begin{itemize}
...
\label{sec:org261d39e}
\begin{enumerate}
\item Diet
\label{sec:org2beaed3}
\begin{itemize}
...
\label{sec:orga1180cd}
\subsubsection{Clinical Presentation}
\label{sec:orged57c71}
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orga5e63de}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figure \ref{fig:orge3177e9})
...
\begin{table}[htbp]
\caption{\label{tab:orgb089d6d}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org53f1f40}} & primapterin\textsuperscript{\ref{org53f1f40}} & CSF 5HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org53f1f40}blood or urine}

\subsubsection{Treatment}
\label{sec:org6462678}
\begin{itemize}
\item BH\(_{\text{4}}\)
...
\section{Tyrosine}
\label{sec:orgefd839d}
\subsection{Introduction}
\label{sec:orgdb17d59}
...
\label{sec:orgb4c4de8}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org9596c10}
\begin{itemize}
...
\label{sec:org378de20}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org21db563}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge7df1a5}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org8c070ae}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgf7fcb4d}
\begin{itemize}
\item AR, HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org7b996fa}
\begin{itemize}
...
\label{sec:orga8c1ef0}
\subsubsection{Clinical Presentation}
\label{sec:org69e12fa}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgf1d170b}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org41a9884}
\begin{itemize}
...
\label{sec:org391ea9c}
\subsubsection{Clinical Presentation}
\label{sec:orge7d5d1f}
\begin{itemize}
...
\section{BCAA}
\label{sec:orgb0c8770}
\subsection{Introduction}
\label{sec:org32e70a0}
\begin{itemize}
...
\label{sec:org57da647}
\subsubsection{Clinical Presentation}
\label{sec:orged668af}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:orgcb97738}
\begin{enumerate}
\item MSUD
\label{sec:orgc8c3d0e}
\begin{itemize}
...
\begin{itemize}
\item \(\uparrow\) PA and PA derivatives (see \ref{sec:orgfab6246})
\end{itemize}
\end{itemize}

\item Secondary Effects Of Elevated Propionyl-CoA
\label{sec:org0280b9f}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org416ab04}
\begin{description}
\item[{MSUD}] AR, E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR, IVD
\item[{PA}] AR, PCCB
\item[{MMA}] AR, MUT or cobalamin system (Table \ref{tab:org09b8156})
\begin{itemize}
...
MMADHC & cblD\\
\end{tabular}
\end{table}\footnotetext[2]{\label{org9ccaa5c}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org32a4242}
\begin{itemize}
\item MSUD \(\to\) PAA
\begin{itemize}
\item alloisoleucine
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgfaa3415}
\begin{itemize}
\item AR, MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org4626bf0}
\begin{itemize}
\item \(\Uparrow\) 3-HIVA
...
\section{Urea Cycle}
\label{sec:orgc2dda99}
\subsection{Introduction}
\label{sec:org009ba0c}
\begin{itemize}
...
\label{sec:orgc3d458e}
\begin{enumerate}
\item Newborns
\label{sec:org5c1c61e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org3ab57b9}
\begin{itemize}
\item AR, ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgb41e7d5}
\begin{itemize}
...
\label{sec:org6a622ff}
\subsubsection{HHH Syndrome}
\label{sec:org0c65d25}
\begin{itemize}
\item see section \ref{sec:org48ed7e0}
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:orgdbd2ed9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org27c4718}
\begin{itemize}
...
\item Genetics
\label{sec:org4a172c2}
-AR, SLC25A13

\item Diagnostic Tests
\label{sec:org5863c2c}
\begin{itemize}
...
\item Genetics
\label{sec:orgc95909c}
\begin{itemize}
\item AR, CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org557f27f}
\begin{itemize}
...
\label{sec:orgc416620}
\subsection{Introduction}
\label{sec:org14ea9f9}
\begin{itemize}
...
\caption{\label{fig:orgf73d80d}
Disorders of sulfur amino acid metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:org2daa926}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgbc8e616}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org6e5ca54}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org288dd7a}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgbb3cac1}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org46ed637}
\begin{itemize}
...
\label{sec:org1c9e243}
\subsubsection{Clinical Presentation}
\label{sec:org17287d6}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgd7f9639}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4e12b31}
\begin{itemize}
\item AR, SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org421b27b}
\begin{itemize}
...
\label{sec:orgd47c7c4}
\subsubsection{Clinical Presentation}
\label{sec:org5d33dce}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgd387783}
\begin{itemize}
\item AR, ETHE1, rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org71714f5}
\begin{itemize}
...
\label{sec:org48ed7e0}
\subsection{Introduction}
\label{sec:org84eb878}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org55afb09}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3b6002e}
\begin{itemize}
...
\label{sec:orgf1c09d9}
\begin{itemize}
\item \(\Delta\)1-Pyrroline-5-Carboxylate Synthetase Deficiency
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org6487dc9}
\begin{itemize}
\item central and peripheral neurological
\item see figure \ref{fig:orgb8208bd} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:orgbd74a9c}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org33239e1}
\begin{itemize}
\item AR/AD, ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgf4b452f}
\begin{itemize}
...
\label{sec:org642abbe}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org566d86c}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgea9b876}
\begin{itemize}
\item AR, ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7f45074}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgde34100}
\begin{itemize}
\item AR, PEPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org428e861}
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org4ca70a7} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid and the
peroxisomal key enzyme, pipecolic acid oxidase (Figure \ref{fig:org4ca70a7} enzyme 2)
\begin{itemize}
...
2-oxoglutarate dehydrogenase-like complex (Figure \ref{fig:org4ca70a7} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org4ca70a7} enzyme 6b)
...
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org4ca70a7} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org4ca70a7} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org4ca70a7} enzyme 9)
...
(Figure \ref{fig:org4ca70a7} enzyme 10)
...
\label{sec:orgb17bc90}
\subsubsection{Clinical Presentation}
\label{sec:org8ac207d}
\begin{description}
...
\label{sec:orgaf0479d}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org38e7c93}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org6fea1c5}
\begin{itemize}
\item AR, ASPAragine
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org874c499}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgf08009d}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:org6efabf5}
\subsection{Introduction}
\label{sec:org1956f39}
\begin{itemize}
...
\caption{\label{fig:orgb0c9189}
Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:orgf7266f8}
\subsubsection{Severe Classic NKH}
\label{sec:org5bea289}
\begin{itemize}
\item neonatal onset
...
\label{sec:org07bf511}
\subsection{Glutamine Metabolism}
\label{sec:orge66b50d}
\begin{itemize}
...
\caption{\label{fig:org6af7481}
Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org633662e}
\begin{itemize}
...
\section{Transport}
\label{sec:org9778109}
\subsection{Introduction}
\label{sec:orgdf38ca0}
\begin{itemize}
...
\label{sec:org67fa25c}
\subsubsection{Clinical Presentation}
\label{sec:orgcf715b4}
\begin{itemize}
...
\label{sec:org5d1e490}
\subsubsection{Clinical Presentation}
\label{sec:org9b5e728}
\begin{itemize}
...
\label{sec:orge6c4731}
\subsubsection{Clinical Presentation}
\label{sec:org0e38413}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgbcac5c0}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgfb516b1}
\begin{itemize}
