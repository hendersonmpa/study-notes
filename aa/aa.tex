...
\label{sec:orge3866ac}
\subsection{Introduction}
\label{sec:org6e09823}
\begin{itemize}
...
\caption{\label{fig:org3f97613}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:org8c5ab1e}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:org38c6798}Tetrahydrobiopterin metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org2d3166a}Phenylalaninemia classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org8c87f19}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:orgc706f21}
\subsubsection{Clinical Presentation}
\label{sec:org81627cb}
\begin{itemize}
...
\label{sec:org9d110f3}
\begin{enumerate}
\item Diet
\label{sec:org9d2fcb7}
\begin{itemize}
...
treatment of responsive\textsuperscript{\ref{org8c87f19}} patients with HPA and PKU, of all
ages
\end{itemize}
\item Alternative/Experimental
\label{sec:orgd082a19}
\begin{itemize}
...
\label{sec:orgdfd01fd}
\subsubsection{Clinical Presentation}
\label{sec:org0621963}
\begin{itemize}
...
\label{sec:org445ba53}
\begin{itemize}
\item disorders of BH\textsubscript{4} metabolism associated with HPA and biogenic amine deficiency (Figure \ref{fig:org38c6798})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org3954618}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:org3f97613}
and \ref{fig:org38c6798})
...
\subsubsection{Diagnostic Tests}
\label{sec:org93adac9}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:orgadf0ce2})
...
\begin{table}[htbp]
\caption{\label{tab:orgadf0ce2}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org9fbadb5}} & primapterin\textsuperscript{\ref{org9fbadb5}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org9fbadb5}blood or urine}

\subsubsection{Treatment}
\label{sec:org9ea2d52}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:org85dbae2}
\subsection{Introduction}
\label{sec:org3eb47e9}
\begin{itemize}
...
\caption{\label{fig:orgef7ef19}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:orgf48203c}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:orgef91db1}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org0dadcea}
\begin{itemize}
...
\label{sec:orge5e59a5}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgd0aa545}
\begin{itemize}
...
4-hydroxyphenyllactate and 4-hydroxyphenylacetate via AST (Figure \ref{fig:orgef7ef19})
\end{itemize}

\subsubsection{Genetics}
\label{sec:org34d011b}
\begin{itemize}
\item AR, TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3a7f1a7}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgc0c0075}
\begin{itemize}
\item AR, HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orga811461}
\begin{itemize}
...
\label{sec:org18f54e9}
\subsubsection{Clinical Presentation}
\label{sec:org104b9a1}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orge2d9727}
\begin{itemize}
\item AR, HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgab0ca88}
\begin{itemize}
...
\label{sec:org4dc5eff}
\subsubsection{Clinical Presentation}
\label{sec:orgad6ba5e}
\begin{itemize}
...
\section{BCAA}
\label{sec:org961572d}
\subsection{Introduction}
\label{sec:orgc132afe}
\begin{itemize}
...
\caption{\label{fig:org7f471e5}BCAA catabolism}
\end{figure}
...
\label{sec:org3aff29c}
\subsubsection{Clinical Presentation}
\label{sec:org88b87f7}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:orgec85add}
\begin{enumerate}
\item MSUD
\label{sec:org1e3c7b7}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgc32837a}
\begin{description}
\item{MSUD} AR E1\(\alpha\), E1\(\beta\) and E2
\item{IVA} AR IVD
\item{PA} AR PCCB
\item{MMA} AR MUT or cobalamin system (Table \ref{tab:orgf87bd24})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgf87bd24}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
Gene & Protein\\
\hline
...
\end{tabular}
\end{table}\footnotetext[4]{\label{orga04e251}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org56e1c86}
\begin{enumerate}
\item MSUD
\label{sec:orgb8f0f90}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org6bcec0b}
\begin{itemize}
\item AR, MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org581ed41}
\begin{itemize}
...
\section{Urea Cycle}
\label{sec:orgd2bcb2a}
\subsection{Introduction}
\label{sec:orgd6d6466}
\begin{itemize}
...
\caption{\label{fig:orgab08dbd}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org5a269a4}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org7ffa1d7}Diagnostic algorithm that can be applied to any hyperammonaemic patient}
\end{figure}

\subsection{Mitochondrial}
\label{sec:org192e146}
\begin{itemize}
...
\caption{\label{fig:org2101ecd}Nitrogen elimination by phenylbutyrate and benzoate}
\end{figure}

\item Prognosis
\label{sec:orgf14d6a7}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orga43c614}
\begin{enumerate}
\item Newborns
\label{sec:org641ebf0}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga2638d2}
\begin{itemize}
\item AR ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgc5a8a98}
\begin{itemize}
...
\label{sec:org14bb3da}
\subsubsection{HHH Syndrome}
\label{sec:orge3230c4}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:org92c6b23})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org1cee03a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgfc38464}
\begin{itemize}
...
\item Genetics
\label{sec:orgbdf4dd1}
\begin{itemize}
\item AR, SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf3ff2fd}
\begin{itemize}
...
\item Genetics
\label{sec:orge7824c8}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org137e93e}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:org54b2717}
\subsection{Introduction}
\label{sec:org6005690}
...
\caption{\label{fig:org377db2b}Cysteine vs Cystine}
\end{figure}
...
kinase (ADK)
\item homocysteine has two metabolic pathways (Figure \ref{fig:org38c7223}):
\begin{enumerate}
...
\caption{\label{fig:org8bb5740}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:org38c7223}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:org25f884a}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:orgacb58db}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgb954c7d}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org758aa39}
\begin{itemize}
\item AR, MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org5c8e182}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgaf8215d}
\begin{itemize}
\item AR, CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org974a8f9}
\begin{itemize}
...
\label{sec:orgff78dd4}
\subsubsection{Clinical Presentation}
\label{sec:org48a638d}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org1a38ff6}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org2b37b45}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org61e9283}
\begin{itemize}
...
\label{sec:org9abb49c}
\subsubsection{Clinical Presentation}
\label{sec:org0688d70}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge7e9f99}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org1d18162}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:org92c6b23}
\subsection{Introduction}
\label{sec:org10c49e8}
\begin{itemize}
...
\caption{\label{fig:orgd2b1ed9}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:org8890b95}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:orgb8a2c5b}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:orgc4cc5aa}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org1ab7195}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org45d4afc}
\begin{itemize}
\item AR, OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org727ce16}
\begin{itemize}
...
\item see figure \ref{fig:orgb8a2c5b} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:orgb083169}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org07317d6}
\begin{itemize}
\item AR/AD ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orged4ba59}
\begin{itemize}
...
\label{sec:org0605c94}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org580a2de}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgcc93551}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org4900850}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:org63a3e65} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:org63a3e65} enzyme 2)
\begin{itemize}
...
ketoglutarate dehydrogenase-like complex (Figure \ref{fig:org63a3e65} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:org63a3e65} enzyme 6b)
\begin{itemize}
\item KGDH may serve as an alternative route
\item 2-oxoadipic acid is dehydrogenated and decarboxylated to
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:org63a3e65} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:org63a3e65} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:org63a3e65} enzyme 9)
...
(Figure \ref{fig:org63a3e65} enzyme 10)
...
\caption{\label{fig:org63a3e65}Tryptophan, hydroxylysine and lysine catabolic pathways}
\end{figure}
...
\caption{\label{fig:orgba2302c}Tryptophan and lysine catabolic pathways}
\end{figure}

\subsection{Glutaric Aciduria Type I}
\label{sec:org6a49d2f}
\subsubsection{Clinical Presentation}
\label{sec:org88ae0c0}
\begin{itemize}
...
\label{sec:org035a5d8}
\subsubsection{Clinical Presentation}
\label{sec:orgc1538ac}
\begin{description}
...
\label{sec:org16818c4}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgefb4647}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga971ebb}
\begin{itemize}
\item AR, ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7518a29}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgaeea7aa}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:orgba56516}
\subsection{Introduction}
\label{sec:orge5016c1}
\begin{itemize}
...
\caption{\label{fig:org8217c12}Glycine cleavage enzyme}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:orgbc0af97}Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org3204538}
\subsubsection{Severe Classic NKH}
\label{sec:org1709713}
\begin{itemize}
\item neonatal onset
...
\label{sec:org5b2cfc6}
\subsection{Glutamine Metabolism}
\label{sec:org7f31900}
\begin{itemize}
...
\caption{\label{fig:orgac123b6}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orgcc05bb1}
\begin{itemize}
...
\section{Transport}
\label{sec:orgd62254a}
\subsection{Introduction}
\label{sec:org2f51c74}
\begin{itemize}
...
\caption{\label{fig:orgfa17b4c}Simplified schematic representation of cationic and neutral amino acid transport in epithelial cells}
\end{figure}

\subsection{Cystinuria}
\label{sec:org300595d}
\subsubsection{Clinical Presentation}
\label{sec:org96105fe}
\begin{itemize}
...
\label{sec:org16f5f0e}
\subsubsection{Clinical Presentation}
\label{sec:org9a0d524}
\begin{itemize}
...
\label{sec:orgc19cfa4}
\subsubsection{Clinical Presentation}
\label{sec:orge3d8f12}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org28c6922}
\begin{itemize}
\item AR, SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org1717afa}
\begin{itemize}
