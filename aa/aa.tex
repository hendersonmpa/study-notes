...
\label{sec:org4b3e482}
\subsection{Introduction}
\label{sec:orge47db8c}
\begin{itemize}
...
\caption{\label{fig:org7c9c9b6}Phenylalanine Hydroxylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide04.png}
\caption{\label{fig:orge2254d2}Phenylalanine and Tyrosine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{phe/figures/Slide21.png}
\caption{\label{fig:org890d2c0}Tetrahydrobiopterin metabolism}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org559ee26}Phenylalaninemia classification}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orge11ea0a}mild hyperphenylalaninaemia}

\subsection{Phenylalanine Hydroxylase Deficiency}
\label{sec:orgefd1ea8}
\subsubsection{Clinical Presentation}
\label{sec:orgcd1c102}
\begin{itemize}
...
\label{sec:org62d4124}
\begin{enumerate}
\item Diet
\label{sec:orgf82e912}
\begin{itemize}
...
treatment of responsive\textsuperscript{\ref{orge11ea0a}} patients with HPA and PKU, of all
ages
\end{itemize}
\item Alternative/Experimental
\label{sec:org34c0e1d}
\begin{itemize}
...
\label{sec:org525e5ac}
\subsubsection{Clinical Presentation}
\label{sec:org0ecedc8}
\begin{itemize}
...
\label{sec:org1a2bb7a}
\begin{itemize}
\item disorders of BH\textsubscript{4} metabolism associated with HPA and biogenic amine deficiency (Figure \ref{fig:org890d2c0})
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org1bd5cdf}
\begin{itemize}
\item associated with decreased activity of PAH, tyrosine hydroxylase,
tryptophan hydroxylase and nitric oxide synthase (Figures \ref{fig:org7c9c9b6}
and \ref{fig:org890d2c0})
...
\subsubsection{Diagnostic Tests}
\label{sec:orgeef5ea9}
\begin{itemize}
\item urine or blood pterin analysis and blood DHPR assay (Table \ref{tab:org339f7d2})
...
\begin{table}[htbp]
\caption{\label{tab:org339f7d2}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{orgf4a7b1f}} & primapterin\textsuperscript{\ref{orgf4a7b1f}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{orgf4a7b1f}blood or urine}

\subsubsection{Treatment}
\label{sec:org7562660}
\begin{itemize}
\item BH\textsubscript{4}
...
\section{Tyrosine}
\label{sec:org107f56c}
\subsection{Introduction}
\label{sec:org1a35822}
\begin{itemize}
...
\caption{\label{fig:org31c44eb}Tyrosine Catabolism:1 Tyrosine aminotransferase; 2 4-hydroxyphenylpyruvate dioxygenase; 3 homogentisate dioxygenase; 4 fumarylacetoacetase; 5 AST; 6 ALAD}
\end{figure}
...
\caption{\label{fig:org31df683}Phenylalanine and Tyrosine Metabolism}
\end{figure}
...
\label{sec:orgddf74f8}
\begin{itemize}
\item Hepatorenal Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org031a466}
\begin{itemize}
...
\label{sec:orgfef9d22}
\begin{itemize}
\item Oculocutaneous Tyrosinemia
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org1b88791}
\begin{itemize}
...
4-hydroxyphenyllactate and 4-hydroxyphenylacetate via AST (Figure \ref{fig:org31c44eb})
\end{itemize}

\subsubsection{Genetics}
\label{sec:org4e4b5e6}
\begin{itemize}
\item AR TAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgf9f29f4}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org93b5d21}
\begin{itemize}
\item AR HPD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orga4f00b5}
\begin{itemize}
...
\label{sec:org5df6051}
\subsubsection{Clinical Presentation}
\label{sec:orgf8df11e}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgd0c9008}
\begin{itemize}
\item AR HGD
\item 1:250000-1:1000000
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org31a3b74}
\begin{itemize}
...
\label{sec:org1f9068c}
\subsubsection{Clinical Presentation}
\label{sec:org790cc15}
\begin{itemize}
...
\section{BCAA}
\label{sec:org2f578fa}
\subsection{Introduction}
\label{sec:org5b7ffa9}
\begin{itemize}
...
\caption{\label{fig:org31235a0}BCAA catabolism}
\end{figure}
...
\label{sec:org6b29aa0}
\subsubsection{Clinical Presentation}
\label{sec:org523572e}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:orga317918}
\begin{enumerate}
\item MSUD
\label{sec:org9805f3c}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org22ebe7e}
\begin{description}
\item[{MSUD}] AR E1\(\alpha\), E1\(\beta\) and E2
\item[{IVA}] AR IVD
\item[{PA}] AR PCCB
\item[{MMA}] AR MUT or cobalamin system (Table \ref{tab:orgdecfa15})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgdecfa15}Isolated Methylmalonic Acidemia Genes}
\centering
\begin{tabular}{ll}
Gene & Protein\\
\hline
...
\end{tabular}
\end{table}\footnotetext[4]{\label{org17bfa7a}deficiency of cblC (MMACHC) causes both MMA and homocysteinemia so not "isolated"}

\subsubsection{Diagnostic Tests}
\label{sec:org0e1bb34}
\begin{enumerate}
\item MSUD
\label{sec:orge93c112}
\begin{itemize}
\item plasma amino acids:
\begin{itemize}
\item \(\uparrow\) BCAA
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org87d5ef9}
\begin{itemize}
\item AR MCCA and MCCB
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org6efcf97}
\begin{itemize}
...
\section{Urea Cycle}
\label{sec:orga0d30a7}
\subsection{Introduction}
\label{sec:org6f9b69e}
\begin{itemize}
...
\caption{\label{fig:org439a3dd}Urea Cycle}
\end{figure}
...
\caption{\label{fig:org9a9d104}Urea Cycle}
\end{figure}
...
\caption{\label{fig:orga992ce8}Diagnostic algorithm that can be applied to any hyperammonaemic patient}
\end{figure}

\subsection{Mitochondrial}
\label{sec:org7a64bcf}
\begin{itemize}
...
\caption{\label{fig:org2f99680}Nitrogen elimination by phenylbutyrate and benzoate}
\end{figure}

\item Prognosis
\label{sec:org902e9b8}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orged2d9c2}
\begin{enumerate}
\item Newborns
\label{sec:orgd7b3fe5}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgde92278}
\begin{itemize}
\item AR ASS1, ASL, ARG1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7a56a82}
\begin{itemize}
...
\label{sec:org9ed943a}
\subsubsection{HHH Syndrome}
\label{sec:orgc46cea1}
\begin{itemize}
\item see Ornithine and Proline (Section \ref{sec:org4ff3539})
\end{itemize}
\subsubsection{Citrin Deficiency}
\label{sec:org5b77779}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org071180e}
\begin{itemize}
...
\item Genetics
\label{sec:org3585ea8}
\begin{itemize}
\item AR SLC25A13
\end{itemize}

\item Diagnostic Tests
\label{sec:orgc58b531}
\begin{itemize}
...
\item Genetics
\label{sec:org41f7d4a}
\begin{itemize}
\item AR CA5A
\end{itemize}

\item Diagnostic Tests
\label{sec:org23bf55b}
\begin{itemize}
\item metabolic acidosis
\item plasma:
\begin{itemize}
...
\label{sec:org4706db6}
\subsection{Introduction}
\label{sec:orgad87afd}
...
\caption{\label{fig:org1442962}Cysteine vs Cystine}
\end{figure}
...
kinase (ADK)
\item homocysteine has two metabolic pathways (Figure \ref{fig:org5b76d1e}):
\begin{enumerate}
...
\caption{\label{fig:org69a295e}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/Slide03.png}
\caption{\label{fig:org5b76d1e}Sulfur Amino Acid Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{sulfur/figures/sulfaa.png}
\caption{\label{fig:org60e413b}Disorders of Sulfur Amino Acid Metabolism}
\end{figure}

\subsection{Methionine S-Adenosyltransferase Deficiency}
\label{sec:orgf15efbe}
\begin{itemize}
\item Mudd’s Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org0d18e91}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org7d74a0d}
\begin{itemize}
\item AR MAT1A
\item some mutation are AD
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orge4b3d34}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org98fd983}
\begin{itemize}
\item AR CBS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org331d6af}
\begin{itemize}
...
\label{sec:orgaea408b}
\subsubsection{Clinical Presentation}
\label{sec:orgd6c1868}
\begin{itemize}
\item resembles MoCo deficiency
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org99581c0}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgff494df}
\begin{itemize}
\item AR SUOX
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org51bc1c8}
\begin{itemize}
...
\label{sec:org10732b8}
\subsubsection{Clinical Presentation}
\label{sec:org64e83b9}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org6bbc337}
\begin{itemize}
\item AR ETHE1 rare
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org36191a2}
\begin{itemize}
\item \(\uparrow\) lactate
...
\label{sec:org4ff3539}
\subsection{Introduction}
\label{sec:org42ab6ce}
\begin{itemize}
...
\caption{\label{fig:org259925f}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{orn_pro/figures/Slide07.png}
\caption{\label{fig:org75e2375}Ornithine and Proline Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{orn_pro/figures/op_diff.png}
\caption{\label{fig:orgf47aac5}Differential Diagnosis of Ornthine and Proline Disorders}
\end{figure}

\subsection{OAT Deficiency}
\label{sec:org2961f62}
\begin{itemize}
\item Gyrate Atrophy of the Choriod Retina
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org880ff50}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org118be81}
\begin{itemize}
\item AR OAT
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7d2fba5}
\begin{itemize}
...
\item see figure \ref{fig:orgf47aac5} for details
\end{itemize}

\subsubsection{Metabolic Derangement}
\label{sec:orgda10799}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org52dfc06}
\begin{itemize}
\item AR/AD ALDH18A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org129e275}
\begin{itemize}
...
\label{sec:org56144f9}
\begin{itemize}
\item Hyperprolinaemia Type I
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgc5f16b7}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4fbfc8b}
\begin{itemize}
\item AR ALDH4A1
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org695dad7}
\begin{itemize}
\item \(\Uparrow\) plasma proline
\begin{itemize}
...
bifunctional enzyme, 2-aminoadipic-6-semialdehyde synthase (Figure \ref{fig:orge18cf47} enzyme 1)
\item small amount of lysine is catabolised via pipecolic acid by the
peroxisomal enzyme, pipecolic acid oxidase (Figure \ref{fig:orge18cf47} enzyme 2)
\begin{itemize}
...
ketoglutarate dehydrogenase-like complex (Figure \ref{fig:orge18cf47} enzyme 6a)
...
the Krebs cycle (Figure \ref{fig:orge18cf47} enzyme 6b)
\begin{itemize}
\item KGDH may serve as an alternative route
\item 2-oxoadipic acid is dehydrogenated and decarboxylated to
crotonyl-CoA by glutaryl-CoA dehydrogenase (Figure \ref{fig:orge18cf47} enzyme 7)
\begin{itemize}
...
short-chain enoyl-CoA hydratase 1 (Figure \ref{fig:orge18cf47} crotonase, enzyme 8)
\begin{itemize}
...
3-hydroxyacyl-CoA dehydrogenase (Figure \ref{fig:orge18cf47} enzyme 9)
...
(Figure \ref{fig:orge18cf47} enzyme 10)
...
\caption{\label{fig:orge18cf47}Tryptophan, hydroxylysine and lysine catabolic pathways}
\end{figure}
...
\caption{\label{fig:org123e646}Tryptophan and lysine catabolic pathways}
\end{figure}

\subsection{Glutaric Aciduria Type I}
\label{sec:org3c5cfa6}
\subsubsection{Clinical Presentation}
\label{sec:org371e249}
\begin{itemize}
...
\label{sec:org0483035}
\subsubsection{Clinical Presentation}
\label{sec:orgaff3338}
\begin{description}
...
\label{sec:org767ee7b}
\begin{itemize}
\item Canavan disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org1461b60}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0598683}
\begin{itemize}
\item AR ASPA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org4be6111}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org4bbbd43}
\begin{itemize}
\item none
\end{itemize}

\section{Nonketotic Hyperglycinemia}
\label{sec:orga26dbb9}
\subsection{Introduction}
\label{sec:org01db084}
\begin{itemize}
...
\caption{\label{fig:org75467e9}Glycine cleavage enzyme}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{nkh/figures/lip.png}
\caption{\label{fig:org1836d17}Lipoate}
\end{figure}

\subsection{Clinical Presentation}
\label{sec:org05a9265}
\subsubsection{Severe Classic NKH}
\label{sec:org2b20f8f}
\begin{itemize}
\item neonatal onset
...
\label{sec:orgbc4596a}
\subsection{Glutamine Metabolism}
\label{sec:org68b3be4}
\begin{itemize}
...
\caption{\label{fig:org05e1afd}Serine and Glycine Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orgacaab5e}
\begin{itemize}
...
\section{Transport}
\label{sec:orgf33decb}
\subsection{Introduction}
\label{sec:org6034e19}
\begin{itemize}
...
\caption{\label{fig:orgf7211f5}Cystine}
\end{figure}

\subsubsection{Neutral  Amino Acids}
\label{sec:org2c9cf5a}
\begin{itemize}
...
\caption{\label{fig:orgb7f05c7}Simplified schematic representation of cationic and neutral amino acid transport in epithelial cells}
\end{figure}

\subsection{Cystinuria}
\label{sec:org05579ea}
\subsubsection{Clinical Presentation}
\label{sec:orgdb8d9a4}
\begin{itemize}
...
\label{sec:orga2a7798}
\subsubsection{Clinical Presentation}
\label{sec:org340c52f}
\begin{itemize}
...
\label{sec:orgd86d18d}
\subsubsection{Clinical Presentation}
\label{sec:orgc854e69}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org5ff4756}
\begin{itemize}
\item AR SLC6A19
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org6e6ac76}
\begin{itemize}
