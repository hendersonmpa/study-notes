...
\begin{enumerate}
\item :BMCOL:
\label{sec:org25f2cd5}
\begin{enumerate}
\item Endogenous Sources
\label{sec:orgf758b28}
\begin{itemize}
\item amino acids
\begin{itemize}
...
\end{enumerate}
\item :BMCOL:
\label{sec:org0cc4b39}
\begin{enumerate}
\item Exogenous
\label{sec:org75b7367}
\begin{itemize}
\item food
\begin{itemize}
\item adipic - gelatin
...
\label{sec:org293e769}

\begin{enumerate}
\item classic organic acidemias
\label{sec:org661256f}
\begin{itemize}
...
\item Disorders that can be identified by UOA analysis
\label{sec:org4105eef}
\begin{enumerate}
\item Mitochondrial disorders
\label{sec:org2e661e0}
\begin{itemize}
...
\item Disorders that can be identified by UOA analysis
\label{sec:org26c2379}

\begin{enumerate}
\item neurotransmission
\label{sec:org1f92574}
\begin{itemize}
...
\subsection{Examples}
\label{sec:orgcf29678}

\begin{enumerate}
\item Case 1
\label{sec:org1fe8aaf}
...
\label{sec:orgcc56cdc}
\subsection{Introduction}
\label{sec:org3c91e50}
\begin{enumerate}
\item BCAAs
\label{sec:orgb758e90}
...
\label{sec:orgd0d209e}
\subsection{Introduction}
\label{sec:orge9fc1f5}
\begin{enumerate}
\item History
\label{sec:orgb4ed4a2}
\begin{itemize}
...
\label{sec:orge03d90f}

\begin{enumerate}
\item Genetics
\label{sec:orgc513cfb}
\begin{itemize}
...
\caption[PA MRI]{\label{fig:org7ad9b5f}
PA MRI}
\end{figure}

\item Long-term Treatment
\label{sec:orgb839111}
\begin{enumerate}
\item Diet
\label{sec:org1e40f9c}
\begin{itemize}
...
\label{sec:org02a44e5}
\subsection{Introduction}
\label{sec:org9597513}
\begin{enumerate}
\item History
\label{sec:org1bc2871}
\begin{itemize}
...
\item Hyperammonemia
\label{sec:orgf998f94}
\begin{itemize}
\item PA inhibits carbamylphosphate synthetase
\end{itemize}
\item Ketosis
\label{sec:org817f4cc}
\begin{itemize}
\item PA inhibits mitochondrial oxidation of succinic acid and 2-ketoglutaric acid
\end{itemize}
\end{enumerate}
...
\subsection{Laboratory Investigations}
\label{sec:org5378385}
\begin{enumerate}
\item NSO PA/MMA Screening Logic
\label{sec:org3d7d38d}
\begin{enumerate}
\item Inital positive \textless{} 7 days
\label{sec:org1092703}
(C3/C2 \(\ge\) 0.21 AND C3 \(\ge\) 4.0)
OR
(C3/C2 \(\ge\) 0.23 AND C3 \(\ge\) 3.5)
\item Inital positive \textgreater{} 7 days
\label{sec:org4a629c3}
(C3/C2 \(\ge\) 0.21 AND C3 \(\ge\) 2.6)
OR
(C3/C2 \(\ge\) 0.23 AND C3 \(\ge\) 2.4)
\begin{itemize}
...
\end{itemize}
\item Confirmation
\label{sec:orgbfe8b32}
C3/C2 \(\ge\) 0.23 AND MCA \(\ge\) 0.5
\end{enumerate}

\item Clinical Chemistry
\label{sec:orgfb17f7f}
\begin{itemize}
\item Acidosis in acute episodes
\begin{itemize}
\item accumulation of \(\beta\)-hydroxybutyrate and acetoacetate
...
\item Biochemical Genetics
\label{sec:org6c4c5c0}
\begin{enumerate}
\item Plasma Amino Acids
\label{sec:orgdaaf098}
\begin{itemize}
\item \textpm{} glycine
\item \(\uparrow\) glutamine when hyperammonemia
\end{itemize}
\item Plasma Acylcarnitines
\label{sec:org4d79800}
\begin{itemize}
\item \(\uparrow\) propionyl carnitine (C3)
...
\subsection{Clinical Findings}
\label{sec:org0ea8cf6}
\begin{enumerate}
\item Initial presentation
\label{sec:org7fb3a88}
\begin{itemize}
\item Failure to thrive
\begin{itemize}
...
\item Long-term Treatment
\label{sec:org591d0bf}
\begin{enumerate}
\item Diet
\label{sec:org60ce0e3}
\begin{itemize}
\item Limit Val, Ile, Thr, Met
\begin{itemize}
\item Monitor urine metabolites, plasma amino acids
...
\item Long-term Treatment
\label{sec:org6389af7}
\begin{enumerate}
\item Medication
\label{sec:orgfe23f75}
\begin{itemize}
...
\label{sec:orgb7d1ca3}
\subsection{Introduction}
\label{sec:orgae38d3c}

\begin{enumerate}
\item Multiple Carboxylase Deficiency
\label{sec:org3f79b40}
\begin{itemize}
...
\caption[Holocarboxylase Synthase]{\label{fig:orgdf6c07f}
Holocarboxylase Synthase}
\end{figure}

\item Holocarboxylase Synthetase Deficiency
\label{sec:orgfeb301e}
\begin{itemize}
...
\caption[Kinetics]{\label{fig:org51aef2b}
Holocarboxylase Synthetase Kinetics}
\end{figure}


\item Biotinidase
\label{sec:org3e3b133}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./mcd/figures/biot.png}
\caption[Biotinidase]{\label{fig:orgf1f9983}
Biotinidase}
\end{figure}

\item Biotin and HCS
\label{sec:orgd8453e4}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./mcd/figures/biotHCS.png}
\caption[Biotin and HCS]{\label{fig:orgd23ee8b}
Biotin and HCS}
\end{figure}


\item Treatment
\label{sec:org5476ebb}
\begin{itemize}
...
\label{sec:org689dc40}

\begin{enumerate}
\item Biotinidase NBS
\label{sec:orgd533395}
