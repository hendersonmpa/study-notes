...
\begin{enumerate}
\item :BMCOL:
\label{sec:org9217edb}
\begin{enumerate}
\item Endogenous Sources
\label{sec:orga2f5a4a}
\begin{itemize}
\item amino acids
\begin{itemize}
...
\end{enumerate}
\item :BMCOL:
\label{sec:orgf421f8e}
\begin{enumerate}
\item Exogenous
\label{sec:orgde9ab75}
\begin{itemize}
\item food
\begin{itemize}
\item adipic - gelatin
...
\label{sec:orgbc33b13}

\begin{enumerate}
\item classic organic acidemias
\label{sec:orga10b042}
\begin{itemize}
...
\item Disorders that can be identified by UOA analysis
\label{sec:org0f5cf44}
\begin{enumerate}
\item Mitochondrial disorders
\label{sec:orgadf13e9}
\begin{itemize}
...
\item Disorders that can be identified by UOA analysis
\label{sec:org9641797}

\begin{enumerate}
\item neurotransmission
\label{sec:org2f16f99}
\begin{itemize}
...
\subsection{Examples}
\label{sec:orga8c9267}

\begin{enumerate}
\item Case 1
\label{sec:org58d88f9}
...
\label{sec:orgbb70f45}
\subsection{Introduction}
\label{sec:org57db858}
\begin{enumerate}
\item BCAAs
\label{sec:orgd73ddab}
...
\label{sec:org42bd9c8}
\subsection{Introduction}
\label{sec:org5c3f764}
\begin{enumerate}
\item History
\label{sec:org7b070f3}
\begin{itemize}
...
\label{sec:orgef79649}

\begin{enumerate}
\item Genetics
\label{sec:org0b2498e}
\begin{itemize}
...
\caption[PA MRI]{\label{fig:orgc0f1696}
PA MRI}
\end{figure}

\item Long-term Treatment
\label{sec:org8aa2753}
\begin{enumerate}
\item Diet
\label{sec:org2d66a45}
\begin{itemize}
...
\label{sec:orge239d5b}
\subsection{Introduction}
\label{sec:orgfc1695c}
\begin{enumerate}
\item History
\label{sec:org28260f6}
\begin{itemize}
...
\item Hyperammonemia
\label{sec:org971e983}
\begin{itemize}
\item PA inhibits carbamylphosphate synthetase
\end{itemize}
\item Ketosis
\label{sec:orgac39c2e}
\begin{itemize}
\item PA inhibits mitochondrial oxidation of succinic acid and 2-ketoglutaric acid
\end{itemize}
\end{enumerate}
...
\subsection{Laboratory Investigations}
\label{sec:org78e09df}
\begin{enumerate}
\item NSO PA/MMA Screening Logic
\label{sec:org87cf698}
\begin{enumerate}
\item Inital positive \textless{} 7 days
\label{sec:org1a2d37f}
(C3/C2 \(\ge\) 0.21 AND C3 \(\ge\) 4.0)
OR
(C3/C2 \(\ge\) 0.23 AND C3 \(\ge\) 3.5)
\item Inital positive \textgreater{} 7 days
\label{sec:org035fe09}
(C3/C2 \(\ge\) 0.21 AND C3 \(\ge\) 2.6)
OR
(C3/C2 \(\ge\) 0.23 AND C3 \(\ge\) 2.4)
\begin{itemize}
...
\end{itemize}
\item Confirmation
\label{sec:orgc19d3f1}
C3/C2 \(\ge\) 0.23 AND MCA \(\ge\) 0.5
\end{enumerate}

\item Clinical Chemistry
\label{sec:orgac855a6}
\begin{itemize}
\item Acidosis in acute episodes
\begin{itemize}
\item accumulation of \(\beta\)-hydroxybutyrate and acetoacetate
...
\item Biochemical Genetics
\label{sec:orgadc55a4}
\begin{enumerate}
\item Plasma Amino Acids
\label{sec:org69ab6fd}
\begin{itemize}
\item \textpm{} glycine
\item \(\uparrow\) glutamine when hyperammonemia
\end{itemize}
\item Plasma Acylcarnitines
\label{sec:org80a64f2}
\begin{itemize}
\item \(\uparrow\) propionyl carnitine (C3)
...
\subsection{Clinical Findings}
\label{sec:orgb0b3a76}
\begin{enumerate}
\item Initial presentation
\label{sec:org97ea664}
\begin{itemize}
\item Failure to thrive
\begin{itemize}
...
\item Long-term Treatment
\label{sec:org89c8154}
\begin{enumerate}
\item Diet
\label{sec:org992214e}
\begin{itemize}
\item Limit Val, Ile, Thr, Met
\begin{itemize}
\item Monitor urine metabolites, plasma amino acids
...
\item Long-term Treatment
\label{sec:org037f90f}
\begin{enumerate}
\item Medication
\label{sec:org1c69369}
\begin{itemize}
...
\label{sec:orgcef419a}
\subsection{Introduction}
\label{sec:org1805264}

\begin{enumerate}
\item Multiple Carboxylase Deficiency
\label{sec:org13070ad}
\begin{itemize}
...
\caption[Holocarboxylase Synthase]{\label{fig:orgf792189}
Holocarboxylase Synthase}
\end{figure}

\item Holocarboxylase Synthetase Deficiency
\label{sec:org6ad683c}
\begin{itemize}
...
\caption[Kinetics]{\label{fig:orge03a7bf}
Holocarboxylase Synthetase Kinetics}
\end{figure}


\item Biotinidase
\label{sec:orgdfada56}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./mcd/figures/biot.png}
\caption[Biotinidase]{\label{fig:org4fbc028}
Biotinidase}
\end{figure}

\item Biotin and HCS
\label{sec:org66a3d73}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./mcd/figures/biotHCS.png}
\caption[Biotin and HCS]{\label{fig:org814bb88}
Biotin and HCS}
\end{figure}


\item Treatment
\label{sec:orgf69cac3}
\begin{itemize}
...
\label{sec:orgb7bf57c}

\begin{enumerate}
\item Clinical
\label{sec:org2dc0cb0}
\begin{itemize}
...
\caption[Biotin Cycle]{\label{fig:orgf06f439}
Biotin Cycle}
\end{figure}


\item Biotinidase
\label{sec:orgdbe3f3f}
...
\label{sec:orgeb32aa3}

\begin{enumerate}
\item Profound Deficiency
\label{sec:org5d040a0}
\begin{itemize}
...
\label{sec:org4958dfa}

\begin{enumerate}
\item Biotinidase NBS
\label{sec:orgca99b6b}
