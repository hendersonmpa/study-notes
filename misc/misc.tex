...
\label{sec:org24051bc}
\subsection{Introduction}
\label{sec:orgb05241d}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org80deed6}blood or urine}
\section{Peptides}
...
\item Genetics
\label{sec:org679fd61}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org8463b3e}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:org7cdf11e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1972693}
\begin{itemize}
...
\item Genetics
\label{sec:orgcf62d8c}
\begin{itemize}
\item AR, UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgacb8c8a}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:org82344ed}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org4ac749b}
\subsection{Introduction}
\label{sec:orgf8a889e}
\begin{itemize}
...
\label{sec:org8b8a1b9}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:org137e4fb}
\begin{itemize}
