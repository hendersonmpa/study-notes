...
\label{sec:org9816726}
\subsection{Introduction}
\label{sec:orga6b708e}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:org02bae91})
\item three receptor defects (section \ref{sec:orge07a66a})
\item three transportopathies are reported (section \ref{sec:orge07a66a})
\item six disorders of monoamine metabolism (section \ref{sec:org81128a8})
\item see Amino Acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:org02bae91}
\begin{itemize}
...
\caption{\label{fig:org68d78fd}Brain Metabolism of GABA: 1 glutamic acid decarboxylase; 2 GABA transaminase; 3 succinic semialdehyde dehydrogenase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide23.png}
\caption{\label{fig:orga37a095}\(\gamma\)-Aminobutryic Acid Metabolism}
\end{figure}

\subsubsection{Succinic Semialdehyde Dehydrogenase Deficiency}
\label{sec:org582ae93}
\begin{itemize}
...
\item Genetics
\label{sec:org9d4efd7}
\begin{itemize}
\item AR ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org8770577}
\begin{itemize}
...
\caption{\label{fig:orgd806667}Tetrahydrobiopterin Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide22.png}
\caption{\label{fig:org21bed0a}Biogenic Amines}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{neuro/figures/monoamines.png}
\caption{\label{fig:org5090b04}Metabolism of Adrenaline, Noradrenaline, Dopamine and Serotonin}
\end{figure}


\subsubsection{Tyrosine Hydroxylase (TH) Deficiency}
\label{sec:org22c1413}
\begin{itemize}
...
\label{sec:org476618e}
\begin{itemize}
\item dopamine responsive dystonia (Figure \ref{fig:orgd806667} and Table \ref{tab:org49fbffc})
...
\begin{table}[htbp]
\caption{\label{tab:org49fbffc}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org460bbc8}} & primapterin\textsuperscript{\ref{org460bbc8}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org460bbc8}blood or urine}
\section{Peptides}
\label{sec:org1d092ea}
\subsection{TMA and Choline}
\label{sec:org374f744}
\subsubsection{Trimethylamine Metabolism}
\label{sec:orgad51ec8}
\begin{itemize}
...
\caption{\label{fig:org0faf5cf}Trimethlyamine Metabolism}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:orge3a1e7b}
\begin{itemize}
...
\caption{\label{fig:org5549254}Choline Catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org7906272}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org72011e5}
\begin{itemize}
...
\caption{\label{fig:orgd83e081}The \(\gamma\)-Glutamyl Cycle}
\end{figure}
...
\caption{\label{fig:orgd421c95}The \(\gamma\)-Glutamyl Cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:org32a3985}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6eb82b7}
\begin{itemize}
...
\item Genetics
\label{sec:org13bc3c3}
\begin{itemize}
\item AR GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:org067122c}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:org8da5206}
\subsection{Copper}
\label{sec:orgdf70f00}
\begin{itemize}
...
\caption[copper]{\label{fig:orgc3eb0f2}Copper Metabolism}
\end{figure}
\subsubsection{Menkes Disease}
\label{sec:org236b3a0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org342ab4e}
\begin{itemize}
...
\label{sec:org5a461f0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc0bb903}
\begin{itemize}
...
\subsection{Iron}
\label{sec:org78832a3}
\begin{itemize}
\item iron is essential for the synthesis of haem and other
metalloproteins
\begin{itemize}
\item iron sulfur cluster has a crucial role in mitochondrial metabolism (Figure \ref{fig:org5f71da8})
\end{itemize}
...
\caption[iron]{\label{fig:org1d7003d}Iron Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{metal/figures/fes.png}
\caption[fes]{\label{fig:org5f71da8}Iron Sulfur Cluster Proteins}
\end{figure}

\subsubsection{Classic Hereditary Haemochromatosis}
\label{sec:org5c4c11e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2c6a0dd}
\begin{itemize}
...
\label{sec:orgb261492}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{pp/figures/Slide17.png}
\caption{\label{fig:orgbe22b4c}Purine and Pyrimidine Metabolism}
\end{figure}

\subsection{Purine Metabolism}
\label{sec:orga7cf863}
\subsubsection{Introduction}
\label{sec:org2e71e77}
\begin{itemize}
...
\caption{\label{fig:orged7fa96}Purine Metabolism:1 PRPP synthetase; 2 adenylosuccinase; 3 AICAR transformylase; 4 IMP cyclohydrolase; 5 adenylosuccinate synthetase; 6 AMP deaminase; 7 5‘-nucleotidase; 8 adenosine deaminase; 9 purine nucleoside phosphorylase; 10 hypoxanthine-guanine phosphoribosyltransferase; 11 adenine phosphoribosyltransferase; 12 adenosine kinase; 13 guanosine kinase; 14 xanthine oxidase}
\end{figure}

\subsubsection{Phosphoribosyl Pyrophosphate Synthetase Superactivity}
\label{sec:org013a9f7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6d91621}
\begin{itemize}
\item gouty arthritis and/or uric acid lithiasis in young males
\end{itemize}

\item Metabolic Derangement
\label{sec:org37292c4}
\begin{itemize}
...
\item Genetics
\label{sec:org4112386}
\begin{itemize}
\item \textbf{XL PRPS1}
\end{itemize}

\item Diagnostic Tests
\label{sec:org73821ef}
\begin{itemize}
...
\item Genetics
\label{sec:orgc988b68}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:orga679b58}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:org15aeab3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgca78f22}
\begin{itemize}
...
\item Genetics
\label{sec:orgf562bd7}
\begin{itemize}
\item AR PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:org0aa8c21}
\begin{itemize}
...
\item Genetics
\label{sec:org319eea1}
\begin{itemize}
\item AR XDH
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd694482}
\begin{itemize}
\item \(\downarrow\) plasma uric acid
\item \(\downarrow\) urine uric acid
...
\label{sec:org7f45b67}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org7485989}
\begin{itemize}
...
\item Genetic
\label{sec:org2b666c9}
\begin{itemize}
\item \textbf{XL HPRT}
\end{itemize}

\item Diagnostic Tests
\label{sec:org9013a07}
\begin{itemize}
...
\label{sec:orgd2b1f4c}
\subsubsection{Introduction}
\label{sec:org0d96a0f}
\begin{itemize}
...
\item Genetics
\label{sec:orge970dd7}
\begin{itemize}
\item AR UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgcd8f949}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid 200-1000X
\end{itemize}

\item Treatment
\label{sec:orgbd6d213}
\begin{itemize}
...
\label{sec:org3e85de7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb006e6c}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:orgfbc77aa}
\begin{itemize}
\item AR DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:orgc5acccc}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org57227fb}
\subsection{Introduction}
\label{sec:orgc2a8efa}
\begin{itemize}
...
\caption{\label{fig:org5325f0b}Heme Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{porphyrins/figures/Slide19.png}
\caption{\label{fig:orgff50a1d}Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org0d90785}Route of Excretion of Porphyrin Precursors}
\centering
\begin{tabular}{ll}
Porphyrin & Route\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orgb24bcfa}Porphyrin Function}
\centering
\begin{tabular}{ll}
Protein & Functions\\
\hline
...
\label{sec:org5b42073}

\begin{table}[htbp]
\caption{\label{tab:orgefcf5b5}Main Types of Human Porphyrias}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{orge52259e}A = anemia, N = neuroviseral, C = cutaneous}
...
\begin{table}[htbp]
\caption{\label{tab:orgb099c14}Main Types of Human Porphyrias: Classification by Onset}
\centering
...
\label{sec:orged5c24a}
\subsubsection{Clinical Features}
\label{sec:org2ed7cd4}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orge91716e}Clinical Features of Acute Neuroviseral Attacks}
\centering
\begin{tabular}{lr}
...
\label{sec:org7cf8c95}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:org16b6910}
\begin{itemize}
...
\label{sec:org364dfc5}
\begin{enumerate}
\item Acute Attack
\label{sec:orgf01a625}
\begin{itemize}
...
\label{sec:orge0a06ac}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org21405b4}
\begin{itemize}
\item both sexes
...
\label{sec:orga2a5c8c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgdcc294c}
\begin{itemize}
...
\label{sec:org328304b}
\begin{enumerate}
\item Clinical Features
\label{sec:org6e0237d}
\begin{itemize}
...
\end{itemize}
\section{Oxalate}
\label{sec:orgbab6216}
\subsection{Primary Hyperoxalouria}
\label{sec:org61359e8}
\begin{itemize}
...
\caption{\label{fig:orgad47c79}Glyoxylate Metabolism}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:org99866fd}
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org6b79691}
\begin{enumerate}
\item PH1
\label{sec:org9227b4b}
\begin{itemize}
...
\caption{\label{fig:orge9b2b3f}Diagnosis of Primary Hyperoxaluria}
\end{figure}

\subsubsection{Treatment}
\label{sec:org4459677}
\begin{itemize}
