...
\label{sec:orgb07d7f2}
\subsection{Introduction}
\label{sec:orgb4c5a8f}
\begin{itemize}
...
\item Genetics
\label{sec:org37f4726}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgc254515}
\begin{itemize}
...
\caption{\label{fig:org7c8c48a}
TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:orgcdda04b}
\begin{itemize}
...
\caption{\label{fig:orge97ed5b}
Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org9538402}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1e51263}
\begin{itemize}
...
\label{sec:orga3c2c38}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org7192172}
\begin{itemize}
...
\caption[iron]{\label{fig:org6204cd6}
Iron Metabolism}
\end{figure}
...
\item Genetics
\label{sec:org1fe3c2c}
\begin{itemize}
\item X-linked, PRPS1
\end{itemize}

\item Diagnostic Tests
\label{sec:org709d4fe}
\begin{itemize}
...
\label{sec:org3d9b10e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org597867f}
\begin{itemize}
...
\item Genetics
\label{sec:org9d97b30}
\begin{itemize}
\item AR
\end{itemize}

\item Diagnostic Tests
\label{sec:org4c1b7e5}
\begin{itemize}
...
\label{sec:orgc0d9819}
\begin{enumerate}
\item Clinical Picture
\label{sec:org66066fc}
\begin{itemize}
...
\label{sec:org65258ca}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org661cc8a}
\begin{itemize}
...
\item Genetic
\label{sec:orgb5cad94}
\begin{itemize}
\item XLR, HPRT
\end{itemize}

\item Diagnostic Tests
\label{sec:orgaa753b2}
\begin{itemize}
...
\label{sec:org283ac67}
\subsubsection{Introduction}
\label{sec:orge621f1d}
\begin{itemize}
...
\label{sec:orgce73ea4}
\begin{itemize}
\item AKA: Hereditary Orotic Aciduria
\end{itemize}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org554c211}
\begin{itemize}
...
\item Genetics
\label{sec:org2cdde4f}
\begin{itemize}
\item AR, UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org46cbbda}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:orgfaa5db7}
\begin{itemize}
...
\label{sec:orgd140624}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd745a81}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\section{Porphyrias}
\label{sec:orgabf279e}
\subsection{Introduction}
\label{sec:org9f76215}
\begin{itemize}
...
\caption{\label{fig:orgcc6e614}
Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org2e79cf8}
...
\label{sec:org1017b31}
\subsubsection{ALA Dehydratase Porphyria}
\label{sec:orgb06b485}
\begin{itemize}
...
\label{sec:orge1f605b}
\begin{enumerate}
\item Acute Attack
\label{sec:org950fee1}
\begin{itemize}
