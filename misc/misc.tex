...
\label{sec:orge50b09d}
\subsection{Introduction}
\label{sec:org679a68d}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:org36b46a3})
\item three receptor defects (section \ref{sec:org580c6a4})
\item three transportopathies are reported (section \ref{sec:org580c6a4})
\item six disorders of monoamine metabolism (section \ref{sec:org02bc0c5})
\item see Amino Acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:org36b46a3}
\begin{itemize}
...
\caption{\label{fig:orgcd7b97b}Brain Metabolism of GABA: 1 glutamic acid decarboxylase; 2 GABA transaminase; 3 succinic semialdehyde dehydrogenase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide23.png}
\caption{\label{fig:org0ea8368}\(\gamma\)-Aminobutryic Acid Metabolism}
\end{figure}

\subsubsection{Succinic Semialdehyde Dehydrogenase Deficiency}
\label{sec:org2c18466}
\begin{itemize}
...
\item Genetics
\label{sec:org6eb6aec}
\begin{itemize}
\item AR ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org162d7af}
\begin{itemize}
...
\caption{\label{fig:orgb196057}Tetrahydrobiopterin Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide22.png}
\caption{\label{fig:orgee5fdd3}Biogenic Amines}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{neuro/figures/monoamines.png}
\caption{\label{fig:org88d764e}Metabolism of Adrenaline, Noradrenaline, Dopamine and Serotonin}
\end{figure}


\subsubsection{Tyrosine Hydroxylase (TH) Deficiency}
\label{sec:orgfdec7f1}
\begin{itemize}
...
\label{sec:orgbbfd2dc}
\begin{itemize}
\item dopamine responsive dystonia (Figure \ref{fig:orgb196057} and Table \ref{tab:org2a9955a})
...
\begin{table}[htbp]
\caption{\label{tab:org2a9955a}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org17c195e}} & primapterin\textsuperscript{\ref{org17c195e}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org17c195e}blood or urine}
\section{Peptides}
\label{sec:org7cbcb31}
\subsection{TMA and Choline}
\label{sec:org229f1b6}
\subsubsection{Trimethylamine Metabolism}
\label{sec:orgdee59aa}
\begin{itemize}
...
\caption{\label{fig:orgb67a0ec}Trimethlyamine Metabolism}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:org2e84151}
\begin{itemize}
...
\caption{\label{fig:org8cffa3a}Choline Catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:orgdd4df00}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge0c1dec}
\begin{itemize}
...
\caption{\label{fig:org4958cfc}The \(\gamma\)-Glutamyl Cycle}
\end{figure}
...
\caption{\label{fig:org70f7708}The \(\gamma\)-Glutamyl Cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:org69d96f9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org48d5866}
\begin{itemize}
...
\item Genetics
\label{sec:orgc75169b}
\begin{itemize}
\item AR GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgeccb38f}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:orge044a57}
\subsection{Copper}
\label{sec:orgac10d2b}
\begin{itemize}
...
\caption[copper]{\label{fig:org0970b4a}Copper Metabolism}
\end{figure}
\subsubsection{Menkes Disease}
\label{sec:org561d317}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc1fc7b9}
\begin{itemize}
...
\label{sec:orgc314c6b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org22b66f8}
\begin{itemize}
...
\subsection{Iron}
\label{sec:org0afbe0a}
\begin{itemize}
\item iron is essential for the synthesis of haem and other
metalloproteins
\begin{itemize}
\item iron sulfur cluster has a crucial role in mitochondrial metabolism (Figure \ref{fig:orga3baa05})
\end{itemize}
...
\caption[iron]{\label{fig:orgcf50d48}Iron Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{metal/figures/fes.png}
\caption[fes]{\label{fig:orga3baa05}Iron Sulfur Cluster Proteins}
\end{figure}

\subsubsection{Classic Hereditary Haemochromatosis}
\label{sec:org2c0baa3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd4c8407}
\begin{itemize}
...
\label{sec:org4d149c3}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{pp/figures/Slide17.png}
\caption{\label{fig:org8783e0b}Purine and Pyrimidine Metabolism}
\end{figure}

\subsection{Purine Metabolism}
\label{sec:orgd5493b9}
\subsubsection{Introduction}
\label{sec:org06b758c}
\begin{itemize}
...
\caption{\label{fig:org2385d9a}Purine Metabolism:1 PRPP synthetase; 2 adenylosuccinase; 3 AICAR transformylase; 4 IMP cyclohydrolase; 5 adenylosuccinate synthetase; 6 AMP deaminase; 7 5‘-nucleotidase; 8 adenosine deaminase; 9 purine nucleoside phosphorylase; 10 hypoxanthine-guanine phosphoribosyltransferase; 11 adenine phosphoribosyltransferase; 12 adenosine kinase; 13 guanosine kinase; 14 xanthine oxidase}
\end{figure}

\subsubsection{Phosphoribosyl Pyrophosphate Synthetase Superactivity}
\label{sec:org2c06ac5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc56b427}
\begin{itemize}
\item gouty arthritis and/or uric acid lithiasis in young males
\end{itemize}

\item Metabolic Derangement
\label{sec:org2a8fc96}
\begin{itemize}
...
\item Genetics
\label{sec:org0623b0a}
\begin{itemize}
\item \textbf{XL PRPS1}
\end{itemize}

\item Diagnostic Tests
\label{sec:org9a62577}
\begin{itemize}
...
\item Genetics
\label{sec:orgc4f8e05}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org96d2752}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:org873a289}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org74b06e0}
\begin{itemize}
...
\item Genetics
\label{sec:orge771e7d}
\begin{itemize}
\item AR PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:org52ef53a}
\begin{itemize}
...
\item Genetics
\label{sec:orga54cf6d}
\begin{itemize}
\item AR XDH
\end{itemize}

\item Diagnostic Tests
\label{sec:org83db45c}
\begin{itemize}
\item \(\downarrow\) plasma uric acid
\item \(\downarrow\) urine uric acid
...
\label{sec:org41db97b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc11a287}
\begin{itemize}
...
\item Genetic
\label{sec:org16f1b50}
\begin{itemize}
\item \textbf{XL HPRT}
\end{itemize}

\item Diagnostic Tests
\label{sec:org4e325e7}
\begin{itemize}
...
\label{sec:org683133f}
\subsubsection{Introduction}
\label{sec:orgd26a48a}
\begin{itemize}
...
\item Genetics
\label{sec:org63d0513}
\begin{itemize}
\item AR UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org039ca04}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid 200-1000X
\end{itemize}

\item Treatment
\label{sec:org1e170d0}
\begin{itemize}
...
\label{sec:orgc82f683}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2061154}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:org8118e85}
\begin{itemize}
\item AR DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:org1ed8f58}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org2b325b3}
\subsection{Introduction}
\label{sec:org4e91a77}
\begin{itemize}
...
\caption{\label{fig:orgb06e57e}Heme Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{porphyrins/figures/Slide19.png}
\caption{\label{fig:org889315b}Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org710a3e7}Route of excretion dictated by solubility for porphyrin precursors}
\centering
\begin{tabular}{ll}
Porphyrin & Route\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org28b3a49}Porphyrin Function}
\centering
\begin{tabular}{ll}
Protein & Functions\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org51a0f6d}Main types of human porphyrias}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{orgba1d07e}A = anemia, N = neuroviseral, C = cutaneous}

\subsubsection{Clinical Classification of the Porphyrias}
\label{sec:orgcaa73d4}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org7e1c0e9}Main types of human porphyrias: Classification by onset}
\centering
...
\label{sec:org9eb7697}
\subsubsection{Clinical Features}
\label{sec:orgd3aff94}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org2112956}Clinical features of acute neuroviseral attacks}
\centering
\begin{tabular}{lr}
...
\label{sec:org841c4e7}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:orgc7ad9f9}
\begin{itemize}
...
\label{sec:org66b64d9}
\begin{enumerate}
\item Acute Attack
\label{sec:org5780c3b}
\begin{itemize}
...
\label{sec:orgc60658d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org52b36bf}
\begin{itemize}
\item both sexes
...
\label{sec:org41da13c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3cb3192}
\begin{itemize}
...
\label{sec:orgdd0bee1}
\begin{enumerate}
\item Clinical Features
\label{sec:org312c0e3}
\begin{itemize}
...
\end{itemize}
\section{Oxalate}
\label{sec:orga9905a5}
\subsection{Primary Hyperoxalouria}
\label{sec:orgbedc786}
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org9f408bc}
\begin{enumerate}
\item PH1
\label{sec:org676de6a}
\begin{itemize}
...
\caption{\label{fig:org3ce61b6}Diagnosis of Primary Hyperoxaluria}
\end{figure}

\subsubsection{Treatment}
\label{sec:org6188b79}
\begin{itemize}
