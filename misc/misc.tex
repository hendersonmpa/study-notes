...
\end{tabular}
\end{table}\footnotetext[1]{\label{org291909a}blood or urine}
\section{Peptides}
...
\label{sec:org2d89708}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4318e7e}
\begin{itemize}
...
\caption[copper]{\label{fig:org913d5ad}Copper Metabolism}
\end{figure}
\subsubsection{Menkes Disease}
\label{sec:org14198dc}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb043f69}
\begin{itemize}
...
\label{sec:org9bd0e63}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3999d56}
\begin{itemize}
...
\caption[iron]{\label{fig:orgaadd2d9}Iron Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{metal/figures/fes.png}
\caption[fes]{\label{fig:org10e4867}Iron Sulfur Cluster Proteins}
\end{figure}

\subsubsection{Classic Hereditary Haemochromatosis}
\label{sec:org9fcf4f4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgee83a8b}
\begin{itemize}
...
\caption{\label{fig:org5b621e7}Purine Metabolism:1 PRPP synthetase; 2 adenylosuccinase; 3 AICAR transformylase; 4 IMP cyclohydrolase; 5 adenylosuccinate synthetase; 6 AMP deaminase; 7 5‘-nucleotidase; 8 adenosine deaminase; 9 purine nucleoside phosphorylase; 10 hypoxanthine-guanine phosphoribosyltransferase; 11 adenine phosphoribosyltransferase; 12 adenosine kinase; 13 guanosine kinase; 14 xanthine oxidase}
\end{figure}

\subsubsection{Phosphoribosyl Pyrophosphate Synthetase Superactivity}
\label{sec:orgc78cc09}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9cbefbb}
\begin{itemize}
\item gouty arthritis and/or uric acid lithiasis in young males
\end{itemize}

\item Metabolic Derangement
\label{sec:orgd6fe9be}
\begin{itemize}
...
\item Genetics
\label{sec:org7607e94}
\begin{itemize}
\item \textbf{XL PRPS1}
\end{itemize}

\item Diagnostic Tests
\label{sec:org9085b7c}
\begin{itemize}
...
\item Genetics
\label{sec:org8facb1d}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org677deb0}
\begin{itemize}
\item NIET
\begin{itemize}
...
\item Genetics
\label{sec:orgcd761be}
\begin{itemize}
\item AR PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf532be4}
\begin{itemize}
...
\item Genetics
\label{sec:org530ea33}
\begin{itemize}
\item AR UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org67ed856}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid 200-1000X
\end{itemize}

\item Treatment
\label{sec:org6002e85}
\begin{itemize}
...
\label{sec:org2e353e9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org64c3710}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:orged51589}
\begin{itemize}
\item AR DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:org8713363}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org75a468c}
\subsection{Introduction}
\label{sec:orgf899ef4}
\begin{itemize}
...
\caption{\label{fig:org4a493ed}Heme Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{porphyrins/figures/Slide19.png}
\caption{\label{fig:org1bf7918}Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orgea705a7}Route of excretion dictated by solubility for porphyrin precursors}
\centering
\begin{tabular}{ll}
Porphyrin & Route\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orgdc47431}Porphyrin Function}
\centering
\begin{tabular}{ll}
Protein & Functions\\
\hline
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org74be7c2}A = anemia, N = neuroviseral, C = cutaneous}
...
\begin{table}[htbp]
\caption{\label{tab:org1f8b6a4}Main types of human porphyrias: Classification by onset}
\centering
...
\label{sec:orgccb1f2b}
\subsubsection{Clinical Features}
\label{sec:org5d771b2}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgeca98ad}Clinical features of acute neuroviseral attacks}
\centering
\begin{tabular}{lr}
...
\label{sec:org9064a7c}
\begin{enumerate}
\item Acute Attack
\label{sec:orgf696226}
\begin{itemize}
