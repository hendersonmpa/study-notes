...
\end{tabular}
\end{table}\footnotetext[1]{\label{org60b3776}blood or urine}
\section{Peptides}
...
\label{sec:org93994f4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0a07dfd}
\begin{itemize}
...
\caption[copper]{\label{fig:orgfdea860}Copper Metabolism}
\end{figure}
\subsubsection{Menkes Disease}
\label{sec:org2bf7aa4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org271d52e}
\begin{itemize}
...
\label{sec:orgfe14e1f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1932a2e}
\begin{itemize}
...
\caption[iron]{\label{fig:orga96c817}Iron Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{metal/figures/fes.png}
\caption[fes]{\label{fig:orgc9fedd8}Iron Sulfur Cluster Proteins}
\end{figure}

\subsubsection{Classic Hereditary Haemochromatosis}
\label{sec:org7162e69}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2afffa3}
\begin{itemize}
...
\caption{\label{fig:org8b7abaa}Purine Metabolism:1 PRPP synthetase; 2 adenylosuccinase; 3 AICAR transformylase; 4 IMP cyclohydrolase; 5 adenylosuccinate synthetase; 6 AMP deaminase; 7 5‘-nucleotidase; 8 adenosine deaminase; 9 purine nucleoside phosphorylase; 10 hypoxanthine-guanine phosphoribosyltransferase; 11 adenine phosphoribosyltransferase; 12 adenosine kinase; 13 guanosine kinase; 14 xanthine oxidase}
\end{figure}

\subsubsection{Phosphoribosyl Pyrophosphate Synthetase Superactivity}
\label{sec:org348dc85}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org78f23a8}
\begin{itemize}
\item gouty arthritis and/or uric acid lithiasis in young males
\end{itemize}

\item Metabolic Derangement
\label{sec:orgffbf5b3}
\begin{itemize}
...
\item Genetics
\label{sec:org7c55a09}
\begin{itemize}
\item \textbf{XL PRPS1}
\end{itemize}

\item Diagnostic Tests
\label{sec:org30058fc}
\begin{itemize}
...
\item Genetics
\label{sec:orgb4da964}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgfc355f1}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:org8e6e84e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5975ba1}
\begin{itemize}
...
\item Genetics
\label{sec:orgcbc8076}
\begin{itemize}
\item AR PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:org7883371}
\begin{itemize}
...
\item Genetics
\label{sec:orgb90640e}
\begin{itemize}
\item AR UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org86df457}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid 200-1000X
\end{itemize}

\item Treatment
\label{sec:org9196964}
\begin{itemize}
...
\label{sec:org30c0c36}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga2ed7ff}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:org5ebf34f}
\begin{itemize}
\item AR DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:org6428529}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org51aa7ac}
\subsection{Introduction}
\label{sec:orgaaa6358}
\begin{itemize}
...
\caption{\label{fig:orgc9ebda6}Heme Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{porphyrins/figures/Slide19.png}
\caption{\label{fig:org7234d06}Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org721410d}Route of excretion dictated by solubility for porphyrin precursors}
\centering
\begin{tabular}{ll}
Porphyrin & Route\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org8dd2add}Porphyrin Function}
\centering
\begin{tabular}{ll}
Protein & Functions\\
\hline
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org752547e}A = anemia, N = neuroviseral, C = cutaneous}
...
\begin{table}[htbp]
\caption{\label{tab:org93e5015}Main types of human porphyrias: Classification by onset}
\centering
...
\label{sec:org1eba026}
\subsubsection{Clinical Features}
\label{sec:org9476f3a}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org54ecae8}Clinical features of acute neuroviseral attacks}
\centering
\begin{tabular}{lr}
...
\label{sec:org0f71080}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:org2b22a29}
\begin{itemize}
...
\label{sec:org1888ec7}
\begin{enumerate}
\item Acute Attack
\label{sec:orgeeba490}
\begin{itemize}
