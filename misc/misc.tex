...
\label{sec:orgbc86d60}
\subsection{Introduction}
\label{sec:orga2604d7}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:orgf77bb98})
\item three receptor defects (section \ref{sec:org1629ab6})
\item three transportopathies are reported (section \ref{sec:org1629ab6})
\item six disorders of monoamine metabolism (section \ref{sec:org2405c5f})
\item see Amino Acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:orgf77bb98}
\begin{itemize}
...
\caption{\label{fig:orge88d53f}Brain Metabolism of GABA: 1 glutamic acid decarboxylase; 2 GABA transaminase; 3 succinic semialdehyde dehydrogenase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide23.png}
\caption{\label{fig:org919a143}\(\gamma\)-Aminobutryic Acid Metabolism}
\end{figure}

\subsubsection{Succinic Semialdehyde Dehydrogenase Deficiency}
\label{sec:orgb5651e3}
\begin{itemize}
...
\item Genetics
\label{sec:orgf2d7fcf}
\begin{itemize}
\item AR ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org39e4755}
\begin{itemize}
...
\caption{\label{fig:org6c3d49b}Tetrahydrobiopterin Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide22.png}
\caption{\label{fig:org73f3dc1}Biogenic Amines}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{neuro/figures/monoamines.png}
\caption{\label{fig:orgb54fbe7}Metabolism of Adrenaline, Noradrenaline, Dopamine and Serotonin}
\end{figure}


\subsubsection{Tyrosine Hydroxylase (TH) Deficiency}
\label{sec:org2eb56c8}
\begin{itemize}
...
\label{sec:org370f757}
\begin{itemize}
\item dopamine responsive dystonia (Figure \ref{fig:org6c3d49b} and Table \ref{tab:org1befbaf})
...
\begin{table}[htbp]
\caption{\label{tab:org1befbaf}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org2643d6c}} & primapterin\textsuperscript{\ref{org2643d6c}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org2643d6c}blood or urine}
\section{Peptides}
\label{sec:orgbac4d17}
\subsection{TMA and Choline}
\label{sec:orge0aca5e}
\subsubsection{Trimethylamine Metabolism}
\label{sec:org681f759}
\begin{itemize}
...
\caption{\label{fig:org32a2793}Trimethlyamine Metabolism}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:org64fbc85}
\begin{itemize}
...
\caption{\label{fig:org31a4731}Choline Catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org377f10d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgaa4f062}
\begin{itemize}
...
\caption{\label{fig:orgabc0935}The \(\gamma\)-Glutamyl Cycle}
\end{figure}
...
\caption{\label{fig:org607768e}The \(\gamma\)-Glutamyl Cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:orgc9bc5e1}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga2788fb}
\begin{itemize}
...
\item Genetics
\label{sec:org4c4d4e9}
\begin{itemize}
\item AR GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgb40d7c7}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:org6bb0c31}
\subsection{Copper}
\label{sec:orgc7d63d0}
\begin{itemize}
...
\caption[copper]{\label{fig:org2a67326}Copper Metabolism}
\end{figure}
\subsubsection{Menkes Disease}
\label{sec:orgabc8088}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orged6b280}
\begin{itemize}
...
\label{sec:org207df76}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2217a08}
\begin{itemize}
...
\subsection{Iron}
\label{sec:orgf27169c}
\begin{itemize}
\item iron is essential for the synthesis of haem and other
metalloproteins
\begin{itemize}
\item iron sulfur cluster has a crucial role in mitochondrial metabolism (Figure \ref{fig:org30c04c1})
\end{itemize}
...
\caption[iron]{\label{fig:org33095c8}Iron Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{metal/figures/fes.png}
\caption[fes]{\label{fig:org30c04c1}Iron Sulfur Cluster Proteins}
\end{figure}

\subsubsection{Classic Hereditary Haemochromatosis}
\label{sec:orge889b20}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9460c3f}
\begin{itemize}
...
\label{sec:orgb39be60}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{pp/figures/Slide17.png}
\caption{\label{fig:org861e364}Purine and Pyrimidine Metabolism}
\end{figure}

\subsection{Purine Metabolism}
\label{sec:org096d3c9}
\subsubsection{Introduction}
\label{sec:orgd6cb7e5}
\begin{itemize}
...
\caption{\label{fig:orgfe54fe0}Purine Metabolism:1 PRPP synthetase; 2 adenylosuccinase; 3 AICAR transformylase; 4 IMP cyclohydrolase; 5 adenylosuccinate synthetase; 6 AMP deaminase; 7 5‘-nucleotidase; 8 adenosine deaminase; 9 purine nucleoside phosphorylase; 10 hypoxanthine-guanine phosphoribosyltransferase; 11 adenine phosphoribosyltransferase; 12 adenosine kinase; 13 guanosine kinase; 14 xanthine oxidase}
\end{figure}

\subsubsection{Phosphoribosyl Pyrophosphate Synthetase Superactivity}
\label{sec:org7eaab72}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org61b5c49}
\begin{itemize}
\item gouty arthritis and/or uric acid lithiasis in young males
\end{itemize}

\item Metabolic Derangement
\label{sec:orgdde34e0}
\begin{itemize}
...
\item Genetics
\label{sec:orgbc1529f}
\begin{itemize}
\item \textbf{XL PRPS1}
\end{itemize}

\item Diagnostic Tests
\label{sec:org9049470}
\begin{itemize}
...
\item Genetics
\label{sec:org44fa818}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org262a4e9}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:orga671160}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5ca50e1}
\begin{itemize}
...
\item Genetics
\label{sec:orga3e955d}
\begin{itemize}
\item AR PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:org4e8a4cc}
\begin{itemize}
...
\item Genetics
\label{sec:org0057d7f}
\begin{itemize}
\item AR XDH
\end{itemize}

\item Diagnostic Tests
\label{sec:orgc4aa2a2}
\begin{itemize}
\item \(\downarrow\) plasma uric acid
\item \(\downarrow\) urine uric acid
...
\label{sec:org635490c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org895f818}
\begin{itemize}
...
\item Genetic
\label{sec:org2e683b9}
\begin{itemize}
\item \textbf{XL HPRT}
\end{itemize}

\item Diagnostic Tests
\label{sec:org671f2f6}
\begin{itemize}
...
\label{sec:org8506130}
\subsubsection{Introduction}
\label{sec:orgab36cce}
\begin{itemize}
...
\item Genetics
\label{sec:org8ca419e}
\begin{itemize}
\item AR UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgbabbbfb}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid 200-1000X
\end{itemize}

\item Treatment
\label{sec:org4427e98}
\begin{itemize}
...
\label{sec:org4127d65}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org459d483}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:orgf08692d}
\begin{itemize}
\item AR DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:orgc1b7873}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org74eca71}
\subsection{Introduction}
\label{sec:org786926a}
\begin{itemize}
...
\caption{\label{fig:org00121a7}Heme Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{porphyrins/figures/Slide19.png}
\caption{\label{fig:org739e031}Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org79a1869}Route of Excretion of Porphyrin Precursors}
\centering
\begin{tabular}{ll}
Porphyrin & Route\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orgfbecf0c}Porphyrin Function}
\centering
\begin{tabular}{ll}
Protein & Functions\\
\hline
...
\label{sec:orga5c5a36}

\begin{table}[htbp]
\caption{\label{tab:orga2f265f}Main Types of Human Porphyrias}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{orgc254f03}A = anemia, N = neuroviseral, C = cutaneous}
...
\begin{table}[htbp]
\caption{\label{tab:orga4d3a4b}Main Types of Human Porphyrias: Classification by Onset}
\centering
...
\label{sec:org3bb34ec}
\subsubsection{Clinical Features}
\label{sec:orgeb3cf77}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgeda2731}Clinical Features of Acute Neuroviseral Attacks}
\centering
\begin{tabular}{lr}
...
\label{sec:orga06b826}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:org360a935}
\begin{itemize}
...
\label{sec:org3e73489}
\begin{enumerate}
\item Acute Attack
\label{sec:org00aa135}
\begin{itemize}
...
\label{sec:org04885bf}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgbc42e93}
\begin{itemize}
\item both sexes
...
\label{sec:orgbf79b51}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgad36b1d}
\begin{itemize}
...
\label{sec:orgb6c1126}
\begin{enumerate}
\item Clinical Features
\label{sec:orge39ade2}
\begin{itemize}
...
\end{itemize}
\section{Oxalate}
\label{sec:orgd348924}
\subsection{Primary Hyperoxalouria}
\label{sec:org3d5abee}
\begin{itemize}
...
\caption{\label{fig:org52cc9f1}Glyoxylate Metabolism}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:org91c0218}
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org5c8d061}
\begin{enumerate}
\item PH1
\label{sec:org9a0621f}
\begin{itemize}
...
\caption{\label{fig:org7c747f6}Diagnosis of Primary Hyperoxaluria}
\end{figure}

\subsubsection{Treatment}
\label{sec:org10a648e}
\begin{itemize}
