...
\label{sec:orge7f4816}
\subsection{Introduction}
\label{sec:orgd090d83}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:org7ccf9ba})
\item three receptor defects (section \ref{sec:org2ddacd8})
\item three transportopathies are reported (section \ref{sec:org2ddacd8})
\item six disorders of monoamine metabolism (section \ref{sec:orga9d8324})
\item see Amino Acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:org7ccf9ba}
\begin{itemize}
...
\caption{\label{fig:org97218bb}Brain metabolism of GABA: 1 glutamic acid decarboxylase; 2 GABA transaminase; 3 succinic semialdehyde dehydrogenase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide23.png}
\caption{\label{fig:org3e65cf0}\(\gamma\)-aminobutryic acid metabolism}
\end{figure}

\subsubsection{Succinic Semialdehyde Dehydrogenase Deficiency}
\label{sec:orgca4e187}
\begin{itemize}
...
\item Genetics
\label{sec:org815be01}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org701eda6}
\begin{itemize}
...
\caption{\label{fig:org0af2c0c}Tetrahydrobiopterin metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide22.png}
\caption{\label{fig:org3b01399}Biogenic Amines}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{neuro/figures/monoamines.png}
\caption{\label{fig:org9028086}Metabolism of adrenaline, noradrenaline, dopamine and serotonin}
\end{figure}


\subsubsection{Tyrosine hydroxylase (TH) deficiency}
\label{sec:orgd669eda}
\begin{itemize}
...
\label{sec:org7a804e6}
\begin{itemize}
\item dopamine responsive dystonia (Figure \ref{fig:org0af2c0c} and Table \ref{tab:orgd737bad})
...
\begin{table}[htbp]
\caption{\label{tab:orgd737bad}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{orge5fdad6}} & primapterin\textsuperscript{\ref{orge5fdad6}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orge5fdad6}blood or urine}
\section{Peptides}
\label{sec:orga2c70bc}
\subsection{TMA and Choline}
\label{sec:org997fbf4}
\subsubsection{Trimethylamine Metabolism}
\label{sec:org82f1253}
\begin{itemize}
...
\caption{\label{fig:orgf99703a}TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:org7a90bbc}
\begin{itemize}
...
\caption{\label{fig:org0a95121}Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org330958b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf06d43a}
\begin{itemize}
...
\caption{\label{fig:org6a7ba49}The \(\gamma\)-glutamyl cycle}
\end{figure}
...
\caption{\label{fig:org72edbbc}The \(\gamma\)-glutamyl cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:org871faea}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org696117f}
\begin{itemize}
...
\item Genetics
\label{sec:org7fdc42b}
\begin{itemize}
\item AR GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgaf83f4d}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:org1c9e79b}
\subsection{Copper}
\label{sec:orgc6b9bbe}
\begin{itemize}
...
\caption[copper]{\label{fig:orgad37eba}Copper Metabolism}
\end{figure}
\subsubsection{Menkes Disease}
\label{sec:orgbde7af2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd53f180}
\begin{itemize}
...
\label{sec:org2c4acab}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgdcd5f2c}
\begin{itemize}
...
\subsection{Iron}
\label{sec:org5a24428}
\begin{itemize}
\item iron is essential for the synthesis of haem and other
metalloproteins
\begin{itemize}
\item iron sulfur cluster has a crucial role in mitochondrial metabolism (Figure \ref{fig:orgd227234})
\end{itemize}
...
\caption[iron]{\label{fig:org870da1e}Iron Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{metal/figures/fes.png}
\caption[fes]{\label{fig:orgd227234}Iron Sulfur Cluster Proteins}
\end{figure}

\subsubsection{Classic Hereditary Haemochromatosis}
\label{sec:org40b24a0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga96263d}
\begin{itemize}
...
\label{sec:orgd2ac13d}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{pp/figures/Slide17.png}
\caption{\label{fig:org3fd1b30}Purine and Pyrimidine Metabolism}
\end{figure}

\subsection{Purine Metabolism}
\label{sec:orgdce103f}
\subsubsection{Introduction}
\label{sec:org86ee303}
\begin{itemize}
...
\caption{\label{fig:org122bf3f}Purine Metabolism:1 PRPP synthetase; 2 adenylosuccinase; 3 AICAR transformylase; 4 IMP cyclohydrolase; 5 adenylosuccinate synthetase; 6 AMP deaminase; 7 5‘-nucleotidase; 8 adenosine deaminase; 9 purine nucleoside phosphorylase; 10 hypoxanthine-guanine phosphoribosyltransferase; 11 adenine phosphoribosyltransferase; 12 adenosine kinase; 13 guanosine kinase; 14 xanthine oxidase}
\end{figure}

\subsubsection{Phosphoribosyl Pyrophosphate Synthetase Superactivity}
\label{sec:org2119b72}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga03d464}
\begin{itemize}
\item gouty arthritis and/or uric acid lithiasis in young males
\end{itemize}

\item Metabolic Derangement
\label{sec:org3366c72}
\begin{itemize}
...
\item Genetics
\label{sec:org2a71951}
\begin{itemize}
\item \textbf{XL PRPS1}
\end{itemize}

\item Diagnostic Tests
\label{sec:orgff17258}
\begin{itemize}
...
\item Genetics
\label{sec:org0de336d}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgb055ade}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:org660063e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2491876}
\begin{itemize}
...
\item Genetics
\label{sec:org82049ac}
\begin{itemize}
\item AR PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:org18722c7}
\begin{itemize}
...
\item Genetics
\label{sec:org718235b}
\begin{itemize}
\item AR XDH
\end{itemize}

\item Diagnostic Tests
\label{sec:org45a0b1e}
\begin{itemize}
\item \(\downarrow\) plasma uric acid
\item \(\downarrow\) urine uric acid
...
\label{sec:org0d5b86b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org13015fe}
\begin{itemize}
...
\item Genetic
\label{sec:orgda86d06}
\begin{itemize}
\item \textbf{XL HPRT}
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd131747}
\begin{itemize}
...
\label{sec:org30cfa15}
\subsubsection{Introduction}
\label{sec:org44f27d7}
\begin{itemize}
...
\item Genetics
\label{sec:org4353755}
\begin{itemize}
\item AR UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd61004a}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:org1ce30a7}
\begin{itemize}
...
\label{sec:org2b311c5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgff7e1ae}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:orgc79b2dc}
\begin{itemize}
\item AR DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:orgbccc532}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org7bdd050}
\subsection{Introduction}
\label{sec:org39eded1}
\begin{itemize}
...
\caption{\label{fig:orgc0d4bda}Heme Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{porphyrins/figures/Slide19.png}
\caption{\label{fig:orga286408}Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orgae642f8}Route of excretion dictated by solubility for porphyrin precursors}
\centering
\begin{tabular}{ll}
Porphyrin & Route\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orgbb84477}Porphyrin Function}
\centering
\begin{tabular}{ll}
Protein & Functions\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org56e1c4b}Main types of human porphyrias}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org3d7fed0}A = anemia, N = neuroviseral, C = cutaneous}

\subsubsection{Clinical Classification of the Porphyrias}
\label{sec:org212971c}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org04ba29e}Main types of human porphyrias: Classification by onset}
\centering
...
\label{sec:org22685fd}
\subsubsection{Clinical Features}
\label{sec:org323a176}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org6a0c18f}Clinical features of acute neuroviseral attacks}
\centering
\begin{tabular}{lr}
...
\label{sec:orga6d34f5}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:org18091e9}
\begin{itemize}
...
\label{sec:orgff64ffe}
\begin{enumerate}
\item Acute Attack
\label{sec:org89b14d8}
\begin{itemize}
...
\label{sec:orge67748f}
\begin{enumerate}
\item Clincal Presentation
\label{sec:org6fa3e7f}
\begin{itemize}
\item both sexes
...
\label{sec:orgd9aec8d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5897125}
\begin{itemize}
...
\label{sec:org9a6cb73}
\begin{enumerate}
\item Clinical Features
\label{sec:orge4cde56}
\begin{itemize}
