...
\label{sec:org930f88c}
\subsection{Introduction}
\label{sec:orga0ea8a4}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgc907587}blood or urine}
\section{Peptides}
...
\item Genetics
\label{sec:org170a4e9}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org74d06e4}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:org97030d9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6b81604}
\begin{itemize}
...
\item Genetics
\label{sec:org264edfd}
\begin{itemize}
\item AR, UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf083e71}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:orgd8edc3d}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org30586f5}
\subsection{Introduction}
\label{sec:orgfde99d9}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgef83c92}Main types of human porphyrias: Classification by onset}
\centering
...
\label{sec:orgc076c4d}
\subsubsection{Clinical Features}
\label{sec:org4821f52}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org9f7312e}Clinical features of acute neuroviseral attacks}
\centering
\begin{tabular}{lr}
