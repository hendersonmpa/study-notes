...
\label{sec:orgab57283}
\subsection{Introduction}
\label{sec:org6e43583}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:org44a1d48})
\item three receptor defects (section \ref{sec:org8dc17f1})
\item three transportopathies are reported (section \ref{sec:org8dc17f1})
\item six disorders of monoamine metabolism (section \ref{sec:org14ee8e0})
\item see Amino Acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:org44a1d48}
\begin{itemize}
...
\caption{\label{fig:org3abd783}Brain metabolism of GABA: 1 glutamic acid decarboxylase; 2 GABA transaminase; 3 succinic semialdehyde dehydrogenase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide23.png}
\caption{\label{fig:org14d668d}\(\gamma\)-aminobutryic acid metabolism}
\end{figure}

\subsubsection{Succinic Semialdehyde Dehydrogenase Deficiency}
\label{sec:orgff43a81}
\begin{itemize}
...
\item Genetics
\label{sec:orgac5a38b}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgb102f99}
\begin{itemize}
...
\caption{\label{fig:org7a02581}Tetrahydrobiopterin metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide22.png}
\caption{\label{fig:orgccdd038}Biogenic Amines}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{neuro/figures/monoamines.png}
\caption{\label{fig:orgb1a48bb}Metabolism of adrenaline, noradrenaline, dopamine and serotonin}
\end{figure}


\subsubsection{Tyrosine hydroxylase (TH) deficiency}
\label{sec:org10b853e}
\begin{itemize}
...
\label{sec:orgea8a3f9}
\begin{itemize}
\item dopamine responsive dystonia (Figure \ref{fig:org7a02581} and Table \ref{tab:org661d382})
...
\begin{table}[htbp]
\caption{\label{tab:org661d382}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{orgf9021a0}} & primapterin\textsuperscript{\ref{orgf9021a0}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgf9021a0}blood or urine}
\section{Peptides}
\label{sec:org6b74201}
\subsection{TMA and Choline}
\label{sec:orgb6672fc}
\subsubsection{Trimethylamine Metabolism}
\label{sec:org5369ec6}
\begin{itemize}
...
\caption{\label{fig:org4d62bf7}TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:org61e4222}
\begin{itemize}
...
\caption{\label{fig:org6a7575b}Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org6b5d8b8}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2a88445}
\begin{itemize}
...
\caption{\label{fig:orgda9eb48}The \(\gamma\)-glutamyl cycle}
\end{figure}
...
\caption{\label{fig:orgda98fc6}The \(\gamma\)-glutamyl cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:org884c8ae}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9e09b3c}
\begin{itemize}
...
\item Genetics
\label{sec:org5026271}
\begin{itemize}
\item AR GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:org61ca9e1}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:org30961eb}
\subsection{Copper}
\label{sec:org2eadcbd}
\begin{itemize}
...
\caption[copper]{\label{fig:org4125fa4}Copper Metabolism}
\end{figure}
\subsubsection{Menkes Disease}
\label{sec:orgcc599ad}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org14dedb4}
\begin{itemize}
...
\label{sec:orgf866666}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org15edc29}
\begin{itemize}
...
\subsection{Iron}
\label{sec:orgdaa0aa2}
\begin{itemize}
\item iron is essential for the synthesis of haem and other
metalloproteins
\begin{itemize}
\item iron sulfur cluster has a crucial role in mitochondrial metabolism (Figure \ref{fig:org073353e})
\end{itemize}
...
\caption[iron]{\label{fig:org4f2603b}Iron Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{metal/figures/fes.png}
\caption[fes]{\label{fig:org073353e}Iron Sulfur Cluster Proteins}
\end{figure}

\subsubsection{Classic Hereditary Haemochromatosis}
\label{sec:orga86f270}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org53b94d6}
\begin{itemize}
...
\label{sec:org5949054}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{pp/figures/Slide17.png}
\caption{\label{fig:orgbd639f9}Purine and Pyrimidine Metabolism}
\end{figure}

\subsection{Purine Metabolism}
\label{sec:org0209b17}
\subsubsection{Introduction}
\label{sec:orgf5b42cc}
\begin{itemize}
...
\caption{\label{fig:orge36f3a7}Purine Metabolism:1 PRPP synthetase; 2 adenylosuccinase; 3 AICAR transformylase; 4 IMP cyclohydrolase; 5 adenylosuccinate synthetase; 6 AMP deaminase; 7 5‘-nucleotidase; 8 adenosine deaminase; 9 purine nucleoside phosphorylase; 10 hypoxanthine-guanine phosphoribosyltransferase; 11 adenine phosphoribosyltransferase; 12 adenosine kinase; 13 guanosine kinase; 14 xanthine oxidase}
\end{figure}

\subsubsection{Phosphoribosyl Pyrophosphate Synthetase Superactivity}
\label{sec:org88a267e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd55498a}
\begin{itemize}
\item gouty arthritis and/or uric acid lithiasis in young males
\end{itemize}

\item Metabolic Derangement
\label{sec:orge57e3d2}
\begin{itemize}
...
\item Genetics
\label{sec:orgec87adf}
\begin{itemize}
\item \textbf{XL PRPS1}
\end{itemize}

\item Diagnostic Tests
\label{sec:orgb166e0e}
\begin{itemize}
...
\item Genetics
\label{sec:org4c546a0}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org3640f23}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:org65c0574}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org474c82a}
\begin{itemize}
...
\item Genetics
\label{sec:org1a9f0fc}
\begin{itemize}
\item AR PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:org92075c7}
\begin{itemize}
...
\item Genetics
\label{sec:orgfbe2dd4}
\begin{itemize}
\item AR XDH
\end{itemize}

\item Diagnostic Tests
\label{sec:org43e570c}
\begin{itemize}
\item \(\downarrow\) plasma uric acid
\item \(\downarrow\) urine uric acid
...
\label{sec:org9f5584c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4f8e08c}
\begin{itemize}
...
\item Genetic
\label{sec:org359e7d0}
\begin{itemize}
\item \textbf{XL HPRT}
\end{itemize}

\item Diagnostic Tests
\label{sec:orgc2ddbb5}
\begin{itemize}
...
\label{sec:org12db710}
\subsubsection{Introduction}
\label{sec:orgdb4fada}
\begin{itemize}
...
\item Genetics
\label{sec:orgfeb55b6}
\begin{itemize}
\item AR UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org0843bd0}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid 200-1000X
\end{itemize}

\item Treatment
\label{sec:org8ee6c91}
\begin{itemize}
...
\label{sec:org188d096}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0d90cca}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:orgf9e2de3}
\begin{itemize}
\item AR DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:org4bbb5d4}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org4b72214}
\subsection{Introduction}
\label{sec:org5c97588}
\begin{itemize}
...
\caption{\label{fig:org627bbf3}Heme Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{porphyrins/figures/Slide19.png}
\caption{\label{fig:org302899c}Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org68bfe88}Route of excretion dictated by solubility for porphyrin precursors}
\centering
\begin{tabular}{ll}
Porphyrin & Route\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org94532bc}Porphyrin Function}
\centering
\begin{tabular}{ll}
Protein & Functions\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orgc19c72d}Main types of human porphyrias}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{orgfdefb32}A = anemia, N = neuroviseral, C = cutaneous}

\subsubsection{Clinical Classification of the Porphyrias}
\label{sec:org2890267}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgdb3da61}Main types of human porphyrias: Classification by onset}
\centering
...
\label{sec:orgdcc1b07}
\subsubsection{Clinical Features}
\label{sec:orgfb56993}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgbd1ee3d}Clinical features of acute neuroviseral attacks}
\centering
\begin{tabular}{lr}
...
\label{sec:orgbb30c45}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:org79b0178}
\begin{itemize}
...
\label{sec:org75a437c}
\begin{enumerate}
\item Acute Attack
\label{sec:orgbf200fd}
\begin{itemize}
...
\label{sec:orgec06401}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org12bcf56}
\begin{itemize}
\item both sexes
...
\label{sec:org72c3428}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgeda8aed}
\begin{itemize}
...
\label{sec:org8d53ac5}
\begin{enumerate}
\item Clinical Features
\label{sec:org32219a1}
\begin{itemize}
