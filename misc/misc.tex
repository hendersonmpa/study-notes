...
\label{sec:org73927af}
\subsection{Introduction}
\label{sec:org7fca662}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:orgfc6967e})
\item three receptor defects (section \ref{sec:org4a9c5cb})
\item three transportopathies are reported section \ref{sec:org4a9c5cb})
\item six disorders of monoamine metabolism (section \ref{sec:org34421af})
\item see aminoacidopathies for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:orgfc6967e}
\begin{itemize}
...
\item Genetics
\label{sec:orgd4ae93e}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd880277}
\begin{itemize}
...
\caption{\label{fig:org966223b}
TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:org9c81557}
\begin{itemize}
...
\caption{\label{fig:orgb36b161}
Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org6e58ef3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org52526ea}
\begin{itemize}
...
\caption{\label{fig:org25e40c5}
The \(\gamma\)-glutamyl cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:orgbceab73}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0b8a5fe}
\begin{itemize}
...
\item Genetics
\label{sec:org1129f37}
\begin{itemize}
\item AR
\end{itemize}

\item Diagnostic Tests
\label{sec:org2cc3222}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:org7f1711a}
\subsection{Copper}
\label{sec:org40443b7}
\begin{itemize}
...
\caption[copper]{\label{fig:org6aa78c8}
Copper Metabolism}
\end{figure}

\subsubsection{Wilson Disease}
\label{sec:orga3c7fba}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org99e03ed}
\begin{itemize}
...
\label{sec:org1e61b6c}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org4eb8014}
\begin{itemize}
...
\caption[iron]{\label{fig:orgc285c15}
Iron Metabolism}
\end{figure}
...
\item Genetics
\label{sec:orgd5a6998}
\begin{itemize}
\item X-linked, PRPS1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf1726dd}
\begin{itemize}
...
\label{sec:orgc231f7a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org371ea78}
\begin{itemize}
...
\item Genetics
\label{sec:orgc142a75}
\begin{itemize}
\item AR
\end{itemize}

\item Diagnostic Tests
\label{sec:org766aba4}
\begin{itemize}
...
\label{sec:org983b103}
\begin{enumerate}
\item Clinical Picture
\label{sec:org82917d1}
\begin{itemize}
...
\label{sec:org42161f4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org42ab2d7}
\begin{itemize}
...
\item Genetic
\label{sec:org2f0f0a4}
\begin{itemize}
\item XLR, HPRT
\end{itemize}

\item Diagnostic Tests
\label{sec:orgedad48e}
\begin{itemize}
...
\label{sec:org849cdf4}
\subsubsection{Introduction}
\label{sec:orgb3e3017}
\begin{itemize}
...
\label{sec:orgc4a8401}
\begin{itemize}
\item AKA: Hereditary Orotic Aciduria
\end{itemize}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org54373a2}
\begin{itemize}
...
\item Genetics
\label{sec:org1ca19bf}
\begin{itemize}
\item AR, UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org65349e2}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:orgcf370f5}
\begin{itemize}
...
\label{sec:org9c043fc}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org7840278}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org979a293}
\subsection{Introduction}
\label{sec:orgcc596a9}
\begin{itemize}
...
\caption{\label{fig:org01fa6e4}
Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org6663f7d}
...
\label{sec:orgf7caf64}
\subsubsection{ALA Dehydratase Porphyria}
\label{sec:orge4a0d47}
\begin{itemize}
...
\label{sec:org2f6ce13}
\begin{enumerate}
\item Acute Attack
\label{sec:orgdaef88e}
\begin{itemize}
