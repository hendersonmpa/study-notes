...
\label{sec:orgb14d7c2}
\subsection{Introduction}
\label{sec:orgd738d3a}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:orgf640645})
\item three receptor defects (section \ref{sec:org5fc159d})
\item three transportopathies are reported (section \ref{sec:org5fc159d})
\item six disorders of monoamine metabolism (section \ref{sec:org1295705})
\item see amino acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:orgf640645}
\begin{itemize}
...
\item Genetics
\label{sec:org4681220}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org64e3e68}
\begin{itemize}
...
\label{sec:org671e377}
\begin{itemize}
\item dopamine responsive dystonia
...
\caption{\label{fig:org64dd1bc}
TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:org839e754}
\begin{itemize}
...
\caption{\label{fig:orge01451a}
Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org88e6564}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1e3e817}
\begin{itemize}
...
\item Genetics
\label{sec:org0f6fbce}
\begin{itemize}
\item AR, \textasciitilde{}1\% carrier freq
\end{itemize}

\item Diagnostic Tests
\label{sec:orgbfc791f}
\begin{itemize}
...
\caption{\label{fig:orgc60e6a3}
The \(\gamma\)-glutamyl cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:org517cae9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd80de44}
\begin{itemize}
...
\item Genetics
\label{sec:orgcab574d}
\begin{itemize}
\item AR, GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgcfc0bbd}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:org54ee017}
\subsection{Copper}
\label{sec:orgb7afec4}
\begin{itemize}
...
\caption[copper]{\label{fig:org9160c59}
Copper Metabolism}
\end{figure}

\subsubsection{Wilson Disease}
\label{sec:orge17bccd}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgcb1d429}
\begin{itemize}
...
\label{sec:org0de2f23}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgffaac0e}
\begin{itemize}
...
\caption[iron]{\label{fig:orgfe94963}
Iron Metabolism}
\end{figure}
...
\item Genetics
\label{sec:orgc76c310}
\begin{itemize}
\item X-linked, PRPS1
\end{itemize}

\item Diagnostic Tests
\label{sec:orge56dafc}
\begin{itemize}
...
\item Genetics
\label{sec:org1d47d1f}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org3fb7677}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:org5487dc0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge8854f8}
\begin{itemize}
...
\item Genetics
\label{sec:orgd7b76b6}
\begin{itemize}
\item AR, PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:org9c4354e}
\begin{itemize}
...
\label{sec:org5d53037}
\begin{enumerate}
\item Clinical Picture
\label{sec:orgc3c139c}
\begin{itemize}
...
\label{sec:org9f65fc8}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge0807c4}
\begin{itemize}
...
\item Genetic
\label{sec:orgb86a9ab}
\begin{itemize}
\item \textbf{XLR}, HPRT
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf8804a9}
\begin{itemize}
...
\label{sec:orgc1029af}
\subsubsection{Introduction}
\label{sec:org27f1819}
\begin{itemize}
...
\label{sec:orgfb6e582}
\begin{itemize}
\item AKA: Hereditary Orotic Aciduria
\end{itemize}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8f52219}
\begin{itemize}
...
\item Genetics
\label{sec:orga41adde}
\begin{itemize}
\item AR, UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org74bcb6c}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:orgbe3199d}
\begin{itemize}
...
\label{sec:org7e4f1e3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org16fd56a}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:org5b43f9a}
\begin{itemize}
\item AR, DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:org7a75b3b}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:orgb8f470c}
\subsection{Introduction}
\label{sec:org103058c}
\begin{itemize}
...
\caption{\label{fig:org14a24d1}
Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org7031df9}
...
\label{sec:org1274942}
\subsubsection{Clinical Features}
\label{sec:org528c371}
\begin{itemize}
...
\label{sec:org60cb864}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:orga36e31b}
\begin{itemize}
...
\label{sec:org23ad4fd}
\begin{enumerate}
\item Acute Attack
\label{sec:org8fd4491}
\begin{itemize}
...
\item urine should be markedly elevated
\begin{itemize}
...
\label{sec:org5d30461}
\begin{enumerate}
\item Clincal Presentation
\label{sec:orged6e923}
\begin{itemize}
\item both sexes
...
\label{sec:org81f2704}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc2b6289}
\begin{itemize}
...
\label{sec:org1075f3f}
\begin{enumerate}
\item Clinical Features
\label{sec:org94712b2}
\begin{itemize}
