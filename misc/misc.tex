...
\label{sec:org1a23f1d}
\subsection{Introduction}
\label{sec:orgb26a8a2}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:org7b0d5d6})
\item three receptor defects (section \ref{sec:orgee6471d})
\item three transportopathies are reported (section \ref{sec:orgee6471d})
\item six disorders of monoamine metabolism (section \ref{sec:org50230e0})
\item see amino acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:org7b0d5d6}
\begin{itemize}
...
\item Genetics
\label{sec:orgcaa4f3b}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgfd5da12}
\begin{itemize}
...
\label{sec:org22c984d}
\begin{itemize}
\item dopamine responsive dystonia (Figure \ref{fig:orga590f97} and Table \ref{tab:orgd756a0a})
...
\begin{table}[htbp]
\caption{\label{tab:orgd756a0a}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org205ac58}} & primapterin\textsuperscript{\ref{org205ac58}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org205ac58}blood or urine}
\section{Peptides}
\label{sec:orgbc7a7df}
\subsection{TMA and Choline}
\label{sec:org8ecf31e}
\subsubsection{Trimethylamine Metabolism}
\label{sec:orgf50db7b}
\begin{itemize}
...
\caption{\label{fig:orgdaaeedf}
TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:org97b3068}
\begin{itemize}
...
\caption{\label{fig:orgdae444b}
Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org9d902b1}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgac66b5b}
\begin{itemize}
...
\item Genetics
\label{sec:orgb9f20fc}
\begin{itemize}
\item AR, \textasciitilde{}1\% carrier freq
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf49d805}
\begin{itemize}
...
\caption{\label{fig:org95b47ca}
The \(\gamma\)-glutamyl cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:orgb40aed4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2b536b4}
\begin{itemize}
...
\item Genetics
\label{sec:orgbef4c3c}
\begin{itemize}
\item AR, GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:org4d1aabc}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:orgb5c6460}
\subsection{Copper}
\label{sec:org1826073}
\begin{itemize}
...
\caption[copper]{\label{fig:orge8479b2}
Copper Metabolism}
\end{figure}

\subsubsection{Wilson Disease}
\label{sec:org6237661}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3d86e1a}
\begin{itemize}
...
\label{sec:org878cbe4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgfc42735}
\begin{itemize}
...
\caption[iron]{\label{fig:org5641af5}
Iron Metabolism}
\end{figure}
...
\item Genetics
\label{sec:org50665a7}
\begin{itemize}
\item X-linked, PRPS1
\end{itemize}

\item Diagnostic Tests
\label{sec:org5b955cb}
\begin{itemize}
...
\item Genetics
\label{sec:org9f746d6}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org4ffd79b}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:orgfccc23a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org99759eb}
\begin{itemize}
...
\item Genetics
\label{sec:orgce85c96}
\begin{itemize}
\item AR, PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:org73d6b50}
\begin{itemize}
...
\label{sec:orgeb7662b}
\begin{enumerate}
\item Clinical Picture
\label{sec:orgc005784}
\begin{itemize}
...
\label{sec:orgb1530ef}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org946fcc7}
\begin{itemize}
...
\item Genetic
\label{sec:orgfa9f7dd}
\begin{itemize}
\item \textbf{XLR}, HPRT
\end{itemize}

\item Diagnostic Tests
\label{sec:org47beadf}
\begin{itemize}
...
\label{sec:org04a2fd1}
\subsubsection{Introduction}
\label{sec:org074706b}
\begin{itemize}
...
\label{sec:org7964277}
\begin{itemize}
\item AKA: Hereditary Orotic Aciduria
\end{itemize}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org95c5754}
\begin{itemize}
...
\item Genetics
\label{sec:orgbe58bfd}
\begin{itemize}
\item AR, UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:orga05ffc8}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:org3514b19}
\begin{itemize}
...
\label{sec:orgfaf7d39}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org57d5f5e}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:org54fbdc7}
\begin{itemize}
\item AR, DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:org5ca315b}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org702186b}
\subsection{Introduction}
\label{sec:org8a35283}
\begin{itemize}
...
\caption{\label{fig:org52ef7d0}
Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org3363766}
...
\label{sec:org78e3840}
\subsubsection{Clinical Features}
\label{sec:orgb8e488c}
\begin{itemize}
...
\label{sec:orge014b52}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:org72805d6}
\begin{itemize}
...
\label{sec:orga8f82a8}
\begin{enumerate}
\item Acute Attack
\label{sec:orgf187979}
\begin{itemize}
...
\label{sec:org1e31e70}
\begin{enumerate}
\item Clincal Presentation
\label{sec:orgf3594b5}
\begin{itemize}
\item both sexes
...
\label{sec:orgfba651c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf7c6de9}
\begin{itemize}
...
\label{sec:orga01866e}
\begin{enumerate}
\item Clinical Features
\label{sec:orgcbadb83}
\begin{itemize}
