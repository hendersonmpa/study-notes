...
\label{sec:org77d2bf5}
\subsection{Introduction}
\label{sec:orgc2c547e}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:org45ac48b})
\item three receptor defects (section \ref{sec:org15ab21a})
\item three transportopathies are reported (section \ref{sec:org15ab21a})
\item six disorders of monoamine metabolism (section \ref{sec:orga5b601a})
\item see amino acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:org45ac48b}
\begin{itemize}
...
\item Genetics
\label{sec:org9dd6976}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org84c467a}
\begin{itemize}
...
\begin{itemize}
\item dopamine responsive dystonia (Figure \ref{fig:orgf3d4cbc} and Table \ref{tab:org5183b2e})
...
\begin{table}[htbp]
\caption{\label{tab:org5183b2e}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{orgcaaa9a6}} & primapterin\textsuperscript{\ref{orgcaaa9a6}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgcaaa9a6}blood or urine}
\section{Peptides}
\label{sec:orgf5a2847}
\subsection{TMA and Choline}
\label{sec:org6fd5d87}
\subsubsection{Trimethylamine Metabolism}
\label{sec:org41a3136}
\begin{itemize}
...
\caption{\label{fig:org59cd03f}
TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:org24ee0d7}
\begin{itemize}
...
\caption{\label{fig:org807a434}
Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org282cef3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb46e2cc}
\begin{itemize}
...
\item Genetics
\label{sec:org03bcb74}
\begin{itemize}
\item AR, \textasciitilde{}1\% carrier freq
\end{itemize}

\item Diagnostic Tests
\label{sec:org579901e}
\begin{itemize}
...
\caption{\label{fig:org4753e8d}
The \(\gamma\)-glutamyl cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:orga72f2d9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8ea3401}
\begin{itemize}
...
\item Genetics
\label{sec:orgcf4d13a}
\begin{itemize}
\item AR, GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgffb3990}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:org1dfa846}
\subsection{Copper}
\label{sec:org75b2c7a}
\begin{itemize}
...
\caption[copper]{\label{fig:orgd09e3ff}
Copper Metabolism}
\end{figure}

\subsubsection{Wilson Disease}
\label{sec:orgf240c7d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9ca86aa}
\begin{itemize}
...
\label{sec:org7d38e06}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb0e1eca}
\begin{itemize}
...
\caption[iron]{\label{fig:orgfefb6df}
Iron Metabolism}
\end{figure}
...
\item Genetics
\label{sec:org76a1429}
\begin{itemize}
\item X-linked, PRPS1
\end{itemize}

\item Diagnostic Tests
\label{sec:org43ff8f0}
\begin{itemize}
...
\item Genetics
\label{sec:orge946aa7}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org0a18123}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:org5bdbc0a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6867c37}
\begin{itemize}
...
\item Genetics
\label{sec:org72f7bbd}
\begin{itemize}
\item AR, PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:org5f95b25}
\begin{itemize}
...
\label{sec:org36ea5ec}
\begin{enumerate}
\item Clinical Picture
\label{sec:orgdc55f0b}
\begin{itemize}
...
\label{sec:org1b359cf}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org995dd54}
\begin{itemize}
...
\item Genetic
\label{sec:orge7dbdbd}
\begin{itemize}
\item \textbf{XLR}, HPRT
\end{itemize}

\item Diagnostic Tests
\label{sec:org4393630}
\begin{itemize}
...
\label{sec:org369e87c}
\subsubsection{Introduction}
\label{sec:org1558822}
\begin{itemize}
...
\label{sec:orgccca96d}
\begin{itemize}
\item AKA: Hereditary Orotic Aciduria
\end{itemize}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org734274d}
\begin{itemize}
...
\item Genetics
\label{sec:org648d3f2}
\begin{itemize}
\item AR, UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org195111b}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:orgfe07a95}
\begin{itemize}
...
\label{sec:org197f2c5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga42fc84}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:org6e3ca9e}
\begin{itemize}
\item AR, DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:org09b4f9d}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:orgb136f27}
\subsection{Introduction}
\label{sec:org6b61b7f}
\begin{itemize}
...
\caption{\label{fig:org70ef7ad}
Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org011f94b}
...
\label{sec:org4ceb6cb}
\subsubsection{Clinical Features}
\label{sec:org353578e}
\begin{itemize}
...
\label{sec:org3f72ef5}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:orgb1c8364}
\begin{itemize}
...
\label{sec:org0ec0e5f}
\begin{enumerate}
\item Acute Attack
\label{sec:orgd65716c}
\begin{itemize}
...
\label{sec:org0c5988e}
\begin{enumerate}
\item Clincal Presentation
\label{sec:org86fb4aa}
\begin{itemize}
\item both sexes
...
\label{sec:org88fce0a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org40a7202}
\begin{itemize}
