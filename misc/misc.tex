...
\label{sec:org2c84730}
\subsection{Introduction}
\label{sec:org3724729}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:orgbd836f0})
\item three receptor defects (section \ref{sec:org964a146})
\item three transportopathies are reported (section \ref{sec:org964a146})
\item six disorders of monoamine metabolism (section \ref{sec:org8445095})
\item see Amino Acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:orgbd836f0}
\begin{itemize}
...
\caption{\label{fig:orgde9c480}Brain Metabolism of GABA: 1 glutamic acid decarboxylase; 2 GABA transaminase; 3 succinic semialdehyde dehydrogenase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide23.png}
\caption{\label{fig:org8627469}\(\gamma\)-Aminobutryic Acid Metabolism}
\end{figure}

\subsubsection{Succinic Semialdehyde Dehydrogenase Deficiency}
\label{sec:org244b9d8}
\begin{itemize}
...
\item Genetics
\label{sec:orgf2aebf7}
\begin{itemize}
\item AR ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org65aa3b1}
\begin{itemize}
...
\caption{\label{fig:org3adfe19}Tetrahydrobiopterin Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide22.png}
\caption{\label{fig:org86905fd}Biogenic Amines}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{neuro/figures/monoamines.png}
\caption{\label{fig:org63d87ba}Metabolism of Adrenaline, Noradrenaline, Dopamine and Serotonin}
\end{figure}


\subsubsection{Tyrosine Hydroxylase (TH) Deficiency}
\label{sec:org6313567}
\begin{itemize}
...
\label{sec:org6ab304b}
\begin{itemize}
\item dopamine responsive dystonia (Figure \ref{fig:org3adfe19} and Table \ref{tab:orge09d8d4})
...
\begin{table}[htbp]
\caption{\label{tab:orge09d8d4}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org1cf9478}} & primapterin\textsuperscript{\ref{org1cf9478}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org1cf9478}blood or urine}
\section{Peptides}
\label{sec:org0d40b3b}
\subsection{TMA and Choline}
\label{sec:org5d7fca3}
\subsubsection{Trimethylamine Metabolism}
\label{sec:org0ed3979}
\begin{itemize}
...
\caption{\label{fig:orgeb68d4c}Trimethlyamine Metabolism}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:orgfc4e5d3}
\begin{itemize}
...
\caption{\label{fig:orgb6bbbe4}Choline Catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org847dc59}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org41e43df}
\begin{itemize}
...
\caption{\label{fig:org5e7e8d0}The \(\gamma\)-Glutamyl Cycle}
\end{figure}
...
\caption{\label{fig:org3e566df}The \(\gamma\)-Glutamyl Cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:orgb8f94a8}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf8eb290}
\begin{itemize}
...
\item Genetics
\label{sec:org1220bb3}
\begin{itemize}
\item AR GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:org60abf6c}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:org215460e}
\subsection{Copper}
\label{sec:org46d0b8d}
\begin{itemize}
...
\caption[copper]{\label{fig:org022caeb}Copper Metabolism}
\end{figure}
\subsubsection{Menkes Disease}
\label{sec:org42ed932}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org67e3cc8}
\begin{itemize}
...
\label{sec:org94ec8af}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3563881}
\begin{itemize}
...
\subsection{Iron}
\label{sec:org57aff8f}
\begin{itemize}
\item iron is essential for the synthesis of haem and other
metalloproteins
\begin{itemize}
\item iron sulfur cluster has a crucial role in mitochondrial metabolism (Figure \ref{fig:org76613a6})
\end{itemize}
...
\caption[iron]{\label{fig:orgf02855f}Iron Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{metal/figures/fes.png}
\caption[fes]{\label{fig:org76613a6}Iron Sulfur Cluster Proteins}
\end{figure}

\subsubsection{Classic Hereditary Haemochromatosis}
\label{sec:orgf47fa7e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8386eac}
\begin{itemize}
...
\label{sec:orgc12c286}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{pp/figures/Slide17.png}
\caption{\label{fig:org7032a2b}Purine and Pyrimidine Metabolism}
\end{figure}

\subsection{Purine Metabolism}
\label{sec:orga5e4c1d}
\subsubsection{Introduction}
\label{sec:orgafacddf}
\begin{itemize}
...
\caption{\label{fig:org71e1d1b}Purine Metabolism:1 PRPP synthetase; 2 adenylosuccinase; 3 AICAR transformylase; 4 IMP cyclohydrolase; 5 adenylosuccinate synthetase; 6 AMP deaminase; 7 5‘-nucleotidase; 8 adenosine deaminase; 9 purine nucleoside phosphorylase; 10 hypoxanthine-guanine phosphoribosyltransferase; 11 adenine phosphoribosyltransferase; 12 adenosine kinase; 13 guanosine kinase; 14 xanthine oxidase}
\end{figure}

\subsubsection{Phosphoribosyl Pyrophosphate Synthetase Superactivity}
\label{sec:org614a945}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgae62797}
\begin{itemize}
\item gouty arthritis and/or uric acid lithiasis in young males
\end{itemize}

\item Metabolic Derangement
\label{sec:org7a7f012}
\begin{itemize}
...
\item Genetics
\label{sec:org09144c4}
\begin{itemize}
\item \textbf{XL PRPS1}
\end{itemize}

\item Diagnostic Tests
\label{sec:orgaeed0c4}
\begin{itemize}
...
\item Genetics
\label{sec:org1cd7f62}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org916f8a5}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:org0d22032}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org379c4dd}
\begin{itemize}
...
\item Genetics
\label{sec:orgeed8f4b}
\begin{itemize}
\item AR PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:org035de30}
\begin{itemize}
...
\item Genetics
\label{sec:org66f3bbb}
\begin{itemize}
\item AR XDH
\end{itemize}

\item Diagnostic Tests
\label{sec:orge219903}
\begin{itemize}
\item \(\downarrow\) plasma uric acid
\item \(\downarrow\) urine uric acid
...
\label{sec:org0f5c209}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb901876}
\begin{itemize}
...
\item Genetic
\label{sec:orge5dc536}
\begin{itemize}
\item \textbf{XL HPRT}
\end{itemize}

\item Diagnostic Tests
\label{sec:org6dce13b}
\begin{itemize}
...
\label{sec:orgfb432ef}
\subsubsection{Introduction}
\label{sec:org079948f}
\begin{itemize}
...
\item Genetics
\label{sec:org008cd76}
\begin{itemize}
\item AR UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org2e301c3}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid 200-1000X
\end{itemize}

\item Treatment
\label{sec:org12f45fb}
\begin{itemize}
...
\label{sec:org6912085}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2f896f5}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:orgc63e5b0}
\begin{itemize}
\item AR DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:orga3dae12}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org3d0b592}
\subsection{Introduction}
\label{sec:org22a663d}
\begin{itemize}
...
\caption{\label{fig:org7fc8294}Heme Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{porphyrins/figures/Slide19.png}
\caption{\label{fig:org3e4279a}Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org09a2c6b}Route of Excretion of Porphyrin Precursors}
\centering
\begin{tabular}{ll}
Porphyrin & Route\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orgc5cf2a7}Porphyrin Function}
\centering
\begin{tabular}{ll}
Protein & Functions\\
\hline
...
\label{sec:org1808af7}

\begin{table}[htbp]
\caption{\label{tab:org2d44579}Main Types of Human Porphyrias}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{orgba83c02}A = anemia, N = neuroviseral, C = cutaneous}
...
\begin{table}[htbp]
\caption{\label{tab:org6474b61}Main Types of Human Porphyrias: Classification by Onset}
\centering
...
\label{sec:org45c33ab}
\subsubsection{Clinical Features}
\label{sec:org7a08d6a}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgf337b65}Clinical Features of Acute Neuroviseral Attacks}
\centering
\begin{tabular}{lr}
...
\label{sec:org9a493ff}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:org6acf9d8}
\begin{itemize}
...
\label{sec:orgcef643e}
\begin{enumerate}
\item Acute Attack
\label{sec:org9244f43}
\begin{itemize}
...
\label{sec:orgf901475}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga16b9a0}
\begin{itemize}
\item both sexes
...
\label{sec:org19aeba1}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org590e681}
\begin{itemize}
...
\label{sec:org6b457e2}
\begin{enumerate}
\item Clinical Features
\label{sec:org19c62da}
\begin{itemize}
...
\end{itemize}
\section{Oxalate}
\label{sec:org98e5a00}
\subsection{Primary Hyperoxalouria}
\label{sec:org0b5c0c7}
\begin{itemize}
...
\caption{\label{fig:orgbe86fc9}Glyoxylate Metabolism}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:orgd859a39}
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgb96ebfd}
\begin{enumerate}
\item PH1
\label{sec:orgb2f4398}
\begin{itemize}
...
\caption{\label{fig:orge85f2ad}Diagnosis of Primary Hyperoxaluria}
\end{figure}

\subsubsection{Treatment}
\label{sec:org7dee651}
\begin{itemize}
