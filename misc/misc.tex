...
\label{sec:orgf948011}
\subsection{Introduction}
\label{sec:org06ce28b}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:orgf267d53})
\item three receptor defects (section \ref{sec:orge4ef14d})
\item three transportopathies are reported section \ref{sec:orge4ef14d})
\item six disorders of monoamine metabolism (section \ref{sec:orgcb09996})
\item see aminoacidopathies for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:orgf267d53}
\begin{itemize}
...
\item Genetics
\label{sec:org6099212}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org9946d87}
\begin{itemize}
...
\caption{\label{fig:orga183472}
TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:orgb7ce890}
\begin{itemize}
...
\caption{\label{fig:orgc1e944e}
Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org19a6ce3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf73f75f}
\begin{itemize}
...
\caption{\label{fig:org4ca6f53}
The \(\gamma\)-glutamyl cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:orgc00e03b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org237bc09}
\begin{itemize}
...
\item Genetics
\label{sec:org4f84233}
\begin{itemize}
\item AR
\end{itemize}

\item Diagnostic Tests
\label{sec:org7d2b8f6}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:org34ab516}
\subsection{Copper}
\label{sec:org2b5c765}
\begin{itemize}
...
\caption[copper]{\label{fig:org203e904}
Copper Metabolism}
\end{figure}

\subsubsection{Wilson Disease}
\label{sec:orga850be9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org815e430}
\begin{itemize}
...
\label{sec:org21bddc2}

\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd915cb2}
\begin{itemize}
...
\caption[iron]{\label{fig:orgbef2d42}
Iron Metabolism}
\end{figure}
...
\label{sec:orgc39cc6f}
\subsection{Purine Metabolism}
\label{sec:org5d09e40}
\subsubsection{Introduction}
\label{sec:org40ed619}
\begin{itemize}
...
\item Genetics
\label{sec:orgfa81b16}
\begin{itemize}
\item X-linked, PRPS1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd615f5d}
\begin{itemize}
...
\label{sec:orgfd071a1}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgcf25343}
\begin{itemize}
...
\item Genetics
\label{sec:org31e6e55}
\begin{itemize}
\item AR
\end{itemize}

\item Diagnostic Tests
\label{sec:org0fa2b3f}
\begin{itemize}
...
\label{sec:orgdbd7e48}
\begin{enumerate}
\item Clinical Picture
\label{sec:orgdc5052d}
\begin{itemize}
...
\label{sec:orge0199c2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd53b1ce}
\begin{itemize}
...
\item Genetic
\label{sec:org8ec54e9}
\begin{itemize}
\item XLR, HPRT
\end{itemize}

\item Diagnostic Tests
\label{sec:org34db8f1}
\begin{itemize}
...
\label{sec:orgc384bd1}
\subsubsection{Introduction}
\label{sec:orgb90e5a6}
\begin{itemize}
...
\label{sec:org10d5999}
\begin{itemize}
\item AKA: Hereditary Orotic Aciduria
\end{itemize}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org718a303}
\begin{itemize}
...
\item Genetics
\label{sec:org6d0fab7}
\begin{itemize}
\item AR, UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org35fb3eb}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:org2716862}
\begin{itemize}
...
\label{sec:org8e1a7ba}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org03f0781}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:orgeb35618}
\subsection{Introduction}
\label{sec:org2396918}
\begin{itemize}
...
\caption{\label{fig:org3684371}
Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org9e8e6df}
...
\label{sec:org7532600}
\subsubsection{ALA Dehydratase Porphyria}
\label{sec:org8e8767d}
\begin{itemize}
...
\label{sec:orgae77bfd}
\begin{enumerate}
\item Acute Attack
\label{sec:org0fc9a1b}
\begin{itemize}
