...
\label{sec:orgdc94f89}
\subsection{Introduction}
\label{sec:org701beb0}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:orgc94a511})
\item three receptor defects (section \ref{sec:org38d8d35})
\item three transportopathies are reported (section \ref{sec:org38d8d35})
\item six disorders of monoamine metabolism (section \ref{sec:orgd2356a1})
\item see amino acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:orgc94a511}
\begin{itemize}
...
\item Genetics
\label{sec:org866a615}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org17f71a9}
\begin{itemize}
...
\caption{\label{fig:org1715675}
TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:org534490a}
\begin{itemize}
...
\caption{\label{fig:org524809f}
Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org0bbc7f4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge772814}
\begin{itemize}
...
\item Genetics
\label{sec:orgea12c74}
\begin{itemize}
\item AR, \textasciitilde{}1\% carrier freq
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf3d6dc4}
\begin{itemize}
...
\caption{\label{fig:org1f48dda}
The \(\gamma\)-glutamyl cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:org728fc12}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orged69970}
\begin{itemize}
...
\item Genetics
\label{sec:org095b120}
\begin{itemize}
\item AR, GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:org01f8b38}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:orgd12f830}
\subsection{Copper}
\label{sec:orgac94e0f}
\begin{itemize}
...
\caption[copper]{\label{fig:org6e9ba7d}
Copper Metabolism}
\end{figure}

\subsubsection{Wilson Disease}
\label{sec:orga095477}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5d2222f}
\begin{itemize}
...
\label{sec:org58ee572}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8739aaa}
\begin{itemize}
...
\caption[iron]{\label{fig:org458fa73}
Iron Metabolism}
\end{figure}
...
\item Genetics
\label{sec:org77fac61}
\begin{itemize}
\item X-linked, PRPS1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgc11c5f6}
\begin{itemize}
...
\item Genetics
\label{sec:org5a29e20}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgba2e15e}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:org2c3b428}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb4e7eb9}
\begin{itemize}
...
\item Genetics
\label{sec:org76c188f}
\begin{itemize}
\item AR, PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:orgfb8a8d0}
\begin{itemize}
...
\label{sec:org714ee20}
\begin{enumerate}
\item Clinical Picture
\label{sec:org7df76fb}
\begin{itemize}
...
\label{sec:orgbc1dfd8}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org83ac57b}
\begin{itemize}
...
\item Genetic
\label{sec:org73035fb}
\begin{itemize}
\item \textbf{XLR}, HPRT
\end{itemize}

\item Diagnostic Tests
\label{sec:org76d85d5}
\begin{itemize}
...
\label{sec:org5bb7dcb}
\subsubsection{Introduction}
\label{sec:orgb1e1e80}
\begin{itemize}
...
\label{sec:org537f61f}
\begin{itemize}
\item AKA: Hereditary Orotic Aciduria
\end{itemize}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org91d8f85}
\begin{itemize}
...
\item Genetics
\label{sec:org52a32ba}
\begin{itemize}
\item AR, UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org959c4e3}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:org251e671}
\begin{itemize}
...
\label{sec:org533c017}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org19da724}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:org5a698f7}
\begin{itemize}
\item AR, DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:org8ff7e29}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org592aa10}
\subsection{Introduction}
\label{sec:orga474c48}
\begin{itemize}
...
\caption{\label{fig:org340fc31}
Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org69ba459}
...
\label{sec:org05c0724}
\subsubsection{Clinical Features}
\label{sec:org4ce9ed2}
\begin{itemize}
...
\label{sec:org3a42f54}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:org6e02a5c}
\begin{itemize}
...
\label{sec:org2e9450a}
\begin{enumerate}
\item Acute Attack
\label{sec:orgb66a42a}
\begin{itemize}
...
\label{sec:org47b8f9a}
\begin{enumerate}
\item Clincal Presentation
\label{sec:org4978700}
\begin{itemize}
\item both sexes
...
\label{sec:orgee8260c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge3f2490}
\begin{itemize}
...
\label{sec:org81441d3}
\begin{enumerate}
\item Clinical Features
\label{sec:org35ee6c2}
\begin{itemize}
