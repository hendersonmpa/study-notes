...
\label{sec:org5dd771d}
\subsection{Introduction}
\label{sec:org7fd9ce2}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:org626e92f})
\item three receptor defects (section \ref{sec:orgb4bfb2f})
\item three transportopathies are reported (section \ref{sec:orgb4bfb2f})
\item six disorders of monoamine metabolism (section \ref{sec:orgb72c407})
\item see Amino Acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:org626e92f}
\begin{itemize}
...
\caption{\label{fig:org21773d8}Brain metabolism of GABA: 1 glutamic acid decarboxylase; 2 GABA transaminase; 3 succinic semialdehyde dehydrogenase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide23.png}
\caption{\label{fig:org48de4c1}\(\gamma\)-aminobutryic acid metabolism}
\end{figure}

\subsubsection{Succinic Semialdehyde Dehydrogenase Deficiency}
\label{sec:org4d98ff7}
\begin{itemize}
...
\item Genetics
\label{sec:org43769c4}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org1500fa8}
\begin{itemize}
...
\caption{\label{fig:orgab518ca}Tetrahydrobiopterin metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide22.png}
\caption{\label{fig:orgfb133ff}Biogenic Amines}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{neuro/figures/monoamines.png}
\caption{\label{fig:orgbc84651}Metabolism of adrenaline, noradrenaline, dopamine and serotonin}
\end{figure}


\subsubsection{Tyrosine hydroxylase (TH) deficiency}
\label{sec:orgdfafd09}
\begin{itemize}
...
\label{sec:orgb7afcee}
\begin{itemize}
\item dopamine responsive dystonia (Figure \ref{fig:orgab518ca} and Table \ref{tab:org93ec7d6})
...
\begin{table}[htbp]
\caption{\label{tab:org93ec7d6}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org15f0e6b}} & primapterin\textsuperscript{\ref{org15f0e6b}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org15f0e6b}blood or urine}
\section{Peptides}
\label{sec:org3f53842}
\subsection{TMA and Choline}
\label{sec:orgdc9674b}
\subsubsection{Trimethylamine Metabolism}
\label{sec:org5feb417}
\begin{itemize}
...
\caption{\label{fig:org7e0fd3f}TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:org11c96d3}
\begin{itemize}
...
\caption{\label{fig:org764928f}Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org1619808}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc5d49db}
\begin{itemize}
...
\item Genetics
\label{sec:org3b21b54}
\begin{itemize}
\item AR, \textasciitilde{}1\% carrier freq
\end{itemize}

\item Diagnostic Tests
\label{sec:orge7b699b}
\begin{itemize}
...
\caption{\label{fig:orgaa2f6ab}The \(\gamma\)-glutamyl cycle}
\end{figure}
...
\caption{\label{fig:org34acb38}The \(\gamma\)-glutamyl cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:org0f47478}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4f89132}
\begin{itemize}
...
\item Genetics
\label{sec:org12fef3d}
\begin{itemize}
\item AR, GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgb854d8c}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:orga6ad530}
\subsection{Copper}
\label{sec:orgc4e999c}
\begin{itemize}
...
\caption[copper]{\label{fig:org76ebab3}Copper Metabolism}
\end{figure}
\subsubsection{Menkes Disease}
\label{sec:org38384ae}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2543a7d}
\begin{itemize}
...
\label{sec:orgf324818}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org64ed3f8}
\begin{itemize}
...
\subsection{Iron}
\label{sec:org494acb9}
\begin{itemize}
\item iron is essential for the synthesis of haem and other
metalloproteins
\begin{itemize}
\item iron sulfur cluster has a crucial role in mitochondrial metabolism (Figure \ref{fig:orgae68708})
\end{itemize}
...
\caption[iron]{\label{fig:orgd009b69}Iron Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{metal/figures/fes.png}
\caption[fes]{\label{fig:orgae68708}Iron Sulfur Cluster Proteins}
\end{figure}

\subsubsection{Classic Hereditary Haemochromatosis}
\label{sec:org1c4f2f5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge4ef752}
\begin{itemize}
...
\label{sec:orgb8830e7}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{pp/figures/Slide17.png}
\caption{\label{fig:orgf102ac5}Purine and Pyrimidine Metabolism}
\end{figure}

\subsection{Purine Metabolism}
\label{sec:orgf89dde4}
\subsubsection{Introduction}
\label{sec:org6ba2c82}
\begin{itemize}
...
\caption{\label{fig:org8df140d}Purine Metabolism:1 PRPP synthetase; 2 adenylosuccinase; 3 AICAR transformylase; 4 IMP cyclohydrolase; 5 adenylosuccinate synthetase; 6 AMP deaminase; 7 5‘-nucleotidase; 8 adenosine deaminase; 9 purine nucleoside phosphorylase; 10 hypoxanthine-guanine phosphoribosyltransferase; 11 adenine phosphoribosyltransferase; 12 adenosine kinase; 13 guanosine kinase; 14 xanthine oxidase}
\end{figure}

\subsubsection{Phosphoribosyl Pyrophosphate Synthetase Superactivity}
\label{sec:org91ba72d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org58fbd80}
\begin{itemize}
\item gouty arthritis and/or uric acid lithiasis in young males
\end{itemize}

\item Metabolic Derangement
\label{sec:org82c652e}
\begin{itemize}
...
\item Genetics
\label{sec:org910435e}
\begin{itemize}
\item \textbf{XL PRPS1}
\end{itemize}

\item Diagnostic Tests
\label{sec:org3b50012}
\begin{itemize}
...
\item Genetics
\label{sec:org945c2cf}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org492fc6c}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:orgbcda2fe}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga6c3494}
\begin{itemize}
...
\item Genetics
\label{sec:orgc1ab2e8}
\begin{itemize}
\item AR PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:orgaed87d3}
\begin{itemize}
...
\item Genetics
\label{sec:orgdbcf6ad}
\begin{itemize}
\item AR XDH
\end{itemize}

\item Diagnostic Tests
\label{sec:orge3d1a25}
\begin{itemize}
\item \(\downarrow\) plasma uric acid
\item \(\downarrow\) urine uric acid
...
\label{sec:org3b95cd2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgbf8de13}
\begin{itemize}
...
\item Genetic
\label{sec:org52ef6f1}
\begin{itemize}
\item \textbf{XL HPRT}
\end{itemize}

\item Diagnostic Tests
\label{sec:orgaddfe49}
\begin{itemize}
...
\label{sec:orgf2d51c3}
\subsubsection{Introduction}
\label{sec:org5682c22}
\begin{itemize}
...
\item Genetics
\label{sec:orga7e5da8}
\begin{itemize}
\item AR UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgb13fc91}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:orgfc28ac4}
\begin{itemize}
...
\label{sec:org8569865}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge69c307}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:org90cb072}
\begin{itemize}
\item AR DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:orgea448ba}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org751386d}
\subsection{Introduction}
\label{sec:orgabc4532}
\begin{itemize}
...
\caption{\label{fig:org6b2f81f}Heme Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{porphyrins/figures/Slide19.png}
\caption{\label{fig:org7af0209}Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org87db16a}Route of excretion dictated by solubility for porphyrin precursors}
\centering
\begin{tabular}{ll}
Porphyrin & Route\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org719567b}Porphyrin Function}
\centering
\begin{tabular}{ll}
Protein & Functions\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org562ba3d}Main types of human porphyrias}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{orgf421c0a}A = anemia, N = neuroviseral, C = cutaneous}

\subsubsection{Clinical Classification of the Porphyrias}
\label{sec:org35648ea}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org3f369ae}Main types of human porphyrias: Classification by onset}
\centering
...
\label{sec:org470f4a7}
\subsubsection{Clinical Features}
\label{sec:org611a77f}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgbd32c52}Clinical features of acute neuroviseral attacks}
\centering
\begin{tabular}{lr}
...
\label{sec:org534b878}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:org24c275e}
\begin{itemize}
...
\label{sec:orgc554178}
\begin{enumerate}
\item Acute Attack
\label{sec:orgdb104e6}
\begin{itemize}
...
\label{sec:orgfa7d705}
\begin{enumerate}
\item Clincal Presentation
\label{sec:orga460401}
\begin{itemize}
\item both sexes
...
\label{sec:orgb9bd4a6}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9c72353}
\begin{itemize}
...
\label{sec:orga5d8100}
\begin{enumerate}
\item Clinical Features
\label{sec:org9aa86f7}
\begin{itemize}
