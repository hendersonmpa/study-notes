...
\label{sec:orga8d03bd}
\subsection{Introduction}
\label{sec:org32bc7f9}
\begin{itemize}
...
\item Genetics
\label{sec:orgbd3483e}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org8b00827}
\begin{itemize}
...
\caption{\label{fig:org6ec20b5}
TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:orgb0b7904}
\begin{itemize}
...
\caption{\label{fig:org904b907}
Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org7d090a2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org407292c}
\begin{itemize}
...
\label{sec:org85f2dbb}

\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb077215}
\begin{itemize}
...
\caption[iron]{\label{fig:org75e8eb9}
Iron Metabolism}
\end{figure}
...
\item Genetics
\label{sec:org9ab6178}
\begin{itemize}
\item X-linked, PRPS1
\end{itemize}

\item Diagnostic Tests
\label{sec:orge72285e}
\begin{itemize}
...
\label{sec:org573c263}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org81e64ab}
\begin{itemize}
...
\item Genetics
\label{sec:org17b32ee}
\begin{itemize}
\item AR
\end{itemize}

\item Diagnostic Tests
\label{sec:orga5de776}
\begin{itemize}
...
\label{sec:org3e09124}
\begin{enumerate}
\item Clinical Picture
\label{sec:org10c545e}
\begin{itemize}
...
\label{sec:org06485ad}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org92383f3}
\begin{itemize}
...
\item Genetic
\label{sec:org654cf2e}
\begin{itemize}
\item XLR, HPRT
\end{itemize}

\item Diagnostic Tests
\label{sec:org5518730}
\begin{itemize}
...
\label{sec:orgbab36f2}
\subsubsection{Introduction}
\label{sec:org846619f}
\begin{itemize}
...
\label{sec:orgf2f8a3a}
\begin{itemize}
\item AKA: Hereditary Orotic Aciduria
\end{itemize}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org57d84ba}
\begin{itemize}
...
\item Genetics
\label{sec:org425933e}
\begin{itemize}
\item AR, UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org7426f70}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:orga0923cb}
\begin{itemize}
...
\label{sec:org15aa90a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org285fd65}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\section{Porphyrias}
\label{sec:org2205f6c}
\subsection{Introduction}
\label{sec:org940c520}
\begin{itemize}
...
\caption{\label{fig:orgf26ee3c}
Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org9896a3e}
...
\label{sec:org3e14faa}
\subsubsection{ALA Dehydratase Porphyria}
\label{sec:orgbcc592a}
\begin{itemize}
...
\label{sec:orgeab7de2}
\begin{enumerate}
\item Acute Attack
\label{sec:orgf1891aa}
\begin{itemize}
