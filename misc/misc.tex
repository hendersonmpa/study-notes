...
\label{sec:orgf2cdaac}
\subsection{Introduction}
\label{sec:orgf9f6371}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:orgee83588})
\item three receptor defects (section \ref{sec:orgf77f60c})
\item three transportopathies are reported (section \ref{sec:orgf77f60c})
\item six disorders of monoamine metabolism (section \ref{sec:orgaa493d9})
\item see Amino Acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:orgee83588}
\begin{itemize}
...
\caption{\label{fig:orgb9696f0}Brain Metabolism of GABA: 1 glutamic acid decarboxylase; 2 GABA transaminase; 3 succinic semialdehyde dehydrogenase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide23.png}
\caption{\label{fig:orgad7cca4}\(\gamma\)-Aminobutryic Acid Metabolism}
\end{figure}

\subsubsection{Succinic Semialdehyde Dehydrogenase Deficiency}
\label{sec:orge914ad1}
\begin{itemize}
...
\item Genetics
\label{sec:org94b6f33}
\begin{itemize}
\item AR ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org20d1ade}
\begin{itemize}
...
\caption{\label{fig:orgd38f386}Tetrahydrobiopterin Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide22.png}
\caption{\label{fig:org5b7a8a5}Biogenic Amines}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{neuro/figures/monoamines.png}
\caption{\label{fig:org4c9f746}Metabolism of Adrenaline, Noradrenaline, Dopamine and Serotonin}
\end{figure}


\subsubsection{Tyrosine Hydroxylase (TH) Deficiency}
\label{sec:orgbfdcb40}
\begin{itemize}
...
\label{sec:orge26b20d}
\begin{itemize}
\item dopamine responsive dystonia (Figure \ref{fig:orgd38f386} and Table \ref{tab:orgc4c1142})
...
\begin{table}[htbp]
\caption{\label{tab:orgc4c1142}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{orgf52aa68}} & primapterin\textsuperscript{\ref{orgf52aa68}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgf52aa68}blood or urine}
\section{Peptides}
\label{sec:org02d0f52}
\subsection{TMA and Choline}
\label{sec:org3ef29a1}
\subsubsection{Trimethylamine Metabolism}
\label{sec:orgb2cf648}
\begin{itemize}
...
\caption{\label{fig:orgf9b7f14}Trimethlyamine Metabolism}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:orgf8f699d}
\begin{itemize}
...
\caption{\label{fig:org05ff137}Choline Catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:orgb8dafac}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6e65255}
\begin{itemize}
...
\caption{\label{fig:org080a98d}The \(\gamma\)-Glutamyl Cycle}
\end{figure}
...
\caption{\label{fig:org6e75398}The \(\gamma\)-Glutamyl Cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:org23b1a7d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge0594f9}
\begin{itemize}
...
\item Genetics
\label{sec:orgb937669}
\begin{itemize}
\item AR GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:org50f1c2e}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:orgc65fcf6}
\subsection{Copper}
\label{sec:orgc5ef4f8}
\begin{itemize}
...
\caption[copper]{\label{fig:org47c2b30}Copper Metabolism}
\end{figure}
\subsubsection{Menkes Disease}
\label{sec:org5af3be6}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd7e7aea}
\begin{itemize}
...
\label{sec:orge0060ad}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgbd08aea}
\begin{itemize}
...
\subsection{Iron}
\label{sec:org8d83c22}
\begin{itemize}
\item iron is essential for the synthesis of haem and other
metalloproteins
\begin{itemize}
\item iron sulfur cluster has a crucial role in mitochondrial metabolism (Figure \ref{fig:org95e5243})
\end{itemize}
...
\caption[iron]{\label{fig:org2a56ca7}Iron Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{metal/figures/fes.png}
\caption[fes]{\label{fig:org95e5243}Iron Sulfur Cluster Proteins}
\end{figure}

\subsubsection{Classic Hereditary Haemochromatosis}
\label{sec:org57d5fa1}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org11338ea}
\begin{itemize}
...
\label{sec:org1e9d639}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{pp/figures/Slide17.png}
\caption{\label{fig:orgc37dc91}Purine and Pyrimidine Metabolism}
\end{figure}

\subsection{Purine Metabolism}
\label{sec:orga618cd3}
\subsubsection{Introduction}
\label{sec:orgf2aa99c}
\begin{itemize}
...
\caption{\label{fig:orgb8b20a1}Purine Metabolism:1 PRPP synthetase; 2 adenylosuccinase; 3 AICAR transformylase; 4 IMP cyclohydrolase; 5 adenylosuccinate synthetase; 6 AMP deaminase; 7 5‘-nucleotidase; 8 adenosine deaminase; 9 purine nucleoside phosphorylase; 10 hypoxanthine-guanine phosphoribosyltransferase; 11 adenine phosphoribosyltransferase; 12 adenosine kinase; 13 guanosine kinase; 14 xanthine oxidase}
\end{figure}

\subsubsection{Phosphoribosyl Pyrophosphate Synthetase Superactivity}
\label{sec:org6b7cca6}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga00eb97}
\begin{itemize}
\item gouty arthritis and/or uric acid lithiasis in young males
\end{itemize}

\item Metabolic Derangement
\label{sec:org870e0cb}
\begin{itemize}
...
\item Genetics
\label{sec:org25292b9}
\begin{itemize}
\item \textbf{XL PRPS1}
\end{itemize}

\item Diagnostic Tests
\label{sec:org886780d}
\begin{itemize}
...
\item Genetics
\label{sec:orge620c8c}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org259590c}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:orgb23fd08}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd432d34}
\begin{itemize}
...
\item Genetics
\label{sec:org6019255}
\begin{itemize}
\item AR PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:org3851bdd}
\begin{itemize}
...
\item Genetics
\label{sec:orgd846122}
\begin{itemize}
\item AR XDH
\end{itemize}

\item Diagnostic Tests
\label{sec:org6326719}
\begin{itemize}
\item \(\downarrow\) plasma uric acid
\item \(\downarrow\) urine uric acid
...
\label{sec:orgb44ca65}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3624b37}
\begin{itemize}
...
\item Genetic
\label{sec:org0b99ead}
\begin{itemize}
\item \textbf{XL HPRT}
\end{itemize}

\item Diagnostic Tests
\label{sec:org267a288}
\begin{itemize}
...
\label{sec:orgb8da235}
\subsubsection{Introduction}
\label{sec:orgdd7dd16}
\begin{itemize}
...
\item Genetics
\label{sec:org6a6cde7}
\begin{itemize}
\item AR UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org66a23b7}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid 200-1000X
\end{itemize}

\item Treatment
\label{sec:orgcc95e71}
\begin{itemize}
...
\label{sec:orge07f51e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org64311ac}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:org68f2565}
\begin{itemize}
\item AR DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:org8d49686}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:orgb6fdde9}
\subsection{Introduction}
\label{sec:org905d0fc}
\begin{itemize}
...
\caption{\label{fig:org7ef7fa3}Heme Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{porphyrins/figures/Slide19.png}
\caption{\label{fig:org689241e}Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org929ddd2}Route of Excretion of Porphyrin Precursors}
\centering
\begin{tabular}{ll}
Porphyrin & Route\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orge4091b4}Porphyrin Function}
\centering
\begin{tabular}{ll}
Protein & Functions\\
\hline
...
\label{sec:org6210b9f}

\begin{table}[htbp]
\caption{\label{tab:org3659ae8}Main Types of Human Porphyrias}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org26b750a}A = anemia, N = neuroviseral, C = cutaneous}
...
\begin{table}[htbp]
\caption{\label{tab:org894be45}Main Types of Human Porphyrias: Classification by Onset}
\centering
...
\label{sec:org2ef2338}
\subsubsection{Clinical Features}
\label{sec:org82555cd}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org2d416ef}Clinical Features of Acute Neuroviseral Attacks}
\centering
\begin{tabular}{lr}
...
\label{sec:org6b08d0f}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:orgb1e271a}
\begin{itemize}
...
\label{sec:org91a1f1b}
\begin{enumerate}
\item Acute Attack
\label{sec:orgb656adc}
\begin{itemize}
...
\label{sec:orgfe6b375}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4afc400}
\begin{itemize}
\item both sexes
...
\label{sec:org890d478}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org89c91eb}
\begin{itemize}
...
\label{sec:orgb618abc}
\begin{enumerate}
\item Clinical Features
\label{sec:org839dd7b}
\begin{itemize}
...
\end{itemize}
\section{Oxalate}
\label{sec:org4d8bb23}
\subsection{Primary Hyperoxalouria}
\label{sec:orge986d36}
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org6445adf}
\begin{enumerate}
\item PH1
\label{sec:orgb4ec64c}
\begin{itemize}
...
\caption{\label{fig:org3b94a53}Diagnosis of Primary Hyperoxaluria}
\end{figure}

\subsubsection{Treatment}
\label{sec:org4a4a0c1}
\begin{itemize}
