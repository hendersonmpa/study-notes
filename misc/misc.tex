...
\label{sec:org46200e1}
\subsection{Introduction}
\label{sec:org58a07a3}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:orgffab83e})
\item three receptor defects (section \ref{sec:org36e34f4})
\item three transportopathies are reported (section \ref{sec:org36e34f4})
\item six disorders of monoamine metabolism (section \ref{sec:orgc589cfe})
\item see Amino Acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:orgffab83e}
\begin{itemize}
...
\caption{\label{fig:org6fa7769}Brain metabolism of GABA: 1 glutamic acid decarboxylase; 2 GABA transaminase; 3 succinic semialdehyde dehydrogenase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide23.png}
\caption{\label{fig:org1d77e85}\(\gamma\)-aminobutryic acid metabolism}
\end{figure}

\subsubsection{Succinic Semialdehyde Dehydrogenase Deficiency}
\label{sec:org3753fec}
\begin{itemize}
...
\item Genetics
\label{sec:orga3cbe1f}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgb732726}
\begin{itemize}
...
\caption{\label{fig:org681cf98}Tetrahydrobiopterin metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide22.png}
\caption{\label{fig:org8e6443c}Biogenic Amines}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{neuro/figures/monoamines.png}
\caption{\label{fig:org64e3d31}Metabolism of adrenaline, noradrenaline, dopamine and serotonin}
\end{figure}


\subsubsection{Tyrosine hydroxylase (TH) deficiency}
\label{sec:orge769b6f}
\begin{itemize}
...
\label{sec:org7dca86e}
\begin{itemize}
\item dopamine responsive dystonia (Figure \ref{fig:org681cf98} and Table \ref{tab:orgd9a8881})
...
\begin{table}[htbp]
\caption{\label{tab:orgd9a8881}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org22a5a9b}} & primapterin\textsuperscript{\ref{org22a5a9b}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org22a5a9b}blood or urine}
\section{Peptides}
\label{sec:orge952e71}
\subsection{TMA and Choline}
\label{sec:orgf0e7652}
\subsubsection{Trimethylamine Metabolism}
\label{sec:org4d2d944}
\begin{itemize}
...
\caption{\label{fig:org314e100}TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:orgfc6008e}
\begin{itemize}
...
\caption{\label{fig:org40cf4b9}Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org29e4fe0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3e9f666}
\begin{itemize}
...
\caption{\label{fig:orgce33e52}The \(\gamma\)-glutamyl cycle}
\end{figure}
...
\caption{\label{fig:org51bc22c}The \(\gamma\)-glutamyl cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:org5b5280f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org26858d3}
\begin{itemize}
...
\item Genetics
\label{sec:org8c2da50}
\begin{itemize}
\item AR GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:org170fe80}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:org4fec623}
\subsection{Copper}
\label{sec:orgcf9bfec}
\begin{itemize}
...
\caption[copper]{\label{fig:org6a3eddb}Copper Metabolism}
\end{figure}
\subsubsection{Menkes Disease}
\label{sec:org01eb298}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org80aea15}
\begin{itemize}
...
\label{sec:org90d187c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgbfee595}
\begin{itemize}
...
\subsection{Iron}
\label{sec:org2b0bac3}
\begin{itemize}
\item iron is essential for the synthesis of haem and other
metalloproteins
\begin{itemize}
\item iron sulfur cluster has a crucial role in mitochondrial metabolism (Figure \ref{fig:org6c994a9})
\end{itemize}
...
\caption[iron]{\label{fig:orgffc05d7}Iron Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{metal/figures/fes.png}
\caption[fes]{\label{fig:org6c994a9}Iron Sulfur Cluster Proteins}
\end{figure}

\subsubsection{Classic Hereditary Haemochromatosis}
\label{sec:orgdc74463}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6219419}
\begin{itemize}
...
\label{sec:orgb2352c0}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{pp/figures/Slide17.png}
\caption{\label{fig:org1523c80}Purine and Pyrimidine Metabolism}
\end{figure}

\subsection{Purine Metabolism}
\label{sec:orgbcc1271}
\subsubsection{Introduction}
\label{sec:org2e221d0}
\begin{itemize}
...
\caption{\label{fig:org6d8e236}Purine Metabolism:1 PRPP synthetase; 2 adenylosuccinase; 3 AICAR transformylase; 4 IMP cyclohydrolase; 5 adenylosuccinate synthetase; 6 AMP deaminase; 7 5‘-nucleotidase; 8 adenosine deaminase; 9 purine nucleoside phosphorylase; 10 hypoxanthine-guanine phosphoribosyltransferase; 11 adenine phosphoribosyltransferase; 12 adenosine kinase; 13 guanosine kinase; 14 xanthine oxidase}
\end{figure}

\subsubsection{Phosphoribosyl Pyrophosphate Synthetase Superactivity}
\label{sec:orgf5102a9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb64abbc}
\begin{itemize}
\item gouty arthritis and/or uric acid lithiasis in young males
\end{itemize}

\item Metabolic Derangement
\label{sec:org19a5231}
\begin{itemize}
...
\item Genetics
\label{sec:orgd262598}
\begin{itemize}
\item \textbf{XL PRPS1}
\end{itemize}

\item Diagnostic Tests
\label{sec:orgbc47049}
\begin{itemize}
...
\item Genetics
\label{sec:org5cfe5fe}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org2a0bb45}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:org660c1a2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgbc73488}
\begin{itemize}
...
\item Genetics
\label{sec:orgabe502a}
\begin{itemize}
\item AR PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:orgaa883d5}
\begin{itemize}
...
\item Genetics
\label{sec:orgf51ade4}
\begin{itemize}
\item AR XDH
\end{itemize}

\item Diagnostic Tests
\label{sec:orgbae7b4f}
\begin{itemize}
\item \(\downarrow\) plasma uric acid
\item \(\downarrow\) urine uric acid
...
\label{sec:orgbc60eca}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5a5a5d5}
\begin{itemize}
...
\item Genetic
\label{sec:orga6fa551}
\begin{itemize}
\item \textbf{XL HPRT}
\end{itemize}

\item Diagnostic Tests
\label{sec:org8d26a64}
\begin{itemize}
...
\label{sec:orgcdf724a}
\subsubsection{Introduction}
\label{sec:org0ad909c}
\begin{itemize}
...
\item Genetics
\label{sec:org30da9db}
\begin{itemize}
\item AR UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org367b700}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid 200-1000X
\end{itemize}

\item Treatment
\label{sec:org21ceae5}
\begin{itemize}
...
\label{sec:org854d55d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org27d6e0b}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:org5fe16bd}
\begin{itemize}
\item AR DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:orgdecd6f9}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org79c5dff}
\subsection{Introduction}
\label{sec:org269d3f1}
\begin{itemize}
...
\caption{\label{fig:org2eae9bb}Heme Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{porphyrins/figures/Slide19.png}
\caption{\label{fig:org3c8cd22}Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org7939855}Route of excretion dictated by solubility for porphyrin precursors}
\centering
\begin{tabular}{ll}
Porphyrin & Route\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org120b4f4}Porphyrin Function}
\centering
\begin{tabular}{ll}
Protein & Functions\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org8fc6c53}Main types of human porphyrias}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org026d792}A = anemia, N = neuroviseral, C = cutaneous}

\subsubsection{Clinical Classification of the Porphyrias}
\label{sec:orga744078}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgabeff09}Main types of human porphyrias: Classification by onset}
\centering
...
\label{sec:org34eb992}
\subsubsection{Clinical Features}
\label{sec:org63bf706}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org3cf4a25}Clinical features of acute neuroviseral attacks}
\centering
\begin{tabular}{lr}
...
\label{sec:orgce14fbf}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:org0bf50d3}
\begin{itemize}
...
\label{sec:orgad976ae}
\begin{enumerate}
\item Acute Attack
\label{sec:org2c6a6d2}
\begin{itemize}
...
\label{sec:orgeb615b7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge77c0ba}
\begin{itemize}
\item both sexes
...
\label{sec:org9ff3f1b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2a7834f}
\begin{itemize}
...
\label{sec:orgdb82820}
\begin{enumerate}
\item Clinical Features
\label{sec:org3453fde}
\begin{itemize}
