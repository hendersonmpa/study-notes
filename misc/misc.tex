...
\label{sec:orgba4ea9b}
\subsection{Introduction}
\label{sec:orgf8c2285}
\begin{itemize}
...
\item Genetics
\label{sec:orge6ce74b}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org4726fad}
\begin{itemize}
...
\caption{\label{fig:org339629b}
TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:org0baba78}
\begin{itemize}
...
\caption{\label{fig:org535ba64}
Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org6c45d50}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org21972c0}
\begin{itemize}
...
\caption{\label{fig:org158bdaf}
The \(\gamma\)-glutamyl cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:orgc99e2d8}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org241bb0e}
\begin{itemize}
...
\item Genetics
\label{sec:org042dfea}
\begin{itemize}
\item AR
\end{itemize}

\item Diagnostic Tests
\label{sec:orgdbdd3e3}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:org6e3bd28}
\subsection{Copper}
\label{sec:org7656123}
\begin{itemize}
...
\caption[copper]{\label{fig:org88f0348}
Copper Metabolism}
\end{figure}

\subsubsection{Wilson Disease}
\label{sec:org1b04bbd}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org23cea52}
\begin{itemize}
...
\label{sec:org5f16341}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org22fb9da}
\begin{itemize}
...
\caption[iron]{\label{fig:org9ed3f05}
Iron Metabolism}
\end{figure}
...
\label{sec:org62b922f}
\subsection{Purine Metabolism}
\label{sec:orgc97214f}
\subsubsection{Introduction}
\label{sec:org11e5b2e}
\begin{itemize}
...
\item Genetics
\label{sec:orge9c79ca}
\begin{itemize}
\item X-linked, PRPS1
\end{itemize}

\item Diagnostic Tests
\label{sec:org3f08678}
\begin{itemize}
...
\label{sec:orgdbab0e2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org11c06e7}
\begin{itemize}
...
\item Genetics
\label{sec:org45c3b21}
\begin{itemize}
\item AR
\end{itemize}

\item Diagnostic Tests
\label{sec:org2684b4a}
\begin{itemize}
...
\label{sec:org9212610}
\begin{enumerate}
\item Clinical Picture
\label{sec:org58375fd}
\begin{itemize}
...
\label{sec:org94893d7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgad0ce6f}
\begin{itemize}
...
\item Genetic
\label{sec:org3727626}
\begin{itemize}
\item XLR, HPRT
\end{itemize}

\item Diagnostic Tests
\label{sec:org1a69474}
\begin{itemize}
...
\label{sec:org12f3e23}
\subsubsection{Introduction}
\label{sec:orgac61b95}
\begin{itemize}
...
\label{sec:org911ab95}
\begin{itemize}
\item AKA: Hereditary Orotic Aciduria
\end{itemize}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2609b4b}
\begin{itemize}
...
\item Genetics
\label{sec:org005ddbf}
\begin{itemize}
\item AR, UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgc3f1b4d}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:orgdf412e1}
\begin{itemize}
...
\label{sec:org83225c4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0b763df}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:orgc5abfc0}
\subsection{Introduction}
\label{sec:orgb63b5a4}
\begin{itemize}
...
\caption{\label{fig:org3744100}
Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orgca3b6d5}
...
\label{sec:org3bfb2af}
\subsubsection{ALA Dehydratase Porphyria}
\label{sec:org94d4250}
\begin{itemize}
...
\label{sec:orgd36fd5f}
\begin{enumerate}
\item Acute Attack
\label{sec:org5b9e2ef}
\begin{itemize}
