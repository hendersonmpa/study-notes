...
\end{tabular}
\end{table}\footnotetext[1]{\label{orga1f49fc}blood or urine}
\section{Peptides}
...
\label{sec:org421d953}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org63521a1}
\begin{itemize}
...
\caption[copper]{\label{fig:orgdbc341f}Copper Metabolism}
\end{figure}
\subsubsection{Menkes Disease}
\label{sec:org45be1a8}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org7982735}
\begin{itemize}
...
\label{sec:org269e775}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5e8672b}
\begin{itemize}
...
\caption[iron]{\label{fig:org14f88c2}Iron Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{metal/figures/fes.png}
\caption[fes]{\label{fig:org497aa92}Iron Sulfur Cluster Proteins}
\end{figure}

\subsubsection{Classic Hereditary Haemochromatosis}
\label{sec:org7e44dc0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org43034ff}
\begin{itemize}
...
\caption{\label{fig:org65a55ca}Purine Metabolism:1 PRPP synthetase; 2 adenylosuccinase; 3 AICAR transformylase; 4 IMP cyclohydrolase; 5 adenylosuccinate synthetase; 6 AMP deaminase; 7 5‘-nucleotidase; 8 adenosine deaminase; 9 purine nucleoside phosphorylase; 10 hypoxanthine-guanine phosphoribosyltransferase; 11 adenine phosphoribosyltransferase; 12 adenosine kinase; 13 guanosine kinase; 14 xanthine oxidase}
\end{figure}

\subsubsection{Phosphoribosyl Pyrophosphate Synthetase Superactivity}
\label{sec:orgda511e5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4fb50b4}
\begin{itemize}
\item gouty arthritis and/or uric acid lithiasis in young males
\end{itemize}

\item Metabolic Derangement
\label{sec:orga4ab332}
\begin{itemize}
...
\item Genetics
\label{sec:org4229e65}
\begin{itemize}
\item \textbf{XL PRPS1}
\end{itemize}

\item Diagnostic Tests
\label{sec:org2adc0ec}
\begin{itemize}
...
\item Genetics
\label{sec:org7e68a04}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org71d763d}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:orgf2f502a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4762c94}
\begin{itemize}
...
\item Genetics
\label{sec:org6ceae30}
\begin{itemize}
\item AR PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:org24d5a0a}
\begin{itemize}
...
\item Genetics
\label{sec:org6207092}
\begin{itemize}
\item AR UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:orge6df214}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid 200-1000X
\end{itemize}

\item Treatment
\label{sec:org4c9c84d}
\begin{itemize}
...
\label{sec:orgeb369f5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org90cd8f6}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:org55867be}
\begin{itemize}
\item AR DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:org39718f1}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:orge71d4bf}
\subsection{Introduction}
\label{sec:orgd6bda37}
\begin{itemize}
...
\caption{\label{fig:org2f5c067}Heme Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{porphyrins/figures/Slide19.png}
\caption{\label{fig:org3cc1ff4}Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orgcff3466}Route of excretion dictated by solubility for porphyrin precursors}
\centering
\begin{tabular}{ll}
Porphyrin & Route\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org5e0dbf2}Porphyrin Function}
\centering
\begin{tabular}{ll}
Protein & Functions\\
\hline
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org6e7b7f3}A = anemia, N = neuroviseral, C = cutaneous}
...
\begin{table}[htbp]
\caption{\label{tab:orgd1e3360}Main types of human porphyrias: Classification by onset}
\centering
...
\label{sec:org8dbf6b0}
\subsubsection{Clinical Features}
\label{sec:org7ed3a52}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org1ddefb5}Clinical features of acute neuroviseral attacks}
\centering
\begin{tabular}{lr}
...
\label{sec:org036b66d}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:orgdcd986b}
\begin{itemize}
...
\label{sec:org82c1bbf}
\begin{enumerate}
\item Acute Attack
\label{sec:org856f67f}
\begin{itemize}
