...
\label{sec:orgc900740}
\subsection{Introduction}
\label{sec:org8780ab5}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:orga6e539e})
\item three receptor defects (section \ref{sec:org99c547a})
\item three transportopathies are reported (section \ref{sec:org99c547a})
\item six disorders of monoamine metabolism (section \ref{sec:orgbd81c8f})
\item see Amino Acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:orga6e539e}
\begin{itemize}
...
\caption{\label{fig:org11d4012}Brain Metabolism of GABA: 1 glutamic acid decarboxylase; 2 GABA transaminase; 3 succinic semialdehyde dehydrogenase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide23.png}
\caption{\label{fig:orgfadddeb}\(\gamma\)-Aminobutryic Acid Metabolism}
\end{figure}

\subsubsection{Succinic Semialdehyde Dehydrogenase Deficiency}
\label{sec:org2fdc722}
\begin{itemize}
...
\item Genetics
\label{sec:org79378c9}
\begin{itemize}
\item AR ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org5b0de25}
\begin{itemize}
...
\caption{\label{fig:orge6d1c01}Tetrahydrobiopterin Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide22.png}
\caption{\label{fig:orgccb27d7}Biogenic Amines}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{neuro/figures/monoamines.png}
\caption{\label{fig:org4a45d80}Metabolism of Adrenaline, Noradrenaline, Dopamine and Serotonin}
\end{figure}


\subsubsection{Tyrosine Hydroxylase (TH) Deficiency}
\label{sec:org5baf405}
\begin{itemize}
...
\label{sec:org8bb7ff2}
\begin{itemize}
\item dopamine responsive dystonia (Figure \ref{fig:orge6d1c01} and Table \ref{tab:orgf40ab4b})
...
\begin{table}[htbp]
\caption{\label{tab:orgf40ab4b}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org86065b7}} & primapterin\textsuperscript{\ref{org86065b7}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org86065b7}blood or urine}
\section{Peptides}
\label{sec:orgb4d99f7}
\subsection{TMA and Choline}
\label{sec:orga4e968a}
\subsubsection{Trimethylamine Metabolism}
\label{sec:org2cae65f}
\begin{itemize}
...
\caption{\label{fig:org3262d08}Trimethlyamine Metabolism}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:org500cdd6}
\begin{itemize}
...
\caption{\label{fig:org041d46e}Choline Catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org7e81382}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5028446}
\begin{itemize}
...
\caption{\label{fig:orgc87ecff}The \(\gamma\)-Glutamyl Cycle}
\end{figure}
...
\caption{\label{fig:orgb211c6f}The \(\gamma\)-Glutamyl Cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:org3d89a21}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc71f1a1}
\begin{itemize}
...
\item Genetics
\label{sec:org3c55345}
\begin{itemize}
\item AR GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgba3bf6a}
\begin{itemize}
...
\item markers of hemolytic anemia include:
\begin{itemize}
\item \(\uparrow\) reticulocytes, an indicator of marrow compensatory response, elevated lactate dehydrogenase, a marker of intravascular hemolysis, reduced haptoglobin, and unconjugated hyperbilirubinemia.
\end{itemize}
\end{itemize}

\item Treatment
\label{sec:org41c158d}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:org9c3849e}
\subsection{Copper}
\label{sec:org4a1573b}
\begin{itemize}
...
\caption[copper]{\label{fig:orgfeabaa6}Copper Metabolism}
\end{figure}
\subsubsection{Menkes Disease}
\label{sec:org1110e6c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3a6b04a}
\begin{itemize}
...
\label{sec:org6a2d1d9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga3a0ed0}
\begin{itemize}
...
\subsection{Iron}
\label{sec:orgc988952}
\begin{itemize}
\item iron is essential for the synthesis of haem and other
metalloproteins
\begin{itemize}
\item iron sulfur cluster has a crucial role in mitochondrial metabolism (Figure \ref{fig:org5aa61b6})
\end{itemize}
...
\caption[iron]{\label{fig:org47ae7d1}Iron Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{metal/figures/fes.png}
\caption[fes]{\label{fig:org5aa61b6}Iron Sulfur Cluster Proteins}
\end{figure}

\subsubsection{Classic Hereditary Haemochromatosis}
\label{sec:org7623221}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3a545b7}
\begin{itemize}
...
\label{sec:orgfad17e4}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{pp/figures/Slide17.png}
\caption{\label{fig:org4eaf1a1}Purine and Pyrimidine Metabolism}
\end{figure}

\subsection{Purine Metabolism}
\label{sec:org12211a7}
\subsubsection{Introduction}
\label{sec:org73a4afe}
\begin{itemize}
...
\caption{\label{fig:orgb762932}Purine Metabolism:1 PRPP synthetase; 2 adenylosuccinase; 3 AICAR transformylase; 4 IMP cyclohydrolase; 5 adenylosuccinate synthetase; 6 AMP deaminase; 7 5‘-nucleotidase; 8 adenosine deaminase; 9 purine nucleoside phosphorylase; 10 hypoxanthine-guanine phosphoribosyltransferase; 11 adenine phosphoribosyltransferase; 12 adenosine kinase; 13 guanosine kinase; 14 xanthine oxidase}
\end{figure}

\subsubsection{Phosphoribosyl Pyrophosphate Synthetase Superactivity}
\label{sec:orgcc27c14}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge5c19a6}
\begin{itemize}
\item gouty arthritis and/or uric acid lithiasis in young males
\end{itemize}

\item Metabolic Derangement
\label{sec:org786cf9b}
\begin{itemize}
...
\item Genetics
\label{sec:orgfc312c9}
\begin{itemize}
\item \textbf{XL PRPS1}
\end{itemize}

\item Diagnostic Tests
\label{sec:org312725b}
\begin{itemize}
...
\item Genetics
\label{sec:org20cc723}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd4842f5}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:org81b5778}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org92a1cb5}
\begin{itemize}
...
\item Genetics
\label{sec:org6f28978}
\begin{itemize}
\item AR PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:org6188c11}
\begin{itemize}
...
\item Genetics
\label{sec:orgff5efb3}
\begin{itemize}
\item AR XDH
\end{itemize}

\item Diagnostic Tests
\label{sec:orga80fa36}
\begin{itemize}
\item \(\downarrow\) plasma uric acid
\item \(\downarrow\) urine uric acid
...
\label{sec:orgf91abd3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6304da6}
\begin{itemize}
...
\item Genetic
\label{sec:org1449d24}
\begin{itemize}
\item \textbf{XL HPRT}
\end{itemize}

\item Diagnostic Tests
\label{sec:org7e59f3e}
\begin{itemize}
...
\label{sec:org43752e8}
\subsubsection{Introduction}
\label{sec:orgd083e93}
\begin{itemize}
...
\item Genetics
\label{sec:org80f4b64}
\begin{itemize}
\item AR UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org543f158}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid 200-1000X
\end{itemize}

\item Treatment
\label{sec:org9b13abf}
\begin{itemize}
...
\label{sec:orgec5feaa}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org02c60f6}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:org602b06d}
\begin{itemize}
\item AR DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:org0e34b1d}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org7d89c98}
\subsection{Introduction}
\label{sec:org58a89a5}
\begin{itemize}
...
\caption{\label{fig:org7b0fe57}Heme Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{porphyrins/figures/Slide19.png}
\caption{\label{fig:orgec7a475}Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orga4fd8f6}Route of Excretion of Porphyrin Precursors}
\centering
\begin{tabular}{ll}
Porphyrin & Route\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org5f255a1}Porphyrin Function}
\centering
\begin{tabular}{ll}
Protein & Functions\\
\hline
...
\label{sec:orgddc62b8}

\begin{table}[htbp]
\caption{\label{tab:org994bce6}Main Types of Human Porphyrias}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org44c87bd}A = anemia, N = neuroviseral, C = cutaneous}
...
\begin{table}[htbp]
\caption{\label{tab:orgf25c7eb}Main Types of Human Porphyrias: Classification by Onset}
\centering
...
\label{sec:orgf334bd7}
\subsubsection{Clinical Features}
\label{sec:orgf6e5c0b}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgfb4a127}Clinical Features of Acute Neuroviseral Attacks}
\centering
\begin{tabular}{lr}
...
\label{sec:orgcbdb466}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:orgec55106}
\begin{itemize}
...
\label{sec:org061ed17}
\begin{enumerate}
\item Acute Attack
\label{sec:org60efbbf}
\begin{itemize}
...
\label{sec:org3ed0659}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1cd6e5d}
\begin{itemize}
\item both sexes
...
\label{sec:org0a8431a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org595dac6}
\begin{itemize}
...
\label{sec:org3f1b8d7}
\begin{enumerate}
\item Clinical Features
\label{sec:org70cf618}
\begin{itemize}
...
\end{itemize}
\section{Oxalate}
\label{sec:org2e392d3}
\subsection{Primary Hyperoxalouria}
\label{sec:org13ccc54}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{oxalate/figures/F1.large.jpg}
\caption{\label{fig:org1c356af}Glyoxylate Metabolism}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:org8da5e92}
\begin{itemize}
...
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org202ceca}
\begin{enumerate}
\item PH1
\label{sec:org8c13a3d}
\begin{itemize}
...
\caption{\label{fig:orgbde4413}Diagnosis of Primary Hyperoxaluria}
\end{figure}

\subsubsection{Treatment}
\label{sec:orga4fd13e}
\begin{itemize}
