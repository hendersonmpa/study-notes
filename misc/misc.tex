...
\label{sec:orga80ab23}
\subsection{Introduction}
\label{sec:orge7ae10e}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:org7e3778a})
\item three receptor defects (section \ref{sec:orgdcb5909})
\item three transportopathies are reported (section \ref{sec:orgdcb5909})
\item six disorders of monoamine metabolism (section \ref{sec:org46e19b1})
\item see amino acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:org7e3778a}
\begin{itemize}
...
\item Genetics
\label{sec:org7c74076}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org846334b}
\begin{itemize}
...
\label{sec:org111df63}
\begin{itemize}
\item dopamine responsive dystonia (Figure \ref{fig:org3f87bda} and Table \ref{tab:org6d00c35})
...
\begin{table}[htbp]
\caption{\label{tab:org6d00c35}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{orgf42d017}} & primapterin\textsuperscript{\ref{orgf42d017}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgf42d017}blood or urine}
\section{Peptides}
\label{sec:orgd6c430e}
\subsection{TMA and Choline}
\label{sec:orgefc389f}
\subsubsection{Trimethylamine Metabolism}
\label{sec:org6fb990a}
\begin{itemize}
...
\caption{\label{fig:org71cc46b}
TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:orgd80a8e9}
\begin{itemize}
...
\caption{\label{fig:org5378ca7}
Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org4953b17}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org316a5ec}
\begin{itemize}
...
\item Genetics
\label{sec:org98759c1}
\begin{itemize}
\item AR, \textasciitilde{}1\% carrier freq
\end{itemize}

\item Diagnostic Tests
\label{sec:org48ed0a1}
\begin{itemize}
...
\caption{\label{fig:org9ca0594}
The \(\gamma\)-glutamyl cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:org33243b1}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4a7b6a6}
\begin{itemize}
...
\item Genetics
\label{sec:org18a6bae}
\begin{itemize}
\item AR, GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:org4e10816}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:org8113d84}
\subsection{Copper}
\label{sec:orgdacb006}
\begin{itemize}
...
\caption[copper]{\label{fig:org69eabe1}
Copper Metabolism}
\end{figure}

\subsubsection{Wilson Disease}
\label{sec:orgd2d22d7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org798ae3b}
\begin{itemize}
...
\label{sec:org9c2e5ca}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge7f888d}
\begin{itemize}
...
\caption[iron]{\label{fig:orgbffe673}
Iron Metabolism}
\end{figure}
...
\item Genetics
\label{sec:orgcf7efeb}
\begin{itemize}
\item X-linked, PRPS1
\end{itemize}

\item Diagnostic Tests
\label{sec:org1233100}
\begin{itemize}
...
\item Genetics
\label{sec:org59c30ab}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org72cf22d}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:orgba998c9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3eaa432}
\begin{itemize}
...
\item Genetics
\label{sec:org6c75b7d}
\begin{itemize}
\item AR, PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:org70549d6}
\begin{itemize}
...
\label{sec:org66521dc}
\begin{enumerate}
\item Clinical Picture
\label{sec:org5cd7db1}
\begin{itemize}
...
\label{sec:orga63ae25}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6f43041}
\begin{itemize}
...
\item Genetic
\label{sec:orge3b2b9f}
\begin{itemize}
\item \textbf{XLR}, HPRT
\end{itemize}

\item Diagnostic Tests
\label{sec:org634a124}
\begin{itemize}
...
\label{sec:orgeea0d8c}
\subsubsection{Introduction}
\label{sec:org2b9c411}
\begin{itemize}
...
\label{sec:org4f26e37}
\begin{itemize}
\item AKA: Hereditary Orotic Aciduria
\end{itemize}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgeb8a3b7}
\begin{itemize}
...
\item Genetics
\label{sec:org8ec9fc9}
\begin{itemize}
\item AR, UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org1aab5d0}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:org5eb72c7}
\begin{itemize}
...
\label{sec:org1346802}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgadbb746}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:orgf67420c}
\begin{itemize}
\item AR, DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:org1449e65}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:orgd9f33b1}
\subsection{Introduction}
\label{sec:orgc6bdb25}
\begin{itemize}
...
\caption{\label{fig:org1ea723f}
Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org809d5a0}
...
\label{sec:orgfb1630b}
\subsubsection{Clinical Features}
\label{sec:orgee169ca}
\begin{itemize}
...
\label{sec:orgf6e8332}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:orga57439a}
\begin{itemize}
...
\label{sec:org9a123b0}
\begin{enumerate}
\item Acute Attack
\label{sec:org2ebe915}
\begin{itemize}
...
\label{sec:org356d80c}
\begin{enumerate}
\item Clincal Presentation
\label{sec:org2461de2}
\begin{itemize}
\item both sexes
...
\label{sec:org5934711}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge1d619f}
\begin{itemize}
...
\label{sec:org8ded256}
\begin{enumerate}
\item Clinical Features
\label{sec:org9d6e076}
\begin{itemize}
