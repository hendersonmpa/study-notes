...
\label{sec:org8e60240}
\subsection{Introduction}
\label{sec:org83442a1}
\begin{itemize}
...
\item Genetics
\label{sec:orgf31483b}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org28f759d}
\begin{itemize}
...
\caption{\label{fig:org92b2a77}
TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:org37aea2b}
\begin{itemize}
...
\caption{\label{fig:orgc8552b7}
Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org4ffc1c1}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc4491b4}
\begin{itemize}
...
\caption{\label{fig:org2a9e6cc}
The \(\gamma\)-glutamyl cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:org793da37}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0c3c877}
\begin{itemize}
...
\item Genetics
\label{sec:org46d8cff}
\begin{itemize}
\item AR
\end{itemize}

\item Diagnostic Tests
\label{sec:org7eeb02c}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:org90ee86f}
\subsection{Copper}
\label{sec:org0f7b51f}
\begin{itemize}
...
\caption[copper]{\label{fig:org15cc463}
Copper Metabolism}
\end{figure}

\subsubsection{Wilson Disease}
\label{sec:orgb8206cf}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org36f19fd}
\begin{itemize}
...
\label{sec:org1aa413d}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org622d9e9}
\begin{itemize}
...
\caption[iron]{\label{fig:org85fb8d0}
Iron Metabolism}
\end{figure}
...
\label{sec:orgff8f872}
\subsection{Purine Metabolism}
\label{sec:org71b34d4}
\subsubsection{Introduction}
\label{sec:org7f484c9}
\begin{itemize}
...
\item Genetics
\label{sec:org6bdeb00}
\begin{itemize}
\item X-linked, PRPS1
\end{itemize}

\item Diagnostic Tests
\label{sec:orga1e006e}
\begin{itemize}
...
\label{sec:org7528f59}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc5bd308}
\begin{itemize}
...
\item Genetics
\label{sec:org1b8411d}
\begin{itemize}
\item AR
\end{itemize}

\item Diagnostic Tests
\label{sec:orgeff5954}
\begin{itemize}
...
\label{sec:orgdb1eb3e}
\begin{enumerate}
\item Clinical Picture
\label{sec:org9d218b3}
\begin{itemize}
...
\label{sec:org69a587b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2d13e01}
\begin{itemize}
...
\item Genetic
\label{sec:org6377560}
\begin{itemize}
\item XLR, HPRT
\end{itemize}

\item Diagnostic Tests
\label{sec:orga065ab0}
\begin{itemize}
...
\label{sec:org4c60f63}
\subsubsection{Introduction}
\label{sec:org5f05f35}
\begin{itemize}
...
\label{sec:orga639a5b}
\begin{itemize}
\item AKA: Hereditary Orotic Aciduria
\end{itemize}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org7447f83}
\begin{itemize}
...
\item Genetics
\label{sec:org563232f}
\begin{itemize}
\item AR, UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org630f9d2}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:org7483ee1}
\begin{itemize}
...
\label{sec:orgc5d03db}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5274614}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org8b9e7df}
\subsection{Introduction}
\label{sec:org6331a30}
\begin{itemize}
...
\caption{\label{fig:orgcc4811c}
Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org70bf002}
...
\label{sec:orgc54c2df}
\subsubsection{ALA Dehydratase Porphyria}
\label{sec:orgda9b176}
\begin{itemize}
...
\label{sec:orgc436fcf}
\begin{enumerate}
\item Acute Attack
\label{sec:org8502665}
\begin{itemize}
