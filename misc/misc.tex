...
\label{sec:orgfad2013}
\subsection{Introduction}
\label{sec:orgb88ab98}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:orgb11c276})
\item three receptor defects (section \ref{sec:orgced879a})
\item three transportopathies are reported (section \ref{sec:orgced879a})
\item six disorders of monoamine metabolism (section \ref{sec:orge47ae60})
\item see Amino Acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:orgb11c276}
\begin{itemize}
...
\caption{\label{fig:orged183fe}Brain metabolism of GABA: 1 glutamic acid decarboxylase; 2 GABA transaminase; 3 succinic semialdehyde dehydrogenase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide23.png}
\caption{\label{fig:orgbfba739}\(\gamma\)-aminobutryic acid metabolism}
\end{figure}

\subsubsection{Succinic Semialdehyde Dehydrogenase Deficiency}
\label{sec:orgb0a411d}
\begin{itemize}
...
\item Genetics
\label{sec:orgec9b4ed}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org7341c9e}
\begin{itemize}
...
\caption{\label{fig:org1e1a771}Tetrahydrobiopterin metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{neuro/figures/Slide22.png}
\caption{\label{fig:orgcbe1b95}Biogenic Amines}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{neuro/figures/monoamines.png}
\caption{\label{fig:org8f856e0}Metabolism of adrenaline, noradrenaline, dopamine and serotonin}
\end{figure}


\subsubsection{Tyrosine hydroxylase (TH) deficiency}
\label{sec:org844a2e3}
\begin{itemize}
...
\label{sec:org806c914}
\begin{itemize}
\item dopamine responsive dystonia (Figure \ref{fig:org1e1a771} and Table \ref{tab:org1da01a7})
...
\begin{table}[htbp]
\caption{\label{tab:org1da01a7}Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{orgc23ecda}} & primapterin\textsuperscript{\ref{orgc23ecda}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgc23ecda}blood or urine}
\section{Peptides}
\label{sec:orgc24e955}
\subsection{TMA and Choline}
\label{sec:orgb32ac9d}
\subsubsection{Trimethylamine Metabolism}
\label{sec:orgc51e936}
\begin{itemize}
...
\caption{\label{fig:org66f62cc}TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:orgfe8ee28}
\begin{itemize}
...
\caption{\label{fig:org44fbf8f}Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:orgd1b005e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4a353b6}
\begin{itemize}
...
\caption{\label{fig:org550814d}The \(\gamma\)-glutamyl cycle}
\end{figure}
...
\caption{\label{fig:org439d2ed}The \(\gamma\)-glutamyl cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:org2adb5ea}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org34b0f4e}
\begin{itemize}
...
\item Genetics
\label{sec:orgb7e8dec}
\begin{itemize}
\item AR GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:org2d8ef85}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:org4ec174f}
\subsection{Copper}
\label{sec:org6e4aa54}
\begin{itemize}
...
\caption[copper]{\label{fig:orgb54b02e}Copper Metabolism}
\end{figure}
\subsubsection{Menkes Disease}
\label{sec:orgc4c4af2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc05944e}
\begin{itemize}
...
\label{sec:org31882c9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org72a8f7c}
\begin{itemize}
...
\subsection{Iron}
\label{sec:orgf20204f}
\begin{itemize}
\item iron is essential for the synthesis of haem and other
metalloproteins
\begin{itemize}
\item iron sulfur cluster has a crucial role in mitochondrial metabolism (Figure \ref{fig:orgbf1a4da})
\end{itemize}
...
\caption[iron]{\label{fig:orgdd213da}Iron Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{metal/figures/fes.png}
\caption[fes]{\label{fig:orgbf1a4da}Iron Sulfur Cluster Proteins}
\end{figure}

\subsubsection{Classic Hereditary Haemochromatosis}
\label{sec:org84628d3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org74adfe0}
\begin{itemize}
...
\label{sec:orga2daa13}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{pp/figures/Slide17.png}
\caption{\label{fig:orgbc7be89}Purine and Pyrimidine Metabolism}
\end{figure}

\subsection{Purine Metabolism}
\label{sec:org3b979a4}
\subsubsection{Introduction}
\label{sec:orgc76fc90}
\begin{itemize}
...
\caption{\label{fig:org72766ae}Purine Metabolism:1 PRPP synthetase; 2 adenylosuccinase; 3 AICAR transformylase; 4 IMP cyclohydrolase; 5 adenylosuccinate synthetase; 6 AMP deaminase; 7 5‘-nucleotidase; 8 adenosine deaminase; 9 purine nucleoside phosphorylase; 10 hypoxanthine-guanine phosphoribosyltransferase; 11 adenine phosphoribosyltransferase; 12 adenosine kinase; 13 guanosine kinase; 14 xanthine oxidase}
\end{figure}

\subsubsection{Phosphoribosyl Pyrophosphate Synthetase Superactivity}
\label{sec:org2649068}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5ea9bb8}
\begin{itemize}
\item gouty arthritis and/or uric acid lithiasis in young males
\end{itemize}

\item Metabolic Derangement
\label{sec:org481da8a}
\begin{itemize}
...
\item Genetics
\label{sec:orgd964573}
\begin{itemize}
\item \textbf{XL PRPS1}
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf09791a}
\begin{itemize}
...
\item Genetics
\label{sec:org7b201eb}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd643f42}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:org4cfaec5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org22d6c9d}
\begin{itemize}
...
\item Genetics
\label{sec:org035132b}
\begin{itemize}
\item AR PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:org61482c9}
\begin{itemize}
...
\item Genetics
\label{sec:org5e1f190}
\begin{itemize}
\item AR XDH
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf3c0d42}
\begin{itemize}
\item \(\downarrow\) plasma uric acid
\item \(\downarrow\) urine uric acid
...
\label{sec:orgad69588}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8ebeee8}
\begin{itemize}
...
\item Genetic
\label{sec:org500c618}
\begin{itemize}
\item \textbf{XL HPRT}
\end{itemize}

\item Diagnostic Tests
\label{sec:org47ac88b}
\begin{itemize}
...
\label{sec:org991b941}
\subsubsection{Introduction}
\label{sec:orgfb3a559}
\begin{itemize}
...
\item Genetics
\label{sec:org5cb5dce}
\begin{itemize}
\item AR UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org6a04344}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid 200-1000X
\end{itemize}

\item Treatment
\label{sec:org5013b67}
\begin{itemize}
...
\label{sec:orgb90202d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8d1e4aa}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:org9414ace}
\begin{itemize}
\item AR DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:org1f5557e}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org121614b}
\subsection{Introduction}
\label{sec:org532ff88}
\begin{itemize}
...
\caption{\label{fig:org21ab09c}Heme Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{porphyrins/figures/Slide19.png}
\caption{\label{fig:org56c11bf}Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org405effa}Route of excretion dictated by solubility for porphyrin precursors}
\centering
\begin{tabular}{ll}
Porphyrin & Route\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orgc7a785c}Porphyrin Function}
\centering
\begin{tabular}{ll}
Protein & Functions\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org7a4e44c}Main types of human porphyrias}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[3]{\label{org6d6d91b}A = anemia, N = neuroviseral, C = cutaneous}

\subsubsection{Clinical Classification of the Porphyrias}
\label{sec:orgd7d7489}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org9df4751}Main types of human porphyrias: Classification by onset}
\centering
...
\label{sec:org1ee5c25}
\subsubsection{Clinical Features}
\label{sec:orgd006ccd}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgc02ac27}Clinical features of acute neuroviseral attacks}
\centering
\begin{tabular}{lr}
...
\label{sec:orge17d64e}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:org12707f3}
\begin{itemize}
...
\label{sec:org5e35cd3}
\begin{enumerate}
\item Acute Attack
\label{sec:org111f022}
\begin{itemize}
...
\label{sec:org6425d77}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org125865f}
\begin{itemize}
\item both sexes
...
\label{sec:orgcdbcc91}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgddfad09}
\begin{itemize}
...
\label{sec:org371c9e1}
\begin{enumerate}
\item Clinical Features
\label{sec:org1cd9f57}
\begin{itemize}
