...
\label{sec:orgee00ffc}
\subsection{Introduction}
\label{sec:org7465817}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:org5b901c8})
\item three receptor defects (section \ref{sec:org084ecf1})
\item three transportopathies are reported (section \ref{sec:org084ecf1})
\item six disorders of monoamine metabolism (section \ref{sec:org97b43d1})
\item see amino acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:org5b901c8}
\begin{itemize}
...
\item Genetics
\label{sec:org9962f4d}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org1ed3436}
\begin{itemize}
...
\label{sec:org982ee99}
\begin{itemize}
\item dopamine responsive dystonia (Figure \ref{fig:orgfa454e5} and Table \ref{tab:orge0d9f5f})
...
\begin{table}[htbp]
\caption{\label{tab:orge0d9f5f}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org5f00677}} & primapterin\textsuperscript{\ref{org5f00677}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org5f00677}blood or urine}
\section{Peptides}
\label{sec:org2f6a5d5}
\subsection{TMA and Choline}
\label{sec:org4ccfe53}
\subsubsection{Trimethylamine Metabolism}
\label{sec:org9d3493c}
\begin{itemize}
...
\caption{\label{fig:org5f0c94f}
TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:org4d3df54}
\begin{itemize}
...
\caption{\label{fig:org96b6802}
Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:orgd7d9afa}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org288a023}
\begin{itemize}
...
\item Genetics
\label{sec:org2b77f93}
\begin{itemize}
\item AR, \textasciitilde{}1\% carrier freq
\end{itemize}

\item Diagnostic Tests
\label{sec:orgdef1d3d}
\begin{itemize}
...
\caption{\label{fig:org5000b38}
The \(\gamma\)-glutamyl cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:org03114c9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge6db824}
\begin{itemize}
...
\item Genetics
\label{sec:orgec9b767}
\begin{itemize}
\item AR, GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:orga99a84f}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:org6b48542}
\subsection{Copper}
\label{sec:org8fcdad9}
\begin{itemize}
...
\caption[copper]{\label{fig:org0227b98}
Copper Metabolism}
\end{figure}

\subsubsection{Wilson Disease}
\label{sec:orgbcd58dd}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org083de4f}
\begin{itemize}
...
\label{sec:org58614c4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2bc12aa}
\begin{itemize}
...
\caption[iron]{\label{fig:org23f99ce}
Iron Metabolism}
\end{figure}
...
\item Genetics
\label{sec:org13a58c4}
\begin{itemize}
\item X-linked, PRPS1
\end{itemize}

\item Diagnostic Tests
\label{sec:org4e7b2a8}
\begin{itemize}
...
\item Genetics
\label{sec:org4de651d}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org2527071}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:orgb9e68db}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org7ea942e}
\begin{itemize}
...
\item Genetics
\label{sec:org98bbab4}
\begin{itemize}
\item AR, PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:org421430e}
\begin{itemize}
...
\label{sec:org89a0a8e}
\begin{enumerate}
\item Clinical Picture
\label{sec:org0ada6f5}
\begin{itemize}
...
\label{sec:orgfaef358}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge0563b9}
\begin{itemize}
...
\item Genetic
\label{sec:org9923838}
\begin{itemize}
\item \textbf{XLR}, HPRT
\end{itemize}

\item Diagnostic Tests
\label{sec:org86942f9}
\begin{itemize}
...
\label{sec:orgd47f660}
\subsubsection{Introduction}
\label{sec:org73e56f3}
\begin{itemize}
...
\label{sec:org6165b39}
\begin{itemize}
\item AKA: Hereditary Orotic Aciduria
\end{itemize}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org404c8e7}
\begin{itemize}
...
\item Genetics
\label{sec:org8d8fc98}
\begin{itemize}
\item AR, UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:orge825d01}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:org408aae3}
\begin{itemize}
...
\label{sec:org935ae93}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd6eb39a}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:orga57bc8f}
\begin{itemize}
\item AR, DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd07a642}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org5eab8a8}
\subsection{Introduction}
\label{sec:orgf0fd1c2}
\begin{itemize}
...
\caption{\label{fig:org5779431}
Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org680e98c}
...
\label{sec:org6319b68}
\subsubsection{Clinical Features}
\label{sec:org0756304}
\begin{itemize}
...
\label{sec:org9bab116}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:orga3feb2e}
\begin{itemize}
...
\label{sec:org2a20f9f}
\begin{enumerate}
\item Acute Attack
\label{sec:org15becea}
\begin{itemize}
...
\label{sec:orgfa9d61c}
\begin{enumerate}
\item Clincal Presentation
\label{sec:org8f9023c}
\begin{itemize}
\item both sexes
...
\label{sec:orge25a4c5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb2f216e}
\begin{itemize}
...
\label{sec:org98f7579}
\begin{enumerate}
\item Clinical Features
\label{sec:org76645d8}
\begin{itemize}
