...
\label{sec:org5dae458}
\subsection{Introduction}
\label{sec:org9d9687a}
\begin{itemize}
...
\begin{itemize}
\item three defects of GABA catabolism have been reported (section \ref{sec:orgb114ad5})
\item three receptor defects (section \ref{sec:org2d467bb})
\item three transportopathies are reported (section \ref{sec:org2d467bb})
\item six disorders of monoamine metabolism (section \ref{sec:org64636bd})
\item see amino acids for disorders of glycine metabolism
\end{itemize}
\end{itemize}
\subsection{GABA catabolism}
\label{sec:orgb114ad5}
\begin{itemize}
...
\item Genetics
\label{sec:org296b9b0}
\begin{itemize}
\item AR, ALDH5A1
\end{itemize}

\item Diagnostic Tests
\label{sec:org89e47a0}
\begin{itemize}
...
\label{sec:orgdb5ccca}
\begin{itemize}
\item dopamine responsive dystonia (Figure \ref{fig:org9ace0e8} and Table \ref{tab:org1e9ca9a})
...
\begin{table}[htbp]
\caption{\label{tab:org1e9ca9a}
Results in Biopterin Disorders}
\centering
\begin{tabular}{lrlllll}
Deficiency & Phe & biopterin\footnotemark & neopterin\textsuperscript{\ref{org2d5d2f9}} & primapterin\textsuperscript{\ref{org2d5d2f9}} & CSF 5-HIAA HVA & DHPR activity\\
\hline
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org2d5d2f9}blood or urine}
\section{Peptides}
\label{sec:org77b4824}
\subsection{TMA and Choline}
\label{sec:org4ed2af5}
\subsubsection{Trimethylamine Metabolism}
\label{sec:orgd0931d0}
\begin{itemize}
...
\caption{\label{fig:orgc0cd262}
TMA}
\end{figure}

\subsubsection{Catabolism of Choline}
\label{sec:orge8077d2}
\begin{itemize}
...
\caption{\label{fig:org7a0ca39}
Choline catabolism}
\end{figure}

\subsubsection{Trimethylaminuria (Fish Malodour Syndrome)}
\label{sec:org9a8d8d4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5d4b57f}
\begin{itemize}
...
\item Genetics
\label{sec:orga04f736}
\begin{itemize}
\item AR, \textasciitilde{}1\% carrier freq
\end{itemize}

\item Diagnostic Tests
\label{sec:org0657ab5}
\begin{itemize}
...
\caption{\label{fig:org16d7e4f}
The \(\gamma\)-glutamyl cycle}
\end{figure}


\subsubsection{Glutathione Synthetase Deficiency}
\label{sec:orgbd90e3b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0c749db}
\begin{itemize}
...
\item Genetics
\label{sec:org0fb2648}
\begin{itemize}
\item AR, GSS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgfe4382e}
\begin{itemize}
...
\end{enumerate}
\section{Metal}
\label{sec:orgd9996ea}
\subsection{Copper}
\label{sec:orgfcccf41}
\begin{itemize}
...
\caption[copper]{\label{fig:org276f99b}
Copper Metabolism}
\end{figure}

\subsubsection{Wilson Disease}
\label{sec:orgf3310f2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org320ccc2}
\begin{itemize}
...
\label{sec:orgfc8f9af}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org41fb869}
\begin{itemize}
...
\caption[iron]{\label{fig:orga9c07ec}
Iron Metabolism}
\end{figure}
...
\item Genetics
\label{sec:orgbbb57b6}
\begin{itemize}
\item X-linked, PRPS1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgb47480f}
\begin{itemize}
...
\item Genetics
\label{sec:org0333bb2}
\begin{itemize}
\item AR AMPD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org241233f}
\begin{itemize}
\item NIET
\begin{itemize}
...
\label{sec:org58e2c31}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8f35cb1}
\begin{itemize}
...
\item Genetics
\label{sec:org5e0590c}
\begin{itemize}
\item AR, PNP
\end{itemize}

\item Diagnostic Tests
\label{sec:orgb260b71}
\begin{itemize}
...
\label{sec:orgef7c7a5}
\begin{enumerate}
\item Clinical Picture
\label{sec:orge36987d}
\begin{itemize}
...
\label{sec:org9ea3b36}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6fdf127}
\begin{itemize}
...
\item Genetic
\label{sec:orgf8bedf8}
\begin{itemize}
\item \textbf{XLR}, HPRT
\end{itemize}

\item Diagnostic Tests
\label{sec:orgc9b418b}
\begin{itemize}
...
\label{sec:org13a9f9d}
\subsubsection{Introduction}
\label{sec:orgfbbc92b}
\begin{itemize}
...
\label{sec:org3105b3a}
\begin{itemize}
\item AKA: Hereditary Orotic Aciduria
\end{itemize}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd4e6f4d}
\begin{itemize}
...
\item Genetics
\label{sec:org81c6661}
\begin{itemize}
\item AR, UMPS
\end{itemize}

\item Diagnostic Tests
\label{sec:org94881b7}
\begin{itemize}
\item \(\Uparrow\) urine orotic acid, 200-1000X
\end{itemize}

\item Treatment
\label{sec:org96e2fe5}
\begin{itemize}
...
\label{sec:org98d0d9e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1a0ef5a}
\begin{itemize}
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:orgb60d470}
\begin{itemize}
\item AR, DPYD
\end{itemize}

\item Diagnostic Tests
\label{sec:org6afffbd}
\begin{itemize}
...
\end{enumerate}
\section{Porphyrias}
\label{sec:org0e1c19e}
\subsection{Introduction}
\label{sec:org2d32011}
\begin{itemize}
...
\caption{\label{fig:orgdb75f23}
Heme Synthesis}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org955decc}
...
\label{sec:org631b099}
\subsubsection{Clinical Features}
\label{sec:org20bd1a5}
\begin{itemize}
...
\label{sec:orgee25cee}
\begin{enumerate}
\item ALA Dehydratase Porphyria
\label{sec:org2171b81}
\begin{itemize}
...
\label{sec:org50e6ead}
\begin{enumerate}
\item Acute Attack
\label{sec:org09cca69}
\begin{itemize}
...
\label{sec:org4ea3728}
\begin{enumerate}
\item Clincal Presentation
\label{sec:org9c81df0}
\begin{itemize}
\item both sexes
...
\label{sec:orgeaa5b9f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org79ca150}
\begin{itemize}
...
\label{sec:orgca50161}
\begin{enumerate}
\item Clinical Features
\label{sec:orgb8f5a97}
\begin{itemize}
