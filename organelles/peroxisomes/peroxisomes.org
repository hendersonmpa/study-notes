...
#+CAPTION[]:Non-Mitochondrial FA Metabolism
#+NAME: fig:nmfa
...
** Diagnostic Tests
- \downarrow cortisol and aldosterone
- quantitative VLCFAs including: C22:0, C24:0, and C26:0 in plasma
  ...
  - \uparrow C26:0/C22:0
  - \uparrow C24:0/C22:0
    - C22:0 used as denominator \because not increased
...
- \uparrow pipecolic acid in urine or plasma
  - elevations in pipecolic acid also occur in:
    - pyridoxine-dependent epilepsy - \because antiquitin deficiency 
    - sulfite oxidase deficiency - \because \uparrow S-sulfocysteine inhibits antiquitin
- \uparrow plasma pristanic and phytanic
...
*** RCDP Type 1
 ...
 - three PTS2-containing peroxisomal enzymes are known 
   ...
   2) alkylglycerone phosphate synthase (see RCDP Type 3)
   3) phytanoyl-CoA hydroxylase
      - phytanoyl-CoA \to pristanoly-CoA
...
- COX pathway generates the different prostaglandins:
  - PGE2, PGD2, PGF2\alpha, PGI2, and TXA2
