...
\label{sec:org6760eda}
\subsection{Introduction}
\label{sec:orgc8eeaa1}
\begin{enumerate}
\item Sphingolipids
\label{sec:org68b8a63}
\begin{itemize}
...
\item Biosynthesis
\label{sec:orgb0551e9}
\begin{enumerate}
\item ER
\label{sec:orgacb331e}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:orgc82dc27}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org5afef3f}
...
\label{sec:org7feb7e5}
\begin{enumerate}
\item Classification
\label{sec:orge9892d7}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org1ffe45a}
\begin{itemize}
...
\label{sec:org98f4239}

\begin{table}[htbp]
\caption{\label{tab:org131ec29}
...
\caption{\label{fig:org4bf77ac}
Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:org00090ee}
\begin{itemize}
...
\caption[Lysosomal protein trafficking receptors]{\label{fig:orga197d09}
Lysosomal protein trafficking receptors}
\end{figure}

\begin{enumerate}
\item M6P receptors
\label{sec:org9bf6e0a}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:orgf82fe1b}
\begin{enumerate}
\item Introduction
\label{sec:org3c6cbd2}
\begin{itemize}
...
\caption{\label{fig:org3ee3354}
\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}

\item Genetics
\label{sec:org506c7d0}
\begin{itemize}
\item AR GBA
...
\label{sec:org1b080f6}
\begin{itemize}
\item see table \ref{tab:orgd32c683}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgd32c683}
...
\item Treatment
\label{sec:org12241be}
\begin{enumerate}
\item bone marrow transplantation
\label{sec:org087d1d7}
\begin{itemize}
...
\label{sec:org28efa33}
\begin{enumerate}
\item Introduction
\label{sec:org27bf88d}
\begin{itemize}
...
\caption{\label{fig:org0125dec}
Sphingomyelinase}
\end{figure}

\item Genetics
\label{sec:orgab8e469}
\begin{itemize}
\item AR, SMPD1
...
\item Clinical Findings
\label{sec:org8bcf930}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:org2aa0b8e}
\begin{itemize}
...
\end{itemize}
\item foam cells in bone marrow (Figure \ref{fig:orgbf077b2})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{./niemann_pick/figures/foam_cells.png}
\caption{\label{fig:orgbf077b2}
Foam cells in bone marrow}
\end{figure}

\item Treatment
\label{sec:org9bbd39b}
\begin{itemize}
...
\label{sec:org233eb36}
\begin{enumerate}
\item Introduction
\label{sec:org3d5c9c1}
\begin{itemize}
\item defect in \textbf{\(\beta\)-galactosidase (AKA: \(\beta\)-gangliosidase)}
\begin{itemize}
\item removes galactose from GM1, keratin sulfate and some oligosaccharides (Figure \ref{fig:orgde23486})
\end{itemize}
...
\begin{itemize}
\item ML-1 (sialidosis) (section \ref{sec:orga96631b})
\end{itemize}
\end{itemize}
\end{enumerate}

\item Genetics
\label{sec:orga982bec}
\begin{itemize}
\item AR GLB1
...
\item Clinical Findings
\label{sec:orgf8ee558}
\begin{itemize}
\item see table \ref{tab:orga0ede5c}
\item a cause of non-immune fetal hydrops
\end{itemize}
\begin{table}[htbp]
\caption[GM1 Signs and Symptoms]{\label{tab:orga0ede5c}
...
coarse facial features & \textpm{} & - & - & \textsuperscript{\ref{org27a30f7}}\\
skeletal findings & + & \textpm{} & - & +\\
urine & \footnotemark & \textsuperscript{\ref{org07ead67}} & \textsuperscript{\ref{org07ead67}} & keratan sulfate \footnotemark\\
\end{tabular}
\end{table}\footnotetext[1]{\label{org85f760d}corneal clouding}\footnotetext[2]{\label{org27a30f7}secondary to bony changes}\footnotetext[3]{\label{org07ead67}oligosacaride with terminal galactose}\footnotetext[4]{\label{org76aabe6}FN have been observed}
\item Laboratory Investigations
\label{sec:orgb179f25}
\begin{itemize}
...
and \(\beta\) subunits (Table \ref{tab:orgfecab0a})
\end{itemize}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgfecab0a}
...
\caption{\label{fig:org6f24445}
Hexosaminidase A \& B:Sandhoff disease}
\end{figure}

\item Genetics
\label{sec:orgfc9f5a5}
\begin{itemize}
...
\item Clinical Findings
\label{sec:org4eb2066}
\begin{itemize}
\item see table \ref{tab:orgfda09ad}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orgfda09ad}
...
\end{enumerate}
\subsection{Krabbe}
\label{sec:org02690c4}
\begin{enumerate}
\item Introduction
\label{sec:org5b485a1}
\begin{itemize}
...
\begin{enumerate}
\item Treatment
\label{sec:orga076fae}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:org82db26b}
\begin{itemize}
...
\label{sec:org1e14561}
\begin{enumerate}
\item Introduction
\label{sec:org288e409}
\begin{itemize}
...
\item multiple sulphatase deficiency (Section \ref{sec:org3b7cf90})
\end{itemize}
\end{itemize}
\begin{enumerate}
\item Late-infantile
\label{sec:org1a6b3c1}
\begin{itemize}
...
\end{enumerate}
\subsection{Fabry}
\label{sec:org12a9c05}
\begin{enumerate}
\item Introduction
\label{sec:org2b6e9a0}
\begin{itemize}
...
(Figure \ref{fig:org3ee3354})
\item accumulation of Gb3 in blood vessels and other tissues
\item globotriaosylceramide (Gb3): the Fabry lipid (Figure \ref{fig:org7e4f852})
...
\caption[Globotriaosylceramide]{\label{fig:org7e4f852}
...
\caption[\(\alpha\)-galactosidase A]{\label{fig:orgc71a588}
\(\alpha\)-galactosidase A, located in the lumen of lysosomes}
\end{figure}

\item Genetics
\label{sec:org31576e9}
\begin{itemize}
\item \textbf{XL GLA}
...
\item Clinical Findings
\label{sec:org8ea38e7}
\begin{itemize}
\item see table \ref{tab:orgf717421}
...
\item ocular lesions
\item angiokeratomas (Figure \ref{fig:orgae1b08f})
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org8bf54b9}induced by heat, cold, fatigue or emotional stress

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fabry/figures/angiokeratomas.png}
\caption[Angiokeratomas of the skin]{\label{fig:orgae1b08f}
Angiokeratomas of the Skin}
\end{figure}}

\item Laboratory Investigations
\label{sec:orgc15d79b}
\begin{enumerate}
\item Biochemistry
\label{sec:org613eff4}
\begin{itemize}
...
\end{enumerate}
\subsection{Farber}
\label{sec:orgae17421}
\begin{enumerate}
\item Introduction
\label{sec:org2c250ef}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org402c045}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\item Clinical
\label{sec:org18331fc}
\begin{itemize}
...
\item Treatment
\label{sec:orgb676454}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\section{Niemann-Pick C}
\label{sec:orgd73b50f}
\subsection{Introduction}
\label{sec:org5edab30}
\begin{itemize}
...
\label{sec:orge02f810}
\begin{enumerate}
\item Early Infantile
\label{sec:orgf2a7376}
\begin{itemize}
...
\caption{\label{fig:org51a4869}
Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:org7e25534}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:org3b7cf90}
\subsection{Introduction}
\label{sec:org3a1b3e9}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./mps/figures/ch17f01.jpg}
\caption[Proteoglycans]{\label{fig:org56b88dc}
Proteoglycans}
\end{figure}
...
\caption[Proteoglycan Synthesis]{\label{fig:org686ed35}
...
\caption[Glycan Nomenclature]{\label{fig:orge80e48b}
...
\caption[Glycosaminoglycans]{\label{fig:org1a22081}
Glycosaminoglycans}
\end{figure}

\begin{itemize}
\item GAGs are composed of repeating units of disaccharides (Figure \ref{fig:org1a22081})
\begin{itemize}
...
\caption[DS Degradation]{\label{fig:org5b08a2b}
DS degradation}
\end{figure}
...
\caption[KS Degradation]{\label{fig:orgeba54b1}
KS degradation}
\end{figure}
...
\caption[HS Degradation]{\label{fig:orgc211787}
HS Degradation}
\end{figure}
\end{enumerate}

\subsection{Multiple sulfatase deficiency}
\label{sec:org090b95f}
\begin{itemize}
...
\label{sec:orgdec58da}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgafa5fbf}
\begin{itemize}
...
\label{sec:orge4aec74}
\begin{itemize}
\item MPS III (Sanfilippo)
\end{itemize}
\item Severe Skeletal Dysplasia
\label{sec:org535e7f3}
\begin{itemize}
\item MPS IV (Morquio)
\end{itemize}
\item Rare
\label{sec:orgffb78f3}
\begin{itemize}
\item MPS VII (Sly)
...
\caption[Glycosaminoglycan Degradation]{\label{fig:orge10ce2c}
Glycosaminoglycan Degradation}
\end{figure}

\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:orgb199228}
...
\item Diagnostic Testing
\label{sec:org4ccec2a}
\begin{itemize}
\item quantitation of urine GAGs (Table \ref{tab:orgb199228})
\begin{itemize}
...
\label{sec:orgeaeabdb}
\subsection{Introduction}
\label{sec:orgcbeca67}
...
\caption{\label{fig:org88489cd}
Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Oligosaccharidoses}
\label{sec:org2f02ded}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org21b9585}
\begin{itemize}
\item oligosaccharidoses share many features in common with MPS disorders (Table \ref{tab:orgd13a02f})
\begin{itemize}
...
\item Genetics
\label{sec:org528ff3d}
\begin{itemize}
\item AR
\end{itemize}
\item Diagnostic Tests
\label{sec:org493f682}
\begin{itemize}
...
\item enzyme activity assays (Table \ref{tab:orgd13a02f})
\end{itemize}

\item Treatment
\label{sec:org6ea2ba1}
\begin{itemize}
\item supportive
\end{itemize}
\end{enumerate}
\section{Mucolipidoses}
\label{sec:orga96631b}
\subsection{Introduction}
\label{sec:org91ffe27}
\begin{itemize}
...
\label{sec:org3f1121e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb2a7105}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8b02ec4}
\begin{enumerate}
\item ML II
\label{sec:org3abe111}
\begin{itemize}
\item low IQ
...
\caption[Protein trafficking to lysosomes]{\label{fig:org398f0a1}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org149b760}
...
\caption{\label{fig:orgb7ba566}
I cell in fibroblast culture}
\end{figure}

\item Genetics
\label{sec:org41cde9a}
\begin{itemize}
\item AR GNPTAB
\end{itemize}

\item Diagnostic Testing
\label{sec:org1812642}
\begin{itemize}
...
\item Treatment
\label{sec:org5f9d62d}
\begin{itemize}
\item supportive
\end{itemize}
\end{enumerate}
\subsection{ML IV}
\label{sec:org9c731f1}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgea07b43}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org255e00f}
\begin{itemize}
\item AR MCOLN1
\end{itemize}
\item Diagnostic Testing
\label{sec:orge1bd142}
\begin{itemize}
...
\section{Peroxisomes}
\label{sec:org80d278e}
\subsection{Introduction}
\label{sec:org3e8988a}
\begin{itemize}
...
\caption[Non-mitochondrial FA metabolism]{\label{fig:org1b6d621}
...
\label{sec:orga13af05}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb493054}
\begin{itemize}
\item 1:20000
\item two forms:
\begin{enumerate}
...
\item Genetics
\label{sec:org791ea58}
\begin{itemize}
\item X-linked ABCD1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgea8f2b4}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org850e576}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:org1e54515}
\begin{itemize}
...
\label{sec:org10d80c2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9149409}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org3f126d1}
Oxidation of Phytanic Acid}
\end{figure}

\item Genetics
\label{sec:orge7db9b5}
\begin{itemize}
\item AR PHYH
\end{itemize}

\item Diagnostic Tests
\label{sec:org9d1fd39}
\begin{itemize}
...
\label{sec:org25f93bb}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9974605}
\begin{itemize}
...
\item Genetics
\label{sec:orgb9d132b}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\item Diagnostic Tests
\label{sec:org08dd64b}
\begin{itemize}
...
\label{sec:org312eb94}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8ce4546}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:orgf580364}
\begin{enumerate}
\item RCDP Type 1
\label{sec:org4b87ae6}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:orgbf8068c}
\begin{itemize}
\item \(\downarrow\) RBC plasmalogens
\end{itemize}
\begin{enumerate}
\item RDCP1
\label{sec:org78c79da}
\begin{itemize}
...
\caption{\label{fig:orgcd90644}
Eicosanoid Metabolism}
\end{figure}

\begin{enumerate}
\item Disorders
\label{sec:org053280e}
\begin{itemize}
...
\label{sec:orgce90971}
\subsection{Introduction}
\label{sec:orgec9f705}
\begin{itemize}
...
\caption{\label{fig:org2d1cc5c}
CDGs}
\end{figure}

\item Congenital Disorders of Glycosylation
\label{sec:org9812bc1}
\begin{itemize}
...
\caption{\label{fig:org13db680}
CDG diagnosis}
\end{figure}
\end{enumerate}

\subsection{PMM2-CDG (CDG Ia)}
\label{sec:orgc132eb1}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1f017ad}
\begin{itemize}
...
\item Genetics
\label{sec:org1e38e65}
\begin{itemize}
\item AR, PMM2
\end{itemize}

\item Diagnostic Testing
\label{sec:org0dd8cf9}
\begin{itemize}
...
\label{sec:orgb3e8ea0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgdaa0061}
\begin{itemize}
...
\item Genetics
\label{sec:org2323d7b}
\begin{itemize}
\item AR, MPI
\end{itemize}

\item Diagnostic Testing
\label{sec:orga08661b}
\begin{itemize}
...
\label{sec:org2189c8f}
\begin{enumerate}
\item MGAT2-CDG (CDG IIa)
\label{sec:org22555bd}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org20d2452}
\begin{itemize}
\item onset in infancy, neonatal
...
\end{itemize}
\item Genetics
\label{sec:org194adc7}
\begin{itemize}
\item AR MGAT2
\end{itemize}
\item Diagnostic Testing
\label{sec:org85024e6}
\begin{itemize}
...
\item Treatment
\label{sec:org87eec42}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\item SLC35C1-CDG (CDG IIc)
\label{sec:orgfc485a0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org572e246}
\begin{itemize}
...
neutrophilia
\item Bombay (hh) blood phenotype (Figure \ref{fig:orgec604c7})
\begin{itemize}
\item do not express H antigen
\end{itemize}
\end{itemize}
\item Metabolic Derangement
\label{sec:orgce5946f}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org8129458}
\begin{itemize}
\item AR SLC35C1
\end{itemize}

\item Diagnostic Testing
\label{sec:orgdefa7eb}
\begin{itemize}
\item normal transferrin IEF
\item molecular
\end{itemize}
\item Treatment
\label{sec:orged1cb4c}
\begin{itemize}
...
\caption[Hh]{\label{fig:orgec604c7}
Hh Blood Group}
\end{figure}
\end{enumerate}
\end{enumerate}
\section{Cystinosis}
\label{sec:org5296c7f}
\subsection{Introduction}
\label{sec:org682240b}
\begin{itemize}
...
marrow
\end{enumerate}
\item nephropathic or infantile form is by far the most frequent (see \ref{sec:org4189f73})
...
\label{sec:org4189f73}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org144589a}
\begin{enumerate}
\item First stage
\label{sec:org1b86c25}
\begin{itemize}
...
\label{sec:org42f1d4f}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:orga1bdaa7}
\begin{itemize}
...
\item Genetics
\label{sec:orge3d1e96}
\begin{itemize}
\item AR, CTNS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgae5b961}
\begin{itemize}
...
\item Treatment
\label{sec:org0eae6b6}
\begin{enumerate}
\item Supportive
\label{sec:orgbfc4fb8}
\begin{itemize}
