...
\label{sec:org689dfa6}
\subsection{Introduction}
\label{sec:org74a21b9}
\subsubsection{Sphingolipids}
\label{sec:org7a7b40c}
\begin{itemize}
...
\label{sec:orgfbdb3af}
\begin{enumerate}
\item ER
\label{sec:org85301b2}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:orgc02a46e}Sphingolipid Structure}
\end{figure}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org1194854}Sphingolipid Biosynthesis}
\end{figure}
\end{enumerate}

\subsection{Disorders of Sphingolipid Synthesis}
\label{sec:org816b539}
\subsubsection{Classification}
\label{sec:orgd56d496}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org88a0cb2}
\begin{description}
...
\label{sec:org673488b}

\begin{table}[htbp]
\caption{\label{tab:orga677fea}Sphingolipidoses}
\centering
\begin{tabular}{llll}
...
\caption{\label{fig:org8d624bd}Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:orgda348a7}
\begin{itemize}
...
\caption{\label{fig:org97dbc6b}Protein Trafficking to Lysosome}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./figures/lysosome_trafficking.jpeg}
\caption[Lysosomal protein trafficking receptors]{\label{fig:org1a864ca}Lysosomal protein trafficking receptors}
\end{figure}

\subsubsection{M6P receptors}
\label{sec:orgac00d63}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:orga68494f}
\subsubsection{Introduction}
\label{sec:orgca15d99}
\begin{itemize}
...
\caption{\label{fig:orgc366752}Glucocerebroside the Gaucher Lipid}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{gaucher/figures/glucocerebrosidase.png}
\caption{\label{fig:orgb03966a}\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}


\subsubsection{Clinical Findings}
\label{sec:org908ed35}
\begin{itemize}
\item see table \ref{tab:org3eaddee}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org3eaddee}Gaucher Clinical Variants}
\centering
\begin{tabular}{llll}
...
\label{sec:org2fd361d}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{gaucher/figures/Gaucher_Cells_with_Fibrillar_Appearing_Cytoplasm.jpg}
\caption{\label{fig:org5b04cec}Gaucher Cells in a bone marrow smear}
\end{figure}

\begin{enumerate}
\item Biochemistry
\label{sec:org6797251}
\begin{itemize}
...
\label{sec:org0eee9f9}
\begin{enumerate}
\item Bone marrow transplantation
\label{sec:orgef911d1}
\begin{itemize}
...
\label{sec:orgde46d71}
\subsubsection{Introduction}
\label{sec:orgc27f295}
\begin{itemize}
...
\caption{\label{fig:org4c46748}Sphingomyelin}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{niemann_pick/figures/sphingomyelinase.png}
\caption{\label{fig:org08f557f}Sphingomyelinase}
\end{figure}

\subsubsection{Clinical Findings}
\label{sec:org562dae9}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:org9118f4d}
\begin{itemize}
...
\end{itemize}
\item foam cells in bone marrow (Figure \ref{fig:orga7a80f4})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{niemann_pick/figures/foam_cells.png}
\caption{\label{fig:orga7a80f4}Foam cells in bone marrow}
\end{figure}

\subsubsection{Treatment}
\label{sec:org24909b8}
\begin{itemize}
...
\label{sec:org950646b}
\subsubsection{Introduction}
\label{sec:orge577303}
\begin{itemize}
\item defect in \textbf{\(\beta\)-galactosidase (AKA: \(\beta\)-gangliosidase)}
\begin{itemize}
\item removes galactose from GM1, keratin sulfate and some oligosaccharides (Figure \ref{fig:org62870b6})
\end{itemize}
...
\caption{\label{fig:org62870b6}\(\beta\)-galactosidase}
\end{figure}


\begin{enumerate}
\item Lysosomal multi-enzyme complex
\label{sec:orgdcdf4bf}
\begin{itemize}
...
\subsubsection{Clinical Findings}
\label{sec:org53b79c7}
\begin{itemize}
\item see table \ref{tab:orga9ae9bc}
\item a cause of non-immune fetal hydrops
\end{itemize}
\begin{table}[htbp]
\caption[GM1 Signs and Symptoms]{\label{tab:orga9ae9bc}GM1 Signs and Symptoms}
\centering
\begin{tabular}{lllll}
...
coarse facial features & \textpm{} & - & - & \textsuperscript{\ref{org0b682ee}}\\
skeletal findings & + & \textpm{} & - & +\\
urine & \footnotemark & \textsuperscript{\ref{orgcea7733}} & \textsuperscript{\ref{orgcea7733}} & keratan sulfate \footnotemark\\
\end{tabular}
\end{table}\footnotetext[1]{\label{org4c1dcdf}corneal clouding}\footnotetext[2]{\label{org0b682ee}secondary to bony changes}\footnotetext[3]{\label{orgcea7733}oligosacaride with terminal galactose}\footnotetext[4]{\label{org9a1c97b}FN have been observed}

\subsubsection{Genetics}
\label{sec:org225ef72}
\begin{itemize}
\item AR GLB1
...
and \(\beta\) subunits (Table \ref{tab:orgfbf8b49})
\end{itemize}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgfbf8b49}Hexoaminidase Isozymes}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:org80cdd0b}GM2 ganglioside storage diseases}
\centering
\begin{tabular}{llrll}
...
\caption{\label{fig:orgd6988e8}Hexosaminidase A: Tay-Sachs}
\end{figure}
...
\caption{\label{fig:org0d4c548}Hexosaminidase A \& B:Sandhoff disease [fn:gl]}
\end{figure}

\subsubsection{Clinical Findings}
\label{sec:org9ee75f2}
\begin{itemize}
\item see table \ref{tab:orgd1d1a47}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orgd1d1a47}GM2 Signs and Symptoms}
\centering
\begin{tabular}{llll}
...
\subsubsection{Treatment}
\label{sec:org2f11400}
\begin{itemize}
\item treat seizures
\item no curative treatment to date
\end{itemize}
\subsection{Krabbe}
\label{sec:org7713b74}
\subsubsection{Introduction}
\label{sec:org0d993db}
\begin{itemize}
...
\caption{\label{fig:org6988b6c}Galactocerebrosidase}
\end{figure}
...
\caption{\label{fig:org14532cf}NBS follow-up at Mayo}
\end{figure}
...
\begin{enumerate}
\item Treatment
\label{sec:orgaf2e7eb}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:org0f93598}
\begin{itemize}
...
\label{sec:org6c283f6}
\subsubsection{Introduction}
\label{sec:org1f87bcd}
\begin{itemize}
...
\label{sec:orge3e9b91}
\begin{itemize}
\item three forms: late infantile-onset, juvenile and adult
\item variants include:
\begin{itemize}
\item saposin B deficiency
\item multiple sulphatase deficiency (see Section \ref{sec:org2e8d695})
\end{itemize}
\end{itemize}
\begin{enumerate}
\item Late-infantile
\label{sec:orge10330c}
\begin{itemize}
...
\end{itemize}
\subsection{Fabry}
\label{sec:org8a4d8e8}
\subsubsection{Introduction}
\label{sec:org60396ac}
\begin{itemize}
...
(Figure \ref{fig:orgb03966a})
\item accumulation of Gb3 in blood vessels and other tissues
\begin{itemize}
\item Gb3 is the Fabry lipid (Figure \ref{fig:org1bc91e7})
\end{itemize}
...
\caption[Globotriaosylceramide]{\label{fig:org1bc91e7}Globotriaosylceramide (Gb3): the Fabry lipid}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\textwidth]{fabry/figures/galactosidaseA.png}
\caption[\(\alpha\)-galactosidase A]{\label{fig:orgb45a8e3}\(\alpha\)-galactosidase A, located in the lumen of lysosomes}
\end{figure}


\subsubsection{Clinical Findings}
\label{sec:orgacde628}
\begin{itemize}
\item see table \ref{tab:orga0a8739}
...
\item ocular lesions
\item angiokeratomas (Figure \ref{fig:org74cae87})
\begin{itemize}
...
\caption[Angiokeratomas of the skin]{\label{fig:org74cae87}Angiokeratomas of the Skin}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orga0a8739}Fabry Signs and Symptoms}
\centering
\begin{tabular}{ll}
Age & Signs\\
\hline
...
\end{tabular}
\end{table}\footnotetext[5]{\label{orgf06a9c8}induced by heat, cold, fatigue or emotional stress}

\subsubsection{Genetics}
\label{sec:org164af38}
\begin{itemize}
\item \textbf{XL GLA}
...
\subsubsection{Laboratory Investigations}
\label{sec:org082bdac}
\begin{enumerate}
\item Biochemistry
\label{sec:org486ea77}
\begin{itemize}
...
\caption[Fabry EM]{\label{fig:org0130b6d}EM showing concentric or lamellar structure of lysosomal inclusions in Fabry disease renal biopsy}
\end{figure}
\end{enumerate}

\subsubsection{Treatment}
\label{sec:orge6add01}
\begin{itemize}
\item alleviate pain
\begin{itemize}
...
\end{itemize}
\subsection{Farber}
\label{sec:org1a4eade}
\subsubsection{Introduction}
\label{sec:orgce63369}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgc49472c}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\subsubsection{Clinical}
\label{sec:orgb6a5873}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org85031b4}
\begin{itemize}
\item none
\end{itemize}
\section{Niemann-Pick C}
\label{sec:orge1ecefa}
\subsection{Introduction}
\label{sec:orgf5bf701}
\begin{itemize}
...
\label{sec:org0b4cfa3}
\begin{enumerate}
\item Early Infantile
\label{sec:org96dba18}
\begin{itemize}
...
\subsection{Genetics}
\label{sec:org8b6dee3}
\begin{itemize}
\item AR NPC1 (95\%) and NPC2 (5\%)
\end{itemize}
\subsection{Diagnostic Tests}
\label{sec:orge37148a}
\begin{itemize}
...
\caption{\label{fig:orga6490d1}Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:orgc1b7664}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:org30e8b60}
\subsection{Introduction}
\label{sec:org8b537ef}
\begin{itemize}
...
\subsection{Genetics}
\label{sec:org7960fc3}
\begin{itemize}
\item AR
\item adult form is AD
\end{itemize}
\subsection{Diagnostic Tests}
\label{sec:org3d0bb24}
\begin{itemize}
...
\caption[Proteoglycan Synthesis]{\label{fig:orgc7df9be}Proteoglycan Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{mps/figures/snfg.png}
\caption[Glycan Nomenclature]{\label{fig:orgd7819d3}Symbol Nomenclature for Glycans (SNFG)}
\end{figure}
...
\caption[Glycosaminoglycans]{\label{fig:org447830b}Glycosaminoglycans}
\end{figure}

\begin{itemize}
\item GAGs are composed of repeating units of disaccharides (Figure \ref{fig:org447830b})
\begin{itemize}
...
\caption[DS Degradation]{\label{fig:orgf8699df}DS degradation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{mps/figures/ks_degradation_disorders.png}
\caption[KS Degradation]{\label{fig:org17d4aba}KS degradation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{mps/figures/hs_degradation_disorders.png}
\caption[HS Degradation]{\label{fig:org7ad34e6}HS Degradation}
\end{figure}
\end{enumerate}

\subsection{Multiple Sulfatase Deficiency}
\label{sec:org6da317b}
\begin{itemize}
...
\label{sec:org2ffaf07}
\subsubsection{Clinical Presentation}
\label{sec:orgfb7aa7e}
\begin{itemize}
...
\label{sec:org130fb3f}
\begin{itemize}
\item MPS III (Sanfilippo)
\end{itemize}
\item Severe skeletal dysplasia
\label{sec:org9dc7fca}
\begin{itemize}
\item MPS IV (Morquio)
\end{itemize}
\item Rare
\label{sec:org3add0dc}
\begin{itemize}
\item MPS VII (Sly)
...
\begin{table}[htbp]
\caption{\label{tab:org7d97d10}MPS Signs and Symptoms}
\centering
...
\caption[Glycosaminoglycan Degradation]{\label{fig:org912c1c6}Glycosaminoglycan Degradation}
\end{figure}


\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:org01ad8ae}MPS Enzymes and Substrates}
\centering
\begin{tabular}{lllll}
...
\subsubsection{Diagnostic Tests}
\label{sec:org8c11b29}
\begin{itemize}
\item quantitation of urine GAGs (Table \ref{tab:org01ad8ae})
\begin{itemize}
...
\label{sec:orgafe26e6}
\subsection{Introduction}
\label{sec:org5c6c3d5}
\begin{itemize}
...
\caption{\label{fig:orgf671c67}Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Oligosaccharidoses}
\label{sec:org120420d}
\subsubsection{Clinical Presentation}
\label{sec:org1611e77}
\begin{itemize}
\item oligosaccharidoses share many features in common with MPS disorders (Table \ref{tab:org874d216})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org874d216}Oligosaccharidoses}
\centering
...
\subsubsection{Genetics}
\label{sec:org24a9492}
\begin{itemize}
\item AR
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org9a18b74}
\begin{itemize}
...
\item enzyme activity assays (Table \ref{tab:org874d216})
\end{itemize}

\subsubsection{Treatment}
\label{sec:org111cff3}
\begin{itemize}
\item supportive
\end{itemize}
\section{Mucolipidoses}
\label{sec:org12111e2}
\subsection{Introduction}
\label{sec:orgfdec29e}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org90a7bb4}Mucolipidoses}
\centering
\begin{tabular}{lllllll}
Disease & enzyme & dysostosis & progressive & angio- & hepato & sample\\
 &  & multiplex & cognitive & keratoma & -splenomegally & \\
...
\label{sec:orgc794b19}
\subsubsection{Clinical Presentation}
\label{sec:orgf2d21ac}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org71139b6}
\begin{itemize}
\item supportive
\end{itemize}

\subsection{ML II \& III}
\label{sec:org64eeeec}
\begin{itemize}
\item ML II AKA: I-Cell Disease
\item ML III AKA: Pseudo-Hurler
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org665b3b5}
\begin{enumerate}
\item ML II
\label{sec:orgeec24cf}
\begin{itemize}
\item low IQ
...
\begin{table}[htbp]
\caption{\label{tab:org3305a52}Lysosomal enzyme receptors}
\centering
\begin{tabular}{lll}
...
\caption[Protein trafficking to lysosomes]{\label{fig:orgdf6e81f}Protein trafficking to lysosomes}
\end{figure}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org6e32222}N-acetylglucosamine (GlcNAc) phosphotransferase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[height=0.5\textwidth]{mucolipidosis/figures/icell.png}
\caption{\label{fig:orgd6765a5}I cell in fibroblast culture}
\end{figure}

\subsubsection{Genetics}
\label{sec:org8ccc580}
\begin{itemize}
\item AR GNPTAB
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org1c23398}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org0ffea14}
\begin{itemize}
\item supportive
\end{itemize}
\subsection{ML IV}
\label{sec:org0a60320}
\subsubsection{Clinical Presentation}
\label{sec:org09966a7}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org75e1d96}
\begin{itemize}
\item AR MCOLN1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org5facef7}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgc9568db}
\begin{itemize}
\item supportive
\end{itemize}

\section{Peroxisomes}
\label{sec:orgb8311f3}
\subsection{Introduction}
\label{sec:orgb056219}
\begin{itemize}
...
\caption[Non-mitochondrial FA metabolism]{\label{fig:org1124070}Non-mitochondrial FA metabolism}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:orga60ff93}Biochemical Findings in Peroxisomal Disease}
\centering
\begin{tabular}{llllll}
...
\label{sec:org0a5f027}
\subsubsection{Clinical Presentation}
\label{sec:orgd93c621}
\begin{itemize}
\item three forms:
\begin{enumerate}
...
\subsubsection{Genetics}
\label{sec:org9bbc519}
\begin{itemize}
\item \textbf{X-linked ABCD1}
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org09e0fd3}
\begin{itemize}
...
\end{itemize}
\item see table \ref{tab:orga60ff93}
\end{itemize}
\subsubsection{Treatment}
\label{sec:org031a222}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org79dfe5f}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:orgf9ac093}
\begin{itemize}
...
\label{sec:org0be348b}
\subsubsection{Clinical Presentation}
\label{sec:org2984f4f}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:orgc25f916}Oxidation of Phytanic Acid}
\end{figure}

\subsubsection{Genetics}
\label{sec:orgb0c9b84}
\begin{itemize}
\item AR PHYH
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgf8eb1ec}
\begin{itemize}
...
\label{sec:orge40bee2}
\subsubsection{Clinical Presentation}
\label{sec:orga922eca}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org396863a}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org8803ac0}
\begin{itemize}
...
\label{sec:org4ffa472}
\subsubsection{Clinical Presentation}
\label{sec:org53c38d1}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org1748e25}
\begin{enumerate}
\item RCDP Type 1
\label{sec:org9d7cada}
\begin{itemize}
...
\caption{\label{fig:orgaff7c8e}Eicosanoid Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org3e5c814}
\begin{itemize}
...
\label{sec:org7fbbdca}
\subsection{Introduction}
\label{sec:orgc80c300}
\begin{itemize}
...
\caption{\label{fig:orgb43c1c6}CDGs}
\end{figure}

\subsubsection{Congenital Disorders of Glycosylation}
\label{sec:org6ae81d3}
\begin{itemize}
...
\caption{\label{fig:org001d956}CDG diagnosis}
\end{figure}

\subsection{CDG Ia (PMM2-CDG)}
\label{sec:org5b0852d}
\subsubsection{Clinical Presentation}
\label{sec:org0502cee}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org07cbfc3}
\begin{itemize}
\item AR PMM2
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgbb4f1d6}
\begin{itemize}
...
\item see figure \ref{fig:org001d956}
\end{itemize}

\subsubsection{Treatment}
\label{sec:org490ca29}
\begin{itemize}
\item no effective treatment is available
\end{itemize}

\subsection{CDG Ib (MPI-CDG)}
\label{sec:org43e8737}
\subsubsection{Clinical Presentation}
\label{sec:orgca1a1de}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org9e7bb14}
\begin{itemize}
\item AR, MPI
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org769c789}
\begin{itemize}
...
\label{sec:org0f40ac5}
\subsubsection{CDG IIa (MGAT2-CDG)}
\label{sec:org7c08339}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3282ba4}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org603b329}
\begin{itemize}
\item AR MGAT2
\end{itemize}
\item Diagnostic Tests
\label{sec:orgf4f7c72}
\begin{itemize}
...
\end{itemize}
\item Treatment
\label{sec:org9e7c6f5}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\subsubsection{CDG IIc SLC35C1-CDG}
\label{sec:org17f183e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0141043}
\begin{itemize}
...
neutrophilia
\item Bombay (hh) blood phenotype (Figure \ref{fig:org6e375f3})
\begin{itemize}
\item do not express H antigen
\end{itemize}
\end{itemize}
\item Metabolic Derangement
\label{sec:org15400e6}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org7d0632f}
\begin{itemize}
\item AR SLC35C1
\end{itemize}

\item Diagnostic Tests
\label{sec:org9d7527b}
\begin{itemize}
...
\caption[Hh]{\label{fig:org6e375f3}Bombay (hh) Blood Group}
\end{figure}
\end{enumerate}
\section{Cystinosis}
\label{sec:org6bebdfd}
\subsection{Introduction}
\label{sec:org0b8f8af}
\begin{itemize}
...
\caption{\label{fig:orgff9f952}Cystine}
\end{figure}

\begin{itemize}
\item normally exported by a cystine porter which contains the membrane protein cystinosin (Figure \ref{fig:org866dc1b})
\begin{itemize}
...
\caption{\label{fig:org866dc1b}Lysosomal export of cystine and related compounds. The cross represents the defect in cystinosis}
\end{figure}
...
marrow
\end{enumerate}
\item nephropathic or infantile form is by far the most frequent (Section \ref{sec:orgd16ac18})
...
\label{sec:orgd16ac18}
\subsubsection{Clinical Presentation}
\label{sec:org75e10aa}
\begin{enumerate}
\item First stage
\label{sec:org418d6a5}
\begin{itemize}
...
\label{sec:orgb1be99c}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org267f300}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org60243ac}
\begin{itemize}
\item AR, CTNS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org8476089}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgc9ef834}
\begin{enumerate}
\item Supportive
\label{sec:org29b71d5}
\begin{itemize}
