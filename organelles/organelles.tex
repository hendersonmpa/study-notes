...
\label{sec:orgf46c61d}
\subsection{Introduction}
\label{sec:orgf2b9f04}
\begin{enumerate}
\item Sphingolipids
\label{sec:org106a3ab}
\begin{itemize}
...
\item Biosynthesis
\label{sec:org89daec8}
\begin{enumerate}
\item ER
\label{sec:orga15de10}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:org2ccfb91}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:orgc794088}
...
\label{sec:org4ce0001}
\begin{enumerate}
\item Classification
\label{sec:org07c5ab6}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org177523c}
\begin{itemize}
...
\label{sec:org420f8a9}

\begin{table}[htbp]
\caption{\label{tab:org62a5849}
...
\caption{\label{fig:org0dc8100}
Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:orgc9b2ce0}
\begin{itemize}
...
\caption[Lysosomal protein trafficking receptors]{\label{fig:org5c1361a}
Lysosomal protein trafficking receptors}
\end{figure}

\begin{enumerate}
\item M6P receptors
\label{sec:orgcee9b4f}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:org804a993}
\begin{enumerate}
\item Introduction
\label{sec:org2b839d8}
\begin{itemize}
...
\caption{\label{fig:org7b35abf}
\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}

\item Genetics
\label{sec:org1142006}
\begin{itemize}
\item AR GBA
...
\label{sec:org8380222}
\begin{itemize}
\item see table \ref{tab:org2470209}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org2470209}
...
\item Treatment
\label{sec:org138c400}
\begin{enumerate}
\item bone marrow transplantation
\label{sec:org2c3fd62}
\begin{itemize}
...
\label{sec:org1bd0758}
\begin{enumerate}
\item Introduction
\label{sec:org5f9bf8a}
\begin{itemize}
...
\caption{\label{fig:org8cb98a6}
Sphingomyelinase}
\end{figure}

\item Genetics
\label{sec:orgdac71b7}
\begin{itemize}
\item AR, SMPD1
...
\item Clinical Findings
\label{sec:org5e05c25}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:org1b76bf2}
\begin{itemize}
...
\end{itemize}
\item foam cells in bone marrow (Figure \ref{fig:org546a906})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{./niemann_pick/figures/foam_cells.png}
\caption{\label{fig:org546a906}
Foam cells in bone marrow}
\end{figure}

\item Treatment
\label{sec:orgb4f8463}
\begin{itemize}
...
\begin{itemize}
\item removes galactose from GM1, keratin sulfate and some oligosaccharides (Figure \ref{fig:orgcb991a4})
\end{itemize}
...
\begin{itemize}
\item ML-1 (sialidosis) (section \ref{sec:org0d0ae5c})
\end{itemize}
\end{itemize}
\end{enumerate}

\item Genetics
\label{sec:org12b159c}
\begin{itemize}
\item AR GLB1
...
\item Clinical Findings
\label{sec:org5264871}
\begin{itemize}
\item see table \ref{tab:org0c82004}
\item a cause of non-immune fetal hydrops
\end{itemize}
\begin{table}[htbp]
\caption[GM1 Signs and Symptoms]{\label{tab:org0c82004}
...
coarse facial features & \textpm{} & - & - & \textsuperscript{\ref{org1785abc}}\\
skeletal findings & + & \textpm{} & - & +\\
urine & \footnotemark & \textsuperscript{\ref{orge4d1b9d}} & \textsuperscript{\ref{orge4d1b9d}} & keratan sulfate \footnotemark\\
\end{tabular}
\end{table}\footnotetext[1]{\label{org3bdbf8e}corneal clouding}\footnotetext[2]{\label{org1785abc}secondary to bony changes}\footnotetext[3]{\label{orge4d1b9d}oligosacaride with terminal galactose}\footnotetext[4]{\label{org03379cd}FN have been observed}
\item Laboratory Investigations
\label{sec:orgc2d5ce2}
\begin{itemize}
...
and \(\beta\) subunits (Table \ref{tab:org371e97e})
\end{itemize}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org371e97e}
...
\caption{\label{fig:orga73e766}
Hexosaminidase A \& B:Sandhoff disease}
\end{figure}

\item Genetics
\label{sec:org6e740de}
\begin{itemize}
...
\item Clinical Findings
\label{sec:orgb09b43b}
\begin{itemize}
\item see table \ref{tab:orgedf68b1}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orgedf68b1}
...
\end{enumerate}
\subsection{Krabbe}
\label{sec:orgaa95232}
\begin{enumerate}
\item Introduction
\label{sec:org2b576ca}
\begin{itemize}
...
\begin{enumerate}
\item Treatment
\label{sec:org4a3f63f}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:orgec942d1}
\begin{itemize}
...
\item multiple sulphatase deficiency (Section \ref{sec:orgd2f3a67})
\end{itemize}
\end{itemize}
\begin{enumerate}
\item Late-infantile
\label{sec:org7eb4e6f}
\begin{itemize}
...
\end{enumerate}
\subsection{Fabry}
\label{sec:org3426915}
\begin{enumerate}
\item Introduction
\label{sec:orga6e5ee8}
\begin{itemize}
...
(Figure \ref{fig:org7b35abf})
\item accumulation of Gb3 in blood vessels and other tissues
\item globotriaosylceramide (Gb3): the Fabry lipid (Figure \ref{fig:org6425fa1})
...
\caption[Globotriaosylceramide]{\label{fig:org6425fa1}
...
\caption[\(\alpha\)-galactosidase A]{\label{fig:orga114387}
\(\alpha\)-galactosidase A, located in the lumen of lysosomes}
\end{figure}

\item Genetics
\label{sec:orgb9174f5}
\begin{itemize}
\item \textbf{XL GLA}
...
\item Clinical Findings
\label{sec:orgae59d09}
\begin{itemize}
\item see table \ref{tab:orgf0ccdba}
...
\item ocular lesions
\item angiokeratomas (Figure \ref{fig:org718501e})
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{orgf96cfc9}induced by heat, cold, fatigue or emotional stress

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fabry/figures/angiokeratomas.png}
\caption[Angiokeratomas of the skin]{\label{fig:org718501e}
Angiokeratomas of the Skin}
\end{figure}}

\item Laboratory Investigations
\label{sec:orgb6e1404}
\begin{enumerate}
\item Biochemistry
\label{sec:orgc89b7f4}
\begin{itemize}
...
\end{enumerate}
\subsection{Farber}
\label{sec:org8e1fb8e}
\begin{enumerate}
\item Introduction
\label{sec:orgf606c11}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org50dff6b}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\item Clinical
\label{sec:org42bdcbf}
\begin{itemize}
...
\item Treatment
\label{sec:org5408ebd}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\section{Niemann-Pick C}
\label{sec:org754149f}
\subsection{Introduction}
\label{sec:org6bb10ec}
\begin{itemize}
...
\label{sec:org31ee467}
\begin{enumerate}
\item Early Infantile
\label{sec:orgce5abd1}
\begin{itemize}
...
\caption{\label{fig:org93ff627}
Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:org31fa4d7}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:org51e568e}
\subsection{Introduction}
\label{sec:orgab0fa30}
\begin{itemize}
...
\label{sec:orgd2f3a67}
\subsection{Introduction}
\label{sec:org3c50ebe}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./mps/figures/ch17f01.jpg}
\caption[Proteoglycans]{\label{fig:org80f842d}
Proteoglycans}
\end{figure}
...
\caption[Proteoglycan Synthesis]{\label{fig:org751a2b9}
...
\caption[Glycan Nomenclature]{\label{fig:orgb7b9e78}
...
\caption[Glycosaminoglycans]{\label{fig:org6d5d1ae}
Glycosaminoglycans}
\end{figure}

\begin{itemize}
\item GAGs are composed of repeating units of disaccharides (Figure \ref{fig:org6d5d1ae})
\begin{itemize}
...
\caption[DS Degradation]{\label{fig:orgda6a8df}
DS degradation}
\end{figure}
...
\caption[KS Degradation]{\label{fig:org52c4d8c}
KS degradation}
\end{figure}
...
\caption[HS Degradation]{\label{fig:org813a9f6}
HS Degradation}
\end{figure}
\end{enumerate}

\subsection{Multiple sulfatase deficiency}
\label{sec:org860aebd}
\begin{itemize}
...
\label{sec:orgbe92780}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc24bd32}
\begin{itemize}
...
\label{sec:orgadfe476}
\begin{itemize}
\item MPS III (Sanfilippo)
\end{itemize}
\item Severe Skeletal Dysplasia
\label{sec:orgd9db188}
\begin{itemize}
\item MPS IV (Morquio)
\end{itemize}
\item Rare
\label{sec:org14b051b}
\begin{itemize}
\item MPS VII (Sly)
...
\caption[Glycosaminoglycan Degradation]{\label{fig:orgaeae3ac}
Glycosaminoglycan Degradation}
\end{figure}

\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:orgd974ae8}
...
\item Diagnostic Tests
\label{sec:orgbfbdde8}
\begin{itemize}
\item quantitation of urine GAGs (Table \ref{tab:orgd974ae8})
\begin{itemize}
...
\label{sec:orgbe9e064}
\subsection{Introduction}
\label{sec:orga74f131}
...
\caption{\label{fig:org5f983fe}
Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Oligosaccharidoses}
\label{sec:org22f78d5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org63106ea}
\begin{itemize}
\item oligosaccharidoses share many features in common with MPS disorders (Table \ref{tab:org6a4334a})
\begin{itemize}
...
\item Genetics
\label{sec:org199367f}
\begin{itemize}
\item AR
\end{itemize}
\item Diagnostic Tests
\label{sec:org827d72a}
\begin{itemize}
...
\item enzyme activity assays (Table \ref{tab:org6a4334a})
\end{itemize}

\item Treatment
\label{sec:org1597dcc}
\begin{itemize}
\item supportive
\end{itemize}
\end{enumerate}
\section{Mucolipidoses}
\label{sec:org0d0ae5c}
\subsection{Introduction}
\label{sec:orgbce8692}
\begin{itemize}
...
\label{sec:org6f1366f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3fe620b}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3d42393}
\begin{enumerate}
\item ML II
\label{sec:orgf6fd594}
\begin{itemize}
\item low IQ
...
\caption[Protein trafficking to lysosomes]{\label{fig:org80e58f4}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org656c413}
...
\caption{\label{fig:org1713801}
I cell in fibroblast culture}
\end{figure}

\item Genetics
\label{sec:orgf4eeab5}
\begin{itemize}
\item AR GNPTAB
\end{itemize}

\item Diagnostic Tests
\label{sec:orgc1a4639}
\begin{itemize}
...
\item Treatment
\label{sec:org8fd8dec}
\begin{itemize}
\item supportive
\end{itemize}
\end{enumerate}
\subsection{ML IV}
\label{sec:org37e2cc2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4c9ebaa}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org0937c70}
\begin{itemize}
\item AR MCOLN1
\end{itemize}
\item Diagnostic Tests
\label{sec:org97acfee}
\begin{itemize}
...
\section{Peroxisomes}
\label{sec:org8767c8a}
\subsection{Introduction}
\label{sec:orgce13a63}
\begin{itemize}
...
\caption[Non-mitochondrial FA metabolism]{\label{fig:org8eec9a2}
...
\label{sec:org4c4158a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org477a243}
\begin{itemize}
\item three forms:
\begin{enumerate}
...
\item Genetics
\label{sec:orgf124f8f}
\begin{itemize}
\item X-linked ABCD1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgc30be3e}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgbad166d}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:org57eb595}
\begin{itemize}
...
\label{sec:org2d394c6}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org93cdad7}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org942e1c4}
Oxidation of Phytanic Acid}
\end{figure}

\item Genetics
\label{sec:orge3c8e50}
\begin{itemize}
\item AR PHYH
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf78f3a9}
\begin{itemize}
...
\label{sec:org435208c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0011184}
\begin{itemize}
...
\item Genetics
\label{sec:orgd538e3d}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\item Diagnostic Tests
\label{sec:org1784e49}
\begin{itemize}
...
\label{sec:org86d72a6}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9445b89}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:orga1ec629}
\begin{enumerate}
\item RCDP Type 1
\label{sec:orgc68930f}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org9ad2ba7}
\begin{itemize}
\item \(\downarrow\) RBC plasmalogens
\end{itemize}
\begin{enumerate}
\item RDCP1
\label{sec:org6a49df5}
\begin{itemize}
...
\caption{\label{fig:org634c48b}
Eicosanoid Metabolism}
\end{figure}

\begin{enumerate}
\item Disorders
\label{sec:org1770970}
\begin{itemize}
...
\label{sec:org1890c0c}
\subsection{Introduction}
\label{sec:org16d4bc7}
\begin{itemize}
...
\caption{\label{fig:orgf798e5b}
CDGs}
\end{figure}

\item Congenital Disorders of Glycosylation
\label{sec:orgc35ff29}
\begin{itemize}
...
\caption{\label{fig:org8947358}
CDG diagnosis}
\end{figure}
\end{enumerate}

\subsection{PMM2-CDG (CDG Ia)}
\label{sec:orgffcb97a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3ec2b69}
\begin{itemize}
...
\item Genetics
\label{sec:org55102f7}
\begin{itemize}
\item AR, PMM2
\end{itemize}

\item Diagnostic Tests
\label{sec:org1765797}
\begin{itemize}
...
\label{sec:orga12888e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf4303f6}
\begin{itemize}
...
\item Genetics
\label{sec:org5542b55}
\begin{itemize}
\item AR, MPI
\end{itemize}

\item Diagnostic Tests
\label{sec:orge651aa5}
\begin{itemize}
...
\label{sec:orga594dbb}
\begin{enumerate}
\item MGAT2-CDG (CDG IIa)
\label{sec:orgd66d508}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5efb4e6}
\begin{itemize}
\item onset in infancy, neonatal
...
\end{itemize}
\item Genetics
\label{sec:org30120e7}
\begin{itemize}
\item AR MGAT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org92c4808}
\begin{itemize}
...
\item Treatment
\label{sec:orgf255b67}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\item SLC35C1-CDG (CDG IIc)
\label{sec:org055f2c2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9938788}
\begin{itemize}
...
neutrophilia
\item Bombay (hh) blood phenotype (Figure \ref{fig:org83efba3})
\begin{itemize}
\item do not express H antigen
\end{itemize}
\end{itemize}
\item Metabolic Derangement
\label{sec:orga23f4b8}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org439216f}
\begin{itemize}
\item AR SLC35C1
\end{itemize}

\item Diagnostic Tests
\label{sec:orga76a40b}
\begin{itemize}
\item normal transferrin IEF
\item molecular
\end{itemize}
\item Treatment
\label{sec:orgf074454}
\begin{itemize}
...
\caption[Hh]{\label{fig:org83efba3}
Hh Blood Group}
\end{figure}
\end{enumerate}
\end{enumerate}
\section{Cystinosis}
\label{sec:org520ca34}
\subsection{Introduction}
\label{sec:org138e1fb}
\begin{itemize}
...
marrow
\end{enumerate}
\item nephropathic or infantile form is by far the most frequent (see \ref{sec:orgb1ead94})
...
\label{sec:orgb1ead94}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgeda0ccf}
\begin{enumerate}
\item First stage
\label{sec:org692e2c6}
\begin{itemize}
...
\label{sec:org3f9a62a}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:orgce1b81a}
\begin{itemize}
...
\item Genetics
\label{sec:org6af8cc1}
\begin{itemize}
\item AR, CTNS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgccdb72c}
\begin{itemize}
...
\item Treatment
\label{sec:orge53da82}
\begin{enumerate}
\item Supportive
\label{sec:orgff8cdaa}
\begin{itemize}
