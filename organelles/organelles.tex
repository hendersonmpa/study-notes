...
\label{sec:org91c9412}
\subsection{Introduction}
\label{sec:orga0f4091}
\begin{enumerate}
\item Sphingolipids
\label{sec:orgfaf51f1}
\begin{itemize}
...
\item Biosynthesis
\label{sec:org048d6d3}
\begin{enumerate}
\item ER
\label{sec:org553c924}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:org9bf1030}Sphingolipid Structure}
\end{figure}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org3b151af}Sphingolipid Biosynthesis}
\end{figure}
\end{enumerate}
\end{enumerate}

\subsection{Disorders of Sphingolipid Synthesis}
\label{sec:orgd36da57}
\begin{enumerate}
\item Classification
\label{sec:orgb84e45e}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:orgf3cebc9}
\begin{itemize}
...
\label{sec:org805c7c9}

\begin{table}[htbp]
\caption{\label{tab:org2933282}Sphingolipidoses}
\centering
\begin{tabular}{llll}
...
\caption{\label{fig:orgac7caf2}Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:orgec45525}
\begin{itemize}
...
\caption{\label{fig:orge2370bf}Protein Trafficking to Lysosome}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./figures/lysosome_trafficking.jpeg}
\caption[Lysosomal protein trafficking receptors]{\label{fig:org1d9e031}Lysosomal protein trafficking receptors}
\end{figure}

\begin{enumerate}
\item M6P receptors
\label{sec:org9e16fb1}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:org0ccb5ff}
\begin{enumerate}
\item Introduction
\label{sec:org6e3ae7e}
\begin{itemize}
...
\caption{\label{fig:org1d94b9c}Glucocerebroside the Gaucher Lipid}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{gaucher/figures/glucocerebrosidase.png}
\caption{\label{fig:org5b882ac}\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}

\item Genetics
\label{sec:orgb65a64d}
\begin{itemize}
\item AR GBA
...
\label{sec:orgf3acf74}
\begin{itemize}
\item see table \ref{tab:org5c824dd}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org5c824dd}Gaucher Clinical Variants}
\centering
\begin{tabular}{llll}
...
\label{sec:org6e5aff6}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{gaucher/figures/Gaucher_Cells_with_Fibrillar_Appearing_Cytoplasm.jpg}
\caption{\label{fig:org4b9749a}Gaucher Cells in a bone marrow smear}
\end{figure}

\begin{enumerate}
\item Biochemistry
\label{sec:orgc290a79}
\begin{itemize}
...
\item Treatment
\label{sec:org5d2d74b}
\begin{enumerate}
\item Bone marrow transplantation
\label{sec:orge38d438}
\begin{itemize}
...
\label{sec:org2cdf774}
\begin{enumerate}
\item Introduction
\label{sec:orge60fe6d}
\begin{itemize}
...
\caption{\label{fig:org71e7495}Sphingomyelin}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{niemann_pick/figures/sphingomyelinase.png}
\caption{\label{fig:org4ee3f63}Sphingomyelinase}
\end{figure}

\item Genetics
\label{sec:org5f1c7c7}
\begin{itemize}
\item AR, SMPD1
...
\item Clinical Findings
\label{sec:orgbd07216}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:orgdba8515}
\begin{itemize}
...
\end{itemize}
\item foam cells in bone marrow (Figure \ref{fig:orga6ea934})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{niemann_pick/figures/foam_cells.png}
\caption{\label{fig:orga6ea934}Foam cells in bone marrow}
\end{figure}

\item Treatment
\label{sec:org52baadb}
\begin{itemize}
...
\label{sec:org179ff98}
\begin{enumerate}
\item Introduction
\label{sec:orgaebfb15}
\begin{itemize}
\item defect in \textbf{\(\beta\)-galactosidase (AKA: \(\beta\)-gangliosidase)}
\begin{itemize}
\item removes galactose from GM1, keratin sulfate and some oligosaccharides (Figure \ref{fig:org095dd14})
\end{itemize}
...
\caption{\label{fig:org095dd14}\(\beta\)-galactosidase}
\end{figure}


\begin{enumerate}
\item Lysosomal multi-enzyme complex
\label{sec:org38fabd1}
\begin{itemize}
...
\begin{itemize}
\item ML-1 (sialidosis) (section \ref{sec:org490f227})
\end{itemize}
\end{itemize}
\end{enumerate}

\item Genetics
\label{sec:org3531e4d}
\begin{itemize}
\item AR GLB1
...
\item Clinical Findings
\label{sec:orgb2f7178}
\begin{itemize}
\item see table \ref{tab:org5766c48}
\item a cause of non-immune fetal hydrops
\end{itemize}
\begin{table}[htbp]
\caption[GM1 Signs and Symptoms]{\label{tab:org5766c48}GM1 Signs and Symptoms}
\centering
\begin{tabular}{lllll}
...
coarse facial features & \textpm{} & - & - & \textsuperscript{\ref{org9b5309c}}\\
skeletal findings & + & \textpm{} & - & +\\
urine & \footnotemark & \textsuperscript{\ref{orgf602ac6}} & \textsuperscript{\ref{orgf602ac6}} & keratan sulfate \footnotemark\\
\end{tabular}
\end{table}\footnotetext[1]{\label{org97fa083}corneal clouding}\footnotetext[2]{\label{org9b5309c}secondary to bony changes}\footnotetext[3]{\label{orgf602ac6}oligosacaride with terminal galactose}\footnotetext[4]{\label{org9a32c70}FN have been observed}
\item Laboratory Investigations
\label{sec:org7ef3de9}
\begin{itemize}
...
and \(\beta\) subunits (Table \ref{tab:org6ee1d58})
\end{itemize}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org6ee1d58}Hexoaminidase Isozymes}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:orgb2f97a8}GM2 ganglioside storage diseases}
\centering
\begin{tabular}{llrll}
...
\caption{\label{fig:org3105af4}Hexosaminidase A: Tay-Sachs}
\end{figure}
...
\caption{\label{fig:orgd45ce1d}Hexosaminidase A \& B:Sandhoff disease [fn:gl]}
\end{figure}

\item Genetics
\label{sec:org66bd63c}
\begin{itemize}
...
\item Clinical Findings
\label{sec:orgcfca467}
\begin{itemize}
\item see table \ref{tab:orge9e9c9e}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orge9e9c9e}GM2 Signs and Symptoms}
\centering
\begin{tabular}{llll}
...
\end{enumerate}
\subsection{Krabbe}
\label{sec:orgdc0c3e7}
\begin{enumerate}
\item Introduction
\label{sec:orgc5694d2}
\begin{itemize}
...
\caption{\label{fig:org717895d}Galactocerebrosidase}
\end{figure}
...
\caption{\label{fig:org85e71d2}NBS follow-up at Mayo}
\end{figure}
...
\begin{enumerate}
\item Treatment
\label{sec:org5d1ce9d}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:org1d207d1}
\begin{itemize}
...
\label{sec:org70660f0}
\begin{enumerate}
\item Introduction
\label{sec:orgdb23cfa}
\begin{itemize}
...
\item Clinical
\label{sec:org8f99c79}
\begin{itemize}
\item three forms: late infantile-onset, juvenile and adult
\item variants include:
\begin{itemize}
\item saposin B deficiency
\item multiple sulphatase deficiency (see Section \ref{sec:orgacb588c})
\end{itemize}
\end{itemize}
\begin{enumerate}
\item Late-infantile
\label{sec:org8c4bf9e}
\begin{itemize}
...
\end{enumerate}
\subsection{Fabry}
\label{sec:org73f514a}
\begin{enumerate}
\item Introduction
\label{sec:orgf330239}
\begin{itemize}
...
(Figure \ref{fig:org5b882ac})
\item accumulation of Gb3 in blood vessels and other tissues
\begin{itemize}
\item Gb3 is the Fabry lipid (Figure \ref{fig:org8fbff3d})
\end{itemize}
...
\caption[Globotriaosylceramide]{\label{fig:org8fbff3d}Globotriaosylceramide (Gb3): the Fabry lipid}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\textwidth]{fabry/figures/galactosidaseA.png}
\caption[\(\alpha\)-galactosidase A]{\label{fig:orgdf04e0c}\(\alpha\)-galactosidase A, located in the lumen of lysosomes}
\end{figure}

\item Genetics
\label{sec:orgcfa29b3}
\begin{itemize}
\item \textbf{XL GLA}
...
\item Clinical Findings
\label{sec:org97df20f}
\begin{itemize}
\item see table \ref{tab:org06d4941}
...
\item ocular lesions
\item angiokeratomas (Figure \ref{fig:orgb74cafe})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org06d4941}Fabry Signs and Symptoms}
\centering
\begin{tabular}{ll}
Age & Signs\\
\hline
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org4e0f26c}induced by heat, cold, fatigue or emotional stress}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{fabry/figures/angiokeratomas.png}
\caption[Angiokeratomas of the skin]{\label{fig:orgb74cafe}Angiokeratomas of the skin}
\end{figure}

\item Laboratory Investigations
\label{sec:org9cf41b1}
\begin{enumerate}
\item Biochemistry
\label{sec:org4812bc0}
\begin{itemize}
...
\caption[Fabry EM]{\label{fig:org626998a}EM showing concentric or lamellar structure of lysosomal inclusions in Fabry disease renal biopsy}
\end{figure}
\end{enumerate}

\item Treatment
\label{sec:org9f76476}
\begin{itemize}
\item alleviate pain
\begin{itemize}
...
\end{enumerate}
\subsection{Farber}
\label{sec:orga23d6c2}
\begin{enumerate}
\item Introduction
\label{sec:orga7f0ace}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org4b0eab1}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\item Clinical
\label{sec:org9f9dedd}
\begin{itemize}
...
\item Treatment
\label{sec:org561b03c}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\section{Niemann-Pick C}
\label{sec:org881069a}
\subsection{Introduction}
\label{sec:org4b3bd4d}
\begin{itemize}
...
\caption{\label{fig:org28916cc}Cholesterol Transport}
\end{figure}

\begin{enumerate}
\item NPC1 \& NPC2
\label{sec:orgd8485b5}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{niemann_pick/figures/Niemann-Pick-C-Brown-and-Goldstein.png}
\caption{\label{fig:org2779d17}NPC1 \& NPC2}
\end{figure}
...
\label{sec:org9a501fb}
\begin{enumerate}
\item Early Infantile
\label{sec:org1e44c45}
\begin{itemize}
...
\caption{\label{fig:org2b949a4}Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:org83d4c61}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:org6c3a2dc}
\subsection{Introduction}
\label{sec:org60143b4}
\begin{itemize}
...
\caption[Proteoglycan Synthesis]{\label{fig:orge35c202}Proteoglycan Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{mps/figures/snfg.png}
\caption[Glycan Nomenclature]{\label{fig:org5822acf}Symbol Nomenclature for Glycans (SNFG)}
\end{figure}
...
\caption[Glycosaminoglycans]{\label{fig:org023e194}Glycosaminoglycans}
\end{figure}

\begin{itemize}
\item GAGs are composed of repeating units of disaccharides (Figure \ref{fig:org023e194})
\begin{itemize}
...
\caption[DS Degradation]{\label{fig:org07ee812}DS degradation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{mps/figures/ks_degradation_disorders.png}
\caption[KS Degradation]{\label{fig:org10f1237}KS degradation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{mps/figures/hs_degradation_disorders.png}
\caption[HS Degradation]{\label{fig:orgbd33714}HS Degradation}
\end{figure}
\end{enumerate}

\subsection{Multiple sulfatase deficiency}
\label{sec:org2ba8e1e}
\begin{itemize}
...
\label{sec:orga8b6b83}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5efd2fd}
\begin{itemize}
...
\label{sec:org86d82af}
\begin{itemize}
\item MPS III (Sanfilippo)
\end{itemize}
\item Severe skeletal dysplasia
\label{sec:org44f39d3}
\begin{itemize}
\item MPS IV (Morquio)
\end{itemize}
\item Rare
\label{sec:orgda60605}
\begin{itemize}
\item MPS VII (Sly)
...
\begin{table}[htbp]
\caption{\label{tab:org1849410}MPS Signs and Symptoms}
\centering
...
\caption[Glycosaminoglycan Degradation]{\label{fig:org3dd79d6}Glycosaminoglycan Degradation}
\end{figure}


\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:org0108d8d}MPS Enzymes and Substrates}
\centering
\begin{tabular}{lllll}
...
\item Diagnostic Tests
\label{sec:org47ed1c7}
\begin{itemize}
\item quantitation of urine GAGs (Table \ref{tab:org0108d8d})
\begin{itemize}
...
\label{sec:org8491673}
\subsection{Introduction}
\label{sec:org520738a}
\begin{itemize}
...
\caption{\label{fig:org77d4158}Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Oligosaccharidoses}
\label{sec:org40a36db}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8051a7e}
\begin{itemize}
\item oligosaccharidoses share many features in common with MPS disorders (Table \ref{tab:org0fa1bdc})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org0fa1bdc}Oligosaccharidoses}
\centering
...
\item Genetics
\label{sec:org424ea27}
\begin{itemize}
\item AR
\end{itemize}
\item Diagnostic Tests
\label{sec:org608e276}
\begin{itemize}
...
\item enzyme activity assays (Table \ref{tab:org0fa1bdc})
\end{itemize}

\item Treatment
\label{sec:org872f76c}
\begin{itemize}
\item supportive
\end{itemize}
\end{enumerate}
\section{Mucolipidoses}
\label{sec:org490f227}
\subsection{Introduction}
\label{sec:org219e832}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgf2c38ac}Mucolipidoses}
\centering
\begin{tabular}{lllllll}
Disease & enzyme & dysostosis & progressive & angio- & hepato & sample\\
 &  & multiplex & cognitive & keratoma & -splenomegally & \\
...
\label{sec:org95f02f5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd53abd9}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgbc49b41}
\begin{enumerate}
\item ML II
\label{sec:org13fda77}
\begin{itemize}
\item low IQ
...
\begin{table}[htbp]
\caption{\label{tab:org9d3d8e8}Lysosomal enzyme receptors}
\centering
\begin{tabular}{lll}
...
\caption[Protein trafficking to lysosomes]{\label{fig:orgfe14f1c}Protein trafficking to lysosomes}
\end{figure}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org63f4786}N-acetylglucosamine (GlcNAc) phosphotransferase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[height=0.5\textwidth]{mucolipidosis/figures/icell.png}
\caption{\label{fig:orgc8b652a}I cell in fibroblast culture}
\end{figure}

\item Genetics
\label{sec:orge923564}
\begin{itemize}
\item AR GNPTAB
\end{itemize}

\item Diagnostic Tests
\label{sec:orgadd8293}
\begin{itemize}
...
\item Treatment
\label{sec:org4d5cca6}
\begin{itemize}
\item supportive
\end{itemize}
\end{enumerate}
\subsection{ML IV}
\label{sec:org0c3378a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org7f2946c}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org9e9481e}
\begin{itemize}
\item AR MCOLN1
\end{itemize}
\item Diagnostic Tests
\label{sec:orgb4113c2}
\begin{itemize}
...
\section{Peroxisomes}
\label{sec:orga594eba}
\subsection{Introduction}
\label{sec:org778b4b8}
\begin{itemize}
...
\caption[Non-mitochondrial FA metabolism]{\label{fig:org6ea3a67}Non-mitochondrial FA metabolism}
\end{figure}
...
\label{sec:orgdb0f398}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1eb6f69}
\begin{itemize}
\item three forms:
\begin{enumerate}
...
\item Genetics
\label{sec:org1a5536e}
\begin{itemize}
\item X-linked ABCD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org6a0e2bb}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9d6cc7e}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:org05c4eca}
\begin{itemize}
...
\label{sec:org57bddc3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org03e3092}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:orgf22364f}Oxidation of Phytanic Acid}
\end{figure}

\item Genetics
\label{sec:org2e32b1f}
\begin{itemize}
\item AR PHYH
\end{itemize}

\item Diagnostic Tests
\label{sec:orgb0721d1}
\begin{itemize}
...
\label{sec:org13f2e0f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgfe1e5c6}
\begin{itemize}
...
\item Genetics
\label{sec:orgca4aa3d}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\item Diagnostic Tests
\label{sec:org436bf85}
\begin{itemize}
...
\label{sec:org411409f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge679fa3}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org7499b3e}
\begin{enumerate}
\item RCDP Type 1
\label{sec:org1f4a96d}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:orga6c2f9e}
\begin{itemize}
\item \(\downarrow\) RBC plasmalogens
\end{itemize}
\begin{enumerate}
\item RDCP1
\label{sec:org07be255}
\begin{itemize}
...
\caption{\label{fig:org0c751ab}Eicosanoid Metabolism}
\end{figure}

\begin{enumerate}
\item Disorders
\label{sec:orgbb0aa80}
\begin{itemize}
...
\label{sec:orgf88adb5}
\subsection{Introduction}
\label{sec:org2dcf4a2}
\begin{itemize}
...
\caption{\label{fig:orgf077a7a}CDGs}
\end{figure}

\item Congenital Disorders of Glycosylation
\label{sec:orgeb4df2b}
\begin{itemize}
...
\caption{\label{fig:orgd989f70}CDG diagnosis}
\end{figure}
\end{enumerate}

\subsection{PMM2-CDG (CDG Ia)}
\label{sec:org609bd25}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgeda4b8b}
\begin{itemize}
...
\item Genetics
\label{sec:org0936666}
\begin{itemize}
\item AR, PMM2
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf8b615f}
\begin{itemize}
...
\label{sec:org7fb96af}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb5bcdb5}
\begin{itemize}
...
\item Genetics
\label{sec:org2cc3868}
\begin{itemize}
\item AR, MPI
\end{itemize}

\item Diagnostic Tests
\label{sec:org85adcad}
\begin{itemize}
...
\label{sec:org1f49b90}
\begin{enumerate}
\item MGAT2-CDG (CDG IIa)
\label{sec:org20cd807}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1d76744}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org5d613f8}
\begin{itemize}
\item AR MGAT2
\end{itemize}
\item Diagnostic Tests
\label{sec:orgce940b9}
\begin{itemize}
...
\item Treatment
\label{sec:orgcb231c4}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\item SLC35C1-CDG (CDG IIc)
\label{sec:org08b7c64}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org58c61d7}
\begin{itemize}
...
neutrophilia
\item Bombay (hh) blood phenotype (Figure \ref{fig:org5767e97})
\begin{itemize}
\item do not express H antigen
\end{itemize}
\end{itemize}
\item Metabolic Derangement
\label{sec:org73ae610}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org4793934}
\begin{itemize}
\item AR SLC35C1
\end{itemize}

\item Diagnostic Tests
\label{sec:orge06509b}
\begin{itemize}
\item normal transferrin IEF
\item molecular
\end{itemize}
\item Treatment
\label{sec:orgb1f911c}
\begin{itemize}
...
\caption[Hh]{\label{fig:org5767e97}Hh Blood Group}
\end{figure}
\end{enumerate}
\end{enumerate}
\section{Cystinosis}
\label{sec:orgcf99e55}
\subsection{Introduction}
\label{sec:org4d202d6}
\begin{itemize}
...
\caption{\label{fig:org273cbff}Lysosomal export of cystine and related compounds. The cross represents the defect in cystinosis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.2\textwidth]{cystinosis/figures/cystine.png}
\caption{\label{fig:orgb050707}Cystine}
\end{figure}
...
marrow
\end{enumerate}
\item nephropathic or infantile form is by far the most frequent (see \ref{sec:orgf8b49fa})
...
\label{sec:orgf8b49fa}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb9661e3}
\begin{enumerate}
\item First stage
\label{sec:orge23e32b}
\begin{itemize}
...
\label{sec:org11307ae}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org58147e1}
\begin{itemize}
...
\item Genetics
\label{sec:org8f722d2}
\begin{itemize}
\item AR, CTNS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgee3f9a2}
\begin{itemize}
...
\item Treatment
\label{sec:org4f10d2c}
\begin{enumerate}
\item Supportive
\label{sec:orgd93a219}
\begin{itemize}
