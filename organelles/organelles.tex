...
\label{sec:org5214129}
\subsection{Introduction}
\label{sec:org904d9a8}
\subsubsection{Sphingolipids}
\label{sec:org0a7067f}
\begin{itemize}
...
\label{sec:orgbc91c2b}
\begin{enumerate}
\item ER
\label{sec:org80c1498}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:org8e42094}Sphingolipid Structure}
\end{figure}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org3a0dea9}Sphingolipid Biosynthesis}
\end{figure}
\end{enumerate}

\subsection{Disorders of Sphingolipid Synthesis}
\label{sec:orgec87e0d}
\subsubsection{Classification}
\label{sec:orgfde91ae}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org4c9e060}
\begin{description}
...
\caption{\label{fig:org9ea488d}Protein Trafficking to Lysosome}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./figures/lysosome_trafficking.jpeg}
\caption[Lysosomal protein trafficking receptors]{\label{fig:orgc7ab7b0}Lysosomal protein trafficking receptors}
\end{figure}

\subsubsection{M6P receptors}
\label{sec:org0269b25}
\begin{itemize}
...
\label{sec:orgc0e40b1}
\subsubsection{Introduction}
\label{sec:org4e96b6b}
\begin{itemize}
...
\caption{\label{fig:orgdbfa416}Sphingomyelin}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{niemann_pick/figures/sphingomyelinase.png}
\caption{\label{fig:orgc40393f}Sphingomyelinase}
\end{figure}

\subsubsection{Clinical Findings}
\label{sec:orgc48181a}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:orgc6fd2ff}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orga9d1657}corneal clouding}\footnotetext[2]{\label{orge3359f3}secondary to bony changes}\footnotetext[3]{\label{org4a25ee8}oligosacaride with terminal galactose}\footnotetext[4]{\label{orgff0f76b}FN have been observed}
...
\begin{table}[htbp]
\caption{\label{tab:orga59e81b}Hexoaminidase Isozymes}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:org19d0002}GM2 ganglioside storage diseases}
\centering
\begin{tabular}{llrll}
...
\begin{enumerate}
\item Treatment
\label{sec:org4b1f7be}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:orgc339399}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{orge81b173}induced by heat, cold, fatigue or emotional stress}
...
\end{itemize}
\subsection{Farber}
\label{sec:org5a3ac3b}
\subsubsection{Introduction}
\label{sec:orgc01a9f1}
\begin{itemize}
...
\caption[Proteoglycan Synthesis]{\label{fig:orga3de190}Proteoglycan Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{mps/figures/snfg.png}
\caption[Glycan Nomenclature]{\label{fig:org560efe8}Symbol Nomenclature for Glycans (SNFG)}
\end{figure}
...
\caption[Glycosaminoglycans]{\label{fig:orgab12913}Glycosaminoglycans}
\end{figure}

\begin{itemize}
\item GAGs are composed of repeating units of disaccharides (Figure \ref{fig:orgab12913})
\begin{itemize}
...
\caption[DS Degradation]{\label{fig:org3eceb12}DS degradation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{mps/figures/ks_degradation_disorders.png}
\caption[KS Degradation]{\label{fig:orgc431bc6}KS degradation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{mps/figures/hs_degradation_disorders.png}
\caption[HS Degradation]{\label{fig:orgd6a2703}HS Degradation}
\end{figure}
\end{enumerate}
...
\label{sec:org938aa18}
\subsection{Introduction}
\label{sec:org11879ff}
\begin{itemize}
...
\caption{\label{fig:org234e0a0}Glycoprotein Oligosaccharide Chain}
\end{figure}
...
\subsubsection{Treatment}
\label{sec:org26d88a3}
\begin{itemize}
\item supportive
\end{itemize}

\subsection{ML II \& III}
\label{sec:org4675ed3}
\begin{itemize}
\item ML II AKA: I-Cell Disease
\item ML III AKA: Pseudo-Hurler
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgccb1c3b}
\begin{enumerate}
\item ML II
\label{sec:org7a5234a}
\begin{itemize}
\item low IQ
...
\begin{table}[htbp]
\caption{\label{tab:orgc0a1b20}Lysosomal enzyme receptors}
\centering
\begin{tabular}{lll}
...
\caption[Protein trafficking to lysosomes]{\label{fig:orgb378982}Protein trafficking to lysosomes}
\end{figure}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:orgb9bbff6}N-acetylglucosamine (GlcNAc) phosphotransferase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[height=0.5\textwidth]{mucolipidosis/figures/icell.png}
\caption{\label{fig:org7119c55}I cell in fibroblast culture}
\end{figure}

\subsubsection{Genetics}
\label{sec:orgce98324}
\begin{itemize}
\item AR GNPTAB
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgfcc053c}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org2b80f02}
\begin{itemize}
\item supportive
\end{itemize}
\subsection{ML IV}
\label{sec:orged1cb37}
\subsubsection{Clinical Presentation}
\label{sec:org7df84f6}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org1373662}
\begin{itemize}
\item AR MCOLN1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org2c440e2}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgb2777f5}Biochemical Findings in Peroxisomal Disease}
\centering
\begin{tabular}{llllll}
...
\subsubsection{Clinical Presentation}
\label{sec:org7292bee}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:org200ed07}
\begin{itemize}
...
\label{sec:org1a16c20}
\subsubsection{Clinical Presentation}
\label{sec:orgc72b889}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga03162f}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3b9667e}
\begin{itemize}
...
\caption{\label{fig:orgd7b1312}CDGs}
\end{figure}
...
\end{enumerate}
\section{Cystinosis}
\label{sec:orge4d4d48}
\subsection{Introduction}
\label{sec:org6c44d46}
\begin{itemize}
...
\caption{\label{fig:org960ae88}Cystine}
\end{figure}

\begin{itemize}
\item normally exported by a cystine porter which contains the membrane protein cystinosin (Figure \ref{fig:org539d451})
\begin{itemize}
...
\caption{\label{fig:org539d451}Lysosomal export of cystine and related compounds. The cross represents the defect in cystinosis}
\end{figure}
...
marrow
\end{enumerate}
\item nephropathic or infantile form is by far the most frequent (Section \ref{sec:org7e6d9f1})
...
\label{sec:org7e6d9f1}
\subsubsection{Clinical Presentation}
\label{sec:orgb8c7b50}
\begin{enumerate}
\item First stage
\label{sec:org7c300e7}
\begin{itemize}
...
\label{sec:orgcc7e2de}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org0fabbcb}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org2325c42}
\begin{enumerate}
\item Supportive
\label{sec:org5e0f4bd}
\begin{itemize}
