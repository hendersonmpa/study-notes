...
\label{sec:orgde4fb33}
\subsection{Introduction}
\label{sec:orga0762b8}
\begin{enumerate}
\item Sphingolipids
\label{sec:org8de245c}
\begin{itemize}
...
\item Biosynthesis
\label{sec:orge7fe2c0}
\begin{enumerate}
\item ER
\label{sec:org064db09}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:orgddd9b63}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org1ba8dc9}
...
\label{sec:orgf8a0526}
\begin{enumerate}
\item Classification
\label{sec:org7662511}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org1ba2b07}
\begin{itemize}
...
\label{sec:orga294367}

\begin{table}[htbp]
\caption{\label{tab:orgeb32e81}
...
\caption{\label{fig:orge48c78c}
Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:orgff20ca9}
\begin{itemize}
...
\caption[Lysosomal protein trafficking receptors]{\label{fig:orga17e5b6}
Lysosomal protein trafficking receptors}
\end{figure}

\begin{enumerate}
\item M6P receptors
\label{sec:org824d51b}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:org492d6be}
\begin{enumerate}
\item Introduction
\label{sec:orge542a33}
\begin{itemize}
...
\caption{\label{fig:org0788b85}
\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}

\item Genetics
\label{sec:org896c0b2}
\begin{itemize}
\item AR GBA
...
\label{sec:org915cac3}
\begin{itemize}
\item see table \ref{tab:org5e18d14}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org5e18d14}
...
\item Treatment
\label{sec:org77c22d0}
\begin{enumerate}
\item bone marrow transplantation
\label{sec:org6be179e}
\begin{itemize}
...
\label{sec:orgb2f2114}
\begin{enumerate}
\item Introduction
\label{sec:org904f06b}
\begin{itemize}
...
\caption{\label{fig:org0dbbfcf}
Sphingomyelinase}
\end{figure}

\item Genetics
\label{sec:orga7de74d}
\begin{itemize}
\item AR, SMPD1
...
\item Clinical Findings
\label{sec:org392c3c9}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:orgb6e0740}
\begin{itemize}
...
\end{itemize}
\item foam cells in bone marrow (Figure \ref{fig:org37916fd})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{./niemann_pick/figures/foam_cells.png}
\caption{\label{fig:org37916fd}
Foam cells in bone marrow}
\end{figure}

\item Treatment
\label{sec:orgcaaf568}
\begin{itemize}
...
\label{sec:orge380ad7}
\begin{enumerate}
\item Introduction
\label{sec:org0f1ad28}
\begin{itemize}
\item defect in \textbf{\(\beta\)-galactosidase (AKA: \(\beta\)-gangliosidase)}
\begin{itemize}
\item removes galactose from GM1, keratin sulfate and some oligosaccharides (Figure \ref{fig:orgebbece1})
\end{itemize}
...
\begin{itemize}
\item ML-1 (sialidosis) (section \ref{sec:orgdd40dd4})
\end{itemize}
\end{itemize}
\end{enumerate}

\item Genetics
\label{sec:org378752a}
\begin{itemize}
\item AR GLB1
...
\item Clinical Findings
\label{sec:orgf46ddbe}
\begin{itemize}
\item see table \ref{tab:orgb461805}
\item a cause of non-immune fetal hydrops
\end{itemize}
\begin{table}[htbp]
\caption[GM1 Signs and Symptoms]{\label{tab:orgb461805}
...
coarse facial features & \textpm{} & - & - & \textsuperscript{\ref{org00113e8}}\\
skeletal findings & + & \textpm{} & - & +\\
urine & \footnotemark & \textsuperscript{\ref{orge923c66}} & \textsuperscript{\ref{orge923c66}} & keratan sulfate \footnotemark\\
\end{tabular}
\end{table}\footnotetext[1]{\label{org35f9b05}corneal clouding}\footnotetext[2]{\label{org00113e8}secondary to bony changes}\footnotetext[3]{\label{orge923c66}oligosacaride with terminal galactose}\footnotetext[4]{\label{orgc83b664}FN have been observed}
\item Laboratory Investigations
\label{sec:org8582794}
\begin{itemize}
...
and \(\beta\) subunits (Table \ref{tab:org0ff01ad})
\end{itemize}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org0ff01ad}
...
\caption{\label{fig:org0c049db}
Hexosaminidase A \& B:Sandhoff disease}
\end{figure}

\item Genetics
\label{sec:org68b4f28}
\begin{itemize}
...
\item Clinical Findings
\label{sec:org395c197}
\begin{itemize}
\item see table \ref{tab:orgf769ed9}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orgf769ed9}
...
\end{enumerate}
\subsection{Krabbe}
\label{sec:org6a7ba8a}
\begin{enumerate}
\item Introduction
\label{sec:org7495ce2}
\begin{itemize}
...
\begin{enumerate}
\item Treatment
\label{sec:orgc851cb0}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:org79d281f}
\begin{itemize}
...
\label{sec:org20dc7fd}
\begin{enumerate}
\item Introduction
\label{sec:orge752e2b}
\begin{itemize}
...
\item multiple sulphatase deficiency (Section \ref{sec:org79b83a8})
\end{itemize}
\end{itemize}
\begin{enumerate}
\item Late-infantile
\label{sec:org88da70f}
\begin{itemize}
...
\end{enumerate}
\subsection{Fabry}
\label{sec:org27e7372}
\begin{enumerate}
\item Introduction
\label{sec:org0933a01}
\begin{itemize}
...
(Figure \ref{fig:org0788b85})
\item accumulation of Gb3 in blood vessels and other tissues
\item globotriaosylceramide (Gb3): the Fabry lipid (Figure \ref{fig:org53d6daf})
...
\caption[Globotriaosylceramide]{\label{fig:org53d6daf}
...
\caption[\(\alpha\)-galactosidase A]{\label{fig:org4f160ab}
\(\alpha\)-galactosidase A, located in the lumen of lysosomes}
\end{figure}

\item Genetics
\label{sec:org6f67b38}
\begin{itemize}
\item \textbf{XL GLA}
...
\item Clinical Findings
\label{sec:orga7562c3}
\begin{itemize}
\item see table \ref{tab:org88dce15}
...
\item ocular lesions
\item angiokeratomas (Figure \ref{fig:org41148b7})
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org088ff3c}induced by heat, cold, fatigue or emotional stress

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fabry/figures/angiokeratomas.png}
\caption[Angiokeratomas of the skin]{\label{fig:org41148b7}
Angiokeratomas of the Skin}
\end{figure}}

\item Laboratory Investigations
\label{sec:org9c6b051}
\begin{enumerate}
\item Biochemistry
\label{sec:org0d619a9}
\begin{itemize}
...
\end{enumerate}
\subsection{Farber}
\label{sec:org703f13c}
\begin{enumerate}
\item Introduction
\label{sec:org21d12cc}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org6900ab2}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\item Clinical
\label{sec:org4e11575}
\begin{itemize}
...
\item Treatment
\label{sec:orgff7723b}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\section{Niemann-Pick C}
\label{sec:orgf3bdf41}
\subsection{Introduction}
\label{sec:orgdddded3}
\begin{itemize}
...
\label{sec:org3b61699}
\begin{enumerate}
\item Early Infantile
\label{sec:org550a889}
\begin{itemize}
...
\caption{\label{fig:org31b1618}
Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:org84bb711}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:org6a3c7df}
\subsection{Introduction}
\label{sec:org933fc97}
\begin{itemize}
...
\label{sec:org79b83a8}
\subsection{Introduction}
\label{sec:org9af4890}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./mps/figures/ch17f01.jpg}
\caption[Proteoglycans]{\label{fig:org551282f}
Proteoglycans}
\end{figure}
...
\caption[Proteoglycan Synthesis]{\label{fig:org167df09}
...
\caption[Glycan Nomenclature]{\label{fig:org89c5487}
...
\caption[Glycosaminoglycans]{\label{fig:org766b455}
Glycosaminoglycans}
\end{figure}

\begin{itemize}
\item GAGs are composed of repeating units of disaccharides (Figure \ref{fig:org766b455})
\begin{itemize}
...
\caption[DS Degradation]{\label{fig:orgcc4498a}
DS degradation}
\end{figure}
...
\caption[KS Degradation]{\label{fig:org32dcc30}
KS degradation}
\end{figure}
...
\caption[HS Degradation]{\label{fig:orgb77a4cd}
HS Degradation}
\end{figure}
\end{enumerate}

\subsection{Multiple sulfatase deficiency}
\label{sec:orge8d33c2}
\begin{itemize}
...
\label{sec:org1b8f884}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org252d5f9}
\begin{itemize}
...
\label{sec:org57bb343}
\begin{itemize}
\item MPS III (Sanfilippo)
\end{itemize}
\item Severe Skeletal Dysplasia
\label{sec:org5ab5766}
\begin{itemize}
\item MPS IV (Morquio)
\end{itemize}
\item Rare
\label{sec:org36d5bcb}
\begin{itemize}
\item MPS VII (Sly)
...
\caption[Glycosaminoglycan Degradation]{\label{fig:org99d1718}
Glycosaminoglycan Degradation}
\end{figure}

\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:org9606055}
...
\item Diagnostic Tests
\label{sec:org50b74af}
\begin{itemize}
\item quantitation of urine GAGs (Table \ref{tab:org9606055})
\begin{itemize}
...
\label{sec:org6de0981}
\subsection{Introduction}
\label{sec:orgbc8a059}
...
\caption{\label{fig:orgdccf5d3}
Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Oligosaccharidoses}
\label{sec:org965d38b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8434bc6}
\begin{itemize}
\item oligosaccharidoses share many features in common with MPS disorders (Table \ref{tab:org01e6e06})
\begin{itemize}
...
\item Genetics
\label{sec:org8fa7ade}
\begin{itemize}
\item AR
\end{itemize}
\item Diagnostic Tests
\label{sec:orgf800386}
\begin{itemize}
...
\item enzyme activity assays (Table \ref{tab:org01e6e06})
\end{itemize}

\item Treatment
\label{sec:org8adc9db}
\begin{itemize}
\item supportive
\end{itemize}
\end{enumerate}
\section{Mucolipidoses}
\label{sec:orgdd40dd4}
\subsection{Introduction}
\label{sec:orgc1556f5}
\begin{itemize}
...
\label{sec:orga0a0449}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8b2df19}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf81e3c7}
\begin{enumerate}
\item ML II
\label{sec:orge27dadc}
\begin{itemize}
\item low IQ
...
\caption[Protein trafficking to lysosomes]{\label{fig:orgdfca626}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org72412d4}
...
\caption{\label{fig:org314727e}
I cell in fibroblast culture}
\end{figure}

\item Genetics
\label{sec:org75555a1}
\begin{itemize}
\item AR GNPTAB
\end{itemize}

\item Diagnostic Tests
\label{sec:org668964f}
\begin{itemize}
...
\item Treatment
\label{sec:orgbc03b4c}
\begin{itemize}
\item supportive
\end{itemize}
\end{enumerate}
\subsection{ML IV}
\label{sec:org019af95}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1791c61}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:orgcde66c1}
\begin{itemize}
\item AR MCOLN1
\end{itemize}
\item Diagnostic Tests
\label{sec:orgaf6fa1c}
\begin{itemize}
...
\section{Peroxisomes}
\label{sec:org659cdb8}
\subsection{Introduction}
\label{sec:org696edbf}
\begin{itemize}
...
\caption[Non-mitochondrial FA metabolism]{\label{fig:org8678af7}
...
\label{sec:org375e4fd}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd603d79}
\begin{itemize}
\item three forms:
\begin{enumerate}
...
\item Genetics
\label{sec:orgb9b1c3b}
\begin{itemize}
\item X-linked ABCD1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgcf78007}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgdff7b54}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:orgc30a91e}
\begin{itemize}
...
\label{sec:org2d58833}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org7f3c363}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org92c31a2}
Oxidation of Phytanic Acid}
\end{figure}

\item Genetics
\label{sec:org6851afe}
\begin{itemize}
\item AR PHYH
\end{itemize}

\item Diagnostic Tests
\label{sec:org63a7b79}
\begin{itemize}
...
\label{sec:org3713ea5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgac0bd03}
\begin{itemize}
...
\item Genetics
\label{sec:org9cbf204}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf744fa8}
\begin{itemize}
...
\label{sec:org7bfe7bf}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga9913f3}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org29e7bf7}
\begin{enumerate}
\item RCDP Type 1
\label{sec:org019ed4b}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org71ab322}
\begin{itemize}
\item \(\downarrow\) RBC plasmalogens
\end{itemize}
\begin{enumerate}
\item RDCP1
\label{sec:org4bcc440}
\begin{itemize}
...
\caption{\label{fig:org29e4466}
Eicosanoid Metabolism}
\end{figure}

\begin{enumerate}
\item Disorders
\label{sec:orgaadaa18}
\begin{itemize}
...
\label{sec:orgebeb2ca}
\subsection{Introduction}
\label{sec:orgb1dd08b}
\begin{itemize}
...
\caption{\label{fig:org4e09d50}
CDGs}
\end{figure}

\item Congenital Disorders of Glycosylation
\label{sec:orgceb5b2c}
\begin{itemize}
...
\caption{\label{fig:org3c6048f}
CDG diagnosis}
\end{figure}
\end{enumerate}

\subsection{PMM2-CDG (CDG Ia)}
\label{sec:org286efd3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org7d3781e}
\begin{itemize}
...
\item Genetics
\label{sec:orga84a8b2}
\begin{itemize}
\item AR, PMM2
\end{itemize}

\item Diagnostic Tests
\label{sec:orgc316922}
\begin{itemize}
...
\label{sec:orgac2fa42}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb81063d}
\begin{itemize}
...
\item Genetics
\label{sec:org20b51bc}
\begin{itemize}
\item AR, MPI
\end{itemize}

\item Diagnostic Tests
\label{sec:orgc54bcaf}
\begin{itemize}
...
\label{sec:orge598b08}
\begin{enumerate}
\item MGAT2-CDG (CDG IIa)
\label{sec:org6da6deb}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2fb6c24}
\begin{itemize}
\item onset in infancy, neonatal
...
\end{itemize}
\item Genetics
\label{sec:orga448815}
\begin{itemize}
\item AR MGAT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org0c8690e}
\begin{itemize}
...
\item Treatment
\label{sec:org6c44235}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\item SLC35C1-CDG (CDG IIc)
\label{sec:org9fbb45c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1b627c6}
\begin{itemize}
...
neutrophilia
\item Bombay (hh) blood phenotype (Figure \ref{fig:org1a8eabb})
\begin{itemize}
\item do not express H antigen
\end{itemize}
\end{itemize}
\item Metabolic Derangement
\label{sec:orgc611a7b}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org2196cb6}
\begin{itemize}
\item AR SLC35C1
\end{itemize}

\item Diagnostic Tests
\label{sec:orge02f190}
\begin{itemize}
\item normal transferrin IEF
\item molecular
\end{itemize}
\item Treatment
\label{sec:orgd076833}
\begin{itemize}
...
\caption[Hh]{\label{fig:org1a8eabb}
Hh Blood Group}
\end{figure}
\end{enumerate}
\end{enumerate}
\section{Cystinosis}
\label{sec:org90c7934}
\subsection{Introduction}
\label{sec:orgfe54434}
\begin{itemize}
...
marrow
\end{enumerate}
\item nephropathic or infantile form is by far the most frequent (see \ref{sec:org2c4c777})
...
\label{sec:org2c4c777}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org71b25ff}
\begin{enumerate}
\item First stage
\label{sec:org574d601}
\begin{itemize}
...
\label{sec:org05bd489}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org6a171e5}
\begin{itemize}
...
\item Genetics
\label{sec:org41cda50}
\begin{itemize}
\item AR, CTNS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd0a90ef}
\begin{itemize}
...
\item Treatment
\label{sec:org8bb0bee}
\begin{enumerate}
\item Supportive
\label{sec:org6b86634}
\begin{itemize}
