...
\label{sec:orgb926cf7}
\subsection{Introduction}
\label{sec:org4e91bf0}
\subsubsection{Sphingolipids}
\label{sec:orgc2480d8}
\begin{itemize}
...
\label{sec:org4f8e497}
\begin{enumerate}
\item ER
\label{sec:org734a002}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:org2eaf5fd}Sphingolipid Structure}
\end{figure}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org8d9f227}Sphingolipid Biosynthesis}
\end{figure}
\end{enumerate}

\subsection{Disorders of Sphingolipid Synthesis}
\label{sec:orgfde92bd}
\subsubsection{Classification}
\label{sec:org102100a}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org0a7ddfb}
\begin{description}
...
\label{sec:org07157bc}

\begin{table}[htbp]
\caption{\label{tab:orgb87a546}Sphingolipidoses}
\centering
\begin{tabular}{llll}
...
\caption{\label{fig:org4e2b53c}Sphingolipid Degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:org57c886a}
\begin{itemize}
...
\caption{\label{fig:org3ff1790}Protein Trafficking to Lysosome}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./figures/lysosome_trafficking.jpeg}
\caption{\label{fig:org87dbc58}Lysosomal Protein Trafficking Receptors}
\end{figure}

\subsubsection{M6P receptors}
\label{sec:org460ccf1}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:org63badb0}
\subsubsection{Introduction}
\label{sec:orgc1873ac}
\begin{itemize}
...
\label{sec:org39fcb15}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{gaucher/figures/Gaucher_Cells_with_Fibrillar_Appearing_Cytoplasm.jpg}
\caption{\label{fig:org8d0223a}Gaucher Cells in a Bone Marrow Smear}
\end{figure}

\begin{enumerate}
\item Biochemistry
\label{sec:org45c148b}
\begin{itemize}
...
\label{sec:orgdd77676}
\begin{enumerate}
\item Bone marrow transplantation
\label{sec:orgcd29f34}
\begin{itemize}
...
\label{sec:org8f9b366}
\subsubsection{Introduction}
\label{sec:org49786a4}
\begin{itemize}
...
\caption{\label{fig:org3ea6e09}Sphingomyelin}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{niemann_pick/figures/sphingomyelinase.png}
\caption{\label{fig:orgfc459f3}Sphingomyelinase}
\end{figure}

\subsubsection{Clinical Findings}
\label{sec:orge0894ac}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:orgd99f8e4}
\begin{itemize}
...
urine & \footnotemark & \textsuperscript{\ref{org91ab658}} & \textsuperscript{\ref{org91ab658}} & keratan sulfate \footnotemark\\
 &  &  &  & \\
\end{tabular}
\end{table}\footnotetext[1]{\label{orgef7d5e0}corneal clouding}\footnotetext[2]{\label{org9b44bc6}secondary to bony changes}\footnotetext[3]{\label{org91ab658}oligosacaride with terminal galactose}\footnotetext[4]{\label{org61d97ce}FN have been observed}
...
\begin{table}[htbp]
\caption{\label{tab:orgf9d62c1}Hexoaminidase Isozymes}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:org4ebeacb}GM2 ganglioside storage diseases}
\centering
\begin{tabular}{llrll}
...
\caption{\label{fig:org25c868c}Hexosaminidase A: Tay-Sachs}
\end{figure}
...
\caption{\label{fig:orge45bb68}Hexosaminidase A \& B:Sandhoff disease (GL-3 \& 4 equivalent to Gb3 \& 4)}
\end{figure}
...
\begin{itemize}
\item see table \ref{tab:org7e7f568}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:org7e7f568}GM2 Signs and Symptoms}
\centering
\begin{tabular}{llll}
...
\caption{\label{fig:org5b41de6}NBS Follow-up at Mayo}
\end{figure}
...
\begin{enumerate}
\item Treatment
\label{sec:org08fda32}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:org8568d41}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{orgdc818c1}induced by heat, cold, fatigue or emotional stress}
...
\end{itemize}
\subsection{Farber}
\label{sec:org0f96a00}
\subsubsection{Introduction}
\label{sec:org260e1a9}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgdd2ec51}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\subsubsection{Clinical}
\label{sec:org50103ce}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org717ce5c}
\begin{itemize}
\item none
\item HSCT trial with poor outcome
\end{itemize}
\section{Niemann-Pick C}
\label{sec:org575bb88}
\subsection{Introduction}
\label{sec:org6cd120a}
\begin{itemize}
...
\label{sec:orgabde48e}
\begin{enumerate}
\item Early Infantile
\label{sec:org7b675e9}
\begin{itemize}
...
\label{sec:org28f6ca5}
\subsection{Introduction}
\label{sec:org9cdac7d}
\begin{itemize}
...
\subsection{Genetics}
\label{sec:org3c5a458}
\begin{itemize}
\item AR
\item adult form is AD
\end{itemize}
\subsection{Diagnostic Tests}
\label{sec:orga8847ba}
\begin{itemize}
...
\caption[Proteoglycan Synthesis]{\label{fig:org50b3598}Proteoglycan Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{mps/figures/snfg.png}
\caption[Glycan Nomenclature]{\label{fig:org6b3444c}Symbol Nomenclature for Glycans (SNFG)}
\end{figure}
...
\caption[Glycosaminoglycans]{\label{fig:org75a4b65}Glycosaminoglycans}
\end{figure}

\begin{itemize}
\item GAGs are composed of repeating units of disaccharides (Figure \ref{fig:org75a4b65})
\begin{itemize}
...
\caption[DS Degradation]{\label{fig:org13b150d}DS degradation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{mps/figures/ks_degradation_disorders.png}
\caption[KS Degradation]{\label{fig:org8c19118}KS degradation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{mps/figures/hs_degradation_disorders.png}
\caption[HS Degradation]{\label{fig:orgf18c0a3}HS Degradation}
\end{figure}
\end{enumerate}
...
\label{sec:org64ce6a0}
\subsubsection{Clinical Presentation}
\label{sec:orgfe1bdcf}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgcc726c5}MPS Signs and Symptoms}
\centering
...
\caption[Glycosaminoglycan Degradation]{\label{fig:org109c908}Glycosaminoglycan Degradation}
\end{figure}


\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:org84b66f8}MPS Enzymes and Substrates}
\centering
\begin{tabular}{lllll}
...
\end{tabular}
\end{table}\footnotetext[6]{\label{org0c35232}\(\beta\)-galactosidase deficiency also causes GM1 gangliosidosis}

\subsubsection{Genetics}
\label{sec:orgbf5d635}
\begin{itemize}
\item AR
\item \textbf{MPS II Hunter is XLR}
\item see table \ref{tab:org84b66f8}
\end{itemize}
\subsubsection{Diagnostic Tests}
...
\label{sec:orge04b5fa}
\subsection{Introduction}
\label{sec:orga49b1a6}
\begin{itemize}
...
\caption{\label{fig:orged95a08}Glycoprotein Oligosaccharide Chain}
\end{figure}
...
\subsubsection{Treatment}
\label{sec:orge47e9b9}
\begin{itemize}
\item supportive
\end{itemize}

\subsection{ML II \& III}
\label{sec:orgd960938}
\begin{itemize}
\item ML II AKA: I-Cell Disease
\item ML III AKA: Pseudo-Hurler
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgdbbe740}
\begin{enumerate}
\item ML II
\label{sec:org01d7292}
\begin{itemize}
\item low IQ
...
\begin{table}[htbp]
\caption{\label{tab:orga0e4a24}Lysosomal enzyme receptors}
\centering
\begin{tabular}{lll}
...
\caption[Protein trafficking to lysosomes]{\label{fig:org34aa062}Protein trafficking to lysosomes}
\end{figure}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:orgc896484}N-acetylglucosamine (GlcNAc) phosphotransferase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[height=0.5\textwidth]{mucolipidosis/figures/icell.png}
\caption{\label{fig:org5f5047c}I cell in fibroblast culture}
\end{figure}

\subsubsection{Genetics}
\label{sec:org8961185}
\begin{itemize}
\item AR GNPTAB
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org995caa0}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org1b1b828}
\begin{itemize}
\item supportive
\end{itemize}
\subsection{ML IV}
\label{sec:orge9bd026}
\subsubsection{Clinical Presentation}
\label{sec:org9bb78c5}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgdc09ca0}
\begin{itemize}
\item AR MCOLN1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org268e712}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgb6bf060}
\begin{itemize}
\item supportive
\end{itemize}

\section{Peroxisomes}
\label{sec:org2589e97}
\subsection{Introduction}
\label{sec:orge3d0ab7}
\begin{itemize}
...
\caption{\label{fig:org77c5486}Non-Mitochondrial FA Metabolism}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:orgf0bc012}Biochemical Findings in Peroxisomal Disease}
\centering
\begin{tabular}{llllll}
...
\label{sec:orgadd0274}
\subsubsection{Clinical Presentation}
\label{sec:org2bd901c}
\begin{itemize}
\item three forms:
\begin{enumerate}
...
\subsubsection{Clinical Presentation}
\label{sec:org0a01b08}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:org10edf67}
\begin{itemize}
...
\label{sec:orged52f5c}
\subsubsection{Clinical Presentation}
\label{sec:org0b75389}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org308d5ef}Oxidation of Phytanic Acid}
\end{figure}
...
\label{sec:orgbf5b7e5}
\subsubsection{Clinical Presentation}
\label{sec:orgb71bc44}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0896a2d}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org215178d}
\begin{itemize}
...
\label{sec:orgd0d6c22}
\subsubsection{Clinical Presentation}
\label{sec:org5374c8a}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org018c66f}
\begin{enumerate}
\item RCDP Type 1
\label{sec:org2676f52}
\begin{itemize}
...
\caption{\label{fig:orgb262190}Eicosanoid Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org0707385}
\begin{itemize}
...
\label{sec:org49d0052}
\subsection{Introduction}
\label{sec:org6900d98}
\begin{itemize}
...
\caption{\label{fig:orgeac741d}CDGs}
\end{figure}

\subsubsection{Congenital Disorders of Glycosylation}
\label{sec:org9f2b6de}
\begin{itemize}
...
\label{sec:orgc56c4d2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org450dd9e}
\begin{itemize}
...
\label{sec:orgc7ef061}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org51808ec}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org007a45c}
\begin{itemize}
\item AR ALG6
\end{itemize}
\item Diagnostic Tests
\label{sec:org8b6f455}
\begin{itemize}
\item transferrin IEF - Type I pattern
...
\label{sec:org0cb28c9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge5ef176}
\begin{itemize}
...
\end{enumerate}
\section{Cystinosis}
\label{sec:orgf02f2e5}
\subsection{Introduction}
\label{sec:org683d495}
\begin{itemize}
...
\caption{\label{fig:org2ca9bbf}Cystine}
\end{figure}

\begin{itemize}
\item normally exported by a cystine porter which contains the membrane protein cystinosin (Figure \ref{fig:org0156d41})
\begin{itemize}
...
\caption{\label{fig:org0156d41}Lysosomal export of cystine and related compounds. The cross represents the defect in cystinosis}
\end{figure}
...
marrow
\end{enumerate}
\item nephropathic or infantile form is by far the most frequent (Section \ref{sec:orgf7318fc})
...
\label{sec:orgf7318fc}
\subsubsection{Clinical Presentation}
\label{sec:org91010c9}
\begin{enumerate}
\item First stage
\label{sec:org366751c}
\begin{itemize}
...
\label{sec:org8410e7f}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org5068051}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgfb13a1d}
\begin{itemize}
\item AR CTNS
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgab320b1}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org73ec068}
\begin{enumerate}
\item Supportive
\label{sec:orgec6788b}
\begin{itemize}
