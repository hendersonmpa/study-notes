...
\label{sec:org8529dde}
\subsection{Introduction}
\label{sec:org4e2c409}
\begin{enumerate}
\item Sphingolipids
\label{sec:org328174a}
\begin{itemize}
...
\item Biosynthesis
\label{sec:org76ae689}
\begin{enumerate}
\item ER
\label{sec:org704005d}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:orgc6efdff}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:orgf129f54}
...
\label{sec:orgbcc0a19}
\begin{enumerate}
\item Classification
\label{sec:org04cdb6a}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org784959c}
\begin{itemize}
...
\label{sec:org3a399a4}

\begin{table}[htbp]
\caption{\label{tab:orgcf1dcb0}
...
\caption{\label{fig:org106f99c}
Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:org604f2fe}
\begin{itemize}
...
\caption[Lysosomal protein trafficking receptors]{\label{fig:org8ef49f5}
Lysosomal protein trafficking receptors}
\end{figure}

\begin{enumerate}
\item M6P receptors
\label{sec:org8d613ba}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:org82ebfbd}
\begin{enumerate}
\item Introduction
\label{sec:org0f178b4}
\begin{itemize}
...
\caption{\label{fig:org3fc5f65}
\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}

\item Genetics
\label{sec:org3fd98c1}
\begin{itemize}
\item AR GBA
...
\label{sec:org6f46d4a}
\begin{itemize}
\item see table \ref{tab:org55952c8}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org55952c8}
...
\item Treatment
\label{sec:orgb33aa01}
\begin{enumerate}
\item bone marrow transplantation
\label{sec:orgc911c88}
\begin{itemize}
...
\label{sec:org33ec0be}
\begin{enumerate}
\item Introduction
\label{sec:orgbfde814}
\begin{itemize}
...
\caption{\label{fig:org0bf51e2}
Sphingomyelinase}
\end{figure}

\item Genetics
\label{sec:org1810741}
\begin{itemize}
\item AR, SMPD1
...
\item Clinical Findings
\label{sec:org39a7d0a}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:org5529f15}
\begin{itemize}
...
\end{itemize}
\item foam cells in bone marrow (Figure \ref{fig:orga552547})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{./niemann_pick/figures/foam_cells.png}
\caption{\label{fig:orga552547}
Foam cells in bone marrow}
\end{figure}

\item Treatment
\label{sec:orgcd5ea02}
\begin{itemize}
...
\label{sec:org8f3fe4a}
\begin{enumerate}
\item Introduction
\label{sec:org567f7a9}
\begin{itemize}
\item defect in \textbf{\(\beta\)-galactosidase (AKA: \(\beta\)-gangliosidase)}
\begin{itemize}
\item removes galactose from GM1, keratin sulfate and some oligosaccharides (Figure \ref{fig:org75c286d})
\end{itemize}
...
\begin{itemize}
\item ML-1 (sialidosis) (section \ref{sec:org092c7dd})
\end{itemize}
\end{itemize}
\end{enumerate}

\item Genetics
\label{sec:org6e0e9ea}
\begin{itemize}
\item AR GLB1
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgb0776ff}corneal clouding}\footnotetext[2]{\label{org4bcaa2c}secondary to bony changes}\footnotetext[3]{\label{orga986cc2}oligosacaride with terminal galactose}\footnotetext[4]{\label{org67b97f6}FN have been observed}
\item Laboratory Investigations
...
\label{sec:org68769ba}
\begin{enumerate}
\item Introduction
\label{sec:org96f65e6}
\begin{itemize}
...
and \(\beta\) subunits (Table \ref{tab:org3b10a61})
\end{itemize}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org3b10a61}
...
\caption{\label{fig:orgc55bbd3}
Hexosaminidase A \& B:Sandhoff disease}
\end{figure}

\item Genetics
\label{sec:orgc8793e2}
\begin{itemize}
...
\item Clinical Findings
\label{sec:org34ce7c8}
\begin{itemize}
\item see table \ref{tab:org0c41be2}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:org0c41be2}
...
\end{enumerate}
\subsection{Krabbe}
\label{sec:orgb443f97}
\begin{enumerate}
\item Introduction
\label{sec:org9ffa9ea}
\begin{itemize}
...
\begin{enumerate}
\item Treatment
\label{sec:org4fe5cd9}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:org3ea82f0}
\begin{itemize}
...
\label{sec:orgbd5bcab}
\begin{enumerate}
\item Introduction
\label{sec:org80a008f}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org083e868}induced by heat, cold, fatigue or emotional stress

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fabry/figures/angiokeratomas.png}
\caption[Angiokeratomas of the skin]{\label{fig:orgac49f80}
Angiokeratomas of the Skin}
\end{figure}}

\item Laboratory Investigations
\label{sec:org54b59d1}
\begin{enumerate}
\item Biochemistry
\label{sec:org775147e}
\begin{itemize}
...
\end{enumerate}
\subsection{Farber}
\label{sec:orgf18eeb7}
\begin{enumerate}
\item Introduction
\label{sec:org22b338e}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:orga4d96ce}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\item Clinical
\label{sec:org8f3d576}
\begin{itemize}
...
\item Treatment
\label{sec:orgcd75904}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\section{Niemann-Pick C}
\label{sec:orgfee78a6}
\subsection{Introduction}
\label{sec:orgfee132c}
\begin{itemize}
...
\label{sec:org4745765}
\begin{enumerate}
\item Early Infantile
\label{sec:org555ea75}
\begin{itemize}
...
\caption{\label{fig:orgc92eab1}
Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:org9f9e5a1}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:org7973d11}
\subsection{Introduction}
\label{sec:orgbc85d63}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./mps/figures/ch17f01.jpg}
\caption[Proteoglycans]{\label{fig:orga8fb62c}
Proteoglycans}
\end{figure}
...
\caption[Proteoglycan Synthesis]{\label{fig:orgf96db5b}
...
\caption[Glycan Nomenclature]{\label{fig:org7f2024e}
...
\caption[Glycosaminoglycans]{\label{fig:orgd6208d8}
Glycosaminoglycans}
\end{figure}
...
\caption[DS Degradation]{\label{fig:org1142ee8}
DS degradation}
\end{figure}
...
\caption[KS Degradation]{\label{fig:orge3184b3}
KS degradation}
\end{figure}
...
\caption[HS Degradation]{\label{fig:org9d8f18e}
HS Degradation}
\end{figure}
\end{enumerate}

\subsection{Multiple sulfatase deficiency}
\label{sec:orgabcc753}
\begin{itemize}
...
\label{sec:org0c072e9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org33f6ca0}
\begin{itemize}
...
\label{sec:orgf76677c}
\begin{itemize}
\item MPS III (Sanfilippo)
\end{itemize}
\item Severe Skeletal Dysplasia
\label{sec:org5bd1c3b}
\begin{itemize}
\item MPS IV (Morquio)
\end{itemize}
\item Rare
\label{sec:org947dc99}
\begin{itemize}
\item MPS VII (Sly)
...
\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:orgfe89a46}
...
\item Diagnostic Testing
\label{sec:orgd85081e}
\begin{itemize}
\item quantitation of urine GAGs (Table \ref{tab:orgfe89a46})
\begin{itemize}
...
\label{sec:org8f82c89}
\subsection{Introduction}
\label{sec:orga337018}
...
\label{sec:org1f27f2e}
\begin{enumerate}
\item Mannosidosis
\label{sec:org82bad48}
\begin{itemize}
...
\label{sec:org092c7dd}
\subsection{Introduction}
\label{sec:orgaf23333}
\begin{itemize}
...
\label{sec:orgcca77c9}
\begin{enumerate}
\item Biochemical
\label{sec:org3392faa}
\begin{itemize}
...
\caption[Protein trafficking to lysosomes]{\label{fig:org2d6d6ad}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org229d96c}
...
\caption{\label{fig:org3d4ddc4}
I cell in fibroblast culture}
\end{figure}

\item Clinical
\label{sec:org636cdde}

\begin{enumerate}
\item ML II
\label{sec:org8c60dda}
\begin{itemize}
\item low IQ
...
\label{sec:orgf53f939}
\subsection{Introduction}
\label{sec:orgbf8f696}
\begin{enumerate}
\item Peroxisomal FA oxidation
\label{sec:orgcb7981e}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0a39727}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:org6168e87}
\begin{itemize}
...
\label{sec:orgeda2526}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org39ea826}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org7a914c9}
Oxidation of Phytanic Acid}
\end{figure}

\item Genetics
\label{sec:org20b3022}
\begin{itemize}
...
\label{sec:orgc8cc52b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org764020a}
\begin{itemize}
...
\label{sec:org8c6a47a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb99fcc7}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org1eab382}
\begin{enumerate}
\item RCDP Type 1
\label{sec:orgd7ac399}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org1ed3c84}
\begin{itemize}
\item \(\downarrow\) plasmalogens
\end{itemize}
\begin{enumerate}
\item RDCP1
\label{sec:orgc505391}
\begin{itemize}
...
\caption{\label{fig:org07cfcef}
Eicosanoid Metabolism}
\end{figure}

\begin{enumerate}
\item Disorders
\label{sec:org3e1bc88}
\begin{itemize}
...
\label{sec:org4f9e7ec}
\subsection{Introduction}
\label{sec:org97646dd}
\begin{itemize}
...
\label{sec:org9d336c9}
\begin{enumerate}
\item Transferrin IEF
\label{sec:orgb3f6466}
\begin{itemize}
...
\caption{\label{fig:org0f8a13b}
Transferrin IEF}
\end{figure}

\item Transferrin IEF limitations
\label{sec:org09f088d}
...
\caption{\label{fig:org2bc63f5}
CDG diagnosis}
\end{figure}
\end{enumerate}
\section{Cystinosis}
\label{sec:org7c19aff}
\subsection{Introduction}
\label{sec:orgbeda385}
\begin{itemize}
...
\label{sec:org38cca94}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org29a3099}
\begin{itemize}
...
\item Treatment
\label{sec:orgb84fce7}
\begin{enumerate}
\item Supportive
\label{sec:orgb6155f7}
\begin{itemize}
