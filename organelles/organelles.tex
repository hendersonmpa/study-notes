...
\label{sec:org19dc9b7}
\subsection{Introduction}
\label{sec:orgbf028f6}
\begin{enumerate}
\item Sphingolipids
\label{sec:orgb809206}
\begin{itemize}
...
\item Biosynthesis
\label{sec:org2e5d96a}
\begin{enumerate}
\item ER
\label{sec:orge946778}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:orgd503576}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org00b5023}
...
\label{sec:org301e09c}
\begin{enumerate}
\item Classification
\label{sec:orgde3d0a7}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org989477d}
\begin{itemize}
...
\label{sec:org1bb5798}

\begin{table}[htbp]
\caption{\label{tab:org75c4d3f}
...
\caption{\label{fig:org7e2e524}
Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:orga547ca3}
\begin{itemize}
...
\caption[Lysosomal protein trafficking receptors]{\label{fig:orge549443}
Lysosomal protein trafficking receptors}
\end{figure}

\begin{enumerate}
\item M6P receptors
\label{sec:org65593c6}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:org2d7c0d8}
\begin{enumerate}
\item Introduction
\label{sec:org393db1d}
\begin{itemize}
...
\caption{\label{fig:orge471eb6}
\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}

\item Genetics
\label{sec:org7337aec}
\begin{itemize}
\item AR GBA
...
\label{sec:orgbc723b4}
\begin{itemize}
\item see table \ref{tab:org71588a1}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org71588a1}
...
\item Treatment
\label{sec:org8ce3e62}
\begin{enumerate}
\item bone marrow transplantation
\label{sec:org408b32e}
\begin{itemize}
...
\label{sec:org98a2a29}
\begin{enumerate}
\item Introduction
\label{sec:orgcbcd5e7}
\begin{itemize}
...
\caption{\label{fig:orgcb7dd57}
Sphingomyelinase}
\end{figure}

\item Genetics
\label{sec:orgd095d5d}
\begin{itemize}
\item AR, SMPD1
...
\item Clinical Findings
\label{sec:orge0ab002}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:org7892bf8}
\begin{itemize}
...
\end{itemize}
\item foam cells in bone marrow (Figure \ref{fig:orge559c56})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{./niemann_pick/figures/foam_cells.png}
\caption{\label{fig:orge559c56}
Foam cells in bone marrow}
\end{figure}

\item Treatment
\label{sec:org78f1c6b}
\begin{itemize}
...
\label{sec:org777aac3}
\begin{enumerate}
\item Introduction
\label{sec:orgc5338d2}
\begin{itemize}
\item defect in \textbf{\(\beta\)-galactosidase (AKA: \(\beta\)-gangliosidase)}
\begin{itemize}
\item removes galactose from GM1, keratin sulfate and some oligosaccharides (Figure \ref{fig:org3290a50})
\end{itemize}
...
\begin{itemize}
\item ML-1 (sialidosis) (section \ref{sec:org9b3daa8})
\end{itemize}
\end{itemize}
\end{enumerate}

\item Genetics
\label{sec:orgfabbfe9}
\begin{itemize}
\item AR GLB1
...
\item Clinical Findings
\label{sec:org543000f}
\begin{itemize}
\item see table \ref{tab:org9a0c57d}
\item a cause of non-immune fetal hydrops
\end{itemize}
\begin{table}[htbp]
\caption[GM1 Signs and Symptoms]{\label{tab:org9a0c57d}
...
coarse facial features & \textpm{} & - & - & \textsuperscript{\ref{org47eb894}}\\
skeletal findings & + & \textpm{} & - & +\\
urine & \footnotemark & \textsuperscript{\ref{org63e18f8}} & \textsuperscript{\ref{org63e18f8}} & keratan sulfate \footnotemark\\
\end{tabular}
\end{table}\footnotetext[1]{\label{org91182b5}corneal clouding}\footnotetext[2]{\label{org47eb894}secondary to bony changes}\footnotetext[3]{\label{org63e18f8}oligosacaride with terminal galactose}\footnotetext[4]{\label{org2e0982b}FN have been observed}
\item Laboratory Investigations
\label{sec:org2f6fa2c}
\begin{itemize}
...
and \(\beta\) subunits (Table \ref{tab:org5dd6ee9})
\end{itemize}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org5dd6ee9}
...
\caption{\label{fig:org2016a65}
Hexosaminidase A \& B:Sandhoff disease}
\end{figure}

\item Genetics
\label{sec:orgfa33c42}
\begin{itemize}
...
\item Clinical Findings
\label{sec:org948aaea}
\begin{itemize}
\item see table \ref{tab:orgd0cb159}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orgd0cb159}
...
\end{enumerate}
\subsection{Krabbe}
\label{sec:org5901219}
\begin{enumerate}
\item Introduction
\label{sec:orgbab420a}
\begin{itemize}
...
\begin{enumerate}
\item Treatment
\label{sec:org1903b5e}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:org34148b0}
\begin{itemize}
...
\label{sec:org28f3da7}
\begin{enumerate}
\item Introduction
\label{sec:org8bfecc8}
\begin{itemize}
...
\item multiple sulphatase deficiency (Section \ref{sec:org95ba625})
\end{itemize}
\end{itemize}
\begin{enumerate}
\item Late-infantile
\label{sec:orgd6c5cd4}
\begin{itemize}
...
\end{enumerate}
\subsection{Fabry}
\label{sec:orgaee1b42}
\begin{enumerate}
\item Introduction
\label{sec:orgc45f1ad}
\begin{itemize}
...
(Figure \ref{fig:orge471eb6})
\item accumulation of Gb3 in blood vessels and other tissues
\item globotriaosylceramide (Gb3): the Fabry lipid (Figure \ref{fig:orgae1db85})
...
\caption[Globotriaosylceramide]{\label{fig:orgae1db85}
...
\caption[\(\alpha\)-galactosidase A]{\label{fig:org6b759c0}
\(\alpha\)-galactosidase A, located in the lumen of lysosomes}
\end{figure}

\item Genetics
\label{sec:org5292863}
\begin{itemize}
\item \textbf{XL GLA}
...
\item Clinical Findings
\label{sec:org8deeded}
\begin{itemize}
\item see table \ref{tab:orgd8151f2}
...
\item ocular lesions
\item angiokeratomas (Figure \ref{fig:org8c1e50c})
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org9810f44}induced by heat, cold, fatigue or emotional stress

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fabry/figures/angiokeratomas.png}
\caption[Angiokeratomas of the skin]{\label{fig:org8c1e50c}
Angiokeratomas of the Skin}
\end{figure}}

\item Laboratory Investigations
\label{sec:orgfe99ab4}
\begin{enumerate}
\item Biochemistry
\label{sec:orgd7ebc16}
\begin{itemize}
...
\end{enumerate}
\subsection{Farber}
\label{sec:orgf65f980}
\begin{enumerate}
\item Introduction
\label{sec:orga0dbb60}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org5572971}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\item Clinical
\label{sec:org74640ce}
\begin{itemize}
...
\item Treatment
\label{sec:orgaac9a54}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\section{Niemann-Pick C}
\label{sec:org02e76f2}
\subsection{Introduction}
\label{sec:orga535764}
\begin{itemize}
...
\label{sec:org34ad2a0}
\begin{enumerate}
\item Early Infantile
\label{sec:org52f0825}
\begin{itemize}
...
\caption{\label{fig:org5535ae8}
Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:org69f049e}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:orgd92ab71}
\subsection{Introduction}
\label{sec:orgedba698}
\begin{itemize}
...
\label{sec:org95ba625}
\subsection{Introduction}
\label{sec:orgc02aa46}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./mps/figures/ch17f01.jpg}
\caption[Proteoglycans]{\label{fig:org2ac1d70}
Proteoglycans}
\end{figure}
...
\caption[Proteoglycan Synthesis]{\label{fig:org3223422}
...
\caption[Glycan Nomenclature]{\label{fig:orgc8573eb}
...
\caption[Glycosaminoglycans]{\label{fig:orgbdfa444}
Glycosaminoglycans}
\end{figure}

\begin{itemize}
\item GAGs are composed of repeating units of disaccharides (Figure \ref{fig:orgbdfa444})
\begin{itemize}
...
\caption[DS Degradation]{\label{fig:org937763e}
DS degradation}
\end{figure}
...
\caption[KS Degradation]{\label{fig:org1a3d962}
KS degradation}
\end{figure}
...
\caption[HS Degradation]{\label{fig:org7b83b3a}
HS Degradation}
\end{figure}
\end{enumerate}

\subsection{Multiple sulfatase deficiency}
\label{sec:orgaabbf6c}
\begin{itemize}
...
\label{sec:orga4799d3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga99f04c}
\begin{itemize}
...
\label{sec:org6bee867}
\begin{itemize}
\item MPS III (Sanfilippo)
\end{itemize}
\item Severe Skeletal Dysplasia
\label{sec:org0e2a310}
\begin{itemize}
\item MPS IV (Morquio)
\end{itemize}
\item Rare
\label{sec:org9a9731a}
\begin{itemize}
\item MPS VII (Sly)
...
\caption[Glycosaminoglycan Degradation]{\label{fig:org0ec140c}
Glycosaminoglycan Degradation}
\end{figure}

\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:org5feb8ab}
...
\item Diagnostic Tests
\label{sec:orgffa2989}
\begin{itemize}
\item quantitation of urine GAGs (Table \ref{tab:org5feb8ab})
\begin{itemize}
...
\label{sec:org1147087}
\subsection{Introduction}
\label{sec:org32dc6be}
...
\caption{\label{fig:org47a1928}
Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Oligosaccharidoses}
\label{sec:org1ed3913}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge3bd98b}
\begin{itemize}
\item oligosaccharidoses share many features in common with MPS disorders (Table \ref{tab:org4f30b24})
\begin{itemize}
...
\item Genetics
\label{sec:org4d2ec29}
\begin{itemize}
\item AR
\end{itemize}
\item Diagnostic Tests
\label{sec:orgca6bd93}
\begin{itemize}
...
\item enzyme activity assays (Table \ref{tab:org4f30b24})
\end{itemize}

\item Treatment
\label{sec:org67b7cb0}
\begin{itemize}
\item supportive
\end{itemize}
\end{enumerate}
\section{Mucolipidoses}
\label{sec:org9b3daa8}
\subsection{Introduction}
\label{sec:orgc5b8653}
\begin{itemize}
...
\label{sec:orga936af5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9302f85}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1835c5b}
\begin{enumerate}
\item ML II
\label{sec:org7ba5769}
\begin{itemize}
\item low IQ
...
\caption[Protein trafficking to lysosomes]{\label{fig:orgf14808d}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org7ff69b6}
...
\caption{\label{fig:orge853419}
I cell in fibroblast culture}
\end{figure}

\item Genetics
\label{sec:org0556c5c}
\begin{itemize}
\item AR GNPTAB
\end{itemize}

\item Diagnostic Tests
\label{sec:orgaa16c54}
\begin{itemize}
...
\item Treatment
\label{sec:orgf761711}
\begin{itemize}
\item supportive
\end{itemize}
\end{enumerate}
\subsection{ML IV}
\label{sec:org0d6939f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb31ca21}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:orgd24e5da}
\begin{itemize}
\item AR MCOLN1
\end{itemize}
\item Diagnostic Tests
\label{sec:org349b94c}
\begin{itemize}
...
\section{Peroxisomes}
\label{sec:org84d7b43}
\subsection{Introduction}
\label{sec:org918086b}
\begin{itemize}
...
\caption[Non-mitochondrial FA metabolism]{\label{fig:org0049150}
...
\label{sec:org32eae30}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org71e3a3a}
\begin{itemize}
\item three forms:
\begin{enumerate}
...
\item Genetics
\label{sec:org60433b7}
\begin{itemize}
\item X-linked ABCD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org073691f}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga5c229e}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:org3abd6af}
\begin{itemize}
...
\label{sec:org8527c6a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5e3f180}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org729b4d9}
Oxidation of Phytanic Acid}
\end{figure}

\item Genetics
\label{sec:org69fbaaa}
\begin{itemize}
\item AR PHYH
\end{itemize}

\item Diagnostic Tests
\label{sec:org0b7b6e4}
\begin{itemize}
...
\label{sec:org0dd8e82}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4351a50}
\begin{itemize}
...
\item Genetics
\label{sec:org6b36115}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\item Diagnostic Tests
\label{sec:org4aad568}
\begin{itemize}
...
\label{sec:org06c7730}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org22e9b6d}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:orgcd6e637}
\begin{enumerate}
\item RCDP Type 1
\label{sec:org28f9d7e}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org709c392}
\begin{itemize}
\item \(\downarrow\) RBC plasmalogens
\end{itemize}
\begin{enumerate}
\item RDCP1
\label{sec:org032fb9c}
\begin{itemize}
...
\caption{\label{fig:org653306e}
Eicosanoid Metabolism}
\end{figure}

\begin{enumerate}
\item Disorders
\label{sec:orgaaf38b6}
\begin{itemize}
...
\label{sec:org751c5db}
\subsection{Introduction}
\label{sec:org2df566e}
\begin{itemize}
...
\caption{\label{fig:orgdf68bea}
CDGs}
\end{figure}

\item Congenital Disorders of Glycosylation
\label{sec:org8787783}
\begin{itemize}
...
\caption{\label{fig:orgebd7664}
CDG diagnosis}
\end{figure}
\end{enumerate}

\subsection{PMM2-CDG (CDG Ia)}
\label{sec:org5a331ec}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6ef0d2b}
\begin{itemize}
...
\item Genetics
\label{sec:org5dfcb5a}
\begin{itemize}
\item AR, PMM2
\end{itemize}

\item Diagnostic Tests
\label{sec:org1569bc4}
\begin{itemize}
...
\label{sec:orgf265a94}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb207539}
\begin{itemize}
...
\item Genetics
\label{sec:org581d03c}
\begin{itemize}
\item AR, MPI
\end{itemize}

\item Diagnostic Tests
\label{sec:org1f0b5e3}
\begin{itemize}
...
\label{sec:org0e50585}
\begin{enumerate}
\item MGAT2-CDG (CDG IIa)
\label{sec:org5b60723}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgba912a5}
\begin{itemize}
\item onset in infancy, neonatal
...
\end{itemize}
\item Genetics
\label{sec:org8631345}
\begin{itemize}
\item AR MGAT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org0a78cf6}
\begin{itemize}
...
\item Treatment
\label{sec:org5d858ba}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\item SLC35C1-CDG (CDG IIc)
\label{sec:org7224a77}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2a0be71}
\begin{itemize}
...
neutrophilia
\item Bombay (hh) blood phenotype (Figure \ref{fig:org883f008})
\begin{itemize}
\item do not express H antigen
\end{itemize}
\end{itemize}
\item Metabolic Derangement
\label{sec:orgcbd7322}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org2432a6c}
\begin{itemize}
\item AR SLC35C1
\end{itemize}

\item Diagnostic Tests
\label{sec:org349ef4e}
\begin{itemize}
\item normal transferrin IEF
\item molecular
\end{itemize}
\item Treatment
\label{sec:org493015d}
\begin{itemize}
...
\caption[Hh]{\label{fig:org883f008}
Hh Blood Group}
\end{figure}
\end{enumerate}
\end{enumerate}
\section{Cystinosis}
\label{sec:orgccc685a}
\subsection{Introduction}
\label{sec:org03d98a4}
\begin{itemize}
...
marrow
\end{enumerate}
\item nephropathic or infantile form is by far the most frequent (see \ref{sec:orgfd5cb57})
...
\label{sec:orgfd5cb57}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgab94645}
\begin{enumerate}
\item First stage
\label{sec:org36dd526}
\begin{itemize}
...
\label{sec:orgd34f505}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org44f1e87}
\begin{itemize}
...
\item Genetics
\label{sec:org106573b}
\begin{itemize}
\item AR, CTNS
\end{itemize}

\item Diagnostic Tests
\label{sec:org87b5c5d}
\begin{itemize}
...
\item Treatment
\label{sec:org0f13d54}
\begin{enumerate}
\item Supportive
\label{sec:orgad923cc}
\begin{itemize}
