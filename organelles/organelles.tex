...
\label{sec:org0fe9c0b}
\subsection{Introduction}
\label{sec:org7d3e91a}
\begin{enumerate}
\item Sphingolipids
\label{sec:orgbede78e}
\begin{itemize}
...
\item Biosynthesis
\label{sec:orgd4feeae}
\begin{enumerate}
\item ER
\label{sec:org24adda5}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:orgd6c5b91}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:orgf24306b}
...
\label{sec:org290e05d}
\begin{enumerate}
\item Classification
\label{sec:org130dd65}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:orgc2697ac}
\begin{itemize}
...
\label{sec:orgf979697}

\begin{table}[htbp]
\caption{\label{tab:orge4d499b}
...
\caption{\label{fig:orgf915805}
Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosome}
\label{sec:org6415035}
\begin{itemize}
...
\caption[Lysosomal protein trafficking receptors]{\label{fig:org3f6ee20}
Lysosomal protein trafficking receptors}
\end{figure}


\subsection{M6P receptors}
\label{sec:org3561538}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:orgb26286d}
\begin{enumerate}
\item Introduction
\label{sec:org1a496fe}
\begin{itemize}
...
\caption{\label{fig:org11415ac}
\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}

\item Genetics
\label{sec:org65ba6dd}
\begin{itemize}
...
\label{sec:org682c0c0}
\begin{table}[htbp]
\caption{\label{tab:orgd104dcd}
...
\item Treatment
\label{sec:org2d5ba42}
\begin{enumerate}
\item Bone marrow transplantation
\label{sec:org4527cce}
\begin{itemize}
...
\caption{\label{fig:org5c843a8}
Sphingomyelinase}
\end{figure}

\item Genetics
\label{sec:orgca8a0f7}
\begin{itemize}
...
\item Clinical Findings
\label{sec:orgde417f5}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:orgdd5186a}
\begin{itemize}
...
\caption{\label{fig:orga535f2b}
Foam cells in bone marrow}
\end{figure}

\item Treatment
\label{sec:org7a28a69}
\begin{itemize}
...
\label{sec:org0a74624}
\begin{enumerate}
\item Introduction
\label{sec:org338fd66}
...
\item Clinical Findings
\label{sec:orgc107ff8}

\begin{table}[htbp]
\caption[GM1 Signs and Symptoms]{\label{tab:orga10eea4}
...
Hepatosplenomegaly & + & +/– & – & –\\
Cardiac involvement & +/– & +/– & +/– & +\\
Coarse facial features & +/– & – & – & \textsuperscript{\ref{org9b3f4eb}}\\
Skeletal findings & + & +/– & – & +\\
Neuroimaging & PA & PA & +/– mild atrophy & \textsuperscript{\ref{org9b3f4eb}}\\
Urine (GAG) & \footnotemark & \textsuperscript{\ref{orgea1078d}} & \textsuperscript{\ref{orgea1078d}} & Keratan sulfate \footnotemark\\
\end{tabular}
\end{table}\footnotetext[1]{\label{org9b3f4eb}secondary to bony changes}\footnotetext[2]{\label{orgea1078d}oligosacaride with terminal galactose}\footnotetext[3]{\label{org3351e79}FN have been observed}

\item Laboratory Investigations
\label{sec:org352eaf8}
\begin{itemize}
...
\caption{\label{fig:orga96dc68}
Hexosaminidase A \& B:Sandhoff disease}
\end{figure}

\item Genetics
\label{sec:org82bf776}
\begin{itemize}
...
\item Clinical Findings
\label{sec:orgd587260}
\begin{table}[htbp]
\caption{\label{tab:org3794dd3}
...
\end{tabular}
\end{table}\footnotetext[4]{\label{orge5dbebc}Prior offspring as well as heterozygote screening (1969-1992)}
\end{enumerate}
\subsection{Krabbe}
\label{sec:orgbb98364}
\begin{enumerate}
\item Introduction
\label{sec:org711b5ad}
\begin{itemize}
...
\item Diagnosis
\label{sec:orgc94496e}
\begin{enumerate}
\item Symptomatic presentation
\label{sec:org36ee3f0}
\begin{itemize}
...
\caption{\label{fig:org518c4df}
NBS follow-up at Mayo}
\end{figure}
\end{enumerate}

\item Laboratory Investigations
\label{sec:orgcdf0fc9}
\begin{enumerate}
\item CSF protein
\label{sec:org4250986}
\begin{itemize}
...
\item Treatment
\label{sec:org460710f}

\begin{enumerate}
\item Treatment of manifestations
\label{sec:orgc5f5250}
\begin{itemize}
...
\label{sec:orga0f2726}
\begin{enumerate}
\item Introduction
\label{sec:org1da4a66}
...
\item Clinical
\label{sec:org5d70a50}
\begin{enumerate}
\item Late-infantile MLD
\label{sec:org844c82f}
\begin{itemize}
...
\end{enumerate}
\subsection{Fabry}
\label{sec:org63c5de4}
\begin{enumerate}
\item Introduction
\label{sec:org27df7b3}
\begin{itemize}
...
\caption[Globotriaosylceramide]{\label{fig:orge6cd4e8}
...
\caption[\(\alpha\)-galactosidase A]{\label{fig:orgc426b50}
\(\alpha\)-galactosidase A, located in the lumen of lysosomes}
\end{figure}

\item Genetics
\label{sec:orgad8960a}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org2ae2015}May be induced by heat, cold, fatigue or emotional stress

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fabry/figures/angiokeratomas.png}
\caption[Angiokeratomas of the skin]{\label{fig:orgd2a1692}
Angiokeratomas of the skin}
\end{figure}}


\item Laboratory Investigations
\label{sec:org787cbb1}
\begin{enumerate}
\item Biochemistry
\label{sec:orge1514e9}
\begin{itemize}
...
\end{enumerate}
\subsection{Farber}
\label{sec:orgb974f10}
\begin{enumerate}
\item Introduction
\label{sec:org5fd743a}
\begin{itemize}
...
\item Treatment
\label{sec:orgab51689}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\section{Niemann-Pick C}
\label{sec:orgaf354b0}
\subsection{Introduction}
\label{sec:org09a7bca}
\begin{itemize}
...
\label{sec:org128b0ab}
\begin{enumerate}
\item Early infantile
\label{sec:org2985efb}
\begin{itemize}
...
\caption{\label{fig:orgd94dc22}
Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:org4538de5}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:orgceb6463}
\subsection{Introduction}
\label{sec:org64e9e2a}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./mps/figures/ch17f01.jpg}
\caption[Proteoglycans]{\label{fig:org51d9c8f}
Proteoglycans}
\end{figure}

\begin{enumerate}
\item Proteoglycans function
\label{sec:org5d333d0}
...
\caption[Proteoglycan Synthesis]{\label{fig:orge0ac09a}
Proteoglycan Synthesis}
\end{figure}


\item Glycosaminoglycans
\label{sec:org16e683e}
...
\caption[Glycan Nomenclature]{\label{fig:orgb18b930}
...
\caption[Glycosaminoglycans]{\label{fig:org1f20fea}
Glycosaminoglycans}
\end{figure}

\item GAGs
\label{sec:orgfb83d15}

\begin{enumerate}
\item Hyaluronan
\label{sec:org4943760}
\begin{itemize}
...
\label{sec:org8844c08}

\begin{enumerate}
\item Mucopolysaccharidoses
\label{sec:org81d51fe}
\begin{itemize}
...
\caption[Glycosaminoglycan Degradation]{\label{fig:orgca3919b}
Glycosaminoglycan Degradation}
\end{figure}

\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:org3386867}
...
\caption[DS Degradation]{\label{fig:org3cb5140}
DS degradation}
\end{figure}
...
\caption[KS Degradation]{\label{fig:org096745d}
KS degradation}
\end{figure}
...
\caption[HS Degradation]{\label{fig:org9f30197}
HS Degradation}
\end{figure}
\end{enumerate}

\section{Oligosaccharidoses}
\label{sec:orgf614691}
\subsection{Introduction}
\label{sec:orgfec3b36}
...
\caption{\label{fig:org5012985}
Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Disorders}
\label{sec:orge7b9784}
\begin{enumerate}
\item Mannosidosis
\label{sec:orgd4d6c52}
\begin{itemize}
...
\label{sec:org97f79e4}
\subsection{Introduction}
\label{sec:org946780a}
\begin{itemize}
...
\label{sec:org0a480b2}
\begin{enumerate}
\item Biochemical
\label{sec:orge692b64}
\begin{itemize}
...
\caption[Protein trafficking to lysosomes]{\label{fig:orge3c06ef}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org4218cd8}
...
\caption{\label{fig:org8a9895a}
I cell in fibroblast culture}
\end{figure}

\item Clinical
\label{sec:orgba590fd}

\begin{enumerate}
\item ML II
\label{sec:org61dbb9d}
\begin{itemize}
\item low IQ
...
\label{sec:org2d828d6}

\begin{enumerate}
\item Sialidosis (ML I)
\label{sec:orga2430f3}
\begin{itemize}
...
\label{sec:org5957dba}
\subsection{Introduction}
\label{sec:org8890284}
\begin{enumerate}
\item Peroxisomal FA oxidation
\label{sec:org6816ef3}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4324092}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:orge260977}
\begin{itemize}
...
\label{sec:orgcae8b66}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3dcd3bd}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:orgff6cdd4}
Oxidation of Phytanic Acid}
\end{figure}

\item Genetics
\label{sec:org66f5458}
\begin{itemize}
...
\label{sec:org479eff7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5fc6957}
\begin{itemize}
...
\caption{\label{fig:org8929fee}
Eicosanoid Metabolism}
\end{figure}

\begin{enumerate}
\item Disorders
\label{sec:orgafb0706}
\begin{itemize}
...
\label{sec:org946e023}
\subsection{Introduction}
\label{sec:orgce17393}
\begin{itemize}
...
\label{sec:org3fb027e}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org20f8c1f}
\begin{itemize}
...
\label{sec:orga28a570}

\begin{enumerate}
\item MGAT2-CDG (CDG-IIa)
\label{sec:orge3747fd}
\begin{itemize}
...
\caption[Hh]{\label{fig:org2ef0328}
Hh Blood Group}
\end{figure}
\end{enumerate}

\subsection{Laboratory Tests}
\label{sec:orgbd74ba8}
\begin{enumerate}
\item Transferrin IEF
\label{sec:org8f7e801}
\begin{itemize}
...
\caption{\label{fig:orgd48e3d8}
Transferrin IEF}
\end{figure}

\item Transferrin IEF limitations
\label{sec:org993f0d9}
...
\caption{\label{fig:org79031fd}
CDG diagnosis}
\end{figure}
\end{enumerate}
\section{Cystinosis}
\label{sec:org4707af9}
\subsection{Introduction}
\label{sec:org8bf88c4}
\begin{itemize}
...
\label{sec:orgb374433}
\begin{enumerate}
\item First stage
\label{sec:org6ea57a8}
\begin{itemize}
...
\label{sec:orgeaa736d}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org9e24ef5}
\begin{itemize}
...
\item Treatment
\label{sec:org2651ee5}
\begin{enumerate}
\item Supportive
\label{sec:org54e496b}
\begin{itemize}
