...
\label{sec:org508e7a2}
\subsection{Introduction}
\label{sec:org161bb25}
\subsubsection{Sphingolipids}
\label{sec:orgb2c9b30}
\begin{itemize}
...
\label{sec:org5723124}
\begin{enumerate}
\item ER
\label{sec:orge16e9b5}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:orgb8fa6a7}Sphingolipid Structure}
\end{figure}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:orge742588}Sphingolipid Biosynthesis}
\end{figure}
\end{enumerate}

\subsection{Disorders of Sphingolipid Synthesis}
\label{sec:orgd817441}
\subsubsection{Classification}
\label{sec:org14c87d3}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org44d0e3f}
\begin{description}
...
\label{sec:org31987ff}

\begin{table}[htbp]
\caption{\label{tab:orgd35fa81}Sphingolipidoses}
\centering
\begin{tabular}{llll}
...
\caption{\label{fig:org13ed9b2}Sphingolipid Degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:org03729ce}
\begin{itemize}
...
\caption{\label{fig:orgcf08fb7}Protein Trafficking to Lysosome}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./figures/lysosome_trafficking.jpeg}
\caption{\label{fig:orgefd8401}Lysosomal Protein Trafficking Receptors}
\end{figure}

\subsubsection{M6P receptors}
\label{sec:orga8b4ab9}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:org5cea030}
\subsubsection{Introduction}
\label{sec:org318409a}
\begin{itemize}
...
\caption{\label{fig:orgc2bc2dc}Glucocerebroside the Gaucher Lipid}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{gaucher/figures/glucocerebrosidase.png}
\caption{\label{fig:org4d31848}\(\beta\)-Glucocerebrosidase: Gaucher}
\end{figure}

\subsubsection{Clinical Findings}
\label{sec:org05dd6b6}
\begin{itemize}
\item see table \ref{tab:orgb03c9b5}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgb03c9b5}Gaucher Clinical Variants}
\centering
\begin{tabular}{llll}
...
\label{sec:orgf58733e}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{gaucher/figures/Gaucher_Cells_with_Fibrillar_Appearing_Cytoplasm.jpg}
\caption{\label{fig:orgb3ece6d}Gaucher Cells in a Bone Marrow Smear}
\end{figure}

\begin{enumerate}
\item Biochemistry
\label{sec:orgfd07715}
\begin{itemize}
...
\label{sec:org1d23e56}
\begin{enumerate}
\item Bone marrow transplantation
\label{sec:org5ad5f1d}
\begin{itemize}
...
\label{sec:org363098d}
\subsubsection{Introduction}
\label{sec:orgac03fa8}
\begin{itemize}
...
\caption{\label{fig:org23e445d}Sphingomyelin}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{niemann_pick/figures/sphingomyelinase.png}
\caption{\label{fig:org72bc449}Acid Sphingomyelinase: NP A \& B}
\end{figure}

\subsubsection{Clinical Findings}
\label{sec:org5c62dbe}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:org1f09517}
\begin{itemize}
...
\end{itemize}
\item foam cells in bone marrow (Figure \ref{fig:orgfc07f28})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{niemann_pick/figures/foam_cells.png}
\caption{\label{fig:orgfc07f28}Foam Cells in Bone Marrow in NP A, B and C}
\end{figure}

\subsubsection{Treatment}
\label{sec:org7643533}
\begin{itemize}
...
\label{sec:orgdc09bc8}
\subsubsection{Introduction}
\label{sec:orge16aaa9}
\begin{itemize}
\item defect in \textbf{\(\beta\)-galactosidase (AKA: \(\beta\)-gangliosidase)}
\begin{itemize}
\item removes galactose from GM1, keratin sulfate and some oligosaccharides (Figure \ref{fig:org472ced7})
\end{itemize}
...
\caption{\label{fig:org472ced7}\(\beta\)-Galactosidase: GM1 Gangliosidosis}
\end{figure}


\begin{enumerate}
\item Lysosomal multi-enzyme complex
\label{sec:org8a5a752}
\begin{itemize}
...
\subsubsection{Clinical Findings}
\label{sec:org8e4a1fd}
\begin{itemize}
\item see table \ref{tab:orge3aef2a}
\item a cause of non-immune fetal hydrops
\end{itemize}
\begin{table}[htbp]
\caption[GM1 Signs and Symptoms]{\label{tab:orge3aef2a}GM1 Signs and Symptoms}
\centering
\begin{tabular}{lllll}
...
coarse facial features & \textpm{} & - & - & \textsuperscript{\ref{orgb622ca4}}\\
skeletal findings & + & \textpm{} & - & +\\
urine & \footnotemark & \textsuperscript{\ref{org1b7f57f}} & \textsuperscript{\ref{org1b7f57f}} & keratan sulfate \footnotemark\\
 &  &  &  & \\
\end{tabular}
\end{table}\footnotetext[1]{\label{org6099fca}corneal clouding}\footnotetext[2]{\label{orgb622ca4}secondary to bony changes}\footnotetext[3]{\label{org1b7f57f}oligosacaride with terminal galactose}\footnotetext[4]{\label{org2b49986}FN have been observed}

\subsubsection{Genetics}
\label{sec:org1040b59}
\begin{itemize}
\item AR GLB1
...
and \(\beta\) subunits (Table \ref{tab:org40ffe4f})
\end{itemize}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org40ffe4f}Hexoaminidase Isozymes}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:orgc2b5f70}GM2 ganglioside storage diseases}
\centering
\begin{tabular}{llrll}
...
\caption{\label{fig:org12f97ae}Hexosaminidase A: Tay-Sachs}
\end{figure}
...
\caption{\label{fig:org37c9da7}Hexosaminidase A \& B:Sandhoff disease (GL-3 \& 4 equivalent to Gb3 \& 4)}
\end{figure}


\subsubsection{Clinical Findings}
\label{sec:org6462bc3}
\begin{itemize}
\item see table \ref{tab:org77cb749}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:org77cb749}GM2 Signs and Symptoms}
\centering
\begin{tabular}{llll}
...
\end{itemize}
\subsubsection{Treatment}
\label{sec:org0e6fe3f}
\begin{itemize}
\item treat seizures
\item no curative treatment to date
\end{itemize}
\subsection{Krabbe}
\label{sec:org54c4357}
\subsubsection{Introduction}
\label{sec:org2805a82}
\begin{itemize}
...
\caption{\label{fig:orge24cdf1}Galactocerebrosidase: Krabbe}
\end{figure}
...
\caption{\label{fig:orgda57720}NBS Follow-up at Mayo}
\end{figure}
...
\begin{enumerate}
\item Treatment
\label{sec:org010c8a0}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:org07e2c0f}
\begin{itemize}
...
\label{sec:org131eef6}
\subsubsection{Introduction}
\label{sec:orgaedfd5e}
\begin{itemize}
...
\caption{\label{fig:org40a8f52}Arylsulfatase A: Metachromatic Leukodystrophy}
\end{figure}

\subsubsection{Clinical}
\label{sec:orgb1146d0}
\begin{itemize}
\item three forms: late infantile-onset, juvenile and adult
\item variants include:
\begin{itemize}
\item saposin B deficiency
\item multiple sulphatase deficiency (see Section \ref{sec:orgb85eddd})
\end{itemize}
\end{itemize}
\begin{enumerate}
\item Late-infantile
\label{sec:orgcd72820}
\begin{itemize}
...
\end{itemize}
\subsection{Fabry}
\label{sec:org85622eb}
\subsubsection{Introduction}
\label{sec:org761146e}
\begin{itemize}
...
\begin{itemize}
\item Gb3 is the Fabry lipid (Figure \ref{fig:org8039d1d})
\end{itemize}
...
\caption[Globotriaosylceramide]{\label{fig:org8039d1d}Globotriaosylceramide (Gb3): The Fabry lipid}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\textwidth]{fabry/figures/galactosidaseA.png}
\caption[\(\alpha\)-galactosidase A]{\label{fig:org7b28431}\(\alpha\)-Galactosidase A: Fabry}
\end{figure}


\subsubsection{Clinical Findings}
\label{sec:orga5a81c5}
\begin{itemize}
\item see table \ref{tab:orge64229f}
...
\item ocular lesions
\item angiokeratomas (Figure \ref{fig:org3bf5ee7})
\begin{itemize}
...
\caption[Angiokeratomas of the skin]{\label{fig:org3bf5ee7}Angiokeratomas of the Skin}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orge64229f}Fabry Signs and Symptoms}
\centering
\begin{tabular}{ll}
Age & Signs\\
\hline
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org3830671}induced by heat, cold, fatigue or emotional stress}

\subsubsection{Genetics}
\label{sec:org20ef52c}
\begin{itemize}
\item \textbf{XL GLA}
...
\end{itemize}
\subsubsection{Laboratory Investigations}
\label{sec:org4741e90}
\begin{enumerate}
\item Biochemistry
\label{sec:orgdb815ac}
\begin{itemize}
...
\caption[Fabry EM]{\label{fig:org71b24d0}EM Showing Lamellar Structure of Lysosomal Inclusions in Fabry Disease Renal Biopsy}
\end{figure}
\end{enumerate}
...
\end{itemize}
\subsection{Farber}
\label{sec:org9d26157}
\subsubsection{Introduction}
\label{sec:orga5a7b95}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orge5d511e}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\subsubsection{Clinical}
\label{sec:orge5c1edc}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgc0da8b1}
\begin{itemize}
\item none
\item HSCT trial with poor outcome
\end{itemize}
\section{Niemann-Pick C}
\label{sec:orgc00cb14}
\subsection{Introduction}
\label{sec:org367c486}
\begin{itemize}
...
\label{sec:orgb206d10}
\begin{enumerate}
\item Early Infantile
\label{sec:orga6048ba}
\begin{itemize}
...
\caption{\label{fig:org7541376}Filipin Staining (red:filipin stains cholesterol in lysosomes), green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:orgb77b7ee}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:org5baf9d7}
\subsection{Introduction}
\label{sec:org1a46b21}
\begin{itemize}
...
\subsection{Genetics}
\label{sec:org8bc2ac1}
\begin{itemize}
\item AR
\item adult form is AD
\end{itemize}
\subsection{Diagnostic Tests}
\label{sec:orgf4e8383}
\begin{itemize}
...
\caption[Proteoglycan Synthesis]{\label{fig:orgfe4511b}Proteoglycan Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{mps/figures/snfg.png}
\caption[Glycan Nomenclature]{\label{fig:orge12b97a}Symbol Nomenclature for Glycans (SNFG)}
\end{figure}
...
\caption[Glycosaminoglycans]{\label{fig:org6054ce9}Glycosaminoglycans}
\end{figure}

\begin{itemize}
\item GAGs are composed of repeating units of disaccharides (Figure \ref{fig:org6054ce9})
\begin{itemize}
\item hexosamine and a hexose or hexuronic acid
\end{itemize}

\item Online resource: Essentials of Glycobiology, 4th edition
\begin{itemize}
\item Chapter 44 : Genetic Disorders of Glycan Degradation
\item 
\end{itemize}
\item \url{https://www-ncbi-nlm-nih-gov.proxy.bib.uottawa.ca/books/NBK579918/}
\end{itemize}
\begin{enumerate}
\item Hyaluronan
\label{sec:orgf551554}
\begin{itemize}
...
\caption[DS Degradation]{\label{fig:org24c8d12}Dermatan Sulfate Degradation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{mps/figures/ks_degradation_disorders.png}
\caption[KS Degradation]{\label{fig:org79f508e}Keratan Sulfate Degradation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{mps/figures/hs_degradation_disorders.png}
\caption[HS Degradation]{\label{fig:org392093c}Heparan Sulfate Degradation}
\end{figure}
\end{enumerate}

\subsection{Multiple Sulfatase Deficiency}
\label{sec:org0fc1811}
\begin{itemize}
...
\label{sec:org99d21a4}
\subsubsection{Clinical Presentation}
\label{sec:org301e751}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org3478953}MPS Signs and Symptoms}
\centering
...
\label{sec:org3840905}
\begin{itemize}
\item MPS III (Sanfilippo)
\end{itemize}
\item Severe skeletal dysplasia
\label{sec:orga406053}
\begin{itemize}
\item MPS IV (Morquio)
\end{itemize}
\item Rare
\label{sec:orgb2d1972}
\begin{itemize}
\item MPS VII (Sly)
...
\caption[Glycosaminoglycan Degradation]{\label{fig:org0a3cb19}Glycosaminoglycan Degradation}
\end{figure}


\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:org39efefd}MPS Enzymes and Substrates}
\centering
\begin{tabular}{lllll}
...
\end{tabular}
\end{table}\footnotetext[6]{\label{org232ecf8}\(\beta\)-galactosidase deficiency also causes GM1 gangliosidosis}

\subsubsection{Genetics}
\label{sec:org56577cb}
\begin{itemize}
\item AR
...
\subsubsection{Diagnostic Tests}
\label{sec:orgd2e75ee}
\begin{itemize}
\item fractionation of urine GAGs (Table \ref{tab:org39efefd})
\begin{itemize}
...
\label{sec:org1aada50}
\subsection{Introduction}
\label{sec:org62e4a77}
\begin{itemize}
...
\caption{\label{fig:org03417ac}Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Oligosaccharidoses}
\label{sec:org176c487}
\subsubsection{Clinical Presentation}
\label{sec:org97fbb91}
\begin{itemize}
\item oligosaccharidoses share many features in common with MPS disorders (Table \ref{tab:org81f9b1b})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org81f9b1b}Oligosaccharidoses}
\centering
...
\subsubsection{Genetics}
\label{sec:orge126b63}
\begin{itemize}
\item AR
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org6820e2a}Oligosaccharidoses Genetics}
\centering
\begin{tabular}{lll}
Disease & Enzyme & Gene\\
\hline
...
\item enzyme activity assays (Table \ref{tab:org81f9b1b})
\end{itemize}

\subsubsection{Treatment}
\label{sec:org7f5de84}
\begin{itemize}
\item supportive
\end{itemize}
\section{Mucolipidoses}
\label{sec:org2f0712a}
\subsection{Introduction}
\label{sec:org4a1a9aa}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org70de312}Mucolipidoses}
\centering
\small
\begin{tabular}{lllllll}
Disease & Enzyme & dysostosis & progressive & angio- & hepato & sample\\
...
\label{sec:org59c6bd3}
\subsubsection{Clinical Presentation}
\label{sec:org4f65fe0}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgd0214f0}
\begin{itemize}
\item AR NEU1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgf85f286}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org47471aa}
\begin{itemize}
\item supportive
\end{itemize}

\subsection{ML II \& III}
\label{sec:org02d87ad}
\begin{itemize}
\item ML II AKA: I-Cell Disease
\item ML III AKA: Pseudo-Hurler
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orga7c08fb}
\begin{enumerate}
\item ML II
\label{sec:org434c602}
\begin{itemize}
\item low IQ
...
\begin{table}[htbp]
\caption{\label{tab:org9f0b72e}Lysosomal Enzyme Receptors}
\centering
\begin{tabular}{lll}
...
\caption[Protein trafficking to lysosomes]{\label{fig:orgca39a2a}Protein Trafficking to Lysosomes}
\end{figure}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:orgc2bf720}N-acetylglucosamine (GlcNAc) Phosphotransferase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[height=0.5\textwidth]{mucolipidosis/figures/icell.png}
\caption{\label{fig:org6790ba2}I-Cell in Fibroblast Culture}
\end{figure}

\subsubsection{Genetics}
\label{sec:org6ada890}
\begin{itemize}
\item AR GNPTAB
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgffe5fa4}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org0f2fd10}
\begin{itemize}
\item supportive
\end{itemize}
\subsection{ML IV}
\label{sec:org6bb88aa}
\subsubsection{Clinical Presentation}
\label{sec:orgbbefb74}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org0f32edb}
\begin{itemize}
\item AR MCOLN1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org8c68609}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orge20faf2}
\begin{itemize}
\item supportive
\end{itemize}

\section{Peroxisomes}
\label{sec:org6f7ec65}
\subsection{Introduction}
\label{sec:org9b981a8}
\begin{itemize}
...
\caption{\label{fig:org5293e4b}Non-Mitochondrial FA Metabolism}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:org2ac203f}Biochemical Findings in Peroxisomal Disease}
\centering
\begin{tabular}{llllll}
...
\label{sec:org7e2f94f}
\subsubsection{Clinical Presentation}
\label{sec:orga7db3c9}
\begin{itemize}
\item three forms:
\begin{enumerate}
...
\subsubsection{Genetics}
\label{sec:orgb80cdb7}
\begin{itemize}
\item \textbf{X-linked ABCD1}
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org6ced2da}
\begin{itemize}
...
\end{itemize}
\item see table \ref{tab:org2ac203f}
\end{itemize}
\subsubsection{Treatment}
\label{sec:org98ffd4f}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org708d7b6}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:orgc139af0}
\begin{itemize}
...
\label{sec:orgb071c9c}
\subsubsection{Clinical Presentation}
\label{sec:org10d61f6}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:orgc0eef42}Oxidation of Phytanic Acid}
\end{figure}

\subsubsection{Genetics}
\label{sec:org66775bf}
\begin{itemize}
\item AR PHYH
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgd6eeb2d}
\begin{itemize}
...
\label{sec:org0cf92e1}
\subsubsection{Clinical Presentation}
\label{sec:org30f99f4}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org32b3c13}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgaef3c36}
\begin{itemize}
...
\label{sec:orgdb5e152}
\subsubsection{Clinical Presentation}
\label{sec:org78f28f0}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:orgfccd5d9}
\begin{enumerate}
\item RCDP Type 1
\label{sec:orgdb5c9c9}
\begin{itemize}
...
\caption{\label{fig:orgb76b421}Eicosanoid Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org54b3fb4}
\begin{itemize}
...
\label{sec:org48bf633}
\subsection{Introduction}
\label{sec:org85eedf5}
\begin{itemize}
...
\caption{\label{fig:orgea959e8}Congenital Disorders of Glycosylation}
\end{figure}

\subsubsection{Congenital Disorders of Glycosylation}
\label{sec:org68ad1f4}
\begin{itemize}
...
\caption{\label{fig:orgbfde7be}Diagnosis of Congenital Disorders of Glycosylation}
\end{figure}

\begin{enumerate}
\item Treatable CDGs
\label{sec:org7d7035b}
\begin{description}
...
\label{sec:org051633a}
\subsubsection{CDG IA (PMM2-CDG)}
\label{sec:orge50ab68}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org724bd91}
\begin{itemize}
...
\item Genetics
\label{sec:org0006ccf}
\begin{itemize}
\item AR PMM2
\end{itemize}

\item Diagnostic Tests
\label{sec:org4b30e37}
\begin{itemize}
...
\end{itemize}
\item see figure \ref{fig:orgbfde7be}
\end{itemize}

\item Treatment
\label{sec:orgdaa75ed}
\begin{itemize}
...
\item Genetics
\label{sec:orgd0e8a60}
\begin{itemize}
\item AR, MPI
\end{itemize}

\item Diagnostic Tests
\label{sec:org2c9933f}
\begin{itemize}
...
\label{sec:org436bcb1}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org329a6b9}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org38c5a44}
\begin{itemize}
\item AR ALG6
\end{itemize}
\item Diagnostic Tests
\label{sec:orgb7d1b42}
\begin{itemize}
\item transferrin IEF - Type I pattern
...
\label{sec:org83df033}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org66a4af4}
\begin{itemize}
...
\label{sec:orge6a40ae}
\subsubsection{CDG IIa (MGAT2-CDG)}
\label{sec:orgb93dab1}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org56c49de}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org029db34}
\begin{itemize}
\item AR MGAT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org9c6db19}
\begin{itemize}
...
\end{itemize}
\item Treatment
\label{sec:orgf6e4c14}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\subsubsection{CDG IIc SLC35C1-CDG}
\label{sec:orgec101f7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0eee56f}
\begin{itemize}
...
neutrophilia
\item Bombay (hh) blood phenotype (Figure \ref{fig:org2c91673})
\begin{itemize}
\item do not express H antigen
\end{itemize}
\end{itemize}
\item Metabolic Derangement
\label{sec:org29b4ca0}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org2365116}
\begin{itemize}
\item AR SLC35C1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgfa16cf3}
\begin{itemize}
...
\caption[Hh]{\label{fig:org2c91673}Bombay (hh) Blood Group}
\end{figure}
\end{enumerate}
\section{Cystinosis}
\label{sec:org98817aa}
\subsection{Introduction}
\label{sec:orgc363558}
\begin{itemize}
...
\caption{\label{fig:org868fd26}Cystine}
\end{figure}

\begin{itemize}
\item normally exported by a cystine porter which contains the membrane protein cystinosin (Figure \ref{fig:orgb3c8df1})
\begin{itemize}
...
\caption{\label{fig:orgb3c8df1}Lysosomal Export of Cystine and Related Compounds. The cross represents the defect in cystinosis}
\end{figure}
...
marrow
\end{enumerate}
\item nephropathic or infantile form is by far the most frequent (Section \ref{sec:org929063b})
...
\label{sec:org929063b}
\subsubsection{Clinical Presentation}
\label{sec:org28ce339}
\begin{enumerate}
\item First stage
\label{sec:org8468256}
\begin{itemize}
...
\label{sec:org0060816}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:orgf6a3d34}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org508b2c9}
\begin{itemize}
\item AR CTNS
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orga844423}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org6a2aa78}
\begin{enumerate}
\item Supportive
\label{sec:org66b734c}
\begin{itemize}
