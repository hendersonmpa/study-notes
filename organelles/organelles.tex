...
\label{sec:org8a9f69d}
\subsection{Introduction}
\label{sec:org4e9f0dc}
\subsubsection{Sphingolipids}
\label{sec:orgbbd206b}
\begin{itemize}
...
\label{sec:org35f5b5e}
\begin{enumerate}
\item ER
\label{sec:org7eb0f2c}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:org2e3bf4b}Sphingolipid Structure}
\end{figure}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org8126ea6}Sphingolipid Biosynthesis}
\end{figure}
\end{enumerate}

\subsection{Disorders of Sphingolipid Synthesis}
\label{sec:orgff81797}
\subsubsection{Classification}
\label{sec:org8d41952}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:orgbc61ca2}
\begin{description}
...
\label{sec:org3679389}

\begin{table}[htbp]
\caption{\label{tab:org07823ea}Sphingolipidoses}
\centering
\begin{tabular}{llll}
...
\caption{\label{fig:orgb1063d8}Sphingolipid Degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:org73a7ca3}
\begin{itemize}
...
\caption{\label{fig:org643ffa8}Protein Trafficking to Lysosome}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./figures/lysosome_trafficking.jpeg}
\caption{\label{fig:orgd803758}Lysosomal Protein Trafficking Receptors}
\end{figure}

\subsubsection{M6P receptors}
\label{sec:org36b94ec}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:orgb2cc70c}
\subsubsection{Introduction}
\label{sec:orgf83877b}
\begin{itemize}
...
\label{sec:org28e98ca}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{gaucher/figures/Gaucher_Cells_with_Fibrillar_Appearing_Cytoplasm.jpg}
\caption{\label{fig:org23da9a3}Gaucher Cells in a Bone Marrow Smear}
\end{figure}

\begin{enumerate}
\item Biochemistry
\label{sec:orgead8dbc}
\begin{itemize}
...
\label{sec:orgb983246}
\begin{enumerate}
\item Bone marrow transplantation
\label{sec:org0e329af}
\begin{itemize}
...
\subsubsection{Clinical Findings}
\label{sec:org3fa5671}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:orgb15902f}
\begin{itemize}
...
urine & \footnotemark & \textsuperscript{\ref{org1af4df8}} & \textsuperscript{\ref{org1af4df8}} & keratan sulfate \footnotemark\\
 &  &  &  & \\
\end{tabular}
\end{table}\footnotetext[1]{\label{orga6833cb}corneal clouding}\footnotetext[2]{\label{orgca9990a}secondary to bony changes}\footnotetext[3]{\label{org1af4df8}oligosacaride with terminal galactose}\footnotetext[4]{\label{orgd44fda4}FN have been observed}
...
\begin{table}[htbp]
\caption{\label{tab:org3a10c6b}Hexoaminidase Isozymes}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:orgbe65238}GM2 ganglioside storage diseases}
\centering
\begin{tabular}{llrll}
...
\caption{\label{fig:org350c047}Hexosaminidase A: Tay-Sachs}
\end{figure}
...
\caption{\label{fig:org03a728f}Hexosaminidase A \& B:Sandhoff disease (GL-3 \& 4 equivalent to Gb3 \& 4)}
\end{figure}


\subsubsection{Clinical Findings}
\label{sec:orgab39091}
\begin{itemize}
\item see table \ref{tab:org9cfbec9}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:org9cfbec9}GM2 Signs and Symptoms}
\centering
\begin{tabular}{llll}
...
\caption{\label{fig:orgf91718e}NBS Follow-up at Mayo}
\end{figure}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org8c65aa3}induced by heat, cold, fatigue or emotional stress}
...
\end{itemize}
\subsection{Farber}
\label{sec:orga826fac}
\subsubsection{Introduction}
\label{sec:orgb967007}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgea935b9}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\subsubsection{Clinical}
\label{sec:org36025a1}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org67da873}
\begin{itemize}
\item none
\item HSCT trial with poor outcome
\end{itemize}
\section{Niemann-Pick C}
\label{sec:orga233b29}
\subsection{Introduction}
\label{sec:org9e88d11}
\begin{itemize}
...
\label{sec:org888387f}
\begin{enumerate}
\item Early Infantile
\label{sec:org37c401f}
\begin{itemize}
...
\label{sec:org068b587}
\subsection{Introduction}
\label{sec:orgcd41a33}
\begin{itemize}
...
\subsection{Genetics}
\label{sec:org4fe2fa3}
\begin{itemize}
\item AR
\item adult form is AD
\end{itemize}
\subsection{Diagnostic Tests}
\label{sec:org3d8e374}
\begin{itemize}
...
\caption[Proteoglycan Synthesis]{\label{fig:org0b3fd85}Proteoglycan Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{mps/figures/snfg.png}
\caption[Glycan Nomenclature]{\label{fig:org9dfd573}Symbol Nomenclature for Glycans (SNFG)}
\end{figure}
...
\caption[Glycosaminoglycans]{\label{fig:orgc622501}Glycosaminoglycans}
\end{figure}

\begin{itemize}
\item GAGs are composed of repeating units of disaccharides (Figure \ref{fig:orgc622501})
\begin{itemize}
...
\label{sec:org32f9897}
\subsubsection{Clinical Presentation}
\label{sec:org8b0e337}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org5b28acd}MPS Signs and Symptoms}
\centering
...
\caption[Glycosaminoglycan Degradation]{\label{fig:orgaa8779f}Glycosaminoglycan Degradation}
\end{figure}


\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:orge5b00fa}MPS Enzymes and Substrates}
\centering
\begin{tabular}{lllll}
...
\end{tabular}
\end{table}\footnotetext[6]{\label{org7fe169d}\(\beta\)-galactosidase deficiency also causes GM1 gangliosidosis}

\subsubsection{Genetics}
\label{sec:orgcec1343}
\begin{itemize}
\item AR
\item \textbf{MPS II Hunter is XLR}
\item see table \ref{tab:orge5b00fa}
\end{itemize}
\subsubsection{Diagnostic Tests}
...
\label{sec:org7973768}
\subsection{Introduction}
\label{sec:orge8047e1}
\begin{itemize}
...
\caption{\label{fig:orgdca277e}Glycoprotein Oligosaccharide Chain}
\end{figure}
...
\subsubsection{Treatment}
\label{sec:orgb514a72}
\begin{itemize}
\item supportive
\end{itemize}

\subsection{ML II \& III}
\label{sec:org8d2ed99}
\begin{itemize}
\item ML II AKA: I-Cell Disease
\item ML III AKA: Pseudo-Hurler
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgd5e4816}
\begin{enumerate}
\item ML II
\label{sec:org41d2bca}
\begin{itemize}
\item low IQ
...
\end{itemize}
\subsection{ML IV}
\label{sec:org069fe0a}
\subsubsection{Clinical Presentation}
\label{sec:orgb63b544}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org5d905f6}
\begin{itemize}
\item AR MCOLN1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgf099cf8}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org414ef64}
\begin{itemize}
\item supportive
\end{itemize}

\section{Peroxisomes}
\label{sec:orga82eadc}
\subsection{Introduction}
\label{sec:orgb109498}
\begin{itemize}
...
\caption{\label{fig:org99b2685}Non-Mitochondrial FA Metabolism}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:org1020f52}Biochemical Findings in Peroxisomal Disease}
\centering
\begin{tabular}{llllll}
...
\label{sec:org73e7056}
\subsubsection{Clinical Presentation}
\label{sec:org3171af9}
\begin{itemize}
\item three forms:
\begin{enumerate}
...
\subsubsection{Clinical Presentation}
\label{sec:org5e09820}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:org6b61b54}
\begin{itemize}
...
\label{sec:orgb1e8e12}
\subsubsection{Clinical Presentation}
\label{sec:org5ed2b1b}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org67f4d2d}Oxidation of Phytanic Acid}
\end{figure}
...
\label{sec:orgbd4239b}
\subsubsection{Clinical Presentation}
\label{sec:orga41d2b1}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org3abb0d4}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org8b47dea}
\begin{itemize}
...
\label{sec:org6d4703f}
\subsubsection{Clinical Presentation}
\label{sec:org753ab4f}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:orga78ee8d}
\begin{enumerate}
\item RCDP Type 1
\label{sec:org2c9131c}
\begin{itemize}
...
\caption{\label{fig:org25018ef}Eicosanoid Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org77206de}
\begin{itemize}
...
\label{sec:orga3248bd}
\subsection{Introduction}
\label{sec:org08823ee}
\begin{itemize}
...
\label{sec:org1198092}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2dd2771}
\begin{itemize}
...
\label{sec:orgebb2dab}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4e9c7a9}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org45430e9}
\begin{itemize}
\item AR ALG6
\end{itemize}
\item Diagnostic Tests
\label{sec:orgc184940}
\begin{itemize}
\item transferrin IEF - Type I pattern
...
\label{sec:org65be82b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge98fc68}
\begin{itemize}
...
marrow
\end{enumerate}
\item nephropathic or infantile form is by far the most frequent (Section \ref{sec:org4070820})
...
\label{sec:org4070820}
\subsubsection{Clinical Presentation}
\label{sec:org798ca03}
\begin{enumerate}
\item First stage
\label{sec:orgcf7accc}
\begin{itemize}
...
\label{sec:orgc0dd9ed}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org18938a9}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org29a1575}
\begin{itemize}
\item AR CTNS
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgeab194e}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org9f5fac6}
\begin{enumerate}
\item Supportive
\label{sec:org0c2c72d}
\begin{itemize}
