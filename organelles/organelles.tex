...
\label{sec:org1e7cebd}
\subsection{Introduction}
\label{sec:orgfa23bed}
\subsubsection{Sphingolipids}
\label{sec:orgc425bfb}
\begin{itemize}
...
\label{sec:org8dc7d57}
\begin{enumerate}
\item ER
\label{sec:org8ea3310}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:orgaeeced7}Sphingolipid Structure}
\end{figure}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org5eee3c9}Sphingolipid Biosynthesis}
\end{figure}
\end{enumerate}

\subsection{Disorders of Sphingolipid Synthesis}
\label{sec:org9c67969}
\subsubsection{Classification}
\label{sec:org0592bdb}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org50d120c}
\begin{description}
...
\label{sec:org9cfb2e7}

\begin{table}[htbp]
\caption{\label{tab:org4a417f1}Sphingolipidoses}
\centering
\begin{tabular}{llll}
...
\caption{\label{fig:orgf919850}Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:org044f678}
\begin{itemize}
...
\caption{\label{fig:orgb0cb786}Protein Trafficking to Lysosome}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./figures/lysosome_trafficking.jpeg}
\caption[Lysosomal protein trafficking receptors]{\label{fig:orgc750345}Lysosomal protein trafficking receptors}
\end{figure}

\subsubsection{M6P receptors}
\label{sec:orge3965d3}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:org97111e6}
\subsubsection{Introduction}
\label{sec:org66eba23}
\begin{itemize}
...
\caption{\label{fig:org6838352}Glucocerebroside the Gaucher Lipid}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{gaucher/figures/glucocerebrosidase.png}
\caption{\label{fig:org9610f27}\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}


\subsubsection{Clinical Findings}
\label{sec:org03cadd7}
\begin{itemize}
\item see table \ref{tab:org91f1a34}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org91f1a34}Gaucher Clinical Variants}
\centering
\begin{tabular}{llll}
...
\label{sec:org9a0dfec}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{gaucher/figures/Gaucher_Cells_with_Fibrillar_Appearing_Cytoplasm.jpg}
\caption{\label{fig:org3db17b5}Gaucher Cells in a bone marrow smear}
\end{figure}

\begin{enumerate}
\item Biochemistry
\label{sec:orgd63d5eb}
\begin{itemize}
...
\label{sec:orga14e210}
\begin{enumerate}
\item Bone marrow transplantation
\label{sec:org6aa9ac6}
\begin{itemize}
...
\label{sec:org654a7af}
\subsubsection{Introduction}
\label{sec:org3ed9ce1}
\begin{itemize}
...
\caption{\label{fig:org6ba2888}Sphingomyelin}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{niemann_pick/figures/sphingomyelinase.png}
\caption{\label{fig:orgc06c30f}Sphingomyelinase}
\end{figure}

\subsubsection{Clinical Findings}
\label{sec:org3358276}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:orgd07356e}
\begin{itemize}
...
\end{itemize}
\item foam cells in bone marrow (Figure \ref{fig:orgc12d96f})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{niemann_pick/figures/foam_cells.png}
\caption{\label{fig:orgc12d96f}Foam cells in bone marrow}
\end{figure}

\subsubsection{Treatment}
\label{sec:orge441d48}
\begin{itemize}
...
\label{sec:org1a6457d}
\subsubsection{Introduction}
\label{sec:orgdc260a0}
\begin{itemize}
\item defect in \textbf{\(\beta\)-galactosidase (AKA: \(\beta\)-gangliosidase)}
\begin{itemize}
\item removes galactose from GM1, keratin sulfate and some oligosaccharides (Figure \ref{fig:org2457366})
\end{itemize}
...
\caption{\label{fig:org2457366}\(\beta\)-galactosidase}
\end{figure}


\begin{enumerate}
\item Lysosomal multi-enzyme complex
\label{sec:org5ff93b4}
\begin{itemize}
...
\subsubsection{Clinical Findings}
\label{sec:org06529dc}
\begin{itemize}
\item see table \ref{tab:orgc8eec20}
\item a cause of non-immune fetal hydrops
\end{itemize}
\begin{table}[htbp]
\caption[GM1 Signs and Symptoms]{\label{tab:orgc8eec20}GM1 Signs and Symptoms}
\centering
\begin{tabular}{lllll}
...
coarse facial features & \textpm{} & - & - & \textsuperscript{\ref{org75e1ab6}}\\
skeletal findings & + & \textpm{} & - & +\\
urine & \footnotemark & \textsuperscript{\ref{org09bf730}} & \textsuperscript{\ref{org09bf730}} & keratan sulfate \footnotemark\\
\end{tabular}
\end{table}\footnotetext[1]{\label{orga8f1074}corneal clouding}\footnotetext[2]{\label{org75e1ab6}secondary to bony changes}\footnotetext[3]{\label{org09bf730}oligosacaride with terminal galactose}\footnotetext[4]{\label{org8888fc5}FN have been observed}

\subsubsection{Genetics}
\label{sec:org1dad4bc}
\begin{itemize}
\item AR GLB1
...
and \(\beta\) subunits (Table \ref{tab:orge5ea475})
\end{itemize}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orge5ea475}Hexoaminidase Isozymes}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:orgbf3ead0}GM2 ganglioside storage diseases}
\centering
\begin{tabular}{llrll}
...
\caption{\label{fig:org2988353}Hexosaminidase A: Tay-Sachs}
\end{figure}
...
\caption{\label{fig:org0693b01}Hexosaminidase A \& B:Sandhoff disease [fn:gl]}
\end{figure}

\subsubsection{Clinical Findings}
\label{sec:org48f18e2}
\begin{itemize}
\item see table \ref{tab:org2338c84}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:org2338c84}GM2 Signs and Symptoms}
\centering
\begin{tabular}{llll}
...
\subsubsection{Treatment}
\label{sec:org71a6a62}
\begin{itemize}
\item treat seizures
\item no curative treatment to date
\end{itemize}
\subsection{Krabbe}
\label{sec:org7b7aae9}
\subsubsection{Introduction}
\label{sec:org9c09fa2}
\begin{itemize}
...
\caption{\label{fig:org82f2f70}Galactocerebrosidase}
\end{figure}
...
\caption{\label{fig:orgbc974d0}NBS follow-up at Mayo}
\end{figure}
...
\begin{enumerate}
\item Treatment
\label{sec:orgbb74e3c}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:orgcedb18e}
\begin{itemize}
...
\label{sec:org9f0793b}
\subsubsection{Introduction}
\label{sec:org7355f31}
\begin{itemize}
...
\label{sec:orgf72edca}
\begin{itemize}
\item three forms: late infantile-onset, juvenile and adult
\item variants include:
\begin{itemize}
\item saposin B deficiency
\item multiple sulphatase deficiency (see Section \ref{sec:orga41cec9})
\end{itemize}
\end{itemize}
\begin{enumerate}
\item Late-infantile
\label{sec:orgb8a4624}
\begin{itemize}
...
\end{itemize}
\subsection{Fabry}
\label{sec:org7a4a879}
\subsubsection{Introduction}
\label{sec:org8d192fb}
\begin{itemize}
...
(Figure \ref{fig:org9610f27})
\item accumulation of Gb3 in blood vessels and other tissues
\begin{itemize}
\item Gb3 is the Fabry lipid (Figure \ref{fig:orgc9e29e8})
\end{itemize}
...
\caption[Globotriaosylceramide]{\label{fig:orgc9e29e8}Globotriaosylceramide (Gb3): the Fabry lipid}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\textwidth]{fabry/figures/galactosidaseA.png}
\caption[\(\alpha\)-galactosidase A]{\label{fig:org91e22b1}\(\alpha\)-galactosidase A, located in the lumen of lysosomes}
\end{figure}


\subsubsection{Clinical Findings}
\label{sec:orgb435e88}
\begin{itemize}
\item see table \ref{tab:org949d3ea}
...
\item ocular lesions
\item angiokeratomas (Figure \ref{fig:org29fa6d8})
\begin{itemize}
...
\caption[Angiokeratomas of the skin]{\label{fig:org29fa6d8}Angiokeratomas of the Skin}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org949d3ea}Fabry Signs and Symptoms}
\centering
\begin{tabular}{ll}
Age & Signs\\
\hline
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org8780964}induced by heat, cold, fatigue or emotional stress}

\subsubsection{Genetics}
\label{sec:org91af2df}
\begin{itemize}
\item \textbf{XL GLA}
...
\subsubsection{Laboratory Investigations}
\label{sec:org798527a}
\begin{enumerate}
\item Biochemistry
\label{sec:orga892d57}
\begin{itemize}
...
\caption[Fabry EM]{\label{fig:orgaabd081}EM showing concentric or lamellar structure of lysosomal inclusions in Fabry disease renal biopsy}
\end{figure}
\end{enumerate}

\subsubsection{Treatment}
\label{sec:orgb4596fb}
\begin{itemize}
\item alleviate pain
\begin{itemize}
...
\end{itemize}
\subsection{Farber}
\label{sec:orge2d9bff}
\subsubsection{Introduction}
\label{sec:org2b84e72}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orge0fd631}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\subsubsection{Clinical}
\label{sec:orgb987b33}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgab0d097}
\begin{itemize}
\item none
\end{itemize}
\section{Niemann-Pick C}
\label{sec:org2cea6d6}
\subsection{Introduction}
\label{sec:org8d27095}
\begin{itemize}
...
\label{sec:orga17b42e}
\begin{enumerate}
\item Early Infantile
\label{sec:org0fba3b3}
\begin{itemize}
...
\subsection{Genetics}
\label{sec:org356af45}
\begin{itemize}
\item AR NPC1 (95\%) and NPC2 (5\%)
\end{itemize}
\subsection{Diagnostic Tests}
\label{sec:orgb63c242}
\begin{itemize}
...
\caption{\label{fig:orgb9500d8}Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:org1b40616}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:org3364d0e}
\subsection{Introduction}
\label{sec:orgb7a4723}
\begin{itemize}
...
\subsection{Genetics}
\label{sec:org89d9439}
\begin{itemize}
\item AR
\item adult form is AD
\end{itemize}
\subsection{Diagnostic Tests}
\label{sec:org5dae0c1}
\begin{itemize}
...
\caption[Proteoglycan Synthesis]{\label{fig:org13906ad}Proteoglycan Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{mps/figures/snfg.png}
\caption[Glycan Nomenclature]{\label{fig:org8719071}Symbol Nomenclature for Glycans (SNFG)}
\end{figure}
...
\caption[Glycosaminoglycans]{\label{fig:orgd19084c}Glycosaminoglycans}
\end{figure}

\begin{itemize}
\item GAGs are composed of repeating units of disaccharides (Figure \ref{fig:orgd19084c})
\begin{itemize}
...
\caption[DS Degradation]{\label{fig:orgf601cda}DS degradation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{mps/figures/ks_degradation_disorders.png}
\caption[KS Degradation]{\label{fig:org4ebc8c9}KS degradation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{mps/figures/hs_degradation_disorders.png}
\caption[HS Degradation]{\label{fig:org50738e1}HS Degradation}
\end{figure}
\end{enumerate}

\subsection{Multiple Sulfatase Deficiency}
\label{sec:org496606b}
\begin{itemize}
...
\label{sec:org1d2bb85}
\subsubsection{Clinical Presentation}
\label{sec:orgf4b6b47}
\begin{itemize}
...
\label{sec:orgfa13519}
\begin{itemize}
\item MPS III (Sanfilippo)
\end{itemize}
\item Severe skeletal dysplasia
\label{sec:orgafe3ce7}
\begin{itemize}
\item MPS IV (Morquio)
\end{itemize}
\item Rare
\label{sec:org7070605}
\begin{itemize}
\item MPS VII (Sly)
...
\begin{table}[htbp]
\caption{\label{tab:org2c242d1}MPS Signs and Symptoms}
\centering
...
\caption[Glycosaminoglycan Degradation]{\label{fig:org3cf0db8}Glycosaminoglycan Degradation}
\end{figure}


\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:org3c35047}MPS Enzymes and Substrates}
\centering
\begin{tabular}{lllll}
...
\subsubsection{Diagnostic Tests}
\label{sec:orgdbd4c5d}
\begin{itemize}
\item quantitation of urine GAGs (Table \ref{tab:org3c35047})
\begin{itemize}
...
\label{sec:org1bd34ed}
\subsection{Introduction}
\label{sec:org4708b14}
\begin{itemize}
...
\caption{\label{fig:orgf03c72f}Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Oligosaccharidoses}
\label{sec:org5b5832e}
\subsubsection{Clinical Presentation}
\label{sec:orgb1bbdb3}
\begin{itemize}
\item oligosaccharidoses share many features in common with MPS disorders (Table \ref{tab:orgf59f84e})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgf59f84e}Oligosaccharidoses}
\centering
...
\subsubsection{Genetics}
\label{sec:org08dbde8}
\begin{itemize}
\item AR
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org768067c}
\begin{itemize}
...
\item enzyme activity assays (Table \ref{tab:orgf59f84e})
\end{itemize}

\subsubsection{Treatment}
\label{sec:orgac9030c}
\begin{itemize}
\item supportive
\end{itemize}
\section{Mucolipidoses}
\label{sec:orgada59a8}
\subsection{Introduction}
\label{sec:org570bd17}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org7e9d866}Mucolipidoses}
\centering
\small
\begin{tabular}{lllllll}
Disease & enzyme & dysostosis & progressive & angio- & hepato & sample\\
...
\label{sec:org743e4f9}
\subsubsection{Clinical Presentation}
\label{sec:orgfbf6cbc}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org64fcf35}
\begin{itemize}
\item supportive
\end{itemize}

\subsection{ML II \& III}
\label{sec:org81431b9}
\begin{itemize}
\item ML II AKA: I-Cell Disease
\item ML III AKA: Pseudo-Hurler
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgded0a56}
\begin{enumerate}
\item ML II
\label{sec:org26ee48a}
\begin{itemize}
\item low IQ
...
\begin{table}[htbp]
\caption{\label{tab:orge116e82}Lysosomal enzyme receptors}
\centering
\begin{tabular}{lll}
...
\caption[Protein trafficking to lysosomes]{\label{fig:orgac3ffec}Protein trafficking to lysosomes}
\end{figure}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org20e97c0}N-acetylglucosamine (GlcNAc) phosphotransferase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[height=0.5\textwidth]{mucolipidosis/figures/icell.png}
\caption{\label{fig:orga7a41b3}I cell in fibroblast culture}
\end{figure}

\subsubsection{Genetics}
\label{sec:org34b030e}
\begin{itemize}
\item AR GNPTAB
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org1c86d4a}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org8df4773}
\begin{itemize}
\item supportive
\end{itemize}
\subsection{ML IV}
\label{sec:orgbd51382}
\subsubsection{Clinical Presentation}
\label{sec:org41e32c1}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgcb43d1d}
\begin{itemize}
\item AR MCOLN1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org58e794c}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgecda811}
\begin{itemize}
\item supportive
\end{itemize}

\section{Peroxisomes}
\label{sec:org14cefde}
\subsection{Introduction}
\label{sec:orgf160de5}
\begin{itemize}
...
\caption[Non-mitochondrial FA metabolism]{\label{fig:orgf9a0284}Non-mitochondrial FA metabolism}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:org0f5f7fe}Biochemical Findings in Peroxisomal Disease}
\centering
\begin{tabular}{llllll}
...
\label{sec:org1d65976}
\subsubsection{Clinical Presentation}
\label{sec:orgf6f9e20}
\begin{itemize}
\item three forms:
\begin{enumerate}
...
\subsubsection{Genetics}
\label{sec:org905fcfd}
\begin{itemize}
\item \textbf{X-linked ABCD1}
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgdee51e9}
\begin{itemize}
...
\end{itemize}
\item see table \ref{tab:org0f5f7fe}
\end{itemize}
\subsubsection{Treatment}
\label{sec:org1a262af}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orgacb8b7f}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:orgb7afa01}
\begin{itemize}
...
\label{sec:org8c3c8ee}
\subsubsection{Clinical Presentation}
\label{sec:org309dd2b}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org47ebe3c}Oxidation of Phytanic Acid}
\end{figure}

\subsubsection{Genetics}
\label{sec:orgfb5aaae}
\begin{itemize}
\item AR PHYH
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgffbd4bc}
\begin{itemize}
...
\label{sec:orgaebf0b2}
\subsubsection{Clinical Presentation}
\label{sec:orgdf2195b}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org26df934}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org83946e7}
\begin{itemize}
...
\label{sec:org83f4df7}
\subsubsection{Clinical Presentation}
\label{sec:org82d1316}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:orgb51cf32}
\begin{enumerate}
\item RCDP Type 1
\label{sec:orgca1f56f}
\begin{itemize}
...
\caption{\label{fig:org49001d0}Eicosanoid Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org01e27b5}
\begin{itemize}
...
\label{sec:org2cff745}
\subsection{Introduction}
\label{sec:orgf9aa9d2}
\begin{itemize}
...
\caption{\label{fig:orgc91b5cb}CDGs}
\end{figure}

\subsubsection{Congenital Disorders of Glycosylation}
\label{sec:org54b5a80}
\begin{itemize}
...
\caption{\label{fig:orgf2f4563}CDG diagnosis}
\end{figure}

\subsection{CDG Ia (PMM2-CDG)}
\label{sec:org6656b92}
\subsubsection{Clinical Presentation}
\label{sec:orge8c6cbd}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org6dca133}
\begin{itemize}
\item AR PMM2
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgbc9d451}
\begin{itemize}
...
\item see figure \ref{fig:orgf2f4563}
\end{itemize}

\subsubsection{Treatment}
\label{sec:org29df7bb}
\begin{itemize}
\item no effective treatment is available
\end{itemize}

\subsection{CDG Ib (MPI-CDG)}
\label{sec:org0a78a71}
\subsubsection{Clinical Presentation}
\label{sec:org466c6e4}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org566d294}
\begin{itemize}
\item AR, MPI
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org83ac146}
\begin{itemize}
...
\label{sec:org39e87d7}
\subsubsection{CDG IIa (MGAT2-CDG)}
\label{sec:org5b6c752}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org50213de}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:orge044af0}
\begin{itemize}
\item AR MGAT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org5d17bea}
\begin{itemize}
...
\end{itemize}
\item Treatment
\label{sec:orgca0d3a6}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\subsubsection{CDG IIc SLC35C1-CDG}
\label{sec:org6a09196}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0eedc33}
\begin{itemize}
...
neutrophilia
\item Bombay (hh) blood phenotype (Figure \ref{fig:orgecf9756})
\begin{itemize}
\item do not express H antigen
\end{itemize}
\end{itemize}
\item Metabolic Derangement
\label{sec:org91af8a2}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:orgddb7331}
\begin{itemize}
\item AR SLC35C1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd61f42c}
\begin{itemize}
...
\caption[Hh]{\label{fig:orgecf9756}Bombay (hh) Blood Group}
\end{figure}
\end{enumerate}
\section{Cystinosis}
\label{sec:org5934a5c}
\subsection{Introduction}
\label{sec:orgff68ad0}
\begin{itemize}
...
\caption{\label{fig:org7d67554}Cystine}
\end{figure}

\begin{itemize}
\item normally exported by a cystine porter which contains the membrane protein cystinosin (Figure \ref{fig:orgdf2dd7c})
\begin{itemize}
...
\caption{\label{fig:orgdf2dd7c}Lysosomal export of cystine and related compounds. The cross represents the defect in cystinosis}
\end{figure}
...
marrow
\end{enumerate}
\item nephropathic or infantile form is by far the most frequent (Section \ref{sec:org6cf008a})
...
\label{sec:org6cf008a}
\subsubsection{Clinical Presentation}
\label{sec:orgacaf41e}
\begin{enumerate}
\item First stage
\label{sec:org4d7c651}
\begin{itemize}
...
\label{sec:org795eaa3}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org572d513}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgdf893fe}
\begin{itemize}
\item AR, CTNS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org5612ed2}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org1f28a1a}
\begin{enumerate}
\item Supportive
\label{sec:org567e5a0}
\begin{itemize}
