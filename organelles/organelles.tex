...
\label{sec:orgc3f5467}
\subsection{Introduction}
\label{sec:orgd009f28}
\begin{enumerate}
\item Sphingolipids
\label{sec:orgd554d4e}
\begin{itemize}
...
\item Biosynthesis
\label{sec:orga9fbd3a}
\begin{enumerate}
\item ER
\label{sec:orgdbe1b2e}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:org91304a9}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org14c9755}
...
\label{sec:orgf5c7ec2}
\begin{enumerate}
\item Classification
\label{sec:org440c2e0}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org1858a92}
\begin{itemize}
...
\label{sec:orga15ac1b}

\begin{table}[htbp]
\caption{\label{tab:org6f18574}
...
\caption{\label{fig:orgec067c8}
Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosome}
\label{sec:org7e1a09b}
\begin{itemize}
...
\caption[Lysosomal protein trafficking receptors]{\label{fig:orgf732955}
Lysosomal protein trafficking receptors}
\end{figure}

\subsection{M6P receptors}
\label{sec:org55fb5bc}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:org9885f7a}
\begin{enumerate}
\item Introduction
\label{sec:org46f8584}
\begin{itemize}
...
\caption{\label{fig:orgcdc4827}
\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}

\item Genetics
\label{sec:org502d4db}
\begin{itemize}
...
\label{sec:org9270df5}
\begin{table}[htbp]
\caption{\label{tab:org7f04193}
...
\item Treatment
\label{sec:org6464500}
\begin{enumerate}
\item Bone marrow transplantation
\label{sec:org731ba41}
\begin{itemize}
...
\caption{\label{fig:org4b85713}
Sphingomyelinase}
\end{figure}

\item Genetics
\label{sec:orgcf3a172}
\begin{itemize}
...
\item Clinical Findings
\label{sec:orgff533b6}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:org4484a02}
\begin{itemize}
...
\caption{\label{fig:org71206d3}
Foam cells in bone marrow}
\end{figure}

\item Treatment
\label{sec:org0d07366}
\begin{itemize}
...
\label{sec:org022fd3b}
\begin{enumerate}
\item Introduction
\label{sec:org980be59}
...
\item Clinical Findings
\label{sec:orgcd3e6fc}

\begin{table}[htbp]
\caption[GM1 Signs and Symptoms]{\label{tab:org39d9227}
...
Hepatosplenomegaly & + & +/– & – & –\\
Cardiac involvement & +/– & +/– & +/– & +\\
Coarse facial features & +/– & – & – & \textsuperscript{\ref{org9b77c6d}}\\
Skeletal findings & + & +/– & – & +\\
Neuroimaging & PA & PA & +/– mild atrophy & \textsuperscript{\ref{org9b77c6d}}\\
Urine (GAG) & \footnotemark & \textsuperscript{\ref{org3012861}} & \textsuperscript{\ref{org3012861}} & Keratan sulfate \footnotemark\\
\end{tabular}
\end{table}\footnotetext[1]{\label{org9b77c6d}secondary to bony changes}\footnotetext[2]{\label{org3012861}oligosacaride with terminal galactose}\footnotetext[3]{\label{org43b804f}FN have been observed}

\item Laboratory Investigations
\label{sec:org2f2fe68}
\begin{itemize}
...
\caption{\label{fig:org01dd8a4}
Hexosaminidase A \& B:Sandhoff disease}
\end{figure}

\item Genetics
\label{sec:org7253a57}
\begin{itemize}
...
\item Clinical Findings
\label{sec:org6ed1276}
\begin{table}[htbp]
\caption{\label{tab:orgd121346}
...
\end{tabular}
\end{table}\footnotetext[4]{\label{org393513b}Prior offspring as well as heterozygote screening (1969-1992)}
\end{enumerate}
\subsection{Krabbe}
\label{sec:orgf415e1d}
\begin{enumerate}
\item Introduction
\label{sec:org9e39076}
\begin{itemize}
...
\item Diagnosis
\label{sec:orga86e98c}
\begin{enumerate}
\item Symptomatic presentation
\label{sec:org9ad88df}
\begin{itemize}
...
\caption{\label{fig:org399faad}
NBS follow-up at Mayo}
\end{figure}
\end{enumerate}

\item Laboratory Investigations
\label{sec:org49627a9}
\begin{enumerate}
\item CSF protein
\label{sec:org1feb05d}
\begin{itemize}
...
\item Treatment
\label{sec:org9ad62d1}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:org0286659}
\begin{itemize}
...
\label{sec:org788fc4d}
\begin{enumerate}
\item Introduction
\label{sec:org8b7844a}
...
\item Clinical
\label{sec:orgc131e31}
\begin{enumerate}
\item Late-infantile MLD
\label{sec:orgcd19e8a}
\begin{itemize}
...
\end{enumerate}
\subsection{Fabry}
\label{sec:org37eb3c4}
\begin{enumerate}
\item Introduction
\label{sec:orga5e03bc}
\begin{itemize}
...
\caption[Globotriaosylceramide]{\label{fig:orga1d6db9}
...
\caption[\(\alpha\)-galactosidase A]{\label{fig:org1de19ce}
\(\alpha\)-galactosidase A, located in the lumen of lysosomes}
\end{figure}

\item Genetics
\label{sec:org7fdec94}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org3b1d4ea}May be induced by heat, cold, fatigue or emotional stress

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fabry/figures/angiokeratomas.png}
\caption[Angiokeratomas of the skin]{\label{fig:org64423b2}
Angiokeratomas of the skin}
\end{figure}}


\item Laboratory Investigations
\label{sec:org3c7738b}
\begin{enumerate}
\item Biochemistry
\label{sec:orgb834e5e}
\begin{itemize}
...
\end{enumerate}
\subsection{Farber}
\label{sec:orgc4fc595}
\begin{enumerate}
\item Introduction
\label{sec:org2792356}
\begin{itemize}
...
\item Treatment
\label{sec:org5abb502}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\section{Niemann-Pick C}
\label{sec:org46cf084}
\subsection{Introduction}
\label{sec:org62edc5b}
\begin{itemize}
...
\label{sec:org71054fe}
\begin{enumerate}
\item Early infantile
\label{sec:org1eb99a0}
\begin{itemize}
...
\caption{\label{fig:org7edf4fd}
Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:org7a04fe5}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:org964769a}
\subsection{Introduction}
\label{sec:orga61f7e5}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./mps/figures/ch17f01.jpg}
\caption[Proteoglycans]{\label{fig:org2dfff80}
Proteoglycans}
\end{figure}

\begin{enumerate}
\item Proteoglycans function
\label{sec:org7440430}
...
\caption[Proteoglycan Synthesis]{\label{fig:org9a367a8}
Proteoglycan Synthesis}
\end{figure}


\item Glycosaminoglycans
\label{sec:org896a6b9}
...
\caption[Glycan Nomenclature]{\label{fig:orgc24742d}
...
\caption[Glycosaminoglycans]{\label{fig:org4445b01}
Glycosaminoglycans}
\end{figure}

\item GAGs
\label{sec:orgb9a3126}

\begin{enumerate}
\item Hyaluronan
\label{sec:org3cd3911}
\begin{itemize}
...
\label{sec:org2003017}

\begin{enumerate}
\item Mucopolysaccharidoses
\label{sec:org54a5470}
\begin{itemize}
...
\caption[Glycosaminoglycan Degradation]{\label{fig:orgd71e18b}
Glycosaminoglycan Degradation}
\end{figure}

\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:org2e63e7f}
...
\caption[DS Degradation]{\label{fig:org02d7b7e}
DS degradation}
\end{figure}
...
\caption[KS Degradation]{\label{fig:org74974e7}
KS degradation}
\end{figure}
...
\caption[HS Degradation]{\label{fig:org7ca9d7e}
HS Degradation}
\end{figure}
\end{enumerate}

\section{Oligosaccharidoses}
\label{sec:orge3f9cc3}
\subsection{Introduction}
\label{sec:org02deb95}
...
\caption{\label{fig:org8283701}
Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Disorders}
\label{sec:org9b036db}
\begin{enumerate}
\item Mannosidosis
\label{sec:org77f13af}
\begin{itemize}
...
\label{sec:orgd263bed}
\begin{enumerate}
\item Biochemical
\label{sec:org872e37f}
\begin{itemize}
...
\caption[Protein trafficking to lysosomes]{\label{fig:orgaec505a}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org22f299f}
...
\caption{\label{fig:orgf3f4db3}
I cell in fibroblast culture}
\end{figure}

\item Clinical
\label{sec:orgd597a27}

\begin{enumerate}
\item ML II
\label{sec:org4602852}
\begin{itemize}
\item low IQ
...
\label{sec:orga23c2f2}

\begin{enumerate}
\item Sialidosis (ML I)
\label{sec:org2a6e820}
\begin{itemize}
...
\label{sec:orge49df69}
\subsection{Introduction}
\label{sec:org165a154}
\begin{enumerate}
\item Peroxisomal FA oxidation
\label{sec:org0474f54}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1d39cef}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:orgdb22aac}
\begin{itemize}
...
\label{sec:org8b1f500}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org79d2e67}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org4680373}
Oxidation of Phytanic Acid}
\end{figure}

\item Genetics
\label{sec:orgf2b417e}
\begin{itemize}
...
\label{sec:orge45c85a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge86a5d9}
\begin{itemize}
...
\caption{\label{fig:orgc4c5a2c}
Eicosanoid Metabolism}
\end{figure}

\begin{enumerate}
\item Disorders
\label{sec:org62bacdb}
\begin{itemize}
...
\label{sec:org184c71e}
\subsection{Introduction}
\label{sec:org9061c4e}
\begin{itemize}
...
\label{sec:org7eee8dd}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org86a801b}
\begin{itemize}
...
\label{sec:org54fbb92}

\begin{enumerate}
\item MGAT2-CDG (CDG-IIa)
\label{sec:orgc03e38d}
\begin{itemize}
...
\caption[Hh]{\label{fig:org208543b}
Hh Blood Group}
\end{figure}
\end{enumerate}

\subsection{Laboratory Tests}
\label{sec:org5937b92}
\begin{enumerate}
\item Transferrin IEF
\label{sec:org7faec32}
\begin{itemize}
...
\caption{\label{fig:org8af9b69}
Transferrin IEF}
\end{figure}

\item Transferrin IEF limitations
\label{sec:orgf832630}
...
\caption{\label{fig:org711c503}
CDG diagnosis}
\end{figure}
\end{enumerate}
\section{Cystinosis}
\label{sec:org4521343}
\subsection{Introduction}
\label{sec:orge910ab2}
\begin{itemize}
...
\label{sec:orgf1ca847}
\begin{enumerate}
\item First stage
\label{sec:orga24d421}
\begin{itemize}
...
\label{sec:orgcf597d7}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:orgf487bce}
\begin{itemize}
...
\item Treatment
\label{sec:org0e3d229}
\begin{enumerate}
\item Supportive
\label{sec:org0fd66ff}
\begin{itemize}
