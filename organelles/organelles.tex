...
\caption[Sphingolipid Structure]{\label{fig:orgf9c4d8e}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org670912b}
...
\label{sec:org81e1950}
\begin{enumerate}
\item Classification
\label{sec:org1aeddd5}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org6d4ccf4}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgba82144}secondary to bony changes}\footnotetext[2]{\label{org7d8c9b4}oligosacaride with terminal galactose}\footnotetext[3]{\label{org10b106a}FN have been observed}
...
\caption{\label{fig:org5510fbe}
Hexosaminidase A \& B:Sandhoff disease}
\end{figure}

\item Genetics
\label{sec:org6ab5465}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[4]{\label{org3debd4a}Prior offspring as well as heterozygote screening (1969-1992)}
\end{enumerate}
\subsection{Krabbe}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org2986e91}May be induced by heat, cold, fatigue or emotional stress

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fabry/figures/angiokeratomas.png}
\caption[Angiokeratomas of the skin]{\label{fig:orgd036def}
...
\caption{\label{fig:org1fdc6e4}
Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:orgf7499c9}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:orgb22ed12}
\subsection{Introduction}
\label{sec:org95bb469}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./mps/figures/ch17f01.jpg}
\caption[Proteoglycans]{\label{fig:org1b2de57}
Proteoglycans}
\end{figure}

\begin{enumerate}
\item Proteoglycans function
\label{sec:orgbda16d4}
...
\caption[Proteoglycan Synthesis]{\label{fig:org09634c5}
Proteoglycan Synthesis}
\end{figure}


\item Glycosaminoglycans
\label{sec:orgaa098f4}
...
\caption[Glycan Nomenclature]{\label{fig:org4cbc2bd}
...
\caption[Glycosaminoglycans]{\label{fig:orga9838f2}
Glycosaminoglycans}
\end{figure}

\item GAGs
\label{sec:org6c8e6cc}

\begin{enumerate}
\item Hyaluronan
\label{sec:org1394827}
\begin{itemize}
...
\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:org3e6b907}
...
\caption[DS Degradation]{\label{fig:org7d55117}
DS degradation}
\end{figure}
...
\caption[KS Degradation]{\label{fig:org7a5b6c4}
KS degradation}
\end{figure}
...
\caption[HS Degradation]{\label{fig:orga52e0f9}
HS Degradation}
\end{figure}
\end{enumerate}

\section{Oligosaccharidoses}
\label{sec:orgf111f03}
\subsection{Introduction}
\label{sec:org72cf588}
...
\caption{\label{fig:orgb6f1453}
Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Disorders}
\label{sec:orgaadf065}
\begin{enumerate}
\item Mannosidosis
\label{sec:org7c8f2ad}
\begin{itemize}
...
\label{sec:org78daac5}
\subsection{Introduction}
\label{sec:org7759d9c}
\begin{itemize}
...
\label{sec:orgcfb5cc8}
\begin{enumerate}
\item Biochemical
\label{sec:org7a2cfe0}
\begin{itemize}
...
\caption[Protein trafficking to lysosomes]{\label{fig:orgea3ff4e}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org1b62419}
...
\caption{\label{fig:org40318da}
I cell in fibroblast culture}
\end{figure}

\item Clinical
\label{sec:org6f653ab}

\begin{enumerate}
\item ML II
\label{sec:org3d714b4}
\begin{itemize}
\item low IQ
...
\label{sec:org1699aa0}
\subsection{Introduction}
\label{sec:org5123bcf}
\begin{enumerate}
\item Peroxisomal FA oxidation
\label{sec:org94babe8}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd6e8149}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:org7d8c383}
\begin{itemize}
...
\label{sec:org8815e3e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org90ca444}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org69629b7}
Oxidation of Phytanic Acid}
\end{figure}

\item Genetics
\label{sec:org5edc3b3}
\begin{itemize}
...
\label{sec:orgfab4416}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgcf2ce06}
\begin{itemize}
...
\label{sec:orge4b8a55}
\subsection{Introduction}
\label{sec:org11dc374}
\begin{itemize}
...
\label{sec:orgf175de5}

\begin{enumerate}
\item Clinical Presentation
\label{sec:orgee957dc}
\begin{itemize}
...
\label{sec:org15adb93}

\begin{enumerate}
\item MGAT2-CDG (CDG-IIa)
\label{sec:org592e505}
\begin{itemize}
...
\caption[Hh]{\label{fig:org358708f}
Hh Blood Group}
\end{figure}
\end{enumerate}

\subsection{Laboratory Tests}
\label{sec:org437e8d1}
\begin{enumerate}
\item Transferrin IEF
\label{sec:org94b4150}
\begin{itemize}
...
\caption{\label{fig:orgff6839a}
Transferrin IEF}
\end{figure}

\item Transferrin IEF limitations
\label{sec:org917397f}
...
\caption{\label{fig:org9bdc831}
CDG diagnosis}
\end{figure}
\end{enumerate}
\section{Cystinosis}
\label{sec:org60a0acf}
\subsection{Introduction}
\label{sec:orgf8778f1}
\begin{itemize}
...
\label{sec:org008905e}
\begin{enumerate}
\item First stage
\label{sec:org07027e1}
\begin{itemize}
...
\label{sec:org527d4c5}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:orgf6787cd}
\begin{itemize}
...
\item Treatment
\label{sec:org8d54e0a}
\begin{enumerate}
\item Supportive
\label{sec:org3996392}
\begin{itemize}
