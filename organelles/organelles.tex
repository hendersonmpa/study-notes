...
\label{sec:orgcac3df1}
\subsection{Introduction}
\label{sec:orgb649a96}
\begin{enumerate}
\item Sphingolipids
\label{sec:org89c7244}
\begin{itemize}
...
\item Biosynthesis
\label{sec:org3c6dc05}

\begin{enumerate}
\item ER
\label{sec:org284723c}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:org581342b}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org7d5e3e0}
...
\label{sec:org7e3e295}
\begin{enumerate}
\item Classification
\label{sec:org63429e2}

\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:orgcb358c6}
\begin{itemize}
...
\label{sec:org31446c2}

\begin{table}[htbp]
\caption{\label{tab:org0faf7a0}
...
\caption{\label{fig:org6a642c3}
Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosome}
\label{sec:org25d72ea}
\begin{itemize}
...
\caption[Lysosomal protein trafficking receptors]{\label{fig:org212f4c6}
Lysosomal protein trafficking receptors}
\end{figure}


\subsection{M6P receptors}
\label{sec:org61cfcbc}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:org344fcfc}
\begin{enumerate}
\item Introduction
\label{sec:org3b1e232}
\begin{itemize}
...
\caption{\label{fig:orgd8cf079}
\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}

\item Genetics
\label{sec:org6f7969e}
\begin{itemize}
...
\label{sec:org67edf99}
\begin{table}[htbp]
\caption{\label{tab:orgdf07281}
...
\item Treatment
\label{sec:org9d05501}
\begin{enumerate}
\item Bone marrow transplantation
\label{sec:org41c9152}
\begin{itemize}
...
\caption{\label{fig:org3a84f40}
Sphingomyelinase}
\end{figure}

\item Genetics
\label{sec:org8591b04}
\begin{itemize}
...
\item Clinical Findings
\label{sec:org60a2901}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:org37cd80b}
\begin{itemize}
...
\caption{\label{fig:org460d800}
Foam cells in bone marrow}
\end{figure}

\item Treatment
\label{sec:orgcc1bd2a}
\begin{itemize}
...
\label{sec:orgb198f36}
\begin{enumerate}
\item Introduction
\label{sec:org37adf0d}
...
\item Clinical Findings
\label{sec:org9f6291a}

\begin{table}[htbp]
\caption[GM1 Signs and Symptoms]{\label{tab:org2f10c13}
...
Hepatosplenomegaly & + & +/– & – & –\\
Cardiac involvement & +/– & +/– & +/– & +\\
Coarse facial features & +/– & – & – & \textsuperscript{\ref{org0600aca}}\\
Skeletal findings & + & +/– & – & +\\
Neuroimaging & PA & PA & +/– mild atrophy & \textsuperscript{\ref{org0600aca}}\\
Urine (GAG) & \footnotemark & \textsuperscript{\ref{org032f8f0}} & \textsuperscript{\ref{org032f8f0}} & Keratan sulfate \footnotemark\\
\end{tabular}
\end{table}\footnotetext[1]{\label{org0600aca}Secondary to bony changes}\footnotetext[2]{\label{org032f8f0}Oligosacaride with terminal galactose}\footnotetext[3]{\label{orgb3427eb}FN have been observed}




\item Laboratory Investigations
\label{sec:org72fefdb}
\begin{itemize}
...
\caption{\label{fig:orgacda482}
Hexosaminidase A \& B:Sandhoff disease}
\end{figure}

\item Genetics
\label{sec:org97cdd47}
\begin{itemize}
...
\item Clinical Findings
\label{sec:orga2d862a}
\begin{table}[htbp]
\caption{\label{tab:org0ee2994}
...
\end{tabular}
\end{table}\footnotetext[4]{\label{orgbc9ceb4}Prior offspring as well as heterozygote screening (1969-1992)}
\end{enumerate}
\subsection{Krabbe}
\label{sec:org2d645d1}
\begin{enumerate}
\item Introduction
\label{sec:org7ce86f1}
\begin{itemize}
...
\item Diagnosis
\label{sec:org4865d6b}
\begin{enumerate}
\item Symptomatic presentation
\label{sec:org1ec6944}
\begin{itemize}
...
\caption{\label{fig:orgace8eab}
NBS follow-up at Mayo}
\end{figure}
\end{enumerate}

\item Laboratory Investigations
\label{sec:orgda3d6a7}
\begin{enumerate}
\item CSF protein
\label{sec:org95b9327}
\begin{itemize}
...
\label{sec:org7b693e7}
\begin{enumerate}
\item Introduction
\label{sec:orgc0184e3}
...
\item Clinical
\label{sec:orgde0fb34}
\begin{enumerate}
\item Late-infantile MLD
\label{sec:org8c4d6b0}
\begin{itemize}
...
\end{enumerate}
\subsection{Fabry}
\label{sec:org8ba1b7a}
\begin{enumerate}
\item Introduction
\label{sec:org5308185}
\begin{itemize}
...
\caption[Globotriaosylceramide]{\label{fig:org8a31284}
...
\caption[\(\alpha\)-galactosidase A]{\label{fig:org475a4d4}
\(\alpha\)-galactosidase A, located in the lumen of lysosomes}
\end{figure}

\item Genetics
\label{sec:org0e51ba6}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org947cccd}May be induced by heat, cold, fatigue or emotional stress

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fabry/figures/angiokeratomas.png}
\caption[Angiokeratomas of the skin]{\label{fig:orgec36050}
Angiokeratomas of the skin}
\end{figure}}


\item Laboratory Investigations
\label{sec:org0633813}

\begin{enumerate}
\item Biochemistry
\label{sec:org4005c4b}
\begin{itemize}
...
\end{enumerate}
\subsection{Farber}
\label{sec:org8ffb431}
\begin{enumerate}
\item Introduction
\label{sec:org88be14a}
\begin{itemize}
...
\item Treatment
\label{sec:org0cb85c2}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\section{Niemann-Pick C}
\label{sec:org4b35d9c}
\subsection{Introduction}
\label{sec:org12797b6}
\begin{itemize}
...
\label{sec:orgd1083fb}
\begin{enumerate}
\item Early infantile
\label{sec:org3512ee6}
\begin{itemize}
...
\caption{\label{fig:org68bdf59}
Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:org42c6e11}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:org39cfeee}
\subsection{Introduction}
\label{sec:org15c6aa9}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./mps/figures/ch17f01.jpg}
\caption[Proteoglycans]{\label{fig:orgfbdd41c}
Proteoglycans}
\end{figure}

\begin{enumerate}
\item Proteoglycans function
\label{sec:org04789c4}
...
\caption[Proteoglycan Synthesis]{\label{fig:org11d7292}
Proteoglycan Synthesis}
\end{figure}


\item Glycosaminoglycans
\label{sec:org79a83ff}
...
\item 
\label{sec:org5c16934}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./mps/figures/snfg.png}
\caption[Glycan Nomenclature]{\label{fig:org8be7195}
...
\caption[Glycosaminoglycans]{\label{fig:orga51f432}
Glycosaminoglycans}
\end{figure}

\item GAGs
\label{sec:orgaa426fa}

\begin{enumerate}
\item Hyaluronan
\label{sec:org8ca4109}
\begin{itemize}
...
\label{sec:orgaba4ef8}

\begin{enumerate}
\item Mucopolysaccharidoses
\label{sec:orgaa968bd}
\begin{itemize}
...
\caption[Glycosaminoglycan Degradation]{\label{fig:org99d212f}
...
\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:org22dbfce}
...
\caption[DS Degradation]{\label{fig:org7b9df00}
DS degradation}
\end{figure}
...
\caption[KS Degradation]{\label{fig:org3eff336}
KS degradation}
\end{figure}
...
\caption[HS Degradation]{\label{fig:org6efc8e1}
HS Degradation}
\end{figure}
\end{enumerate}

\section{Oligosaccharidoses}
\label{sec:orga4fc71b}
\subsection{Introduction}
\label{sec:org738afe2}
...
\caption{\label{fig:orgf38c9b6}
Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Disorders}
\label{sec:org11c2a26}
\begin{enumerate}
\item Mannosidosis
\label{sec:orgb1cdb2a}
\begin{itemize}
...
\label{sec:org2bb3ba5}
\subsection{Introduction}
\label{sec:orgda60c66}
\begin{itemize}
...
\label{sec:org3fc7aac}
\begin{enumerate}
\item Biochemical
\label{sec:orgf803eed}
\begin{itemize}
...
\caption[Protein trafficking to lysosomes]{\label{fig:org321c517}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org6713e65}
...
\caption{\label{fig:org9b31814}
I cell in fibroblast culture}
\end{figure}

\item Clinical
\label{sec:org4be2147}

\begin{enumerate}
\item ML II
\label{sec:orgc361adf}
\begin{itemize}
\item Low IQ
...
\label{sec:orgeaf45d3}

\begin{enumerate}
\item Sialidosis (ML I)
\label{sec:org42deede}
\begin{itemize}
...
\label{sec:orgc055e8e}
\subsection{Introduction}
\label{sec:orgab049c9}
\begin{enumerate}
\item Peroxisomal FA oxidation
\label{sec:org6256405}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3103708}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:org84f33ff}
\begin{itemize}
...
\label{sec:orgb94f49c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd26833b}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:orge5353b0}
Oxidation of Phytanic Acid}
\end{figure}

\item Genetics
\label{sec:org66cea50}
\begin{itemize}
...
\label{sec:orgb9ffb7d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1cc6818}
\begin{itemize}
...
\caption{\label{fig:orge29e1cd}
Eicosanoid Metabolism}
\end{figure}

\begin{enumerate}
\item Disorders
\label{sec:org749446f}
\begin{itemize}
...
\label{sec:org79765c9}
\subsection{Introduction}
\label{sec:org0a3db86}
\begin{itemize}
...
\label{sec:orgfcf9e33}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org8693ae2}
\begin{itemize}
...
\label{sec:org13c6776}

\begin{enumerate}
\item MGAT2-CDG (CDG-IIa)
\label{sec:orgf883476}
\begin{itemize}
...
\caption[Hh]{\label{fig:orgffb5ad8}
Hh Blood Group}
\end{figure}
\end{enumerate}

\subsection{Laboratory Tests}
\label{sec:orgcd03fa4}
\begin{enumerate}
\item Transferrin IEF
\label{sec:org71e0d53}
\begin{itemize}
...
\caption{\label{fig:org62b39dd}
Transferrin IEF}
\end{figure}

\item Transferrin IEF limitations
\label{sec:org8664ed0}
...
\item CDG diagnosis
\label{sec:org32d64ad}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./cdg/figures/cdg_diag.png}
\caption{\label{fig:org78ef7f0}
CDG diagnosis}
\end{figure}
\end{enumerate}
\section{Cystinosis}
\label{sec:org53b4477}
\subsection{Introduction}
\label{sec:org4e20109}
\begin{itemize}
...
\label{sec:org981ab8b}
\begin{enumerate}
\item First stage
\label{sec:org8c61c96}
\begin{itemize}
...
\label{sec:org3d96e8c}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org168db0e}
\begin{itemize}
...
\item Treatment
\label{sec:org35f7c71}
\begin{enumerate}
\item Supportive
\label{sec:orgb7c561f}
\begin{itemize}
