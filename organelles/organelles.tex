...
\label{sec:orgac5434f}
\subsection{Introduction}
\label{sec:org89e9dd5}
\subsubsection{Sphingolipids}
\label{sec:orgfc9f168}
\begin{itemize}
...
\label{sec:org336dbca}
\begin{enumerate}
\item ER
\label{sec:org8fa4a70}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:org01947f0}Sphingolipid Structure}
\end{figure}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org1b043f7}Sphingolipid Biosynthesis}
\end{figure}
\end{enumerate}

\subsection{Disorders of Sphingolipid Synthesis}
\label{sec:org26a42a3}
\subsubsection{Classification}
\label{sec:orgba06f69}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:orgc1fafb8}
\begin{description}
...
\label{sec:org1b73edd}

\begin{table}[htbp]
\caption{\label{tab:org9760297}Sphingolipidoses}
\centering
\begin{tabular}{llll}
...
\caption{\label{fig:org7b747d7}Sphingolipid Degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:orgd8539ec}
\begin{itemize}
...
\caption{\label{fig:orgdfe8885}Protein Trafficking to Lysosome}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./figures/lysosome_trafficking.jpeg}
\caption{\label{fig:orgb9d307f}Lysosomal Protein Trafficking Receptors}
\end{figure}

\subsubsection{M6P receptors}
\label{sec:org4a1cac0}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:orgd879079}
\subsubsection{Introduction}
\label{sec:org6089d18}
\begin{itemize}
...
\label{sec:org4498f0e}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{gaucher/figures/Gaucher_Cells_with_Fibrillar_Appearing_Cytoplasm.jpg}
\caption{\label{fig:org7582865}Gaucher Cells in a Bone Marrow Smear}
\end{figure}

\begin{enumerate}
\item Biochemistry
\label{sec:orgfd46e81}
\begin{itemize}
...
\label{sec:orga3f3fb2}
\begin{enumerate}
\item Bone marrow transplantation
\label{sec:org8c24c6d}
\begin{itemize}
...
\subsubsection{Clinical Findings}
\label{sec:org04e892f}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:org0deb314}
\begin{itemize}
...
urine & \footnotemark & \textsuperscript{\ref{org886a0d8}} & \textsuperscript{\ref{org886a0d8}} & keratan sulfate \footnotemark\\
 &  &  &  & \\
\end{tabular}
\end{table}\footnotetext[1]{\label{org36ce4be}corneal clouding}\footnotetext[2]{\label{orgfe6d849}secondary to bony changes}\footnotetext[3]{\label{org886a0d8}oligosacaride with terminal galactose}\footnotetext[4]{\label{orgd6c7bbf}FN have been observed}
...
\begin{table}[htbp]
\caption{\label{tab:orga2bce38}Hexoaminidase Isozymes}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:orgebc2be1}GM2 ganglioside storage diseases}
\centering
\begin{tabular}{llrll}
...
\caption{\label{fig:org6450b03}Hexosaminidase A: Tay-Sachs}
\end{figure}
...
\caption{\label{fig:orgf80a22f}Hexosaminidase A \& B:Sandhoff disease (GL-3 \& 4 equivalent to Gb3 \& 4)}
\end{figure}


\subsubsection{Clinical Findings}
\label{sec:orgb76dc88}
\begin{itemize}
\item see table \ref{tab:orgb0cd4c9}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orgb0cd4c9}GM2 Signs and Symptoms}
\centering
\begin{tabular}{llll}
...
\caption{\label{fig:orgf3aca2e}NBS Follow-up at Mayo}
\end{figure}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org1d5380f}induced by heat, cold, fatigue or emotional stress}
...
\end{itemize}
\subsection{Farber}
\label{sec:orgf8228e9}
\subsubsection{Introduction}
\label{sec:org090f873}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org7c71d4a}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\subsubsection{Clinical}
\label{sec:org06060f6}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org741e87b}
\begin{itemize}
\item none
\item HSCT trial with poor outcome
\end{itemize}
\section{Niemann-Pick C}
\label{sec:org867314b}
\subsection{Introduction}
\label{sec:orgf9947bf}
\begin{itemize}
...
\label{sec:org304a52f}
\begin{enumerate}
\item Early Infantile
\label{sec:org5c7f873}
\begin{itemize}
...
\label{sec:orgeaea65c}
\subsection{Introduction}
\label{sec:org4fef6a6}
\begin{itemize}
...
\subsection{Genetics}
\label{sec:orge534e29}
\begin{itemize}
\item AR
\item adult form is AD
\end{itemize}
\subsection{Diagnostic Tests}
\label{sec:orgf3a6082}
\begin{itemize}
...
\caption[Proteoglycan Synthesis]{\label{fig:org6b07aa6}Proteoglycan Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{mps/figures/snfg.png}
\caption[Glycan Nomenclature]{\label{fig:org4b0e869}Symbol Nomenclature for Glycans (SNFG)}
\end{figure}
...
\caption[Glycosaminoglycans]{\label{fig:org946c17b}Glycosaminoglycans}
\end{figure}

\begin{itemize}
\item GAGs are composed of repeating units of disaccharides (Figure \ref{fig:org946c17b})
\begin{itemize}
...
\label{sec:org8fd8610}
\subsubsection{Clinical Presentation}
\label{sec:org8eba9ca}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgec36495}MPS Signs and Symptoms}
\centering
...
\caption[Glycosaminoglycan Degradation]{\label{fig:org777c771}Glycosaminoglycan Degradation}
\end{figure}


\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:orgc299cb6}MPS Enzymes and Substrates}
\centering
\begin{tabular}{lllll}
...
\end{tabular}
\end{table}\footnotetext[6]{\label{orgdeb9e00}\(\beta\)-galactosidase deficiency also causes GM1 gangliosidosis}

\subsubsection{Genetics}
\label{sec:org73a9057}
\begin{itemize}
\item AR
\item \textbf{MPS II Hunter is XLR}
\item see table \ref{tab:orgc299cb6}
\end{itemize}
\subsubsection{Diagnostic Tests}
...
\label{sec:org3cf4eb0}
\subsection{Introduction}
\label{sec:org9cdffb1}
\begin{itemize}
...
\caption{\label{fig:org002b3b5}Glycoprotein Oligosaccharide Chain}
\end{figure}
...
\subsubsection{Treatment}
\label{sec:orgfbf12c0}
\begin{itemize}
\item supportive
\end{itemize}

\subsection{ML II \& III}
\label{sec:org7f94770}
\begin{itemize}
\item ML II AKA: I-Cell Disease
\item ML III AKA: Pseudo-Hurler
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org197a914}
\begin{enumerate}
\item ML II
\label{sec:org3bc90a6}
\begin{itemize}
\item low IQ
...
\end{itemize}
\subsection{ML IV}
\label{sec:orgada763e}
\subsubsection{Clinical Presentation}
\label{sec:org6965556}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org0449b36}
\begin{itemize}
\item AR MCOLN1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org416aada}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org7e5b422}
\begin{itemize}
\item supportive
\end{itemize}

\section{Peroxisomes}
\label{sec:org0266e64}
\subsection{Introduction}
\label{sec:orgaeff00c}
\begin{itemize}
...
\caption{\label{fig:orgfe2fde2}Non-Mitochondrial FA Metabolism}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:orge49521c}Biochemical Findings in Peroxisomal Disease}
\centering
\begin{tabular}{llllll}
...
\label{sec:orgb8eb553}
\subsubsection{Clinical Presentation}
\label{sec:org35cb85d}
\begin{itemize}
\item three forms:
\begin{enumerate}
...
\subsubsection{Clinical Presentation}
\label{sec:org566234e}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:orga04efa8}
\begin{itemize}
...
\label{sec:org0e7bece}
\subsubsection{Clinical Presentation}
\label{sec:org7df2ce5}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org624c2de}Oxidation of Phytanic Acid}
\end{figure}
...
\label{sec:org8590300}
\subsubsection{Clinical Presentation}
\label{sec:org0f0296b}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org410faf9}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org4c3cc05}
\begin{itemize}
...
\label{sec:org27e8690}
\subsubsection{Clinical Presentation}
\label{sec:org83a7e70}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org1333559}
\begin{enumerate}
\item RCDP Type 1
\label{sec:org30f84c7}
\begin{itemize}
...
\caption{\label{fig:org430c453}Eicosanoid Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:orgcf63def}
\begin{itemize}
...
\label{sec:org5ed02a6}
\subsection{Introduction}
\label{sec:orga4fa233}
\begin{itemize}
...
\label{sec:org723c6cd}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga09edc4}
\begin{itemize}
...
\label{sec:orgb3a6665}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgad5a2ae}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org2d101de}
\begin{itemize}
\item AR ALG6
\end{itemize}
\item Diagnostic Tests
\label{sec:org8157482}
\begin{itemize}
\item transferrin IEF - Type I pattern
...
\label{sec:orgf1d07b6}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgdc3ec6a}
\begin{itemize}
...
marrow
\end{enumerate}
\item nephropathic or infantile form is by far the most frequent (Section \ref{sec:orge7fe928})
...
\label{sec:orge7fe928}
\subsubsection{Clinical Presentation}
\label{sec:orgce312e7}
\begin{enumerate}
\item First stage
\label{sec:orgcc39c75}
\begin{itemize}
...
\label{sec:orge20a93d}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org17ce94a}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org1734c1e}
\begin{itemize}
\item AR CTNS
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org9ccf516}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org16e58ab}
\begin{enumerate}
\item Supportive
\label{sec:orgbf8c6d0}
\begin{itemize}
