...
\label{sec:org008766b}
\subsection{Introduction}
\label{sec:org778b561}
\begin{enumerate}
\item Sphingolipids
\label{sec:orgc023f64}
\begin{itemize}
...
\item Biosynthesis
\label{sec:orgd2120d0}
\begin{enumerate}
\item ER
\label{sec:org1ed5d04}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:org16fb7ff}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org21f599a}
...
\label{sec:orga47d88b}
\begin{enumerate}
\item Classification
\label{sec:org56e8543}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org6fe36f1}
\begin{itemize}
...
\label{sec:org9e8917f}

\begin{table}[htbp]
\caption{\label{tab:org07701a5}
...
\caption{\label{fig:org2edbe30}
Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:orgd892d19}
\begin{itemize}
...
\caption[Lysosomal protein trafficking receptors]{\label{fig:orgbf5bcf7}
Lysosomal protein trafficking receptors}
\end{figure}

\begin{enumerate}
\item M6P receptors
\label{sec:org27ad1e5}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:orgc2b4f4d}
\begin{enumerate}
\item Introduction
\label{sec:org5218d7b}
\begin{itemize}
...
\caption{\label{fig:org296aea0}
\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}

\item Genetics
\label{sec:org1cd31a4}
\begin{itemize}
\item AR GBA
...
\label{sec:org6ef9059}
\begin{itemize}
\item see table \ref{tab:org19d6803}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org19d6803}
...
\item Treatment
\label{sec:orge813fae}
\begin{enumerate}
\item bone marrow transplantation
\label{sec:orgd6e7564}
\begin{itemize}
...
\label{sec:org1e3911a}
\begin{enumerate}
\item Introduction
\label{sec:orgc21d8a8}
\begin{itemize}
...
\caption{\label{fig:org0f658e4}
Sphingomyelinase}
\end{figure}

\item Genetics
\label{sec:org1fcf4bc}
\begin{itemize}
\item AR, SMPD1
...
\item Clinical Findings
\label{sec:org33aeb63}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:org7705878}
\begin{itemize}
...
\end{itemize}
\item foam cells in bone marrow (Figure \ref{fig:org2a54c4b})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{./niemann_pick/figures/foam_cells.png}
\caption{\label{fig:org2a54c4b}
Foam cells in bone marrow}
\end{figure}

\item Treatment
\label{sec:orga3dcd2b}
\begin{itemize}
...
\label{sec:org7f3ee8f}
\begin{enumerate}
\item Introduction
\label{sec:org3c89c42}
\begin{itemize}
\item defect in \textbf{\(\beta\)-galactosidase (AKA: \(\beta\)-gangliosidase)}
\begin{itemize}
\item removes galactose from GM1, keratin sulfate and some oligosaccharides (Figure \ref{fig:org2d239aa})
\end{itemize}
...
\begin{itemize}
\item ML-1 (sialidosis) (section \ref{sec:orgb69c046})
\end{itemize}
\end{itemize}
\end{enumerate}

\item Genetics
\label{sec:org318b4d4}
\begin{itemize}
\item AR GLB1
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org3caacd2}corneal clouding}\footnotetext[2]{\label{org4b09fe8}secondary to bony changes}\footnotetext[3]{\label{org3a49d0d}oligosacaride with terminal galactose}\footnotetext[4]{\label{org1642f70}FN have been observed}
\item Laboratory Investigations
...
\label{sec:orgbe343c2}
\begin{enumerate}
\item Introduction
\label{sec:org1d3825e}
\begin{itemize}
...
and \(\beta\) subunits (Table \ref{tab:orga713d4f})
\end{itemize}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orga713d4f}
...
\caption{\label{fig:org8d2d716}
Hexosaminidase A \& B:Sandhoff disease}
\end{figure}

\item Genetics
\label{sec:orga591e30}
\begin{itemize}
...
\item Clinical Findings
\label{sec:org3da7197}
\begin{itemize}
\item see table \ref{tab:orgd66b84c}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orgd66b84c}
...
\end{enumerate}
\subsection{Krabbe}
\label{sec:org6cb569e}
\begin{enumerate}
\item Introduction
\label{sec:org1db28c3}
\begin{itemize}
...
\begin{enumerate}
\item Treatment
\label{sec:org5517fbb}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:org3a7551e}
\begin{itemize}
...
\label{sec:orgc963ca9}
\begin{enumerate}
\item Introduction
\label{sec:org837ce8b}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{orga12bfde}induced by heat, cold, fatigue or emotional stress

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fabry/figures/angiokeratomas.png}
\caption[Angiokeratomas of the skin]{\label{fig:org894bd19}
Angiokeratomas of the Skin}
\end{figure}}

\item Laboratory Investigations
\label{sec:orgba2a81a}
\begin{enumerate}
\item Biochemistry
\label{sec:org2e7ccb1}
\begin{itemize}
...
\end{enumerate}
\subsection{Farber}
\label{sec:org17c641e}
\begin{enumerate}
\item Introduction
\label{sec:orgbda188d}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org8b54d44}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\item Clinical
\label{sec:orgbcea5ce}
\begin{itemize}
...
\item Treatment
\label{sec:orgf4bd4cd}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\section{Niemann-Pick C}
\label{sec:org1e70613}
\subsection{Introduction}
\label{sec:org406a01e}
\begin{itemize}
...
\label{sec:orge15ba95}
\begin{enumerate}
\item Early Infantile
\label{sec:org1c9487b}
\begin{itemize}
...
\caption{\label{fig:orgc0c5486}
Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:org50d4b7c}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:orga8f126c}
\subsection{Introduction}
\label{sec:org0f832d3}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./mps/figures/ch17f01.jpg}
\caption[Proteoglycans]{\label{fig:org227b8c3}
Proteoglycans}
\end{figure}
...
\caption[Proteoglycan Synthesis]{\label{fig:orgef76611}
...
\caption[Glycan Nomenclature]{\label{fig:org97c4508}
...
\caption[Glycosaminoglycans]{\label{fig:org90e36a6}
Glycosaminoglycans}
\end{figure}
...
\caption[DS Degradation]{\label{fig:org977c117}
DS degradation}
\end{figure}
...
\caption[KS Degradation]{\label{fig:org429f0da}
KS degradation}
\end{figure}
...
\caption[HS Degradation]{\label{fig:org98d2006}
HS Degradation}
\end{figure}
\end{enumerate}

\subsection{Multiple sulfatase deficiency}
\label{sec:org1490338}
\begin{itemize}
...
\label{sec:org83a7497}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf60064c}
\begin{itemize}
...
\label{sec:orgeaa6838}
\begin{itemize}
\item MPS III (Sanfilippo)
\end{itemize}
\item Severe Skeletal Dysplasia
\label{sec:orga2c92c3}
\begin{itemize}
\item MPS IV (Morquio)
\end{itemize}
\item Rare
\label{sec:orgef4557c}
\begin{itemize}
\item MPS VII (Sly)
...
\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:orgc70d07f}
...
\item Diagnostic Testing
\label{sec:orgfca4739}
\begin{itemize}
\item quantitation of urine GAGs (Table \ref{tab:orgc70d07f})
\begin{itemize}
...
\label{sec:org9753f8f}
\subsection{Introduction}
\label{sec:org81ed4c1}
...
\caption{\label{fig:org4bc5faa}
Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Oligosaccharidoses}
\label{sec:org43e2815}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd1aba54}
\begin{itemize}
\item oligosaccharidoses share many features in common with MPS disorders (Table \ref{tab:orgcd35039})
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org19d4dd2}
\begin{enumerate}
\item ML II
\label{sec:org68c412c}
\begin{itemize}
\item low IQ
...
\caption[Protein trafficking to lysosomes]{\label{fig:org7986919}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org3de7679}
...
\caption{\label{fig:orged80356}
I cell in fibroblast culture}
\end{figure}

\item Genetics
\label{sec:org0967cff}
\begin{itemize}
\item AR GNPTAB
\end{itemize}
...
\section{Peroxisomes}
\label{sec:org45eb925}
\subsection{Introduction}
\label{sec:orgf96f315}
\begin{itemize}
...
\caption[Non-mitochondrial FA metabolism]{\label{fig:org3161738}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org960a9e3}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:orgcd2e92f}
\begin{itemize}
...
\label{sec:org5169626}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgdb4ff8b}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:orgdab4174}
Oxidation of Phytanic Acid}
\end{figure}

\item Genetics
\label{sec:orgb6d2289}
\begin{itemize}
\item AR PHYH
\end{itemize}

\item Diagnostic Tests
\label{sec:org79d2a13}
\begin{itemize}
...
\label{sec:org22c27a6}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org23d7a57}
\begin{itemize}
...
\item Genetics
\label{sec:orgdfc93cb}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\item Diagnostic Tests
\label{sec:org27bdaa4}
\begin{itemize}
...
\label{sec:org31aa2ac}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd7d1a8d}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:orgacec547}
\begin{enumerate}
\item RCDP Type 1
\label{sec:org9497539}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:orgf6ad8e8}
\begin{itemize}
\item \(\downarrow\) RBC plasmalogens
\end{itemize}
\begin{enumerate}
\item RDCP1
\label{sec:org17ab178}
\begin{itemize}
...
\label{sec:org54466a4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgcad5246}
\begin{itemize}
...
\label{sec:orgc25f272}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3604029}
\begin{enumerate}
\item First stage
\label{sec:org7eec13c}
\begin{itemize}
...
\label{sec:orgeef2ce6}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org56c361c}
\begin{itemize}
...
\item Genetics
\label{sec:org9246f5f}
\begin{itemize}
\item AR, CTNS
\end{itemize}

\item Diagnostic Tests
\label{sec:org03be329}
\begin{itemize}
...
\item Treatment
\label{sec:orgb258531}
\begin{enumerate}
\item Supportive
\label{sec:orgf2d2ec9}
\begin{itemize}
