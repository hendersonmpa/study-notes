...
\label{sec:orgc951850}
\subsection{Introduction}
\label{sec:org4799248}
\begin{enumerate}
\item Sphingolipids
\label{sec:org58264cb}
\begin{itemize}
...
\item Biosynthesis
\label{sec:org050be17}
\begin{enumerate}
\item ER
\label{sec:org28fc02c}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:org07cc0df}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org79b970d}
...
\label{sec:org11802eb}
\begin{enumerate}
\item Classification
\label{sec:org5e921bd}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:orga3e069c}
\begin{itemize}
...
\label{sec:org6e5e4ce}

\begin{table}[htbp]
\caption{\label{tab:org637d23e}
...
\caption{\label{fig:org06bb845}
Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:orga1a1cb8}
\begin{itemize}
...
\caption[Lysosomal protein trafficking receptors]{\label{fig:orgdf41e9c}
Lysosomal protein trafficking receptors}
\end{figure}

\begin{enumerate}
\item M6P receptors
\label{sec:org059cbe8}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:orgb111d97}
\begin{enumerate}
\item Introduction
\label{sec:org15aed2b}
\begin{itemize}
...
\caption{\label{fig:orga622bcd}
\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}

\item Genetics
\label{sec:orgbfd9855}
\begin{itemize}
\item AR GBA
...
\label{sec:org0de1e12}
\begin{itemize}
\item see table \ref{tab:org9719ef2}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org9719ef2}
...
\item Treatment
\label{sec:org156964d}
\begin{enumerate}
\item bone marrow transplantation
\label{sec:orgbaceda7}
\begin{itemize}
...
\label{sec:orgb000b51}
\begin{enumerate}
\item Introduction
\label{sec:org1f44a7f}
\begin{itemize}
...
\caption{\label{fig:orgdd2a673}
Sphingomyelinase}
\end{figure}

\item Genetics
\label{sec:org948938a}
\begin{itemize}
\item AR, SMPD1
...
\item Clinical Findings
\label{sec:org0f13c2f}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:orgd87e481}
\begin{itemize}
...
\end{itemize}
\item foam cells in bone marrow (Figure \ref{fig:orge0f9767})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{./niemann_pick/figures/foam_cells.png}
\caption{\label{fig:orge0f9767}
Foam cells in bone marrow}
\end{figure}

\item Treatment
\label{sec:org5eb2a58}
\begin{itemize}
...
\label{sec:org934c1ec}
\begin{enumerate}
\item Introduction
\label{sec:org3439874}
\begin{itemize}
\item defect in \textbf{\(\beta\)-galactosidase (AKA: \(\beta\)-gangliosidase)}
\begin{itemize}
\item removes galactose from GM1, keratin sulfate and some oligosaccharides (Figure \ref{fig:org4906c41})
\end{itemize}
...
\begin{itemize}
\item ML-1 (sialidosis) (section \ref{sec:org5e8d07b})
\end{itemize}
\end{itemize}
\end{enumerate}

\item Genetics
\label{sec:orgddaa90b}
\begin{itemize}
\item AR GLB1
...
\item Clinical Findings
\label{sec:orgec34dc1}
\begin{itemize}
\item see table \ref{tab:org7209fc1}
\item a cause of non-immune fetal hydrops
\end{itemize}
\begin{table}[htbp]
\caption[GM1 Signs and Symptoms]{\label{tab:org7209fc1}
...
coarse facial features & \textpm{} & - & - & \textsuperscript{\ref{orgcb9b15f}}\\
skeletal findings & + & \textpm{} & - & +\\
urine & \footnotemark & \textsuperscript{\ref{org3be6453}} & \textsuperscript{\ref{org3be6453}} & keratan sulfate \footnotemark\\
\end{tabular}
\end{table}\footnotetext[1]{\label{org5661e1a}corneal clouding}\footnotetext[2]{\label{orgcb9b15f}secondary to bony changes}\footnotetext[3]{\label{org3be6453}oligosacaride with terminal galactose}\footnotetext[4]{\label{org2366d28}FN have been observed}
\item Laboratory Investigations
\label{sec:org00cee79}
\begin{itemize}
...
and \(\beta\) subunits (Table \ref{tab:org2307323})
\end{itemize}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org2307323}
...
\caption{\label{fig:org7491a54}
Hexosaminidase A \& B:Sandhoff disease}
\end{figure}

\item Genetics
\label{sec:orgf47352c}
\begin{itemize}
...
\item Clinical Findings
\label{sec:orgfd2b380}
\begin{itemize}
\item see table \ref{tab:org40ac14b}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:org40ac14b}
...
\end{enumerate}
\subsection{Krabbe}
\label{sec:orga8f415f}
\begin{enumerate}
\item Introduction
\label{sec:org58e9c01}
\begin{itemize}
...
\label{sec:org1feddb9}
\begin{enumerate}
\item Introduction
\label{sec:org7be25a6}
\begin{itemize}
...
\item multiple sulphatase deficiency (Section \ref{sec:orgf56a085})
\end{itemize}
\end{itemize}
\begin{enumerate}
\item Late-infantile
\label{sec:org9683e9e}
\begin{itemize}
...
\end{enumerate}
\subsection{Fabry}
\label{sec:org72edfc8}
\begin{enumerate}
\item Introduction
\label{sec:orgca7692b}
\begin{itemize}
...
(Figure \ref{fig:orga622bcd})
\item accumulation of Gb3 in blood vessels and other tissues
\item globotriaosylceramide (Gb3): the Fabry lipid (Figure \ref{fig:orge199362})
...
\caption[Globotriaosylceramide]{\label{fig:orge199362}
...
\caption[\(\alpha\)-galactosidase A]{\label{fig:orgcbd40ce}
\(\alpha\)-galactosidase A, located in the lumen of lysosomes}
\end{figure}

\item Genetics
\label{sec:orgab4babe}
\begin{itemize}
\item \textbf{XL GLA}
...
\item Clinical Findings
\label{sec:org6073e55}
\begin{itemize}
\item see table \ref{tab:orgfdbbe50}
...
\item ocular lesions
\item angiokeratomas (Figure \ref{fig:org358145f})
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org8a2a7cd}induced by heat, cold, fatigue or emotional stress

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fabry/figures/angiokeratomas.png}
\caption[Angiokeratomas of the skin]{\label{fig:org358145f}
Angiokeratomas of the Skin}
\end{figure}}

\item Laboratory Investigations
\label{sec:org399f74f}
\begin{enumerate}
\item Biochemistry
\label{sec:org519bccd}
\begin{itemize}
...
\end{enumerate}
\subsection{Farber}
\label{sec:org3e59e77}
\begin{enumerate}
\item Introduction
\label{sec:org896b4b3}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:orgee06e9a}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\item Clinical
\label{sec:org2ab9738}
\begin{itemize}
...
\item Treatment
\label{sec:org336efb6}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\section{Niemann-Pick C}
\label{sec:orge2e0c53}
\subsection{Introduction}
\label{sec:org247ea88}
\begin{itemize}
...
\label{sec:org5ad1fc2}
\begin{enumerate}
\item Early Infantile
\label{sec:org8323930}
\begin{itemize}
...
\caption{\label{fig:orgd3fa83b}
Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:org849fe8e}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:org0689ab2}
\subsection{Introduction}
\label{sec:org45c387b}
\begin{itemize}
...
\label{sec:orgf56a085}
\subsection{Introduction}
\label{sec:orgca4dba2}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./mps/figures/ch17f01.jpg}
\caption[Proteoglycans]{\label{fig:orge8a6027}
Proteoglycans}
\end{figure}
...
\caption[Proteoglycan Synthesis]{\label{fig:org4e02532}
...
\caption[Glycan Nomenclature]{\label{fig:orgcc5b115}
...
\caption[Glycosaminoglycans]{\label{fig:org1bbf154}
Glycosaminoglycans}
\end{figure}

\begin{itemize}
\item GAGs are composed of repeating units of disaccharides (Figure \ref{fig:org1bbf154})
\begin{itemize}
...
\caption[DS Degradation]{\label{fig:org5bee423}
DS degradation}
\end{figure}
...
\caption[KS Degradation]{\label{fig:orgdb13220}
KS degradation}
\end{figure}
...
\caption[HS Degradation]{\label{fig:org6dc126c}
HS Degradation}
\end{figure}
\end{enumerate}

\subsection{Multiple sulfatase deficiency}
\label{sec:org197c927}
\begin{itemize}
...
\label{sec:orga7e5214}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org145622f}
\begin{itemize}
...
\label{sec:org62b046a}
\begin{itemize}
\item MPS III (Sanfilippo)
\end{itemize}
\item Severe Skeletal Dysplasia
\label{sec:org9ef2690}
\begin{itemize}
\item MPS IV (Morquio)
\end{itemize}
\item Rare
\label{sec:org1406e94}
\begin{itemize}
\item MPS VII (Sly)
...
\caption[Glycosaminoglycan Degradation]{\label{fig:org975fda0}
Glycosaminoglycan Degradation}
\end{figure}

\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:org878002f}
...
\item Diagnostic Tests
\label{sec:org877a26b}
\begin{itemize}
\item quantitation of urine GAGs (Table \ref{tab:org878002f})
\begin{itemize}
...
\caption{\label{fig:org9ddc4bd}
Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Oligosaccharidoses}
\label{sec:org44f96d5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org53b233d}
\begin{itemize}
\item oligosaccharidoses share many features in common with MPS disorders (Table \ref{tab:orga37c284})
\begin{itemize}
...
\item Genetics
\label{sec:org8a9d835}
\begin{itemize}
\item AR
\end{itemize}
\item Diagnostic Tests
\label{sec:orga97c4b0}
\begin{itemize}
...
\item enzyme activity assays (Table \ref{tab:orga37c284})
\end{itemize}

\item Treatment
\label{sec:org72b6aa8}
\begin{itemize}
\item supportive
\end{itemize}
\end{enumerate}
\section{Mucolipidoses}
\label{sec:org5e8d07b}
\subsection{Introduction}
\label{sec:org2a35704}
\begin{itemize}
...
\label{sec:orgf7f17db}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3cadae0}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgeb30f8e}
\begin{enumerate}
\item ML II
\label{sec:orgd4ea569}
\begin{itemize}
\item low IQ
...
\caption[Protein trafficking to lysosomes]{\label{fig:org75f9c99}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org943bd0d}
...
\caption{\label{fig:orge749554}
I cell in fibroblast culture}
\end{figure}

\item Genetics
\label{sec:orgcad7d50}
\begin{itemize}
\item AR GNPTAB
\end{itemize}

\item Diagnostic Tests
\label{sec:org9395a73}
\begin{itemize}
...
\item Treatment
\label{sec:org805b1b5}
\begin{itemize}
\item supportive
\end{itemize}
\end{enumerate}
\subsection{ML IV}
\label{sec:org270a24d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0d70e75}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:orgcf7f0d2}
\begin{itemize}
\item AR MCOLN1
\end{itemize}
\item Diagnostic Tests
\label{sec:orgb840a45}
\begin{itemize}
...
\section{Peroxisomes}
\label{sec:org2caaa98}
\subsection{Introduction}
\label{sec:org976d7e0}
\begin{itemize}
...
\caption[Non-mitochondrial FA metabolism]{\label{fig:org4a63a58}
...
\label{sec:orgeea90d4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6ade13e}
\begin{itemize}
\item three forms:
\begin{enumerate}
...
\item Genetics
\label{sec:orgadb2773}
\begin{itemize}
\item X-linked ABCD1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgb8bade9}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0881c7c}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:org6f853cf}
\begin{itemize}
...
\label{sec:orgdee905a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org89e8a2b}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org9f86a04}
Oxidation of Phytanic Acid}
\end{figure}

\item Genetics
\label{sec:org8cb53fb}
\begin{itemize}
\item AR PHYH
\end{itemize}

\item Diagnostic Tests
\label{sec:org535649d}
\begin{itemize}
...
\label{sec:orgc83d9ff}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc8e0205}
\begin{itemize}
...
\item Genetics
\label{sec:orge30fcb0}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\item Diagnostic Tests
\label{sec:orgcde3346}
\begin{itemize}
...
\label{sec:org496e44c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org629f0ae}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:org4e47a5a}
\begin{enumerate}
\item RCDP Type 1
\label{sec:org8724db0}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org1a15e29}
\begin{itemize}
\item \(\downarrow\) RBC plasmalogens
\end{itemize}
\begin{enumerate}
\item RDCP1
\label{sec:org3ecab6c}
\begin{itemize}
...
\caption{\label{fig:org998baab}
Eicosanoid Metabolism}
\end{figure}

\begin{enumerate}
\item Disorders
\label{sec:orgc2f409b}
\begin{itemize}
...
\label{sec:org833698a}
\subsection{Introduction}
\label{sec:orga6a0122}
\begin{itemize}
...
\caption{\label{fig:orga9fd3b0}
CDGs}
\end{figure}

\item Congenital Disorders of Glycosylation
\label{sec:org5926268}
\begin{itemize}
...
\caption{\label{fig:org2e74df9}
CDG diagnosis}
\end{figure}
\end{enumerate}

\subsection{PMM2-CDG (CDG Ia)}
\label{sec:org9aa14e2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0190940}
\begin{itemize}
...
\item Genetics
\label{sec:org6cd69cf}
\begin{itemize}
\item AR, PMM2
\end{itemize}

\item Diagnostic Tests
\label{sec:org6010435}
\begin{itemize}
...
\label{sec:org2775ed7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org768ac23}
\begin{itemize}
...
\item Genetics
\label{sec:org94c0407}
\begin{itemize}
\item AR, MPI
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd68e8f7}
\begin{itemize}
...
\label{sec:orgcc01e46}
\begin{enumerate}
\item MGAT2-CDG (CDG IIa)
\label{sec:org69bda9b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8df766a}
\begin{itemize}
\item onset in infancy, neonatal
...
\end{itemize}
\item Genetics
\label{sec:orgb5288cf}
\begin{itemize}
\item AR MGAT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org335bade}
\begin{itemize}
...
\item Treatment
\label{sec:org0db976d}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\item SLC35C1-CDG (CDG IIc)
\label{sec:org898dd82}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc8dfffa}
\begin{itemize}
...
neutrophilia
\item Bombay (hh) blood phenotype (Figure \ref{fig:org6e1cdb6})
\begin{itemize}
\item do not express H antigen
\end{itemize}
\end{itemize}
\item Metabolic Derangement
\label{sec:orgf6f7525}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:orgbfd50f1}
\begin{itemize}
\item AR SLC35C1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgfa7eb10}
\begin{itemize}
\item normal transferrin IEF
\item molecular
\end{itemize}
\item Treatment
\label{sec:org114e58e}
\begin{itemize}
...
\caption[Hh]{\label{fig:org6e1cdb6}
Hh Blood Group}
\end{figure}
\end{enumerate}
\end{enumerate}
\section{Cystinosis}
\label{sec:org2e87141}
\subsection{Introduction}
\label{sec:orgf374024}
\begin{itemize}
...
marrow
\end{enumerate}
\item nephropathic or infantile form is by far the most frequent (see \ref{sec:org58bcf52})
...
\label{sec:org58bcf52}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org59b3eac}
\begin{enumerate}
\item First stage
\label{sec:org597f0b0}
\begin{itemize}
...
\label{sec:org781c451}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org04d5732}
\begin{itemize}
...
\item Genetics
\label{sec:orgecf946c}
\begin{itemize}
\item AR, CTNS
\end{itemize}

\item Diagnostic Tests
\label{sec:org09ee09e}
\begin{itemize}
...
\item Treatment
\label{sec:org927f2c4}
\begin{enumerate}
\item Supportive
\label{sec:orga81d43e}
\begin{itemize}
