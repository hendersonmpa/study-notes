...
\label{sec:orge3193de}
\subsection{Introduction}
\label{sec:orgbd476ef}
\subsubsection{Sphingolipids}
\label{sec:orgcc06c89}
\begin{itemize}
...
\label{sec:org5beaec2}
\begin{enumerate}
\item ER
\label{sec:org4fe3b7d}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:org4313d4a}Sphingolipid Structure}
\end{figure}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org25a287d}Sphingolipid Biosynthesis}
\end{figure}
\end{enumerate}

\subsection{Disorders of Sphingolipid Synthesis}
\label{sec:org7039608}
\subsubsection{Classification}
\label{sec:org1e3d784}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org416fe4b}
\begin{description}
...
\label{sec:org99e561a}

\begin{table}[htbp]
\caption{\label{tab:org606f007}Sphingolipidoses}
\centering
\begin{tabular}{llll}
...
\caption{\label{fig:org5e71969}Sphingolipid Degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:org31de394}
\begin{itemize}
...
\caption{\label{fig:org866212b}Protein Trafficking to Lysosome}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./figures/lysosome_trafficking.jpeg}
\caption{\label{fig:orga1ebf4d}Lysosomal Protein Trafficking Receptors}
\end{figure}

\subsubsection{M6P receptors}
\label{sec:org81c3d47}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:org7908f47}
\subsubsection{Introduction}
\label{sec:org620d8fb}
\begin{itemize}
...
\caption{\label{fig:orga0a84ae}Glucocerebroside the Gaucher Lipid}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{gaucher/figures/glucocerebrosidase.png}
\caption{\label{fig:org95c6e09}\(\beta\)-glucocerebrosidase Defective in Gaucher}
\end{figure}

\subsubsection{Clinical Findings}
\label{sec:orgd70e94d}
\begin{itemize}
\item see table \ref{tab:orgc26fe64}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgc26fe64}Gaucher Clinical Variants}
\centering
\begin{tabular}{llll}
...
\label{sec:org522433a}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{gaucher/figures/Gaucher_Cells_with_Fibrillar_Appearing_Cytoplasm.jpg}
\caption{\label{fig:org42bbe30}Gaucher Cells in a Bone Marrow Smear}
\end{figure}

\begin{enumerate}
\item Biochemistry
\label{sec:org2f11c7e}
\begin{itemize}
...
\label{sec:org13c9b35}
\begin{enumerate}
\item Bone marrow transplantation
\label{sec:org2ce2b9a}
\begin{itemize}
...
\label{sec:org49dbda3}
\subsubsection{Introduction}
\label{sec:orgce95503}
\begin{itemize}
...
\caption{\label{fig:orga63811e}Sphingomyelin}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{niemann_pick/figures/sphingomyelinase.png}
\caption{\label{fig:orgf712aa6}Sphingomyelinase}
\end{figure}

\subsubsection{Clinical Findings}
\label{sec:org057697d}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:org06b73e2}
\begin{itemize}
...
\end{itemize}
\item foam cells in bone marrow (Figure \ref{fig:org6423d58})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{niemann_pick/figures/foam_cells.png}
\caption{\label{fig:org6423d58}Foam Cells in Bone Marrow in NP A,B and C}
\end{figure}

\subsubsection{Treatment}
\label{sec:orgd9d437d}
\begin{itemize}
...
\label{sec:orgabc1072}
\subsubsection{Introduction}
\label{sec:org3bf2693}
\begin{itemize}
\item defect in \textbf{\(\beta\)-galactosidase (AKA: \(\beta\)-gangliosidase)}
\begin{itemize}
\item removes galactose from GM1, keratin sulfate and some oligosaccharides (Figure \ref{fig:orgbb92bc7})
\end{itemize}
...
\caption{\label{fig:orgbb92bc7}\(\beta\)-galactosidase}
\end{figure}


\begin{enumerate}
\item Lysosomal multi-enzyme complex
\label{sec:orge1d111c}
\begin{itemize}
...
\subsubsection{Clinical Findings}
\label{sec:org8af33b9}
\begin{itemize}
\item see table \ref{tab:org45349ee}
\item a cause of non-immune fetal hydrops
\end{itemize}
\begin{table}[htbp]
\caption[GM1 Signs and Symptoms]{\label{tab:org45349ee}GM1 Signs and Symptoms}
\centering
\begin{tabular}{lllll}
...
coarse facial features & \textpm{} & - & - & \textsuperscript{\ref{orga527d0c}}\\
skeletal findings & + & \textpm{} & - & +\\
urine & \footnotemark & \textsuperscript{\ref{org3df5731}} & \textsuperscript{\ref{org3df5731}} & keratan sulfate \footnotemark\\
 &  &  &  & \\
\end{tabular}
\end{table}\footnotetext[1]{\label{org24dcb98}corneal clouding}\footnotetext[2]{\label{orga527d0c}secondary to bony changes}\footnotetext[3]{\label{org3df5731}oligosacaride with terminal galactose}\footnotetext[4]{\label{orge3136e0}FN have been observed}

\subsubsection{Genetics}
\label{sec:org3c3ccf9}
\begin{itemize}
\item AR GLB1
...
and \(\beta\) subunits (Table \ref{tab:orgb0ab19d})
\end{itemize}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgb0ab19d}Hexoaminidase Isozymes}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:org1a74895}GM2 ganglioside storage diseases}
\centering
\begin{tabular}{llrll}
...
\caption{\label{fig:org3d7a5e1}Hexosaminidase A: Tay-Sachs}
\end{figure}
...
\caption{\label{fig:org51d179e}Hexosaminidase A \& B:Sandhoff disease (GL-3 \& 4 equivalent to Gb3 \& 4)}
\end{figure}


\subsubsection{Clinical Findings}
\label{sec:org5f9c1ec}
\begin{itemize}
\item see table \ref{tab:orgb9e481e}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orgb9e481e}GM2 Signs and Symptoms}
\centering
\begin{tabular}{llll}
...
\end{itemize}
\subsubsection{Treatment}
\label{sec:orga84b1ca}
\begin{itemize}
\item treat seizures
\item no curative treatment to date
\end{itemize}
\subsection{Krabbe}
\label{sec:org5e0ced7}
\subsubsection{Introduction}
\label{sec:org606ab15}
\begin{itemize}
...
\caption{\label{fig:org725e0c6}Galactocerebrosidase}
\end{figure}
...
\caption{\label{fig:org96245ee}NBS Follow-up at Mayo}
\end{figure}
...
\begin{enumerate}
\item Treatment
\label{sec:orgc690577}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:orgfda1b93}
\begin{itemize}
...
\label{sec:org8f97586}
\subsubsection{Introduction}
\label{sec:org9aacd1d}
\begin{itemize}
...
\label{sec:org115bd6c}
\begin{itemize}
\item three forms: late infantile-onset, juvenile and adult
\item variants include:
\begin{itemize}
\item saposin B deficiency
\item multiple sulphatase deficiency (see Section \ref{sec:org11c42e3})
\end{itemize}
\end{itemize}
\begin{enumerate}
\item Late-infantile
\label{sec:orge1d6375}
\begin{itemize}
...
\end{itemize}
\subsection{Fabry}
\label{sec:org6e2139e}
\subsubsection{Introduction}
\label{sec:org724aea1}
\begin{itemize}
...
\begin{itemize}
\item Gb3 is the Fabry lipid (Figure \ref{fig:org4c997f0})
\end{itemize}
...
\caption[Globotriaosylceramide]{\label{fig:org4c997f0}Globotriaosylceramide (Gb3): The Fabry lipid}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\textwidth]{fabry/figures/galactosidaseA.png}
\caption[\(\alpha\)-galactosidase A]{\label{fig:org724fb78}\(\alpha\)-galactosidase A, located in the Lumen of Lysosomes}
\end{figure}


\subsubsection{Clinical Findings}
\label{sec:org4523470}
\begin{itemize}
\item see table \ref{tab:org275e3f4}
...
\item ocular lesions
\item angiokeratomas (Figure \ref{fig:orga14259f})
\begin{itemize}
...
\caption[Angiokeratomas of the skin]{\label{fig:orga14259f}Angiokeratomas of the Skin}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org275e3f4}Fabry Signs and Symptoms}
\centering
\begin{tabular}{ll}
Age & Signs\\
\hline
...
\end{tabular}
\end{table}\footnotetext[5]{\label{orgb17b294}induced by heat, cold, fatigue or emotional stress}

\subsubsection{Genetics}
\label{sec:orge46db24}
\begin{itemize}
\item \textbf{XL GLA}
...
\end{itemize}
\subsubsection{Laboratory Investigations}
\label{sec:orge1b2ebe}
\begin{enumerate}
\item Biochemistry
\label{sec:orgd37e2e8}
\begin{itemize}
...
\caption[Fabry EM]{\label{fig:org11dd151}EM showing concentric or lamellar structure of lysosomal inclusions in Fabry disease renal biopsy}
\end{figure}
\end{enumerate}

\subsubsection{Treatment}
\label{sec:org0ad45c3}
\begin{itemize}
\item alleviate pain
\begin{itemize}
...
\end{itemize}
\subsection{Farber}
\label{sec:orgd7c6de1}
\subsubsection{Introduction}
\label{sec:org50b479f}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgbb055b6}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\subsubsection{Clinical}
\label{sec:org062b532}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgf50a4b3}
\begin{itemize}
\item none
\item HSCT trial with poor outcome
\end{itemize}
\section{Niemann-Pick C}
\label{sec:org791d4e6}
\subsection{Introduction}
\label{sec:orgc4504c5}
\begin{itemize}
...
\label{sec:orgfd6099d}
\begin{enumerate}
\item Early Infantile
\label{sec:orgcac191b}
\begin{itemize}
...
\caption{\label{fig:org09d14e7}Filipin Staining (red:filipin stains cholesterol in lysosomes), green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:org29a10f4}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:orgb68abe7}
\subsection{Introduction}
\label{sec:orge36710e}
\begin{itemize}
...
\subsection{Genetics}
\label{sec:org5abd1e3}
\begin{itemize}
\item AR
\item adult form is AD
\end{itemize}
\subsection{Diagnostic Tests}
\label{sec:org45fc804}
\begin{itemize}
...
\caption[Proteoglycan Synthesis]{\label{fig:org5914187}Proteoglycan Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{mps/figures/snfg.png}
\caption[Glycan Nomenclature]{\label{fig:org908d53c}Symbol Nomenclature for Glycans (SNFG)}
\end{figure}
...
\caption[Glycosaminoglycans]{\label{fig:org59aa977}Glycosaminoglycans}
\end{figure}

\begin{itemize}
\item GAGs are composed of repeating units of disaccharides (Figure \ref{fig:org59aa977})
\begin{itemize}
...
\caption[DS Degradation]{\label{fig:org82bcafe}DS degradation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{mps/figures/ks_degradation_disorders.png}
\caption[KS Degradation]{\label{fig:org340eeb7}KS degradation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{mps/figures/hs_degradation_disorders.png}
\caption[HS Degradation]{\label{fig:org2628174}HS Degradation}
\end{figure}
\end{enumerate}

\subsection{Multiple Sulfatase Deficiency}
\label{sec:org9707c74}
\begin{itemize}
...
\label{sec:orgb98f44f}
\subsubsection{Clinical Presentation}
\label{sec:orga8deadd}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org9b34108}MPS Signs and Symptoms}
\centering
...
\label{sec:orgf202155}
\begin{itemize}
\item MPS III (Sanfilippo)
\end{itemize}
\item Severe skeletal dysplasia
\label{sec:org3dd027f}
\begin{itemize}
\item MPS IV (Morquio)
\end{itemize}
\item Rare
\label{sec:org0a730f2}
\begin{itemize}
\item MPS VII (Sly)
...
\caption[Glycosaminoglycan Degradation]{\label{fig:org32b7e46}Glycosaminoglycan Degradation}
\end{figure}


\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:org92fc8a4}MPS Enzymes and Substrates}
\centering
\begin{tabular}{lllll}
...
\end{tabular}
\end{table}\footnotetext[6]{\label{org164603d}\(\beta\)-galactosidase deficiency also causes GM1 gangliosidosis}

\subsubsection{Genetics}
\label{sec:org4638346}
\begin{itemize}
\item AR
\item \textbf{MPS II Hunter is XLR}
\item see table \ref{tab:org92fc8a4}
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orge1001a1}
\begin{itemize}
\item fractionation of urine GAGs (Table \ref{tab:org92fc8a4})
\begin{itemize}
...
\label{sec:orgc96acc5}
\subsection{Introduction}
\label{sec:org7cc365d}
\begin{itemize}
...
\caption{\label{fig:org58ecbf2}Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Oligosaccharidoses}
\label{sec:orgcf666da}
\subsubsection{Clinical Presentation}
\label{sec:org7da443c}
\begin{itemize}
\item oligosaccharidoses share many features in common with MPS disorders (Table \ref{tab:org2406412})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org2406412}Oligosaccharidoses}
\centering
...
\subsubsection{Genetics}
\label{sec:orgcde232e}
\begin{itemize}
\item AR
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orge63e25d}
\begin{itemize}
...
\item enzyme activity assays (Table \ref{tab:org2406412})
\end{itemize}

\subsubsection{Treatment}
\label{sec:org06422b0}
\begin{itemize}
\item supportive
\end{itemize}
\section{Mucolipidoses}
\label{sec:org1e86fdc}
\subsection{Introduction}
\label{sec:orge11988d}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org62861ac}Mucolipidoses}
\centering
\small
\begin{tabular}{lllllll}
Disease & enzyme & dysostosis & progressive & angio- & hepato & sample\\
...
\label{sec:orge8f4bd1}
\subsubsection{Clinical Presentation}
\label{sec:org648e537}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgbd55079}
\begin{itemize}
\item supportive
\end{itemize}

\subsection{ML II \& III}
\label{sec:org85e3e32}
\begin{itemize}
\item ML II AKA: I-Cell Disease
\item ML III AKA: Pseudo-Hurler
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org6581b80}
\begin{enumerate}
\item ML II
\label{sec:org2939ec6}
\begin{itemize}
\item low IQ
...
\begin{table}[htbp]
\caption{\label{tab:org5e57d47}Lysosomal enzyme receptors}
\centering
\begin{tabular}{lll}
...
\caption[Protein trafficking to lysosomes]{\label{fig:orga5f5069}Protein trafficking to lysosomes}
\end{figure}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org67fca2a}N-acetylglucosamine (GlcNAc) phosphotransferase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[height=0.5\textwidth]{mucolipidosis/figures/icell.png}
\caption{\label{fig:orgb81a9cf}I cell in fibroblast culture}
\end{figure}

\subsubsection{Genetics}
\label{sec:orga9881cf}
\begin{itemize}
\item AR GNPTAB
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3ba31e5}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orge88c1ae}
\begin{itemize}
\item supportive
\end{itemize}
\subsection{ML IV}
\label{sec:orgee4ba0f}
\subsubsection{Clinical Presentation}
\label{sec:org97a6252}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgabc635a}
\begin{itemize}
\item AR MCOLN1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgc9f79fe}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org8da3880}
\begin{itemize}
\item supportive
\end{itemize}

\section{Peroxisomes}
\label{sec:orgb0e6ca2}
\subsection{Introduction}
\label{sec:org769a666}
\begin{itemize}
...
\caption{\label{fig:org0d5c299}Non-Mitochondrial FA Metabolism}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:org5041bdb}Biochemical Findings in Peroxisomal Disease}
\centering
\begin{tabular}{llllll}
...
\label{sec:org5a1d73c}
\subsubsection{Clinical Presentation}
\label{sec:org08da9d2}
\begin{itemize}
\item three forms:
\begin{enumerate}
...
\subsubsection{Genetics}
\label{sec:org6e3b819}
\begin{itemize}
\item \textbf{X-linked ABCD1}
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org5fd0eed}
\begin{itemize}
...
\end{itemize}
\item see table \ref{tab:org5041bdb}
\end{itemize}
\subsubsection{Treatment}
\label{sec:orgd267aa4}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orgd5946ef}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:org6cb9eec}
\begin{itemize}
...
\label{sec:org615af48}
\subsubsection{Clinical Presentation}
\label{sec:org3338b13}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org2abc21e}Oxidation of Phytanic Acid}
\end{figure}

\subsubsection{Genetics}
\label{sec:orgfb34995}
\begin{itemize}
\item AR PHYH
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org221e80f}
\begin{itemize}
...
\label{sec:orgb0a9542}
\subsubsection{Clinical Presentation}
\label{sec:org52b8fac}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgd0f99cf}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgd5f669d}
\begin{itemize}
...
\label{sec:org2a8ba2c}
\subsubsection{Clinical Presentation}
\label{sec:org3139486}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org555a134}
\begin{enumerate}
\item RCDP Type 1
\label{sec:org2ff0d40}
\begin{itemize}
...
\caption{\label{fig:orgfa6a362}Eicosanoid Metabolism}
\end{figure}
...
\label{sec:org8e43c87}
\subsection{Introduction}
\label{sec:org2c40440}
\begin{itemize}
...
\caption{\label{fig:orgf909e2f}CDGs}
\end{figure}

\subsubsection{Congenital Disorders of Glycosylation}
\label{sec:orgc31476d}
\begin{itemize}
...
\caption{\label{fig:org99256e2}CDG Diagnosis}
\end{figure}

\begin{enumerate}
\item Treatable CDGs
\label{sec:orgdd69345}
\begin{description}
...
\label{sec:org05f5fa1}
\subsubsection{CDG IA (PMM2-CDG)}
\label{sec:orgdae1644}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org50be9ed}
\begin{itemize}
...
\item Genetics
\label{sec:org4d5acd9}
\begin{itemize}
\item AR PMM2
\end{itemize}

\item Diagnostic Tests
\label{sec:org30a56ff}
\begin{itemize}
...
\end{itemize}
\item see figure \ref{fig:org99256e2}
\end{itemize}

\item Treatment
\label{sec:org395401f}
\begin{itemize}
...
\item Genetics
\label{sec:org2382a57}
\begin{itemize}
\item AR, MPI
\end{itemize}

\item Diagnostic Tests
\label{sec:org524b157}
\begin{itemize}
...
\label{sec:org9e30f48}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org53632ce}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org0df441a}
\begin{itemize}
\item AR ALG6
\end{itemize}
\item Diagnostic Tests
\label{sec:org187f524}
\begin{itemize}
\item transferrin IEF - Type I pattern
...
\label{sec:orgf5b03e9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd3971df}
\begin{itemize}
...
\label{sec:orga8d921c}
\subsubsection{CDG IIa (MGAT2-CDG)}
\label{sec:orgf2e3580}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org411fea1}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org25b7ad7}
\begin{itemize}
\item AR MGAT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org1c52da7}
\begin{itemize}
...
\end{itemize}
\item Treatment
\label{sec:orgaed2236}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\subsubsection{CDG IIc SLC35C1-CDG}
\label{sec:org04fb15b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8f8d54c}
\begin{itemize}
...
neutrophilia
\item Bombay (hh) blood phenotype (Figure \ref{fig:org0d70c01})
\begin{itemize}
\item do not express H antigen
\end{itemize}
\end{itemize}
\item Metabolic Derangement
\label{sec:org0b26d78}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org6a39cfd}
\begin{itemize}
\item AR SLC35C1
\end{itemize}

\item Diagnostic Tests
\label{sec:org8648ae3}
\begin{itemize}
...
\caption[Hh]{\label{fig:org0d70c01}Bombay (hh) Blood Group}
\end{figure}
\end{enumerate}
\section{Cystinosis}
\label{sec:org85c7481}
\subsection{Introduction}
\label{sec:org8538cb5}
\begin{itemize}
...
\caption{\label{fig:orgd8488dc}Cystine}
\end{figure}

\begin{itemize}
\item normally exported by a cystine porter which contains the membrane protein cystinosin (Figure \ref{fig:orgac7cb9d})
\begin{itemize}
...
\caption{\label{fig:orgac7cb9d}Lysosomal export of cystine and related compounds. The cross represents the defect in cystinosis}
\end{figure}
...
marrow
\end{enumerate}
\item nephropathic or infantile form is by far the most frequent (Section \ref{sec:orgafdfeb7})
...
\label{sec:orgafdfeb7}
\subsubsection{Clinical Presentation}
\label{sec:org6f03573}
\begin{enumerate}
\item First stage
\label{sec:orgdb5c152}
\begin{itemize}
...
\label{sec:org00f1d8f}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org4c784a2}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org796d3f0}
\begin{itemize}
\item AR CTNS
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org2b40a72}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgd4e3beb}
\begin{enumerate}
\item Supportive
\label{sec:orgb0cf627}
\begin{itemize}
