...
\label{sec:orgba01b5a}
\subsection{Introduction}
\label{sec:org8a5270a}
\begin{enumerate}
\item Sphingolipids
\label{sec:org7bf576f}
\begin{itemize}
...
\item Biosynthesis
\label{sec:org07756d7}
\begin{enumerate}
\item ER
\label{sec:org2bbee95}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:orgc50d988}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org8d0e2dc}
...
\label{sec:orgadfb09d}
\begin{enumerate}
\item Classification
\label{sec:org21af3b5}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:orge6ec82d}
\begin{itemize}
...
\label{sec:org6857e6c}

\begin{table}[htbp]
\caption{\label{tab:org94cb5ca}
Sphingolipidoses}
\centering
\begin{tabular}{llll}
...
\caption{\label{fig:org6e1becf}
Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:org412eb69}
\begin{itemize}
...
\caption[Lysosomal protein trafficking receptors]{\label{fig:orgc129b8f}
Lysosomal protein trafficking receptors}
\end{figure}

\begin{enumerate}
\item M6P receptors
\label{sec:org02442eb}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:orgcc337d5}
\begin{enumerate}
\item Introduction
\label{sec:org1802c46}
\begin{itemize}
...
\caption{\label{fig:orgf337926}
\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}

\item Genetics
\label{sec:org3135a51}
\begin{itemize}
\item AR GBA
...
\label{sec:org5bb5138}
\begin{itemize}
\item see table \ref{tab:org5af213d}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org5af213d}
...
\label{sec:org2559b19}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./gaucher/figures/Gaucher_Cells_with_Fibrillar_Appearing_Cytoplasm.jpg}
\caption{\label{fig:org432a0cc}
Gaucher Cells in a bone marrow smear}
\end{figure}

\begin{enumerate}
\item Biochemistry
\label{sec:org364c6f7}
\begin{itemize}
...
\item Treatment
\label{sec:org5598ae2}
\begin{enumerate}
\item Bone marrow transplantation
\label{sec:org7bd17a8}
\begin{itemize}
...
\label{sec:org9161ceb}
\begin{enumerate}
\item Introduction
\label{sec:org321a980}
\begin{itemize}
...
\caption{\label{fig:org9793ad9}
Sphingomyelinase}
\end{figure}

\item Genetics
\label{sec:org2e0f4d5}
\begin{itemize}
\item AR, SMPD1
...
\item Clinical Findings
\label{sec:org6ef4b5e}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:orgcfb2d02}
\begin{itemize}
...
\end{itemize}
\item foam cells in bone marrow (Figure \ref{fig:org75f429e})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{./niemann_pick/figures/foam_cells.png}
\caption{\label{fig:org75f429e}
Foam cells in bone marrow}
\end{figure}

\item Treatment
\label{sec:orgd386d71}
\begin{itemize}
...
\label{sec:org4c98ed6}
\begin{enumerate}
\item Introduction
\label{sec:org733533b}
\begin{itemize}
\item defect in \textbf{\(\beta\)-galactosidase (AKA: \(\beta\)-gangliosidase)}
\begin{itemize}
\item removes galactose from GM1, keratin sulfate and some oligosaccharides (Figure \ref{fig:orga5008ff})
\end{itemize}
...
\begin{itemize}
\item ML-1 (sialidosis) (section \ref{sec:org4216f7b})
\end{itemize}
\end{itemize}
\end{enumerate}

\item Genetics
\label{sec:org731c5af}
\begin{itemize}
\item AR GLB1
...
\item Clinical Findings
\label{sec:org061eece}
\begin{itemize}
\item see table \ref{tab:org7b3043f}
\item a cause of non-immune fetal hydrops
\end{itemize}
\begin{table}[htbp]
\caption[GM1 Signs and Symptoms]{\label{tab:org7b3043f}
...
coarse facial features & \textpm{} & - & - & \textsuperscript{\ref{org69a29f3}}\\
skeletal findings & + & \textpm{} & - & +\\
urine & \footnotemark & \textsuperscript{\ref{orgd2ce873}} & \textsuperscript{\ref{orgd2ce873}} & keratan sulfate \footnotemark\\
\end{tabular}
\end{table}\footnotetext[1]{\label{orgb82a1bd}corneal clouding}\footnotetext[2]{\label{org69a29f3}secondary to bony changes}\footnotetext[3]{\label{orgd2ce873}oligosacaride with terminal galactose}\footnotetext[4]{\label{org6ea8fbf}FN have been observed}
\item Laboratory Investigations
\label{sec:org143fc54}
\begin{itemize}
...
and \(\beta\) subunits (Table \ref{tab:orgd46b72c})
\end{itemize}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgd46b72c}
...
\caption{\label{fig:org89ec21a}
Hexosaminidase A \& B:Sandhoff disease (GL-3 \& 4 AKA Gb3 \& 4)}
\end{figure}

\item Genetics
\label{sec:org8188018}
\begin{itemize}
...
\item Clinical Findings
\label{sec:org180dc96}
\begin{itemize}
\item see table \ref{tab:orgc68b305}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orgc68b305}
...
\end{enumerate}
\subsection{Krabbe}
\label{sec:orgf44c2a9}
\begin{enumerate}
\item Introduction
\label{sec:org28a8c20}
\begin{itemize}
...
\begin{enumerate}
\item Treatment
\label{sec:org59376d4}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:org3f0ffc9}
\begin{itemize}
...
\label{sec:orgd17610f}
\begin{enumerate}
\item Introduction
\label{sec:org5d62dcd}
\begin{itemize}
...
\item Clinical
\label{sec:org0e00b8e}
\begin{itemize}
\item three forms: late infantile-onset, juvenile and adult
\item variants include:
\begin{itemize}
\item saposin B deficiency
\item multiple sulphatase deficiency (see Section \ref{sec:org1bae1de})
\end{itemize}
\end{itemize}
\begin{enumerate}
\item Late-infantile
\label{sec:orge6983b9}
\begin{itemize}
...
\end{enumerate}
\subsection{Fabry}
\label{sec:org4fc3f6e}
\begin{enumerate}
\item Introduction
\label{sec:org2c1afae}
\begin{itemize}
...
(Figure \ref{fig:orgf337926})
\item accumulation of Gb3 in blood vessels and other tissues
\begin{itemize}
\item Gb3 is the Fabry lipid (Figure \ref{fig:orgaec18b2})
\end{itemize}
...
\caption[Globotriaosylceramide]{\label{fig:orgaec18b2}
...
\caption[\(\alpha\)-galactosidase A]{\label{fig:org4f93fc7}
\(\alpha\)-galactosidase A, located in the lumen of lysosomes}
\end{figure}

\item Genetics
\label{sec:org44c7529}
\begin{itemize}
\item \textbf{XL GLA}
...
\item Clinical Findings
\label{sec:org8b5c72e}
\begin{itemize}
\item see table \ref{tab:org62ef576}
...
\item ocular lesions
\item angiokeratomas (Figure \ref{fig:orgdac1a72})
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org565bb22}induced by heat, cold, fatigue or emotional stress

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fabry/figures/angiokeratomas.png}
\caption[Angiokeratomas of the skin]{\label{fig:orgdac1a72}
Angiokeratomas of the Skin}
\end{figure}}

\item Laboratory Investigations
\label{sec:orga1a6976}
\begin{enumerate}
\item Biochemistry
\label{sec:orgbe58c16}
\begin{itemize}
...
\end{enumerate}
\subsection{Farber}
\label{sec:orge609b7f}
\begin{enumerate}
\item Introduction
\label{sec:org9a7a411}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org9308259}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\item Clinical
\label{sec:orga560e7b}
\begin{itemize}
...
\item Treatment
\label{sec:orgd5e7b1c}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\section{Niemann-Pick C}
\label{sec:org0e3c241}
\subsection{Introduction}
\label{sec:org6d08c7f}
\begin{itemize}
...
\label{sec:orgb387d77}
\begin{enumerate}
\item Early Infantile
\label{sec:orgd88814f}
\begin{itemize}
...
\caption{\label{fig:orgbe0fd00}
Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:orgb587d97}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:orge206c55}
\subsection{Introduction}
\label{sec:org6cbb3bb}
\begin{itemize}
...
\label{sec:org1bae1de}
\subsection{Introduction}
\label{sec:orgc9ad52d}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./mps/figures/ch17f01.jpg}
\caption[Proteoglycans]{\label{fig:orgef26e82}
Proteoglycans}
\end{figure}
...
\caption[Proteoglycan Synthesis]{\label{fig:org27f0a50}
...
\caption[Glycan Nomenclature]{\label{fig:org629cf5a}
...
\caption[Glycosaminoglycans]{\label{fig:org049f5d2}
Glycosaminoglycans}
\end{figure}

\begin{itemize}
\item GAGs are composed of repeating units of disaccharides (Figure \ref{fig:org049f5d2})
\begin{itemize}
...
\caption[DS Degradation]{\label{fig:org04162ad}
DS degradation}
\end{figure}
...
\caption[KS Degradation]{\label{fig:org4821e24}
KS degradation}
\end{figure}
...
\caption[HS Degradation]{\label{fig:org20c7104}
HS Degradation}
\end{figure}
\end{enumerate}

\subsection{Multiple sulfatase deficiency}
\label{sec:org626336d}
\begin{itemize}
...
\label{sec:org10ab616}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgfa9348e}
\begin{itemize}
...
\label{sec:orgd44c7db}
\begin{itemize}
\item MPS III (Sanfilippo)
\end{itemize}
\item Severe skeletal dysplasia
\label{sec:org64d95d7}
\begin{itemize}
\item MPS IV (Morquio)
\end{itemize}
\item Rare
\label{sec:org001a9a5}
\begin{itemize}
\item MPS VII (Sly)
...
\caption[Glycosaminoglycan Degradation]{\label{fig:org85700ce}
Glycosaminoglycan Degradation}
\end{figure}

\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:orged38520}
...
\item Diagnostic Tests
\label{sec:org39054f0}
\begin{itemize}
\item quantitation of urine GAGs (Table \ref{tab:orged38520})
\begin{itemize}
...
\label{sec:org0b96ca6}
\subsection{Introduction}
\label{sec:org50ad58d}
\begin{itemize}
...
\caption{\label{fig:orgf6d3af2}
Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Oligosaccharidoses}
\label{sec:orgb09ce25}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5f0ba89}
\begin{itemize}
\item oligosaccharidoses share many features in common with MPS disorders (Table \ref{tab:org144c514})
\begin{itemize}
...
\item Genetics
\label{sec:org6153daa}
\begin{itemize}
\item AR
\end{itemize}
\item Diagnostic Tests
\label{sec:org6a722da}
\begin{itemize}
...
\item enzyme activity assays (Table \ref{tab:org144c514})
\end{itemize}

\item Treatment
\label{sec:org37327f4}
\begin{itemize}
\item supportive
\end{itemize}
\end{enumerate}
\section{Mucolipidoses}
\label{sec:org4216f7b}
\subsection{Introduction}
\label{sec:orga055281}
\begin{itemize}
...
\label{sec:org41f5ce2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5bca783}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0283aec}
\begin{enumerate}
\item ML II
\label{sec:org744b9ca}
\begin{itemize}
\item low IQ
...
\begin{table}[htbp]
\caption{\label{tab:orgc94974e}
Lysosomal enzyme receptors}
\centering
\begin{tabular}{lll}
...
\caption[Protein trafficking to lysosomes]{\label{fig:org909e8b1}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org785a441}
...
\caption{\label{fig:orgf145834}
I cell in fibroblast culture}
\end{figure}

\item Genetics
\label{sec:org1fca966}
\begin{itemize}
\item AR GNPTAB
\end{itemize}

\item Diagnostic Tests
\label{sec:orgaf6d5a0}
\begin{itemize}
...
\item Treatment
\label{sec:org7764f7d}
\begin{itemize}
\item supportive
\end{itemize}
\end{enumerate}
\subsection{ML IV}
\label{sec:org88502c7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf031f08}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:orgb908c6d}
\begin{itemize}
\item AR MCOLN1
\end{itemize}
\item Diagnostic Tests
\label{sec:org2dde370}
\begin{itemize}
...
\section{Peroxisomes}
\label{sec:org3f7234b}
\subsection{Introduction}
\label{sec:org845bb13}
\begin{itemize}
...
\caption[Non-mitochondrial FA metabolism]{\label{fig:orgcba2b74}
...
\label{sec:orgee7ddab}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc57576f}
\begin{itemize}
\item three forms:
\begin{enumerate}
...
\item Genetics
\label{sec:orgacbddda}
\begin{itemize}
\item X-linked ABCD1
\end{itemize}

\item Diagnostic Tests
\label{sec:org2a7e26f}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgabe8410}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:org1916173}
\begin{itemize}
...
\label{sec:org7ea3305}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org238fa0d}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org88d73c6}
Oxidation of Phytanic Acid}
\end{figure}

\item Genetics
\label{sec:org77ea5d0}
\begin{itemize}
\item AR PHYH
\end{itemize}

\item Diagnostic Tests
\label{sec:org4d9d601}
\begin{itemize}
...
\label{sec:orgb6a099e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3646ab3}
\begin{itemize}
...
\item Genetics
\label{sec:orgb3bec5a}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\item Diagnostic Tests
\label{sec:org50096b3}
\begin{itemize}
...
\label{sec:orge06f158}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgeafddf9}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:orgdc5e583}
\begin{enumerate}
\item RCDP Type 1
\label{sec:org5e46a97}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:orgaa9e975}
\begin{itemize}
\item \(\downarrow\) RBC plasmalogens
\end{itemize}
\begin{enumerate}
\item RDCP1
\label{sec:org32dccbb}
\begin{itemize}
...
\caption{\label{fig:org078ec66}
Eicosanoid Metabolism}
\end{figure}

\begin{enumerate}
\item Disorders
\label{sec:org9ce4840}
\begin{itemize}
...
\label{sec:org22d5f80}
\subsection{Introduction}
\label{sec:orgb996cec}
\begin{itemize}
...
\begin{itemize}
\item dolichol pyrophosphate-glcNac\(_{\text{2}}\)-man\(_{\text{9}}\)-glu\(_{\text{3}}\) (AKA: dolichol-P)
\end{itemize}
\end{itemize}
...
\caption{\label{fig:orgc1b72e5}
CDGs}
\end{figure}

\item Congenital Disorders of Glycosylation
\label{sec:org46958cc}
\begin{itemize}
...
\caption{\label{fig:org94b7885}
CDG diagnosis}
\end{figure}
\end{enumerate}

\subsection{PMM2-CDG (CDG Ia)}
\label{sec:orgfaa65af}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5448d71}
\begin{itemize}
...
\item Genetics
\label{sec:org7d6d60a}
\begin{itemize}
\item AR, PMM2
\end{itemize}

\item Diagnostic Tests
\label{sec:org6759ce8}
\begin{itemize}
...
\label{sec:org3a2c4d0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org91d9154}
\begin{itemize}
...
\item Genetics
\label{sec:org025e837}
\begin{itemize}
\item AR, MPI
\end{itemize}

\item Diagnostic Tests
\label{sec:orgadd33c3}
\begin{itemize}
...
\label{sec:org2083c06}
\begin{enumerate}
\item MGAT2-CDG (CDG IIa)
\label{sec:orgf15e0ba}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9fa6b94}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org69886e5}
\begin{itemize}
\item AR MGAT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org3b95004}
\begin{itemize}
...
\item Treatment
\label{sec:orgfe0ecf7}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\item SLC35C1-CDG (CDG IIc)
\label{sec:orga2947f4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org07b7f92}
\begin{itemize}
...
neutrophilia
\item Bombay (hh) blood phenotype (Figure \ref{fig:orgc2fa429})
\begin{itemize}
\item do not express H antigen
\end{itemize}
\end{itemize}
\item Metabolic Derangement
\label{sec:orgddfeb0f}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org8425a0f}
\begin{itemize}
\item AR SLC35C1
\end{itemize}

\item Diagnostic Tests
\label{sec:orgec84580}
\begin{itemize}
\item normal transferrin IEF
\item molecular
\end{itemize}
\item Treatment
\label{sec:orgb2c00f7}
\begin{itemize}
...
\caption[Hh]{\label{fig:orgc2fa429}
Hh Blood Group}
\end{figure}
\end{enumerate}
\end{enumerate}
\section{Cystinosis}
\label{sec:orge7a5755}
\subsection{Introduction}
\label{sec:org179a913}
\begin{itemize}
...
marrow
\end{enumerate}
\item nephropathic or infantile form is by far the most frequent (see \ref{sec:org87cd562})
...
\label{sec:org87cd562}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org22fbcd6}
\begin{enumerate}
\item First stage
\label{sec:org2b7146f}
\begin{itemize}
...
\label{sec:orge9f3137}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:orgdde9991}
\begin{itemize}
...
\item Genetics
\label{sec:org74d5ba4}
\begin{itemize}
\item AR, CTNS
\end{itemize}

\item Diagnostic Tests
\label{sec:orgea4f159}
\begin{itemize}
...
\item Treatment
\label{sec:orgc366462}
\begin{enumerate}
\item Supportive
\label{sec:orgdda70bf}
\begin{itemize}
