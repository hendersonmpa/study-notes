...
\label{sec:org8214f17}
\subsection{Introduction}
\label{sec:org3d92a40}
\begin{enumerate}
\item Sphingolipids
\label{sec:orgd5d930c}
\begin{itemize}
...
\item Biosynthesis
\label{sec:org90aed4e}
\begin{enumerate}
\item ER
\label{sec:org8aa0bc3}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:org9bf5c15}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org7f07df5}
...
\label{sec:orgbbb37b9}
\begin{enumerate}
\item Classification
\label{sec:org3388d31}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org797bcde}
\begin{itemize}
...
\item Nonlysosomal Î²-Glucosidase - SPG46
...
\item Non-lysosomal Î²-Glucosidase Deficiency
\label{sec:orge486e88}
...
\label{sec:orgd1877a9}

\begin{table}[htbp]
\caption{\label{tab:orgd4dee49}
...
\caption{\label{fig:orgf65dea5}
Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosome}
\label{sec:orga68228d}
\begin{itemize}
...
\caption[Lysosomal protein trafficking receptors]{\label{fig:org1eefd9d}
Lysosomal protein trafficking receptors}
\end{figure}

\subsection{M6P receptors}
\label{sec:orga1b67a3}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:orgc70ef01}
\begin{enumerate}
\item Introduction
\label{sec:org9286440}
\begin{itemize}
...
\caption{\label{fig:orge529c30}
\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}

\item Genetics
\label{sec:orgbfa59dd}
\begin{itemize}
...
\label{sec:org98fcf43}
\begin{table}[htbp]
\caption{\label{tab:org13bbd77}
...
\item Treatment
\label{sec:orgb8eec70}
\begin{enumerate}
\item Bone marrow transplantation
\label{sec:orgac7206e}
\begin{itemize}
...
\caption{\label{fig:org762a1e7}
Sphingomyelinase}
\end{figure}

\item Genetics
\label{sec:org3a8c3ad}
\begin{itemize}
...
\item Clinical Findings
\label{sec:org8a502d1}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:orgee94a44}
\begin{itemize}
...
\caption{\label{fig:orgb556b3d}
Foam cells in bone marrow}
\end{figure}

\item Treatment
\label{sec:orgeca870c}
\begin{itemize}
...
\label{sec:org5701ada}
\begin{enumerate}
\item Introduction
\label{sec:org1af72aa}
...
\item Clinical Findings
\label{sec:org18f55ad}

\begin{table}[htbp]
\caption[GM1 Signs and Symptoms]{\label{tab:org86c0332}
...
Hepatosplenomegaly & + & +/– & – & –\\
Cardiac involvement & +/– & +/– & +/– & +\\
Coarse facial features & +/– & – & – & \textsuperscript{\ref{org7310461}}\\
Skeletal findings & + & +/– & – & +\\
Neuroimaging & PA & PA & +/– mild atrophy & \textsuperscript{\ref{org7310461}}\\
Urine (GAG) & \footnotemark & \textsuperscript{\ref{org1aa7fba}} & \textsuperscript{\ref{org1aa7fba}} & Keratan sulfate \footnotemark\\
\end{tabular}
\end{table}\footnotetext[1]{\label{org7310461}secondary to bony changes}\footnotetext[2]{\label{org1aa7fba}oligosacaride with terminal galactose}\footnotetext[3]{\label{org675aea0}FN have been observed}

\item Laboratory Investigations
\label{sec:orgc521be5}
\begin{itemize}
...
\caption{\label{fig:orgb3e2678}
Hexosaminidase A \& B:Sandhoff disease}
\end{figure}

\item Genetics
\label{sec:org1b46926}
\begin{itemize}
...
\item Clinical Findings
\label{sec:org35beb8a}
\begin{table}[htbp]
\caption{\label{tab:org0e87b0f}
...
\end{tabular}
\end{table}\footnotetext[4]{\label{org10bbbcb}Prior offspring as well as heterozygote screening (1969-1992)}
\end{enumerate}
\subsection{Krabbe}
\label{sec:org1bf83e1}
\begin{enumerate}
\item Introduction
\label{sec:org7c66a85}
\begin{itemize}
...
\item Diagnosis
\label{sec:orge3924eb}
\begin{enumerate}
\item Symptomatic presentation
\label{sec:orgb0ee9b0}
\begin{itemize}
...
\caption{\label{fig:org58b782a}
NBS follow-up at Mayo}
\end{figure}
\end{enumerate}

\item Laboratory Investigations
\label{sec:orga231fb6}
\begin{enumerate}
\item CSF protein
\label{sec:org232d907}
\begin{itemize}
...
\item Treatment
\label{sec:org67832c2}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:orgaf9a88e}
\begin{itemize}
...
\label{sec:org6cecf55}
\begin{enumerate}
\item Introduction
\label{sec:orgeb39087}
...
\item Clinical
\label{sec:org9ee96c5}
\begin{enumerate}
\item Late-infantile MLD
\label{sec:org3a3d934}
\begin{itemize}
...
\end{enumerate}
\subsection{Fabry}
\label{sec:org485d7bf}
\begin{enumerate}
\item Introduction
\label{sec:orgf946bac}
\begin{itemize}
...
\caption[Globotriaosylceramide]{\label{fig:org945071f}
...
\caption[\(\alpha\)-galactosidase A]{\label{fig:org1eccabe}
\(\alpha\)-galactosidase A, located in the lumen of lysosomes}
\end{figure}

\item Genetics
\label{sec:org4d570a3}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{orga922c17}May be induced by heat, cold, fatigue or emotional stress

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fabry/figures/angiokeratomas.png}
\caption[Angiokeratomas of the skin]{\label{fig:org8327924}
Angiokeratomas of the skin}
\end{figure}}


\item Laboratory Investigations
\label{sec:org5789853}
\begin{enumerate}
\item Biochemistry
\label{sec:org30c1092}
\begin{itemize}
...
\item Treatment
\label{sec:orge6c81b4}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\section{Niemann-Pick C}
\label{sec:orgfa3da7d}
\subsection{Introduction}
\label{sec:org8a575bd}
\begin{itemize}
...
\label{sec:org973fb5c}
\begin{enumerate}
\item Early infantile
\label{sec:org174592f}
\begin{itemize}
...
\caption{\label{fig:orgaea43f7}
Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:org825441e}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:org9770759}
\subsection{Introduction}
\label{sec:orgce68a8f}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./mps/figures/ch17f01.jpg}
\caption[Proteoglycans]{\label{fig:orgd78deae}
Proteoglycans}
\end{figure}

\begin{enumerate}
\item Proteoglycans function
\label{sec:org45843f8}
...
\caption[Proteoglycan Synthesis]{\label{fig:org83cacd9}
Proteoglycan Synthesis}
\end{figure}


\item Glycosaminoglycans
\label{sec:orgbcd921c}
...
\caption[Glycan Nomenclature]{\label{fig:orgc40a742}
...
\caption[Glycosaminoglycans]{\label{fig:orgc7b24f6}
Glycosaminoglycans}
\end{figure}

\item GAGs
\label{sec:orgfdbb5b7}

\begin{enumerate}
\item Hyaluronan
\label{sec:org37882a8}
\begin{itemize}
...
\label{sec:org2753dcc}

\begin{enumerate}
\item Mucopolysaccharidoses
\label{sec:org9740f11}
\begin{itemize}
...
\caption[Glycosaminoglycan Degradation]{\label{fig:org30b606f}
Glycosaminoglycan Degradation}
\end{figure}

\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:org15602df}
...
\caption[DS Degradation]{\label{fig:org91f0832}
DS degradation}
\end{figure}
...
\caption[KS Degradation]{\label{fig:org9c394bc}
KS degradation}
\end{figure}
...
\caption[HS Degradation]{\label{fig:orge8df754}
HS Degradation}
\end{figure}
\end{enumerate}

\section{Oligosaccharidoses}
\label{sec:orgafbdc62}
\subsection{Introduction}
\label{sec:orge6bd262}
...
\caption{\label{fig:org3ed1026}
Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Disorders}
\label{sec:org4c7268f}
\begin{enumerate}
\item Mannosidosis
\label{sec:org7ca13b1}
\begin{itemize}
...
\label{sec:orgfb420c7}
\subsection{Introduction}
\label{sec:org4baf64e}
\begin{itemize}
...
\label{sec:orgf8201be}
\begin{enumerate}
\item Biochemical
\label{sec:org1e8dbae}
\begin{itemize}
...
\caption[Protein trafficking to lysosomes]{\label{fig:org39e43de}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org83fa64b}
...
\caption{\label{fig:org5017ee1}
I cell in fibroblast culture}
\end{figure}

\item Clinical
\label{sec:org938231c}

\begin{enumerate}
\item ML II
\label{sec:orgec05101}
\begin{itemize}
\item low IQ
...
\label{sec:org3d3bf17}

\begin{enumerate}
\item Sialidosis (ML I)
\label{sec:org00972eb}
\begin{itemize}
...
\label{sec:orgc20a152}
\subsection{Introduction}
\label{sec:org5f17932}
\begin{enumerate}
\item Peroxisomal FA oxidation
\label{sec:org2a3055b}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgcaf35f3}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:org0f4cddc}
\begin{itemize}
...
\label{sec:org2057ceb}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgdb3ab41}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org916ed1a}
Oxidation of Phytanic Acid}
\end{figure}

\item Genetics
\label{sec:org2c89720}
\begin{itemize}
...
\label{sec:orge9654d6}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0e0e6bb}
\begin{itemize}
...
\caption{\label{fig:orgf48c529}
Eicosanoid Metabolism}
\end{figure}

\begin{enumerate}
\item Disorders
\label{sec:orgf94f308}
\begin{itemize}
...
\label{sec:org39ec662}
\subsection{Introduction}
\label{sec:orgf3e3776}
\begin{itemize}
...
\label{sec:orga211f55}

\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf34b97e}
\begin{itemize}
...
\label{sec:org3061461}

\begin{enumerate}
\item MGAT2-CDG (CDG-IIa)
\label{sec:orgbc0e8ae}
\begin{itemize}
...
\caption[Hh]{\label{fig:orgc6429b1}
Hh Blood Group}
\end{figure}
\end{enumerate}

\subsection{Laboratory Tests}
\label{sec:org8aa218c}
\begin{enumerate}
\item Transferrin IEF
\label{sec:orgd74bf46}
\begin{itemize}
...
\caption{\label{fig:orge137c41}
Transferrin IEF}
\end{figure}

\item Transferrin IEF limitations
\label{sec:orgb6ed1a1}
...
\caption{\label{fig:org5f6727f}
CDG diagnosis}
\end{figure}
\end{enumerate}
\section{Cystinosis}
\label{sec:org8819a9c}
\subsection{Introduction}
\label{sec:orgc2db0fa}
\begin{itemize}
...
\label{sec:orgd98b4df}
\begin{enumerate}
\item First stage
\label{sec:org726463f}
\begin{itemize}
...
\label{sec:orgcc2e8a7}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org945650d}
\begin{itemize}
...
\item Treatment
\label{sec:orge51e846}
\begin{enumerate}
\item Supportive
\label{sec:orgb4280fb}
\begin{itemize}
