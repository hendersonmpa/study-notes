...
\caption[Sphingolipid Structure]{\label{fig:orgfee0b64}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:org0a3f0c9}
...
\label{sec:org35d26c8}
\begin{enumerate}
\item Classification
\label{sec:org31c5dbb}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org87211ef}
\begin{itemize}
...
\label{sec:org766533c}

\begin{table}[htbp]
\caption{\label{tab:org188bb95}
...
\caption{\label{fig:org6593684}
Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:org3f1e9fb}
\begin{itemize}
...
\caption[Lysosomal protein trafficking receptors]{\label{fig:org512a6f3}
Lysosomal protein trafficking receptors}
\end{figure}

\begin{enumerate}
\item M6P receptors
\label{sec:orgaf50a78}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:orgf47b4d4}
\begin{enumerate}
\item Introduction
\label{sec:org684db22}
\begin{itemize}
...
\caption{\label{fig:org09b8852}
\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}

\item Genetics
\label{sec:org906d848}
\begin{itemize}
\item AR GBA
...
\label{sec:orgcf3abdf}
\begin{itemize}
\item see table \ref{tab:org6ae41bb}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org6ae41bb}
...
\item Treatment
\label{sec:org1628734}
\begin{enumerate}
\item bone marrow transplantation
\label{sec:org453872e}
\begin{itemize}
...
\label{sec:orge4f6e04}
\begin{enumerate}
\item Introduction
\label{sec:org4823824}
\begin{itemize}
...
\caption{\label{fig:orgb0e3d42}
Sphingomyelinase}
\end{figure}

\item Genetics
\label{sec:orgcd3d4a3}
\begin{itemize}
\item AR, SMPD1
...
\item Clinical Findings
\label{sec:orge05e68f}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:org700fbf1}
\begin{itemize}
...
\end{itemize}
\item foam cells in bone marrow (Figure \ref{fig:orgd1fa2d6})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{./niemann_pick/figures/foam_cells.png}
\caption{\label{fig:orgd1fa2d6}
Foam cells in bone marrow}
\end{figure}

\item Treatment
\label{sec:org0913122}
\begin{itemize}
...
\label{sec:org02bf8c3}
\begin{enumerate}
\item Introduction
\label{sec:orgd784d99}
\begin{itemize}
\item defect in \textbf{\(\beta\)-galactosidase (AKA: \(\beta\)-gangliosidase)}
\begin{itemize}
\item removes galactose from GM1, keratin sulfate and some oligosaccharides (Figure \ref{fig:org7006fe0})
\end{itemize}
...
\begin{itemize}
\item ML-1 (sialidosis) (section \ref{sec:orgfeae879})
\end{itemize}
\end{itemize}
\end{enumerate}

\item Genetics
\label{sec:org260f9e0}
\begin{itemize}
\item AR GLB1
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org064cb48}corneal clouding}\footnotetext[2]{\label{org01fa64a}secondary to bony changes}\footnotetext[3]{\label{org1db0600}oligosacaride with terminal galactose}\footnotetext[4]{\label{orga862ab3}FN have been observed}
\item Laboratory Investigations
...
\label{sec:orgde61a91}
\begin{enumerate}
\item Introduction
\label{sec:org14efda2}
\begin{itemize}
...
and \(\beta\) subunits (Table \ref{tab:orgd01457f})
\end{itemize}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgd01457f}
...
\caption{\label{fig:orgea8e9c8}
Hexosaminidase A \& B:Sandhoff disease}
\end{figure}

\item Genetics
\label{sec:org50d0652}
\begin{itemize}
...
\item Clinical Findings
\label{sec:org01448e0}
\begin{itemize}
\item see table \ref{tab:org79115dc}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:org79115dc}
...
\end{enumerate}
\subsection{Krabbe}
\label{sec:orgee43ef7}
\begin{enumerate}
\item Introduction
\label{sec:orgc706b38}
\begin{itemize}
...
\begin{enumerate}
\item Treatment
\label{sec:orgdbbfa2d}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:orgcee6256}
\begin{itemize}
...
\label{sec:org5cafdad}
\begin{enumerate}
\item Introduction
\label{sec:orgce911e1}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org6a7ecb8}induced by heat, cold, fatigue or emotional stress

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fabry/figures/angiokeratomas.png}
\caption[Angiokeratomas of the skin]{\label{fig:org973c9de}
Angiokeratomas of the Skin}
\end{figure}}

\item Laboratory Investigations
\label{sec:org702ec37}
\begin{enumerate}
\item Biochemistry
\label{sec:org4f7c162}
\begin{itemize}
...
\end{enumerate}
\subsection{Farber}
\label{sec:orgb35f8fe}
\begin{enumerate}
\item Introduction
\label{sec:orgcb2782b}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org0e15072}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\item Clinical
\label{sec:orge325b82}
\begin{itemize}
...
\item Treatment
\label{sec:orgd88fba6}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\section{Niemann-Pick C}
\label{sec:org093226f}
\subsection{Introduction}
\label{sec:org825e428}
\begin{itemize}
...
\label{sec:orgfbc55fd}
\begin{enumerate}
\item Early Infantile
\label{sec:org57c2e2e}
\begin{itemize}
...
\caption[DS Degradation]{\label{fig:org5a000eb}
DS degradation}
\end{figure}
...
\caption[KS Degradation]{\label{fig:orgca0ef89}
KS degradation}
\end{figure}
...
\caption[HS Degradation]{\label{fig:org2a71360}
HS Degradation}
\end{figure}
\end{enumerate}

\subsection{Multiple sulfatase deficiency}
\label{sec:org8ec042e}
\begin{itemize}
...
\label{sec:org491b813}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgaf156dc}
\begin{itemize}
...
\label{sec:orgfe5ec37}
\begin{itemize}
\item MPS III (Sanfilippo)
\end{itemize}
\item Severe Skeletal Dysplasia
\label{sec:org89f7929}
\begin{itemize}
\item MPS IV (Morquio)
\end{itemize}
\item Rare
\label{sec:org4280ad0}
\begin{itemize}
\item MPS VII (Sly)
...
\label{sec:org09c87ca}
\subsection{Introduction}
\label{sec:orgeefec14}
...
\caption{\label{fig:orgf18e8c2}
Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Oligosaccharidoses}
\label{sec:org6126c20}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9e739bc}
\begin{itemize}
\item oligosaccharidoses share many features in common with MPS disorders (Table \ref{tab:orge660aa0})
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9c09814}
\begin{enumerate}
\item ML II
\label{sec:orgd6a7826}
\begin{itemize}
\item low IQ
...
\caption[Protein trafficking to lysosomes]{\label{fig:org24e72fc}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org41b9ca7}
...
\caption{\label{fig:orgc74082a}
I cell in fibroblast culture}
\end{figure}

\item Genetics
\label{sec:org37d78cf}
\begin{itemize}
\item AR GNPTAB
\end{itemize}
...
\section{Peroxisomes}
\label{sec:org6482740}
\subsection{Introduction}
\label{sec:orgb954d87}
\begin{itemize}
...
\caption[Non-mitochondrial FA metabolism]{\label{fig:orgb6ad806}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3fe0eef}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:org8b8fccc}
\begin{itemize}
...
\label{sec:orge441277}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6cc28f4}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org0c1bc8b}
Oxidation of Phytanic Acid}
\end{figure}

\item Genetics
\label{sec:orgcde4268}
\begin{itemize}
\item AR PHYH
\end{itemize}

\item Diagnostic Tests
\label{sec:orge4058e3}
\begin{itemize}
...
\label{sec:org6d1141a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc4e0d41}
\begin{itemize}
...
\item Genetics
\label{sec:org9422d3b}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\item Diagnostic Tests
\label{sec:org2bf73bf}
\begin{itemize}
...
\label{sec:orgf2e9c1a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org85012ab}
\begin{itemize}
...
\item Metabolic Derangement
\label{sec:orge84ea38}
\begin{enumerate}
\item RCDP Type 1
\label{sec:org10dea12}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org1bd2925}
\begin{itemize}
\item \(\downarrow\) RBC plasmalogens
\end{itemize}
\begin{enumerate}
\item RDCP1
\label{sec:org1c45e9b}
\begin{itemize}
...
\label{sec:org58a6d95}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc2c2920}
\begin{itemize}
...
\label{sec:org03eb908}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org41a8ffe}
\begin{enumerate}
\item First stage
\label{sec:org3df06ea}
\begin{itemize}
...
\label{sec:org735490b}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org15486f5}
\begin{itemize}
...
\item Genetics
\label{sec:org718e3bb}
\begin{itemize}
\item AR, CTNS
\end{itemize}

\item Diagnostic Tests
\label{sec:org1e890a5}
\begin{itemize}
...
\item Treatment
\label{sec:org64231c7}
\begin{enumerate}
\item Supportive
\label{sec:orgbfdc4d3}
\begin{itemize}
