...
\label{sec:orgbea9338}
\subsection{Introduction}
\label{sec:org276bb4f}
\subsubsection{Sphingolipids}
\label{sec:org3f40df8}
\begin{itemize}
...
\label{sec:org80a08d0}
\begin{enumerate}
\item ER
\label{sec:org9ae4fc2}
\begin{itemize}
...
\caption[Sphingolipid Structure]{\label{fig:org19ee588}Sphingolipid Structure}
\end{figure}
...
\caption[Sphingolipid Biosynthesis]{\label{fig:orge83c32d}Sphingolipid Biosynthesis}
\end{figure}
\end{enumerate}

\subsection{Disorders of Sphingolipid Synthesis}
\label{sec:orge3061d2}
\subsubsection{Classification}
\label{sec:orge86f4f6}
\begin{enumerate}
\item Primarily nervous system involvement
\label{sec:org0502adb}
\begin{description}
...
\label{sec:org80ce5c8}

\begin{table}[htbp]
\caption{\label{tab:org98e0e0b}Sphingolipidoses}
\centering
\begin{tabular}{llll}
...
\caption{\label{fig:org4aaa530}Sphingolipid degradation}
\end{figure}

\subsection{Protein Trafficking to Lysosomes}
\label{sec:org9c6ac8f}
\begin{itemize}
...
\caption{\label{fig:orga29b6ec}Protein Trafficking to Lysosome}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./figures/lysosome_trafficking.jpeg}
\caption[Lysosomal protein trafficking receptors]{\label{fig:org6c825f4}Lysosomal protein trafficking receptors}
\end{figure}

\subsubsection{M6P receptors}
\label{sec:org2d826c5}
\begin{itemize}
...
\subsection{Gaucher}
\label{sec:org6e97efc}
\subsubsection{Introduction}
\label{sec:orgb1428a2}
\begin{itemize}
...
\caption{\label{fig:orgf0a1e8c}Glucocerebroside the Gaucher Lipid}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{gaucher/figures/glucocerebrosidase.png}
\caption{\label{fig:orgd00833c}\(\beta\)-glucocerebrosidase defective in Gaucher}
\end{figure}


\subsubsection{Clinical Findings}
\label{sec:orge9d0858}
\begin{itemize}
\item see table \ref{tab:org61130ed}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org61130ed}Gaucher Clinical Variants}
\centering
\begin{tabular}{llll}
...
\label{sec:orgd69edac}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{gaucher/figures/Gaucher_Cells_with_Fibrillar_Appearing_Cytoplasm.jpg}
\caption{\label{fig:orge52a33d}Gaucher Cells in a bone marrow smear}
\end{figure}

\begin{enumerate}
\item Biochemistry
\label{sec:orga26c4e8}
\begin{itemize}
...
\label{sec:orgf3ec7d3}
\begin{enumerate}
\item Bone marrow transplantation
\label{sec:orge127da2}
\begin{itemize}
...
\label{sec:orgb5f1ba7}
\subsubsection{Introduction}
\label{sec:org5eaa891}
\begin{itemize}
...
\caption{\label{fig:orgefcfa9e}Sphingomyelin}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{niemann_pick/figures/sphingomyelinase.png}
\caption{\label{fig:orgc831690}Sphingomyelinase}
\end{figure}

\subsubsection{Clinical Findings}
\label{sec:orgb7d3664}
\begin{enumerate}
\item Niemann-Pick A symptoms
\label{sec:org1de93ce}
\begin{itemize}
...
\end{itemize}
\item foam cells in bone marrow (Figure \ref{fig:org1e0daae})
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{niemann_pick/figures/foam_cells.png}
\caption{\label{fig:org1e0daae}Foam cells in bone marrow}
\end{figure}

\subsubsection{Treatment}
\label{sec:org0c7dc15}
\begin{itemize}
...
\label{sec:org61ca885}
\subsubsection{Introduction}
\label{sec:org7d21f6d}
\begin{itemize}
\item defect in \textbf{\(\beta\)-galactosidase (AKA: \(\beta\)-gangliosidase)}
\begin{itemize}
\item removes galactose from GM1, keratin sulfate and some oligosaccharides (Figure \ref{fig:orgce90c50})
\end{itemize}
...
\caption{\label{fig:orgce90c50}\(\beta\)-galactosidase}
\end{figure}


\begin{enumerate}
\item Lysosomal multi-enzyme complex
\label{sec:org5f7b7d9}
\begin{itemize}
...
\subsubsection{Clinical Findings}
\label{sec:orgfdf055e}
\begin{itemize}
\item see table \ref{tab:orgaf55d72}
\item a cause of non-immune fetal hydrops
\end{itemize}
\begin{table}[htbp]
\caption[GM1 Signs and Symptoms]{\label{tab:orgaf55d72}GM1 Signs and Symptoms}
\centering
\begin{tabular}{lllll}
...
coarse facial features & \textpm{} & - & - & \textsuperscript{\ref{org4452fc4}}\\
skeletal findings & + & \textpm{} & - & +\\
urine & \footnotemark & \textsuperscript{\ref{orge934692}} & \textsuperscript{\ref{orge934692}} & keratan sulfate \footnotemark\\
\end{tabular}
\end{table}\footnotetext[1]{\label{orgea6fd13}corneal clouding}\footnotetext[2]{\label{org4452fc4}secondary to bony changes}\footnotetext[3]{\label{orge934692}oligosacaride with terminal galactose}\footnotetext[4]{\label{org4535ac5}FN have been observed}

\subsubsection{Genetics}
\label{sec:org9bb92c3}
\begin{itemize}
\item AR GLB1
...
and \(\beta\) subunits (Table \ref{tab:org186836a})
\end{itemize}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org186836a}Hexoaminidase Isozymes}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:orgdba0186}GM2 ganglioside storage diseases}
\centering
\begin{tabular}{llrll}
...
\caption{\label{fig:orga80060a}Hexosaminidase A: Tay-Sachs}
\end{figure}
...
\caption{\label{fig:org5f95e31}Hexosaminidase A \& B:Sandhoff disease [fn:gl]}
\end{figure}

\subsubsection{Clinical Findings}
\label{sec:orgc14e115}
\begin{itemize}
\item see table \ref{tab:org88ca258}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:org88ca258}GM2 Signs and Symptoms}
\centering
\begin{tabular}{llll}
...
\subsubsection{Treatment}
\label{sec:org6801343}
\begin{itemize}
\item treat seizures
\item no curative treatment to date
\end{itemize}
\subsection{Krabbe}
\label{sec:orgb5362c6}
\subsubsection{Introduction}
\label{sec:org2e96f4a}
\begin{itemize}
...
\caption{\label{fig:orga57789d}Galactocerebrosidase}
\end{figure}
...
\caption{\label{fig:org56aa856}NBS follow-up at Mayo}
\end{figure}
...
\begin{enumerate}
\item Treatment
\label{sec:org2c78d3e}
\begin{enumerate}
\item Treatment of manifestations
\label{sec:org0a735c0}
\begin{itemize}
...
\label{sec:orgffb8ef8}
\subsubsection{Introduction}
\label{sec:orgc7a89af}
\begin{itemize}
...
\label{sec:orga13a6c1}
\begin{itemize}
\item three forms: late infantile-onset, juvenile and adult
\item variants include:
\begin{itemize}
\item saposin B deficiency
\item multiple sulphatase deficiency (see Section \ref{sec:orgabea66d})
\end{itemize}
\end{itemize}
\begin{enumerate}
\item Late-infantile
\label{sec:org8ab7da2}
\begin{itemize}
...
\end{itemize}
\subsection{Fabry}
\label{sec:orga44efdd}
\subsubsection{Introduction}
\label{sec:orgb1a2e01}
\begin{itemize}
...
(Figure \ref{fig:orgd00833c})
\item accumulation of Gb3 in blood vessels and other tissues
\begin{itemize}
\item Gb3 is the Fabry lipid (Figure \ref{fig:orgf6afc5c})
\end{itemize}
...
\caption[Globotriaosylceramide]{\label{fig:orgf6afc5c}Globotriaosylceramide (Gb3): the Fabry lipid}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\textwidth]{fabry/figures/galactosidaseA.png}
\caption[\(\alpha\)-galactosidase A]{\label{fig:org49fab6c}\(\alpha\)-galactosidase A, located in the lumen of lysosomes}
\end{figure}


\subsubsection{Clinical Findings}
\label{sec:orgff591e5}
\begin{itemize}
\item see table \ref{tab:org89f90b9}
...
\item ocular lesions
\item angiokeratomas (Figure \ref{fig:orgd0790a5})
\begin{itemize}
...
\caption[Angiokeratomas of the skin]{\label{fig:orgd0790a5}Angiokeratomas of the Skin}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org89f90b9}Fabry Signs and Symptoms}
\centering
\begin{tabular}{ll}
Age & Signs\\
\hline
...
\end{tabular}
\end{table}\footnotetext[5]{\label{org6fdf21b}induced by heat, cold, fatigue or emotional stress}

\subsubsection{Genetics}
\label{sec:org86c90ad}
\begin{itemize}
\item \textbf{XL GLA}
...
\subsubsection{Laboratory Investigations}
\label{sec:org0c6b7b1}
\begin{enumerate}
\item Biochemistry
\label{sec:orgfc91130}
\begin{itemize}
...
\caption[Fabry EM]{\label{fig:org7076dde}EM showing concentric or lamellar structure of lysosomal inclusions in Fabry disease renal biopsy}
\end{figure}
\end{enumerate}

\subsubsection{Treatment}
\label{sec:orgec76d60}
\begin{itemize}
\item alleviate pain
\begin{itemize}
...
\end{itemize}
\subsection{Farber}
\label{sec:org75f5e63}
\subsubsection{Introduction}
\label{sec:org6822fda}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org83b8c67}
\begin{itemize}
\item AR ASAH1
\end{itemize}
\subsubsection{Clinical}
\label{sec:orgd86ebef}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org23b57bc}
\begin{itemize}
\item none
\end{itemize}
\section{Niemann-Pick C}
\label{sec:orgd1957d9}
\subsection{Introduction}
\label{sec:org64bae90}
\begin{itemize}
...
\label{sec:orgb6e9dbb}
\begin{enumerate}
\item Early Infantile
\label{sec:org9aa5ecc}
\begin{itemize}
...
\subsection{Genetics}
\label{sec:orgf09bb41}
\begin{itemize}
\item AR NPC1 (95\%) and NPC2 (5\%)
\end{itemize}
\subsection{Diagnostic Tests}
\label{sec:org7ca0969}
\begin{itemize}
...
\caption{\label{fig:org1088259}Filipin staining (red:filipin, green:CellMask)}
\end{figure}

\subsection{Treatment}
\label{sec:org9053971}
\begin{itemize}
\item substrate reduction therapy
\begin{itemize}
...
\label{sec:orga66ed19}
\subsection{Introduction}
\label{sec:orgee617c3}
\begin{itemize}
...
\subsection{Genetics}
\label{sec:org6464fc7}
\begin{itemize}
\item AR
\item adult form is AD
\end{itemize}
\subsection{Diagnostic Tests}
\label{sec:org96ab297}
\begin{itemize}
...
\caption[Proteoglycan Synthesis]{\label{fig:org2ac6b52}Proteoglycan Synthesis}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{mps/figures/snfg.png}
\caption[Glycan Nomenclature]{\label{fig:org2ad4a1e}Symbol Nomenclature for Glycans (SNFG)}
\end{figure}
...
\caption[Glycosaminoglycans]{\label{fig:orgb11d69b}Glycosaminoglycans}
\end{figure}

\begin{itemize}
\item GAGs are composed of repeating units of disaccharides (Figure \ref{fig:orgb11d69b})
\begin{itemize}
...
\caption[DS Degradation]{\label{fig:org3e7e7fa}DS degradation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{mps/figures/ks_degradation_disorders.png}
\caption[KS Degradation]{\label{fig:org7c88531}KS degradation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{mps/figures/hs_degradation_disorders.png}
\caption[HS Degradation]{\label{fig:orgb11a95d}HS Degradation}
\end{figure}
\end{enumerate}

\subsection{Multiple Sulfatase Deficiency}
\label{sec:org7b558e3}
\begin{itemize}
...
\label{sec:org6483c6a}
\subsubsection{Clinical Presentation}
\label{sec:orga3ad4ec}
\begin{itemize}
...
\label{sec:orgc262efa}
\begin{itemize}
\item MPS III (Sanfilippo)
\end{itemize}
\item Severe skeletal dysplasia
\label{sec:org6dbfb23}
\begin{itemize}
\item MPS IV (Morquio)
\end{itemize}
\item Rare
\label{sec:org003e34d}
\begin{itemize}
\item MPS VII (Sly)
...
\begin{table}[htbp]
\caption{\label{tab:org2520bbb}MPS Signs and Symptoms}
\centering
...
\caption[Glycosaminoglycan Degradation]{\label{fig:orgc5c632d}Glycosaminoglycan Degradation}
\end{figure}


\begin{table}[htbp]
\caption[Mucopolysaccharidoses]{\label{tab:orgb4c3024}MPS Enzymes and Substrates}
\centering
\begin{tabular}{lllll}
...
\subsubsection{Diagnostic Tests}
\label{sec:org81b3f97}
\begin{itemize}
\item quantitation of urine GAGs (Table \ref{tab:orgb4c3024})
\begin{itemize}
...
\label{sec:orgdbdbe70}
\subsection{Introduction}
\label{sec:org3cad2fb}
\begin{itemize}
...
\caption{\label{fig:org4be32c5}Glycoprotein Oligosaccharide Chain}
\end{figure}

\subsection{Oligosaccharidoses}
\label{sec:orgc6fd58d}
\subsubsection{Clinical Presentation}
\label{sec:orgac86f7c}
\begin{itemize}
\item oligosaccharidoses share many features in common with MPS disorders (Table \ref{tab:org7e98bdd})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org7e98bdd}Oligosaccharidoses}
\centering
...
\subsubsection{Genetics}
\label{sec:org068a454}
\begin{itemize}
\item AR
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orge47e7d7}
\begin{itemize}
...
\item enzyme activity assays (Table \ref{tab:org7e98bdd})
\end{itemize}

\subsubsection{Treatment}
\label{sec:orgf2344ab}
\begin{itemize}
\item supportive
\end{itemize}
\section{Mucolipidoses}
\label{sec:orgf8ff58b}
\subsection{Introduction}
\label{sec:orgb228ae5}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orge1116a6}Mucolipidoses}
\centering
\begin{tabular}{lllllll}
Disease & enzyme & dysostosis & progressive & angio- & hepato & sample\\
 &  & multiplex & cognitive & keratoma & -splenomegally & \\
...
\label{sec:orgb26d86a}
\subsubsection{Clinical Presentation}
\label{sec:org0d24fa7}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgd2a5847}
\begin{itemize}
\item supportive
\end{itemize}

\subsection{ML II \& III}
\label{sec:orgdcce6f7}
\begin{itemize}
\item ML II AKA: I-Cell Disease
\item ML III AKA: Pseudo-Hurler
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgf5d83d0}
\begin{enumerate}
\item ML II
\label{sec:orga076cfc}
\begin{itemize}
\item low IQ
...
\begin{table}[htbp]
\caption{\label{tab:org3840341}Lysosomal enzyme receptors}
\centering
\begin{tabular}{lll}
...
\caption[Protein trafficking to lysosomes]{\label{fig:orgfe7a3bd}Protein trafficking to lysosomes}
\end{figure}
...
\caption[N-acetylglucosamine (GlcNAc) phosphotransferase]{\label{fig:org5206835}N-acetylglucosamine (GlcNAc) phosphotransferase}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[height=0.5\textwidth]{mucolipidosis/figures/icell.png}
\caption{\label{fig:org2ea3ec5}I cell in fibroblast culture}
\end{figure}

\subsubsection{Genetics}
\label{sec:org85aac97}
\begin{itemize}
\item AR GNPTAB
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgf6df9f3}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org776390b}
\begin{itemize}
\item supportive
\end{itemize}
\subsection{ML IV}
\label{sec:org4ff162c}
\subsubsection{Clinical Presentation}
\label{sec:org7152f9e}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orge1a9d4d}
\begin{itemize}
\item AR MCOLN1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org78fcb3b}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgc30180e}
\begin{itemize}
\item supportive
\end{itemize}

\section{Peroxisomes}
\label{sec:org9ca1e81}
\subsection{Introduction}
\label{sec:orgc9a9d0a}
\begin{itemize}
...
\caption[Non-mitochondrial FA metabolism]{\label{fig:orgf43af5d}Non-mitochondrial FA metabolism}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:orgf703ad7}Biochemical Findings in Peroxisomal Disease}
\centering
\begin{tabular}{llllll}
...
\label{sec:orgeb49175}
\subsubsection{Clinical Presentation}
\label{sec:org36f0100}
\begin{itemize}
\item three forms:
\begin{enumerate}
...
\subsubsection{Genetics}
\label{sec:orgf04490e}
\begin{itemize}
\item \textbf{X-linked ABCD1}
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgbd84280}
\begin{itemize}
...
\end{itemize}
\item see table \ref{tab:orgf703ad7}
\end{itemize}
\subsubsection{Treatment}
\label{sec:org048770c}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org09789dd}
\begin{enumerate}
\item Zellweger Syndrome
\label{sec:orgad96a01}
\begin{itemize}
...
\label{sec:org350b7b8}
\subsubsection{Clinical Presentation}
\label{sec:orgfec1a1b}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org550075b}Oxidation of Phytanic Acid}
\end{figure}

\subsubsection{Genetics}
\label{sec:org154938a}
\begin{itemize}
\item AR PHYH
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org4aff96b}
\begin{itemize}
...
\label{sec:orgc97a770}
\subsubsection{Clinical Presentation}
\label{sec:org67fde2e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga2893bb}
\begin{itemize}
\item AR ALDH3A2
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7c74351}
\begin{itemize}
...
\label{sec:org0749947}
\subsubsection{Clinical Presentation}
\label{sec:orgd858e4c}
\begin{itemize}
...
\subsubsection{Metabolic Derangement}
\label{sec:org84c1987}
\begin{enumerate}
\item RCDP Type 1
\label{sec:orga1102b1}
\begin{itemize}
...
\caption{\label{fig:org243b7dd}Eicosanoid Metabolism}
\end{figure}

\subsubsection{Disorders}
\label{sec:org1b2c67a}
\begin{itemize}
...
\label{sec:org571d82a}
\subsection{Introduction}
\label{sec:orgbe405aa}
\begin{itemize}
...
\caption{\label{fig:org36ca4f0}CDGs}
\end{figure}

\subsubsection{Congenital Disorders of Glycosylation}
\label{sec:orgf2a0db1}
\begin{itemize}
...
\caption{\label{fig:org0d4e4b4}CDG diagnosis}
\end{figure}

\subsection{CDG Ia (PMM2-CDG)}
\label{sec:org0f4e7ce}
\subsubsection{Clinical Presentation}
\label{sec:org39911f7}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org888e12f}
\begin{itemize}
\item AR PMM2
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org872a23f}
\begin{itemize}
...
\item see figure \ref{fig:org0d4e4b4}
\end{itemize}

\subsubsection{Treatment}
\label{sec:orgcaca8a0}
\begin{itemize}
\item no effective treatment is available
\end{itemize}

\subsection{CDG Ib (MPI-CDG)}
\label{sec:org5eb5590}
\subsubsection{Clinical Presentation}
\label{sec:orgaf16762}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb39acc0}
\begin{itemize}
\item AR, MPI
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgb19bb05}
\begin{itemize}
...
\label{sec:org33010cc}
\subsubsection{CDG IIa (MGAT2-CDG)}
\label{sec:org4516ff9}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8963368}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org661b9e4}
\begin{itemize}
\item AR MGAT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org39a1759}
\begin{itemize}
...
\end{itemize}
\item Treatment
\label{sec:orgdeff736}
\begin{itemize}
\item none
\end{itemize}
\end{enumerate}
\subsubsection{CDG IIc SLC35C1-CDG}
\label{sec:orgacb6127}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org7f54aa5}
\begin{itemize}
...
neutrophilia
\item Bombay (hh) blood phenotype (Figure \ref{fig:org7cbfb48})
\begin{itemize}
\item do not express H antigen
\end{itemize}
\end{itemize}
\item Metabolic Derangement
\label{sec:org52e0fbf}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org441704c}
\begin{itemize}
\item AR SLC35C1
\end{itemize}

\item Diagnostic Tests
\label{sec:org6495c1c}
\begin{itemize}
...
\caption[Hh]{\label{fig:org7cbfb48}Bombay (hh) Blood Group}
\end{figure}
\end{enumerate}
\section{Cystinosis}
\label{sec:orgbca4273}
\subsection{Introduction}
\label{sec:org41c2c51}
\begin{itemize}
...
\caption{\label{fig:orge52e9d4}Cystine}
\end{figure}

\begin{itemize}
\item normally exported by a cystine porter which contains the membrane protein cystinosin (Figure \ref{fig:orgbf2770b})
\begin{itemize}
...
\caption{\label{fig:orgbf2770b}Lysosomal export of cystine and related compounds. The cross represents the defect in cystinosis}
\end{figure}
...
marrow
\end{enumerate}
\item nephropathic or infantile form is by far the most frequent (Section \ref{sec:org9cbe55d})
...
\label{sec:org9cbe55d}
\subsubsection{Clinical Presentation}
\label{sec:org879c434}
\begin{enumerate}
\item First stage
\label{sec:org88af13a}
\begin{itemize}
...
\label{sec:orgcb24b93}
\begin{itemize}
\item 6-12 years
\item delayed by cysteamine treatment
\end{itemize}
\item Late symptoms
\label{sec:org767dbef}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb9cbec7}
\begin{itemize}
\item AR, CTNS
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org5d53004}
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org65e6f3d}
\begin{enumerate}
\item Supportive
\label{sec:orgfb2635d}
\begin{itemize}
