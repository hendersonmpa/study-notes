...
\caption{\label{tab:orgd80d2f4}Lysosomal Storage Disorder Biochemistry}
\\
...
ML II \& III\footnotemark & GlcNAc-1-P transferase & Oligos, GAGs, lipids & Oligos(U), GAGs(U) & E\footnotemark, M & \emph{GNPTAB},\\
...
\end{longtable}\footnotetext[1]{\label{orga9293ef}GM1 and MPS-IVB appear to be a continuum of phenotypes}\footnotetext[2]{\label{org9f5809c}p-nitrocatecol sulfate is used for ARSA(MLD) and
ARSB(MPS-VI) arylsulfatase assays. ARSB is inactivated with
0.25M sodium pyrophosphate. ARSA is inactivated with barium}\footnotetext[3]{\label{org59d94d9}Patients with the B1 variant produce Hex A, which is normal
when tested with artificial substrates, but defective with natural
substrates}\footnotetext[4]{\label{orgdfafb09}5-7\% of the population have an AR defect in the
chitotriosidase gene, which leads to false-negative values}\footnotetext[5]{\label{org103049f}GAA measurement in leukocytes is unreliable due to
neutral \(\alpha\)-glucosidase activity in acidic conditions. Acarbose can
be used to inhibit neutral \(\alpha\)-glucosidase activity in leukocytes}\footnotetext[6]{\label{orgb2be7be}Leads to \(\beta\)-galactosidase and neuraminidase deficiency}\footnotetext[7]{\label{org05441a3}Decreased activity of multiple sulfatases}\footnotetext[8]{\label{org58aad6d}ML-II \& III are allelic, extremes in a spectrum of severity}\footnotetext[9]{\label{org545f639}Activity of MPR targeted lysosomal hydrolases is elevated in
