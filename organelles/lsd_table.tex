...
\end{longtable}\footnotetext[1]{\label{orgcd94d17}p-nitrocatecol sulfate is used for \(\alpha\)(MLD) and
\(\beta\)(Maroteaux-Lamy) arylsulfatase assays. \(\beta\) is inactivated with
0.25M sodium pyrophosphate. \(\alpha\) is inactivated with barium}\footnotetext[2]{\label{org93fc47d}Note that 5-7 per cent of the population have a AR defect in the
chitotriosidase gene, which leads to false-negative values}\footnotetext[3]{\label{org46465d4}GAA measurement in leukocytes is unreliable due to
neutral \(\alpha\)-glucosidase that can be active in acidic pH. Acarbose
can be used to inactivate competitor enzymes in leukocytes}\footnotetext[4]{\label{org847de42}Leads to \(\beta\)-galactosidase and neuraminidase deficiency}\footnotetext[5]{\label{orgdca6b7e}Decrease in some lysosomal and non-lysosomal sulphatases}\footnotetext[6]{\label{org18e3c15}In I-cell some lysosomal hydrolase activities are elevated in plasma and
