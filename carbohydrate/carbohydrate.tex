...
\label{sec:org7d3e1f6}
\subsection{Introduction}
\label{sec:org92c42ab}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{glycolysis_ppp/figures/glyc_ppp_rot.png}
\caption{\label{fig:orgd6f6c09}Glycolysis and PPP}
\end{figure}

\subsubsection{Glycolysis}
\label{sec:orgfa09315}
\begin{itemize}
...
\label{sec:org2b13a0f}
\begin{itemize}
\item two phases
\end{itemize}
\begin{enumerate}
\item Oxidative Phase
\label{sec:org0fc2bd4}
\begin{itemize}
\item produces NADPH
...
\label{sec:org5071b05}
\subsubsection{Glycolysis Disorders}
\label{sec:org857451d}
\begin{itemize}
...
\label{sec:orgd7becc4}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{glycolysis_ppp/figures/Slide10.png}
\caption{\label{fig:org71c0c4b}Pentose Phosphate Pathway}
\end{figure}
...
\caption[insulin]{\label{fig:org456015f}Regulation of Insulin Secretion}
\end{figure}
...
\label{sec:org2c64cdf}
\subsubsection{Transient Neonatal HI}
\label{sec:org591e94b}
\begin{itemize}
...
\subsection{Introduction}
\label{sec:org48bc580}
\begin{itemize}
\item glucose is hydrophilic \(\therefore\) cannot easily cross cell membrane
\item transporters exist in almost all cell types (Table \ref{fig:orgf3dcaa5})
...
\caption[glucose transporters]{\label{fig:orgf3dcaa5}Glucose Transporters}
\end{figure}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:org16135c8}GLUTS}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:orgee86e7d}Hepatic Glycogenoses}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org77bdfc2}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:org69dba35}
\subsubsection{Clinical Presentation}
\label{sec:org651e8fc}
\begin{itemize}
...
\label{sec:org7c67508}
\subsubsection{Clinical Presentation}
\label{sec:orgc40965b}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[2]{\label{orgb6a65f8}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:orgeac364d}
\subsubsection{Clinical Presentation}
\label{sec:orgb43275b}
\begin{itemize}
\item muscle fatigue
\item hypertrophic cardiomyopathy
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org88ca692}
\begin{itemize}
...
\label{sec:orgc4b66ab}
\begin{itemize}
\item AKA McArdle Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org881a889}
\begin{itemize}
...
\label{sec:orgba6c818}
\subsubsection{Clinical Presentation}
\label{sec:org72e1c55}
\begin{itemize}
