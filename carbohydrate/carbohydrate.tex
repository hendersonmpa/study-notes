...
\label{sec:org29e60c6}
\subsubsection{Clinical Presentation}
\label{sec:orgacd6ce6}
\begin{itemize}
...
\label{sec:org6d283db}
\subsubsection{Glycolysis Disorders}
\label{sec:org879a976}
\begin{itemize}
...
\label{sec:orgcfc6fe4}
\subsubsection{Transient Neonatal HI}
\label{sec:org60a313e}
\begin{itemize}
...
\label{sec:org80fbaef}
\subsubsection{Clinical Presentation}
\label{sec:org630d092}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb6a6401}
\begin{itemize}
\item see table \ref{tab:org0a44060}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:org0a44060}
...
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org9fccb2d}
\begin{enumerate}
\item Infantile
\label{sec:org8a770c4}
\begin{itemize}
