...
\caption{\label{fig:orgac601af}Major reactions of galactose metabolism}
\end{figure}
...
\label{sec:org7d4f831}
\subsubsection{Clinical Presentation}
\label{sec:org3bd0105}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org9ccfa04}
\begin{itemize}
\item AR GALE
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org6084c2a}
\begin{itemize}
...
\label{sec:org9116bee}
\subsubsection{Clinical Presentation}
\label{sec:org340b280}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org6bd192c}
\begin{itemize}
\item AR GK1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org32d3061}
\begin{itemize}
...
\end{itemize}
\section{Fructose}
\label{sec:orgfe7e53c}
\subsection{Introduction}
\label{sec:org9ed780c}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgcb709e9}
\begin{itemize}
\item AR KHK
\end{itemize}
\subsubsection{Diagnosis and Treatment}
\label{sec:org8cd1421}
\begin{itemize}
...
\label{sec:orgb2e2078}
\subsubsection{Clinical Presentation}
\label{sec:orgfd958e2}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org71facd6}
\begin{itemize}
\item AR ALDOB
\end{itemize}

\subsubsection{Diagnostic Testing}
\label{sec:orgafe99e0}
\begin{itemize}
...
\label{sec:org0886711}
\subsubsection{Clinical Presentation}
\label{sec:org98e4d0e}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org82e7b7c}
\begin{itemize}
\item AR FBP1
\end{itemize}

\subsubsection{Diagnosis}
\label{sec:org54a92b4}
\begin{itemize}
...
\label{sec:org288b645}
\subsection{Introduction}
\label{sec:orgc8f85d0}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{glycolysis_ppp/figures/glyc_ppp_rot.png}
\caption{\label{fig:org4536e08}Glycolysis and PPP}
\end{figure}

\subsubsection{Glycolysis}
\label{sec:org71af755}
\begin{itemize}
...
\label{sec:org024dde9}
\begin{itemize}
\item two phases
\end{itemize}
\begin{enumerate}
\item Oxidative Phase
\label{sec:orgc8153d4}
\begin{itemize}
\item produces NADPH
...
\label{sec:orgfe17c3c}
\subsubsection{Glycolysis Disorders}
\label{sec:org0b62b09}
\begin{itemize}
...
\label{sec:orgb85bb6b}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{glycolysis_ppp/figures/Slide10.png}
\caption{\label{fig:org0a3dfc3}Pentose Phosphate Pathway}
\end{figure}
...
\end{description}
\section{Insulin}
\label{sec:orgea8fbbb}
\subsection{Introduction}
\label{sec:org2f60fa6}
\begin{itemize}
...
\item other mechanisms regulate the release of insulin (Figure \ref{fig:org4643fb6})
\begin{enumerate}
...
\caption[insulin]{\label{fig:org4643fb6}Regulation of Insulin Secretion}
\end{figure}
...
\caption[insulin]{\label{fig:orgc150f59}Regulation of Insulin Secretion}
\end{figure}
...
\label{sec:org164c559}
\subsection{Introduction}
\label{sec:orged10669}
\begin{itemize}
\item glucose is hydrophilic \(\therefore\) cannot easily cross cell membrane
\item transporters exist in almost all cell types (Table \ref{fig:orgc31df49})
...
\caption[glucose transporters]{\label{fig:orgc31df49}Glucose Transporters}
\end{figure}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:org18e8f27}GLUTS}
\centering
\begin{tabular}{lll}
...
\label{sec:org741a82b}
\subsection{Introduction}
\label{sec:org229cce8}
\begin{itemize}
...
\caption{\label{fig:orgb8c7c14}Hepatic Glycogenoses}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orgb57f6a6}Hepatic Glycogenoses}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org1d2c3d7}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:orgde5f816}
\subsubsection{Clinical Presentation}
\label{sec:org4ab9c6b}
\begin{itemize}
...
\label{sec:org2430085}
\subsubsection{Clinical Presentation}
\label{sec:orgf4faad7}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org7048443}
\begin{itemize}
\item AR AGL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgc8ee9eb}
\begin{itemize}
\item \(\downarrow\) glucose
...
\label{sec:org14d109b}
\subsubsection{Clinical Presentation}
\label{sec:org6f1c8e0}
\begin{itemize}
...
\label{sec:org8def2b5}
\subsubsection{Clinical Presentation}
\label{sec:org1f8f74a}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgaa25a6b}
\begin{itemize}
\item AR PGYL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org8244dce}
\begin{itemize}
\item \(\downarrow\) glucose
\item \(\uparrow\) lactate
\item \(\uparrow\) transaminases
...
\label{sec:org502589c}
\subsubsection{Clinical Presentation}
\label{sec:org0ca9af7}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org5e5b0a4}
\begin{itemize}
\item see table \ref{tab:org970fd96}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:org970fd96}GSD Type IX Genetics}
\centering
\begin{tabular}{lllll}
...
\label{sec:orgde78564}
\subsection{Introduction}
\label{sec:orge1d5ed0}
\begin{itemize}
...
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:orge590289}Muscle and Cardiac Glycogenoses}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org3452d0b}Muscle and Cardiac Glycogenoses}
\centering
\begin{tabular}{llll}
Type & Enzyme & Phenotype & Gene\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org3d4843c}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:org7a84814}
\subsubsection{Clinical Presentation}
\label{sec:org5d8f005}
\begin{itemize}
\item muscle fatigue
\item hypertrophic cardiomyopathy
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orge3eec7d}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org324e505}
\begin{itemize}
\item AR GAA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org1c7acec}
\begin{itemize}
...
\label{sec:orgc65b4c6}
\begin{itemize}
\item AKA McArdle Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org444e5c8}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org80d6712}
\begin{itemize}
\item AR PYGM
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org8379fad}
\begin{itemize}
...
\label{sec:orgad097e6}
\subsubsection{Clinical Presentation}
\label{sec:org6d9f3bf}
\begin{itemize}
