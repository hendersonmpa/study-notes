...
\begin{table}[htbp]
\caption[GLUTS]{\label{tab:orgb400b6c}
GLUTS}
\centering
\begin{tabular}{lll}
...
\caption{\label{fig:org19e3405}
Regulation of Glycogen Synthesis and Degradation}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org8f013fa}
...
\label{sec:org756a93e}
\begin{enumerate}
\item Oxidative Phase
\label{sec:org97e091e}
\begin{itemize}
...
\label{sec:orgfe16a25}
\subsubsection{Metabolic Derangement}
\label{sec:org138795d}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orge80f0dc}
\begin{enumerate}
\item Ia and Ib
\label{sec:orgb1610c9}
\begin{itemize}
...
\subsubsection{Diagnostic Tests}
\label{sec:orge54a75f}
\begin{itemize}
\item mutation analysis
\end{itemize}

\subsubsection{Treatment}
\label{sec:org50e148a}
\begin{itemize}
...
\label{sec:orgb555bb8}
\subsubsection{Metabolic Derangement}
\label{sec:orgedea1bb}
\begin{itemize}
...
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:org6d49614}
Muscle and Cardiac Glycogenoses}
\end{figure}

\subsection{GSD Type 0}
\label{sec:orgd8ed5ae}
\subsubsection{Metabolic Derangement}
\label{sec:org54e163f}
\begin{itemize}
...
\subsubsection{Diagnostic Tests}
\label{sec:org75f2dc3}
\begin{itemize}
\item mutation analysis
\end{itemize}
\subsubsection{Treatment}
\label{sec:org8ad55e9}
\begin{itemize}
...
\subsubsection{Pentose Phosphate Pathway}
\label{sec:orga72a464}
\begin{enumerate}
\item Oxidative Phase
\label{sec:org33e656b}
\begin{itemize}
\item glucose 6-P \(\to\) NADPH + ribose 5-P
\item Glucose 6-P dehydrogenase catalyses first step
\item NADPH is for reducing reactions
...
\label{sec:org3924bb1}
\subsubsection{Clinical Presentation}
\label{sec:org3f063ba}
\begin{itemize}
