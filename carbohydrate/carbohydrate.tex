...
\caption{\label{fig:orgb017762}Major reactions of galactose metabolism}
\end{figure}
...
\label{sec:org2771809}
\subsubsection{Clinical Presentation}
\label{sec:org1234a5b}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga0b2ea7}
\begin{itemize}
\item AR GALE
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org733e1ff}
\begin{itemize}
...
\label{sec:orgbb5c871}
\subsubsection{Clinical Presentation}
\label{sec:org7cf7399}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org611f9bc}
\begin{itemize}
\item AR GK1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org7fd6086}
\begin{itemize}
...
\end{itemize}
\section{Fructose}
\label{sec:orgb5a8da6}
\subsection{Introduction}
\label{sec:org17c05a9}
\begin{itemize}
\item fructose is mainly metabolised in the liver, renal cortex and small
intestinal mucosa (Figure \ref{fig:orgd8e6539})
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org526908a}
\begin{itemize}
\item AR KHK
\end{itemize}
\subsubsection{Diagnosis and Treatment}
\label{sec:org12ea768}
\begin{itemize}
...
\label{sec:orgf701d54}
\subsubsection{Clinical Presentation}
\label{sec:orgb7ed227}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org040aa5a}
\begin{itemize}
\item AR ALDOB
\end{itemize}

\subsubsection{Diagnostic Testing}
\label{sec:orgfc71557}
\begin{itemize}
...
\label{sec:org5b8d499}
\subsubsection{Clinical Presentation}
\label{sec:org4c91362}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org8d49514}
\begin{itemize}
\item AR FBP1
\end{itemize}

\subsubsection{Diagnosis}
\label{sec:org48f002b}
\begin{itemize}
...
\label{sec:org8a63a3e}
\subsection{Introduction}
\label{sec:orgbdecb0b}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{glycolysis_ppp/figures/glyc_ppp_rot.png}
\caption{\label{fig:org1fd3309}Glycolysis and PPP}
\end{figure}

\subsubsection{Glycolysis}
\label{sec:orgc15a687}
\begin{itemize}
...
\label{sec:org63a2bcb}
\begin{itemize}
\item two phases
\end{itemize}
\begin{enumerate}
\item Oxidative Phase
\label{sec:org081514f}
\begin{itemize}
\item produces NADPH
...
\label{sec:orgd5588e0}
\subsubsection{Glycolysis Disorders}
\label{sec:orgb90de77}
\begin{itemize}
...
\label{sec:org21fa03a}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{glycolysis_ppp/figures/Slide10.png}
\caption{\label{fig:org940f376}Pentose Phosphate Pathway}
\end{figure}
...
\end{description}
\section{Insulin}
\label{sec:org75a397c}
\subsection{Introduction}
\label{sec:org545f5a6}
\begin{itemize}
...
\item other mechanisms regulate the release of insulin (Figure \ref{fig:org5a8c5d8})
\begin{enumerate}
...
\caption[insulin]{\label{fig:org5a8c5d8}Regulation of Insulin Secretion}
\end{figure}
...
\caption[insulin]{\label{fig:org8d6818c}Regulation of Insulin Secretion}
\end{figure}
...
\label{sec:org4b5ccfb}
\subsubsection{Transient Neonatal HI}
\label{sec:org5e0d1b6}
\begin{itemize}
...
\label{sec:org9a0a96e}
\subsection{Introduction}
\label{sec:org771be9b}
\begin{itemize}
\item glucose is hydrophilic \(\therefore\) cannot easily cross cell membrane
\item transporters exist in almost all cell types (Table \ref{fig:orgbc48110})
...
\caption[glucose transporters]{\label{fig:orgbc48110}Glucose Transporters}
\end{figure}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:org8943fee}GLUTS}
\centering
\begin{tabular}{lll}
...
\label{sec:orgd2f9b5e}
\subsection{Introduction}
\label{sec:orgf6efd53}
\begin{itemize}
...
\caption{\label{fig:org9275e28}Hepatic Glycogenoses}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org66a1a60}Hepatic Glycogenoses}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org5972e90}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:org673dc0b}
\subsubsection{Clinical Presentation}
\label{sec:org0b67ba2}
\begin{itemize}
...
\label{sec:org7f35d3b}
\subsubsection{Clinical Presentation}
\label{sec:org9ced3ca}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org24ad648}
\begin{itemize}
\item AR AGL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org6656449}
\begin{itemize}
\item \(\downarrow\) glucose
...
\label{sec:orgd3f6f34}
\subsubsection{Clinical Presentation}
\label{sec:org700d409}
\begin{itemize}
...
\label{sec:org388e6b9}
\subsubsection{Clinical Presentation}
\label{sec:org93c76ad}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org0fd8e06}
\begin{itemize}
\item AR PGYL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org8691dc9}
\begin{itemize}
\item \(\downarrow\) glucose
\item \(\uparrow\) lactate
\item \(\uparrow\) transaminases
...
\label{sec:orgfc11a08}
\subsubsection{Clinical Presentation}
\label{sec:org2567355}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org81a2d52}
\begin{itemize}
\item see table \ref{tab:org443c1f9}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:org443c1f9}GSD Type IX Genetics}
\centering
\begin{tabular}{lllll}
...
\end{itemize}
\section{Muscle GSDs}
\label{sec:orgeda920b}
\subsection{Introduction}
\label{sec:org7bb456b}
\begin{itemize}
...
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:org67a7a6d}Muscle and Cardiac Glycogenoses}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orgf617b8c}Muscle and Cardiac Glycogenoses}
\centering
\begin{tabular}{llll}
Type & Enzyme & Phenotype & Gene\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org9474aac}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:org45ffdd4}
\subsubsection{Clinical Presentation}
\label{sec:org43c80ed}
\begin{itemize}
\item muscle fatigue
\item hypertrophic cardiomyopathy
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org9de2862}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org42f6a95}
\begin{itemize}
\item AR GAA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org0b3de33}
\begin{itemize}
...
\label{sec:org40686b2}
\begin{itemize}
\item AKA McArdle Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org0f673af}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org76cd497}
\begin{itemize}
\item AR PYGM
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org0fe2188}
\begin{itemize}
...
\label{sec:org86033bf}
\subsubsection{Clinical Presentation}
\label{sec:orgc44fbf5}
\begin{itemize}
