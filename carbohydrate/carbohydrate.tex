...
\label{sec:org6bf0a8a}
\subsection{Introduction}
\label{sec:orgeede5e0}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{glycolysis_ppp/figures/glyc_ppp_rot.png}
\caption{\label{fig:org7e9928e}Glycolysis and PPP}
\end{figure}

\subsubsection{Glycolysis}
\label{sec:org812db7d}
\begin{itemize}
...
\label{sec:org045d911}
\begin{itemize}
\item two phases
\end{itemize}
\begin{enumerate}
\item Oxidative Phase
\label{sec:org4b2ccb4}
\begin{itemize}
\item produces NADPH
...
\label{sec:orgf39ae47}
\subsubsection{Glycolysis Disorders}
\label{sec:org2a9e020}
\begin{itemize}
...
\caption[insulin]{\label{fig:org8bf6af7}Regulation of Insulin Secretion}
\end{figure}
...
\label{sec:orgf8e373d}
\subsubsection{Transient Neonatal HI}
\label{sec:org8d7db41}
\begin{itemize}
...
\subsection{Introduction}
\label{sec:org949ffbd}
\begin{itemize}
\item glucose is hydrophilic \(\therefore\) cannot easily cross cell membrane
\item transporters exist in almost all cell types (Table \ref{fig:org0bfd21e})
...
\caption[glucose transporters]{\label{fig:org0bfd21e}Glucose Transporters}
\end{figure}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:org32a8061}GLUTS}
\centering
\begin{tabular}{lll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org14dba09}hepatic and myopathic

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{hepatic_glycogenoses/figures/gggmetab_hepatic.png}
\caption{\label{fig:orgae6d798}Hepatic Glycogenoses}
\end{figure}}
...
\label{sec:org703c2e4}
\subsubsection{Clinical Presentation}
\label{sec:org3d8b9a5}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgbd61f78}
\begin{itemize}
\item see table \ref{tab:org44f06a3}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:org44f06a3}GSD Type IX Genetics}
\centering
\begin{tabular}{lllll}
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org517d200}hepatic and myopathic

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{muscle_cardiac_glycogenoses/figures/gggmetab_muscle_cardiac.png}
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:org2de683b}Muscle and Cardiac Glycogenoses}
\end{figure}}

\subsection{GSD Type 0}
\label{sec:orgf9fa200}
\subsubsection{Clinical Presentation}
\label{sec:orge2cbeea}
\begin{itemize}
\item muscle fatigue
\item hypertrophic cardiomyopathy
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org2f93e84}
\begin{itemize}
...
\label{sec:orgaa8abab}
\begin{itemize}
\item AKA McArdle Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orga003623}
\begin{itemize}
...
\label{sec:org9cc2d86}
\subsubsection{Clinical Presentation}
\label{sec:org7d70d11}
\begin{itemize}
