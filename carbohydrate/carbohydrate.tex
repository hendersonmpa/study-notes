...
\label{sec:orgc6c7879}
\subsubsection{Clinical Presentation}
\label{sec:orgdb326ec}
\begin{itemize}
...
\label{sec:orgf007a9b}
\subsubsection{Glycolysis Disorders}
\label{sec:orgafb6c37}
\begin{itemize}
...
\label{sec:org1fc6c9e}
\subsubsection{Clinical Presentation}
\label{sec:org783e5e7}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgc37f042}
\begin{itemize}
\item see table \ref{tab:orgdcdb000}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orgdcdb000}
...
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgb89360f}
\begin{enumerate}
\item Infantile
\label{sec:org0c48287}
\begin{itemize}
