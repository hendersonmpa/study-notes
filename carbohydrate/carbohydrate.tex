...
\caption{\label{fig:org5e3d912}
Conversion of Glucose}
\end{figure}

\subsection{Regulation}
\label{sec:org44eca43}
\subsubsection{Major Hormones of Metabolic Homeostasis}
\label{sec:org942a642}
\begin{itemize}
...
\caption{\label{fig:org0aa03db}
Glucose Homeostasis}
\end{figure}

\subsubsection{Insulin and Counterregulatory Hormones}
\label{sec:orgd6a26fb}

\begin{table}[htbp]
\caption[Insuline and Counterregulatory]{\label{tab:orgd42b60c}
...
\caption{\label{fig:org572b77a}
Absorption from the intestine}
\end{figure}

\subsubsection{GLUTs}
\label{sec:org807aa2d}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:org9be63b2}
GLUTS}
\centering
\begin{tabular}{lll}
...
\caption{\label{fig:org42efe28}
Regulation of Glycogen Synthesis and Degradation}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orgcf95105}
...
\caption{\label{fig:orgdcf9100}
Galactose Metabolism}
\end{figure}

\subsubsection{Pentose Phosphate Pathway}
\label{sec:org3bc923e}
\begin{enumerate}
\item Oxidative Phase
\label{sec:orged842fe}
\begin{itemize}
...
\label{sec:org11e2929}
\subsubsection{Interconversion}
\label{sec:org864347e}
\begin{itemize}
...
\caption[lactose]{\label{fig:orgbebab9d}
...
\label{sec:org1e421fc}

\begin{enumerate}
\item Therapy
\label{sec:orgde3c6da}
\begin{itemize}
\item life long dietary restriction of galactose.
\end{itemize}

\item Outcome
\label{sec:org85a401d}
\begin{itemize}
...
\label{sec:org6aad44d}
\subsubsection{Clinical Presentation}
\label{sec:org0fdf111}
\begin{itemize}
...
\label{sec:org3346b85}
\begin{itemize}
\item AR, GALE
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org4c77695}
\begin{itemize}
...
\label{sec:org81c58b9}
\subsubsection{Clinical Presentation}
\label{sec:org40132c1}
\begin{itemize}
...
\label{sec:org5e3c80a}
\subsection{Introduction}
\label{sec:org70f1c2d}
\begin{table}[htbp]
\caption{\label{tab:org1d1be14}
...
\caption[Hepatic Glycogenoses]{\label{fig:orgb793c45}
Hepatic Glycogenoses}
\end{figure}

\subsection{GSD Type 0}
\label{sec:orgd530707}
\subsubsection{Metabolic Derangement}
\label{sec:orgb3c76bb}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org1a1f55e}
\begin{enumerate}
\item Ia and Ib
\label{sec:orgbdeb831}
\begin{itemize}
...
\subsubsection{Diagnostic Tests}
\label{sec:orgd34e819}
\begin{itemize}
\item mutation analysis
\end{itemize}

\subsubsection{Treatment}
\label{sec:org31ac58f}
\begin{itemize}
...
\label{sec:org1d1607f}
\subsubsection{Metabolic Derangement}
\label{sec:org4a9fc94}
\begin{itemize}
...
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgb565143}
\begin{itemize}
\item DBE activity in leucocytes
\item mutation analysis
\end{itemize}
\subsubsection{Treatment}
\label{sec:org54ce663}
\begin{itemize}
...
\label{sec:org6d17c4d}
\subsubsection{Metabolic Derangement}
\label{sec:orgf582f16}
\begin{itemize}
...
\label{sec:orgdce3ee0}
\subsubsection{Metabolic Derangement}
\label{sec:org4ee430e}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgc587325}
\begin{itemize}
\item AR, PGYL gene
\end{itemize}

\subsubsection{Clinical Presentation}
\label{sec:orge08b61d}
\begin{itemize}
...
\label{sec:orgd6b6d12}
\subsubsection{Metabolic Derangement}
\label{sec:org90362f7}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org314a887}
\begin{table}[htbp]
\caption{\label{tab:orgf2d095e}
...
\label{sec:org8678bf2}
\subsection{Introduction}
\label{sec:org1481c9b}
\subsubsection{Muscle and Cardiac Glycogenoses}
\label{sec:orgbfc32dc}
...
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:org84a417c}
Muscle and Cardiac Glycogenoses}
\end{figure}

\subsection{GSD Type 0}
\label{sec:orgd6de1ae}
\subsubsection{Metabolic Derangement}
\label{sec:org459c6a3}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orgc94f3d9}
\begin{enumerate}
\item Infantile
\label{sec:org87e11e5}
\begin{itemize}
...
\label{sec:org7407396}
\subsubsection{Metabolic Derangement}
\label{sec:org91d613f}
\begin{itemize}
...
\label{sec:org245bd9d}
\subsubsection{AMPK Deficiency}
\label{sec:org1e13587}
\begin{itemize}
...
\subsubsection{Pentose Phosphate Pathway}
\label{sec:orgda81a20}
\begin{enumerate}
\item Oxidative Phase
\label{sec:orga8a8c27}
\begin{itemize}
\item glucose 6-P \(\to\) NADPH + ribose 5-P
\item Glucose 6-P dehydrogenase catalyses first step
\item NADPH is for reducing reactions
...
\label{sec:orga293b5d}
\subsubsection{Glycolysis Disorders}
\label{sec:orgc1250bd}
\begin{itemize}
...
\label{sec:orgd7dda6f}

\begin{table}[htbp]
\caption{\label{tab:org84f666b}
NIET in Myopathy}
\centering
\begin{tabular}{lll}
 & Lactate & Ammonia\\
...
\caption{\label{fig:org97e58cc}
NIET Method}
\end{figure}

\subsubsection{Exercising Muscle}
\label{sec:org3a2c8e1}
\begin{enumerate}
\item Lactate
\label{sec:orga37289e}
\begin{itemize}
...
\caption{\label{fig:org8479b70}
LDH}
\end{figure}

\item ATP
\label{sec:org22a163c}
...
\caption[gln]{\label{fig:org7140061}
...
\caption[interp]{\label{fig:org319c020}
NIET Results}
\end{figure}
\end{enumerate}
\section{Fructose}
\label{sec:org679402a}
\subsection{Introduction}
\label{sec:orgad996be}
\subsubsection{Fructose Metabolism}
\label{sec:orgaf2c398}
\begin{itemize}
...
\subsubsection{Fructose Metabolism}
\label{sec:org0c093fd}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./fructose/figures/fructose.png}
\caption[Fructose]{\label{fig:org49bde40}
Fructose Metabolism}
\end{figure}
\subsection{Essential Fructosuria}
\label{sec:org5f7ab6b}
\subsubsection{Clinical Presentation}
\label{sec:org782d6e1}
\begin{itemize}
...
\label{sec:orgf3d727e}
\subsubsection{Clinical Presentation}
\label{sec:org20a1f28}
\begin{itemize}
...
\label{sec:orgd58e16e}
\subsubsection{Clinical Presentation}
\label{sec:org0eb2302}
\begin{itemize}
...
\section{Insulin}
\label{sec:org056b2a3}
\subsection{Introduction}
\label{sec:org3669aaf}
\subsubsection{Insulin Secretion}
\label{sec:org91177dc}
\begin{itemize}
...
\caption[insulin]{\label{fig:org4c874a8}
Insulin Secretion}
\end{figure}

\subsubsection{Insulin Effects}
\label{sec:org3913550}
\begin{itemize}
...
\label{sec:org94309ff}
\subsection{Introduction}
\label{sec:org40db66e}
\subsubsection{Glucose Transporters}
\label{sec:orgd030e9d}
\begin{itemize}
...
\caption[glucose transporters]{\label{fig:org9325c5c}
Glucose Transporters}
\end{figure}

\subsubsection{Congenital Defects of Glucose Transporters}
\label{sec:org29d28d2}
\begin{itemize}
