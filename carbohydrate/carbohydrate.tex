...
\caption{\label{fig:org800e4d9}Major reactions of galactose metabolism}
\end{figure}
...
\label{sec:org5e77336}
\subsubsection{Clinical Presentation}
\label{sec:org2929e68}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga5ddf9b}
\begin{itemize}
\item AR GALE
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org5889cfc}
\begin{itemize}
...
\label{sec:org241f628}
\subsubsection{Clinical Presentation}
\label{sec:org7878c61}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org3ea9682}
\begin{itemize}
\item AR GK1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org22a11a9}
\begin{itemize}
...
\end{itemize}
\section{Fructose}
\label{sec:org04e01ad}
\subsection{Introduction}
\label{sec:org54c3944}
\begin{itemize}
\item fructose is mainly metabolised in the liver, renal cortex and small
intestinal mucosa (Figure \ref{fig:org71bf38b})
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org6401e11}
\begin{itemize}
\item AR KHK
\end{itemize}
\subsubsection{Diagnosis and Treatment}
\label{sec:orged16732}
\begin{itemize}
...
\label{sec:orge199f87}
\subsubsection{Clinical Presentation}
\label{sec:org06b1a8e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org3bad876}
\begin{itemize}
\item AR ALDOB
\end{itemize}

\subsubsection{Diagnostic Testing}
\label{sec:org692e188}
\begin{itemize}
...
\label{sec:org2bf8886}
\subsubsection{Clinical Presentation}
\label{sec:org9c1caf6}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org4867969}
\begin{itemize}
\item AR FBP1
\end{itemize}

\subsubsection{Diagnosis}
\label{sec:org689b1aa}
\begin{itemize}
...
\label{sec:orgd9803d1}
\subsection{Introduction}
\label{sec:org435249d}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{glycolysis_ppp/figures/glyc_ppp_rot.png}
\caption{\label{fig:orgceb5bdb}Glycolysis and PPP}
\end{figure}

\subsubsection{Glycolysis}
\label{sec:orgf54438a}
\begin{itemize}
...
\label{sec:org60cd25f}
\begin{itemize}
\item two phases
\end{itemize}
\begin{enumerate}
\item Oxidative Phase
\label{sec:org0f046db}
\begin{itemize}
\item produces NADPH
...
\label{sec:org17084f4}
\subsubsection{Glycolysis Disorders}
\label{sec:org1552221}
\begin{itemize}
...
\label{sec:orgdfab07d}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{glycolysis_ppp/figures/Slide10.png}
\caption{\label{fig:org61d2902}Pentose Phosphate Pathway}
\end{figure}
...
\end{description}
\section{Insulin}
\label{sec:orga7428a5}
\subsection{Introduction}
\label{sec:orgffe6364}
\begin{itemize}
...
\item other mechanisms regulate the release of insulin (Figure \ref{fig:org0d76e1e})
\begin{enumerate}
...
\caption[insulin]{\label{fig:org0d76e1e}Regulation of Insulin Secretion}
\end{figure}
...
\caption[insulin]{\label{fig:orgdadd377}Regulation of Insulin Secretion}
\end{figure}
...
\label{sec:org86a5452}
\subsubsection{Transient Neonatal HI}
\label{sec:org858e54a}
\begin{itemize}
...
\label{sec:orge5dbb64}
\subsection{Introduction}
\label{sec:org1072032}
\begin{itemize}
\item glucose is hydrophilic \(\therefore\) cannot easily cross cell membrane
\item transporters exist in almost all cell types (Table \ref{fig:org8d01c73})
...
\caption[glucose transporters]{\label{fig:org8d01c73}Glucose Transporters}
\end{figure}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:org7025fc3}GLUTS}
\centering
\begin{tabular}{lll}
...
\label{sec:orge41b26d}
\subsection{Introduction}
\label{sec:org0af95c1}
\begin{itemize}
...
\caption{\label{fig:org956067c}Hepatic Glycogenoses}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orgad1eef2}Hepatic Glycogenoses}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org5230875}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:org9a3c1a1}
\subsubsection{Clinical Presentation}
\label{sec:org7d59567}
\begin{itemize}
...
\label{sec:orgb327225}
\subsubsection{Clinical Presentation}
\label{sec:orgcec961b}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org0803f0c}
\begin{itemize}
\item AR AGL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgb456872}
\begin{itemize}
\item \(\downarrow\) glucose
...
\label{sec:org0f94f19}
\subsubsection{Clinical Presentation}
\label{sec:orgf8630ab}
\begin{itemize}
...
\label{sec:orgacd88a9}
\subsubsection{Clinical Presentation}
\label{sec:orgd8ffda4}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org28cc6a7}
\begin{itemize}
\item AR PGYL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org7bfb375}
\begin{itemize}
\item \(\downarrow\) glucose
\item \(\uparrow\) lactate
\item \(\uparrow\) transaminases
...
\label{sec:org5262b6f}
\subsubsection{Clinical Presentation}
\label{sec:org68bcd47}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb370e06}
\begin{itemize}
\item see table \ref{tab:orgd096756}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orgd096756}GSD Type IX Genetics}
\centering
\begin{tabular}{lllll}
...
\end{itemize}
\section{Muscle GSDs}
\label{sec:org0f36ed4}
\subsection{Introduction}
\label{sec:orge5fd761}
\begin{itemize}
...
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:orgce2f4c5}Muscle and Cardiac Glycogenoses}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org74537be}Muscle and Cardiac Glycogenoses}
\centering
\begin{tabular}{llll}
Type & Enzyme & Phenotype & Gene\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{orge1e9c4e}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:org04dc8ac}
\subsubsection{Clinical Presentation}
\label{sec:org54a6338}
\begin{itemize}
\item muscle fatigue
\item hypertrophic cardiomyopathy
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org18c7470}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org31ff023}
\begin{itemize}
\item AR GAA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgc05c818}
\begin{itemize}
...
\label{sec:org1254265}
\begin{itemize}
\item AKA McArdle Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgae4975e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4305547}
\begin{itemize}
\item AR PYGM
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3637693}
\begin{itemize}
...
\label{sec:org77c1d46}
\subsubsection{Clinical Presentation}
\label{sec:orge0d95cd}
\begin{itemize}
