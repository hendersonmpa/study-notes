...
\item in the first step of the Leloir pathway, \(\beta\)-d-galactose is epimerized to \(\alpha\)-d-galactose by galactose mutarotase.
\begin{itemize}
\item deficiency of galactose mutarotase is very rare.
\end{itemize}
...
\caption{\label{fig:org438d92a}Major reactions of galactose metabolism}
\end{figure}
...
\label{sec:org2e181f8}
\subsubsection{Clinical Presentation}
\label{sec:orga0881e8}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org536bcda}
\begin{itemize}
\item AR GALE
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org4ed3c48}
\begin{itemize}
...
\label{sec:org6f1339a}
\subsubsection{Clinical Presentation}
\label{sec:org497109b}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgf7c944d}
\begin{itemize}
\item AR GK1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org2082fd3}
\begin{itemize}
...
\end{itemize}
\section{Fructose}
\label{sec:org5eec06b}
\subsection{Introduction}
\label{sec:orge96dce2}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org37bbfb8}
\begin{itemize}
\item AR KHK
\end{itemize}
\subsubsection{Diagnosis and Treatment}
\label{sec:org4ba48ff}
\begin{itemize}
...
\label{sec:org77512a6}
\subsubsection{Clinical Presentation}
\label{sec:orgfd58096}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org87881d6}
\begin{itemize}
\item AR ALDOB
\end{itemize}

\subsubsection{Diagnostic Testing}
\label{sec:org2985c36}
\begin{itemize}
...
\label{sec:org2aa1bc6}
\subsubsection{Clinical Presentation}
\label{sec:org470d19b}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orga71ef75}
\begin{itemize}
\item AR FBP1
\end{itemize}

\subsubsection{Diagnosis}
\label{sec:org22ab21c}
\begin{itemize}
...
\label{sec:orgbed837d}
\subsection{Introduction}
\label{sec:orgdb2f8f4}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{glycolysis_ppp/figures/glyc_ppp_rot.png}
\caption{\label{fig:org11c443c}Glycolysis and PPP}
\end{figure}

\subsubsection{Glycolysis}
\label{sec:org620c5a2}
\begin{itemize}
...
\label{sec:orgd45d44c}
\begin{itemize}
\item two phases
\end{itemize}
\begin{enumerate}
\item Oxidative Phase
\label{sec:orgf1cfdfa}
\begin{itemize}
\item produces NADPH
...
\label{sec:orgf454beb}
\subsubsection{Glycolysis Disorders}
\label{sec:orgc74bbee}
\begin{itemize}
...
\label{sec:org937a589}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{glycolysis_ppp/figures/Slide10.png}
\caption{\label{fig:org1000ef8}Pentose Phosphate Pathway}
\end{figure}
...
\end{description}
\section{Insulin}
\label{sec:org4e1ea90}
\subsection{Introduction}
\label{sec:org88e0035}
\begin{itemize}
...
\item other mechanisms regulate the release of insulin (Figure \ref{fig:org028a771})
\begin{enumerate}
...
\caption[insulin]{\label{fig:org028a771}Regulation of Insulin Secretion}
\end{figure}
...
\caption[insulin]{\label{fig:org7e5148d}Regulation of Insulin Secretion}
\end{figure}
...
\label{sec:org8b0f173}
\subsubsection{Transient Neonatal HI}
\label{sec:orgd89fffc}
\begin{itemize}
...
\label{sec:org2832d5e}
\subsection{Introduction}
\label{sec:orgc27497d}
\begin{itemize}
\item glucose is hydrophilic \(\therefore\) cannot easily cross cell membrane
\item transporters exist in almost all cell types (Table \ref{fig:org2d38cd9})
...
\caption[glucose transporters]{\label{fig:org2d38cd9}Glucose Transporters}
\end{figure}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:org9a69089}GLUTS}
\centering
\begin{tabular}{lll}
...
\label{sec:org53d9276}
\subsection{Introduction}
\label{sec:org2930acf}
\begin{itemize}
...
\caption{\label{fig:orgd178697}Hepatic Glycogenoses}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org8a47e45}Hepatic Glycogenoses}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgdef8766}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:orgb738f3d}
\subsubsection{Clinical Presentation}
\label{sec:org4e4c3e8}
\begin{itemize}
...
\label{sec:orgf8534ec}
\subsubsection{Clinical Presentation}
\label{sec:orga234302}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org331e2d7}
\begin{itemize}
\item AR AGL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orge98a825}
\begin{itemize}
\item \(\downarrow\) glucose
...
\label{sec:org5c03ee6}
\subsubsection{Clinical Presentation}
\label{sec:orga9a0b1f}
\begin{itemize}
...
\label{sec:orga2ee678}
\subsubsection{Clinical Presentation}
\label{sec:orgaf31996}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org0a35fd3}
\begin{itemize}
\item AR PGYL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org650c3f9}
\begin{itemize}
\item \(\downarrow\) glucose
\item \(\uparrow\) lactate
\item \(\uparrow\) transaminases
...
\label{sec:orgfc16721}
\subsubsection{Clinical Presentation}
\label{sec:org4854ce3}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4385e3e}
\begin{itemize}
\item see table \ref{tab:orga375a9d}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orga375a9d}GSD Type IX Genetics}
\centering
\begin{tabular}{lllll}
...
\label{sec:orgb36f26b}
\subsection{Introduction}
\label{sec:org2612d81}
\begin{itemize}
...
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:orgc3c50fb}Muscle and Cardiac Glycogenoses}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orga76de0d}Muscle and Cardiac Glycogenoses}
\centering
\begin{tabular}{llll}
Type & Enzyme & Phenotype & Gene\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org0014679}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:orgb6e520c}
\subsubsection{Clinical Presentation}
\label{sec:orgc05c3df}
\begin{itemize}
\item muscle fatigue
\item hypertrophic cardiomyopathy
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org215eb56}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgba55d9c}
\begin{itemize}
\item AR GAA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org0f908ac}
\begin{itemize}
...
\label{sec:org705b802}
\begin{itemize}
\item AKA McArdle Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org3a85573}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org5352b8c}
\begin{itemize}
\item AR PYGM
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgee560a5}
\begin{itemize}
...
\label{sec:org88f72a7}
\subsubsection{Clinical Presentation}
\label{sec:org4b22b28}
\begin{itemize}
