...
\caption{\label{fig:org400b72a}Major reactions of galactose metabolism}
\end{figure}
...
\label{sec:orgad37ca5}
\subsubsection{Clinical Presentation}
\label{sec:org136b4a6}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org68616bc}
\begin{itemize}
\item AR GALE
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7b76232}
\begin{itemize}
...
\label{sec:orgdafc4e6}
\subsubsection{Clinical Presentation}
\label{sec:org18f4c4b}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org62be711}
\begin{itemize}
\item AR GK1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org3a11413}
\begin{itemize}
...
\end{itemize}
\section{Fructose}
\label{sec:org9f2fbc2}
\subsection{Introduction}
\label{sec:org287962f}
\begin{itemize}
\item fructose is mainly metabolised in the liver, renal cortex and small
intestinal mucosa (Figure \ref{fig:org5f6ace0})
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org3ca1f38}
\begin{itemize}
\item AR KHK
\end{itemize}
\subsubsection{Diagnosis and Treatment}
\label{sec:org9c08196}
\begin{itemize}
...
\label{sec:orgb7a5965}
\subsubsection{Clinical Presentation}
\label{sec:org69138d1}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgf0bcf9e}
\begin{itemize}
\item AR ALDOB
\end{itemize}

\subsubsection{Diagnostic Testing}
\label{sec:orgf1ee00b}
\begin{itemize}
...
\label{sec:orga258d4a}
\subsubsection{Clinical Presentation}
\label{sec:org594f083}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org5fd537a}
\begin{itemize}
\item AR FBP1
\end{itemize}

\subsubsection{Diagnosis}
\label{sec:org842edce}
\begin{itemize}
...
\label{sec:org9fadf72}
\subsection{Introduction}
\label{sec:orgc9f4ac3}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{glycolysis_ppp/figures/glyc_ppp_rot.png}
\caption{\label{fig:orgad3ffde}Glycolysis and PPP}
\end{figure}

\subsubsection{Glycolysis}
\label{sec:org9553433}
\begin{itemize}
...
\label{sec:orgc3c5b2c}
\subsubsection{Glycolysis Disorders}
\label{sec:orgc47d5db}
\begin{itemize}
...
\label{sec:orgba9f452}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{glycolysis_ppp/figures/Slide10.png}
\caption{\label{fig:org20ccaea}Pentose Phosphate Pathway}
\end{figure}
...
\end{description}
\section{Insulin}
\label{sec:orge7b3ed4}
\subsection{Introduction}
\label{sec:org63d83c7}
\begin{itemize}
...
\item other mechanisms regulate the release of insulin (Figure \ref{fig:org07c6884})
\begin{enumerate}
...
\caption[insulin]{\label{fig:org07c6884}Regulation of Insulin Secretion}
\end{figure}
...
\caption[insulin]{\label{fig:orgdba9584}Regulation of Insulin Secretion}
\end{figure}
...
\label{sec:org076a474}
\subsubsection{Transient Neonatal HI}
\label{sec:org0323dae}
\begin{itemize}
...
\label{sec:org8f3d8aa}
\subsection{Introduction}
\label{sec:orgcb2f9c9}
\begin{itemize}
\item glucose is hydrophilic \(\therefore\) cannot easily cross cell membrane
\item transporters exist in almost all cell types (Table \ref{fig:org5af03c5})
...
\caption[glucose transporters]{\label{fig:org5af03c5}Glucose Transporters}
\end{figure}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:orga273a98}GLUTS}
\centering
\begin{tabular}{lll}
...
\label{sec:org4feb131}
\subsection{Introduction}
\label{sec:org6202f9e}
\begin{itemize}
...
\caption{\label{fig:orgef295a3}Hepatic Glycogenoses}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org4d4e6a2}Hepatic Glycogenoses}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org14b680b}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:orga67ff5e}
\subsubsection{Clinical Presentation}
\label{sec:orgee2c68a}
\begin{itemize}
...
\label{sec:org143c252}
\subsubsection{Clinical Presentation}
\label{sec:org5f9e3ce}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org40059f1}
\begin{itemize}
\item AR AGL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org3442506}
\begin{itemize}
\item \(\downarrow\) glucose
...
\label{sec:org5e151f9}
\subsubsection{Clinical Presentation}
\label{sec:orgfa9f6de}
\begin{itemize}
...
\label{sec:org619a506}
\subsubsection{Clinical Presentation}
\label{sec:org067b7a5}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgdab6bdf}
\begin{itemize}
\item AR PGYL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orga7f95ae}
\begin{itemize}
\item \(\downarrow\) glucose
\item \(\uparrow\) lactate
\item \(\uparrow\) transaminases
...
\label{sec:org2bcb173}
\subsubsection{Clinical Presentation}
\label{sec:org31b37b4}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgac2b7a6}
\begin{itemize}
\item see table \ref{tab:orge45144c}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orge45144c}GSD Type IX Genetics}
\centering
\begin{tabular}{lllll}
...
\end{itemize}
\section{Muscle GSDs}
\label{sec:org7295649}
\subsection{Introduction}
\label{sec:org3821468}
\begin{itemize}
...
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:org46ec9a3}Muscle and Cardiac Glycogenoses}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org2f353d1}Muscle and Cardiac Glycogenoses}
\centering
\begin{tabular}{llll}
Type & Enzyme & Phenotype & Gene\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org152c67c}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:org6e4d1fd}
\subsubsection{Clinical Presentation}
\label{sec:org24e2e95}
\begin{itemize}
\item muscle fatigue
\item hypertrophic cardiomyopathy
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org8ab5c47}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgac9e79f}
\begin{itemize}
\item AR GAA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org17a20c0}
\begin{itemize}
...
\label{sec:orge46bb51}
\begin{itemize}
\item AKA McArdle Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org82c4fc3}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org2c40deb}
\begin{itemize}
\item AR PYGM
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org1fd78cc}
\begin{itemize}
...
\label{sec:orgc1a9c74}
\subsubsection{Clinical Presentation}
\label{sec:orgcaac5d8}
\begin{itemize}
