...
\caption{\label{fig:org9b1f1b4}
Conversion of Glucose}
\end{figure}

\subsection{Regulation}
\label{sec:org1f3bf2c}
\subsubsection{Major Hormones of Metabolic Homeostasis}
\label{sec:orgfd56f7c}
\begin{itemize}
...
\caption{\label{fig:orgdf56bb8}
Glucose Homeostasis}
\end{figure}


\begin{table}[htbp]
\caption[Insuline and Counterregulatory]{\label{tab:org24c0a59}
...
\caption{\label{fig:orgb3b107d}
Low Blood Glucose}
\end{figure}

\subsection{Transport}
\label{sec:org89e02ba}
...
\caption{\label{fig:org2f58938}
Regulation of Glycogen Synthesis and Degradation}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org1acd3f6}
...
\subsubsection{Clinical Presentation}
\label{sec:org1c75ac2}
\begin{enumerate}
\item Ia and Ib
\label{sec:org03425b9}
\begin{itemize}
...
\subsubsection{Diagnostic Tests}
\label{sec:org494bd4e}
\begin{itemize}
\item mutation analysis
\end{itemize}

\subsubsection{Treatment}
\label{sec:org1cc108b}
\begin{itemize}
...
\label{sec:org9fee51c}
\subsubsection{Clinical Presentation}
\label{sec:orge1bd92f}
\begin{itemize}
