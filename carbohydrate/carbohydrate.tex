...
\subsection{Glycogen}
\label{sec:orgdc8e77f}
\begin{enumerate}
\item Glycogen
\label{sec:org8c7549f}
...
\item Regulation
\label{sec:orga9f2ad7}
\begin{enumerate}
\item Muscle
\label{sec:org00811bb}
...
\label{sec:org659bf96}
\begin{enumerate}
\item Pathways
\label{sec:orgadcba3f}
\begin{itemize}
\item Fructose
\item Galactose
...
\label{sec:org64383a3}
\begin{enumerate}
\item Interconversion
\label{sec:orgf670478}
\begin{itemize}
...
\caption[lactose]{\label{fig:orgd56a172}
...
\caption[structure]{\label{fig:orgb3fa996}
Crystal structure}
\end{figure}


\subsection{GALT catalytic mechanism}
\label{sec:orge82945b}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./galt/figures/Fig3.png}
\caption[mechanism]{\label{fig:orgc032dd9}
Catalytic mechanism}
\end{figure}


\subsection{GALT gene}
\label{sec:org03f9830}
\begin{itemize}
...
\label{sec:orgf662ec7}

\begin{enumerate}
\item Therapy
\label{sec:orgae9c55e}
\begin{itemize}
\item life long dietary restriction of galactose.
\end{itemize}

\item Outcome
\label{sec:org9fa48d2}
\begin{itemize}
...
\label{sec:org30f2488}
\subsection{Introduction}
\label{sec:org31b0e9c}

\begin{enumerate}
\item Hepatic Glycogenoses
\label{sec:org6ef7b9a}
...
\item Hepatic Glycogenoses
\label{sec:org2c12fe3}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{./figures/gggmetab.png}
\caption[Hepatic Glycogenoses]{\label{fig:org477ec69}
...
\label{sec:orgfee70e4}
\begin{itemize}
\item mutation analysis
\end{itemize}
\item Treatment
\label{sec:org1dffe8c}
\begin{itemize}
\item avoid fasting
...
\label{sec:org465a26b}
\begin{enumerate}
\item Metabolic Derangement
\label{sec:org8fc5a4c}
\begin{itemize}
...
\item Clinical Presentation
\label{sec:orgf9aa706}
\begin{enumerate}
\item Ia and Ib
\label{sec:org0507a37}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org03ded21}
\begin{itemize}
\item mutation analysis
\end{itemize}

\item Treatment
\label{sec:org5696c54}
\begin{itemize}
...
\label{sec:org28d3892}
\begin{enumerate}
\item Metabolic Derangement
\label{sec:org223feeb}
\begin{itemize}
...
\end{itemize}
\item Diagnostic Tests
\label{sec:org8213c7e}
\begin{itemize}
\item DBE activity in leucocytes
\item mutation analysis
\end{itemize}
\item Treatment
\label{sec:orgcb97e75}
\begin{itemize}
...
\label{sec:org29462d6}
\begin{enumerate}
\item Metabolic Derangement
\label{sec:org46fec7d}
\begin{itemize}
...
\item Clinical Presentation
\label{sec:orge904306}

\begin{enumerate}
\item Neuromuscular Disease
\label{sec:orgf30a788}
\begin{itemize}
...
\label{sec:org0a89ad2}
\begin{enumerate}
\item Metabolic Derangement
\label{sec:orgd60fe4a}
\begin{itemize}
...
\end{itemize}
\item Genetics
\label{sec:org7a2c3d0}
\begin{itemize}
\item AR, PGYL gene
\end{itemize}

\item Clinical Presentation
\label{sec:org5849123}
\begin{itemize}
...
\label{sec:org21d5fb7}
\begin{enumerate}
\item Metabolic Derangement
\label{sec:org96a98d1}
\begin{itemize}
...
\label{sec:org5c9203d}
\subsection{Introduction}
\label{sec:orga716f5c}
\begin{enumerate}
\item Muscle and Cardiac Glycogenoses
\label{sec:org6be637e}
...
\item Muscle and Cardiac Glycogenoses
\label{sec:orgfa15abe}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{./muscle_cardiac_glycogenoses/figures/gggmetab_muscle_cardiac.png}
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:orgf0c8991}
Muscle and Cardiac Glycogenoses}
\end{figure}
\end{enumerate}

\subsection{GSD Type 0}
\label{sec:org2419e50}
\begin{enumerate}
\item GSD Type 0
\label{sec:orge0e0118}
\begin{enumerate}
\item Metabolic Derangement
\label{sec:org0f49096}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org66f7bbc}
\begin{itemize}
\item mutation analysis
\end{itemize}
\item Treatment
\label{sec:orgfa28cff}
\begin{itemize}
...
\label{sec:org7d57ae3}
\begin{enumerate}
\item Metabolic Derangement
\label{sec:org092d10f}
\begin{itemize}
...
\item Clinical Presentation
\label{sec:org6c4a39d}
\begin{enumerate}
\item Infantile
\label{sec:org5ca3adb}
\begin{itemize}
...
\end{enumerate}
\item Clinical Presentation
\label{sec:org1da66b4}
\begin{enumerate}
\item Adult
\label{sec:orga22953a}
\begin{itemize}
...
\label{sec:org2e6ee10}
\begin{enumerate}
\item Metabolic Derangement
\label{sec:org48dd574}
\begin{itemize}
...
\label{sec:orge74ab88}
\begin{enumerate}
\item LAMP2 Deficiency (Danon Disease)
\label{sec:org8ccfcc7}
\begin{itemize}
...
\label{sec:orgabc4dca}
\begin{enumerate}
\item AMPK Deficiency
\label{sec:org10007e2}
\begin{itemize}
...
\label{sec:org6d1797e}
\subsection{Introduction}
\label{sec:orgfd83236}
\begin{enumerate}
\item Glycolysis
\label{sec:orgf0b184e}
\begin{itemize}
...
\item Pentose Phosphate Pathway
\label{sec:org2fe8b73}
\begin{enumerate}
\item Oxidative Phase
\label{sec:org0bc3ebb}
\begin{itemize}
\item glucose 6-P \(\to\) NADPH + ribose 5-P
\item Glucose 6-P dehydrogenase catalyses first step
\item NADPH is for reducing reactions
...
\label{sec:org4987331}
\begin{enumerate}
\item NIET in Myopathy
\label{sec:org7b9274c}
...
\caption{\label{fig:org825c1d2}
LDH}
\end{figure}

\item Exercising Muscle: ATP
\label{sec:org09316f6}
...
\caption[gln]{\label{fig:org5af9b6c}
