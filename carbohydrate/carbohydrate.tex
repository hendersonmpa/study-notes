...
\caption{\label{fig:orgca40c68}
Conversion of Glucose}
\end{figure}

\subsection{Regulation}
\label{sec:orgc6dec59}
\subsubsection{Major Hormones of Metabolic Homeostasis}
\label{sec:orgb2c72f8}
\begin{itemize}
...
\caption{\label{fig:orgaaa45a1}
Glucose Homeostasis}
\end{figure}


\begin{table}[htbp]
\caption[Insuline and Counterregulatory]{\label{tab:orgbe87b38}
...
\caption{\label{fig:org3642d86}
Low Blood Glucose}
\end{figure}

\subsection{Transport}
\label{sec:org7e1924d}
\subsubsection{Absorption from the Intestine}
\label{sec:org44c080a}
\begin{itemize}
...
\caption{\label{fig:org945efd0}
Absorption from the intestine}
\end{figure}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:org92f34dd}
GLUTS}
\centering
\begin{tabular}{lll}
...
\caption{\label{fig:orgc7a54a5}
Regulation of Glycogen Synthesis and Degradation}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org08ca809}
...
\caption{\label{fig:org89660d2}
Galactose Metabolism}
\end{figure}

\subsubsection{Pentose Phosphate Pathway}
\label{sec:orgaa41600}
\begin{enumerate}
\item Oxidative Phase
\label{sec:orga77b333}
\begin{itemize}
...
\caption[lactose]{\label{fig:org5da6a47}
...
\label{sec:orgb69a213}
\subsubsection{Clinical Presentation}
\label{sec:orgaa7ad90}
\begin{itemize}
...
\label{sec:org2929430}
\subsubsection{Clinical Presentation}
\label{sec:org3ca91b1}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgbd38c1c}
\begin{itemize}
\item AR, GALE
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgcd2deeb}
\begin{itemize}
...
\label{sec:org53b8f90}
\subsubsection{Clinical Presentation}
\label{sec:orgf120923}
\begin{itemize}
...
\label{sec:org04a8fb5}
\subsection{Introduction}
\label{sec:org00f11b3}
\begin{itemize}
...
\caption[Hepatic Glycogenoses]{\label{fig:orgb829183}
Hepatic Glycogenoses}
\end{figure}

\subsection{GSD Type 0}
\label{sec:org963c3aa}
\subsubsection{Metabolic Derangement}
\label{sec:orgb834d59}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org2a2eb77}
\begin{enumerate}
\item Ia and Ib
\label{sec:org4dc4ed5}
\begin{itemize}
...
\subsubsection{Diagnostic Tests}
\label{sec:org5826371}
\begin{itemize}
\item mutation analysis
\end{itemize}

\subsubsection{Treatment}
\label{sec:orgb872f5a}
\begin{itemize}
...
\label{sec:org33c9664}
\subsubsection{Metabolic Derangement}
\label{sec:orgff32177}
\begin{itemize}
...
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orga265797}
\begin{itemize}
\item DBE activity in leucocytes
\item mutation analysis
\end{itemize}
\subsubsection{Treatment}
\label{sec:org7e25cab}
\begin{itemize}
...
\label{sec:org2b8d9b4}
\subsubsection{Metabolic Derangement}
\label{sec:orgdcf1d15}
\begin{itemize}
...
\label{sec:org6420a96}
\subsubsection{Metabolic Derangement}
\label{sec:org582bf02}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org5ce09fa}
\begin{itemize}
\item AR, PGYL gene
\end{itemize}

\subsubsection{Clinical Presentation}
\label{sec:org1141172}
\begin{itemize}
...
\label{sec:org7cc14f3}
\subsubsection{Metabolic Derangement}
\label{sec:org562eea2}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgd4ce848}
\begin{table}[htbp]
\caption{\label{tab:org907b589}
...
\label{sec:orgb807375}
\subsection{Introduction}
\label{sec:org62d1480}
\begin{itemize}
...
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:orga32eea2}
Muscle and Cardiac Glycogenoses}
\end{figure}

\subsection{GSD Type 0}
\label{sec:org57a5210}
\subsubsection{Metabolic Derangement}
\label{sec:org551ef21}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org0ab8cb1}
\begin{enumerate}
\item Infantile
\label{sec:org3b8a511}
\begin{itemize}
...
\label{sec:orgd4d5d3f}
\subsubsection{Metabolic Derangement}
\label{sec:org762bcf9}
\begin{itemize}
...
\subsubsection{Pentose Phosphate Pathway}
\label{sec:org56cb48e}
\begin{itemize}
\item Two phases
\end{itemize}
\begin{enumerate}
\item Oxidative Phase
\label{sec:orgad4ca89}
\begin{itemize}
\item glucose 6-P \(\to\) NADPH + ribose 5-P
\item Glucose 6-P dehydrogenase catalyses first step
\item NADPH is for reducing reactions
...
\label{sec:orgd179d2f}
\subsubsection{Glycolysis Disorders}
\label{sec:org5be26fc}
\begin{itemize}
...
\end{itemize}
\section{Fructose}
\label{sec:org264134e}
\subsection{Introduction}
\label{sec:org5d02bf8}
\begin{itemize}
\item Fructose is mainly metabolised in the liver, renal cortex and small
intestinal mucosa (Figure \ref{fig:orgb2dc1a0})
...
\caption[Fructose]{\label{fig:orgb2dc1a0}
...
\label{sec:org8663a9a}
\subsubsection{Clinical Presentation}
\label{sec:org2d89ecc}
\begin{itemize}
...
\label{sec:org98f2e54}
\subsubsection{Clinical Presentation}
\label{sec:org76c8e71}
\begin{itemize}
...
\label{sec:org426a47c}
\subsubsection{Clinical Presentation}
\label{sec:org3345eb6}
\begin{itemize}
...
\section{Insulin}
\label{sec:orgee98845}
\subsection{Introduction}
\label{sec:org1e98302}
\subsubsection{Insulin Secretion}
\label{sec:org3959707}
\begin{itemize}
...
\caption[insulin]{\label{fig:org449a690}
Insulin Secretion}
\end{figure}

\subsubsection{Insulin Effects}
\label{sec:org338026f}
\begin{itemize}
...
\label{sec:orgb699c5b}
\subsection{Introduction}
\label{sec:org3d4a09d}
\subsubsection{Glucose Transporters}
\label{sec:org92036df}
\begin{itemize}
...
\caption[glucose transporters]{\label{fig:org84399e3}
Glucose Transporters}
\end{figure}

\subsubsection{Congenital Defects of Glucose Transporters}
\label{sec:org3dfe429}
\begin{itemize}
