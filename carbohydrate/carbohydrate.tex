...
\caption{\label{fig:orgea5fecd}
Carbohydrate metabolism}
\end{figure}

\section{Galactose}
\label{sec:orgbf8ed4d}
\subsection{Introduction}
\label{sec:org642203d}
\begin{itemize}
...
\label{sec:org6231481}
\subsubsection{Clinical Presentation}
\label{sec:org4afbca3}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgfa1beda}
\begin{itemize}
\item AR GALE
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgeece1ba}
\begin{itemize}
...
\label{sec:org4a31979}
\subsubsection{Clinical Presentation}
\label{sec:orgd7f9cc4}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0a220eb}
\begin{itemize}
\item AR GK1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org50fa186}
\begin{itemize}
...
\end{itemize}
\section{Fructose}
\label{sec:org310fd78}
\subsection{Introduction}
\label{sec:orgb087b92}
\begin{itemize}
\item fructose is mainly metabolised in the liver, renal cortex and small
intestinal mucosa (Figure \ref{fig:org2f00f77})
...
\label{sec:org7db4e64}
\subsubsection{Clinical Presentation}
\label{sec:orgdb4c195}
\begin{itemize}
...
\label{sec:org55de8c5}
\subsubsection{Clinical Presentation}
\label{sec:org07686bb}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org50f6978}
\begin{itemize}
\item AR ALDOB
\end{itemize}

\subsubsection{Diagnostic Testing}
\label{sec:org12681b3}
\begin{itemize}
...
\label{sec:org1456325}
\subsubsection{Clinical Presentation}
\label{sec:orgfe3e67b}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org664c631}
\begin{itemize}
\item AR FBP1
\end{itemize}

\subsubsection{Diagnosis}
\label{sec:org6ba4fdf}
\begin{itemize}
...
\label{sec:org6ee981c}
\begin{itemize}
\item two phases
\end{itemize}
\begin{enumerate}
\item Oxidative Phase
\label{sec:orgd4be037}
\begin{itemize}
...
\label{sec:orgfa1f497}
\subsubsection{Glycolysis Disorders}
\label{sec:org61da194}
\begin{itemize}
...
\end{description}
\section{Insulin}
\label{sec:orgc95c893}
\subsection{Introduction}
\label{sec:org1b55aa1}
\begin{itemize}
...
\item other mechanisms regulate the release of insulin (Figure \ref{fig:org65de323})
\begin{enumerate}
...
\caption[insulin]{\label{fig:org65de323}
...
\caption[insulin]{\label{fig:org6e475c2}
Regulation of Insulin Secretion}
\end{figure}
...
\label{sec:org99da941}
\subsubsection{Transient Neonatal HI}
\label{sec:orga8db620}
\begin{itemize}
...
\label{sec:org5eff28f}
\subsection{Introduction}
\label{sec:org330c76e}
\begin{itemize}
\item glucose is hydrophilic \(\therefore\) cannot easily cross cell membrane
\item transporters exist in almost all cell types (Table \ref{fig:orgc335ceb})
...
\caption[glucose transporters]{\label{fig:orgc335ceb}
Glucose Transporters}
\end{figure}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:org91656af}
GLUTS}
\centering
\begin{tabular}{lll}
...
\label{sec:org7d18049}
\subsection{Introduction}
\label{sec:orgcfeee22}
\begin{itemize}
...
\caption{\label{fig:orgbef7b52}
Hepatic GSDs}
\end{figure}

\subsection{GSD Type 0}
\label{sec:org73672b5}
\subsubsection{Clinical Presentation}
\label{sec:org59fa65f}
\begin{itemize}
...
\label{sec:org0590b52}
\subsubsection{Clinical Presentation}
\label{sec:org065b41e}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org43da101}
\begin{itemize}
\item AR AGL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgdf48e63}
\begin{itemize}
\item \(\downarrow\) glucose
...
\label{sec:orgbdc3d80}
\subsubsection{Clinical Presentation}
\label{sec:org9cb71e5}
\begin{itemize}
...
\label{sec:org47347fa}
\subsubsection{Clinical Presentation}
\label{sec:orgf6b7924}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgc957e57}
\begin{itemize}
\item AR PGYL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgfa40937}
\begin{itemize}
\item \(\downarrow\) glucose
\item \(\uparrow\) lactate
\item \(\uparrow\) transaminases
...
\label{sec:org3473ccd}
\subsubsection{Clinical Presentation}
\label{sec:org61482b3}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org3eeb357}
\begin{itemize}
\item see table \ref{tab:orgb71c3c3}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orgb71c3c3}
...
\end{itemize}
\section{Muscle GSDs}
\label{sec:org9edc5b8}
\subsection{Introduction}
\label{sec:org6e5c383}
\begin{itemize}
...
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:orgafb123f}
Muscle and Cardiac Glycogenoses}
\end{figure}

\subsection{GSD Type 0}
\label{sec:org6c7ba76}
\subsubsection{Clinical Presentation}
\label{sec:org97ee76d}
\begin{itemize}
\item muscle fatigue
\item hypertrophic cardiomyopathy
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org7056844}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org216a4e6}
\begin{itemize}
\item AR AGL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org7ec47a4}
\begin{itemize}
...
\label{sec:org5fc3adf}
\begin{itemize}
\item AKA: McArdle Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgc7f393e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org2d9d683}
\begin{itemize}
\item AR PYGM
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7105e6d}
\begin{itemize}
...
\label{sec:org9d7dcf8}
\subsubsection{Clinical Presentation}
\label{sec:orgafda969}
\begin{itemize}
