...
\caption{\label{fig:org1466a00}
Conversion of Glucose}
\end{figure}

\subsection{Regulation}
\label{sec:orgbba1d8b}
\subsubsection{Major Hormones of Metabolic Homeostasis}
\label{sec:orgad2de45}
\begin{itemize}
...
\caption{\label{fig:org29699da}
Glucose Homeostasis}
\end{figure}


\begin{table}[htbp]
\caption[Insuline and Counterregulatory]{\label{tab:org48fea28}
...
\caption{\label{fig:org7d26004}
Low Blood Glucose}
\end{figure}

\subsection{Transport}
\label{sec:orgdfb6d9b}
...
\caption{\label{fig:org1320db0}
Regulation of Glycogen Synthesis and Degradation}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orgd23506a}
...
\subsubsection{Clinical Presentation}
\label{sec:org931b265}
\begin{enumerate}
\item Ia and Ib
\label{sec:orgf182f15}
\begin{itemize}
...
\subsubsection{Diagnostic Tests}
\label{sec:org80f397f}
\begin{itemize}
\item mutation analysis
\end{itemize}

\subsubsection{Treatment}
\label{sec:orgb1b10f8}
\begin{itemize}
...
\label{sec:org025160b}
\subsubsection{Clinical Presentation}
\label{sec:org30c72ed}
\begin{itemize}
