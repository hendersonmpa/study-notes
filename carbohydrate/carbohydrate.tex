...
\label{sec:org4472cdb}
\subsection{Introduction}
\label{sec:org1dba2b5}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{carbohydrate_metabolism/carbohydrate_metabolism/figures/monosaccharides.jpg}
\caption{\label{fig:orgc4704d2}Monosaccharides: A) pentoses B) hexoses}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=.5\textwidth]{carbohydrate_metabolism/carbohydrate_metabolism/figures/disacchardes.png}
\caption{\label{fig:org4540310}Disaccharides}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{carbohydrate_metabolism/carbohydrate_metabolism/figures/Slide09.png}
\caption{\label{fig:orgc0701a1}Carbohydrate metabolism}
\end{figure}

\section{Galactose}
\label{sec:orga5fc6d3}
\subsection{Introduction}
\label{sec:org334523c}
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{galactose/galactose/figures/galmet.png}
\caption{\label{fig:org05dafe0}Major reactions of galactose metabolism}
\end{figure}
...
\label{sec:org50214e9}
\subsubsection{Clinical Presentation}
\label{sec:orge1cc654}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org6f958c7}
\begin{itemize}
\item AR GALE
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7bb9cd0}
\begin{itemize}
...
\label{sec:orgdd6fe41}
\subsubsection{Clinical Presentation}
\label{sec:orgdcd0a45}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0d3db06}
\begin{itemize}
\item AR GK1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgfd63c8c}
\begin{itemize}
...
\end{itemize}
\section{Fructose}
\label{sec:orgab71e47}
\subsection{Introduction}
\label{sec:org30285e9}
\begin{itemize}
\item fructose is mainly metabolised in the liver, renal cortex and small
intestinal mucosa (Figure \ref{fig:orgc4704d2})
...
\label{sec:orgb0a5dca}
\subsubsection{Clinical Presentation}
\label{sec:org3565468}
\begin{itemize}
...
\label{sec:org4d4848c}
\subsubsection{Clinical Presentation}
\label{sec:org1ca9334}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org3233830}
\begin{itemize}
\item AR ALDOB
\end{itemize}

\subsubsection{Diagnostic Testing}
\label{sec:orga610ece}
\begin{itemize}
...
\label{sec:org4112dc4}
\subsubsection{Clinical Presentation}
\label{sec:org751e9c2}
\begin{itemize}
...
\label{sec:org8a66dfd}
\subsection{Introduction}
\label{sec:orga76c566}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{glycolysis_ppp/glycolysis_ppp/figures/glyc_ppp_rot.png}
\caption{\label{fig:orga2a9230}Glycolysis and PPP}
\end{figure}

\subsubsection{Glycolysis}
\label{sec:orgb7a4869}
\begin{itemize}
...
\label{sec:orga111098}
\begin{itemize}
\item two phases
\end{itemize}
\begin{enumerate}
\item Oxidative Phase
\label{sec:orgc78ce4f}
\begin{itemize}
...
\label{sec:org5d1f2a3}
\subsubsection{Glycolysis Disorders}
\label{sec:orgd04d96b}
\begin{itemize}
...
\label{sec:orga1fa06f}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{glycolysis_ppp/glycolysis_ppp/figures/Slide10.png}
\caption{\label{fig:org89b4205}Pentose Phosphate Pathway}
\end{figure}
...
\end{description}
\section{Insulin}
\label{sec:orgafe0239}
\subsection{Introduction}
\label{sec:org1fe2edd}
\begin{itemize}
...
\item other mechanisms regulate the release of insulin (Figure \ref{fig:org1dabfa1})
\begin{enumerate}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{insulin/insulin/figures/insulin.png}
\caption[insulin]{\label{fig:org1dabfa1}Regulation of Insulin Secretion}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{insulin/insulin/figures/Slide11.png}
\caption[insulin]{\label{fig:org3eb09c8}Regulation of Insulin Secretion}
\end{figure}
...
\label{sec:orgdf61c33}
\subsubsection{Transient Neonatal HI}
\label{sec:org3718ab2}
\begin{itemize}
...
\label{sec:orga5898d3}
\subsection{Introduction}
\label{sec:orge080a12}
\begin{itemize}
\item glucose is hydrophilic \(\therefore\) cannot easily cross cell membrane
\item transporters exist in almost all cell types (Table \ref{fig:org4ea6702})
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{glucose_transport/glucose_transport/figures/glut.png}
\caption[glucose transporters]{\label{fig:org4ea6702}Glucose Transporters}
\end{figure}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:org2bbfb1d}GLUTS}
\centering
\begin{tabular}{lll}
...
\label{sec:org9fa62ca}
\subsection{Introduction}
\label{sec:orgd6977d2}
\begin{itemize}
...
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:org8cba922}Hepatic Glycogenoses}
\centering
\begin{tabular}{llll}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{hepatic_glycogenoses/hepatic_glycogenoses/figures/gggmetab_hepatic.png}
\caption{\label{fig:org5905a2c}Hepatic GSDs}
\end{figure}

\subsection{GSD Type 0}
\label{sec:org5879668}
\subsubsection{Clinical Presentation}
\label{sec:orgb69aa42}
\begin{itemize}
...
\label{sec:orge49f991}
\subsubsection{Clinical Presentation}
\label{sec:orgcaa7cd1}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgc551f0f}
\begin{itemize}
\item AR AGL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgbc6b560}
\begin{itemize}
\item \(\downarrow\) glucose
...
\label{sec:org078eb4f}
\subsubsection{Clinical Presentation}
\label{sec:org53cb0b5}
\begin{itemize}
...
\label{sec:org65a7974}
\subsubsection{Clinical Presentation}
\label{sec:org6c8388f}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org0b356d9}
\begin{itemize}
\item AR PGYL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgbc466e2}
\begin{itemize}
\item \(\downarrow\) glucose
\item \(\uparrow\) lactate
\item \(\uparrow\) transaminases
...
\label{sec:orgfd8f4a0}
\subsubsection{Clinical Presentation}
\label{sec:org6b9d082}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org681dfbe}
\begin{itemize}
\item see table \ref{tab:orga271c94}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orga271c94}GSD Type IX Genetics}
\centering
\begin{tabular}{lllll}
...
\end{itemize}
\section{Muscle GSDs}
\label{sec:orge68a590}
\subsection{Introduction}
\label{sec:org42a7f11}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org9e3f8e2}Muscle and Cardiac Glycogenoses}
\centering
\begin{tabular}{llll}
Type & Enzyme & Phenotype & Gene\\
\hline
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{muscle_cardiac_glycogenoses/muscle_cardiac_glycogenoses/figures/gggmetab_muscle_cardiac.png}
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:org936b9e0}Muscle and Cardiac Glycogenoses}
\end{figure}

\subsection{GSD Type 0}
\label{sec:orgb7dd3b7}
\subsubsection{Clinical Presentation}
\label{sec:org2fae469}
\begin{itemize}
\item muscle fatigue
\item hypertrophic cardiomyopathy
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgfcbf297}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org0e2c58e}
\begin{itemize}
\item AR AGL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgdc617e4}
\begin{itemize}
...
\label{sec:org2079212}
\begin{itemize}
\item AKA: McArdle Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgaa243c9}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orga32eba8}
\begin{itemize}
\item AR PYGM
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgecccce6}
\begin{itemize}
...
\label{sec:org871235d}
\subsubsection{Clinical Presentation}
\label{sec:org630a2ad}
\begin{itemize}
