...
\caption{\label{fig:orgab7fa99}Major reactions of galactose metabolism}
\end{figure}
...
\label{sec:orgc018781}
\subsubsection{Clinical Presentation}
\label{sec:org306bf8d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org204fcf0}
\begin{itemize}
\item AR GALE
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org0902822}
\begin{itemize}
...
\label{sec:orgb8f4e34}
\subsubsection{Clinical Presentation}
\label{sec:orge8611cf}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org38b1c4f}
\begin{itemize}
\item AR GK1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org5b6b37e}
\begin{itemize}
...
\end{itemize}
\section{Fructose}
\label{sec:orga4fb089}
\subsection{Introduction}
\label{sec:org82c4c8d}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org6f26f71}
\begin{itemize}
\item AR KHK
\end{itemize}
\subsubsection{Diagnosis and Treatment}
\label{sec:org34cdd88}
\begin{itemize}
...
\label{sec:org245d568}
\subsubsection{Clinical Presentation}
\label{sec:org1c3e587}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgbb8be70}
\begin{itemize}
\item AR ALDOB
\end{itemize}

\subsubsection{Diagnostic Testing}
\label{sec:org2f70212}
\begin{itemize}
...
\label{sec:org85a7b36}
\subsubsection{Clinical Presentation}
\label{sec:org1f98ba7}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orge678c7c}
\begin{itemize}
\item AR FBP1
\end{itemize}

\subsubsection{Diagnosis}
\label{sec:orgf43ee96}
\begin{itemize}
...
\label{sec:orgcadd26e}
\subsection{Introduction}
\label{sec:org5235a71}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{glycolysis_ppp/figures/glyc_ppp_rot.png}
\caption{\label{fig:org52c53c5}Glycolysis and PPP}
\end{figure}

\subsubsection{Glycolysis}
\label{sec:org542940e}
\begin{itemize}
...
\label{sec:org03c0615}
\begin{itemize}
\item two phases
\end{itemize}
\begin{enumerate}
\item Oxidative Phase
\label{sec:org9b7a142}
\begin{itemize}
\item produces NADPH
...
\label{sec:org9e8c773}
\subsubsection{Glycolysis Disorders}
\label{sec:org4487ee0}
\begin{itemize}
...
\label{sec:orgd361529}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{glycolysis_ppp/figures/Slide10.png}
\caption{\label{fig:org81d72ae}Pentose Phosphate Pathway}
\end{figure}
...
\end{description}
\section{Insulin}
\label{sec:orga536409}
\subsection{Introduction}
\label{sec:org375921c}
\begin{itemize}
...
\item other mechanisms regulate the release of insulin (Figure \ref{fig:org299a81a})
\begin{enumerate}
...
\caption[insulin]{\label{fig:org299a81a}Regulation of Insulin Secretion}
\end{figure}
...
\caption[insulin]{\label{fig:org505c9bf}Regulation of Insulin Secretion}
\end{figure}
...
\label{sec:org70e4090}
\subsubsection{Transient Neonatal HI}
\label{sec:orgbade21c}
\begin{itemize}
...
\label{sec:orgb506d4f}
\subsection{Introduction}
\label{sec:orge4e422d}
\begin{itemize}
\item glucose is hydrophilic \(\therefore\) cannot easily cross cell membrane
\item transporters exist in almost all cell types (Table \ref{fig:orgfe3e313})
...
\caption[glucose transporters]{\label{fig:orgfe3e313}Glucose Transporters}
\end{figure}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:org49f6d0f}GLUTS}
\centering
\begin{tabular}{lll}
...
\label{sec:org8bad9c5}
\subsection{Introduction}
\label{sec:org8db6e9e}
\begin{itemize}
...
\caption{\label{fig:orgd01633e}Hepatic Glycogenoses}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org77c84dc}Hepatic Glycogenoses}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org5dc1e17}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:orgd116a8e}
\subsubsection{Clinical Presentation}
\label{sec:orgb29aaa6}
\begin{itemize}
...
\label{sec:org9413c43}
\subsubsection{Clinical Presentation}
\label{sec:orge7221bb}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgd139b28}
\begin{itemize}
\item AR AGL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orge94b63b}
\begin{itemize}
\item \(\downarrow\) glucose
...
\label{sec:org5d01a9d}
\subsubsection{Clinical Presentation}
\label{sec:org5ab2da8}
\begin{itemize}
...
\label{sec:org86591cf}
\subsubsection{Clinical Presentation}
\label{sec:orgb0fadeb}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org21e8d01}
\begin{itemize}
\item AR PGYL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org65e47d2}
\begin{itemize}
\item \(\downarrow\) glucose
\item \(\uparrow\) lactate
\item \(\uparrow\) transaminases
...
\label{sec:org2c16c6e}
\subsubsection{Clinical Presentation}
\label{sec:org5920e05}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4e9fcad}
\begin{itemize}
\item see table \ref{tab:org67a80f5}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:org67a80f5}GSD Type IX Genetics}
\centering
\begin{tabular}{lllll}
...
\label{sec:orge9de861}
\subsection{Introduction}
\label{sec:org8e17b79}
\begin{itemize}
...
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:org0f4fe1d}Muscle and Cardiac Glycogenoses}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org49a51f8}Muscle and Cardiac Glycogenoses}
\centering
\begin{tabular}{llll}
Type & Enzyme & Phenotype & Gene\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{orga6d23a6}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:org06a956c}
\subsubsection{Clinical Presentation}
\label{sec:org21fe884}
\begin{itemize}
\item muscle fatigue
\item hypertrophic cardiomyopathy
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org9af8270}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org46a187b}
\begin{itemize}
\item AR GAA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org34d72e0}
\begin{itemize}
...
\label{sec:orga620252}
\begin{itemize}
\item AKA McArdle Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orga88c874}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org7c46378}
\begin{itemize}
\item AR PYGM
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org0027570}
\begin{itemize}
...
\label{sec:org8dcaae7}
\subsubsection{Clinical Presentation}
\label{sec:org724d6eb}
\begin{itemize}
