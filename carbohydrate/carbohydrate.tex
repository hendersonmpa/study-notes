...
\caption{\label{fig:org3e80794}Major reactions of galactose metabolism}
\end{figure}
...
\label{sec:org0e89d00}
\subsubsection{Clinical Presentation}
\label{sec:org5ee31fe}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org1a5202d}
\begin{itemize}
\item AR GALE
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orga226a59}
\begin{itemize}
...
\label{sec:org20fc6ff}
\subsubsection{Clinical Presentation}
\label{sec:orgabcc5fa}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org296b99d}
\begin{itemize}
\item AR GK1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgbc52d0d}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orga96a8d6}
\begin{itemize}
\item AR KHK
\end{itemize}
\subsubsection{Diagnosis and Treatment}
\label{sec:org0513fac}
\begin{itemize}
...
\label{sec:orgfc4cf11}
\subsubsection{Clinical Presentation}
\label{sec:org449f2a6}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgdc44dcf}
\begin{itemize}
\item AR ALDOB
\end{itemize}

\subsubsection{Diagnostic Testing}
\label{sec:orgff0a518}
\begin{itemize}
...
\label{sec:orga3dd67c}
\subsubsection{Clinical Presentation}
\label{sec:org4b78f52}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgfd911f9}
\begin{itemize}
\item AR FBP1
\end{itemize}

\subsubsection{Diagnosis}
\label{sec:orgce36751}
\begin{itemize}
...
\label{sec:org9f3b4c7}
\subsection{Introduction}
\label{sec:org54055bd}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{glycolysis_ppp/figures/glyc_ppp_rot.png}
\caption{\label{fig:orgda402de}Glycolysis and PPP}
\end{figure}

\subsubsection{Glycolysis}
\label{sec:org567e97e}
\begin{itemize}
...
\label{sec:orgb5aca17}
\begin{itemize}
\item two phases
\end{itemize}
\begin{enumerate}
\item Oxidative Phase
\label{sec:org2198906}
\begin{itemize}
\item produces NADPH
...
\label{sec:org3ee8893}
\subsubsection{Glycolysis Disorders}
\label{sec:org8822439}
\begin{itemize}
...
\label{sec:org1542191}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{glycolysis_ppp/figures/Slide10.png}
\caption{\label{fig:org07aa7aa}Pentose Phosphate Pathway}
\end{figure}
...
\end{description}
\section{Insulin}
\label{sec:orgc0255c4}
\subsection{Introduction}
\label{sec:org797e545}
\begin{itemize}
...
\item other mechanisms regulate the release of insulin (Figure \ref{fig:org1e01ef9})
\begin{enumerate}
...
\caption[insulin]{\label{fig:org1e01ef9}Regulation of Insulin Secretion}
\end{figure}
...
\caption[insulin]{\label{fig:orga68a1ee}Regulation of Insulin Secretion}
\end{figure}
...
\label{sec:org4009850}
\subsubsection{Transient Neonatal HI}
\label{sec:org9a5153d}
\begin{itemize}
...
\label{sec:orga9cdee5}
\subsection{Introduction}
\label{sec:org3d1a71d}
\begin{itemize}
\item glucose is hydrophilic \(\therefore\) cannot easily cross cell membrane
\item transporters exist in almost all cell types (Table \ref{fig:orge7bff23})
...
\caption[glucose transporters]{\label{fig:orge7bff23}Glucose Transporters}
\end{figure}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:org550437b}GLUTS}
\centering
\begin{tabular}{lll}
...
\label{sec:orgad849ea}
\subsection{Introduction}
\label{sec:org431b59f}
\begin{itemize}
...
\caption{\label{fig:org2827b74}Hepatic Glycogenoses}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orgb2046ac}Hepatic Glycogenoses}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org76b221b}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:orgb75b7d6}
\subsubsection{Clinical Presentation}
\label{sec:org6f7cb6d}
\begin{itemize}
...
\label{sec:orga63cf94}
\subsubsection{Clinical Presentation}
\label{sec:org733dd41}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgdb76e46}
\begin{itemize}
\item AR AGL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org6799fed}
\begin{itemize}
\item \(\downarrow\) glucose
...
\label{sec:org59ceb5c}
\subsubsection{Clinical Presentation}
\label{sec:org7e3ede6}
\begin{itemize}
...
\label{sec:orgee3f8ab}
\subsubsection{Clinical Presentation}
\label{sec:orgcee5d0e}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org02c1170}
\begin{itemize}
\item AR PGYL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org05c0136}
\begin{itemize}
\item \(\downarrow\) glucose
\item \(\uparrow\) lactate
\item \(\uparrow\) transaminases
...
\label{sec:org41ec41e}
\subsubsection{Clinical Presentation}
\label{sec:org3ae42ec}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb4fdde3}
\begin{itemize}
\item see table \ref{tab:orge3a8e0b}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orge3a8e0b}GSD Type IX Genetics}
\centering
\begin{tabular}{lllll}
...
\label{sec:orga1e2205}
\subsection{Introduction}
\label{sec:orgd82c3b9}
\begin{itemize}
...
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:orgbed05de}Muscle and Cardiac Glycogenoses}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org7c9a0dc}Muscle and Cardiac Glycogenoses}
\centering
\begin{tabular}{llll}
Type & Enzyme & Phenotype & Gene\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{orge173621}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:org83bdfcc}
\subsubsection{Clinical Presentation}
\label{sec:orgf83e323}
\begin{itemize}
\item muscle fatigue
\item hypertrophic cardiomyopathy
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org2c2e60a}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org385141a}
\begin{itemize}
\item AR GAA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgb685536}
\begin{itemize}
...
\item acarbose is used to inhibit neutral \(\alpha\)-glucosidases in DBS assay
\end{itemize}
\item mutation analysis
\end{itemize}
\subsubsection{Treatment}
\label{sec:org71e2572}
\begin{itemize}
...
\label{sec:org5b116ec}
\begin{itemize}
\item AKA McArdle Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org1b201e7}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgcf64138}
\begin{itemize}
\item AR PYGM
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgaba8536}
\begin{itemize}
...
\label{sec:orgfaa13ef}
\subsubsection{Clinical Presentation}
\label{sec:org37d2830}
\begin{itemize}
