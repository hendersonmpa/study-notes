...
\caption{\label{fig:org78a8b70}
Carbohydrate metabolism}
\end{figure}

\section{Galactose}
\label{sec:org753cc6f}
\subsection{Introduction}
\label{sec:org7a0dc55}
\begin{itemize}
...
\label{sec:org54f2517}
\subsubsection{Clinical Presentation}
\label{sec:orgaf51035}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org33390ec}
\begin{itemize}
\item AR GALE
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgaecfe9f}
\begin{itemize}
...
\label{sec:org0894d65}
\subsubsection{Clinical Presentation}
\label{sec:org3c590d0}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb78e737}
\begin{itemize}
\item AR GK1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org2da6ef6}
\begin{itemize}
...
\end{itemize}
\section{Fructose}
\label{sec:orgceb7201}
\subsection{Introduction}
\label{sec:orgf30674c}
\begin{itemize}
\item fructose is mainly metabolised in the liver, renal cortex and small
intestinal mucosa (Figure \ref{fig:org07f4dac})
...
\label{sec:org239fbb0}
\subsubsection{Clinical Presentation}
\label{sec:org0072154}
\begin{itemize}
...
\label{sec:org435530b}
\subsubsection{Clinical Presentation}
\label{sec:orgbfdae94}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0f6d3f8}
\begin{itemize}
\item AR ALDOB
\end{itemize}

\subsubsection{Diagnostic Testing}
\label{sec:org81ebcef}
\begin{itemize}
...
\label{sec:org9ea7f92}
\subsubsection{Clinical Presentation}
\label{sec:orgb031839}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org48e9dd1}
\begin{itemize}
\item AR FBP1
\end{itemize}

\subsubsection{Diagnosis}
\label{sec:orgbcbcc83}
\begin{itemize}
...
\label{sec:org56674f5}
\begin{itemize}
\item two phases
\end{itemize}
\begin{enumerate}
\item Oxidative Phase
\label{sec:org5462a23}
\begin{itemize}
...
\label{sec:org893ed1d}
\subsubsection{Glycolysis Disorders}
\label{sec:org21090ab}
\begin{itemize}
...
\end{description}
\section{Insulin}
\label{sec:org07944f9}
\subsection{Introduction}
\label{sec:org065cf35}
\begin{itemize}
...
\item other mechanisms regulate the release of insulin (Figure \ref{fig:org12931dd})
\begin{enumerate}
...
\caption[insulin]{\label{fig:org12931dd}
...
\caption[insulin]{\label{fig:orgab863b4}
Regulation of Insulin Secretion}
\end{figure}
...
\label{sec:orgf8d0f9d}
\subsubsection{Transient Neonatal HI}
\label{sec:orga9c658c}
\begin{itemize}
...
\label{sec:orgaa93a86}
\subsection{Introduction}
\label{sec:orgef82d42}
\begin{itemize}
\item glucose is hydrophilic \(\therefore\) cannot easily cross cell membrane
\item transporters exist in almost all cell types (Table \ref{fig:org3246e8d})
...
\caption[glucose transporters]{\label{fig:org3246e8d}
Glucose Transporters}
\end{figure}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:orga4a2141}
GLUTS}
\centering
\begin{tabular}{lll}
...
\label{sec:orgdb6e1ec}
\subsection{Introduction}
\label{sec:org0f6971e}
\begin{itemize}
...
\caption{\label{fig:orgf8aeb21}
Hepatic GSDs}
\end{figure}

\subsection{GSD Type 0}
\label{sec:org3a2b97c}
\subsubsection{Clinical Presentation}
\label{sec:org1ae0dc0}
\begin{itemize}
...
\label{sec:orga295b3c}
\subsubsection{Clinical Presentation}
\label{sec:org285b581}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org62157ab}
\begin{itemize}
\item AR AGL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgcc6b1d8}
\begin{itemize}
\item \(\downarrow\) glucose
...
\label{sec:org1d437b6}
\subsubsection{Clinical Presentation}
\label{sec:org6e97e07}
\begin{itemize}
...
\label{sec:orgfb26a4c}
\subsubsection{Clinical Presentation}
\label{sec:orgb4caf34}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org03f6e34}
\begin{itemize}
\item AR PGYL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org869c85e}
\begin{itemize}
\item \(\downarrow\) glucose
\item \(\uparrow\) lactate
\item \(\uparrow\) transaminases
...
\label{sec:org9c605b5}
\subsubsection{Clinical Presentation}
\label{sec:org1fcd690}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org3373790}
\begin{itemize}
\item see table \ref{tab:orgd02a341}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:orgd02a341}
...
\end{itemize}
\section{Muscle GSDs}
\label{sec:org9e35efb}
\subsection{Introduction}
\label{sec:orgae6098a}
\begin{itemize}
...
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:org01faa75}
Muscle and Cardiac Glycogenoses}
\end{figure}

\subsection{GSD Type 0}
\label{sec:org7037739}
\subsubsection{Clinical Presentation}
\label{sec:orgb3bf204}
\begin{itemize}
\item muscle fatigue
\item hypertrophic cardiomyopathy
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org6c62cc2}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org93edbbe}
\begin{itemize}
\item AR AGL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orga5d44f3}
\begin{itemize}
...
\label{sec:orgebfab54}
\begin{itemize}
\item AKA: McArdle Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:orgd44fe95}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge7f5707}
\begin{itemize}
\item AR PYGM
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org3780ff8}
\begin{itemize}
...
\label{sec:org30c8233}
\subsubsection{Clinical Presentation}
\label{sec:orgf6d031a}
\begin{itemize}
