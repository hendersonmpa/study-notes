...
\caption{\label{fig:orgc08c90e}
Conversion of Glucose}
\end{figure}

\subsection{Regulation}
\label{sec:org99cc9c1}
\subsubsection{Major Hormones of Metabolic Homeostasis}
\label{sec:orge8e1dfc}
\begin{itemize}
...
\caption{\label{fig:org99fc8cd}
Glucose Homeostasis}
\end{figure}


\begin{table}[htbp]
\caption[Insuline and Counterregulatory]{\label{tab:org7437e56}
...
\caption{\label{fig:org52e0a24}
Low Blood Glucose}
\end{figure}

\subsection{Transport}
\label{sec:orgebeec1f}
\subsubsection{Absorption from the Intestine}
\label{sec:orgf264d8a}
\begin{itemize}
...
\caption{\label{fig:org9a50fec}
Absorption from the intestine}
\end{figure}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:org4c637ac}
GLUTS}
\centering
\begin{tabular}{lll}
...
\caption{\label{fig:org235dbb3}
Regulation of Glycogen Synthesis and Degradation}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org185e815}
...
\caption{\label{fig:orgb49297f}
Galactose Metabolism}
\end{figure}

\subsubsection{Pentose Phosphate Pathway}
\label{sec:org02a15ea}
\begin{enumerate}
\item Oxidative Phase
\label{sec:org7eba9fa}
\begin{itemize}
...
\caption[lactose]{\label{fig:orgc61c23c}
...
\label{sec:orged5eca8}
\subsubsection{Clinical Presentation}
\label{sec:orga177e28}
\begin{itemize}
...
\label{sec:org9a23a2c}
\subsubsection{Clinical Presentation}
\label{sec:orge69dc74}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4fb28a1}
\begin{itemize}
\item AR, GALE
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgaf5598d}
\begin{itemize}
...
\label{sec:org6eea83d}
\subsubsection{Clinical Presentation}
\label{sec:org522a10f}
\begin{itemize}
...
\label{sec:org31568bf}
\subsection{Introduction}
\label{sec:orgd1fa624}
\begin{itemize}
...
\caption[Hepatic Glycogenoses]{\label{fig:orgfbb665e}
Hepatic Glycogenoses}
\end{figure}

\subsection{GSD Type 0}
\label{sec:orgecf92a3}
\subsubsection{Metabolic Derangement}
\label{sec:org73e3685}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orgcd8cf42}
\begin{enumerate}
\item Ia and Ib
\label{sec:org12342b1}
\begin{itemize}
...
\subsubsection{Diagnostic Tests}
\label{sec:org78f91bd}
\begin{itemize}
\item mutation analysis
\end{itemize}

\subsubsection{Treatment}
\label{sec:orga265dc8}
\begin{itemize}
...
\label{sec:org8945a70}
\subsubsection{Metabolic Derangement}
\label{sec:org1eb0f88}
\begin{itemize}
...
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org1409120}
\begin{itemize}
\item DBE activity in leucocytes
\item mutation analysis
\end{itemize}
\subsubsection{Treatment}
\label{sec:org2b9dd4e}
\begin{itemize}
...
\label{sec:orgf91a4f9}
\subsubsection{Metabolic Derangement}
\label{sec:org806a2b1}
\begin{itemize}
...
\label{sec:org6ed7a3f}
\subsubsection{Metabolic Derangement}
\label{sec:orgd6afeeb}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org8fa185b}
\begin{itemize}
\item AR, PGYL gene
\end{itemize}

\subsubsection{Clinical Presentation}
\label{sec:org703cf59}
\begin{itemize}
...
\label{sec:orgf487b48}
\subsubsection{Metabolic Derangement}
\label{sec:orgf2acf0e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org2c5dd17}
\begin{table}[htbp]
\caption{\label{tab:org65ee95e}
...
\label{sec:org9b893d4}
\subsection{Introduction}
\label{sec:orgfd3c16e}
\begin{itemize}
...
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:org6215fa0}
Muscle and Cardiac Glycogenoses}
\end{figure}

\subsection{GSD Type 0}
\label{sec:orgcad7f68}
\subsubsection{Metabolic Derangement}
\label{sec:orgd7be26d}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org728c781}
\begin{enumerate}
\item Infantile
\label{sec:orgb7aef38}
\begin{itemize}
...
\label{sec:org4fdeb10}
\subsubsection{Metabolic Derangement}
\label{sec:orge505fe7}
\begin{itemize}
...
\subsubsection{Pentose Phosphate Pathway}
\label{sec:org9f57b9a}
\begin{itemize}
\item Two phases
\end{itemize}
\begin{enumerate}
\item Oxidative Phase
\label{sec:orga26effb}
\begin{itemize}
\item glucose 6-P \(\to\) NADPH + ribose 5-P
\item Glucose 6-P dehydrogenase catalyses first step
\item NADPH is for reducing reactions
...
\label{sec:org22a91ae}
\subsubsection{Glycolysis Disorders}
\label{sec:org89e0d39}
\begin{itemize}
...
\end{itemize}
\section{Fructose}
\label{sec:org3e2b36c}
\subsection{Introduction}
\label{sec:org7c556f0}
\begin{itemize}
\item Fructose is mainly metabolised in the liver, renal cortex and small
intestinal mucosa (Figure \ref{fig:orgbf6dd52})
...
\caption[Fructose]{\label{fig:orgbf6dd52}
...
\label{sec:orgfdae38a}
\subsubsection{Clinical Presentation}
\label{sec:org2bfc8e5}
\begin{itemize}
...
\label{sec:org545f9b7}
\subsubsection{Clinical Presentation}
\label{sec:org13400d0}
\begin{itemize}
...
\label{sec:orgaa4954e}
\subsubsection{Clinical Presentation}
\label{sec:org35731df}
\begin{itemize}
...
\section{Insulin}
\label{sec:orgc9ff849}
\subsection{Introduction}
\label{sec:org89f1fbc}
\subsubsection{Insulin Secretion}
\label{sec:org94d577b}
\begin{itemize}
...
\caption[insulin]{\label{fig:org6a16546}
Insulin Secretion}
\end{figure}

\subsubsection{Insulin Effects}
\label{sec:org723e74f}
\begin{itemize}
...
\label{sec:orgfcb26f4}
\subsection{Introduction}
\label{sec:org736a9b4}
\subsubsection{Glucose Transporters}
\label{sec:orgbbf1708}
\begin{itemize}
...
\caption[glucose transporters]{\label{fig:org07a9691}
Glucose Transporters}
\end{figure}

\subsubsection{Congenital Defects of Glucose Transporters}
\label{sec:org8f39364}
\begin{itemize}
