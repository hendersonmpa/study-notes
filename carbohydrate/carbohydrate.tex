...
\label{sec:org897e41b}
\subsection{Introduction}
\label{sec:orgb928fcf}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{glycolysis_ppp/figures/glyc_ppp_rot.png}
\caption{\label{fig:org49d0b1c}Glycolysis and PPP}
\end{figure}

\subsubsection{Glycolysis}
\label{sec:org27a067b}
\begin{itemize}
...
\label{sec:orgd3be016}
\begin{itemize}
\item two phases
\end{itemize}
\begin{enumerate}
\item Oxidative Phase
\label{sec:orgd942424}
\begin{itemize}
\item produces NADPH
...
\label{sec:org5f2f35c}
\subsubsection{Glycolysis Disorders}
\label{sec:org74d4997}
\begin{itemize}
...
\label{sec:orgc0037c8}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{glycolysis_ppp/figures/Slide10.png}
\caption{\label{fig:org10e017c}Pentose Phosphate Pathway}
\end{figure}
...
\caption[insulin]{\label{fig:org2bd74f7}Regulation of Insulin Secretion}
\end{figure}
...
\label{sec:orged4e75e}
\subsubsection{Transient Neonatal HI}
\label{sec:org6ad1254}
\begin{itemize}
...
\subsection{Introduction}
\label{sec:org5fdf4d7}
\begin{itemize}
\item glucose is hydrophilic \(\therefore\) cannot easily cross cell membrane
\item transporters exist in almost all cell types (Table \ref{fig:org070fe85})
...
\caption[glucose transporters]{\label{fig:org070fe85}Glucose Transporters}
\end{figure}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:org863243d}GLUTS}
\centering
\begin{tabular}{lll}
...
\begin{table}[htbp]
\caption{\label{tab:orgf08a77e}Hepatic Glycogenoses}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{org1a8bdca}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:org5b177df}
\subsubsection{Clinical Presentation}
\label{sec:org0f90a93}
\begin{itemize}
...
\label{sec:org184195c}
\subsubsection{Clinical Presentation}
\label{sec:org2ff0568}
\begin{itemize}
...
\end{tabular}
\end{table}\footnotetext[2]{\label{org521f2bb}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:org17cb23e}
\subsubsection{Clinical Presentation}
\label{sec:org23ec545}
\begin{itemize}
\item muscle fatigue
\item hypertrophic cardiomyopathy
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:org08efc86}
\begin{itemize}
...
\label{sec:orgc110e22}
\subsubsection{Clinical Presentation}
\label{sec:org2627699}
\begin{itemize}
