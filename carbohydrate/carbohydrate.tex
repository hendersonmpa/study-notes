...
\caption{\label{fig:orgd4f0221}Major reactions of galactose metabolism}
\end{figure}
...
\label{sec:orgc9e81a3}
\subsubsection{Clinical Presentation}
\label{sec:orge80a7e2}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4879829}
\begin{itemize}
\item AR GALE
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgc08422f}
\begin{itemize}
...
\label{sec:orgd51da48}
\subsubsection{Clinical Presentation}
\label{sec:org925ff81}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org855ab18}
\begin{itemize}
\item AR GK1
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgf73232d}
\begin{itemize}
...
\end{itemize}
\section{Fructose}
\label{sec:orgbb4a96b}
\subsection{Introduction}
\label{sec:org4625b6f}
\begin{itemize}
\item fructose is mainly metabolised in the liver, renal cortex and small
intestinal mucosa (Figure \ref{fig:orgb65328c})
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgc956f7a}
\begin{itemize}
\item AR KHK
\end{itemize}
\subsubsection{Diagnosis and Treatment}
\label{sec:orgd0cb337}
\begin{itemize}
...
\label{sec:orgce22ed4}
\subsubsection{Clinical Presentation}
\label{sec:org3ded96d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org0a2ba32}
\begin{itemize}
\item AR ALDOB
\end{itemize}

\subsubsection{Diagnostic Testing}
\label{sec:orgb09cc09}
\begin{itemize}
...
\label{sec:org156030a}
\subsubsection{Clinical Presentation}
\label{sec:orgce4003c}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org7e913a8}
\begin{itemize}
\item AR FBP1
\end{itemize}

\subsubsection{Diagnosis}
\label{sec:orgfc1a841}
\begin{itemize}
...
\label{sec:org3303849}
\subsection{Introduction}
\label{sec:org84ad49c}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{glycolysis_ppp/figures/glyc_ppp_rot.png}
\caption{\label{fig:orgba4e4b3}Glycolysis and PPP}
\end{figure}

\subsubsection{Glycolysis}
\label{sec:org5356d4d}
\begin{itemize}
...
\label{sec:org4a294e3}
\begin{itemize}
\item two phases
\end{itemize}
\begin{enumerate}
\item Oxidative Phase
\label{sec:org2543016}
\begin{itemize}
\item produces NADPH
...
\label{sec:org790e3a0}
\subsubsection{Glycolysis Disorders}
\label{sec:orgf6a2da0}
\begin{itemize}
...
\label{sec:org56c4b8f}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{glycolysis_ppp/figures/Slide10.png}
\caption{\label{fig:orgb53ed72}Pentose Phosphate Pathway}
\end{figure}
...
\end{description}
\section{Insulin}
\label{sec:orgb46478e}
\subsection{Introduction}
\label{sec:org1adca5f}
\begin{itemize}
...
\item other mechanisms regulate the release of insulin (Figure \ref{fig:org0edb769})
\begin{enumerate}
...
\caption[insulin]{\label{fig:org0edb769}Regulation of Insulin Secretion}
\end{figure}
...
\caption[insulin]{\label{fig:org83cd710}Regulation of Insulin Secretion}
\end{figure}
...
\label{sec:org3f73495}
\subsubsection{Transient Neonatal HI}
\label{sec:orgcfcc25c}
\begin{itemize}
...
\label{sec:org2c2a8b1}
\subsection{Introduction}
\label{sec:org7de6a74}
\begin{itemize}
\item glucose is hydrophilic \(\therefore\) cannot easily cross cell membrane
\item transporters exist in almost all cell types (Table \ref{fig:orgadb3c19})
...
\caption[glucose transporters]{\label{fig:orgadb3c19}Glucose Transporters}
\end{figure}

\begin{table}[htbp]
\caption[GLUTS]{\label{tab:orgce0a05c}GLUTS}
\centering
\begin{tabular}{lll}
...
\label{sec:org467aadf}
\subsection{Introduction}
\label{sec:org1e5f75e}
\begin{itemize}
...
\caption{\label{fig:org7435df1}Hepatic Glycogenoses}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orga6ec3c6}Hepatic Glycogenoses}
\centering
\begin{tabular}{llll}
...
\end{tabular}
\end{table}\footnotetext[1]{\label{orgbf6b711}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:org14908c1}
\subsubsection{Clinical Presentation}
\label{sec:orgc79b7d0}
\begin{itemize}
...
\label{sec:org8e253fe}
\subsubsection{Clinical Presentation}
\label{sec:org80bce16}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org3d2933d}
\begin{itemize}
\item AR AGL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:orgbb1f574}
\begin{itemize}
\item \(\downarrow\) glucose
...
\label{sec:orgba5eba5}
\subsubsection{Clinical Presentation}
\label{sec:org81dda40}
\begin{itemize}
...
\label{sec:org4604762}
\subsubsection{Clinical Presentation}
\label{sec:org1211217}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgf9d03c8}
\begin{itemize}
\item AR PGYL
\end{itemize}
\subsubsection{Diagnostic Tests}
\label{sec:org564c9ea}
\begin{itemize}
\item \(\downarrow\) glucose
\item \(\uparrow\) lactate
\item \(\uparrow\) transaminases
...
\label{sec:org43b0690}
\subsubsection{Clinical Presentation}
\label{sec:org081d320}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4287219}
\begin{itemize}
\item see table \ref{tab:org7ae64d8}
\end{itemize}
\begin{table}[htbp]
\caption{\label{tab:org7ae64d8}GSD Type IX Genetics}
\centering
\begin{tabular}{lllll}
...
\end{itemize}
\section{Muscle GSDs}
\label{sec:org61b52c9}
\subsection{Introduction}
\label{sec:orgf19ecc5}
\begin{itemize}
...
\caption[Muscle and Cardiac Glycogenoses]{\label{fig:org3245af3}Muscle and Cardiac Glycogenoses}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org97569f7}Muscle and Cardiac Glycogenoses}
\centering
\begin{tabular}{llll}
Type & Enzyme & Phenotype & Gene\\
\hline
...
\end{tabular}
\end{table}\footnotetext[2]{\label{orgd9abcc2}hepatic and myopathic}

\subsection{GSD Type 0}
\label{sec:org8d6f5d3}
\subsubsection{Clinical Presentation}
\label{sec:org2a03df7}
\begin{itemize}
\item muscle fatigue
\item hypertrophic cardiomyopathy
\end{itemize}
\subsubsection{Metabolic Derangement}
\label{sec:orgcb2286a}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org2d7cfbb}
\begin{itemize}
\item AR GAA
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orga636740}
\begin{itemize}
...
\label{sec:org3bfab5f}
\begin{itemize}
\item AKA McArdle Disease
\end{itemize}
\subsubsection{Clinical Presentation}
\label{sec:org7ade987}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org93d0ff4}
\begin{itemize}
\item AR PYGM
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org829f9a9}
\begin{itemize}
...
\label{sec:orge968ad9}
\subsubsection{Clinical Presentation}
\label{sec:org60ac4d1}
\begin{itemize}
