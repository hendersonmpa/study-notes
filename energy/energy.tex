...
\label{sec:org1972e54}
\subsection{Cellular Redox State}
\label{sec:org839c595}
\begin{itemize}
...
\label{sec:org64122a7}
\subsection{Introduction}
\label{sec:orge4ca909}
\begin{itemize}
...
\label{sec:org4aac5c3}
\begin{itemize}
\item involves three processes (Figure \ref{fig:orge41779d})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:org82ccbfe})
\begin{itemize}
...
\caption{\label{fig:orge41779d}Fatty Acid Oxidation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/Slide12.png}
\caption{\label{fig:org7e22e31}Fatty Acid Oxidation and Ketone Body Metabolism}
\end{figure}
...
\caption{\label{fig:org82ccbfe}Fatty Acid \(\beta\)-Oxidation}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:orgcea2d01}Acyl-CoA Synthetases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\begin{table}[htbp]
\caption{\label{tab:orgb935663}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
Enzyme & Length & location\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org4072bbd}Other: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\begin{table}[htbp]
\caption{\label{tab:orga62700f}Common manifestations in FAODs}
\centering
...
\caption{\label{fig:org3082c2b}CPT1 (OMM) \& CPTII (IMM)}
\end{figure}

\item Genetics
\label{sec:org9b96ebb}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:org21fcf80}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6c224bf}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org8d52999}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:org1549b86})
\begin{itemize}
...
\caption{\label{fig:org1549b86}Carnitine Acylcarnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org218a475}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:org36516b5}
\begin{itemize}
...
\label{sec:org38bcb26}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgcd11c36}
\begin{enumerate}
\item Neonatal
\label{sec:org0618bbc}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:org3082c2b})
\end{itemize}
\item Genetics
\label{sec:org01b7a9a}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org2aab5e8}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:orgc6a484d}
\subsubsection{Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency}
\label{sec:orge8b412a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org010d805}
\begin{enumerate}
\item Infancy
\label{sec:orgc05e794}
\begin{itemize}
...
\caption{\label{fig:org0f1b301}VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:org73de50f}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:orgcd33f83}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:orgc04ea40}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgcba6c73}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:orgca6248f}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:orge17eddc}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:orgb0b5a22}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org646ef55}
\begin{itemize}
...
(Figure \ref{fig:org3c1ffa3})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{fao/figures/lchad.png}
\caption{\label{fig:org3c1ffa3}LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:org7195147}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:orgce9c3e2}
\begin{itemize}
...
\label{sec:org0a57859}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgcd9f8e6}
\begin{itemize}
...
\item Genetics
\label{sec:orgcedb2ed}
\begin{itemize}
\item AR ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org1e7fc37}
\begin{itemize}
...
\caption{\label{fig:org850d9d2}Multiple Acyl-CoA Dehydrogenase Deficiency}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/etf.png}
\caption{\label{fig:org8aa9e65}Role of ETF and ETF-QO}
\end{figure}

\item Genetics
\label{sec:orgd4d0045}
\begin{itemize}
\item AR ETFA, ETFB, ETFDH
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf8cf207}
\begin{itemize}
\item plasma acylcarnitines
\begin{itemize}
\item \(\uparrow\) C4-C18
...
\end{enumerate}
\section{Pyruvate}
\label{sec:orgaef19ed}
\subsection{Introduction}
\label{sec:org7208ee4}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgbb26783}Disorders of Pyruvate Metabolism}
\end{figure}
...
\caption[TCA]{\label{fig:org589f9c2}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Reactions involving Pyruvate}
\label{sec:orgbb29277}
...
\begin{table}[htbp]
\caption{\label{tab:org7adf40d}Pyruvate Dehydrogenases Complex}
\centering
\begin{tabular}{llll}
...
\caption[pdhe1]{\label{fig:org685650c}Activation/deactivation of PDHE1}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{pyruvate/figures/pdhc.png}
\caption[pdhc]{\label{fig:orgde32f42}Pyruvate Dehydrogenase Complex}
\end{figure}
...
dephosphorylated (active) (Figure \ref{fig:org685650c})
\end{itemize}

\subsubsection{Pyruvate Transport Defect}
\label{sec:orgadda4e2}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orge522b5a}
\begin{itemize}
\item AR DLD
\end{itemize}
\subsubsection{Diagnostic Testing}
\label{sec:orgdebb885}
\begin{itemize}
\item combined PDHC, TCA, BCAA defect
\begin{itemize}
...
\label{sec:org994c208}
\subsection{Introduction}
\label{sec:org7403a05}
\begin{itemize}
...
\caption[TCA]{\label{fig:org6e20e11}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Disorders of the TCA cycle}
\label{sec:org9865637}
...
\begin{table}[htbp]
\caption{\label{tab:org5cc0de0}\(\alpha\)-Ketoglutarate Dehydrogenase Complex}
\centering
\begin{tabular}{llll}
Unit & Name & Gene & Cofactor\\
\hline
...
\subsubsection{Clinical Presentation}
\label{sec:orgf17b7cc}
\begin{itemize}
\item similar to PDHC (section \ref{sec:org7c40a33})
...
\subsubsection{Genetics}
\label{sec:org3493627}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org1416799}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\caption{\label{fig:orga152aa5}Succinate Dehydrogenase | Complex II}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:org1764937}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org7868a58}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:orgd2c147b})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgd2c147b}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\label{sec:org6f35cb4}
\subsection{Introduction}
\label{sec:orgc1cbcd2}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:orgf821670} and \ref{fig:org5d21c2a})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of Complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:orgab027d5})
...
\caption{\label{fig:orgf821670}Flow of electrons in the ETC}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:orgab027d5}Location of DNA encoding OxPhos Complex Subunits}
\centering
...
\caption[ETC]{\label{fig:org5d21c2a}Oxidative Phosphorylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{oxphos/figures/potential.png}
\caption[redox]{\label{fig:org5aa66bd}Electron flow to O\textsubscript{2} and release free energy}
\end{figure}

\subsubsection{Complex I}
\label{sec:org7526458}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:orgadcf674})
...
\caption[c1]{\label{fig:orgadcf674}Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\subsubsection{Complex II}
\label{sec:org5ab8519}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org4125d0b}
\end{itemize}
\end{itemize}

\subsubsection{Glycerol-3-phosphate shuttle}
\label{sec:orgb8dad86}
\begin{itemize}
...
\caption[g3ps]{\label{fig:org871f512}Glycerol-3-phosphate shuttle}
\end{figure}

\subsubsection{Electron Transferring Flavoprotein/ Dehydrogenase}
\label{sec:orgdc1e30e}
\begin{itemize}
...
\caption[cIV]{\label{fig:orgbaa3c75}Complex IV | Cytochrome c oxidase}
\end{figure}
\end{itemize}

\subsubsection{Complex V}
\label{sec:org50d1b3d}
\begin{itemize}
...
\caption{\label{fig:org061c5dd}Complex V | ATP synthase}
\end{figure}
\end{itemize}
\end{itemize}

\subsection{Clinical Presentation}
\label{sec:orgd3219f2}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:org8784ab1})
\begin{enumerate}
...
\caption[ETC]{\label{fig:org8784ab1}Pathogenesis of OxPhos Disorders}
\end{figure}
...
\caption{\label{fig:orgc2c477e}mtDNA disorders}
\end{figure}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:orgdc2adb1})
...
\begin{table}[htbp]
\caption{\label{tab:orgdc2adb1}Clinical Features of Mitochondrial Disease}
\centering
\begin{tabular}{ll}
...
\label{sec:org43ab4db}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:org0ecb3e2}
\begin{itemize}
...
\label{sec:orgab483cf}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:org189bb9a}
\begin{itemize}
...
\label{sec:org024ff48}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{oxphos/figures/algorithm_rot.png}
\caption{\label{fig:org1792bd2}Diagnosis of Mitochondrial Disease}
\end{figure}


\subsubsection{Biochemistry}
\label{sec:org262b37b}
\begin{itemize}
...
\label{sec:org76dfc95}
\begin{itemize}
\item CII is encoded by nuclear DNA (Table \ref{tab:orgab027d5})
\begin{itemize}
...
\caption[rrf]{\label{fig:orgfa9ce8a}Ragged red fibers - Gomori stain}
\end{figure}

\subsubsection{Molecular}
\label{sec:orge9d3a40}
\begin{itemize}
...
\label{sec:org7b014d2}
\subsection{Introduction}
\label{sec:org1b35e07}
\begin{itemize}
...
\caption{\label{fig:orgc9aa1e0}Ketogenesis and Ketolysis}
\end{figure}
...
\subsubsection{Clinical Presentation}
\label{sec:org7d1784d}
\begin{table}[htbp]
\caption{\label{tab:org0880406}Common Manifestations in Ketogenesis Defects}
\centering
\begin{tabular}{llllll}
FAOD & sudden & fasting & skeletal & cardio- & liver\\
 & death & intolerance & myopathy & myopathy & disease\\
...
\subsubsection{Diagnostic Tests}
\label{sec:org18a52bf}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org9b81df9}
\begin{itemize}
...
\caption{\label{fig:org358ac6d}Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Slide16.png}
\caption{\label{fig:org6db7ae0}Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org9d984b1}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org8253183}Urine findings in CDS}
\centering
\begin{tabular}{lll}
