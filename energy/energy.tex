...
\label{sec:orgc837f9e}
\subsection{Cellular Redox State}
\label{sec:org73c4ad6}
\begin{itemize}
...
\label{sec:org4ce4bc8}
\subsection{Introduction}
\label{sec:org7ecc7f6}
\begin{itemize}
...
\label{sec:org42c6e64}
\begin{itemize}
\item involves three processes (Figure \ref{fig:orgb734d24})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:org9ef21d8})
\begin{itemize}
...
and the \(\beta\) carbon atoms by acyl-CoA dehydrogenase (Table \ref{tab:org98c4796})
\begin{itemize}
...
\caption{\label{fig:orgb734d24}Fatty Acid \(\beta\)-Oxidation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/Slide12.png}
\caption{\label{fig:org378b4d0}Fatty Acid \(\beta\)-Oxidation and Ketone Body Metabolism}
\end{figure}
...
\caption{\label{fig:org9ef21d8}Fatty Acid \(\beta\)-Oxidation}
\end{figure}



\begin{table}[htbp]
\caption{\label{tab:org98c4796}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\end{itemize}
\begin{itemize}
\item summarized in table \ref{tab:orgd0234c4}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgd0234c4}Common Manifestations in FAODs}
\centering
...
\item Genetics
\label{sec:org80d26af}
\begin{itemize}
\item AR OCTN2
\end{itemize}
\item Diagnostic Tests
\label{sec:org34fa4da}
\begin{itemize}
...
\caption{\label{fig:org044d931}CPT1 (OMM) \& CPTII (IMM)}
\end{figure}

\item Genetics
\label{sec:orgd7b1f48}
\begin{itemize}
\item AR CPT1A
...
\label{sec:org4785b67}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org589cfb1}
\begin{itemize}
...
\caption{\label{fig:orgb7d80ef}Carnitine Acylcarnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org739129b}
\begin{itemize}
\item AR SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:org8a503b6}
\begin{itemize}
...
\label{sec:org71c7e42}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb2de8f7}
\begin{enumerate}
\item Neonatal
\label{sec:orgb152b68}
\begin{itemize}
...
(Figure \ref{fig:org044d931})
\end{itemize}
\item Genetics
\label{sec:org9f0bf5c}
\begin{itemize}
\item AR CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org0519ab1}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:orgf144509}
\subsubsection{Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency}
\label{sec:org1ec9382}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb4d87ae}
\begin{enumerate}
\item Infancy
\label{sec:org1e59326}
\begin{itemize}
...
steps in the \(\beta\)-oxidation of fatty acids (Table \ref{tab:org98c4796})
...
\caption{\label{fig:orgdd5bed7}VLCAD Reaction}
\end{figure}

\item Genetics
\label{sec:org05cfac8}
\begin{itemize}
\item AR ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org188dd4e}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:orgd7aa422}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org78ca7e4}
\begin{itemize}
...
\item Genetics
\label{sec:orgc3c190e}
\begin{itemize}
\item AR HADHA, HADHB
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf581e06}
\begin{itemize}
...
\label{sec:orgb26a27f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5c23036}
\begin{itemize}
...
(Figure \ref{fig:org565457f})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{fao/figures/lchad.png}
\caption{\label{fig:org565457f}LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:orgd3ecb75}
\begin{itemize}
\item AR HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:org6501113}
\begin{itemize}
\item \(\uparrow\) lactate \(\because\) 3-OH-palmitoyl-CoA inhibits PDH
\item \(\uparrow\) hydroxy-acylcarnitines
\begin{itemize}
...
\label{sec:org3339616}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4e7b1e1}
\begin{itemize}
...
\item Genetics
\label{sec:org86d63c4}
\begin{itemize}
\item AR ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:orgf1792c9}
\begin{itemize}
...
\caption{\label{fig:org1ded7c1}Multiple Acyl-CoA Dehydrogenase Deficiency}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/etf.png}
\caption{\label{fig:orga00abb3}Role of ETF and ETF-QO}
\end{figure}

\item Genetics
\label{sec:org6f63934}
\begin{itemize}
\item AR ETFA, ETFB, ETFDH
\end{itemize}

\item Diagnostic Tests
\label{sec:org1cee67d}
\begin{itemize}
\item plasma acylcarnitines
\begin{itemize}
\item \(\uparrow\) C4-C18
...
\end{enumerate}
\section{Pyruvate}
\label{sec:orgea63c4c}
\subsection{Introduction}
\label{sec:orge586715}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgecb0926}Disorders of Pyruvate Metabolism}
\end{figure}
...
\caption[TCA]{\label{fig:orgefa6da8}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Reactions involving Pyruvate}
\label{sec:org7067118}
...
\begin{table}[htbp]
\caption{\label{tab:orgc918f82}Pyruvate Dehydrogenases Complex}
\centering
\begin{tabular}{llll}
...
\caption[pdhe1]{\label{fig:orgad8ac65}Activation/Deactivation of PDH E1}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{pyruvate/figures/pdhc.png}
\caption[pdhc]{\label{fig:orgfcdba5e}Pyruvate Dehydrogenase Complex}
\end{figure}
...
dephosphorylated (active) (Figure \ref{fig:orgad8ac65})
\end{itemize}

\subsubsection{Pyruvate Transport Defect}
\label{sec:org15f865b}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgd7f3949}
\begin{itemize}
\item AR DLD
\end{itemize}
\subsubsection{Diagnostic Testing}
\label{sec:org51880cd}
\begin{itemize}
...
\label{sec:org6f5ef97}
\subsection{Introduction}
\label{sec:org22e3a1d}
\begin{itemize}
...
\caption[TCA]{\label{fig:org9675561}Pyruvate Metabolism and the TCA Cycle}
\end{figure}
...
\caption[TCA]{\label{fig:orgda2a2c9}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Disorders of the TCA cycle}
\label{sec:org700c3a2}
...
\begin{table}[htbp]
\caption{\label{tab:org44a0f5e}\(\alpha\)-Ketoglutarate Dehydrogenase Complex}
\centering
\begin{tabular}{llll}
Unit & Name & Gene & Cofactor\\
\hline
...
\subsubsection{Clinical Presentation}
\label{sec:orgdc29040}
\begin{itemize}
\item similar to PDHC (section \ref{sec:orge4b7386})
...
\subsubsection{Genetics}
\label{sec:org831d319}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orga0fa620}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgea98d1b}
\begin{itemize}
\item none
\end{itemize}
\subsection{Succinate Dehydrogenase Deficiency}
\label{sec:org1bb681e}
\begin{itemize}
\item four subunits compose Complex II of the mitochondrial respiratory
chain (Table \ref{tab:org4ab56cb})
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org4ab56cb}Succinate Dehydrogenase | Complex II}
\centering
\begin{tabular}{ll}
Subunit & Description\\
\hline
...
\caption{\label{fig:org4dea8af}Succinate Dehydrogenase | Complex II}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:org54b4fdb}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgd4bcd5e}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:orga729239})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orga729239}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\label{sec:orgd6916c3}
\subsection{Introduction}
\label{sec:orge6e9dea}
\begin{itemize}
...
series of electron carriers (Figures \ref{fig:orgd99230c} and \ref{fig:orgdfa02e7})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:org4c11616})
...
\caption{\label{fig:orgd99230c}Flow of Electrons in the ETC}
\end{figure}
...
\item ETF-QO and mitochondrial glycerol-3-P dehydrogenase (GPD) are part of ETC (Figure \ref{fig:orgd99230c})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org4c11616}Location of DNA Encoding OxPhos Complex Subunits}
\centering
...
\caption[ETC]{\label{fig:orgdfa02e7}Oxidative Phosphorylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{oxphos/figures/potential.png}
\caption[redox]{\label{fig:orgbbf4b84}Electron Flow to O\textsubscript{2} and Release of Free Energy}
\end{figure}

\subsubsection{Complex I}
\label{sec:org5f5d360}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:orge375ad8})
...
\caption[c1]{\label{fig:orge375ad8}Complex I | NADH-Ubiquinone Oxidoreductase}
\end{figure}

\subsubsection{Complex II}
\label{sec:orga17d9e4}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org1bb681e}
\end{itemize}
\end{itemize}

\subsubsection{Glycerol-3-Phosphate Shuttle}
\label{sec:orgec13d2b}
\begin{itemize}
...
\caption[g3ps]{\label{fig:orgffcce79}Glycerol-3-Phosphate Shuttle}
\end{figure}

\subsubsection{Electron Transferring Flavoprotein/ Dehydrogenase}
\label{sec:orga7142f0}
\begin{itemize}
...
\caption[cIV]{\label{fig:org41c32fc}Complex IV | Cytochrome C Oxidase}
\end{figure}
\end{itemize}

\subsubsection{Complex V}
\label{sec:orgca8bd3e}
\begin{itemize}
...
\caption{\label{fig:org41c94e2}Complex V | ATP Synthase}
\end{figure}
\end{itemize}
\end{itemize}

\subsection{Clinical Presentation}
\label{sec:org19e87cf}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:org4aa266f})
\begin{enumerate}
...
\caption[ETC]{\label{fig:org4aa266f}Pathogenesis of OxPhos Disorders}
\end{figure}
...
\caption{\label{fig:org39ee5bc}mtDNA Disorders}
\end{figure}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:org8e814f8})
...
\begin{table}[htbp]
\caption{\label{tab:org8e814f8}Clinical Features of Mitochondrial Disease}
\centering
\begin{tabular}{ll}
...
\label{sec:orgaf677ae}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:org063fbbe}
\begin{itemize}
...
\label{sec:org80494fe}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:orgc6dca2a}
\begin{itemize}
...
\label{sec:org1723f54}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{oxphos/figures/algorithm_rot.png}
\caption{\label{fig:orgf3d6ec1}Diagnosis of Mitochondrial Disease}
\end{figure}


\subsubsection{Biochemistry}
\label{sec:org0b038dd}
\begin{itemize}
...
\label{sec:orgbfcbeb8}
\begin{itemize}
\item CII is encoded by nuclear DNA (Table \ref{tab:org4c11616})
\begin{itemize}
...
\caption[rrf]{\label{fig:orge6eaf30}Ragged Red Fibers - Gomori Stain}
\end{figure}

\subsubsection{Molecular}
\label{sec:orgeab04f6}
\begin{itemize}
...
\label{sec:org3e2b429}
\subsection{Introduction}
\label{sec:org55584c9}
\begin{itemize}
...
\caption{\label{fig:org4e6f486}Ketogenesis and Ketolysis}
\end{figure}
...
\subsubsection{Clinical Presentation}
\label{sec:orga6572f8}
\begin{table}[htbp]
\caption{\label{tab:orgef7bd06}Common Manifestations in Ketogenesis Defects}
\centering
\begin{tabular}{llllll}
FAOD & sudden & fasting & skeletal & cardio- & liver\\
 & death & intolerance & myopathy & myopathy & disease\\
...
\subsubsection{Diagnostic Tests}
\label{sec:org0492894}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:orga8fa248}
\begin{itemize}
...
\caption{\label{fig:orga41784e}Metabolic Pathway of Creatine/Creatine Phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Slide16.png}
\caption{\label{fig:orge2d39cd}Metabolic Pathway of Creatine/Creatine Phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Creatinesynthesis.png}
\caption{\label{fig:org5b1a48c}Creatine Synthesis}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org55821a7}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orge41cfb1}Urine Findings in CDS}
\centering
\begin{tabular}{lll}
