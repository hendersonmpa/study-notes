...
\label{sec:orgc6ad9b1}
\subsection{Cellular Redox State}
\label{sec:org7e3d9f2}
\begin{itemize}
...
\label{sec:org98adde2}
\subsection{Introduction}
\label{sec:org2f5eb47}
\begin{itemize}
...
\caption{\label{fig:orgafab0db}Fatty Acid \(\beta\)-Oxidation}
\end{figure}



\begin{table}[htbp]
\caption{\label{tab:org0e90a6b}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\item Genetics
\label{sec:orgac2f443}
\begin{itemize}
\item AR OCTN2
\end{itemize}
\item Diagnostic Tests
\label{sec:orgb3f7176}
\begin{itemize}
...
\caption{\label{fig:org35e997d}CPT1 (OMM) \& CPTII (IMM)}
\end{figure}

\item Genetics
\label{sec:org65958b1}
\begin{itemize}
\item AR CPT1A
...
\caption{\label{fig:org424bffc}Carnitine Acylcarnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org4379d5e}
\begin{itemize}
\item AR SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:orgbc6f19d}
\begin{itemize}
...
\label{sec:org320527d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6df0feb}
\begin{enumerate}
\item Neonatal
\label{sec:orgb9b873f}
\begin{itemize}
...
\item Genetics
\label{sec:org783d6ba}
\begin{itemize}
\item AR ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:orgc1ccc86}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:orgf4860c0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc153a8e}
\begin{itemize}
...
(Figure \ref{fig:org3f7c3fe})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{fao/figures/lchad.png}
\caption{\label{fig:org3f7c3fe}LCHAD reaction}
\end{figure}
...
\label{sec:org895e6e5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org01a63dc}
\begin{itemize}
...
\caption{\label{fig:org616c727}Multiple Acyl-CoA Dehydrogenase Deficiency}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/etf.png}
\caption{\label{fig:org6b13d2f}Role of ETF and ETF-QO}
\end{figure}

\item Genetics
\label{sec:orgff89e57}
\begin{itemize}
\item AR ETFA, ETFB, ETFDH
\end{itemize}

\item Diagnostic Tests
\label{sec:org6114498}
\begin{itemize}
\item plasma acylcarnitines
\begin{itemize}
\item \(\uparrow\) C4-C18
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org3b4653f}
\subsection{Introduction}
\label{sec:org20f713e}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgff5e5cd}Disorders of Pyruvate Metabolism}
\end{figure}
...
\caption[TCA]{\label{fig:org26c6050}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Reactions involving Pyruvate}
\label{sec:orga50f9e1}
...
\caption[pdhc]{\label{fig:org86989ea}Pyruvate Dehydrogenase Complex}
\end{figure}
...
\label{sec:org911f095}
\subsection{Introduction}
\label{sec:orgdbb9e69}
\begin{itemize}
...
\caption[TCA]{\label{fig:org27adc86}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Disorders of the TCA cycle}
\label{sec:orgdc4be41}
...
\begin{table}[htbp]
\caption{\label{tab:org133ad89}Succinate Dehydrogenase | Complex II}
\centering
\begin{tabular}{ll}
Subunit & Description\\
\hline
...
\caption{\label{fig:org9cbc77a}Succinate Dehydrogenase | Complex II}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:org28c437d}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org58e12ff}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:org425a653})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org425a653}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\subsubsection{Diagnostic Tests}
\label{sec:org0057531}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org3bbe0ed}
\begin{itemize}
