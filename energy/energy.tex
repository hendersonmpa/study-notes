...
\label{sec:org5848557}
\subsection{Cellular Redox State}
\label{sec:orga39bb1d}
\begin{itemize}
...
\label{sec:org47cf165}
\subsection{Introduction}
\label{sec:org8f3c42e}
\begin{itemize}
...
\label{sec:org9df99ae}
\begin{itemize}
\item involves three processes (Figure \ref{fig:org4c69493})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:org1cf8a33})
\begin{itemize}
...
and the \(\beta\) carbon atoms by acyl-CoA dehydrogenase (Table \ref{tab:orgff3a035})
\begin{itemize}
...
\caption{\label{fig:org4c69493}Fatty Acid Oxidation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/Slide12.png}
\caption{\label{fig:orgb6a7da3}Fatty Acid Oxidation and Ketone Body Metabolism}
\end{figure}
...
\caption{\label{fig:org1cf8a33}Fatty Acid \(\beta\)-Oxidation}
\end{figure}



\begin{table}[htbp]
\caption{\label{tab:orgff3a035}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\end{itemize}
\begin{itemize}
\item summarized in table \ref{tab:orgb2f3574}
\end{itemize}
\begin{center}
...
\item Genetics
\label{sec:org0a0c31e}
\begin{itemize}
\item AR OCTN2
\end{itemize}
\item Diagnostic Tests
\label{sec:org0fd8ef0}
\begin{itemize}
...
\caption{\label{fig:org0035e89}CPT1 (OMM) \& CPTII (IMM)}
\end{figure}

\item Genetics
\label{sec:orgc3c79ad}
\begin{itemize}
\item AR CPT1A
...
\label{sec:org728bf37}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgda4a3dd}
\begin{itemize}
...
\caption{\label{fig:orgec18ec4}Carnitine Acylcarnitine Translocase}
\end{figure}

\item Genetics
\label{sec:orgbe019b1}
\begin{itemize}
\item AR SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:org69ce7f5}
\begin{itemize}
...
\label{sec:orgfcdeb12}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf4b5b6c}
\begin{enumerate}
\item Neonatal
\label{sec:org9fabf20}
\begin{itemize}
...
(Figure \ref{fig:org0035e89})
\end{itemize}
\item Genetics
\label{sec:org5f9c20d}
\begin{itemize}
\item AR CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org859c773}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:org4684c3a}
\subsubsection{Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency}
\label{sec:org0638008}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5e174ca}
\begin{enumerate}
\item Infancy
\label{sec:org4c2e822}
\begin{itemize}
...
steps in the \(\beta\)-oxidation of fatty acids (Table \ref{tab:orgff3a035})
...
\caption{\label{fig:orge51c2a4}VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:org616ded7}
\begin{itemize}
\item AR ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org97095a1}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org64e54db}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgbb6a9d4}
\begin{itemize}
...
\item Genetics
\label{sec:org60b0c3b}
\begin{itemize}
\item AR HADHA, HADHB
\end{itemize}

\item Diagnostic Tests
\label{sec:orgb16d47b}
\begin{itemize}
...
\label{sec:org62ac5d4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga7dd74d}
\begin{itemize}
...
(Figure \ref{fig:orgdb031af})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{fao/figures/lchad.png}
\caption{\label{fig:orgdb031af}LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:orgfefd8d0}
\begin{itemize}
\item AR HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf5667fc}
\begin{itemize}
\item \(\uparrow\) lactate \(\because\) 3-OH-palmitoyl-CoA inhibits PDH
\item \(\uparrow\) hydroxy-acylcarnitines
\begin{itemize}
...
\label{sec:orgee82423}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org255b721}
\begin{itemize}
...
\item Genetics
\label{sec:org19e616f}
\begin{itemize}
\item AR ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:orgccda51a}
\begin{itemize}
...
\caption{\label{fig:org8a223ed}Multiple Acyl-CoA Dehydrogenase Deficiency}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/etf.png}
\caption{\label{fig:org4d79266}Role of ETF and ETF-QO}
\end{figure}

\item Genetics
\label{sec:org5468320}
\begin{itemize}
\item AR ETFA, ETFB, ETFDH
\end{itemize}

\item Diagnostic Tests
\label{sec:orgdcee8ba}
\begin{itemize}
\item plasma acylcarnitines
\begin{itemize}
\item \(\uparrow\) C4-C18
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org7180d04}
\subsection{Introduction}
\label{sec:org8e2a86e}
\begin{itemize}
...
\caption[TCA]{\label{fig:org2c60283}Disorders of Pyruvate Metabolism}
\end{figure}
...
\caption[TCA]{\label{fig:orgf38bb30}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Reactions involving Pyruvate}
\label{sec:org0d00702}
...
\begin{table}[htbp]
\caption{\label{tab:org1dc7b74}Pyruvate Dehydrogenases Complex}
\centering
\begin{tabular}{llll}
...
\caption[pdhe1]{\label{fig:orgf48052d}Activation/deactivation of PDH E1}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{pyruvate/figures/pdhc.png}
\caption[pdhc]{\label{fig:org4711ac8}Pyruvate Dehydrogenase Complex}
\end{figure}
...
dephosphorylated (active) (Figure \ref{fig:orgf48052d})
\end{itemize}

\subsubsection{Pyruvate Transport Defect}
\label{sec:orgeecfbcc}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org12df865}
\begin{itemize}
\item AR DLD
\end{itemize}
\subsubsection{Diagnostic Testing}
\label{sec:org73482a2}
\begin{itemize}
...
\caption[TCA]{\label{fig:org809a6ed}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Disorders of the TCA cycle}
\label{sec:org350d179}
...
\begin{table}[htbp]
\caption{\label{tab:orgf9addc8}\(\alpha\)-Ketoglutarate Dehydrogenase Complex}
\centering
\begin{tabular}{llll}
Unit & Name & Gene & Cofactor\\
\hline
...
\subsubsection{Clinical Presentation}
\label{sec:orge6048e4}
\begin{itemize}
\item similar to PDHC (section \ref{sec:org675ac74})
...
\subsubsection{Genetics}
\label{sec:orgb97946b}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgeae7d48}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org1128b77}
\begin{itemize}
\item none
\end{itemize}
\subsection{Succinate Dehydrogenase Deficiency}
\label{sec:org44a6494}
\begin{itemize}
\item four subunits compose Complex II of the mitochondrial respiratory
chain (Table \ref{tab:orgb3c5400})
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgb3c5400}Succinate Dehydrogenase | Complex II}
\centering
\begin{tabular}{ll}
Subunit & Description\\
\hline
...
\caption{\label{fig:org55d4e6b}Succinate Dehydrogenase | Complex II}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:orgd1aac4e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org68fe579}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:org08a4ac1})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org08a4ac1}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\label{sec:org8df71e7}
\subsection{Introduction}
\label{sec:org8850804}
\begin{itemize}
...
series of electron carriers (Figures \ref{fig:org2e8293a} and \ref{fig:org00f439c})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:orgbf056c6})
...
\caption{\label{fig:org2e8293a}Flow of Electrons in the ETC}
\end{figure}
...
\item ETF-QO and mitochondrial glycerol-3-P dehydrogenase (GPD) are part of ETC (Figure \ref{fig:org2e8293a})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgbf056c6}Location of DNA Encoding OxPhos Complex Subunits}
\centering
...
\caption[ETC]{\label{fig:org00f439c}Oxidative Phosphorylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{oxphos/figures/potential.png}
\caption[redox]{\label{fig:orgf1f0cc1}Electron Flow to O\textsubscript{2} and Release of Free Energy}
\end{figure}

\subsubsection{Complex I}
\label{sec:org91b2f20}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:org9a28da2})
...
\caption[c1]{\label{fig:org9a28da2}Complex I | NADH-Ubiquinone Oxidoreductase}
\end{figure}

\subsubsection{Complex II}
\label{sec:org322c8f3}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org44a6494}
\end{itemize}
\end{itemize}

\subsubsection{Glycerol-3-Phosphate Shuttle}
\label{sec:orge244d4f}
\begin{itemize}
...
\caption[g3ps]{\label{fig:orgc64a325}Glycerol-3-Phosphate Shuttle}
\end{figure}

\subsubsection{Electron Transferring Flavoprotein/ Dehydrogenase}
\label{sec:orga3e5e64}
\begin{itemize}
...
\caption[cIV]{\label{fig:orgd029989}Complex IV | Cytochrome C Oxidase}
\end{figure}
\end{itemize}

\subsubsection{Complex V}
\label{sec:org1c24603}
\begin{itemize}
...
\caption{\label{fig:orgc342f42}Complex V | ATP Synthase}
\end{figure}
\end{itemize}
\end{itemize}

\subsection{Clinical Presentation}
\label{sec:orgc200cea}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:orga347433})
\begin{enumerate}
...
\caption[ETC]{\label{fig:orga347433}Pathogenesis of OxPhos Disorders}
\end{figure}
...
\caption{\label{fig:orgeaf55b2}mtDNA Disorders}
\end{figure}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:org5dc6ee5})
...
\begin{table}[htbp]
\caption{\label{tab:org5dc6ee5}Clinical Features of Mitochondrial Disease}
\centering
\begin{tabular}{ll}
...
\label{sec:orge520ea8}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:orgd92904e}
\begin{itemize}
...
\label{sec:orgf953daa}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:org0fa30b1}
\begin{itemize}
...
\label{sec:orga3b46ce}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{oxphos/figures/algorithm_rot.png}
\caption{\label{fig:orga706da2}Diagnosis of Mitochondrial Disease}
\end{figure}


\subsubsection{Biochemistry}
\label{sec:orgae634a4}
\begin{itemize}
...
\label{sec:org402dbbd}
\begin{itemize}
\item CII is encoded by nuclear DNA (Table \ref{tab:orgbf056c6})
\begin{itemize}
...
\caption[rrf]{\label{fig:org857adec}Ragged Red Fibers - Gomori Stain}
\end{figure}

\subsubsection{Molecular}
\label{sec:org08eeec2}
\begin{itemize}
...
\label{sec:org1b2852a}
\subsection{Introduction}
\label{sec:org51954fd}
\begin{itemize}
...
\caption{\label{fig:org34891d0}Ketogenesis and Ketolysis}
\end{figure}
...
\subsubsection{Clinical Presentation}
\label{sec:org8fa496e}
\begin{table}[htbp]
\caption{\label{tab:orgb2f3574}Common Manifestations in Ketogenesis Defects}
\centering
\begin{tabular}{llllll}
FAOD & sudden & fasting & skeletal & cardio- & liver\\
 & death & intolerance & myopathy & myopathy & disease\\
...
\subsubsection{Diagnostic Tests}
\label{sec:orge064217}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org23e0cbd}
\begin{itemize}
...
\caption{\label{fig:org3159bf4}Metabolic Pathway of Creatine/Creatine Phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Slide16.png}
\caption{\label{fig:orgdfaee46}Metabolic Pathway of Creatine/Creatine Phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:orgfc94a6b}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org47e3575}Urine findings in CDS}
\centering
\begin{tabular}{lll}
