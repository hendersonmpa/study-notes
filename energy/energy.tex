...
\label{sec:orga9b7533}
\subsection{Cellular Redox State}
\label{sec:orgfefa4f5}
\begin{itemize}
...
\label{sec:org479da10}
\subsection{Introduction}
\label{sec:orga8df19e}
\begin{itemize}
...
\label{sec:orga97ff0d}
\begin{itemize}
\item involves three processes (Figure \ref{fig:org8d79dee})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:org62687a6})
\begin{itemize}
...
and the \(\beta\) carbon atoms by acyl-CoA dehydrogenase (Table \ref{tab:org38e5a84})
\begin{itemize}
...
\caption{\label{fig:org8d79dee}Fatty Acid Oxidation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/Slide12.png}
\caption{\label{fig:org8e7237d}Fatty Acid Oxidation and Ketone Body Metabolism}
\end{figure}
...
\caption{\label{fig:org62687a6}Fatty Acid \(\beta\)-Oxidation}
\end{figure}



\begin{table}[htbp]
\caption{\label{tab:org38e5a84}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\end{itemize}
\begin{itemize}
\item summarized in table \ref{tab:org071267f}
\end{itemize}
\begin{center}
...
\item Genetics
\label{sec:orgddd64ff}
\begin{itemize}
\item AR OCTN2
\end{itemize}
\item Diagnostic Tests
\label{sec:org767786d}
\begin{itemize}
...
\caption{\label{fig:orgd193f72}CPT1 (OMM) \& CPTII (IMM)}
\end{figure}

\item Genetics
\label{sec:org7084acb}
\begin{itemize}
\item AR CPT1A
...
\label{sec:org463d182}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd3fd16b}
\begin{itemize}
...
\caption{\label{fig:orgfd67ad0}Carnitine Acylcarnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org7432951}
\begin{itemize}
\item AR SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:org17ce282}
\begin{itemize}
...
\label{sec:org28d6502}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgaea6a7b}
\begin{enumerate}
\item Neonatal
\label{sec:org68a20e5}
\begin{itemize}
...
(Figure \ref{fig:orgd193f72})
\end{itemize}
\item Genetics
\label{sec:orgdc16df6}
\begin{itemize}
\item AR CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:orgc0f8a92}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:org7451050}
\subsubsection{Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency}
\label{sec:org4b3e311}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org207e794}
\begin{enumerate}
\item Infancy
\label{sec:org65d2fb0}
\begin{itemize}
...
steps in the \(\beta\)-oxidation of fatty acids (Table \ref{tab:org38e5a84})
...
\caption{\label{fig:org2725359}VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:org60b288f}
\begin{itemize}
\item AR ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org522c07d}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org0512bc5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9e7dd55}
\begin{itemize}
...
\item Genetics
\label{sec:orgf55ad39}
\begin{itemize}
\item AR HADHA, HADHB
\end{itemize}

\item Diagnostic Tests
\label{sec:orge96cc33}
\begin{itemize}
...
\label{sec:orgedd89a3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org75411fc}
\begin{itemize}
...
(Figure \ref{fig:orgb727d58})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{fao/figures/lchad.png}
\caption{\label{fig:orgb727d58}LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:org72b9aeb}
\begin{itemize}
\item AR HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:orgb366533}
\begin{itemize}
\item \(\uparrow\) lactate \(\because\) 3-OH-palmitoyl-CoA inhibits PDH
\item \(\uparrow\) hydroxy-acylcarnitines
\begin{itemize}
...
\label{sec:org05c2336}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org19a204f}
\begin{itemize}
...
\item Genetics
\label{sec:org171fc47}
\begin{itemize}
\item AR ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org1dae328}
\begin{itemize}
...
\caption{\label{fig:org580ffda}Multiple Acyl-CoA Dehydrogenase Deficiency}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/etf.png}
\caption{\label{fig:orgf4f35a8}Role of ETF and ETF-QO}
\end{figure}

\item Genetics
\label{sec:org73e9c54}
\begin{itemize}
\item AR ETFA, ETFB, ETFDH
\end{itemize}

\item Diagnostic Tests
\label{sec:orgc2721e3}
\begin{itemize}
\item plasma acylcarnitines
\begin{itemize}
\item \(\uparrow\) C4-C18
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org039295c}
\subsection{Introduction}
\label{sec:orgf55302b}
\begin{itemize}
...
\caption[TCA]{\label{fig:org49db0e9}Disorders of Pyruvate Metabolism}
\end{figure}
...
\caption[TCA]{\label{fig:orgd24e3ad}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Reactions involving Pyruvate}
\label{sec:orgcf35d40}
...
\begin{table}[htbp]
\caption{\label{tab:org3840103}Pyruvate Dehydrogenases Complex}
\centering
\begin{tabular}{llll}
...
\caption[pdhe1]{\label{fig:orga26b305}Activation/deactivation of PDH E1}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{pyruvate/figures/pdhc.png}
\caption[pdhc]{\label{fig:orgd6494b2}Pyruvate Dehydrogenase Complex}
\end{figure}
...
dephosphorylated (active) (Figure \ref{fig:orga26b305})
\end{itemize}

\subsubsection{Pyruvate Transport Defect}
\label{sec:org45ac5a6}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org9e9f177}
\begin{itemize}
\item AR DLD
\end{itemize}
\subsubsection{Diagnostic Testing}
\label{sec:org8ec0d61}
\begin{itemize}
...
\label{sec:org8df49b9}
\subsection{Introduction}
\label{sec:orged7c752}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgc30ccd3}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Disorders of the TCA cycle}
\label{sec:org09ab027}
...
\begin{table}[htbp]
\caption{\label{tab:org96014e3}\(\alpha\)-Ketoglutarate Dehydrogenase Complex}
\centering
\begin{tabular}{llll}
Unit & Name & Gene & Cofactor\\
\hline
...
\subsubsection{Clinical Presentation}
\label{sec:org5c134ca}
\begin{itemize}
\item similar to PDHC (section \ref{sec:orgd7f9691})
...
\subsubsection{Genetics}
\label{sec:org84c2c26}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org4c363f5}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgcbef475}
\begin{itemize}
\item none
\end{itemize}
\subsection{Succinate Dehydrogenase Deficiency}
\label{sec:org7c49a00}
\begin{itemize}
\item four subunits compose Complex II of the mitochondrial respiratory
chain (Table \ref{tab:orge70ae37})
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orge70ae37}Succinate Dehydrogenase | Complex II}
\centering
\begin{tabular}{ll}
Subunit & Description\\
\hline
...
\caption{\label{fig:org0c66c47}Succinate Dehydrogenase | Complex II}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:org8c3aeaf}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgde7ad44}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:org737a278})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org737a278}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\label{sec:orga2cd116}
\subsection{Introduction}
\label{sec:org9f50096}
\begin{itemize}
...
series of electron carriers (Figures \ref{fig:orge912727} and \ref{fig:org60706ce})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:org25529b6})
...
\caption{\label{fig:orge912727}Flow of Electrons in the ETC}
\end{figure}
...
\item ETF-QO and mitochondrial glycerol-3-P dehydrogenase (GPD) are part of ETC (Figure \ref{fig:orge912727})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org25529b6}Location of DNA Encoding OxPhos Complex Subunits}
\centering
...
\caption[ETC]{\label{fig:org60706ce}Oxidative Phosphorylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{oxphos/figures/potential.png}
\caption[redox]{\label{fig:org595e80e}Electron Flow to O\textsubscript{2} and Release of Free Energy}
\end{figure}

\subsubsection{Complex I}
\label{sec:org2710795}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:org8b85711})
...
\caption[c1]{\label{fig:org8b85711}Complex I | NADH-Ubiquinone Oxidoreductase}
\end{figure}

\subsubsection{Complex II}
\label{sec:org9241bc5}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org7c49a00}
\end{itemize}
\end{itemize}

\subsubsection{Glycerol-3-Phosphate Shuttle}
\label{sec:org63c0f45}
\begin{itemize}
...
\caption[g3ps]{\label{fig:org826b882}Glycerol-3-Phosphate Shuttle}
\end{figure}

\subsubsection{Electron Transferring Flavoprotein/ Dehydrogenase}
\label{sec:org064e67a}
\begin{itemize}
...
\caption[cIV]{\label{fig:org832272b}Complex IV | Cytochrome C Oxidase}
\end{figure}
\end{itemize}

\subsubsection{Complex V}
\label{sec:org271aab9}
\begin{itemize}
...
\caption{\label{fig:org78e4876}Complex V | ATP Synthase}
\end{figure}
\end{itemize}
\end{itemize}

\subsection{Clinical Presentation}
\label{sec:orgcab3f18}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:org6f46cb0})
\begin{enumerate}
...
\caption[ETC]{\label{fig:org6f46cb0}Pathogenesis of OxPhos Disorders}
\end{figure}
...
\caption{\label{fig:org87588b4}mtDNA Disorders}
\end{figure}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:org5f4bdf4})
...
\begin{table}[htbp]
\caption{\label{tab:org5f4bdf4}Clinical Features of Mitochondrial Disease}
\centering
\begin{tabular}{ll}
...
\label{sec:orge8f00ff}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:org7ec88b4}
\begin{itemize}
...
\label{sec:orgbae9f23}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:org96e9d63}
\begin{itemize}
...
\label{sec:org4f3e6b8}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{oxphos/figures/algorithm_rot.png}
\caption{\label{fig:org67f41bc}Diagnosis of Mitochondrial Disease}
\end{figure}


\subsubsection{Biochemistry}
\label{sec:org5b1619b}
\begin{itemize}
...
\label{sec:org9698228}
\begin{itemize}
\item CII is encoded by nuclear DNA (Table \ref{tab:org25529b6})
\begin{itemize}
...
\caption[rrf]{\label{fig:org2050771}Ragged Red Fibers - Gomori Stain}
\end{figure}

\subsubsection{Molecular}
\label{sec:org59cd94f}
\begin{itemize}
...
\label{sec:org00fe14a}
\subsection{Introduction}
\label{sec:orgfa0b057}
\begin{itemize}
...
\caption{\label{fig:org44f97e7}Ketogenesis and Ketolysis}
\end{figure}
...
\subsubsection{Clinical Presentation}
\label{sec:org1788621}
\begin{table}[htbp]
\caption{\label{tab:org071267f}Common Manifestations in Ketogenesis Defects}
\centering
\begin{tabular}{llllll}
FAOD & sudden & fasting & skeletal & cardio- & liver\\
 & death & intolerance & myopathy & myopathy & disease\\
...
\subsubsection{Diagnostic Tests}
\label{sec:org44f5154}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:orga29fb56}
\begin{itemize}
...
\caption{\label{fig:org7b3e885}Metabolic Pathway of Creatine/Creatine Phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Slide16.png}
\caption{\label{fig:org2bea583}Metabolic Pathway of Creatine/Creatine Phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org8a5b3eb}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgfb117fa}Urine findings in CDS}
\centering
\begin{tabular}{lll}
