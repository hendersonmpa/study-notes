...
\label{sec:orgdd9349f}
\subsection{Cellular RedOx State}
\label{sec:org64a77d3}
\begin{itemize}
...
\label{sec:org4462514}
\subsection{Introduction}
\label{sec:org266d866}
\begin{itemize}
...
\label{sec:org0aa7217}

\begin{itemize}
\item involves three processes (Figure \ref{fig:orgc50a674})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:org34ffbbb})
\begin{itemize}
...
\caption{\label{fig:org8ea7e73}
CPT1}
\end{figure}

\item Genetics
\label{sec:org266980b}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:org00c2a8a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org59e27eb}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:orga1ab4d9}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:orgdbe5be4})
...
\caption{\label{fig:orgdbe5be4}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org12d5710}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:org32d3004}
\begin{itemize}
...
\label{sec:org6326103}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgca4686e}
\begin{enumerate}
\item Neonatal
\label{sec:org333e306}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:org8ea7e73})
\end{itemize}
\item Genetics
\label{sec:org61c8c94}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org0434bf2}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:orgb4306ce}
\begin{enumerate}
\item Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency
\label{sec:orgfb06dcf}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org85485fc}
\begin{enumerate}
\item Infancy
\label{sec:orgcdc6684}
\begin{itemize}
...
\caption{\label{fig:orgad9080f}
VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:orga6d53a8}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org89ba552}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:orgf81ae99}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org11d7b81}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org43b760f}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:org9b1626b}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:org02e45a0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5ed2fef}
\begin{itemize}
...
(Figure \ref{fig:org44ff2de})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fao/figures/lchad.png}
\caption{\label{fig:org44ff2de}
LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:org5870e8b}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:orgad76534}
\begin{itemize}
...
\label{sec:org8b6bdd3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf7f1a54}
\begin{itemize}
...
\item Genetics
\label{sec:org0a5aaff}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org60ecfd2}
\begin{itemize}
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org23e0c8c}
\subsection{Introduction}
\label{sec:orgfd19379}
\begin{itemize}
...
\caption[TCA]{\label{fig:org4701bf7}
...
\caption[pdhe1]{\label{fig:org0eec57c}
...
\caption[pdhc]{\label{fig:orgaf2c8ba}
...
dephosphorylated (active) (Figure \ref{fig:org0eec57c})
\end{itemize}

\item Pyruvate Transport Defect
\label{sec:orgb1ef961}
\begin{itemize}
...
\label{sec:orgb615c78}
\subsection{Introduction}
\label{sec:org60b4086}
\begin{itemize}
...
\caption[TCA]{\label{fig:org32f4b71}
Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\begin{enumerate}
\item Disorders of the TCA cycle
\label{sec:orgd6499cd}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc5dbebc}
\begin{itemize}
\item similar to PDHC (section \ref{sec:orgdac88ce})
...
\item Genetics
\label{sec:org6fc9cbb}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\item Diagnostic Tests
\label{sec:org0199ca8}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\caption{\label{fig:orgebaa97e}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf2720b6}
\begin{itemize}
...
\caption{\label{fig:orgd08ad29}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org6c8a8c6}
\begin{itemize}
...
\label{sec:org68b33a3}
\subsection{Introduction}
\label{sec:orge024383}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:org74bf665})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of Complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:org46a160a})
...
\caption[ETC]{\label{fig:org74bf665}
...
\caption[redox]{\label{fig:org785409a}
Electron flow to O\(_{\text{2}}\) and release free energy}
\end{figure}

\begin{enumerate}
\item Complex I
\label{sec:org5bc48b6}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:org54b80ff})
...
\caption[c1]{\label{fig:org54b80ff}
Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\item Complex II
\label{sec:org58dcebb}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org72241b2}
\end{itemize}
\end{itemize}

\item Glycerol-3-phosphate shuttle
\label{sec:org502e9e1}
\begin{itemize}
...
\caption[cIV]{\label{fig:org630cf67}
Complex IV | Cytochrome c oxidase}
\end{figure}
\end{itemize}

\item Complex V
\label{sec:org18faa58}
\begin{itemize}
...
\label{sec:orge5fafd8}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:orgac38c07})
\begin{enumerate}
...
\caption[ETC]{\label{fig:orgac38c07}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:orga2318a5})
...
\label{sec:orgee784fe}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:orgf3ee536}
\begin{itemize}
...
\label{sec:org498309a}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:org0f0e79d}
\begin{itemize}
...
\label{sec:orge9505bb}
\begin{itemize}
\item CII is encoded my nuclear DNA (Table \ref{tab:org46a160a})
\begin{itemize}
...
\caption[rrf]{\label{fig:org8ff2f75}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:org1ded166}
\begin{itemize}
...
\label{sec:orgf279b69}
\subsection{Introduction}
\label{sec:org4cf50e2}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6a03a5c}
\begin{enumerate}
\item HMG-CoA Synthase Deficiency
\label{sec:orgc05dc7d}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:orgf8e0aca}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org8a79266}
\begin{itemize}
...
\end{enumerate}
\section{Creatine}
\label{sec:orgd5cb7c4}
\subsection{Introduction}
\label{sec:orge2fa21b}
\begin{itemize}
...
\caption{\label{fig:org947e7b1}
Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org85a6671}
\begin{itemize}
