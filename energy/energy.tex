...
\label{sec:orga1a4a63}
\subsection{Cellular Redox State}
\label{sec:org03fd570}
\begin{itemize}
...
\label{sec:orgcda8a15}
\subsection{Introduction}
\label{sec:org13c3520}
\begin{itemize}
...
\label{sec:orgea7d76e}
\begin{itemize}
\item involves three processes (Figure \ref{fig:orgac196fd})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:org2bf9080})
\begin{itemize}
...
and the \(\beta\) carbon atoms by acyl-CoA dehydrogenase (Table \ref{tab:org41e7c6c})
\begin{itemize}
...
\caption{\label{fig:orgac196fd}Fatty Acid \(\beta\)-Oxidation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/Slide12.png}
\caption{\label{fig:org4803048}Fatty Acid \(\beta\)-Oxidation and Ketone Body Metabolism}
\end{figure}
...
\caption{\label{fig:org2bf9080}Fatty Acid \(\beta\)-Oxidation}
\end{figure}



\begin{table}[htbp]
\caption{\label{tab:org41e7c6c}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\end{itemize}
\begin{itemize}
\item summarized in table \ref{tab:org84de874}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org84de874}Common Manifestations in FAODs}
\centering
...
\item Genetics
\label{sec:org3dd411c}
\begin{itemize}
\item AR OCTN2
\end{itemize}
\item Diagnostic Tests
\label{sec:org57574c8}
\begin{itemize}
...
\caption{\label{fig:org3db12a6}CPT1 (OMM) \& CPTII (IMM)}
\end{figure}

\item Genetics
\label{sec:org918b7c9}
\begin{itemize}
\item AR CPT1A
...
\label{sec:org8f8dc12}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga8f98e7}
\begin{itemize}
...
\caption{\label{fig:orgaab6e14}Carnitine Acylcarnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org444d972}
\begin{itemize}
\item AR SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:orgf87a2b3}
\begin{itemize}
...
\label{sec:org4ee78e1}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org05f96d1}
\begin{enumerate}
\item Neonatal
\label{sec:org0833754}
\begin{itemize}
...
(Figure \ref{fig:org3db12a6})
\end{itemize}
\item Genetics
\label{sec:org6181599}
\begin{itemize}
\item AR CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:orga8f469a}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:org2e886c9}
\subsubsection{Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency}
\label{sec:org3f3f201}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgaaa5d1b}
\begin{enumerate}
\item Infancy
\label{sec:org768ce1f}
\begin{itemize}
...
steps in the \(\beta\)-oxidation of fatty acids (Table \ref{tab:org41e7c6c})
...
\caption{\label{fig:org456907e}VLCAD Reaction}
\end{figure}

\item Genetics
\label{sec:org6c2e5da}
\begin{itemize}
\item AR ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org1c06d14}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org1ce8aee}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb0757da}
\begin{itemize}
...
\item Genetics
\label{sec:org01618f0}
\begin{itemize}
\item AR HADHA, HADHB
\end{itemize}

\item Diagnostic Tests
\label{sec:org3371170}
\begin{itemize}
...
\label{sec:org7aee1b6}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org37f5f26}
\begin{itemize}
...
(Figure \ref{fig:org6b9dac0})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{fao/figures/lchad.png}
\caption{\label{fig:org6b9dac0}LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:org1f6420c}
\begin{itemize}
\item AR HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:org5173084}
\begin{itemize}
\item \(\uparrow\) lactate \(\because\) 3-OH-palmitoyl-CoA inhibits PDH
\item \(\uparrow\) hydroxy-acylcarnitines
\begin{itemize}
...
\label{sec:org35b68eb}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6c145d4}
\begin{itemize}
...
\item Genetics
\label{sec:org26723b8}
\begin{itemize}
\item AR ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org541204c}
\begin{itemize}
...
\caption{\label{fig:orgfed3dbd}Multiple Acyl-CoA Dehydrogenase Deficiency}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/etf.png}
\caption{\label{fig:org810a7f0}Role of ETF and ETF-QO}
\end{figure}

\item Genetics
\label{sec:orga55b928}
\begin{itemize}
\item AR ETFA, ETFB, ETFDH
\end{itemize}

\item Diagnostic Tests
\label{sec:org6ef412f}
\begin{itemize}
\item plasma acylcarnitines
\begin{itemize}
\item \(\uparrow\) C4-C18
...
\end{enumerate}
\section{Pyruvate}
\label{sec:orgfaca6fc}
\subsection{Introduction}
\label{sec:orgea53fe4}
\begin{itemize}
...
\caption[TCA]{\label{fig:org0ed8e2c}Disorders of Pyruvate Metabolism}
\end{figure}
...
\caption[TCA]{\label{fig:org00120b4}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Reactions involving Pyruvate}
\label{sec:org5fbdfe5}
...
\begin{table}[htbp]
\caption{\label{tab:orgf3b78da}Pyruvate Dehydrogenases Complex}
\centering
\begin{tabular}{llll}
...
\caption[pdhe1]{\label{fig:org27cc0b0}Activation/Deactivation of PDH E1}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{pyruvate/figures/pdhc.png}
\caption[pdhc]{\label{fig:orgd6935b6}Pyruvate Dehydrogenase Complex}
\end{figure}
...
dephosphorylated (active) (Figure \ref{fig:org27cc0b0})
\end{itemize}

\subsubsection{Pyruvate Transport Defect}
\label{sec:org0b24f9a}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org1341802}
\begin{itemize}
\item AR DLD
\end{itemize}
\subsubsection{Diagnostic Testing}
\label{sec:org4b84d9b}
\begin{itemize}
...
\label{sec:org3222904}
\subsection{Introduction}
\label{sec:org031fd4b}
\begin{itemize}
...
\caption[TCA]{\label{fig:org54dae58}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Disorders of the TCA cycle}
\label{sec:org37b6fd5}
...
\begin{table}[htbp]
\caption{\label{tab:orgd79ee01}\(\alpha\)-Ketoglutarate Dehydrogenase Complex}
\centering
\begin{tabular}{llll}
Unit & Name & Gene & Cofactor\\
\hline
...
\subsubsection{Clinical Presentation}
\label{sec:orgf5b4e09}
\begin{itemize}
\item similar to PDHC (section \ref{sec:org4d80dba})
...
\subsubsection{Genetics}
\label{sec:org77f0430}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org349c4fb}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:orgfef2e3a}
\begin{itemize}
\item none
\end{itemize}
\subsection{Succinate Dehydrogenase Deficiency}
\label{sec:orgf736e11}
\begin{itemize}
\item four subunits compose Complex II of the mitochondrial respiratory
chain (Table \ref{tab:org01fae64})
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org01fae64}Succinate Dehydrogenase | Complex II}
\centering
\begin{tabular}{ll}
Subunit & Description\\
\hline
...
\caption{\label{fig:org4e3d5d6}Succinate Dehydrogenase | Complex II}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:org663b85e}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org61315b4}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:orgfcbe06e})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgfcbe06e}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\label{sec:orga779f1f}
\subsection{Introduction}
\label{sec:orgc9e9319}
\begin{itemize}
...
series of electron carriers (Figures \ref{fig:org4cb0540} and \ref{fig:org950555e})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:orga491b9c})
...
\caption{\label{fig:org4cb0540}Flow of Electrons in the ETC}
\end{figure}
...
\item ETF-QO and mitochondrial glycerol-3-P dehydrogenase (GPD) are part of ETC (Figure \ref{fig:org4cb0540})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orga491b9c}Location of DNA Encoding OxPhos Complex Subunits}
\centering
...
\caption[ETC]{\label{fig:org950555e}Oxidative Phosphorylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{oxphos/figures/potential.png}
\caption[redox]{\label{fig:orgffbea58}Electron Flow to O\textsubscript{2} and Release of Free Energy}
\end{figure}

\subsubsection{Complex I}
\label{sec:org13c67d7}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:org07b42bd})
...
\caption[c1]{\label{fig:org07b42bd}Complex I | NADH-Ubiquinone Oxidoreductase}
\end{figure}

\subsubsection{Complex II}
\label{sec:orgbe8162d}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:orgf736e11}
\end{itemize}
\end{itemize}

\subsubsection{Glycerol-3-Phosphate Shuttle}
\label{sec:org9482701}
\begin{itemize}
...
\caption[g3ps]{\label{fig:org15a7330}Glycerol-3-Phosphate Shuttle}
\end{figure}

\subsubsection{Electron Transferring Flavoprotein/ Dehydrogenase}
\label{sec:orgdf50307}
\begin{itemize}
...
\caption[cIV]{\label{fig:org95bc8b7}Complex IV | Cytochrome C Oxidase}
\end{figure}
\end{itemize}

\subsubsection{Complex V}
\label{sec:org7262f58}
\begin{itemize}
...
\caption{\label{fig:org79e634e}Complex V | ATP Synthase}
\end{figure}
\end{itemize}
\end{itemize}

\subsection{Clinical Presentation}
\label{sec:org3b33ac1}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:org7581f2e})
\begin{enumerate}
...
\caption[ETC]{\label{fig:org7581f2e}Pathogenesis of OxPhos Disorders}
\end{figure}
...
\caption{\label{fig:org0f24f65}mtDNA Disorders}
\end{figure}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:org075fcc4})
...
\begin{table}[htbp]
\caption{\label{tab:org075fcc4}Clinical Features of Mitochondrial Disease}
\centering
\begin{tabular}{ll}
...
\label{sec:org890be2f}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:org301985e}
\begin{itemize}
...
\label{sec:orgf81352c}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:org4f4b15a}
\begin{itemize}
...
\label{sec:orga19a2c3}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{oxphos/figures/algorithm_rot.png}
\caption{\label{fig:org394eeb6}Diagnosis of Mitochondrial Disease}
\end{figure}


\subsubsection{Biochemistry}
\label{sec:org8952208}
\begin{itemize}
...
\label{sec:org7063bd7}
\begin{itemize}
\item CII is encoded by nuclear DNA (Table \ref{tab:orga491b9c})
\begin{itemize}
...
\caption[rrf]{\label{fig:org3753e5a}Ragged Red Fibers - Gomori Stain}
\end{figure}

\subsubsection{Molecular}
\label{sec:org6f3cca2}
\begin{itemize}
...
\label{sec:org04c0469}
\subsection{Introduction}
\label{sec:org19bf90a}
\begin{itemize}
...
\caption{\label{fig:org07ea24c}Ketogenesis and Ketolysis}
\end{figure}
...
\subsubsection{Clinical Presentation}
\label{sec:orgf22732b}
\begin{table}[htbp]
\caption{\label{tab:orgade0d34}Common Manifestations in Ketogenesis Defects}
\centering
\begin{tabular}{llllll}
FAOD & sudden & fasting & skeletal & cardio- & liver\\
 & death & intolerance & myopathy & myopathy & disease\\
...
\subsubsection{Diagnostic Tests}
\label{sec:orgbd52876}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:orgad038d0}
\begin{itemize}
...
\caption{\label{fig:orgf4fee7b}Metabolic Pathway of Creatine/Creatine Phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Slide16.png}
\caption{\label{fig:org24afa0e}Metabolic Pathway of Creatine/Creatine Phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org97d1ab9}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org5677c55}Urine Findings in CDS}
\centering
\begin{tabular}{lll}
