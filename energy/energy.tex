...
\label{sec:org8e4cfef}
\subsection{Cellular Redox State}
\label{sec:orgbb6a453}
\begin{itemize}
...
\label{sec:orgf89508d}
\subsection{Introduction}
\label{sec:orge0d4586}
\begin{itemize}
...
\caption{\label{fig:org342717b}Fatty Acid \(\beta\)-Oxidation}
\end{figure}



\begin{table}[htbp]
\caption{\label{tab:org65b03a3}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\item Genetics
\label{sec:org0eeb887}
\begin{itemize}
\item AR OCTN2
\end{itemize}
\item Diagnostic Tests
\label{sec:org661fbf5}
\begin{itemize}
...
\caption{\label{fig:orgf9f85b8}CPT1 (OMM) \& CPTII (IMM)}
\end{figure}

\item Genetics
\label{sec:org53e7feb}
\begin{itemize}
\item AR CPT1A
...
\caption{\label{fig:orgefacc1f}Carnitine Acylcarnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org65fe253}
\begin{itemize}
\item AR SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:org2b6546b}
\begin{itemize}
...
\label{sec:orgad4086c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org38e234e}
\begin{enumerate}
\item Neonatal
\label{sec:orga597dc5}
\begin{itemize}
...
\item Genetics
\label{sec:org03359b6}
\begin{itemize}
\item AR ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org934501d}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:orgcd467d7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgfc3ea81}
\begin{itemize}
...
(Figure \ref{fig:orgdf0122b})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{fao/figures/lchad.png}
\caption{\label{fig:orgdf0122b}LCHAD reaction}
\end{figure}
...
\caption{\label{fig:org833c27f}Multiple Acyl-CoA Dehydrogenase Deficiency}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/etf.png}
\caption{\label{fig:orgfc7703b}Role of ETF and ETF-QO}
\end{figure}

\item Genetics
\label{sec:org136f5a2}
\begin{itemize}
\item AR ETFA, ETFB, ETFDH
\end{itemize}

\item Diagnostic Tests
\label{sec:org6fc0eda}
\begin{itemize}
\item plasma acylcarnitines
\begin{itemize}
\item \(\uparrow\) C4-C18
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org0f401cd}
\subsection{Introduction}
\label{sec:orge917c73}
\begin{itemize}
...
\caption[TCA]{\label{fig:org7be865d}Disorders of Pyruvate Metabolism}
\end{figure}
...
\caption[TCA]{\label{fig:org605547a}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Reactions involving Pyruvate}
\label{sec:orgc90ba09}
...
\caption[pdhc]{\label{fig:org58162a0}Pyruvate Dehydrogenase Complex}
\end{figure}
...
\label{sec:orge02dd6c}
\subsection{Introduction}
\label{sec:org7c6225c}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgfbb7e68}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Disorders of the TCA cycle}
\label{sec:orgfdff479}
...
\begin{table}[htbp]
\caption{\label{tab:orgc76dfe5}Succinate Dehydrogenase | Complex II}
\centering
\begin{tabular}{ll}
Subunit & Description\\
\hline
...
\caption{\label{fig:org55cc129}Succinate Dehydrogenase | Complex II}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:org5b232c0}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgdebfaf2}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:org2224c8b})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org2224c8b}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\subsubsection{Diagnostic Tests}
\label{sec:org0810bb8}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:orgb5ceadb}
\begin{itemize}
