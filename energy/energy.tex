...
\label{sec:orge8eabc1}
\subsection{Cellular RedOx State}
\label{sec:orgde0977e}
\begin{itemize}
...
\label{sec:org9d83b4e}
\subsection{Introduction}
\label{sec:org0a4f55e}
\begin{itemize}
...
\label{sec:org16315de}

\begin{itemize}
\item involves three processes (Figure \ref{fig:orgdf229dd})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:orgc76bea8})
\begin{itemize}
...
\caption{\label{fig:org4b115da}
CPT1}
\end{figure}

\item Genetics
\label{sec:org349c914}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:orgc98e3ad}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge15d93e}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org315f6c2}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:orga2c047f})
...
\caption{\label{fig:orga2c047f}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org0b065aa}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:org9389fd9}
\begin{itemize}
...
\label{sec:org370c81f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org46ecd75}
\begin{enumerate}
\item Neonatal
\label{sec:org795c3d2}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:org4b115da})
\end{itemize}
\item Genetics
\label{sec:org575eee9}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org73dc43d}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:org0cdfdf4}
\begin{enumerate}
\item Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency
\label{sec:org2aca95d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgfa58977}
\begin{enumerate}
\item Infancy
\label{sec:org046e2e8}
\begin{itemize}
...
\caption{\label{fig:orga760277}
VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:orgca43037}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org9e68a5a}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org348f13a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf0e789c}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org502f660}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:org292dada}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:org05ff5fd}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org7c3c223}
\begin{itemize}
...
(Figure \ref{fig:orgcef25ff})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fao/figures/lchad.png}
\caption{\label{fig:orgcef25ff}
LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:orgeaa3e2f}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:org004b7df}
\begin{itemize}
...
\label{sec:orga76fd10}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga80a97f}
\begin{itemize}
...
\item Genetics
\label{sec:org7b77cf0}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org0140cc8}
\begin{itemize}
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org92dd506}
\subsection{Introduction}
\label{sec:org8729c85}
\begin{itemize}
...
\caption[TCA]{\label{fig:orga58156a}
...
\caption[pdhe1]{\label{fig:org2e0fd53}
...
\caption[pdhc]{\label{fig:org328f0f7}
...
dephosphorylated (active) (Figure \ref{fig:org2e0fd53})
\end{itemize}

\item Pyruvate Transport Defect
\label{sec:org4284779}
\begin{itemize}
...
\label{sec:org18d23fa}
\subsection{Introduction}
\label{sec:org38cd5f3}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgeaee9ff}
Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\begin{enumerate}
\item Disorders of the TCA cycle
\label{sec:org41ce711}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgba38058}
\begin{itemize}
\item similar to PDHC (section \ref{sec:org5102d35})
...
\item Genetics
\label{sec:org1a84224}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd395333}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\caption{\label{fig:org79c3100}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org0c23892}
\begin{itemize}
...
\caption{\label{fig:org8d18122}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org1dbf172}
\begin{itemize}
...
\label{sec:org2bcad1b}
\subsection{Introduction}
\label{sec:org25de096}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:orga595bb5})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of Complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:orgc1e090a})
...
\caption[ETC]{\label{fig:orga595bb5}
...
\caption[redox]{\label{fig:org21188ba}
Electron flow to O\(_{\text{2}}\) and release free energy}
\end{figure}

\begin{enumerate}
\item Complex I
\label{sec:org0238d4d}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:org5684da5})
...
\caption[c1]{\label{fig:org5684da5}
Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\item Complex II
\label{sec:org06fa2e1}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:orga2454f0}
\end{itemize}
\end{itemize}

\item Glycerol-3-phosphate shuttle
\label{sec:org6181f82}
\begin{itemize}
...
\caption[cIV]{\label{fig:org1d50d47}
Complex IV | Cytochrome c oxidase}
\end{figure}
\end{itemize}

\item Complex V
\label{sec:orgf97b739}
\begin{itemize}
...
\label{sec:org8a513e4}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:orgb970e80})
\begin{enumerate}
...
\caption[ETC]{\label{fig:orgb970e80}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:org07e18a2})
...
\label{sec:orgecaf108}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:org2f80839}
\begin{itemize}
...
\label{sec:org4066179}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:org8933709}
\begin{itemize}
...
\label{sec:org2374a06}
\begin{itemize}
\item CII is encoded my nuclear DNA (Table \ref{tab:orgc1e090a})
\begin{itemize}
...
\caption[rrf]{\label{fig:orge810f64}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:orgd354c3c}
\begin{itemize}
...
\label{sec:org498f849}
\subsection{Introduction}
\label{sec:org9b37f31}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgfeb7e09}
\begin{enumerate}
\item HMG-CoA Synthase Deficiency
\label{sec:org93c2eb9}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org2488787}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:orgfd00763}
\begin{itemize}
...
\end{enumerate}
\section{Creatine}
\label{sec:org5298bd7}
\subsection{Introduction}
\label{sec:org6e6edcf}
\begin{itemize}
...
\caption{\label{fig:orgae79591}
Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org7357e28}
\begin{itemize}
