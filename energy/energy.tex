...
\label{sec:org31c97de}
\subsection{Cellular Redox State}
\label{sec:orgc0774a0}
\begin{itemize}
...
\label{sec:org4380479}
\subsection{Introduction}
\label{sec:org3ed34f0}
\begin{itemize}
...
\label{sec:org540feef}
\begin{itemize}
\item involves three processes (Figure \ref{fig:org6f7d5ed})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:orgb25d556})
\begin{itemize}
...
\caption{\label{fig:org6f7d5ed}Fatty Acid Oxidation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/Slide12.png}
\caption{\label{fig:org522ff14}Fatty Acid Oxidation and Ketone Body Metabolism}
\end{figure}
...
\caption{\label{fig:orgb25d556}Fatty Acid \(\beta\)-Oxidation}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org4b79295}Acyl-CoA Synthetases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\begin{table}[htbp]
\caption{\label{tab:org1e7455a}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
Enzyme & Length & location\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org4d9d000}Other: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\begin{table}[htbp]
\caption{\label{tab:org49e63dc}Common manifestations in FAODs}
\centering
...
\caption{\label{fig:orgc0b9dc3}CPT1 (OMM) \& CPTII (IMM)}
\end{figure}

\item Genetics
\label{sec:org4e346b2}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:org166b047}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org68791b5}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org538f1d4}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:orgd3330d9})
\begin{itemize}
...
\caption{\label{fig:orgd3330d9}Carnitine Acylcarnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org59a7a5b}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:org3e20403}
\begin{itemize}
...
\label{sec:org2fd81de}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga29e20d}
\begin{enumerate}
\item Neonatal
\label{sec:org38b48ca}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:orgc0b9dc3})
\end{itemize}
\item Genetics
\label{sec:orgb182c9c}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org6f5add6}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:orgc7e78e7}
\subsubsection{Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency}
\label{sec:orgbce6217}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3917b44}
\begin{enumerate}
\item Infancy
\label{sec:org6d4c951}
\begin{itemize}
...
\caption{\label{fig:orgb16b1c3}VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:org51360b5}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org528a75d}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org6e2e4de}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd6829f7}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:orgcd99c08}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:org8e5efb7}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:org8a4c176}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org535436e}
\begin{itemize}
...
(Figure \ref{fig:orgbe8223c})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{fao/figures/lchad.png}
\caption{\label{fig:orgbe8223c}LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:orga49aaf4}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:org24a7bd6}
\begin{itemize}
...
\label{sec:org6e2ea08}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd7f7d5f}
\begin{itemize}
...
\item Genetics
\label{sec:orga6415c4}
\begin{itemize}
\item AR ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org708c76e}
\begin{itemize}
...
\caption{\label{fig:org2a73979}Multiple Acyl-CoA Dehydrogenase Deficiency}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/etf.png}
\caption{\label{fig:org69e1587}Role of ETF and ETF-QO}
\end{figure}

\item Genetics
\label{sec:orgc656103}
\begin{itemize}
\item AR ETFA, ETFB, ETFDH
\end{itemize}

\item Diagnostic Tests
\label{sec:org25be81b}
\begin{itemize}
\item plasma acylcarnitines
\begin{itemize}
\item \(\uparrow\) C4-C18
...
\end{enumerate}
\section{Pyruvate}
\label{sec:orgb6e8597}
\subsection{Introduction}
\label{sec:org29b5619}
\begin{itemize}
...
\caption[TCA]{\label{fig:orga705576}Disorders of Pyruvate Metabolism}
\end{figure}
...
\caption[TCA]{\label{fig:org1d8566f}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Reactions involving Pyruvate}
\label{sec:org196450e}
...
\begin{table}[htbp]
\caption{\label{tab:orgc6fd8d0}Pyruvate Dehydrogenases Complex}
\centering
\begin{tabular}{llll}
...
\caption[pdhe1]{\label{fig:orgce0cbde}Activation/deactivation of PDHE1}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{pyruvate/figures/pdhc.png}
\caption[pdhc]{\label{fig:orgbc01cda}Pyruvate Dehydrogenase Complex}
\end{figure}
...
dephosphorylated (active) (Figure \ref{fig:orgce0cbde})
\end{itemize}

\subsubsection{Pyruvate Transport Defect}
\label{sec:org54bc24c}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org73e38b5}
\begin{itemize}
\item AR DLD
\end{itemize}
\subsubsection{Diagnostic Testing}
\label{sec:org123ae55}
\begin{itemize}
\item combined PDHC, TCA, BCAA defect
\begin{itemize}
...
\label{sec:orgf7a99e7}
\subsection{Introduction}
\label{sec:orgb36d926}
\begin{itemize}
...
\caption[TCA]{\label{fig:org6c6f2ba}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Disorders of the TCA cycle}
\label{sec:org1da2aaf}
...
\begin{table}[htbp]
\caption{\label{tab:org73b53e7}\(\alpha\)-Ketoglutarate Dehydrogenase Complex}
\centering
\begin{tabular}{llll}
Unit & Name & Gene & Cofactor\\
\hline
...
\subsubsection{Clinical Presentation}
\label{sec:orge2da2db}
\begin{itemize}
\item similar to PDHC (section \ref{sec:org595de8f})
...
\subsubsection{Genetics}
\label{sec:org88e9b68}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:orgec1d8f0}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\caption{\label{fig:org81d5c33}Succinate Dehydrogenase | Complex II}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:org8fc9238}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org4c0c40d}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:orgf4b2dec})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgf4b2dec}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\label{sec:org5175e94}
\subsection{Introduction}
\label{sec:org3a7745d}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:orgc10fba2} and \ref{fig:orgde3079a})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of Complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:org08456a1})
...
\caption{\label{fig:orgc10fba2}Flow of electrons in the ETC}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:org08456a1}Location of DNA encoding OxPhos Complex Subunits}
\centering
...
\caption[ETC]{\label{fig:orgde3079a}Oxidative Phosphorylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{oxphos/figures/potential.png}
\caption[redox]{\label{fig:org1687d10}Electron flow to O\textsubscript{2} and release free energy}
\end{figure}

\subsubsection{Complex I}
\label{sec:org6298504}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:org9b8cf3f})
...
\caption[c1]{\label{fig:org9b8cf3f}Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\subsubsection{Complex II}
\label{sec:org2decad6}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org1170cc0}
\end{itemize}
\end{itemize}

\subsubsection{Glycerol-3-phosphate shuttle}
\label{sec:org2ac1180}
\begin{itemize}
...
\caption[g3ps]{\label{fig:org6a89351}Glycerol-3-phosphate shuttle}
\end{figure}

\subsubsection{Electron Transferring Flavoprotein/ Dehydrogenase}
\label{sec:orga870810}
\begin{itemize}
...
\caption[cIV]{\label{fig:org2e50529}Complex IV | Cytochrome c oxidase}
\end{figure}
\end{itemize}

\subsubsection{Complex V}
\label{sec:org5335cc5}
\begin{itemize}
...
\caption{\label{fig:orgfa309a0}Complex V | ATP synthase}
\end{figure}
\end{itemize}
\end{itemize}

\subsection{Clinical Presentation}
\label{sec:orgbd39d2e}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:org8ba1942})
\begin{enumerate}
...
\caption[ETC]{\label{fig:org8ba1942}Pathogenesis of OxPhos Disorders}
\end{figure}
...
\caption{\label{fig:orgf2ff71b}mtDNA disorders}
\end{figure}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:org6846d1b})
...
\begin{table}[htbp]
\caption{\label{tab:org6846d1b}Clinical Features of Mitochondrial Disease}
\centering
\begin{tabular}{ll}
...
\label{sec:org104301a}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:org0f5e660}
\begin{itemize}
...
\label{sec:org9ac8a96}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:orgf7ee15a}
\begin{itemize}
...
\label{sec:org0eded90}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{oxphos/figures/algorithm_rot.png}
\caption{\label{fig:org72d2a80}Diagnosis of Mitochondrial Disease}
\end{figure}


\subsubsection{Biochemistry}
\label{sec:org0b4957f}
\begin{itemize}
...
\label{sec:orgba29784}
\begin{itemize}
\item CII is encoded by nuclear DNA (Table \ref{tab:org08456a1})
\begin{itemize}
...
\caption[rrf]{\label{fig:org91e8599}Ragged red fibers - Gomori stain}
\end{figure}

\subsubsection{Molecular}
\label{sec:orgf5edcad}
\begin{itemize}
...
\label{sec:org476fad0}
\subsection{Introduction}
\label{sec:org22f9ce6}
\begin{itemize}
...
\caption{\label{fig:org422f19f}Ketogenesis and Ketolysis}
\end{figure}
...
\subsubsection{Clinical Presentation}
\label{sec:org58bb311}
\begin{table}[htbp]
\caption{\label{tab:orgf491219}Common Manifestations in Ketogenesis Defects}
\centering
\begin{tabular}{llllll}
FAOD & sudden & fasting & skeletal & cardio- & liver\\
 & death & intolerance & myopathy & myopathy & disease\\
...
\subsubsection{Diagnostic Tests}
\label{sec:org47195c7}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:orgd3e603e}
\begin{itemize}
...
\caption{\label{fig:orgfdfc264}Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Slide16.png}
\caption{\label{fig:org93920e5}Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org052035b}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org2f5ff4d}Urine findings in CDS}
\centering
\begin{tabular}{lll}
