...
\label{sec:orgd10b85c}
\subsection{Cellular Redox State}
\label{sec:org8c7b7ef}
\begin{itemize}
...
\subsection{\(\beta\)-oxidation Redox Rxn}
\label{sec:orgfef5e16}
\begin{description}
\item[{Acyl-CoA Deydrogenase}] FAD reduced to FADH\textsubscript{2}
\end{description}
\ce{Acyl-CoA + FAD <=>[ACD] 2,3-enoyl-CoA + FADH2}
\begin{description}
\item[{Hydroxyacyl-CoA Deydrogenase}] NAD+ reduced to NADH
\end{description}
\ce{3-hydroxyacyl-CoA + NAD+ <=>[HAD] 3-Ketoacyl-CoA + NADH}

\subsection{TCA Net Reaction}
\label{sec:orgee1674f}
\begin{description}
...
\begin{description}
\item[{ETF dehydrogenase}] FADH\textsubscript{2} oxidized to FAD

\ce{FADH2 <=>[ETF DH] FAD + 2H+}
\end{description}

\subsection{Ketone Redox Rxn}
\label{sec:orgd361dee}
\begin{description}
\item[{hydroxybutyrate dehydrogenase}] \(\beta\)-hydroxybutyrate oxidized to acetoacetate

\ce{ \beta-hydroxybutyrate + NAD+ <=>[HBDH] acetoacetate + NADH}
\end{description}

\section{Fatty Acid Oxidation}
\label{sec:orgd1ff38f}
\subsection{Introduction}
\label{sec:org5800928}
\begin{itemize}
...
\label{sec:org943cebc}
\begin{itemize}
\item involves three processes (Figure \ref{fig:orge990e4b})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:org30437ef})
\begin{itemize}
...
and the \(\beta\) carbon atoms by acyl-CoA dehydrogenase (Table \ref{tab:org21d2d8b})
\begin{itemize}
...
\caption{\label{fig:orge990e4b}Fatty Acid \(\beta\)-Oxidation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/Slide12.png}
\caption{\label{fig:org0e0f673}Fatty Acid \(\beta\)-Oxidation and Ketone Body Metabolism}
\end{figure}
...
\caption{\label{fig:org30437ef}Fatty Acid \(\beta\)-Oxidation}
\end{figure}



\begin{table}[htbp]
\caption{\label{tab:org21d2d8b}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\end{itemize}
\begin{itemize}
\item summarized in table \ref{tab:orga5e27fc}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orga5e27fc}Common Manifestations in FAODs}
\centering
...
\item Genetics
\label{sec:org3cca784}
\begin{itemize}
\item AR OCTN2
\end{itemize}
\item Diagnostic Tests
\label{sec:orga995375}
\begin{itemize}
...
\caption{\label{fig:orga166f58}CPT1 (OMM) \& CPTII (IMM)}
\end{figure}

\item Genetics
\label{sec:orga6c83c2}
\begin{itemize}
\item AR CPT1A
...
\label{sec:orgec696c2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6190635}
\begin{itemize}
...
\caption{\label{fig:org36ec3a1}Carnitine Acylcarnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org9eebe87}
\begin{itemize}
\item AR SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:org30cff1e}
\begin{itemize}
...
\label{sec:orga7b86b8}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd4f3c28}
\begin{enumerate}
\item Neonatal
\label{sec:org7c9f509}
\begin{itemize}
...
(Figure \ref{fig:orga166f58})
\end{itemize}
\item Genetics
\label{sec:org3f5e449}
\begin{itemize}
\item AR CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:orgb6db22e}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:org8810e39}
\subsubsection{Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency}
\label{sec:org2a31caa}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org11479fd}
\begin{enumerate}
\item Infancy
\label{sec:org5870d17}
\begin{itemize}
...
steps in the \(\beta\)-oxidation of fatty acids (Table \ref{tab:org21d2d8b})
...
\caption{\label{fig:org71a6b40}VLCAD Reaction}
\end{figure}

\item Genetics
\label{sec:orga5f6915}
\begin{itemize}
\item AR ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org243ac95}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:orgfdb3238}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2e002e1}
\begin{itemize}
...
\item Genetics
\label{sec:org64b9c1a}
\begin{itemize}
\item AR HADHA, HADHB
\end{itemize}

\item Diagnostic Tests
\label{sec:org359ab0a}
\begin{itemize}
...
\label{sec:org0332a1c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org38707fd}
\begin{itemize}
...
(Figure \ref{fig:org89e1756})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{fao/figures/lchad.png}
\caption{\label{fig:org89e1756}LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:org87faef4}
\begin{itemize}
\item AR HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:org149ac41}
\begin{itemize}
\item \(\uparrow\) lactate \(\because\) 3-OH-palmitoyl-CoA inhibits PDH
\item \(\uparrow\) hydroxy-acylcarnitines
\begin{itemize}
...
\label{sec:orgdd3d839}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3668af8}
\begin{itemize}
...
\item Genetics
\label{sec:orgb3ca6d2}
\begin{itemize}
\item AR ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org9c30b3e}
\begin{itemize}
...
\item The detection of phenylpropionylglycine in urine after an oral
load of phenylpropionic acid can be used to diagnose MCADD
\end{itemize}
\end{itemize}

\item Treatment
\label{sec:orgc2efc3a}
\begin{itemize}
\item avoid fasting
...
\caption{\label{fig:org6617b48}Multiple Acyl-CoA Dehydrogenase Deficiency}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/etf.png}
\caption{\label{fig:org8c13a05}Role of ETF and ETF-QO}
\end{figure}

\item Genetics
\label{sec:orga6d4d5c}
\begin{itemize}
\item AR ETFA, ETFB, ETFDH
\end{itemize}

\item Diagnostic Tests
\label{sec:org3fde82f}
\begin{itemize}
\item plasma acylcarnitines
\begin{itemize}
\item \(\uparrow\) C4-C18
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org81e5908}
\subsection{Introduction}
\label{sec:org63e5593}
\begin{itemize}
...
\caption[TCA]{\label{fig:org8b8c52c}Disorders of Pyruvate Metabolism}
\end{figure}
...
\caption[TCA]{\label{fig:org091dc60}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Reactions involving Pyruvate}
\label{sec:orgfa12167}
...
\begin{table}[htbp]
\caption{\label{tab:org32edcc2}Pyruvate Dehydrogenases Complex}
\centering
\begin{tabular}{llll}
...
\caption[pdhe1]{\label{fig:org3afbbd1}Activation/Deactivation of PDH E1}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{pyruvate/figures/pdhc.png}
\caption[pdhc]{\label{fig:org5368afd}Pyruvate Dehydrogenase Complex}
\end{figure}
...
dephosphorylated (active) (Figure \ref{fig:org3afbbd1})
\end{itemize}

\subsubsection{Pyruvate Transport Defect}
\label{sec:org4e26455}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org0252c25}
\begin{itemize}
\item AR DLD
\end{itemize}
\subsubsection{Diagnostic Testing}
\label{sec:orgf40d376}
\begin{itemize}
...
\label{sec:orgcbe2531}
\subsection{Introduction}
\label{sec:org9404919}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgac3bc06}Pyruvate Metabolism and the TCA Cycle}
\end{figure}


\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{tca/figures/tca.png}
\caption[TCA]{\label{fig:orgae7e004}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Disorders of the TCA cycle}
\label{sec:org0bc8fa7}
...
\begin{table}[htbp]
\caption{\label{tab:org41d2910}\(\alpha\)-Ketoglutarate Dehydrogenase Complex}
\centering
\begin{tabular}{llll}
Unit & Name & Gene & Cofactor\\
\hline
...
\subsubsection{Clinical Presentation}
\label{sec:org66c74c9}
\begin{itemize}
\item similar to PDHC (section \ref{sec:org47e7673})
...
\subsubsection{Genetics}
\label{sec:org8e5cd50}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org525cf7d}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org4e8f604}
\begin{itemize}
\item none
\end{itemize}
\subsection{Succinate Dehydrogenase Deficiency}
\label{sec:org3cc9d7b}
\begin{itemize}
\item four subunits compose Complex II of the mitochondrial respiratory
chain (Table \ref{tab:org46149e3})
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org46149e3}Succinate Dehydrogenase | Complex II}
\centering
\begin{tabular}{ll}
Subunit & Description\\
\hline
...
\caption{\label{fig:orgfda6c4e}Succinate Dehydrogenase | Complex II}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:org3ad1a08}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org9d540d3}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:org3c2a2a5})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org3c2a2a5}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\subsection{Aconitase Deficiency}
\label{sec:orge8920d8}
\begin{itemize}
\item two isozymes
\begin{itemize}
\item aconitase 1, soluble
\item aconitase 2, mitochondria
\end{itemize}

\item deficient aconitase activity may be caused by a deficiency in
iron-sulfur cluster scaffold protein (ISCU)
\begin{itemize}
\item helps build the Fe-S cluster required for aconitase activity
\end{itemize}
\item main symptoms are myopathy and exercise intolerance
\begin{itemize}
\item physical strain is lethal for some patients because it can lead to
circulatory shock
\end{itemize}
\item There are no known treatments for this form of aconitase deficiency

\item Pathogenic mutations in ACO2 can cause infantile cerebellar-retinal degeneration (ICRD)
\end{itemize}
\section{Oxidative Phosphorylation}
\label{sec:org3825055}
\subsection{Introduction}
\label{sec:orgd0766a2}
\begin{itemize}
...
series of electron carriers (Figures \ref{fig:orgd2ff6ea} and \ref{fig:org7f65cf9})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:orgcf6c2a0})
...
\caption{\label{fig:orgd2ff6ea}Flow of Electrons in the ETC}
\end{figure}
...
\item ETF-QO and mitochondrial glycerol-3-P dehydrogenase (GPD) are part of ETC (Figure \ref{fig:orgd2ff6ea})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgcf6c2a0}Location of DNA Encoding OxPhos Complex Subunits}
\centering
...
\caption[ETC]{\label{fig:org7f65cf9}Oxidative Phosphorylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{oxphos/figures/potential.png}
\caption[redox]{\label{fig:org4df742b}Electron Flow to O\textsubscript{2} and Release of Free Energy}
\end{figure}

\subsubsection{Complex I}
\label{sec:orge77cc4c}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:org7ed467b})
...
\caption[c1]{\label{fig:org7ed467b}Complex I | NADH-Ubiquinone Oxidoreductase}
\end{figure}

\subsubsection{Complex II}
\label{sec:org562307c}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org3cc9d7b}
\end{itemize}
\end{itemize}

\subsubsection{Glycerol-3-Phosphate Shuttle}
\label{sec:org0bb228e}
\begin{itemize}
...
\caption[g3ps]{\label{fig:org38f5742}Glycerol-3-Phosphate Shuttle}
\end{figure}

\subsubsection{Electron Transferring Flavoprotein/ Dehydrogenase}
\label{sec:org9b5a725}
\begin{itemize}
...
\caption[cIV]{\label{fig:org993f195}Complex IV | Cytochrome C Oxidase}
\end{figure}
\end{itemize}

\subsubsection{Complex V}
\label{sec:org33baa90}
\begin{itemize}
...
\caption{\label{fig:org980b01c}Complex V | ATP Synthase}
\end{figure}
\end{itemize}
\end{itemize}

\subsection{Clinical Presentation}
\label{sec:orgb2d36f7}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:orgc825697})
\begin{enumerate}
...
\caption[ETC]{\label{fig:orgc825697}Pathogenesis of OxPhos Disorders}
\end{figure}
...
\caption{\label{fig:orgb95deec}mtDNA Disorders}
\end{figure}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:org716ddf4})
...
\begin{table}[htbp]
\caption{\label{tab:org716ddf4}Clinical Features of Mitochondrial Disease}
\centering
\begin{tabular}{ll}
...
\label{sec:org4be4be9}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:orgc95080b}
\begin{itemize}
...
\label{sec:orga85d096}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:org232e021}
\begin{itemize}
...
\label{sec:orge9d071c}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{oxphos/figures/algorithm_rot.png}
\caption{\label{fig:org0629884}Diagnosis of Mitochondrial Disease}
\end{figure}


\subsubsection{Biochemistry}
\label{sec:org4d2a486}
\begin{itemize}
...
\label{sec:org42e5c21}
\begin{itemize}
\item CII is encoded by nuclear DNA (Table \ref{tab:orgcf6c2a0})
\begin{itemize}
...
\caption[rrf]{\label{fig:org6281676}Ragged Red Fibers - Gomori Stain}
\end{figure}

\subsubsection{Molecular}
\label{sec:orgcdd8c9f}
\begin{itemize}
...
\label{sec:orge18056d}
\subsection{Introduction}
\label{sec:orgabc1cf0}
\begin{itemize}
...
\caption{\label{fig:orgece1534}Ketogenesis and Ketolysis}
\end{figure}
...
\subsubsection{Clinical Presentation}
\label{sec:orged41fc9}
\begin{table}[htbp]
\caption{\label{tab:org632b1f6}Common Manifestations in Ketogenesis Defects}
\centering
\begin{tabular}{llllll}
FAOD & sudden & fasting & skeletal & cardio- & liver\\
 & death & intolerance & myopathy & myopathy & disease\\
...
\subsubsection{Diagnostic Tests}
\label{sec:orgeddce9a}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org5c26b53}
\begin{itemize}
...
\caption{\label{fig:orgbd76d55}Metabolic Pathway of Creatine/Creatine Phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Slide16.png}
\caption{\label{fig:org81ef289}Metabolic Pathway of Creatine/Creatine Phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Creatinesynthesis.png}
\caption{\label{fig:org20e37d1}Creatine Synthesis}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:orgf78e28a}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org843618a}Urine Findings in CDS}
\centering
\begin{tabular}{lll}
