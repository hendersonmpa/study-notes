...
\label{sec:org4eba743}
\subsection{Cellular RedOx State}
\label{sec:orga32c89a}
\begin{itemize}
...
\label{sec:orgf5db3e8}
\subsection{Introduction}
\label{sec:org7b0bbb4}
\begin{itemize}
...
\label{sec:org5fad6ec}

\begin{itemize}
\item involves three processes (Figure \ref{fig:org60048ba})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:org8b65952})
\begin{itemize}
...
\caption{\label{fig:org17d555e}
CPT1}
\end{figure}

\item Genetics
\label{sec:org145a05f}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:orgddc0e08}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org66b4c89}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org5e5161a}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:orga526340})
...
\caption{\label{fig:orga526340}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org334879c}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:org93bc8e8}
\begin{itemize}
...
\label{sec:orgcdc1893}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org505ba63}
\begin{enumerate}
\item Neonatal
\label{sec:org267d247}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:org17d555e})
\end{itemize}
\item Genetics
\label{sec:org06c2039}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:orgb1c7c97}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:org7370952}
\begin{enumerate}
\item Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency
\label{sec:org99653ce}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8e460fe}
\begin{enumerate}
\item Infancy
\label{sec:org38cd4f2}
\begin{itemize}
...
\caption{\label{fig:orgb0f251d}
VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:org57333d6}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd175d30}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:orgaa7e926}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgefc361b}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:orgd249ecb}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:org7d03d12}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:org6e9726c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2dac865}
\begin{itemize}
...
(Figure \ref{fig:org1cca93a})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fao/figures/lchad.png}
\caption{\label{fig:org1cca93a}
LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:orgb8e9fbf}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:orgcdf338c}
\begin{itemize}
...
\label{sec:org8c3f290}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc818328}
\begin{itemize}
...
\item Genetics
\label{sec:org9ebf6ef}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:orgc2f0693}
\begin{itemize}
...
\end{enumerate}
\section{Pyruvate}
\label{sec:orgd9eb5cf}
\subsection{Introduction}
\label{sec:org0bcadc3}
\begin{itemize}
...
\caption[TCA]{\label{fig:org100bbf8}
...
\caption[pdhe1]{\label{fig:orgfc1eb99}
...
\caption[pdhc]{\label{fig:org30f4ed2}
...
dephosphorylated (active) (Figure \ref{fig:orgfc1eb99})
\end{itemize}

\item Pyruvate Transport Defect
\label{sec:orgdc0b346}
\begin{itemize}
...
\label{sec:org9ad3f0b}
\subsection{Introduction}
\label{sec:orgf2f7be3}
\begin{itemize}
...
\caption[TCA]{\label{fig:org5041989}
Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\begin{enumerate}
\item Disorders of the TCA cycle
\label{sec:org3d38fc6}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org78bbebb}
\begin{itemize}
\item similar to PDHC (section \ref{sec:orgb42fef5})
...
\item Genetics
\label{sec:org21f7442}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\item Diagnostic Tests
\label{sec:orgcaa1e2f}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\caption{\label{fig:org961b6c8}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org707bf49}
\begin{itemize}
...
\caption{\label{fig:org93e0c51}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org135ccae}
\begin{itemize}
...
\label{sec:org37af66b}
\subsection{Introduction}
\label{sec:org20628d3}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:org3ab437a})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of Complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:org7219396})
...
\caption[ETC]{\label{fig:org3ab437a}
...
\caption[redox]{\label{fig:orgc122364}
Electron flow to O\(_{\text{2}}\) and release free energy}
\end{figure}

\begin{enumerate}
\item Complex I
\label{sec:org371872e}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:org7faa226})
...
\caption[c1]{\label{fig:org7faa226}
Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\item Complex II
\label{sec:org56a25ca}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:orgdf24c37}
\end{itemize}
\end{itemize}

\item Glycerol-3-phosphate shuttle
\label{sec:org021d4d7}
\begin{itemize}
...
\caption[cIV]{\label{fig:org26bca23}
Complex IV | Cytochrome c oxidase}
\end{figure}
\end{itemize}

\item Complex V
\label{sec:org1db7682}
\begin{itemize}
...
\label{sec:org54cf700}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:org687e86e})
\begin{enumerate}
...
\caption[ETC]{\label{fig:org687e86e}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:orgf925385})
...
\label{sec:org4c97e46}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:orgca0a980}
\begin{itemize}
...
\label{sec:orgc77d5b6}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:org9cd8203}
\begin{itemize}
...
\label{sec:org2968555}
\begin{itemize}
\item CII is encoded my nuclear DNA (Table \ref{tab:org7219396})
\begin{itemize}
...
\caption[rrf]{\label{fig:org80e64f3}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:org596566d}
\begin{itemize}
...
\label{sec:org680d14c}
\subsection{Introduction}
\label{sec:orgb408a84}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgbe2ae78}
\begin{enumerate}
\item HMG-CoA Synthase Deficiency
\label{sec:org7aec41f}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:orga6971af}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org5653626}
\begin{itemize}
...
\end{enumerate}
\section{Creatine}
\label{sec:org139f918}
\subsection{Introduction}
\label{sec:org03e50e5}
\begin{itemize}
...
\caption{\label{fig:org5936cdd}
Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org5f1167a}
\begin{itemize}
