...
\label{sec:orgc61da5d}
\subsection{Introduction}
\label{sec:org1c1374b}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org681c43f}Acyl-CoA Synthetases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\begin{table}[htbp]
\caption{\label{tab:org7f6f89c}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
Enzyme & Length & location\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orgef94591}Other: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\label{sec:org83f8d17}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3ead48c}
\begin{enumerate}
\item Neonatal
\label{sec:org96839c6}
\begin{itemize}
...
\label{sec:org9f8f31c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb3628b0}
\begin{itemize}
...
\caption[pdhc]{\label{fig:orgbfd818d}Pyruvate Dehydrogenase Complex}
\end{figure}
...
\caption[TCA]{\label{fig:orgfea565d}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Disorders of the TCA cycle}
\label{sec:orgc4e4ded}
...
\subsubsection{Genetics}
\label{sec:orged0a5d5}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org55324ee}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\caption{\label{fig:org16359b8}Succinate Dehydrogenase | Complex II}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:org1ea380f}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgde9a369}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:org362e755})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org362e755}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\caption[cIV]{\label{fig:orgd32e66c}Complex IV | Cytochrome c oxidase}
\end{figure}
\end{itemize}

\subsubsection{Complex V}
\label{sec:org90483b4}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orge7fe5ab}Clinical Features of Mitochondrial Disease}
\centering
\begin{tabular}{ll}
...
\label{sec:orgd21890a}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:orgbf2cfc6}
\begin{itemize}
...
\label{sec:org96d9739}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:orgb7bde6c}
\begin{itemize}
...
\label{sec:orgd52632d}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{oxphos/figures/algorithm_rot.png}
\caption{\label{fig:orge7f49c5}Diagnosis of Mitochondrial Disease}
\end{figure}


\subsubsection{Biochemistry}
\label{sec:org5af474a}
\begin{itemize}
...
\caption[rrf]{\label{fig:org802ec04}Ragged red fibers - Gomori stain}
\end{figure}

\subsubsection{Molecular}
\label{sec:org99331bd}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org37999c0}
\begin{table}[htbp]
\caption{\label{tab:orgdec6dde}Common Manifestations in Ketogenesis Defects}
\centering
\begin{tabular}{llllll}
FAOD & sudden & fasting & skeletal & cardio- & liver\\
 & death & intolerance & myopathy & myopathy & disease\\
...
\subsubsection{Diagnostic Tests}
\label{sec:orgeee8dcd}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:orge77462f}
\begin{itemize}
...
\caption{\label{fig:org7c30c18}Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Slide16.png}
\caption{\label{fig:orgbe4989c}Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:orgdb1fb70}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org4f3e029}Urine findings in CDS}
\centering
\begin{tabular}{lll}
