...
\caption{\label{fig:orga3bc8c0}
CPT1}
\end{figure}

\item Genetics
\label{sec:org534f526}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:org9e4ed35}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge668bd5}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org327ad0b}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:org21c7c27})
...
\caption{\label{fig:org21c7c27}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org8becb61}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:orgf904997}
\begin{itemize}
...
\label{sec:org2d674d2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org42bba1d}
\begin{enumerate}
\item Neonatal
\label{sec:org7f64a07}
\begin{itemize}
...
\item Genetics
\label{sec:org356fdfd}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:orge29e9b3}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org9ec178f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org7726bc7}
\begin{itemize}
...
\label{sec:org0f37e54}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3c1051c}
\begin{itemize}
...
\item Genetics
\label{sec:orgae22167}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org00e612c}
\begin{itemize}
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org2755986}
\subsection{Introduction}
\label{sec:org42228d0}
\begin{itemize}
...
\caption[ETC]{\label{fig:org55a1a5e}
...
\caption[redox]{\label{fig:org74b621e}
...
\label{sec:org339f93b}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:orga7eab5f}
\begin{itemize}
...
\label{sec:org2b80bde}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:orgb3121d5}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org804931f}
\begin{enumerate}
\item HMG-CoA Synthase Deficiency
\label{sec:org78dd4b2}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org7bac91a}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org6c01543}
\begin{itemize}
...
\end{enumerate}
\section{Creatine}
\label{sec:org7120bc9}
\subsection{Introduction}
\label{sec:org5b9c5b8}
\begin{itemize}
