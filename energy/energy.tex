...
\label{sec:org7af6941}
\subsection{Cellular RedOx State}
\label{sec:org144f239}
\begin{itemize}
...
\label{sec:orgb8b5dca}
\subsection{Introduction}
\label{sec:org6085d73}
\begin{itemize}
...
\label{sec:orgec78f6e}

\begin{itemize}
\item involves three processes (Figure \ref{fig:orgd831abd})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:orgb80d8a9})
\begin{itemize}
...
\caption{\label{fig:orgd831abd}Fatty Acid Oxidation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/fao/figures/Slide12.png}
\caption{\label{fig:orga552319}Fatty Acid Oxidation and Ketone Body Metabolism}
\end{figure}
...
\caption{\label{fig:orgb80d8a9}Fatty Acid \(\beta\)-Oxidation}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:org50e2af4}Acyl-CoA Synthetases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\begin{table}[htbp]
\caption{\label{tab:org9c91904}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
Enzyme & Length & location\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org570139e}Other: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\caption{\label{fig:org1777952}Common manifestations in FAODs: green frequent, yellow intermediate, red uncommon}
\end{figure}
\end{enumerate}

\subsection{Carnitine Cycle Defects}
\label{sec:org237149d}
\begin{itemize}
...
\caption{\label{fig:org7d09002}CPT1}
\end{figure}

\item Genetics
\label{sec:org390c0a9}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:org5be14bd}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org60eec1d}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:orga0ee2cd}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:org9841265})
...
\caption{\label{fig:org9841265}Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org96bdf94}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:org340453d}
\begin{itemize}
...
\label{sec:org7bc4812}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org70feec6}
\begin{enumerate}
\item Neonatal
\label{sec:org8062747}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:org7d09002})
\end{itemize}
\item Genetics
\label{sec:org8371e6e}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:orgc6c5853}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:orge4560b7}
\begin{enumerate}
\item Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency
\label{sec:orgfad80dc}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb1fb5cc}
\begin{enumerate}
\item Infancy
\label{sec:org9f650ca}
\begin{itemize}
...
\caption{\label{fig:org3d1d14f}VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:org4062455}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:orgeb6255c}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org629b80c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd60c828}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org79f2858}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:orgfa32522}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:orge15b216}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgdcc8b9b}
\begin{itemize}
...
(Figure \ref{fig:org083dd27})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{fao/fao/figures/lchad.png}
\caption{\label{fig:org083dd27}LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:org1d3b6dd}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:org4f55689}
\begin{itemize}
...
\label{sec:orgf5a4136}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd65a86c}
\begin{itemize}
...
\item Genetics
\label{sec:org3ba7f17}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org0f9693d}
\begin{itemize}
...
\caption{\label{fig:org3292ada}Multiple Acyl-CoA Dehydrogenase Deficiency}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/fao/figures/etf.png}
\caption{\label{fig:orgfe51501}Role of ETF and ETF-QO}
\end{figure}

\item Genetics
\label{sec:org3fbf8d8}
\begin{itemize}
\item AR, ETFA, ETFB, ETFDH
\end{itemize}

\item Diagnostic Tests
\label{sec:org91a8b97}
\begin{itemize}
\item \(\uparrow\) C4-C18
\item \(\uparrow\) UOA lactic, glutaric, 2-OH-glutaric, ethylmalonic, dicarboxylic acids
\end{itemize}
\item Treatment
\label{sec:orgcb3926c}
\begin{itemize}
\item avoid fasting
\item low fat diet
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org6a5712f}
\subsection{Introduction}
\label{sec:orge27fb40}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgd3fc15c}Disorders of Pyruvate Metabolism}
\end{figure}
...
\caption[TCA]{\label{fig:org903a501}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\item Reactions Involving Pyruvate
\label{sec:orgba15af6}
...
\begin{table}[htbp]
\caption{\label{tab:org86d29c3}Pyruvate Dehydrogenases Complex}
\centering
\begin{tabular}{llll}
...
\caption[pdhe1]{\label{fig:org40ef20d}Activation/deactivation of PDHE1}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{pyruvate/pyruvate/figures/pdhc.png}
\caption[pdhc]{\label{fig:org127e2b3}Pyruvate Dehydrogenase Complex}
\end{figure}
...
dephosphorylated (active) (Figure \ref{fig:org40ef20d})
\end{itemize}

\item Pyruvate Transport Defect
\label{sec:org1bd3cb0}
\begin{itemize}
...
\label{sec:org83401d6}
\subsection{Introduction}
\label{sec:orgc0cae39}
\begin{itemize}
...
\caption[TCA]{\label{fig:org5e78b32}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\begin{enumerate}
\item Disorders of the TCA cycle
\label{sec:org0fdfadc}
...
\begin{table}[htbp]
\caption{\label{tab:org7fa0802}\(\alpha\)-Ketoglutarate Dehydrogenase Complex}
\centering
\begin{tabular}{llll}
Unit & Name & Gene & Cofactor\\
\hline
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4b480c5}
\begin{itemize}
\item similar to PDHC (section \ref{sec:orge79c12c})
...
\item Genetics
\label{sec:orge6e25b0}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\item Diagnostic Tests
\label{sec:org4eaab6a}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\caption{\label{fig:orga2f42a8}Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org3df1469}
\begin{itemize}
...
\item Genetics
\label{sec:org1abe1ed}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:org45b3fa3})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org45b3fa3}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\caption{\label{fig:org81b8e65}Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org5a80a59}
\begin{itemize}
...
\label{sec:orgb905c14}
\subsection{Introduction}
\label{sec:orgc4e5ab1}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:orgd5b17ab})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of Complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:org206eb41})
...
\caption{\label{fig:org64e46b3}Electron Transport Chain}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:org206eb41}Location of DNA encoding OxPhos Complex Subunits}
\centering
...
\caption[ETC]{\label{fig:orgd5b17ab}Oxidative Phosphorylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{oxphos/oxphos/figures/potential.png}
\caption[redox]{\label{fig:org6b21519}Electron flow to O\textsubscript{2} and release free energy}
\end{figure}

\begin{enumerate}
\item Complex I
\label{sec:org30d1b55}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:orgd319ca4})
...
\caption[c1]{\label{fig:orgd319ca4}Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\item Complex II
\label{sec:org7639414}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org72c9a80}
\end{itemize}
\end{itemize}

\item Glycerol-3-phosphate shuttle
\label{sec:orga49b4ac}
\begin{itemize}
...
\caption[g3ps]{\label{fig:org6525c75}Glycerol-3-phosphate shuttle}
\end{figure}

\item Electron Transferring Flavoprotein/ Dehydrogenase
\label{sec:orgeb2d715}
\begin{itemize}
...
\caption[cIV]{\label{fig:orga0018d2}Complex IV | Cytochrome c oxidase}
\end{figure}
\end{itemize}

\item Complex V
\label{sec:org567b7f9}
\begin{itemize}
...
\caption{\label{fig:org5413559}Complex V | ATP synthase}
\end{figure}
\end{itemize}
\end{itemize}
\end{enumerate}
...
\label{sec:org70854a2}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:orga8dfbad})
\begin{enumerate}
...
\caption[ETC]{\label{fig:orga8dfbad}Pathogenesis of OxPhos Disorders}
\end{figure}
...
\caption{\label{fig:orgb7e8221}mtDNA disorders}
\end{figure}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:orgc338977})
...
\begin{table}[htbp]
\caption{\label{tab:orgc338977}Clinical Features of Mitochondrial Disease}
\centering
\begin{tabular}{ll}
...
\label{sec:org4a2b1dd}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:orga9a4cb5}
\begin{itemize}
...
\label{sec:org4db8f9c}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:org31ef850}
\begin{itemize}
...
\label{sec:orgc256c32}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{oxphos/oxphos/figures/algorithm_rot.png}
\caption{\label{fig:org9f1d15c}Diagnosis of Mitochondrial Disease}
\end{figure}


\begin{enumerate}
\item Biochemistry
\label{sec:org1ed35f6}
\begin{itemize}
...
\label{sec:orgccae094}
\begin{itemize}
\item CII is encoded my nuclear DNA (Table \ref{tab:org206eb41})
\begin{itemize}
...
\caption[rrf]{\label{fig:orgd6a428c}Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:org31b4582}
\begin{itemize}
...
\label{sec:org0bb5be4}
\subsection{Introduction}
\label{sec:org3f44a33}
\begin{itemize}
...
\caption{\label{fig:orge7b99e5}Ketogenesis and Ketolysis}
\end{figure}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8cba81c}
\begin{enumerate}
\item HMG-CoA Synthase Deficiency
\label{sec:org08e8316}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org15276f9}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org3ddf6d2}
\begin{itemize}
...
\end{enumerate}
\section{Creatine}
\label{sec:orgde2e209}
\subsection{Introduction}
\label{sec:org94f3351}
\begin{itemize}
...
\caption{\label{fig:org53af130}Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/creatine/figures/Slide16.png}
\caption{\label{fig:orgaa351e6}Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org36221fb}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org3165414}Urine findings in CDS}
\centering
\begin{tabular}{lll}
