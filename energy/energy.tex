...
\label{sec:orgbb252dc}
\subsection{Cellular Redox State}
\label{sec:org13c65af}
\begin{itemize}
...
\label{sec:org0a07445}
\subsection{Introduction}
\label{sec:orgc84b8df}
\begin{itemize}
...
\label{sec:org52ed3d0}
\begin{itemize}
\item involves three processes (Figure \ref{fig:org65fb5fa})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:orgab2a4d2})
\begin{itemize}
...
and the \(\beta\) carbon atoms by acyl-CoA dehydrogenase (Table \ref{tab:org5b8dd2f})
\begin{itemize}
...
\caption{\label{fig:org65fb5fa}Fatty Acid \(\beta\)-Oxidation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/Slide12.png}
\caption{\label{fig:org16d5edd}Fatty Acid \(\beta\)-Oxidation and Ketone Body Metabolism}
\end{figure}
...
\caption{\label{fig:orgab2a4d2}Fatty Acid \(\beta\)-Oxidation}
\end{figure}



\begin{table}[htbp]
\caption{\label{tab:org5b8dd2f}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\end{itemize}
\begin{itemize}
\item summarized in table \ref{tab:org12dd45a}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org12dd45a}Common Manifestations in FAODs}
\centering
...
\item Genetics
\label{sec:org058ad7d}
\begin{itemize}
\item AR OCTN2
\end{itemize}
\item Diagnostic Tests
\label{sec:orgf03b089}
\begin{itemize}
...
\caption{\label{fig:orge630d5c}CPT1 (OMM) \& CPTII (IMM)}
\end{figure}

\item Genetics
\label{sec:org89b2450}
\begin{itemize}
\item AR CPT1A
...
\label{sec:org64a9c98}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4780bc7}
\begin{itemize}
...
\caption{\label{fig:org9baf4e3}Carnitine Acylcarnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org1f92520}
\begin{itemize}
\item AR SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:orgd9fde65}
\begin{itemize}
...
\label{sec:orgdb79aa7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgacb20ec}
\begin{enumerate}
\item Neonatal
\label{sec:orgcbf475c}
\begin{itemize}
...
(Figure \ref{fig:orge630d5c})
\end{itemize}
\item Genetics
\label{sec:org48a1fc5}
\begin{itemize}
\item AR CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org89af4cd}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:org6c0e4de}
\subsubsection{Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency}
\label{sec:org0475730}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8bb5c6a}
\begin{enumerate}
\item Infancy
\label{sec:org8d11f80}
\begin{itemize}
...
steps in the \(\beta\)-oxidation of fatty acids (Table \ref{tab:org5b8dd2f})
...
\caption{\label{fig:org6448dcb}VLCAD Reaction}
\end{figure}

\item Genetics
\label{sec:orgd69218d}
\begin{itemize}
\item AR ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org0b18f97}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org37590aa}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6f3211a}
\begin{itemize}
...
\item Genetics
\label{sec:org521109f}
\begin{itemize}
\item AR HADHA, HADHB
\end{itemize}

\item Diagnostic Tests
\label{sec:org7ec62df}
\begin{itemize}
...
\label{sec:orgd4dc160}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgfc089a3}
\begin{itemize}
...
(Figure \ref{fig:orgfad1c94})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{fao/figures/lchad.png}
\caption{\label{fig:orgfad1c94}LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:org52b2d54}
\begin{itemize}
\item AR HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:org110c0a1}
\begin{itemize}
\item \(\uparrow\) lactate \(\because\) 3-OH-palmitoyl-CoA inhibits PDH
\item \(\uparrow\) hydroxy-acylcarnitines
\begin{itemize}
...
\label{sec:org8a3f490}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb5e74e8}
\begin{itemize}
...
\item Genetics
\label{sec:org5d4c218}
\begin{itemize}
\item AR ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org882011b}
\begin{itemize}
...
\caption{\label{fig:orgb573eef}Multiple Acyl-CoA Dehydrogenase Deficiency}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/etf.png}
\caption{\label{fig:org72bfa9a}Role of ETF and ETF-QO}
\end{figure}

\item Genetics
\label{sec:orgee9c966}
\begin{itemize}
\item AR ETFA, ETFB, ETFDH
\end{itemize}

\item Diagnostic Tests
\label{sec:org1ad3b9a}
\begin{itemize}
\item plasma acylcarnitines
\begin{itemize}
\item \(\uparrow\) C4-C18
...
\end{enumerate}
\section{Pyruvate}
\label{sec:orge470c3b}
\subsection{Introduction}
\label{sec:orgb992642}
\begin{itemize}
...
\caption[TCA]{\label{fig:org32af4d3}Disorders of Pyruvate Metabolism}
\end{figure}
...
\caption[TCA]{\label{fig:orgb2cd2be}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Reactions involving Pyruvate}
\label{sec:org10b549c}
...
\begin{table}[htbp]
\caption{\label{tab:orgaf0dcb6}Pyruvate Dehydrogenases Complex}
\centering
\begin{tabular}{llll}
...
\caption[pdhe1]{\label{fig:orgeae02d2}Activation/Deactivation of PDH E1}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{pyruvate/figures/pdhc.png}
\caption[pdhc]{\label{fig:org851208c}Pyruvate Dehydrogenase Complex}
\end{figure}
...
dephosphorylated (active) (Figure \ref{fig:orgeae02d2})
\end{itemize}

\subsubsection{Pyruvate Transport Defect}
\label{sec:org99c053b}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orga6b64fd}
\begin{itemize}
\item AR DLD
\end{itemize}
\subsubsection{Diagnostic Testing}
\label{sec:orgdace6c8}
\begin{itemize}
...
\label{sec:org22538d7}
\subsection{Introduction}
\label{sec:org60a9f2f}
\begin{itemize}
...
\caption[TCA]{\label{fig:orga130154}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Disorders of the TCA cycle}
\label{sec:org3b915dd}
...
\begin{table}[htbp]
\caption{\label{tab:org7d6d15d}\(\alpha\)-Ketoglutarate Dehydrogenase Complex}
\centering
\begin{tabular}{llll}
Unit & Name & Gene & Cofactor\\
\hline
...
\subsubsection{Clinical Presentation}
\label{sec:orgad97cbc}
\begin{itemize}
\item similar to PDHC (section \ref{sec:orgc5cff90})
...
\subsubsection{Genetics}
\label{sec:org60d8264}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org2178d6b}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org3473015}
\begin{itemize}
\item none
\end{itemize}
\subsection{Succinate Dehydrogenase Deficiency}
\label{sec:org0f05ff0}
\begin{itemize}
\item four subunits compose Complex II of the mitochondrial respiratory
chain (Table \ref{tab:org5119d2f})
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org5119d2f}Succinate Dehydrogenase | Complex II}
\centering
\begin{tabular}{ll}
Subunit & Description\\
\hline
...
\caption{\label{fig:org5cc520d}Succinate Dehydrogenase | Complex II}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:orga9f95cb}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgb70db97}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:org9632d36})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org9632d36}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\label{sec:orgf58ff8d}
\subsection{Introduction}
\label{sec:org7a05969}
\begin{itemize}
...
series of electron carriers (Figures \ref{fig:org87b18f7} and \ref{fig:org70b0cf9})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:org002fd17})
...
\caption{\label{fig:org87b18f7}Flow of Electrons in the ETC}
\end{figure}
...
\item ETF-QO and mitochondrial glycerol-3-P dehydrogenase (GPD) are part of ETC (Figure \ref{fig:org87b18f7})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org002fd17}Location of DNA Encoding OxPhos Complex Subunits}
\centering
...
\caption[ETC]{\label{fig:org70b0cf9}Oxidative Phosphorylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{oxphos/figures/potential.png}
\caption[redox]{\label{fig:orgdbe001c}Electron Flow to O\textsubscript{2} and Release of Free Energy}
\end{figure}

\subsubsection{Complex I}
\label{sec:orgb2686ce}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:orged22826})
...
\caption[c1]{\label{fig:orged22826}Complex I | NADH-Ubiquinone Oxidoreductase}
\end{figure}

\subsubsection{Complex II}
\label{sec:org480bf6f}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org0f05ff0}
\end{itemize}
\end{itemize}

\subsubsection{Glycerol-3-Phosphate Shuttle}
\label{sec:org540e738}
\begin{itemize}
...
\caption[g3ps]{\label{fig:org10eda29}Glycerol-3-Phosphate Shuttle}
\end{figure}

\subsubsection{Electron Transferring Flavoprotein/ Dehydrogenase}
\label{sec:orgdab9f1d}
\begin{itemize}
...
\caption[cIV]{\label{fig:orgb8f8b1d}Complex IV | Cytochrome C Oxidase}
\end{figure}
\end{itemize}

\subsubsection{Complex V}
\label{sec:org82c5ecd}
\begin{itemize}
...
\caption{\label{fig:org824aa07}Complex V | ATP Synthase}
\end{figure}
\end{itemize}
\end{itemize}

\subsection{Clinical Presentation}
\label{sec:org396fee3}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:org9356ed4})
\begin{enumerate}
...
\caption[ETC]{\label{fig:org9356ed4}Pathogenesis of OxPhos Disorders}
\end{figure}
...
\caption{\label{fig:orgc0fec68}mtDNA Disorders}
\end{figure}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:orge114557})
...
\begin{table}[htbp]
\caption{\label{tab:orge114557}Clinical Features of Mitochondrial Disease}
\centering
\begin{tabular}{ll}
...
\label{sec:org3fa8cca}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:org18b1cbf}
\begin{itemize}
...
\label{sec:org9236fe2}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:org2ef8671}
\begin{itemize}
...
\label{sec:orgbf1de4e}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{oxphos/figures/algorithm_rot.png}
\caption{\label{fig:orgcd051ca}Diagnosis of Mitochondrial Disease}
\end{figure}


\subsubsection{Biochemistry}
\label{sec:org052c7d7}
\begin{itemize}
...
\label{sec:org6dac21d}
\begin{itemize}
\item CII is encoded by nuclear DNA (Table \ref{tab:org002fd17})
\begin{itemize}
...
\caption[rrf]{\label{fig:orgd9a567a}Ragged Red Fibers - Gomori Stain}
\end{figure}

\subsubsection{Molecular}
\label{sec:orgc976183}
\begin{itemize}
...
\label{sec:orgc3f1154}
\subsection{Introduction}
\label{sec:orgf065e2e}
\begin{itemize}
...
\caption{\label{fig:org893719a}Ketogenesis and Ketolysis}
\end{figure}
...
\subsubsection{Clinical Presentation}
\label{sec:org7ca2b5b}
\begin{table}[htbp]
\caption{\label{tab:org1e636f5}Common Manifestations in Ketogenesis Defects}
\centering
\begin{tabular}{llllll}
FAOD & sudden & fasting & skeletal & cardio- & liver\\
 & death & intolerance & myopathy & myopathy & disease\\
...
\subsubsection{Diagnostic Tests}
\label{sec:org4a67fbf}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org3eee8b6}
\begin{itemize}
...
\caption{\label{fig:org0d22c9d}Metabolic Pathway of Creatine/Creatine Phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Slide16.png}
\caption{\label{fig:orgeec1c78}Metabolic Pathway of Creatine/Creatine Phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:orgc89e791}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org16c98d5}Urine Findings in CDS}
\centering
\begin{tabular}{lll}
