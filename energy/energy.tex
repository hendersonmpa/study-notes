...
\label{sec:org6ec7146}
\subsection{Cellular RedOx State}
\label{sec:org4c3a54e}
\begin{itemize}
...
\label{sec:org5289e02}
\subsection{Introduction}
\label{sec:org84fe1a9}
\begin{itemize}
...
\label{sec:org6379f3e}

\begin{itemize}
\item involves three processes (Figure \ref{fig:org827e2a7})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:org1fd31f0})
\begin{itemize}
...
\caption{\label{fig:org06ef8b3}
CPT1}
\end{figure}

\item Genetics
\label{sec:orgffe92de}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:org5633fca}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0dc0b49}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org081f003}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:org2bfbc51})
...
\caption{\label{fig:org2bfbc51}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:orgbbf8850}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:org1788a40}
\begin{itemize}
...
\label{sec:org12a3845}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgfff8c3b}
\begin{enumerate}
\item Neonatal
\label{sec:orga992e2f}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:org06ef8b3})
\end{itemize}
\item Genetics
\label{sec:orgbcd2f3b}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org72061c0}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:org775d42d}
\begin{enumerate}
\item Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency
\label{sec:org43ae23b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2b7661a}
\begin{enumerate}
\item Infancy
\label{sec:org92844f2}
\begin{itemize}
...
\caption{\label{fig:org8d86ac4}
VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:org6a4d3c1}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org35ee3a6}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:orgf9d5dcb}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org09fdc38}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org613cbcb}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:orgdea48c4}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:org937adb4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6e62eae}
\begin{itemize}
...
(Figure \ref{fig:org4a24649})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fao/figures/lchad.png}
\caption{\label{fig:org4a24649}
LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:org1b2a46e}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf845934}
\begin{itemize}
...
\label{sec:org9e3c829}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgbc57638}
\begin{itemize}
...
\item Genetics
\label{sec:org32d2cde}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org6cd8bc0}
\begin{itemize}
...
\end{enumerate}
\section{Pyruvate}
\label{sec:orgaf68834}
\subsection{Introduction}
\label{sec:org61ad878}
\begin{itemize}
...
\caption[TCA]{\label{fig:orge5f10b5}
...
\caption[pdhe1]{\label{fig:org313ed7b}
...
\caption[pdhc]{\label{fig:org8b46333}
...
dephosphorylated (active) (Figure \ref{fig:org313ed7b})
\end{itemize}

\item Pyruvate Transport Defect
\label{sec:org9e91f4f}
\begin{itemize}
...
\label{sec:org7c6ac68}
\subsection{Introduction}
\label{sec:orgd90ac1b}
\begin{itemize}
...
\caption[TCA]{\label{fig:org80df84a}
Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\begin{enumerate}
\item Disorders of the TCA cycle
\label{sec:orgd280632}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org44f4c1c}
\begin{itemize}
\item similar to PDHC (section \ref{sec:org4c1be1e})
...
\item Genetics
\label{sec:orgab3c82a}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\item Diagnostic Tests
\label{sec:org72257e2}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\caption{\label{fig:org2167c8d}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org9715c6a}
\begin{itemize}
...
\caption{\label{fig:org5153d67}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:orgf1561df}
\begin{itemize}
...
\label{sec:org51795f7}
\subsection{Introduction}
\label{sec:orgc7cbf8d}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:orgf6893cb})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of Complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:org16556db})
...
\caption[ETC]{\label{fig:orgf6893cb}
...
\caption[redox]{\label{fig:orga1a716b}
Electron flow to O\(_{\text{2}}\) and release free energy}
\end{figure}

\begin{enumerate}
\item Complex I
\label{sec:orgdea9e60}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:orgd506dc1})
...
\caption[c1]{\label{fig:orgd506dc1}
Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\item Complex II
\label{sec:orgc5de676}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:orgf32cc6e}
\end{itemize}
\end{itemize}

\item Glycerol-3-phosphate shuttle
\label{sec:orge0eaf01}
\begin{itemize}
...
\caption[cIV]{\label{fig:orga5276f0}
Complex IV | Cytochrome c oxidase}
\end{figure}
\end{itemize}

\item Complex V
\label{sec:orgf2cb524}
\begin{itemize}
...
\label{sec:orgf13b4f9}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:org5ada253})
\begin{enumerate}
...
\caption[ETC]{\label{fig:org5ada253}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:org7e1f022})
...
\label{sec:orgad9286e}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:org64572a7}
\begin{itemize}
...
\label{sec:org1f9ed79}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:orgb365c2b}
\begin{itemize}
...
\label{sec:org80d1b6a}
\begin{itemize}
\item CII is encoded my nuclear DNA (Table \ref{tab:org16556db})
\begin{itemize}
...
\caption[rrf]{\label{fig:org11baf78}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:org83fc96f}
\begin{itemize}
...
\label{sec:org1b05616}
\subsection{Introduction}
\label{sec:org2dc90b3}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org56016e8}
\begin{enumerate}
\item HMG-CoA Synthase Deficiency
\label{sec:orga408baf}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org81fe817}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org151ad03}
\begin{itemize}
...
\end{enumerate}
\section{Creatine}
\label{sec:org1bbbe42}
\subsection{Introduction}
\label{sec:org105774b}
\begin{itemize}
...
\caption{\label{fig:org060564e}
Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:orgeb863f3}
\begin{itemize}
