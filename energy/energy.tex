...
\label{sec:orga5151ba}
\subsection{Cellular Redox State}
\label{sec:orgb814d5f}
\begin{itemize}
...
\label{sec:org1b952e7}
\subsection{Introduction}
\label{sec:org5ec73a3}
\begin{itemize}
...
\label{sec:org5b92a25}
\begin{itemize}
\item involves three processes (Figure \ref{fig:orgc6f96d5})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:org5ba8eb3})
\begin{itemize}
...
and the \(\beta\) carbon atoms by acyl-CoA dehydrogenase (Table \ref{tab:orgf18cde2})
\begin{itemize}
...
\caption{\label{fig:orgc6f96d5}Fatty Acid \(\beta\)-Oxidation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/Slide12.png}
\caption{\label{fig:org53bde71}Fatty Acid \(\beta\)-Oxidation and Ketone Body Metabolism}
\end{figure}
...
\caption{\label{fig:org5ba8eb3}Fatty Acid \(\beta\)-Oxidation}
\end{figure}



\begin{table}[htbp]
\caption{\label{tab:orgf18cde2}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\end{itemize}
\begin{itemize}
\item summarized in table \ref{tab:orgca83f98}
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgca83f98}Common Manifestations in FAODs}
\centering
...
\item Genetics
\label{sec:orgff9f04f}
\begin{itemize}
\item AR OCTN2
\end{itemize}
\item Diagnostic Tests
\label{sec:org9bc434b}
\begin{itemize}
...
\caption{\label{fig:orgdcc98ae}CPT1 (OMM) \& CPTII (IMM)}
\end{figure}

\item Genetics
\label{sec:orgc693639}
\begin{itemize}
\item AR CPT1A
...
\label{sec:orga3930a3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb74c617}
\begin{itemize}
...
\caption{\label{fig:org07d2f28}Carnitine Acylcarnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org327f513}
\begin{itemize}
\item AR SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:orgc9a2cfe}
\begin{itemize}
...
\label{sec:orgeffa940}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb149f6b}
\begin{enumerate}
\item Neonatal
\label{sec:org143fad8}
\begin{itemize}
...
(Figure \ref{fig:orgdcc98ae})
\end{itemize}
\item Genetics
\label{sec:org9e315d5}
\begin{itemize}
\item AR CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:orgfa98d6e}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:org98dffb2}
\subsubsection{Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency}
\label{sec:org7b78b05}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge16b334}
\begin{enumerate}
\item Infancy
\label{sec:org6472c8e}
\begin{itemize}
...
steps in the \(\beta\)-oxidation of fatty acids (Table \ref{tab:orgf18cde2})
...
\caption{\label{fig:org8cdebdf}VLCAD Reaction}
\end{figure}

\item Genetics
\label{sec:orgaa290fd}
\begin{itemize}
\item AR ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org00a1f97}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org4e28795}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6581af9}
\begin{itemize}
...
\item Genetics
\label{sec:org261b56d}
\begin{itemize}
\item AR HADHA, HADHB
\end{itemize}

\item Diagnostic Tests
\label{sec:org59d4f98}
\begin{itemize}
...
\label{sec:orgf6754f5}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5caa3b5}
\begin{itemize}
...
(Figure \ref{fig:org5f87bb6})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{fao/figures/lchad.png}
\caption{\label{fig:org5f87bb6}LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:org2903a8d}
\begin{itemize}
\item AR HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:org6c4877d}
\begin{itemize}
\item \(\uparrow\) lactate \(\because\) 3-OH-palmitoyl-CoA inhibits PDH
\item \(\uparrow\) hydroxy-acylcarnitines
\begin{itemize}
...
\label{sec:org965b1b4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3e1b681}
\begin{itemize}
...
\item Genetics
\label{sec:org67961e5}
\begin{itemize}
\item AR ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:orgee92ca4}
\begin{itemize}
...
\caption{\label{fig:org32facdb}Multiple Acyl-CoA Dehydrogenase Deficiency}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/etf.png}
\caption{\label{fig:org8a98e2a}Role of ETF and ETF-QO}
\end{figure}

\item Genetics
\label{sec:org80b0ed3}
\begin{itemize}
\item AR ETFA, ETFB, ETFDH
\end{itemize}

\item Diagnostic Tests
\label{sec:org008fb8a}
\begin{itemize}
\item plasma acylcarnitines
\begin{itemize}
\item \(\uparrow\) C4-C18
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org9d01d74}
\subsection{Introduction}
\label{sec:org8433857}
\begin{itemize}
...
\caption[TCA]{\label{fig:org1c3f291}Disorders of Pyruvate Metabolism}
\end{figure}
...
\caption[TCA]{\label{fig:orgad12b6d}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Reactions involving Pyruvate}
\label{sec:org5aa313c}
...
\begin{table}[htbp]
\caption{\label{tab:org67e106f}Pyruvate Dehydrogenases Complex}
\centering
\begin{tabular}{llll}
...
\caption[pdhe1]{\label{fig:org7329808}Activation/Deactivation of PDH E1}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{pyruvate/figures/pdhc.png}
\caption[pdhc]{\label{fig:org527e66e}Pyruvate Dehydrogenase Complex}
\end{figure}
...
dephosphorylated (active) (Figure \ref{fig:org7329808})
\end{itemize}

\subsubsection{Pyruvate Transport Defect}
\label{sec:org4d64537}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:orgb467af6}
\begin{itemize}
\item AR DLD
\end{itemize}
\subsubsection{Diagnostic Testing}
\label{sec:orgd715b11}
\begin{itemize}
...
\label{sec:org0b11530}
\subsection{Introduction}
\label{sec:orgf0eaa42}
\begin{itemize}
...
\caption[TCA]{\label{fig:org98e3ba3}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Disorders of the TCA cycle}
\label{sec:org76a631d}
...
\begin{table}[htbp]
\caption{\label{tab:org208b0d4}\(\alpha\)-Ketoglutarate Dehydrogenase Complex}
\centering
\begin{tabular}{llll}
Unit & Name & Gene & Cofactor\\
\hline
...
\subsubsection{Clinical Presentation}
\label{sec:orgcc8902a}
\begin{itemize}
\item similar to PDHC (section \ref{sec:org8ffe45e})
...
\subsubsection{Genetics}
\label{sec:org1651c57}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org5d96cc7}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org641d6af}
\begin{itemize}
\item none
\end{itemize}
\subsection{Succinate Dehydrogenase Deficiency}
\label{sec:org6d88382}
\begin{itemize}
\item four subunits compose Complex II of the mitochondrial respiratory
chain (Table \ref{tab:orgdf880d0})
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgdf880d0}Succinate Dehydrogenase | Complex II}
\centering
\begin{tabular}{ll}
Subunit & Description\\
\hline
...
\caption{\label{fig:orgae3e2b4}Succinate Dehydrogenase | Complex II}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:org52b77a1}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge276e03}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:orgd6414fa})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgd6414fa}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\label{sec:org38ba897}
\subsection{Introduction}
\label{sec:org4a90c7e}
\begin{itemize}
...
series of electron carriers (Figures \ref{fig:orgec22355} and \ref{fig:orgdaa43f0})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:org049db69})
...
\caption{\label{fig:orgec22355}Flow of Electrons in the ETC}
\end{figure}
...
\item ETF-QO and mitochondrial glycerol-3-P dehydrogenase (GPD) are part of ETC (Figure \ref{fig:orgec22355})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org049db69}Location of DNA Encoding OxPhos Complex Subunits}
\centering
...
\caption[ETC]{\label{fig:orgdaa43f0}Oxidative Phosphorylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{oxphos/figures/potential.png}
\caption[redox]{\label{fig:org1cd7acd}Electron Flow to O\textsubscript{2} and Release of Free Energy}
\end{figure}

\subsubsection{Complex I}
\label{sec:orgdc69fda}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:org574bf24})
...
\caption[c1]{\label{fig:org574bf24}Complex I | NADH-Ubiquinone Oxidoreductase}
\end{figure}

\subsubsection{Complex II}
\label{sec:org7bba5d3}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org6d88382}
\end{itemize}
\end{itemize}

\subsubsection{Glycerol-3-Phosphate Shuttle}
\label{sec:orgbdbad59}
\begin{itemize}
...
\caption[g3ps]{\label{fig:org9f59332}Glycerol-3-Phosphate Shuttle}
\end{figure}

\subsubsection{Electron Transferring Flavoprotein/ Dehydrogenase}
\label{sec:org0f15836}
\begin{itemize}
...
\caption[cIV]{\label{fig:orgad208c6}Complex IV | Cytochrome C Oxidase}
\end{figure}
\end{itemize}

\subsubsection{Complex V}
\label{sec:org9b9551c}
\begin{itemize}
...
\caption{\label{fig:orgebe2b86}Complex V | ATP Synthase}
\end{figure}
\end{itemize}
\end{itemize}

\subsection{Clinical Presentation}
\label{sec:org6e3662d}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:org128d6d5})
\begin{enumerate}
...
\caption[ETC]{\label{fig:org128d6d5}Pathogenesis of OxPhos Disorders}
\end{figure}
...
\caption{\label{fig:orge071116}mtDNA Disorders}
\end{figure}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:org3825c11})
...
\begin{table}[htbp]
\caption{\label{tab:org3825c11}Clinical Features of Mitochondrial Disease}
\centering
\begin{tabular}{ll}
...
\label{sec:org19901f2}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:org6d57aa9}
\begin{itemize}
...
\label{sec:org9d29332}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:org9a8667d}
\begin{itemize}
...
\label{sec:org7455ea5}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{oxphos/figures/algorithm_rot.png}
\caption{\label{fig:org54307d5}Diagnosis of Mitochondrial Disease}
\end{figure}


\subsubsection{Biochemistry}
\label{sec:orgbb0e2c6}
\begin{itemize}
...
\label{sec:org93c2e3a}
\begin{itemize}
\item CII is encoded by nuclear DNA (Table \ref{tab:org049db69})
\begin{itemize}
...
\caption[rrf]{\label{fig:org55e8495}Ragged Red Fibers - Gomori Stain}
\end{figure}

\subsubsection{Molecular}
\label{sec:orgdcf5e51}
\begin{itemize}
...
\label{sec:org5504f73}
\subsection{Introduction}
\label{sec:orgba390f8}
\begin{itemize}
...
\caption{\label{fig:orga95547f}Ketogenesis and Ketolysis}
\end{figure}
...
\subsubsection{Clinical Presentation}
\label{sec:org63c4366}
\begin{table}[htbp]
\caption{\label{tab:orgc46db4b}Common Manifestations in Ketogenesis Defects}
\centering
\begin{tabular}{llllll}
FAOD & sudden & fasting & skeletal & cardio- & liver\\
 & death & intolerance & myopathy & myopathy & disease\\
...
\subsubsection{Diagnostic Tests}
\label{sec:org86d177d}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:orgb2469f5}
\begin{itemize}
...
\caption{\label{fig:org87db90f}Metabolic Pathway of Creatine/Creatine Phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Slide16.png}
\caption{\label{fig:org23db6ff}Metabolic Pathway of Creatine/Creatine Phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Creatinesynthesis.png}
\caption{\label{fig:org0f209dd}Creatine Synthesis}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:orgf3e3c2b}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org4a52279}Urine Findings in CDS}
\centering
\begin{tabular}{lll}
