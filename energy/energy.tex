...
\label{sec:orgd07eb4a}
\subsection{Cellular Redox State}
\label{sec:org1f30d66}
\begin{itemize}
...
\label{sec:org3ac1afd}
\subsection{Introduction}
\label{sec:orgbacf0e9}
\begin{itemize}
...
\label{sec:org2f8079f}
\begin{itemize}
\item involves three processes (Figure \ref{fig:org9261da7})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:org9fba0bb})
\begin{itemize}
...
\caption{\label{fig:org9261da7}Fatty Acid Oxidation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/Slide12.png}
\caption{\label{fig:orge4387dc}Fatty Acid Oxidation and Ketone Body Metabolism}
\end{figure}
...
\caption{\label{fig:org9fba0bb}Fatty Acid \(\beta\)-Oxidation}
\end{figure}


\begin{table}[htbp]
\caption{\label{tab:org7ddc3f5}Acyl-CoA Synthetases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\begin{table}[htbp]
\caption{\label{tab:org703c122}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
Enzyme & Length & location\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orgea0a6c0}Other: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\begin{table}[htbp]
\caption{\label{tab:org12cc76a}Common manifestations in FAODs}
\centering
...
\caption{\label{fig:orgf289144}CPT1 (OMM) \& CPTII (IMM)}
\end{figure}

\item Genetics
\label{sec:org8db00a7}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:orgcaaa27a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgfc38a9b}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org2203165}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:org22ca494})
...
\caption{\label{fig:org22ca494}Carnitine Acylcarnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org6683de9}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:orgc9548a2}
\begin{itemize}
...
\label{sec:orge28c4dc}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2358366}
\begin{enumerate}
\item Neonatal
\label{sec:org73c78fd}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:orgf289144})
\end{itemize}
\item Genetics
\label{sec:org22ddf67}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org0e58ab5}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:org4b717f8}
\subsubsection{Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency}
\label{sec:org2f5009f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org12e612a}
\begin{enumerate}
\item Infancy
\label{sec:orgf4a3772}
\begin{itemize}
...
\caption{\label{fig:org6bd107c}VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:orgfd8d056}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org6adc10a}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org7f86eb6}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org7dc429c}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org680a382}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:org49aa872}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:org5ee5f39}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4ae959d}
\begin{itemize}
...
(Figure \ref{fig:org2ab53db})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{fao/figures/lchad.png}
\caption{\label{fig:org2ab53db}LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:org0c4ba3b}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:orgb5180c8}
\begin{itemize}
...
\label{sec:orgb26c8c2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org65ff6bd}
\begin{itemize}
...
\item Genetics
\label{sec:orga462bd9}
\begin{itemize}
\item AR ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:orgba58075}
\begin{itemize}
...
\caption{\label{fig:orge2a034f}Multiple Acyl-CoA Dehydrogenase Deficiency}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/etf.png}
\caption{\label{fig:org7e0572d}Role of ETF and ETF-QO}
\end{figure}

\item Genetics
\label{sec:org04f6c1b}
\begin{itemize}
\item AR ETFA, ETFB, ETFDH
\end{itemize}

\item Diagnostic Tests
\label{sec:orgef599cc}
\begin{itemize}
\item plasma acylcarnitines
\begin{itemize}
\item \(\uparrow\) C4-C18
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org841dd0e}
\subsection{Introduction}
\label{sec:org135d354}
\begin{itemize}
...
\caption[TCA]{\label{fig:org7818c4f}Disorders of Pyruvate Metabolism}
\end{figure}
...
\caption[TCA]{\label{fig:org4784eb6}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Reactions involving Pyruvate}
\label{sec:org4d11933}
...
\begin{table}[htbp]
\caption{\label{tab:orgc9717f6}Pyruvate Dehydrogenases Complex}
\centering
\begin{tabular}{llll}
...
\caption[pdhe1]{\label{fig:org68d0e58}Activation/deactivation of PDHE1}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{pyruvate/figures/pdhc.png}
\caption[pdhc]{\label{fig:orgc8ebfab}Pyruvate Dehydrogenase Complex}
\end{figure}
...
dephosphorylated (active) (Figure \ref{fig:org68d0e58})
\end{itemize}

\subsubsection{Pyruvate Transport Defect}
\label{sec:orgcb13061}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org930261e}
\begin{itemize}
\item AR DLD
\end{itemize}
\subsubsection{Diagnostic Testing}
\label{sec:org5d11253}
\begin{itemize}
\item combined PDHC, TCA, BCAA defect
\begin{itemize}
...
\label{sec:org5990ec2}
\subsection{Introduction}
\label{sec:org8ede549}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgd8377ca}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Disorders of the TCA cycle}
\label{sec:orgf4f7eae}
...
\begin{table}[htbp]
\caption{\label{tab:org1a4d02d}\(\alpha\)-Ketoglutarate Dehydrogenase Complex}
\centering
\begin{tabular}{llll}
Unit & Name & Gene & Cofactor\\
\hline
...
\subsubsection{Clinical Presentation}
\label{sec:orge3434d9}
\begin{itemize}
\item similar to PDHC (section \ref{sec:org9b304de})
...
\subsubsection{Genetics}
\label{sec:org5dbc022}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org7abd03a}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\caption{\label{fig:org7205a28}Succinate Dehydrogenase | Complex II}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:orgb6d6506}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orge9ab4ff}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:org11801fb})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org11801fb}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\label{sec:org9411407}
\subsection{Introduction}
\label{sec:org66a562f}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:org43de893} and \ref{fig:org8d171fa})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of Complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:orga893927})
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.1\textwidth]{./figures/etc.pdf}
\caption{\label{fig:org43de893}Flow of electrons in the ETC}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:orga893927}Location of DNA encoding OxPhos Complex Subunits}
\centering
...
\caption[ETC]{\label{fig:org8d171fa}Oxidative Phosphorylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{oxphos/figures/potential.png}
\caption[redox]{\label{fig:org6dbf695}Electron flow to O\textsubscript{2} and release free energy}
\end{figure}

\subsubsection{Complex I}
\label{sec:org7bd4424}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:orga0c6500})
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./figures/c1.pdf}
\caption[c1]{\label{fig:orga0c6500}Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\subsubsection{Complex II}
\label{sec:orgbc30958}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org846d98f}
\end{itemize}
\end{itemize}

\subsubsection{Glycerol-3-phosphate shuttle}
\label{sec:org57966d4}
\begin{itemize}
...
\caption[g3ps]{\label{fig:orgf397e1e}Glycerol-3-phosphate shuttle}
\end{figure}

\subsubsection{Electron Transferring Flavoprotein/ Dehydrogenase}
\label{sec:org063f9f3}
\begin{itemize}
...
\caption[cIV]{\label{fig:org4c71177}Complex IV | Cytochrome c oxidase}
\end{figure}
\end{itemize}

\subsubsection{Complex V}
\label{sec:org45504eb}
\begin{itemize}
...
\caption{\label{fig:org99e5b39}Complex V | ATP synthase}
\end{figure}
\end{itemize}
\end{itemize}

\subsection{Clinical Presentation}
\label{sec:org33e2c6d}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:orgc20741e})
\begin{enumerate}
...
\caption[ETC]{\label{fig:orgc20741e}Pathogenesis of OxPhos Disorders}
\end{figure}
...
\caption{\label{fig:org5f89671}mtDNA disorders}
\end{figure}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:org3249281})
...
\begin{table}[htbp]
\caption{\label{tab:org3249281}Clinical Features of Mitochondrial Disease}
\centering
\begin{tabular}{ll}
...
\label{sec:org38604cb}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:org0e6a64b}
\begin{itemize}
...
\label{sec:org5ea4854}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:org3ba198a}
\begin{itemize}
...
\label{sec:orgbafefe4}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{oxphos/figures/algorithm_rot.png}
\caption{\label{fig:org38aee7c}Diagnosis of Mitochondrial Disease}
\end{figure}


\subsubsection{Biochemistry}
\label{sec:org0efddfa}
\begin{itemize}
...
\label{sec:org2990373}
\begin{itemize}
\item CII is encoded by nuclear DNA (Table \ref{tab:orga893927})
\begin{itemize}
...
\caption[rrf]{\label{fig:orgd45a4e0}Ragged red fibers - Gomori stain}
\end{figure}

\subsubsection{Molecular}
\label{sec:org85bde47}
\begin{itemize}
...
\label{sec:org95156b3}
\subsection{Introduction}
\label{sec:orgb1d3213}
\begin{itemize}
...
\caption{\label{fig:orgf14b83d}Ketogenesis and Ketolysis}
\end{figure}
...
\subsubsection{Clinical Presentation}
\label{sec:org39590b7}
\begin{table}[htbp]
\caption{\label{tab:org2150c78}Common Manifestations in Ketogenesis Defects}
\centering
\begin{tabular}{llllll}
FAOD & sudden & fasting & skeletal & cardio- & liver\\
 & death & intolerance & myopathy & myopathy & disease\\
...
\subsubsection{Diagnostic Tests}
\label{sec:org4bc5668}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:orgbb7cd67}
\begin{itemize}
...
\caption{\label{fig:orgf1057ae}Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Slide16.png}
\caption{\label{fig:orgec3574b}Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org4e5eac5}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:org48d27d9}
\begin{itemize}
\item global developmental delay (GDD) / intellectual disability (ID)
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org12d6165}Urine findings in CDS}
\centering
\begin{tabular}{lll}
