...
\label{sec:org70d8f2e}
\subsection{Cellular RedOx State}
\label{sec:org3a60e02}
\begin{itemize}
...
\label{sec:org41ddb1e}
\subsection{Introduction}
\label{sec:org289b7a2}
\begin{itemize}
...
\label{sec:orgd0e919d}

\begin{itemize}
\item involves three processes (Figure \ref{fig:orgf8c5349})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:org26dc9af})
\begin{itemize}
...
\caption{\label{fig:org7b85b35}
CPT1}
\end{figure}

\item Genetics
\label{sec:orgad634aa}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:org32c9e93}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org3a46886}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:orgb6dda82}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:org4fdbbc6})
...
\caption{\label{fig:org4fdbbc6}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:orgb0d5cd7}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:org80a3c70}
\begin{itemize}
...
\label{sec:org3c0705e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc77e31c}
\begin{enumerate}
\item Neonatal
\label{sec:org6c3d581}
\begin{itemize}
...
then undergo \(\beta\)-oxidation (Figure \ref{fig:org7b85b35})
\end{itemize}
\item Genetics
\label{sec:orge6e2d5d}
\begin{itemize}
\item AR, CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:orgf486f55}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:org3e717ac}
\begin{enumerate}
\item Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency
\label{sec:orgddffebc}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd43d279}
\begin{enumerate}
\item Infancy
\label{sec:orgd6f1f4e}
\begin{itemize}
...
\caption{\label{fig:orgb8ab721}
VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:org5bf1636}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org6754270}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org3cc8975}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2c27415}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:orgd2f4c88}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:org6899e25}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:org28ed21d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org24c2979}
\begin{itemize}
...
(Figure \ref{fig:org8ee2b22})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./fao/figures/lchad.png}
\caption{\label{fig:org8ee2b22}
LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:org1b7b647}
\begin{itemize}
\item AR, HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:org30473c3}
\begin{itemize}
...
\label{sec:orge491535}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org1ec7704}
\begin{itemize}
...
\item Genetics
\label{sec:orgf867b45}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:orgadcad49}
\begin{itemize}
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org9d14413}
\subsection{Introduction}
\label{sec:orgeff8d05}
\begin{itemize}
...
\caption[TCA]{\label{fig:org631c1fb}
...
\caption[pdhe1]{\label{fig:org424c923}
...
\caption[pdhc]{\label{fig:org639ca95}
...
dephosphorylated (active) (Figure \ref{fig:org424c923})
\end{itemize}

\item Pyruvate Transport Defect
\label{sec:orgb910e1e}
\begin{itemize}
...
\label{sec:org674ba9b}
\subsection{Introduction}
\label{sec:org95e17d8}
\begin{itemize}
...
\caption[TCA]{\label{fig:org0ea50f2}
Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\begin{enumerate}
\item Disorders of the TCA cycle
\label{sec:org570de13}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgdeaa8ae}
\begin{itemize}
\item similar to PDHC (section \ref{sec:org2c00e0a})
...
\item Genetics
\label{sec:org83b4b18}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\item Diagnostic Tests
\label{sec:org7bab770}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\caption{\label{fig:org4246ce4}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org09f55a8}
\begin{itemize}
...
\caption{\label{fig:orgb9bb02b}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org8075393}
\begin{itemize}
...
\label{sec:org92ef71e}
\subsection{Introduction}
\label{sec:orgafa96d6}
\begin{itemize}
...
series of electron carriers (Figure \ref{fig:orga9883d1})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of Complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:org05eb3b8})
...
\caption[ETC]{\label{fig:orga9883d1}
...
\caption[redox]{\label{fig:org4adfd79}
Electron flow to O\(_{\text{2}}\) and release free energy}
\end{figure}

\begin{enumerate}
\item Complex I
\label{sec:org8411095}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:org7e60c6e})
...
\caption[c1]{\label{fig:org7e60c6e}
Complex I | NADH-ubiquinone oxidoreductase}
\end{figure}

\item Complex II
\label{sec:org6dc2416}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org6efaf9e}
\end{itemize}
\end{itemize}

\item Glycerol-3-phosphate shuttle
\label{sec:org184fc09}
\begin{itemize}
...
\caption[cIV]{\label{fig:org5f94318}
Complex IV | Cytochrome c oxidase}
\end{figure}
\end{itemize}

\item Complex V
\label{sec:orgb2dba8f}
\begin{itemize}
...
\label{sec:org396b674}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:orgc6fe3c3})
\begin{enumerate}
...
\caption[ETC]{\label{fig:orgc6fe3c3}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:orgf41ada4})
...
\label{sec:org53bb440}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:org2a930ca}
\begin{itemize}
...
\label{sec:org616e45c}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:org183e875}
\begin{itemize}
...
\label{sec:orge4acd63}
\begin{itemize}
\item CII is encoded my nuclear DNA (Table \ref{tab:org05eb3b8})
\begin{itemize}
...
\caption[rrf]{\label{fig:org09f3af6}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:orgeb043a2}
\begin{itemize}
...
\label{sec:org41ecfc2}
\subsection{Introduction}
\label{sec:org5ee8ff6}
\begin{itemize}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgaea2ebd}
\begin{enumerate}
\item HMG-CoA Synthase Deficiency
\label{sec:org5b1479b}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:orgdf24029}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org923fc99}
\begin{itemize}
...
\end{enumerate}
\section{Creatine}
\label{sec:org9fa1269}
\subsection{Introduction}
\label{sec:orgec60fc5}
\begin{itemize}
...
\caption{\label{fig:orgfa1b5ac}
Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org032839f}
\begin{itemize}
