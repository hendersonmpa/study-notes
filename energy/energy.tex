...
\label{sec:orga8f45c4}
\subsection{Cellular Redox State}
\label{sec:org6d8276b}
\begin{itemize}
...
\label{sec:org97aa35b}
\subsection{Introduction}
\label{sec:org66b10af}
\begin{itemize}
...
\label{sec:orgd1b1d93}
\begin{itemize}
\item involves three processes (Figure \ref{fig:org4cbdb3a})
\begin{enumerate}
...
matrix
\end{itemize}
\item \(\beta\)-oxidation via a spiral pathway (Figure \ref{fig:orgf9c1670})
\begin{itemize}
...
and the \(\beta\) carbon atoms by acyl-CoA dehydrogenase (Table \ref{tab:org9005649})
\begin{itemize}
...
\caption{\label{fig:org4cbdb3a}Fatty Acid Oxidation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/Slide12.png}
\caption{\label{fig:orgf27f341}Fatty Acid Oxidation and Ketone Body Metabolism}
\end{figure}
...
\caption{\label{fig:orgf9c1670}Fatty Acid \(\beta\)-Oxidation}
\end{figure}



\begin{table}[htbp]
\caption{\label{tab:org9005649}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\end{itemize}
\begin{itemize}
\item summarized in table \ref{tab:orgddb9bd1}
\end{itemize}
\begin{center}
...
\item Genetics
\label{sec:orge779c92}
\begin{itemize}
\item AR OCTN2
\end{itemize}
\item Diagnostic Tests
\label{sec:org6bc948e}
\begin{itemize}
...
\caption{\label{fig:orgb939847}CPT1 (OMM) \& CPTII (IMM)}
\end{figure}

\item Genetics
\label{sec:org08595a4}
\begin{itemize}
\item AR CPT1A
...
\label{sec:orgffb304e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4bbde78}
\begin{itemize}
...
\caption{\label{fig:orgfd3215d}Carnitine Acylcarnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org008cae9}
\begin{itemize}
\item AR SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:orga53f622}
\begin{itemize}
...
\label{sec:orgcd6a24a}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org56d2610}
\begin{enumerate}
\item Neonatal
\label{sec:org1c07663}
\begin{itemize}
...
(Figure \ref{fig:orgb939847})
\end{itemize}
\item Genetics
\label{sec:org052b035}
\begin{itemize}
\item AR CPT2
\end{itemize}
\item Diagnostic Tests
\label{sec:org3315e1b}
\begin{itemize}
\item \(\downarrow\) total carnitine
...
\label{sec:orgf95ae81}
\subsubsection{Very-Long-Chain Acyl-CoA Dehydrogenase Deficiency}
\label{sec:orge7a5997}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgbed41e2}
\begin{enumerate}
\item Infancy
\label{sec:orgddb5f63}
\begin{itemize}
...
steps in the \(\beta\)-oxidation of fatty acids (Table \ref{tab:org9005649})
...
\caption{\label{fig:org9f84513}VLCAD reaction}
\end{figure}

\item Genetics
\label{sec:org46ef266}
\begin{itemize}
\item AR ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org979189d}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org01c08bc}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org78dd369}
\begin{itemize}
...
\item Genetics
\label{sec:orge7c6eb4}
\begin{itemize}
\item AR HADHA, HADHB
\end{itemize}

\item Diagnostic Tests
\label{sec:orgfba97cc}
\begin{itemize}
...
\label{sec:org269fc8d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org4511225}
\begin{itemize}
...
(Figure \ref{fig:org7d798c9})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{fao/figures/lchad.png}
\caption{\label{fig:org7d798c9}LCHAD reaction}
\end{figure}

\item Genetics
\label{sec:orgff915e7}
\begin{itemize}
\item AR HADHA
\end{itemize}

\item Diagnostic Tests
\label{sec:orgff7585e}
\begin{itemize}
\item \(\uparrow\) lactate \(\because\) 3-OH-palmitoyl-CoA inhibits PDH
\item \(\uparrow\) hydroxy-acylcarnitines
\begin{itemize}
...
\label{sec:org618a1b6}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5507c02}
\begin{itemize}
...
\item Genetics
\label{sec:org985b481}
\begin{itemize}
\item AR ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org97ad469}
\begin{itemize}
...
\caption{\label{fig:orgd348c38}Multiple Acyl-CoA Dehydrogenase Deficiency}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/etf.png}
\caption{\label{fig:org573a049}Role of ETF and ETF-QO}
\end{figure}

\item Genetics
\label{sec:org614cbe3}
\begin{itemize}
\item AR ETFA, ETFB, ETFDH
\end{itemize}

\item Diagnostic Tests
\label{sec:orgf80769d}
\begin{itemize}
\item plasma acylcarnitines
\begin{itemize}
\item \(\uparrow\) C4-C18
...
\end{enumerate}
\section{Pyruvate}
\label{sec:orgc070f25}
\subsection{Introduction}
\label{sec:orgf562f6e}
\begin{itemize}
...
\caption[TCA]{\label{fig:org0f8538b}Disorders of Pyruvate Metabolism}
\end{figure}
...
\caption[TCA]{\label{fig:orga539080}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Reactions involving Pyruvate}
\label{sec:orgcd5b40a}
...
\begin{table}[htbp]
\caption{\label{tab:orgdf89e5e}Pyruvate Dehydrogenases Complex}
\centering
\begin{tabular}{llll}
...
\caption[pdhe1]{\label{fig:org743d5fc}Activation/deactivation of PDH E1}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{pyruvate/figures/pdhc.png}
\caption[pdhc]{\label{fig:org42a00a7}Pyruvate Dehydrogenase Complex}
\end{figure}
...
dephosphorylated (active) (Figure \ref{fig:org743d5fc})
\end{itemize}

\subsubsection{Pyruvate Transport Defect}
\label{sec:org7d0c85c}
\begin{itemize}
...
\end{itemize}
\subsubsection{Genetics}
\label{sec:org76e0c03}
\begin{itemize}
\item AR DLD
\end{itemize}
\subsubsection{Diagnostic Testing}
\label{sec:org834ff25}
\begin{itemize}
...
\label{sec:orge3cb73b}
\subsection{Introduction}
\label{sec:org1cb6a4f}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgc670d2e}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Disorders of the TCA cycle}
\label{sec:org04f14cb}
...
\begin{table}[htbp]
\caption{\label{tab:org8e1bf83}\(\alpha\)-Ketoglutarate Dehydrogenase Complex}
\centering
\begin{tabular}{llll}
Unit & Name & Gene & Cofactor\\
\hline
...
\subsubsection{Clinical Presentation}
\label{sec:orgf2f62f1}
\begin{itemize}
\item similar to PDHC (section \ref{sec:org02c78e2})
...
\subsubsection{Genetics}
\label{sec:org1f1ccfa}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org2e6a91e}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\subsubsection{Treatment}
\label{sec:org9fa2cd7}
\begin{itemize}
\item none
\end{itemize}
\subsection{Succinate Dehydrogenase Deficiency}
\label{sec:org73bef41}
\begin{itemize}
\item four subunits compose Complex II of the mitochondrial respiratory
chain (Table \ref{tab:orgfee2ef4})
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orgfee2ef4}Succinate Dehydrogenase | Complex II}
\centering
\begin{tabular}{ll}
Subunit & Description\\
\hline
...
\caption{\label{fig:orga78d48d}Succinate Dehydrogenase | Complex II}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:orgf72c608}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:orgd713d6c}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:org19f4deb})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org19f4deb}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\label{sec:org64e411b}
\subsection{Introduction}
\label{sec:org767b370}
\begin{itemize}
...
series of electron carriers (Figures \ref{fig:org09b09fc} and \ref{fig:org5d52293})
\item responsible for ATP production
\item ETC complexes I-IV
\item OxPhos system complexes I-V
\item \textasciitilde{} 90 subunits
\item 13 subunits of complexes I, III, IV and V encoded by mtDNA (Table \ref{tab:orgcec1291})
...
\caption{\label{fig:org09b09fc}Flow of Electrons in the ETC}
\end{figure}
...
\item ETF-QO and mitochondrial glycerol-3-P dehydrogenase (GPD) are part of ETC (Figure \ref{fig:org09b09fc})
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orgcec1291}Location of DNA Encoding OxPhos Complex Subunits}
\centering
...
\caption[ETC]{\label{fig:org5d52293}Oxidative Phosphorylation}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{oxphos/figures/potential.png}
\caption[redox]{\label{fig:orge7195cd}Electron Flow to O\textsubscript{2} and Release of Free Energy}
\end{figure}

\subsubsection{Complex I}
\label{sec:org89a4fde}
\begin{itemize}
...
oxidation to ubiquinone (Figure \ref{fig:org3a41f8a})
...
\caption[c1]{\label{fig:org3a41f8a}Complex I | NADH-Ubiquinone Oxidoreductase}
\end{figure}

\subsubsection{Complex II}
\label{sec:org4bc9f80}
\begin{itemize}
\item AKA Succinate Dehydrogenase 
\begin{itemize}
\item see section \ref{sec:org73bef41}
\end{itemize}
\end{itemize}

\subsubsection{Glycerol-3-Phosphate Shuttle}
\label{sec:org1d257f3}
\begin{itemize}
...
\caption[g3ps]{\label{fig:org305979e}Glycerol-3-Phosphate Shuttle}
\end{figure}

\subsubsection{Electron Transferring Flavoprotein/ Dehydrogenase}
\label{sec:org282a9fa}
\begin{itemize}
...
\caption[cIV]{\label{fig:org29a0590}Complex IV | Cytochrome C Oxidase}
\end{figure}
\end{itemize}

\subsubsection{Complex V}
\label{sec:org2ca5e46}
\begin{itemize}
...
\caption{\label{fig:org1c49abd}Complex V | ATP Synthase}
\end{figure}
\end{itemize}
\end{itemize}

\subsection{Clinical Presentation}
\label{sec:orgcad742a}
\begin{itemize}
\item molecular pathogenesis of OxPhos disorders (Figure \ref{fig:org75303c5})
\begin{enumerate}
...
\caption[ETC]{\label{fig:org75303c5}Pathogenesis of OxPhos Disorders}
\end{figure}
...
\caption{\label{fig:org67c1c33}mtDNA Disorders}
\end{figure}
...
\begin{enumerate}
\item constellation of symptoms/signs consistent with a mitochondrial syndrome (Table \ref{tab:org031ce5e})
...
\begin{table}[htbp]
\caption{\label{tab:org031ce5e}Clinical Features of Mitochondrial Disease}
\centering
\begin{tabular}{ll}
...
\label{sec:org3c3e72c}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:orgf6ca70a}
\begin{itemize}
...
\label{sec:orgacbd137}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:org6fffda1}
\begin{itemize}
...
\label{sec:orgacda04f}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{oxphos/figures/algorithm_rot.png}
\caption{\label{fig:org77a836d}Diagnosis of Mitochondrial Disease}
\end{figure}


\subsubsection{Biochemistry}
\label{sec:org76c4c95}
\begin{itemize}
...
\label{sec:org18f605a}
\begin{itemize}
\item CII is encoded by nuclear DNA (Table \ref{tab:orgcec1291})
\begin{itemize}
...
\caption[rrf]{\label{fig:org934b388}Ragged Red Fibers - Gomori Stain}
\end{figure}

\subsubsection{Molecular}
\label{sec:org557a075}
\begin{itemize}
...
\label{sec:orgad9d601}
\subsection{Introduction}
\label{sec:org39f0505}
\begin{itemize}
...
\caption{\label{fig:org6bd410e}Ketogenesis and Ketolysis}
\end{figure}
...
\subsubsection{Clinical Presentation}
\label{sec:orgdda2aa4}
\begin{table}[htbp]
\caption{\label{tab:orgddb9bd1}Common Manifestations in Ketogenesis Defects}
\centering
\begin{tabular}{llllll}
FAOD & sudden & fasting & skeletal & cardio- & liver\\
 & death & intolerance & myopathy & myopathy & disease\\
...
\subsubsection{Diagnostic Tests}
\label{sec:orgb9705e1}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org1fb51be}
\begin{itemize}
...
\caption{\label{fig:org7c1644d}Metabolic Pathway of Creatine/Creatine Phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Slide16.png}
\caption{\label{fig:org7725b66}Metabolic Pathway of Creatine/Creatine Phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org84dfa69}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org9f37f1a}Urine findings in CDS}
\centering
\begin{tabular}{lll}
