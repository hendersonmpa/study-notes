...
\label{sec:orga7e38d8}
\subsection{Cellular Redox State}
\label{sec:orgcb989c5}
\begin{itemize}
...
\label{sec:org305383c}
\subsection{Introduction}
\label{sec:orge3601cf}
\begin{itemize}
...
\caption{\label{fig:org5204a67}Fatty Acid \(\beta\)-Oxidation}
\end{figure}



\begin{table}[htbp]
\caption{\label{tab:org957484d}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\item Genetics
\label{sec:orgf1c13f5}
\begin{itemize}
\item AR OCTN2
\end{itemize}
\item Diagnostic Tests
\label{sec:orgd57a06e}
\begin{itemize}
...
\caption{\label{fig:org674d049}CPT1 (OMM) \& CPTII (IMM)}
\end{figure}

\item Genetics
\label{sec:orgde55020}
\begin{itemize}
\item AR CPT1A
...
\caption{\label{fig:org761b0fe}Carnitine Acylcarnitine Translocase}
\end{figure}

\item Genetics
\label{sec:orgaa32b52}
\begin{itemize}
\item AR SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:org4bcb585}
\begin{itemize}
...
\label{sec:orgeaf90a8}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org08cdc7f}
\begin{enumerate}
\item Neonatal
\label{sec:orga24b20a}
\begin{itemize}
...
\item Genetics
\label{sec:org17902d7}
\begin{itemize}
\item AR ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org64ba444}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:orge271958}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orga0a7072}
\begin{itemize}
...
(Figure \ref{fig:org25b416b})
\end{itemize}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{fao/figures/lchad.png}
\caption{\label{fig:org25b416b}LCHAD reaction}
\end{figure}
...
\label{sec:orgc57de41}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org90c90b0}
\begin{itemize}
...
\caption{\label{fig:org31478c1}Multiple Acyl-CoA Dehydrogenase Deficiency}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fao/figures/etf.png}
\caption{\label{fig:orgdbda3f8}Role of ETF and ETF-QO}
\end{figure}

\item Genetics
\label{sec:org8944574}
\begin{itemize}
\item AR ETFA, ETFB, ETFDH
\end{itemize}

\item Diagnostic Tests
\label{sec:org922fe2c}
\begin{itemize}
\item plasma acylcarnitines
\begin{itemize}
\item \(\uparrow\) C4-C18
...
\end{enumerate}
\section{Pyruvate}
\label{sec:org018e91f}
\subsection{Introduction}
\label{sec:orgfdfe444}
\begin{itemize}
...
\caption[TCA]{\label{fig:org43629fe}Disorders of Pyruvate Metabolism}
\end{figure}
...
\caption[TCA]{\label{fig:org615a80d}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Reactions involving Pyruvate}
\label{sec:org72d6b98}
...
\caption[pdhc]{\label{fig:org8db95e2}Pyruvate Dehydrogenase Complex}
\end{figure}
...
\label{sec:orga9c4c57}
\subsection{Introduction}
\label{sec:orge3790a3}
\begin{itemize}
...
\caption[TCA]{\label{fig:org3b3b8f1}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Disorders of the TCA cycle}
\label{sec:orgf862928}
...
\subsubsection{Genetics}
\label{sec:org6ea7098}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org67f5659}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\caption{\label{fig:org8c65ece}Succinate Dehydrogenase | Complex II}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:org23becda}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org67ddce3}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:orga511ca2})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:orga511ca2}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\caption[cIV]{\label{fig:org6edab8a}Complex IV | Cytochrome c oxidase}
\end{figure}
\end{itemize}

\subsubsection{Complex V}
\label{sec:orgb89959e}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org8f867f9}Clinical Features of Mitochondrial Disease}
\centering
\begin{tabular}{ll}
...
\label{sec:orgb88f81d}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:org0d3da8b}
\begin{itemize}
...
\label{sec:org78decf0}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:org0f8775d}
\begin{itemize}
...
\label{sec:org35a1fc4}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{oxphos/figures/algorithm_rot.png}
\caption{\label{fig:orgb237dbc}Diagnosis of Mitochondrial Disease}
\end{figure}


\subsubsection{Biochemistry}
\label{sec:org64965ea}
\begin{itemize}
...
\caption[rrf]{\label{fig:org47d65ec}Ragged red fibers - Gomori stain}
\end{figure}

\subsubsection{Molecular}
\label{sec:orgff7fb7d}
\begin{itemize}
...
\subsubsection{Clinical Presentation}
\label{sec:orgcbec24b}
\begin{table}[htbp]
\caption{\label{tab:orgbedcf32}Common Manifestations in Ketogenesis Defects}
\centering
\begin{tabular}{llllll}
FAOD & sudden & fasting & skeletal & cardio- & liver\\
 & death & intolerance & myopathy & myopathy & disease\\
...
\subsubsection{Diagnostic Tests}
\label{sec:orgefc0adf}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:orgd9e8a3f}
\begin{itemize}
...
\caption{\label{fig:org4bc357f}Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Slide16.png}
\caption{\label{fig:org0527d37}Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org2691516}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org2fa3472}Urine findings in CDS}
\centering
\begin{tabular}{lll}
