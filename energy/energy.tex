...
\begin{table}[htbp]
\caption{\label{tab:org3d8a650}Acyl-CoA Synthetases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\begin{table}[htbp]
\caption{\label{tab:org1833a8c}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
Enzyme & Length & location\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org85502f7}Other: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\caption{\label{fig:org7c13b05}CPT1}
\end{figure}

\item Genetics
\label{sec:org61abc6c}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:org3485c6b}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd59f0f4}
\begin{itemize}
...
\item Genetics
\label{sec:orgf827be6}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:org01958f0}
\begin{itemize}
...
\label{sec:orgfa89482}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2b29b81}
\begin{enumerate}
\item Neonatal
\label{sec:orgd8d761a}
\begin{itemize}
...
\item Genetics
\label{sec:orgb789137}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org490d750}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org964fe8e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orge0eb06d}
\begin{itemize}
...
\label{sec:org8dbd3b4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd13d29d}
\begin{itemize}
...
\item Genetics
\label{sec:orga3454f6}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:org7b376b5}
\begin{itemize}
...
\end{enumerate}
\section{Pyruvate}
\label{sec:orgbb5295a}
\subsection{Introduction}
\label{sec:orgf4bb79f}
\begin{itemize}
...
\item Genetics
\label{sec:org79fba7e}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:org2d565e8})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org2d565e8}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\caption[g3ps]{\label{fig:orgfae977e}Glycerol-3-phosphate shuttle}
\end{figure}

\item Electron Transferring Flavoprotein/ Dehydrogenase
\label{sec:orgb1abce4}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org0716f14}Clinical Features of Mitochondrial Disease}
\centering
\begin{tabular}{ll}
...
\caption{\label{fig:org86f534b}Ketogenesis and Ketolysis}
\end{figure}
...
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2bc0cdd}
\begin{enumerate}
\item HMG-CoA Synthase Deficiency
\label{sec:org5029930}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:org4665a6c}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:orgd2c9a96}
\begin{itemize}
...
\end{enumerate}
\section{Creatine}
\label{sec:org5b2c1bf}
\subsection{Introduction}
\label{sec:org18afd9d}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org58332c6}Urine findings in CDS}
\centering
\begin{tabular}{lll}
