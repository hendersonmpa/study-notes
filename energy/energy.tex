...
\begin{enumerate}
\item \(\beta\)-oxidation
\label{sec:orge5fedff}
\end{enumerate}
\item Common manifestations in FAODs
\label{sec:orgb7c6a3e}
\begin{itemize}
...
\caption{\label{fig:org043f3be}
CPT1}
\end{figure}

\item Genetics
\label{sec:orgfab4bf5}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:org656b4b7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0f4c484}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org51edddd}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:orge2ee3cf})
...
\caption{\label{fig:orge2ee3cf}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org6c46a7c}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Tests
\label{sec:orgd5fedfc}
\begin{itemize}
...
\label{sec:orgfa298b4}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8e859f3}
\begin{enumerate}
\item Neonatal
\label{sec:org5bcebbe}
\begin{itemize}
...
\item Genetics
\label{sec:orgfce0387}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Tests
\label{sec:org4965723}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org745cf83}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgd67be2f}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:orgeeb25b6}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:org47352b9}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:org5222f4d}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org354dfb3}
\begin{itemize}
...
\label{sec:orga86f739}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5f55f46}
\begin{itemize}
...
\caption{\label{fig:org273dac6}
Acyl-CoA Dehydrogenase Reaction}
\end{figure}

\item Genetics
\label{sec:org34d24e6}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:orgba3737e}
\begin{itemize}
...
\caption[TCA]{\label{fig:org726ac40}
Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\begin{enumerate}
\item Disorders of the TCA cycle
\label{sec:org33b20e8}
...
mini-cycles (Figure \ref{fig:org3916dfe})
\begin{itemize}
...
\caption{\label{fig:org46a7f7c}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org01fb87f}
\begin{itemize}
...
\caption{\label{fig:orgf2c63a9}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:org3db8a23}
\begin{itemize}
...
\caption[ETC]{\label{fig:org0d4b30d}
...
\caption[redox]{\label{fig:orge546bd6}
...
\caption[rrf]{\label{fig:org532f221}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:orgf281651}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:orgf6a28aa}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:orga081413}
\begin{itemize}
...
\caption{\label{fig:orgb7d37f9}
Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org9af6d48}
\begin{itemize}
