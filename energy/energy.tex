...
\begin{table}[htbp]
\caption{\label{tab:org3a603d4}Acyl-CoA Synthetases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\begin{table}[htbp]
\caption{\label{tab:org0f30ea3}Acyl-CoA Dehydrogenases: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
Enzyme & Length & location\\
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org40583de}Other: Chain Length Specificity}
\centering
\begin{tabular}{lrl}
...
\label{sec:org21dda68}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org969b407}
\begin{enumerate}
\item Neonatal
\label{sec:orgc99c94e}
\begin{itemize}
...
\label{sec:orgafdcab2}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org771e729}
\begin{itemize}
...
\caption[pdhc]{\label{fig:org9211f6d}Pyruvate Dehydrogenase Complex}
\end{figure}
...
\caption[TCA]{\label{fig:org2a1bda4}Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\subsubsection{Disorders of the TCA cycle}
\label{sec:orgf1e5ef2}
...
\subsubsection{Genetics}
\label{sec:org42e341e}
\begin{itemize}
\item AR OGDH, DLST, DLD
\end{itemize}

\subsubsection{Diagnostic Tests}
\label{sec:org5768215}
\begin{itemize}
\item urine organic acids
\begin{itemize}
...
\caption{\label{fig:org184a965}Succinate Dehydrogenase | Complex II}
\end{figure}

\subsubsection{Clinical Presentation}
\label{sec:org5cc90f2}
\begin{itemize}
...
\subsubsection{Genetics}
\label{sec:org972ca9a}
\begin{itemize}
\item AR with highly variable phenotype
\item all components of Complex II are encoded by nuclear DNA (Table \ref{tab:org73b78c7})
\item mutations in SDHB, SDHC and SDHD cause susceptibility to familial
phaeochromocytoma and familial paraganglioma
\end{itemize}

\begin{table}[htbp]
\caption{\label{tab:org73b78c7}Succinate Dehydrogenase Genetics}
\centering
\begin{tabular}{ll}
Gene & Location\\
\hline
...
\caption[cIV]{\label{fig:org5145fb2}Complex IV | Cytochrome c oxidase}
\end{figure}
\end{itemize}

\subsubsection{Complex V}
\label{sec:org0880d15}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orga35bc03}Clinical Features of Mitochondrial Disease}
\centering
\begin{tabular}{ll}
...
\label{sec:org8854a52}
\begin{enumerate}
\item \textbf{Barth}
\label{sec:orgb2e37e7}
\begin{itemize}
...
\label{sec:org01fbba1}
\begin{enumerate}
\item \textbf{Kearns-Sayre Syndrome}
\label{sec:org68a08a8}
\begin{itemize}
...
\label{sec:org029a161}
\begin{figure}[htbp]
\centering
\includegraphics[width=1.2\textwidth]{oxphos/figures/algorithm_rot.png}
\caption{\label{fig:orgdc33db3}Diagnosis of Mitochondrial Disease}
\end{figure}


\subsubsection{Biochemistry}
\label{sec:org6f7f775}
\begin{itemize}
...
\caption[rrf]{\label{fig:org3768e5c}Ragged red fibers - Gomori stain}
\end{figure}

\subsubsection{Molecular}
\label{sec:orga883f92}
\begin{itemize}
...
\label{sec:org22a8efd}
\subsection{Introduction}
\label{sec:orgde09e22}
\begin{itemize}
...
\caption{\label{fig:org497bc9a}Ketogenesis and Ketolysis}
\end{figure}
...
\subsubsection{Clinical Presentation}
\label{sec:org2fc2944}
\begin{table}[htbp]
\caption{\label{tab:org82e16c0}Common Manifestations in Ketogenesis Defects}
\centering
\begin{tabular}{llllll}
FAOD & sudden & fasting & skeletal & cardio- & liver\\
 & death & intolerance & myopathy & myopathy & disease\\
...
\subsubsection{Diagnostic Tests}
\label{sec:org443efae}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org74039f9}
\begin{itemize}
...
\caption{\label{fig:org60792cb}Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{creatine/figures/Slide16.png}
\caption{\label{fig:org9fe9269}Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:orgfd704fc}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:orga188be7}Urine findings in CDS}
\centering
\begin{tabular}{lll}
