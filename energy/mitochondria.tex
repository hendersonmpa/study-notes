...
\caption{\label{fig:org68e2e6f}
FA oxidation and ketone body metabolism}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org9eb42bd}
...
\caption{\label{fig:orgb71d06b}
CPT1}
\end{figure}

\item Genetics
\label{sec:org2e3b0d2}
\begin{itemize}
\item AR, CPT1A
...
\label{sec:orgc4fea4f}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb1307cf}
\begin{itemize}
...
\end{itemize}
\item Metabolic Derangement
\label{sec:org889d556}
\begin{itemize}
\item carnitine-acylcarnitine translocase, catalyzes the transfer of the
acylcarnitines across the inner mitochondrial membrane (Figure \ref{fig:org76ae3ac})
...
\caption{\label{fig:org76ae3ac}
Carnitine Translocase}
\end{figure}

\item Genetics
\label{sec:org5a63b20}
\begin{itemize}
\item AR, SLC25A20
\end{itemize}
\item Diagnostic Testing
\label{sec:org5504464}
\begin{itemize}
...
\label{sec:orgd4634eb}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgab454cc}
\begin{enumerate}
\item Neonatal
\label{sec:org4b7f77e}
\begin{itemize}
...
\item Genetics
\label{sec:org80b93e0}
\begin{itemize}
\item AR, ACADVL
\end{itemize}

\item Diagnostic Testing
\label{sec:orgc26d0aa}
\begin{itemize}
\item \(\uparrow\) C14:1
...
\label{sec:org83c40ce}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org5ad3b5f}
\begin{itemize}
...
\label{sec:orgc8d253c}
\begin{itemize}
\item see LCHAD
\end{itemize}

\item Treatment
\label{sec:orgb70ebc3}
\begin{itemize}
\item see LCHAD
\end{itemize}
\end{enumerate}
...
\label{sec:orge9ba1f7}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgbb3630c}
\begin{itemize}
...
\label{sec:orge0b2f27}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9a6f00f}
\begin{itemize}
...
\caption{\label{fig:org961943e}
Acyl-CoA Dehydrogenase Reaction}
\end{figure}

\item Genetics
\label{sec:orgc674e55}
\begin{itemize}
\item AR, ACADM
\end{itemize}
\item Diagnostic Tests
\label{sec:orgc6b7258}
\begin{itemize}
...
\caption[TCA]{\label{fig:orgf82e4dc}
Pyruvate Metabolism and the TCA Cycle}
\end{figure}

\begin{enumerate}
\item Disorders of the TCA cycle
\label{sec:org0925389}
...
mini-cycles (Figure \ref{fig:org7421963})
\begin{itemize}
...
\caption{\label{fig:orgb0053dc}
Succinate Dehydrogenase | Complex II}
\end{figure}

\begin{enumerate}
\item Clinical Presentation
\label{sec:org1c7b6a9}
\begin{itemize}
...
\caption{\label{fig:org7188326}
Coupled spectrophotometric assay}
\end{figure}

\item Treatment
\label{sec:orgb4d6c8b}
\begin{itemize}
...
\caption[ETC]{\label{fig:orgabc0a3e}
...
\caption[redox]{\label{fig:orgad45e11}
...
\caption[rrf]{\label{fig:org8c91995}
Ragged red fibers - Gomori stain}
\end{figure}

\item Molecular
\label{sec:org117c177}
\begin{itemize}
...
\item Diagnostic Tests
\label{sec:orgf143199}
\begin{enumerate}
\item SCOT \& MCT1 Deficiencies
\label{sec:org70ad1f6}
\begin{itemize}
...
\caption{\label{fig:orgfb83a60}
Metabolic pathway of creatine/creatine phosphate}
\end{figure}

\subsection{Creatine Deficiency Syndromes}
\label{sec:org226b9b7}
\begin{itemize}
