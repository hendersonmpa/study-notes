...
\label{sec:org061dae3}
\subsection{Cobalamin}
\label{sec:orgc39a6fa}
\begin{itemize}
...
\caption{\label{fig:org97ae8a9}Cobalamin Transport and Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b12b9/figures/Slide24.png}
\caption{\label{fig:org7ef9cae}Cobalamin Absorption, Transport and Metabolism}
\end{figure}
...
\item Genetics
\label{sec:orgebdf3dc}
\begin{itemize}
\item AR MTHFR
\end{itemize}

\item Diagnostic Tests
\label{sec:org0570058}
\begin{itemize}
...
\label{sec:orgc259f05}
\subsection{Thiamine}
\label{sec:orgdd4e293}
\begin{itemize}
...
\caption{\label{fig:org0aa4673}Pyridoxine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b1b6/figures/Slide26.png}
\caption{\label{fig:org2c58e54}Pyridoxine Metabolism}
\end{figure}
