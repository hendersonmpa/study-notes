...
\section{Biotin}
\label{sec:orgc47bf7c}
\subsection{Introduction}
\label{sec:org8f6b499}
\begin{itemize}
...
\caption{\label{fig:orgc411993}Biotin Dependent Carboxylases}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/biotin.png}
\caption{\label{fig:orga0472c8}Biotin Cycle}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/Slide25.png}
\caption{\label{fig:orgf12890e}Biotin Cycle}
\end{figure}

\subsection{Biotin-responsive disorders}
\label{sec:org0766097}
\begin{itemize}
...
\caption[Kinetics]{\label{fig:org267b801}Holocarboxylase Synthetase Kinetics}
\end{figure}

\item Biotinidase Deficiency
\label{sec:org11b3e05}
\begin{itemize}
...
\label{sec:org9b97c04}
\subsection{Cobalamin}
\label{sec:orgeca2b31}
\begin{itemize}
...
\caption{\label{fig:orge9ba07e}Cobalamin transport and metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b12b9/figures/Slide24.png}
\caption{\label{fig:org9555362}Cobalamin absorption, transport and metabolism}
\end{figure}
...
\label{sec:orgc822d45}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org6392182}
\begin{itemize}
...
\item Genetics
\label{sec:org37f1494}
\begin{itemize}
\item AR MMACHC
\end{itemize}

\item Diagnostic Tests
\label{sec:orge5e44bc}
\begin{itemize}
...
\item Genetics
\label{sec:orgc438b68}
\begin{itemize}
\item AR, MTHFR
\end{itemize}

\item Diagnostic Tests
\label{sec:org3c970bf}
\begin{itemize}
...
\label{sec:org5660f01}
\subsection{Thiamine}
\label{sec:orgd720185}
\begin{itemize}
...
\caption{\label{fig:org4725f55}Pyridoxine metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b1b6/figures/Slide26.png}
\caption{\label{fig:org87901aa}Pyridoxine metabolism}
\end{figure}
...
\begin{itemize}
\item involved in lysine degradation (Figure \ref{fig:org88b2375})
\end{itemize}
\end{itemize}
...
\caption{\label{fig:org88b2375}Lysine degradation and antiquitin deficiency (blue bar)}
\end{figure}

\subsubsection{Hyperprolinemia Type II}
\label{sec:org25994e8}
\begin{itemize}
\item see Ornithine and Proline
\end{itemize}

\subsubsection{PNPO deficiency}
\label{sec:org85e715b}
\begin{itemize}
