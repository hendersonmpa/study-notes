...
\section{Biotin}
\label{sec:org7872399}
\subsection{Introduction}
\label{sec:org2e9c89a}
\begin{itemize}
...
\caption{\label{fig:orgf210da7}Biotin Dependent Carboxylases}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=.8\textwidth]{./figures/cycle.pdf}
\caption{\label{fig:orge4a3541}The Biotin Cycle adapted from (, ). Grey ovals contain substrates and products. Labelled black points represent enzymes. Metabolic functions of holocarboxylases are listed in the light grey octagon.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/biotin.png}
\caption{\label{fig:org4eb0fac}Biotin Cycle}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/Slide25.png}
\caption{\label{fig:org3d4ef53}Biotin Cycle}
\end{figure}

\subsection{Biotin-Responsive Disorders}
\label{sec:org05d6ebd}
\begin{itemize}
...
\label{sec:orgd1976ea}
\subsection{Cobalamin}
\label{sec:org2d208cb}
\begin{itemize}
...
\caption{\label{fig:org5b26493}Cobalamin Transport and Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b12b9/figures/Slide24.png}
\caption{\label{fig:orgdda5983}Cobalamin Absorption, Transport and Metabolism}
\end{figure}
...
\label{sec:org423c69c}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org0b0c8e4}
\begin{itemize}
...
\item Genetics
\label{sec:orgb787ea5}
\begin{itemize}
\item AR MMACHC
\end{itemize}

\item Diagnostic Tests
\label{sec:orgea072c9}
\begin{itemize}
...
\item Genetics
\label{sec:org1a9a605}
\begin{itemize}
\item AR MTHFR
\end{itemize}

\item Diagnostic Tests
\label{sec:org3bf8690}
\begin{itemize}
...
\label{sec:orgbb47503}
\subsection{Thiamine}
\label{sec:org1348c8a}
\begin{itemize}
...
\begin{itemize}
\item proline, ornithine, glycine (GCS), transamination (i.e. alanine), serine, tryptophan
\end{itemize}
...
\caption{\label{fig:org81ec69c}Pyridoxine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b1b6/figures/Slide26.png}
\caption{\label{fig:org8d7cbbd}Pyridoxine Metabolism}
\end{figure}
...
\begin{itemize}
\item involved in lysine degradation (Figure \ref{fig:org703bc2c})
\end{itemize}
\end{itemize}
...
\caption{\label{fig:org703bc2c}Lysine Degradation and Antiquitin Deficiency (blue bar)}
\end{figure}

\subsubsection{Hyperprolinemia Type II}
\label{sec:org8264a7b}
\begin{itemize}
\item see Ornithine and Proline
\end{itemize}

\subsubsection{PNPO deficiency}
\label{sec:org47c163f}
\begin{itemize}
