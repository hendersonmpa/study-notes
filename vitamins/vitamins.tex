...
\label{sec:org1e19ba7}
\subsection{Cobalamin}
\label{sec:orga1cb933}
\begin{itemize}
...
\caption{\label{fig:orgd937133}Cobalamin Transport and Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b12b9/figures/Slide24.png}
\caption{\label{fig:org6ab213f}Cobalamin Absorption, Transport and Metabolism}
\end{figure}
...
\item Genetics
\label{sec:org269efc8}
\begin{itemize}
\item AR MTHFR
\end{itemize}

\item Diagnostic Tests
\label{sec:org9ac69cb}
\begin{itemize}
...
\label{sec:orgfaf246a}
\subsection{Thiamine}
\label{sec:org2144883}
\begin{itemize}
...
\caption{\label{fig:orgfb9d7a6}Pyridoxine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b1b6/figures/Slide26.png}
\caption{\label{fig:org39e8f3a}Pyridoxine Metabolism}
\end{figure}
