...
\section{Biotin}
\label{sec:org8378ba5}
\subsection{Introduction}
\label{sec:orgdd4a5f8}
\begin{itemize}
...
\caption{\label{fig:org8939284}
Biotin cycle}
\end{figure}

\subsection{Biotin-responsive disorders}
\label{sec:orgf8d800e}
\begin{itemize}
...
\label{sec:orga1d75e9}
\begin{enumerate}
\item HCS Deficiency
\label{sec:orgb000707}
\begin{itemize}
...
\caption[Kinetics]{\label{fig:org8c77a8c}
Holocarboxylase Synthetase Kinetics}
\end{figure}

\item Biotinidase deficiency
\label{sec:org4777787}
\begin{itemize}
...
\label{sec:org73afbdb}
\subsection{Cobalamin}
\label{sec:org606a9cc}
\begin{itemize}
...
\item betaine treatment \(\to\) \(\uparrow\) plasma sarcosine (methlyglycine)
\end{itemize}
\end{enumerate}
\subsubsection{Cobalamin X}
\label{sec:org672593a}
\begin{itemize}
...
\item Genetics
\label{sec:org3e3c512}
\begin{itemize}
\item AR, MTHFR
\end{itemize}

\item Diagnostic Tests
\label{sec:org2aa90cd}
\begin{itemize}
...
\label{sec:org5af14f9}
\subsection{Thiamine}
\label{sec:org374952d}
\begin{itemize}
