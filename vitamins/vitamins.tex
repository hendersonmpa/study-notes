...
\section{Biotin}
\label{sec:orgce29d3a}
\subsection{Introduction}
\label{sec:org9cfcf8d}
\begin{itemize}
...
\caption{\label{fig:org2049aa6}Biotin Dependent Carboxylases}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=.8\textwidth]{./figures/cycle.pdf}
\caption{\label{fig:org8084802}The Biotin Cycle adapted from (, ). Grey ovals contain substrates and products. Labelled black points represent enzymes. Metabolic functions of holocarboxylases are listed in the light grey octagon.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/biotin.png}
\caption{\label{fig:orgc6998d4}Biotin Cycle}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/Slide25.png}
\caption{\label{fig:orgc8504aa}Biotin Cycle}
\end{figure}

\subsection{Biotin-Responsive Disorders}
\label{sec:org5cf30a2}
\begin{itemize}
...
\label{sec:org9de21e7}
\subsection{Cobalamin}
\label{sec:org30453cf}
\begin{itemize}
...
\caption{\label{fig:org79d5db0}Cobalamin Transport and Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b12b9/figures/Slide24.png}
\caption{\label{fig:org8343c8b}Cobalamin Absorption, Transport and Metabolism}
\end{figure}
...
\label{sec:org5254d38}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org8ce4849}
\begin{itemize}
...
\item Genetics
\label{sec:orgc87139b}
\begin{itemize}
\item AR MMACHC
\end{itemize}

\item Diagnostic Tests
\label{sec:orgbc48c55}
\begin{itemize}
...
\item Genetics
\label{sec:org6a0cb89}
\begin{itemize}
\item AR MTHFR
\end{itemize}

\item Diagnostic Tests
\label{sec:orgd58f15b}
\begin{itemize}
...
\label{sec:orgaf15cb1}
\subsection{Thiamine}
\label{sec:orge06cd59}
\begin{itemize}
...
\caption{\label{fig:org334d2d7}Pyridoxine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b1b6/figures/Slide26.png}
\caption{\label{fig:org2dd0c9a}Pyridoxine Metabolism}
\end{figure}
...
\begin{itemize}
\item involved in lysine degradation (Figure \ref{fig:org47f9e16})
\end{itemize}
\end{itemize}
...
\caption{\label{fig:org47f9e16}Lysine Degradation and Antiquitin Deficiency (blue bar)}
\end{figure}

\subsubsection{Hyperprolinemia Type II}
\label{sec:orga3481fa}
\begin{itemize}
\item see Ornithine and Proline
\end{itemize}

\subsubsection{PNPO deficiency}
\label{sec:org4dcaf3b}
\begin{itemize}
