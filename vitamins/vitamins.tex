...
\section{Biotin}
\label{sec:orgf1e3af0}
\subsection{Introduction}
\label{sec:org79cbc9c}
\begin{itemize}
...
\caption{\label{fig:orga052bf1}
Biotin cycle}
\end{figure}

\subsection{Biotin-responsive disorders}
\label{sec:org7032531}
\begin{itemize}
...
\label{sec:orgbfb9f7e}
\begin{enumerate}
\item HCS Deficiency
\label{sec:org0904abb}
\begin{itemize}
...
\caption[Kinetics]{\label{fig:orge239a82}
Holocarboxylase Synthetase Kinetics}
\end{figure}

\item Biotinidase deficiency
\label{sec:org321f83a}
\begin{itemize}
...
\label{sec:orgf7cf319}
\subsection{Cobalamin}
\label{sec:orgfb5ad53}
\begin{itemize}
...
\item Genetics
\label{sec:orga57a1c9}
\begin{itemize}
\item AR, MTHFR
\end{itemize}

\item Diagnostic Tests
\label{sec:org461815e}
\begin{itemize}
...
\label{sec:org6d4d899}
\subsection{Thiamine}
\label{sec:org61d48ab}
\begin{itemize}
