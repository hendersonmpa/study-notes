...
\section{Biotin}
\label{sec:org71f214d}
\subsection{Introduction}
\label{sec:org6005e6a}
\begin{itemize}
...
\caption{\label{fig:orgd693127}Biotin Dependent Carboxylases}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/biotin.png}
\caption{\label{fig:orgb9e9760}Biotin Cycle}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/Slide25.png}
\caption{\label{fig:org083ed66}Biotin Cycle}
\end{figure}

\subsection{Biotin-Responsive Disorders}
\label{sec:org8d87db3}
\begin{itemize}
...
\label{sec:org5e3d006}
\subsection{Cobalamin}
\label{sec:org2288419}
\begin{itemize}
...
\caption{\label{fig:org245c6e9}Cobalamin Transport and Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b12b9/figures/Slide24.png}
\caption{\label{fig:org2eed092}Cobalamin Absorption, Transport and Metabolism}
\end{figure}
...
\label{sec:org7d14ef3}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgc882d72}
\begin{itemize}
...
\item Genetics
\label{sec:org4ea2779}
\begin{itemize}
\item AR MMACHC
\end{itemize}

\item Diagnostic Tests
\label{sec:org6848d17}
\begin{itemize}
...
\item Genetics
\label{sec:orga7cf6f7}
\begin{itemize}
\item AR MTHFR
\end{itemize}

\item Diagnostic Tests
\label{sec:orge2a95a2}
\begin{itemize}
...
\label{sec:org0fcb2c6}
\subsection{Thiamine}
\label{sec:org950fa4c}
\begin{itemize}
...
\caption{\label{fig:orgee8198b}Pyridoxine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b1b6/figures/Slide26.png}
\caption{\label{fig:org5d388a5}Pyridoxine Metabolism}
\end{figure}
...
\begin{itemize}
\item involved in lysine degradation (Figure \ref{fig:orgb9c541c})
\end{itemize}
\end{itemize}
...
\caption{\label{fig:orgb9c541c}Lysine Degradation and Antiquitin Deficiency (blue bar)}
\end{figure}

\subsubsection{Hyperprolinemia Type II}
\label{sec:org3da597b}
\begin{itemize}
\item see Ornithine and Proline
\end{itemize}

\subsubsection{PNPO deficiency}
\label{sec:org0b3edc0}
\begin{itemize}
