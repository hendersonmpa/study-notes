...
\section{Biotin}
\label{sec:org6f811c8}
\subsection{Introduction}
\label{sec:org5b4a72d}
\begin{itemize}
...
\caption{\label{fig:org768d338}Biotin Dependent Carboxylases}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/biotin.png}
\caption{\label{fig:org8da1e0b}Biotin Cycle}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/Slide25.png}
\caption{\label{fig:orgea9294d}Biotin Cycle}
\end{figure}

\subsection{Biotin-responsive disorders}
\label{sec:org7e01e50}
\begin{itemize}
...
\caption[Kinetics]{\label{fig:org1148962}Holocarboxylase Synthetase Kinetics}
\end{figure}

\item Biotinidase Deficiency
\label{sec:orga84fc84}
\begin{itemize}
...
\label{sec:org45dbc6d}
\subsection{Cobalamin}
\label{sec:orgaa22713}
\begin{itemize}
...
\caption{\label{fig:orgfdbec53}Cobalamin transport and metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b12b9/figures/Slide24.png}
\caption{\label{fig:orgbbdb48f}Cobalamin absorption, transport and metabolism}
\end{figure}
...
\label{sec:org4cd08de}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org05d02a7}
\begin{itemize}
...
\item Genetics
\label{sec:orgd8e0145}
\begin{itemize}
\item AR MMACHC
\end{itemize}

\item Diagnostic Tests
\label{sec:org58bf74b}
\begin{itemize}
...
\item Genetics
\label{sec:org64b8ec1}
\begin{itemize}
\item AR, MTHFR
\end{itemize}

\item Diagnostic Tests
\label{sec:org5801fd8}
\begin{itemize}
...
\label{sec:org46b820c}
\subsection{Thiamine}
\label{sec:orga19fb10}
\begin{itemize}
...
\caption{\label{fig:org1e3db8b}Pyridoxine metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b1b6/figures/Slide26.png}
\caption{\label{fig:org806c34c}Pyridoxine metabolism}
\end{figure}
...
\begin{itemize}
\item involved in lysine degradation (Figure \ref{fig:org0a5f449})
\end{itemize}
\end{itemize}
...
\caption{\label{fig:org0a5f449}Lysine degradation and antiquitin deficiency (blue bar)}
\end{figure}

\subsubsection{Hyperprolinemia Type II}
\label{sec:org8a68077}
\begin{itemize}
\item see Ornithine and Proline
\end{itemize}

\subsubsection{PNPO deficiency}
\label{sec:org80a3509}
\begin{itemize}
