...
\section{Biotin}
\label{sec:org0414b4b}
\subsection{Introduction}
\label{sec:org2a1e336}
\begin{itemize}
...
\caption{\label{fig:orgdc6679d}Biotin Dependent Carboxylases}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/biotin.png}
\caption{\label{fig:orgb3cf743}Biotin Cycle}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/Slide25.png}
\caption{\label{fig:orga8eb48d}Biotin Cycle}
\end{figure}

\subsection{Biotin-Responsive Disorders}
\label{sec:orged1ff2f}
\begin{itemize}
...
\label{sec:org4fe1f89}
\subsection{Cobalamin}
\label{sec:org5c8462d}
\begin{itemize}
...
\caption{\label{fig:org099fe15}Cobalamin Transport and Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b12b9/figures/Slide24.png}
\caption{\label{fig:org8d460d8}Cobalamin Absorption, Transport and Metabolism}
\end{figure}
...
\label{sec:orgac77b2e}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgb073946}
\begin{itemize}
...
\item Genetics
\label{sec:org6ae811d}
\begin{itemize}
\item AR MMACHC
\end{itemize}

\item Diagnostic Tests
\label{sec:orgcb83fe4}
\begin{itemize}
...
\item Genetics
\label{sec:org67afc29}
\begin{itemize}
\item AR MTHFR
\end{itemize}

\item Diagnostic Tests
\label{sec:org1f99219}
\begin{itemize}
...
\label{sec:org36dbf08}
\subsection{Thiamine}
\label{sec:org5376804}
\begin{itemize}
...
\caption{\label{fig:orgd553275}Pyridoxine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b1b6/figures/Slide26.png}
\caption{\label{fig:orge6b5d04}Pyridoxine Metabolism}
\end{figure}
...
\begin{itemize}
\item involved in lysine degradation (Figure \ref{fig:orgcab1fe4})
\end{itemize}
\end{itemize}
...
\caption{\label{fig:orgcab1fe4}Lysine Degradation and Antiquitin Deficiency (blue bar)}
\end{figure}

\subsubsection{Hyperprolinemia Type II}
\label{sec:orgd7f6adf}
\begin{itemize}
\item see Ornithine and Proline
\end{itemize}

\subsubsection{PNPO deficiency}
\label{sec:org8b0b252}
\begin{itemize}
