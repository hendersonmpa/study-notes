...
\section{Biotin}
\label{sec:orgc5a26c2}
\subsection{Introduction}
\label{sec:orga5eb3d1}
\begin{itemize}
...
\caption{\label{fig:orgf024be5}Biotin Dependent Carboxylases}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/biotin.png}
\caption{\label{fig:orgaed944a}Biotin Cycle}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/Slide25.png}
\caption{\label{fig:org4c4243a}Biotin Cycle}
\end{figure}

\subsection{Biotin-Responsive Disorders}
\label{sec:orgd4a25be}
\begin{itemize}
...
\label{sec:org668fa87}
\subsection{Cobalamin}
\label{sec:org3489d34}
\begin{itemize}
...
\caption{\label{fig:org9649b91}Cobalamin Transport and Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b12b9/figures/Slide24.png}
\caption{\label{fig:org44fe133}Cobalamin Absorption, Transport and Metabolism}
\end{figure}
...
\label{sec:orgf2d52b0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:orgf94cb56}
\begin{itemize}
...
\item Genetics
\label{sec:orgf6aeea1}
\begin{itemize}
\item AR MMACHC
\end{itemize}

\item Diagnostic Tests
\label{sec:org1d3711a}
\begin{itemize}
...
\item Genetics
\label{sec:org9b40ef2}
\begin{itemize}
\item AR MTHFR
\end{itemize}

\item Diagnostic Tests
\label{sec:org34609b8}
\begin{itemize}
...
\label{sec:org5267aca}
\subsection{Thiamine}
\label{sec:org0dfad77}
\begin{itemize}
...
\caption{\label{fig:org5cdb295}Pyridoxine Metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b1b6/figures/Slide26.png}
\caption{\label{fig:orga35b87e}Pyridoxine Metabolism}
\end{figure}
...
\begin{itemize}
\item involved in lysine degradation (Figure \ref{fig:org5af4b91})
\end{itemize}
\end{itemize}
...
\caption{\label{fig:org5af4b91}Lysine Degradation and Antiquitin Deficiency (blue bar)}
\end{figure}

\subsubsection{Hyperprolinemia Type II}
\label{sec:orgc5e2861}
\begin{itemize}
\item see Ornithine and Proline
\end{itemize}

\subsubsection{PNPO deficiency}
\label{sec:org1461f83}
\begin{itemize}
