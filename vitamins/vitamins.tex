...
\section{Biotin}
\label{sec:orgd2f16c3}
\subsection{Introduction}
\label{sec:org32df096}
\begin{itemize}
...
\caption{\label{fig:orgd10878d}Biotin Dependent Carboxylases}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/biotin.png}
\caption{\label{fig:orgc5bc2b8}Biotin Cycle}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/Slide25.png}
\caption{\label{fig:org3a90a84}Biotin Cycle}
\end{figure}

\subsection{Biotin-responsive disorders}
\label{sec:org40a742d}
\begin{itemize}
...
\caption[Kinetics]{\label{fig:orga0bbb84}Holocarboxylase Synthetase Kinetics}
\end{figure}

\item Biotinidase Deficiency
\label{sec:orgd0f43ce}
\begin{itemize}
...
\label{sec:org0eefebd}
\subsection{Cobalamin}
\label{sec:orgae4a74f}
\begin{itemize}
...
\caption{\label{fig:orgbc75d86}Cobalamin transport and metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b12b9/figures/Slide24.png}
\caption{\label{fig:org1ab266c}Cobalamin absorption, transport and metabolism}
\end{figure}
...
\label{sec:org1928db0}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org2923458}
\begin{itemize}
...
\item Genetics
\label{sec:orgb36b701}
\begin{itemize}
\item AR MMACHC
\end{itemize}

\item Diagnostic Tests
\label{sec:orgec812fe}
\begin{itemize}
...
\item Genetics
\label{sec:org2d8388e}
\begin{itemize}
\item AR, MTHFR
\end{itemize}

\item Diagnostic Tests
\label{sec:orge643372}
\begin{itemize}
...
\label{sec:org2ceaec5}
\subsection{Thiamine}
\label{sec:org19e4801}
\begin{itemize}
...
\caption{\label{fig:org4435888}Pyridoxine metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b1b6/figures/Slide26.png}
\caption{\label{fig:orgfbe1e5e}Pyridoxine metabolism}
\end{figure}
...
\begin{itemize}
\item involved in lysine degradation (Figure \ref{fig:org657dbc7})
\end{itemize}
\end{itemize}
...
\caption{\label{fig:org657dbc7}Lysine degradation and antiquitin deficiency (blue bar)}
\end{figure}

\subsubsection{Hyperprolinemia Type II}
\label{sec:orge702aa2}
\begin{itemize}
\item see Ornithine and Proline
\end{itemize}

\subsubsection{PNPO deficiency}
\label{sec:org5608a05}
\begin{itemize}
