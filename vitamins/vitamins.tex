...
\section{Biotin}
\label{sec:org7db72e8}
\subsection{Introduction}
\label{sec:org8425a2c}
\begin{itemize}
...
\caption{\label{fig:org7624bb0}Biotin Dependent Carboxylases}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/biotin.png}
\caption{\label{fig:org553ed96}Biotin Cycle}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{biotin/figures/Slide25.png}
\caption{\label{fig:org77a5a18}Biotin Cycle}
\end{figure}

\subsection{Biotin-responsive disorders}
\label{sec:org602d112}
\begin{itemize}
...
\caption[Kinetics]{\label{fig:org3f42e48}Holocarboxylase Synthetase Kinetics}
\end{figure}

\item Biotinidase Deficiency
\label{sec:orgf6eb5f9}
\begin{itemize}
...
\label{sec:org6748f68}
\subsection{Cobalamin}
\label{sec:org346d4cf}
\begin{itemize}
...
\caption{\label{fig:orge1c4a65}Cobalamin transport and metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b12b9/figures/Slide24.png}
\caption{\label{fig:org2e9695a}Cobalamin absorption, transport and metabolism}
\end{figure}
...
\label{sec:orga33a355}
\begin{enumerate}
\item Clinical Presentation
\label{sec:org9b94617}
\begin{itemize}
...
\item Genetics
\label{sec:org2109578}
\begin{itemize}
\item AR MMACHC
\end{itemize}

\item Diagnostic Tests
\label{sec:orgeae7454}
\begin{itemize}
...
\item Genetics
\label{sec:org5a9d367}
\begin{itemize}
\item AR, MTHFR
\end{itemize}

\item Diagnostic Tests
\label{sec:org9c2cfa3}
\begin{itemize}
...
\label{sec:orgb786c56}
\subsection{Thiamine}
\label{sec:org63798ae}
\begin{itemize}
...
\caption{\label{fig:org886a761}Pyridoxine metabolism}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{b1b6/figures/Slide26.png}
\caption{\label{fig:org8406165}Pyridoxine metabolism}
\end{figure}
...
\begin{itemize}
\item involved in lysine degradation (Figure \ref{fig:org78f0eb2})
\end{itemize}
\end{itemize}
...
\caption{\label{fig:org78f0eb2}Lysine degradation and antiquitin deficiency (blue bar)}
\end{figure}

\subsubsection{Hyperprolinemia Type II}
\label{sec:org7e8e1a8}
\begin{itemize}
\item see Ornithine and Proline
\end{itemize}

\subsubsection{PNPO deficiency}
\label{sec:org64bb0da}
\begin{itemize}
